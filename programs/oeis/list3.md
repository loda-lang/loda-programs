...
* [A300069](http://oeis.org/A300069) ([L11 program](A300069.asm)): Period 6: repeat [0, 0, 0, 1, 2, 1].
...
* [A301516](http://oeis.org/A301516) ([L16 program](A301516.asm)): Numbers n with decimal expansion (d_1, ..., d_k) such that the convex hull of the set of points { (i, d_i), i = 1..k } has positive area.
...
* [A301647](http://oeis.org/A301647) ([L31 program](A301647.asm)): a(n) = n^3 - (n mod 2).
...
* [A303302](http://oeis.org/A303302) ([L13 program](A303302.asm)): a(n) = 34*n^2.
...
* [A304508](http://oeis.org/A304508) ([L24 program](A304508.asm)): a(n) = 5*(3*n+1)*(9*n+8)/2 (n>=0).
...
* [A304725](http://oeis.org/A304725) ([L43 program](A304725.asm)): a(n) = n^4 + 8*n^3 + 20*n^2 + 16*n + 2.
...
* [A306278](http://oeis.org/A306278) ([L10 program](A306278.asm)): Numbers congruent to 2 or 11 mod 14.
* [A306279](http://oeis.org/A306279) ([L11 program](A306279.asm)): Numbers congruent to 3 or 18 mod 22.
...
* [A309842](http://oeis.org/A309842) ([L19 program](A309842.asm)): a(n) is the total surface area of a hollow cubic block (defined as a block with a shell thickness of 1 cube) where n is the edge length of the removed volume.
...
* [A314840](http://oeis.org/A314840) ([L14 program](A314840.asm)): Coordination sequence Gal.5.66.3 where G.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.
...
* [A315538](http://oeis.org/A315538) ([L12 program](A315538.asm)): Coordination sequence Gal.3.50.2 where G.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.
...
* [A319371](http://oeis.org/A319371) ([L07 program](A319371.asm)): Numbers k such that the characteristic polynomial of a wheel graph of k nodes has exactly one monomial with vanishing coefficient.
...
* [A322008](http://oeis.org/A322008) ([L33 program](A322008.asm)): 1/(1 - Integral_{x=0..1} x^(x^n) dx), rounded to the nearest integer.
...
* [A323178](http://oeis.org/A323178) ([L14 program](A323178.asm)): a(n) = 1 + 100*n^2 for n >= 0.

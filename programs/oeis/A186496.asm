; A186496: Adjusted joint rank sequence of (f(i)) and (g(j)) with f(i) aftere g(j) when f(i)=g(j), where f(i)=5i and g(j)=j-th pentagonal number.  Complement of A186495.

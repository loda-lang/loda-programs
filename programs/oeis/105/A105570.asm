...
lpb $3
  ...
  sub $0,1
  trn $0,1
  cal $0,294246 ; Sum of the smaller parts of the partitions of 2n into two parts with smaller part nonsquarefree.
  mov $2,$3
  mov $4,$0
  lpb $2
    mov $1,$4

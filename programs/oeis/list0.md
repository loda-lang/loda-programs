...
* [A001298](http://oeis.org/A001298) ([L08 program](001/A001298.asm)): Stirling numbers of the second kind S(n+4, n).
...
* [A001953](http://oeis.org/A001953) ([L50 program](001/A001953.asm)): a(n) = floor((n + 1/2) * sqrt(2)).
...
* [A002088](http://oeis.org/A002088) ([L03 program](002/A002088.asm)): Sum of totient function: a(n) = Sum_{k=1..n} phi(k), cf. A000010.
...
* [A002571](http://oeis.org/A002571) ([L33 program](002/A002571.asm)): From a definite integral.
...
* [A002819](http://oeis.org/A002819) ([L06 program](002/A002819.asm)): Liouville's function L(n) = partial sums of A008836.
...
* [A004799](http://oeis.org/A004799) ([L14 program](004/A004799.asm)): Self convolution of Lucas numbers.
...
* [A005022](http://oeis.org/A005022) ([L21 program](005/A005022.asm)): Number of walks of length 2n+6 in the path graph P_7 from one end to the other.
...
* [A005232](http://oeis.org/A005232) ([L16 program](005/A005232.asm)): Expansion of (1-x+x^2)/((1-x)^2*(1-x^2)*(1-x^4)).
...
* [A005359](http://oeis.org/A005359) ([L19 program](005/A005359.asm)): a(n) = n! if n is even, otherwise 0 (from Taylor series for cos x).
...
* [A005713](http://oeis.org/A005713) ([L08 program](005/A005713.asm)): Define strings S(0)=0, S(1)=11, S(n) = S(n-1)S(n-2); iterate.
...
* [A005766](http://oeis.org/A005766) ([L22 program](005/A005766.asm)): a(n) = cost of minimal multiplication-cost addition chain for n.
...
* [A006264](http://oeis.org/A006264) ([L19 program](006/A006264.asm)): Diagonal length function.
...
* [A007088](http://oeis.org/A007088) ([L04 program](007/A007088.asm)): The binary numbers (or binary words, or binary vectors, or binary expansion of n): numbers written in base 2.
...
* [A007424](http://oeis.org/A007424) ([L07 program](007/A007424.asm)): a(n) = 1 if n is squarefree, otherwise 2.
* [A007456](http://oeis.org/A007456) ([L16 program](007/A007456.asm)): Days required to spread gossip to n people.
...
* [A007904](http://oeis.org/A007904) ([L27 program](007/A007904.asm)): Crystal ball sequence for diamond.
...
* [A008475](http://oeis.org/A008475) ([L08 program](008/A008475.asm)): If n = Product (p_j^k_j) then a(n) = Sum (p_j^k_j) (a(1) = 0 by convention).
...
* [A014081](http://oeis.org/A014081) ([L11 program](014/A014081.asm)): a(n) is the number of occurrences of '11' in binary expansion of n.
...
* [A022330](http://oeis.org/A022330) ([L65 program](022/A022330.asm)): Index of 3^n within sequence of numbers of form 2^i*3^j.
...
* [A022963](http://oeis.org/A022963) ([L03 program](022/A022963.asm)): 7-n.
* [A022964](http://oeis.org/A022964) ([L03 program](022/A022964.asm)): 8-n.
...
* [A022975](http://oeis.org/A022975) ([L03 program](022/A022975.asm)): a(n) = 19 - n.
...
* [A022978](http://oeis.org/A022978) ([L03 program](022/A022978.asm)): 22-n.
...
* [A022981](http://oeis.org/A022981) ([L03 program](022/A022981.asm)): 25-n.
...
* [A023659](http://oeis.org/A023659) ([L38 program](023/A023659.asm)): Convolution of odd numbers and A001950.
...
* [A024675](http://oeis.org/A024675) ([L06 program](024/A024675.asm)): Average of two consecutive odd primes.
...
* [A024712](http://oeis.org/A024712) ([L04 program](024/A024712.asm)): a(n) = residue mod 3 of n-th term of A024702.
...
* [A025281](http://oeis.org/A025281) ([L12 program](025/A025281.asm)): a(n) = sopfr(n!), where sopfr = A001414  is the integer log.
...
* [A025693](http://oeis.org/A025693) ([L31 program](025/A025693.asm)): Index of 2^n within sequence of numbers of form 2^i*7^j.
...
* [A025798](http://oeis.org/A025798) ([L27 program](025/A025798.asm)): Expansion of 1/((1-x^2)(1-x^3)(1-x^9)).
...
* [A026274](http://oeis.org/A026274) ([L08 program](026/A026274.asm)): Greatest k such that s(k) = n, where s = A026272.
...
* [A026357](http://oeis.org/A026357) ([L10 program](026/A026357.asm)): a(n) = sum of the numbers between the two n's in A026354.
...
* [A026811](http://oeis.org/A026811) ([L18 program](026/A026811.asm)): Number of partitions of n in which the greatest part is 5.
...
* [A030426](http://oeis.org/A030426) ([L07 program](030/A030426.asm)): a(n) = Fibonacci(prime(n)).
...
* [A031218](http://oeis.org/A031218) ([L11 program](031/A031218.asm)): Largest prime power <= n.
...
* [A032357](http://oeis.org/A032357) ([L53 program](032/A032357.asm)): Convolution of Catalan numbers and powers of -1.
...
* [A034266](http://oeis.org/A034266) ([L06 program](034/A034266.asm)): Partial sums of A027818.
...
* [A038505](http://oeis.org/A038505) ([L19 program](038/A038505.asm)): Sum of every 4th entry of row n in Pascal's triangle, starting at binomial(n,2).
...
* [A038741](http://oeis.org/A038741) ([L18 program](038/A038741.asm)): T(n,n-4), array T as in A038738.
...
* [A044970](http://oeis.org/A044970) ([L11 program](044/A044970.asm)): Numbers n with property that in base-3 representation the numbers of 0's and 1's are 1 and 0, respectively.
* [A044994](http://oeis.org/A044994) ([L12 program](044/A044994.asm)): Numbers n with property that in base-3 representation the numbers of 0's and 2's are 1 and 0, respectively.
...
* [A045717](http://oeis.org/A045717) ([L33 program](045/A045717.asm)): For each prime p take the sum of nonprimes < p.
...
* [A046219](http://oeis.org/A046219) ([L17 program](046/A046219.asm)): Denominators of elements of 1/2-Pascal triangle (by row).
...
* [A046670](http://oeis.org/A046670) ([L21 program](046/A046670.asm)): Partial sums of A006530.
...
* [A046898](http://oeis.org/A046898) ([L06 program](046/A046898.asm)): Partial sums of A046897.
...
* [A048671](http://oeis.org/A048671) ([L07 program](048/A048671.asm)): a(n) is the least common multiple of the proper divisors of n.
...
* [A049502](http://oeis.org/A049502) ([L06 program](049/A049502.asm)): Major index of n, 2nd definition.
...
* [A049632](http://oeis.org/A049632) ([L05 program](049/A049632.asm)): a(n)=T(n,n), array T as in A049627.
...
* [A049691](http://oeis.org/A049691) ([L04 program](049/A049691.asm)): a(n)=T(n,n), array T as in A049687. Also a(n)=T(2n,2n), array T given by A049639.
...
* [A049716](http://oeis.org/A049716) ([L05 program](049/A049716.asm)): a(n) = 2*n + 1 - prevprime(2*n + 1).

...
* [A000093](http://oeis.org/A000093) ([L28 program](A000093.asm)): a(n) = floor(n^(3/2)).
* [A000096](http://oeis.org/A000096) ([L04 program](A000096.asm)): a(n) = n*(n+3)/2.
* [A000108](http://oeis.org/A000108) ([L12 program](A000108.asm)): Catalan numbers: C(n) = binomial(2n,n)/(n+1) = (2n)!/(n!(n+1)!).
...
* [A000128](http://oeis.org/A000128) ([L54 program](A000128.asm)): A nonlinear binomial sum.
...
* [A000539](http://oeis.org/A000539) ([L08 program](A000539.asm)): Sum of 5th powers: 0^5 + 1^5 + 2^5 + ... + n^5.
* [A000540](http://oeis.org/A000540) ([L16 program](A000540.asm)): Sum of 6th powers: 0^6 + 1^6 + 2^6 + ... + n^6.
* [A000541](http://oeis.org/A000541) ([L15 program](A000541.asm)): Sum of 7th powers: 1^7 + 2^7 + ... + n^7.
* [A000542](http://oeis.org/A000542) ([L15 program](A000542.asm)): Sum of 8th powers: 1^8 + 2^8 + ... + n^8.
...
* [A000574](http://oeis.org/A000574) ([L18 program](A000574.asm)): Coefficient of x^5 in expansion of (1 + x + x^2)^n.
...
* [A000917](http://oeis.org/A000917) ([L09 program](A000917.asm)): a(n) = (2n+3)!/(n!*(n+2)!).
...
* [A000972](http://oeis.org/A000972) ([L13 program](A000972.asm)): Fermat coefficients.
...
* [A001316](http://oeis.org/A001316) ([L14 program](A001316.asm)): Gould's sequence: a(n) = Sum_{k=0..n} (binomial(n,k) mod 2); number of odd entries in row n of Pascal's triangle (A007318); 2^A000120(n).
...
* [A001453](http://oeis.org/A001453) ([L11 program](A001453.asm)): Catalan numbers - 1.
...
* [A001552](http://oeis.org/A001552) ([L22 program](A001552.asm)): 1^n + 2^n + ... + 5^n.
...
* [A001816](http://oeis.org/A001816) ([L19 program](A001816.asm)): Coefficients of x^n in Hermite polynomial H_{n+4}
...
* [A001846](http://oeis.org/A001846) ([L09 program](A001846.asm)): Centered 4-dimensional orthoplex numbers (crystal ball sequence for 4-dimensional cubic lattice).
...
* [A001951](http://oeis.org/A001951) ([L18 program](A001951.asm)): A Beatty sequence: a(n) = floor(n*sqrt(2)).
...
* [A002492](http://oeis.org/A002492) ([L05 program](A002492.asm)): Sum of the first n even squares: 2*n*(n+1)*(2*n+1)/3.
...
* [A002736](http://oeis.org/A002736) ([L13 program](A002736.asm)): Apéry numbers: a(n) = n^2*C(2n,n).
...
* [A002993](http://oeis.org/A002993) ([L07 program](A002993.asm)): Initial digits of squares.
...
* [A003258](http://oeis.org/A003258) ([L15 program](A003258.asm)): The number m such that c'(m) = A005206(A003231(n)), where c'(m) = A249115(m) is the m-th positive integer not in A003231.
...
* [A003472](http://oeis.org/A003472) ([L18 program](A003472.asm)): a(n) = 2^(n-4)*C(n,4).
...
* [A003589](http://oeis.org/A003589) ([L34 program](A003589.asm)): a(n) has the property that the sequence b(n) = number of 2's between successive 3's is the same as the original sequence.
...
* [A003892](http://oeis.org/A003892) ([L27 program](A003892.asm)): Degrees of irreducible representations of group L2(32).
...
* [A004220](http://oeis.org/A004220) ([L12 program](A004220.asm)): 10*log_10 (n) rounded to nearest integer.
* [A004235](http://oeis.org/A004235) ([L12 program](A004235.asm)): 10*log(n) rounded to nearest integer.
...
* [A004257](http://oeis.org/A004257) ([L11 program](A004257.asm)): a(n) = round(log_2(n)).
* [A004258](http://oeis.org/A004258) ([L04 program](A004258.asm)): Duplicate of A029837.
* [A004261](http://oeis.org/A004261) ([L11 program](A004261.asm)): a(n) = ceiling(10*log_2(n)).
...
* [A004456](http://oeis.org/A004456) ([L20 program](A004456.asm)): Nimsum n + 15.
...
* [A005057](http://oeis.org/A005057) ([L11 program](A005057.asm)): 5^n - 2^n.
* [A005058](http://oeis.org/A005058) ([L06 program](A005058.asm)): 5^n - 3^n.
* [A005059](http://oeis.org/A005059) ([L07 program](A005059.asm)): a(n) = (5^n - 3^n)/2.
...
* [A005476](http://oeis.org/A005476) ([L04 program](A005476.asm)): a(n) = n*(5*n - 1)/2.
...
* [A005557](http://oeis.org/A005557) ([L13 program](A005557.asm)): Number of walks on square lattice.
...
* [A005583](http://oeis.org/A005583) ([L16 program](A005583.asm)): Coefficients of Chebyshev polynomials.
...
* [A006007](http://oeis.org/A006007) ([L07 program](A006007.asm)): 4-dimensional analog of centered polygonal numbers: a(n) = n(n+1)*(n^2+n+4)/12.
...
* [A006044](http://oeis.org/A006044) ([L19 program](A006044.asm)): A traffic light problem.
...
* [A006261](http://oeis.org/A006261) ([L124 program](A006261.asm)): a(n) = Sum_{k=0..5} C(n,k).
...
* [A006332](http://oeis.org/A006332) ([L12 program](A006332.asm)): From the enumeration of corners.
...
* [A006411](http://oeis.org/A006411) ([L07 program](A006411.asm)): Nonseparable planar tree-rooted maps with three vertices and n+2 edges.
* [A006414](http://oeis.org/A006414) ([L11 program](A006414.asm)): Number of nonseparable toroidal tree-rooted maps on n nodes.
...
* [A006504](http://oeis.org/A006504) ([L30 program](A006504.asm)): Coefficient of x^4 in (1-x-x^2)^(-n).
...
* [A006858](http://oeis.org/A006858) ([L11 program](A006858.asm)): Expansion of x*(1 + x)*(1 + 6*x + x^2)/(1 - x)^7.
...
* [A007007](http://oeis.org/A007007) ([L10 program](A007007.asm)): Valence of graph of maximal intersecting families of sets.
...
* [A007202](http://oeis.org/A007202) ([L45 program](A007202.asm)): Crystal ball sequence for hexagonal close-packing.
...
* [A007291](http://oeis.org/A007291) ([L57 program](A007291.asm)): Series expansion for rectilinear polymers on square lattice.
...
* [A007904](http://oeis.org/A007904) ([L35 program](A007904.asm)): Crystal ball sequence for diamond.
...
* [A007979](http://oeis.org/A007979) ([L46 program](A007979.asm)): Expansion of (1+x^2)(1+x^4)/((1-x)^2*(1-x^2)*(1-x^3)).
...
* [A008384](http://oeis.org/A008384) ([L11 program](A008384.asm)): Crystal ball sequence for A_4 lattice.
...
* [A008488](http://oeis.org/A008488) ([L15 program](A008488.asm)): Expansion of (1-x^6) / (1-x)^6.
...
* [A010131](http://oeis.org/A010131) ([L34 program](A010131.asm)): Continued fraction for sqrt(33).
...
* [A010950](http://oeis.org/A010950) ([L04 program](A010950.asm)): Binomial coefficient C(34,n).
...
* [A010959](http://oeis.org/A010959) ([L04 program](A010959.asm)): Binomial coefficient C(43,n).
...
* [A010975](http://oeis.org/A010975) ([L07 program](A010975.asm)): a(n) = binomial(n,22).
...
* [A010984](http://oeis.org/A010984) ([L09 program](A010984.asm)): Binomial coefficient C(n,31).
* [A010985](http://oeis.org/A010985) ([L05 program](A010985.asm)): Binomial coefficient C(n,32).
* [A010986](http://oeis.org/A010986) ([L06 program](A010986.asm)): Binomial coefficient C(n,33).
...
* [A010990](http://oeis.org/A010990) ([L18 program](A010990.asm)): Binomial coefficient C(n,37).
* [A010991](http://oeis.org/A010991) ([L15 program](A010991.asm)): Binomial coefficient C(n,38).
* [A010992](http://oeis.org/A010992) ([L13 program](A010992.asm)): Binomial coefficient C(n,39).
* [A010993](http://oeis.org/A010993) ([L08 program](A010993.asm)): Binomial coefficient C(n,40).
* [A010994](http://oeis.org/A010994) ([L03 program](A010994.asm)): a(n) = binomial coefficient C(n,41).
...
* [A010997](http://oeis.org/A010997) ([L07 program](A010997.asm)): a(n) = binomial coefficient C(n,44).
...
* [A011000](http://oeis.org/A011000) ([L11 program](A011000.asm)): a(n) = binomial coefficient C(n,47).
...
* [A011870](http://oeis.org/A011870) ([L07 program](A011870.asm)): [ n(n-1)/17 ].
...
* [A011876](http://oeis.org/A011876) ([L06 program](A011876.asm)): [ n(n-1)/23 ].
...
* [A011884](http://oeis.org/A011884) ([L16 program](A011884.asm)): Floor(n(n - 1)/31).
...
* [A011917](http://oeis.org/A011917) ([L25 program](A011917.asm)): [ n(n-1)(n-2)(n-3)/7 ].
* [A011919](http://oeis.org/A011919) ([L10 program](A011919.asm)): a(n) = floor(n*(n-1)*(n-2)*(n-3)/9).
* [A011921](http://oeis.org/A011921) ([L16 program](A011921.asm)): [ n(n-1)(n-2)(n-3)/11 ].
* [A011925](http://oeis.org/A011925) ([L05 program](A011925.asm)): Floor(n(n-1)(n-2)(n-3)/15).
...
* [A011932](http://oeis.org/A011932) ([L15 program](A011932.asm)): [ n(n-1)(n-2)(n-3)/22 ].
...
* [A015221](http://oeis.org/A015221) ([L11 program](A015221.asm)): Odd square pyramidal numbers.
...
* [A017258](http://oeis.org/A017258) ([L04 program](A017258.asm)): a(n) = (9*n + 8)^2.
...
* [A017452](http://oeis.org/A017452) ([L13 program](A017452.asm)): a(n) = (11*n + 5)^4.
...
* [A017642](http://oeis.org/A017642) ([L04 program](A017642.asm)): (12n+10)^2.
...
* [A018210](http://oeis.org/A018210) ([L54 program](A018210.asm)): Alkane (or paraffin) numbers l(9,n).
* [A018211](http://oeis.org/A018211) ([L63 program](A018211.asm)): Alkane (or paraffin) numbers l(10,n).
...
* [A020331](http://oeis.org/A020331) ([L16 program](A020331.asm)): Numbers n such that base 3 representation is the juxtaposition of two identical strings.
...
* [A022107](http://oeis.org/A022107) ([L15 program](A022107.asm)): Fibonacci sequence beginning 1, 17.
...
* [A022777](http://oeis.org/A022777) ([L54 program](A022777.asm)): Place where n-th 1 occurs in A007337.
* [A022779](http://oeis.org/A022779) ([L47 program](A022779.asm)): Place where n-th 1 occurs in A023117.
* [A022783](http://oeis.org/A022783) ([L27 program](A022783.asm)): Place where n-th 1 occurs in A023121.
...
* [A022842](http://oeis.org/A022842) ([L84 program](A022842.asm)): Beatty sequence for sqrt(8).
...
* [A024482](http://oeis.org/A024482) ([L28 program](A024482.asm)): a(n) = (1/2)*(binomial(2n, n) - binomial(2n-2, n-1)).
* [A024483](http://oeis.org/A024483) ([L09 program](A024483.asm)): a(n) = binomial(2*n, n) mod binomial(2*n-2, n-1).
...
* [A025713](http://oeis.org/A025713) ([L47 program](A025713.asm)): Index of 6^n within sequence of numbers of form 3^i*6^j.
...
* [A025726](http://oeis.org/A025726) ([L105 program](A025726.asm)): Index of 7^n within sequence of numbers of form 7^i*9^j.
...
* [A025770](http://oeis.org/A025770) ([L19 program](A025770.asm)): Expansion of 1/((1-x)(1-x^3)(1-x^10)).
...
* [A025783](http://oeis.org/A025783) ([L28 program](A025783.asm)): Expansion of 1/((1-x)(1-x^6)(1-x^11)).
* [A025784](http://oeis.org/A025784) ([L13 program](A025784.asm)): Expansion of 1/((1-x)(1-x^7)(1-x^8)).
* [A025785](http://oeis.org/A025785) ([L30 program](A025785.asm)): Expansion of 1/((1-x)(1-x^7)(1-x^9)).
...
* [A025793](http://oeis.org/A025793) ([L24 program](A025793.asm)): Expansion of 1/((1-x)(1-x^10)(1-x^11)).
...
* [A026039](http://oeis.org/A026039) ([L22 program](A026039.asm)): a(n) = (d(n) - r(n))/5, where d = A026037 and r is the periodic sequence with fundamental period (1,2,0,2,0).
...
* [A026062](http://oeis.org/A026062) ([L17 program](A026062.asm)): a(n) = (d(n)-r(n))/5, where d = A026060 and r is the periodic sequence with fundamental period (0,0,1,4,0).
...
* [A026209](http://oeis.org/A026209) ([L23 program](A026209.asm)): Duplicate of A026185.
* [A026273](http://oeis.org/A026273) ([L38 program](A026273.asm)): a(n) = least k such that s(k) = n, where s = A026272.
...
* [A026383](http://oeis.org/A026383) ([L26 program](A026383.asm)): a(n) = 5a(n-2), starting 1,2.
* [A026384](http://oeis.org/A026384) ([L15 program](A026384.asm)): a(n) = Sum_{j=0..i, i=0..n} T(i,j),  where T is the array in A026374.
...
* [A026396](http://oeis.org/A026396) ([L16 program](A026396.asm)): Sum{T(i,j)}, 0<=j<=i, 0<=i<=n, where T is the array in A026386.
* [A026472](http://oeis.org/A026472) ([L92 program](A026472.asm)): {3, 7} together with the numbers congruent to {1, 2} mod 12.
...
* [A026646](http://oeis.org/A026646) ([L22 program](A026646.asm)): a(n) = Sum_{0<=i,j<=n} A026637(i,j).
...
* [A027271](http://oeis.org/A027271) ([L17 program](A027271.asm)): a(n) = Sum_{k=0..2n} (k+1)*T(n,k), where T is given by A026536.
...
* [A027626](http://oeis.org/A027626) ([L23 program](A027626.asm)): Denominator of n*(n+5)/((n+2)*(n+3)).
...
* [A027769](http://oeis.org/A027769) ([L16 program](A027769.asm)): a(n) = (n+1)*binomial(n+1, 9).
* [A027770](http://oeis.org/A027770) ([L16 program](A027770.asm)): a(n) = (n + 1)*binomial(n + 1, 10).
* [A027772](http://oeis.org/A027772) ([L22 program](A027772.asm)): (n+1)*C(n+1,12).
* [A027776](http://oeis.org/A027776) ([L13 program](A027776.asm)): (n+1)*C(n+1,16).
* [A027777](http://oeis.org/A027777) ([L10 program](A027777.asm)): a(n) = 2*(n+1)*C(n+2,4).
* [A027778](http://oeis.org/A027778) ([L12 program](A027778.asm)): a(n) = 5*(n+1)*binomial(n+2, 5)/2.
* [A027779](http://oeis.org/A027779) ([L17 program](A027779.asm)): a(n) = 3*(n+1)*C(n+2,6).
* [A027780](http://oeis.org/A027780) ([L14 program](A027780.asm)): a(n) = 7*(n+1)*C(n+2,7)/2.
...
* [A027783](http://oeis.org/A027783) ([L12 program](A027783.asm)): a(n) = 5*(n+1)*binomial(n+2,10).
* [A027785](http://oeis.org/A027785) ([L15 program](A027785.asm)): a(n) = 6*(n+1)*binomial(n+2,12).
* [A027789](http://oeis.org/A027789) ([L19 program](A027789.asm)): a(n) = 2*(n+1)*binomial(n+3,4).
* [A027790](http://oeis.org/A027790) ([L20 program](A027790.asm)): a(n) = 10*(n+1)*binomial(n+3,5)/3.
* [A027791](http://oeis.org/A027791) ([L17 program](A027791.asm)): a(n) = 5*(n+1)*C(n+3,6).
* [A027792](http://oeis.org/A027792) ([L20 program](A027792.asm)): a(n) = 7*(n+1)*C(n+3,7).
* [A027793](http://oeis.org/A027793) ([L15 program](A027793.asm)): a(n) = 28*(n+1)*C(n+3,8)/3.
* [A027795](http://oeis.org/A027795) ([L14 program](A027795.asm)): a(n) = 15*(n+1)*C(n+3,10).
* [A027799](http://oeis.org/A027799) ([L21 program](A027799.asm)): a(n) = 91*(n+1)*C(n+3,14)/3.
* [A027800](http://oeis.org/A027800) ([L09 program](A027800.asm)): a(n) = (n+1)*binomial(n+4, 4).
* [A027801](http://oeis.org/A027801) ([L12 program](A027801.asm)): a(n) = 5*(n+1)*binomial(n+4,5)/2.
* [A027802](http://oeis.org/A027802) ([L13 program](A027802.asm)): 5*(n+1)*C(n+4,6).
* [A027803](http://oeis.org/A027803) ([L18 program](A027803.asm)): a(n) = 35*(n+1)*binomial(n+4, 7)/4.
* [A027804](http://oeis.org/A027804) ([L22 program](A027804.asm)): a(n) = 14*(n+1)*C(n+4,8).
* [A027806](http://oeis.org/A027806) ([L12 program](A027806.asm)): 30*(n+1)*C(n+4,10).
* [A027810](http://oeis.org/A027810) ([L24 program](A027810.asm)): a(n) = (n+1)*binomial(n+5, 5).
* [A027811](http://oeis.org/A027811) ([L11 program](A027811.asm)): a(n) = 3*(n+1)*C(n+5,6).
* [A027812](http://oeis.org/A027812) ([L17 program](A027812.asm)): a(n) = 7*(n+1)*C(n+5,7).
* [A027813](http://oeis.org/A027813) ([L13 program](A027813.asm)): a(n) = 14*(n+1)*C(n+5,8).
* [A027814](http://oeis.org/A027814) ([L15 program](A027814.asm)): 126*(n+1)*C(n+5,9)/5.
* [A027815](http://oeis.org/A027815) ([L19 program](A027815.asm)): a(n) = 42*(n+1) * binomial(n+5,10).
* [A027818](http://oeis.org/A027818) ([L13 program](A027818.asm)): a(n) = (n+1)*binomial(n+6,6).
* [A027819](http://oeis.org/A027819) ([L11 program](A027819.asm)): 7*(n+1)*C(n+6,7)/2.
* [A027820](http://oeis.org/A027820) ([L17 program](A027820.asm)): a(n) = 28*(n+1)*C(n+6,8)/3.
* [A027821](http://oeis.org/A027821) ([L105 program](A027821.asm)): 21*(n+1)*C(n+6,9).
* [A027822](http://oeis.org/A027822) ([L12 program](A027822.asm)): 42*(n+1)*C(n+6,10).
...
* [A027928](http://oeis.org/A027928) ([L103 program](A027928.asm)): a(n) = T(n, 2*n-5), T given by A027926.
...
* [A030191](http://oeis.org/A030191) ([L16 program](A030191.asm)): Scaled Chebyshev U-polynomial evaluated at sqrt(5)/2.
...
* [A031313](http://oeis.org/A031313) ([L14 program](A031313.asm)): Position of n-th 0 in A031312.
...
* [A032607](http://oeis.org/A032607) ([L57 program](A032607.asm)): Concatenation of n and n + 2 or {n,n+2}.
* [A032608](http://oeis.org/A032608) ([L51 program](A032608.asm)): Concatenation of n and n + 3.
* [A032609](http://oeis.org/A032609) ([L47 program](A032609.asm)): Concatenation of n and n + 4 or {n,n+4}.
* [A032610](http://oeis.org/A032610) ([L51 program](A032610.asm)): Concatenation of n and n + 5 or {n,n+5}.
* [A032611](http://oeis.org/A032611) ([L56 program](A032611.asm)): Concatenation of n and n + 6 or {n,n+6}.
...
* [A033143](http://oeis.org/A033143) ([L11 program](A033143.asm)): Base-7 digits are, in order, the first n terms of the periodic sequence with initial period 1,0,0.
...
* [A033342](http://oeis.org/A033342) ([L12 program](A033342.asm)): [ 22/n ].
...
* [A033407](http://oeis.org/A033407) ([L09 program](A033407.asm)): [ 87/n ].
...
* [A033876](http://oeis.org/A033876) ([L13 program](A033876.asm)): Expansion of 1/(2*x) * (1/(1-4*x)^(3/2)-1).
...
* [A034793](http://oeis.org/A034793) ([L32 program](A034793.asm)): a(1)=1; thereafter a(n+1) is the least k > a(n) such that k is a square mod a(i) for all  i<= n.
...
* [A035487](http://oeis.org/A035487) ([L27 program](A035487.asm)): Second column of Stolarsky array.
...
* [A036085](http://oeis.org/A036085) ([L14 program](A036085.asm)): Centered cube numbers: (n+1)^7 + n^7.
...
* [A036138](http://oeis.org/A036138) ([L61 program](A036138.asm)): a(n) = 2^n mod 101.
...
* [A036562](http://oeis.org/A036562) ([L21 program](A036562.asm)): a(n) = 4^(n+1) + 3*2^n + 1.
...
* [A036573](http://oeis.org/A036573) ([L05 program](A036573.asm)): Size of maximal triangulation of an n-antiprism with regular polygonal base.
...
* [A036741](http://oeis.org/A036741) ([L05 program](A036741.asm)): Values increase, Roman numerals increase lexicographically.
...
* [A037124](http://oeis.org/A037124) ([L17 program](A037124.asm)): Numbers that contain only one nonzero digit.
...
* [A037213](http://oeis.org/A037213) ([L29 program](A037213.asm)): Expansion of Sum_{n>=0} n*q^(n^2).
...
* [A037227](http://oeis.org/A037227) ([L31 program](A037227.asm)): If n = 2^m*k, k odd, then a(n) = 2*m+1.
...
* [A037239](http://oeis.org/A037239) ([L04 program](A037239.asm)): Numerator of Pi^(2n)/(GAMMA(2n)*(1-2^(-2n))*Zeta(2n)); = 8*(highest power of 2 dividing n).
...
* [A037479](http://oeis.org/A037479) ([L05 program](A037479.asm)): a(n)=Sum{d(i)*10^i: i=0,1,...,m}, where Sum{d(i)*9^i: i=0,1,...,m} is the base 9 representation of n.
...
* [A037483](http://oeis.org/A037483) ([L16 program](A037483.asm)): Base 6 digits are, in order, the first n terms of the periodic sequence with initial period 1,2.
...
* [A037505](http://oeis.org/A037505) ([L14 program](A037505.asm)): Base-4 digits are, in order, the first n terms of the periodic sequence with initial period 1,2,0.
...
* [A037579](http://oeis.org/A037579) ([L11 program](A037579.asm)): Base 7 digits are, in order, the first n terms of the periodic sequence with initial period 1,3.
* [A037583](http://oeis.org/A037583) ([L21 program](A037583.asm)): Base 4 digits are, in order, the first n terms of the periodic sequence with initial period 3,1.
...
* [A037597](http://oeis.org/A037597) ([L07 program](A037597.asm)): Base-4 digits are, in order, the first n terms of the periodic sequence with initial period 1,3,0.
...
* [A037824](http://oeis.org/A037824) ([L09 program](A037824.asm)): Number of i such that d(i)>d(i-1), where Sum{d(i)*9^i: i=0,1,....,m} is base 9 representation of n.
...
* [A037833](http://oeis.org/A037833) ([L21 program](A037833.asm)): Number of i such that d(i)>=d(i-1), where Sum{d(i)*10^i: i=0,1,...,m} is base 10 representation of n.
...
* [A037951](http://oeis.org/A037951) ([L08 program](A037951.asm)): binomial(n,[ (n-3)/2 ]).
* [A037952](http://oeis.org/A037952) ([L05 program](A037952.asm)): a(n) = binomial(n, floor((n-1)/2)).
* [A037953](http://oeis.org/A037953) ([L05 program](A037953.asm)): C(n,[ (n-5)/2 ]).
* [A037954](http://oeis.org/A037954) ([L13 program](A037954.asm)): C(n,[ (n-7)/2 ]).
* [A037955](http://oeis.org/A037955) ([L13 program](A037955.asm)): a(n) = binomial(n, floor(n/2)-1).
* [A037956](http://oeis.org/A037956) ([L05 program](A037956.asm)): C(n,[ (n-4)/2 ]).
* [A037957](http://oeis.org/A037957) ([L07 program](A037957.asm)): C(n,[ (n-6)/2 ]).
* [A037958](http://oeis.org/A037958) ([L07 program](A037958.asm)): a(n) = binomial(n, floor((n-8)/2)).
* [A037965](http://oeis.org/A037965) ([L16 program](A037965.asm)): a(n) = n*binomial(2*n-2, n-1).
* [A038123](http://oeis.org/A038123) ([L05 program](A038123.asm)): Beatty sequence for Feigenbaum's constant.
...
* [A038152](http://oeis.org/A038152) ([L04 program](A038152.asm)): Beatty sequence for e^Pi.
* [A038163](http://oeis.org/A038163) ([L29 program](A038163.asm)): G.f.: 1/((1-x)*(1-x^2))^3.
* [A038164](http://oeis.org/A038164) ([L37 program](A038164.asm)): G.f.: 1/((1-x)*(1-x^2))^4.
* [A038165](http://oeis.org/A038165) ([L48 program](A038165.asm)): G.f.: 1/((1-x)*(1-x^2))^5.
...
* [A038391](http://oeis.org/A038391) ([L18 program](A038391.asm)): Expansion of (x^3+2*x+1) / ((x-1)^4*(x^2+x+1)^2).
...
* [A038502](http://oeis.org/A038502) ([L13 program](A038502.asm)): Remove 3's from n.
* [A038573](http://oeis.org/A038573) ([L13 program](A038573.asm)): a(n) = 2^A000120(n) - 1.
...
* [A038712](http://oeis.org/A038712) ([L06 program](A038712.asm)): Let k be the exponent of highest power of 2 dividing n (A007814); a(n) = 2^(k+1)-1.
...
* [A038725](http://oeis.org/A038725) ([L11 program](A038725.asm)): a(n) = 6*a(n-1) - a(n-2), n >= 2, a(0)=1, a(1)=2.
...
* [A038846](http://oeis.org/A038846) ([L18 program](A038846.asm)): 4-fold convolution of A000302 (powers of 4); expansion of 1/(1-4*x)^4.
...
* [A039966](http://oeis.org/A039966) ([L11 program](A039966.asm)): a(0) = 1; thereafter a(3n+2) = 0, a(3n) = a(3n+1) = a(n).
...
* [A040033](http://oeis.org/A040033) ([L08 program](A040033.asm)): Continued fraction for sqrt(40).
...
* [A040059](http://oeis.org/A040059) ([L08 program](A040059.asm)): Continued fraction for sqrt(68).
* [A040063](http://oeis.org/A040063) ([L10 program](A040063.asm)): Continued fraction for sqrt(72).
...
* [A040090](http://oeis.org/A040090) ([L03 program](A040090.asm)): Continued fraction for sqrt(101).
* [A040091](http://oeis.org/A040091) ([L05 program](A040091.asm)): Continued fraction for sqrt(102).
* [A040093](http://oeis.org/A040093) ([L08 program](A040093.asm)): Continued fraction for sqrt(104).
...
* [A040110](http://oeis.org/A040110) ([L03 program](A040110.asm)): Continued fraction for sqrt(122).
...
* [A040139](http://oeis.org/A040139) ([L10 program](A040139.asm)): Continued fraction for sqrt(152).
...
* [A040156](http://oeis.org/A040156) ([L03 program](A040156.asm)): Continued fraction for sqrt(170).
* [A040157](http://oeis.org/A040157) ([L05 program](A040157.asm)): Continued fraction for sqrt(171).
* [A040166](http://oeis.org/A040166) ([L41 program](A040166.asm)): Continued fraction for sqrt(180).
...
* [A040185](http://oeis.org/A040185) ([L08 program](A040185.asm)): Continued fraction for sqrt(200).
...
* [A040200](http://oeis.org/A040200) ([L21 program](A040200.asm)): Continued fraction for sqrt(215).
* [A040209](http://oeis.org/A040209) ([L18 program](A040209.asm)): Continued fraction for sqrt(224).
* [A040210](http://oeis.org/A040210) ([L03 program](A040210.asm)): Continued fraction for sqrt(226).
* [A040211](http://oeis.org/A040211) ([L05 program](A040211.asm)): Continued fraction for sqrt(227).
* [A040212](http://oeis.org/A040212) ([L08 program](A040212.asm)): Continued fraction for sqrt(228).
...
* [A040243](http://oeis.org/A040243) ([L08 program](A040243.asm)): Continued fraction for sqrt(260).
* [A040247](http://oeis.org/A040247) ([L08 program](A040247.asm)): Continued fraction for sqrt(264).
...
* [A040272](http://oeis.org/A040272) ([L03 program](A040272.asm)): Continued fraction for sqrt(290).
...
* [A040306](http://oeis.org/A040306) ([L03 program](A040306.asm)): Continued fraction for sqrt(325).
* [A040307](http://oeis.org/A040307) ([L05 program](A040307.asm)): Continued fraction for sqrt(326).
* [A040308](http://oeis.org/A040308) ([L08 program](A040308.asm)): Continued fraction for sqrt(327).
* [A040309](http://oeis.org/A040309) ([L08 program](A040309.asm)): Continued fraction for sqrt(328).
...
* [A040316](http://oeis.org/A040316) ([L31 program](A040316.asm)): Continued fraction for sqrt(335).
...
* [A040329](http://oeis.org/A040329) ([L14 program](A040329.asm)): Continued fraction for sqrt(348).
* [A040341](http://oeis.org/A040341) ([L40 program](A040341.asm)): Continued fraction for sqrt(360).
* [A040342](http://oeis.org/A040342) ([L03 program](A040342.asm)): Continued fraction for sqrt(362).
* [A040343](http://oeis.org/A040343) ([L05 program](A040343.asm)): Continued fraction for sqrt(363).
* [A040350](http://oeis.org/A040350) ([L16 program](A040350.asm)): Continued fraction for sqrt(370).
* [A040357](http://oeis.org/A040357) ([L35 program](A040357.asm)): Continued fraction for sqrt(377).
* [A040360](http://oeis.org/A040360) ([L14 program](A040360.asm)): Continued fraction for sqrt(380).
* [A040379](http://oeis.org/A040379) ([L14 program](A040379.asm)): Continued fraction for sqrt(399).
* [A040380](http://oeis.org/A040380) ([L03 program](A040380.asm)): Continued fraction for sqrt(401).
* [A040381](http://oeis.org/A040381) ([L05 program](A040381.asm)): Continued fraction for sqrt(402).
* [A040383](http://oeis.org/A040383) ([L08 program](A040383.asm)): Continued fraction for sqrt(404).
* [A040384](http://oeis.org/A040384) ([L13 program](A040384.asm)): Continued fraction for sqrt(405).
* [A040387](http://oeis.org/A040387) ([L10 program](A040387.asm)): Continued fraction for sqrt(408).
* [A040389](http://oeis.org/A040389) ([L11 program](A040389.asm)): Continued fraction for sqrt(410).
* [A040399](http://oeis.org/A040399) ([L41 program](A040399.asm)): Continued fraction for sqrt(420).
* [A040419](http://oeis.org/A040419) ([L43 program](A040419.asm)): Continued fraction for sqrt(440).
* [A040420](http://oeis.org/A040420) ([L03 program](A040420.asm)): Continued fraction for sqrt(442).
* [A040421](http://oeis.org/A040421) ([L05 program](A040421.asm)): Continued fraction for sqrt(443).
* [A040422](http://oeis.org/A040422) ([L08 program](A040422.asm)): Continued fraction for sqrt(444).
...
* [A040440](http://oeis.org/A040440) ([L12 program](A040440.asm)): Continued fraction for sqrt(462).
* [A040462](http://oeis.org/A040462) ([L03 program](A040462.asm)): Continued fraction for sqrt(485).
* [A040463](http://oeis.org/A040463) ([L05 program](A040463.asm)): Continued fraction for sqrt(486).
* [A040465](http://oeis.org/A040465) ([L08 program](A040465.asm)): Continued fraction for sqrt(488).
* [A040472](http://oeis.org/A040472) ([L31 program](A040472.asm)): Continued fraction for sqrt(495).
* [A040483](http://oeis.org/A040483) ([L17 program](A040483.asm)): Continued fraction for sqrt(506).
* [A040505](http://oeis.org/A040505) ([L18 program](A040505.asm)): Continued fraction for sqrt(528).
* [A040506](http://oeis.org/A040506) ([L03 program](A040506.asm)): Continued fraction for sqrt(530).
* [A040507](http://oeis.org/A040507) ([L05 program](A040507.asm)): Continued fraction for sqrt(531).
* [A040533](http://oeis.org/A040533) ([L26 program](A040533.asm)): Continued fraction for sqrt(557).
* [A040551](http://oeis.org/A040551) ([L17 program](A040551.asm)): Continued fraction for sqrt(575).
* [A040552](http://oeis.org/A040552) ([L03 program](A040552.asm)): Continued fraction for sqrt(577).
* [A040553](http://oeis.org/A040553) ([L05 program](A040553.asm)): Continued fraction for sqrt(578).
* [A040554](http://oeis.org/A040554) ([L08 program](A040554.asm)): Continued fraction for sqrt(579).
* [A040555](http://oeis.org/A040555) ([L08 program](A040555.asm)): Continued fraction for sqrt(580).
* [A040557](http://oeis.org/A040557) ([L14 program](A040557.asm)): Continued fraction for sqrt(582).
* [A040559](http://oeis.org/A040559) ([L10 program](A040559.asm)): Continued fraction for sqrt(584).
...
* [A040600](http://oeis.org/A040600) ([L03 program](A040600.asm)): Continued fraction for sqrt(626).
...
* [A040620](http://oeis.org/A040620) ([L40 program](A040620.asm)): Continued fraction for sqrt(646).
* [A040624](http://oeis.org/A040624) ([L30 program](A040624.asm)): Continued fraction for sqrt(650).
* [A040650](http://oeis.org/A040650) ([L03 program](A040650.asm)): Continued fraction for sqrt(677).
* [A040651](http://oeis.org/A040651) ([L05 program](A040651.asm)): Continued fraction for sqrt(678).
* [A040653](http://oeis.org/A040653) ([L08 program](A040653.asm)): Continued fraction for sqrt(680).
* [A040662](http://oeis.org/A040662) ([L15 program](A040662.asm)): Continued fraction for sqrt(689).
* [A040670](http://oeis.org/A040670) ([L34 program](A040670.asm)): Continued fraction for sqrt(697).
* [A040675](http://oeis.org/A040675) ([L32 program](A040675.asm)): Continued fraction for sqrt(702).
* [A040701](http://oeis.org/A040701) ([L28 program](A040701.asm)): Continued fraction for sqrt(728).
* [A040702](http://oeis.org/A040702) ([L03 program](A040702.asm)): Continued fraction for sqrt(730).
* [A040703](http://oeis.org/A040703) ([L05 program](A040703.asm)): Continued fraction for sqrt(731).
* [A040704](http://oeis.org/A040704) ([L08 program](A040704.asm)): Continued fraction for sqrt(732).
...
* [A040755](http://oeis.org/A040755) ([L101 program](A040755.asm)): Continued fraction for sqrt(783).
* [A040756](http://oeis.org/A040756) ([L03 program](A040756.asm)): Continued fraction for sqrt(785).
* [A040757](http://oeis.org/A040757) ([L05 program](A040757.asm)): Continued fraction for sqrt(786).
* [A040759](http://oeis.org/A040759) ([L08 program](A040759.asm)): Continued fraction for sqrt(788).
* [A040762](http://oeis.org/A040762) ([L10 program](A040762.asm)): Continued fraction for sqrt(791).
* [A040763](http://oeis.org/A040763) ([L10 program](A040763.asm)): Continued fraction for sqrt(792).
...
* [A040789](http://oeis.org/A040789) ([L25 program](A040789.asm)): Continued fraction for sqrt(818).
* [A040811](http://oeis.org/A040811) ([L12 program](A040811.asm)): Continued fraction for sqrt(840).
* [A040812](http://oeis.org/A040812) ([L03 program](A040812.asm)): Continued fraction for sqrt(842).
* [A040813](http://oeis.org/A040813) ([L05 program](A040813.asm)): Continued fraction for sqrt(843).
* [A040850](http://oeis.org/A040850) ([L35 program](A040850.asm)): Continued fraction for sqrt(880).
* [A040869](http://oeis.org/A040869) ([L103 program](A040869.asm)): Continued fraction for sqrt(899).
* [A040870](http://oeis.org/A040870) ([L03 program](A040870.asm)): Continued fraction for sqrt(901).
...
* [A040873](http://oeis.org/A040873) ([L08 program](A040873.asm)): Continued fraction for sqrt(904).
...
* [A040930](http://oeis.org/A040930) ([L03 program](A040930.asm)): Continued fraction for sqrt(962).
* [A040931](http://oeis.org/A040931) ([L05 program](A040931.asm)): Continued fraction for sqrt(963).
* [A040960](http://oeis.org/A040960) ([L32 program](A040960.asm)): Continued fraction for sqrt(992).
* [A040977](http://oeis.org/A040977) ([L19 program](A040977.asm)): a(n) = binomial(n+5,5)*(n+3)/3.
...
* [A043540](http://oeis.org/A043540) ([L16 program](A043540.asm)): Number of distinct base 13 digits of n.
...
* [A043628](http://oeis.org/A043628) ([L05 program](A043628.asm)): Numbers n such that base 8 representation has exactly 6 runs.
* [A043629](http://oeis.org/A043629) ([L25 program](A043629.asm)): Numbers n such that base 8 representation has exactly 7 runs.
* [A043630](http://oeis.org/A043630) ([L05 program](A043630.asm)): Numbers n such that base 8 representation has exactly 8 runs.
...
* [A044382](http://oeis.org/A044382) ([L39 program](A044382.asm)): Numbers n such that string 5,0 occurs in the base 10 representation of n but not of n-1.
...
* [A044641](http://oeis.org/A044641) ([L09 program](A044641.asm)): Numbers n such that string 1,0 occurs in the base 9 representation of n but not of n+1.
...
* [A044909](http://oeis.org/A044909) ([L45 program](A044909.asm)): Numbers n such that base 8 run lengths alternate: odd, even, odd,...
* [A044910](http://oeis.org/A044910) ([L56 program](A044910.asm)): Numbers n such that base 9 run lengths alternate: odd, even, odd,...
* [A044911](http://oeis.org/A044911) ([L51 program](A044911.asm)): Numbers n such that base 10 run lengths alternate: odd, even, odd,...
...
* [A045721](http://oeis.org/A045721) ([L06 program](A045721.asm)): a(n) = binomial(3*n+1,n).
...
* [A045806](http://oeis.org/A045806) ([L14 program](A045806.asm)): 6-ish numbers (end in 23, 27, 61, 89).
...
* [A045943](http://oeis.org/A045943) ([L04 program](A045943.asm)): Triangular matchstick numbers: a(n) = 3*n*(n+1)/2.
...
* [A046127](http://oeis.org/A046127) ([L05 program](A046127.asm)): Maximal number of regions into which space can be divided by n spheres.
...
* [A046163](http://oeis.org/A046163) ([L14 program](A046163.asm)): Reduced denominators of (n-1)^2/(n^2+n+1). Arises in Routh's theorem.
...
* [A046821](http://oeis.org/A046821) ([L20 program](A046821.asm)): Number of 1's in binary expansion of 5n+1.
* [A046916](http://oeis.org/A046916) ([L10 program](A046916.asm)): a(n) = n*2^n + 2*n^2 + 1.
* [A046998](http://oeis.org/A046998) ([L47 program](A046998.asm)): a(n) = 1 - (7/6)*n + (2/3)*n^3 + (1/2)*n^4.
* [A047171](http://oeis.org/A047171) ([L07 program](A047171.asm)): Number of nonempty subsets of {1,2,...,n} in which exactly 1/2 of the elements are <= (n-1)/2.
* [A047182](http://oeis.org/A047182) ([L09 program](A047182.asm)): Number of nonempty subsets of {1,2,...,n} in which exactly 1/2 of the elements are <= (n-2)/2.
* [A047193](http://oeis.org/A047193) ([L10 program](A047193.asm)): Number of nonempty subsets of {1,2,...,n} in which exactly 1/2 of the elements are <= n/3.
...
* [A047236](http://oeis.org/A047236) ([L06 program](A047236.asm)): Numbers that are congruent to {1, 2, 4} mod 6.
...
* [A047254](http://oeis.org/A047254) ([L06 program](A047254.asm)): Numbers that are congruent to {2, 3, 5} mod 6.
...
* [A047331](http://oeis.org/A047331) ([L07 program](A047331.asm)): Numbers that are congruent to {2, 3, 5, 6} mod 7.
...
* [A047337](http://oeis.org/A047337) ([L05 program](A047337.asm)): Numbers that are congruent to {0, 1, 2, 3, 4} mod 7.
...
* [A047369](http://oeis.org/A047369) ([L06 program](A047369.asm)): Numbers that are congruent to {1, 2, 3, 4, 5} mod 7.
...
* [A047378](http://oeis.org/A047378) ([L16 program](A047378.asm)): Numbers that are congruent to {2, 4, 5} mod 7.
* [A047379](http://oeis.org/A047379) ([L04 program](A047379.asm)): Numbers that are congruent to {0, 2, 4, 5} mod 7.
* [A047380](http://oeis.org/A047380) ([L05 program](A047380.asm)): Numbers that are congruent to {1, 2, 4, 5} mod 7.
...
* [A047403](http://oeis.org/A047403) ([L09 program](A047403.asm)): Numbers that are congruent to {0, 2, 3, 6} mod 8.
...
* [A047408](http://oeis.org/A047408) ([L04 program](A047408.asm)): Numbers that are congruent to {1, 4, 6} mod 8.
...
* [A047488](http://oeis.org/A047488) ([L05 program](A047488.asm)): Numbers that are congruent to {0, 2, 3, 5, 7} mod 8.
...
* [A047524](http://oeis.org/A047524) ([L07 program](A047524.asm)): Numbers that are congruent to {2, 7} mod 8.
...
* [A047565](http://oeis.org/A047565) ([L04 program](A047565.asm)): Numbers that are congruent to {0, 1, 3, 4, 5, 6, 7} mod 8.
...
* [A047673](http://oeis.org/A047673) ([L09 program](A047673.asm)): Row 4 of square array defined in A047671.
...
* [A047789](http://oeis.org/A047789) ([L17 program](A047789.asm)): Denominators of Glaisher's I-numbers.
...
* [A047866](http://oeis.org/A047866) ([L20 program](A047866.asm)): a(n) = ceiling(n*(n+1)*(n+2)/8).
...
* [A047925](http://oeis.org/A047925) ([L47 program](A047925.asm)): 3rd column of array in A038150.
...
* [A048005](http://oeis.org/A048005) ([L05 program](A048005.asm)): Number of nonempty subsets of {1,2,...,n} in which exactly 1/2 of the elements are <= (n-1)/3.
* [A048027](http://oeis.org/A048027) ([L13 program](A048027.asm)): Number of nonempty subsets of {1,2,...,n} in which exactly 1/2 of the elements are <= (n-3)/3.
* [A048038](http://oeis.org/A048038) ([L09 program](A048038.asm)): Number of nonempty subsets of {1,2,...,n} in which exactly 1/2 of the elements are <= (n+1)/3.
* [A048058](http://oeis.org/A048058) ([L04 program](A048058.asm)): a(n) = n^2 + n + 11.
* [A048060](http://oeis.org/A048060) ([L10 program](A048060.asm)): Number of nonempty subsets of {1,2,...,n} in which exactly 1/2 of the elements are <= (n-4)/2.
* [A048071](http://oeis.org/A048071) ([L16 program](A048071.asm)): Number of nonempty subsets of {1,2,...,n} in which exactly 1/2 of the elements are <= (n+2)/3.
* [A048082](http://oeis.org/A048082) ([L101 program](A048082.asm)): Number of nonempty subsets of {1,2,...,n} in which exactly 1/2 of the elements are <= (n+3)/3.
...
* [A048478](http://oeis.org/A048478) ([L06 program](A048478.asm)): a(n) = T(6,n), array T given by A048472.
* [A048479](http://oeis.org/A048479) ([L06 program](A048479.asm)): a(n) = T(7,n), array T given by A048472.
* [A048480](http://oeis.org/A048480) ([L06 program](A048480.asm)): a(n) = T(8,n), array T given by A048472.
...
* [A048491](http://oeis.org/A048491) ([L04 program](A048491.asm)): a(n) = T(8,n), array T given by A048483.
...
* [A048701](http://oeis.org/A048701) ([L18 program](A048701.asm)): List of binary palindromes of even length (written in base 10).
...
* [A048765](http://oeis.org/A048765) ([L11 program](A048765.asm)): Smallest factorial >= n.
...
* [A048775](http://oeis.org/A048775) ([L09 program](A048775.asm)): Number of (partially defined) monotone maps from intervals of 1..n to 1..n.
...
* [A049008](http://oeis.org/A049008) ([L44 program](A049008.asm)): Greatest possible number of right angles that can occur as interior angles in a planar n-gon.
...
* [A049452](http://oeis.org/A049452) ([L04 program](A049452.asm)): Pentagonal numbers with even index.
...
* [A049684](http://oeis.org/A049684) ([L12 program](A049684.asm)): a(n) = Fibonacci(2n)^2.
...
* [A050185](http://oeis.org/A050185) ([L20 program](A050185.asm)): T(2n+7,n), array T as in A051168; a count of Lyndon words.
...
* [A051033](http://oeis.org/A051033) ([L14 program](A051033.asm)): a(n) = binomial(n, floor(n/3)).
* [A051036](http://oeis.org/A051036) ([L12 program](A051036.asm)): a(n) = binomial(n, floor(n/4)).
* [A051039](http://oeis.org/A051039) ([L11 program](A051039.asm)): 4-Stohr sequence.
* [A051040](http://oeis.org/A051040) ([L23 program](A051040.asm)): 5-Stohr sequence.
...
* [A051052](http://oeis.org/A051052) ([L05 program](A051052.asm)): a(n) = binomial(n, floor(n/5)).
* [A051053](http://oeis.org/A051053) ([L05 program](A051053.asm)): a(n) = binomial(n, floor(n/6)).
...
* [A051064](http://oeis.org/A051064) ([L34 program](A051064.asm)): 3^a(n) exactly divides 3n. Or, 3-adic valuation of 3n.
...
* [A051170](http://oeis.org/A051170) ([L07 program](A051170.asm)): T(n,5), array T as in A051168; a count of Lyndon words; aperiodic necklaces with 5 black beads and n-5 white beads.
* [A051172](http://oeis.org/A051172) ([L10 program](A051172.asm)): T(n,7), array T as in A051168; a count of Lyndon words; aperiodic necklaces with 7 black beads and n-7 white beads.
* [A051176](http://oeis.org/A051176) ([L03 program](A051176.asm)): If n mod 3 = 0 then n/3 else n.
* [A051192](http://oeis.org/A051192) ([L09 program](A051192.asm)): T(n,7), array T as in A050186; a count of aperiodic binary words.
...
* [A051515](http://oeis.org/A051515) ([L12 program](A051515.asm)): (Terms in A014738)/4.
* [A051596](http://oeis.org/A051596) ([L17 program](A051596.asm)): Numerical values or Gematriahs of Hebrew letters {aleph, bet, ..., tet}.
...
* [A051678](http://oeis.org/A051678) ([L26 program](A051678.asm)): Square-pyramid-tree numbers: a(n) = sum(b(m),m=1..n), b(m) = 1^2, 1^2,2^2, 1^2,2^2,3^2,.. = (A002260)^2.
* [A051682](http://oeis.org/A051682) ([L06 program](A051682.asm)): 11-gonal (or hendecagonal) numbers: a(n) = n*(9*n-7)/2.
* [A051683](http://oeis.org/A051683) ([L19 program](A051683.asm)): Triangle read by rows: T(n,k) = n!*k.
...
* [A051745](http://oeis.org/A051745) ([L09 program](A051745.asm)): a(n) = n*(n^4 + 10*n^3 + 35*n^2 + 50*n + 144)/120.
* [A051746](http://oeis.org/A051746) ([L25 program](A051746.asm)): a(n) = n(n+7)(n+1)(n^2+2n+12)/120.
...
* [A051885](http://oeis.org/A051885) ([L24 program](A051885.asm)): Smallest number whose sum of digits is n.
* [A051890](http://oeis.org/A051890) ([L04 program](A051890.asm)): a(n) = 2*(n^2 - n + 1).
* [A051895](http://oeis.org/A051895) ([L09 program](A051895.asm)): Partial sums of second pentagonal numbers with even index (A049453).
* [A051920](http://oeis.org/A051920) ([L06 program](A051920.asm)): a(n) = binomial(n, floor(n/2)) + 1.
* [A051923](http://oeis.org/A051923) ([L11 program](A051923.asm)): Partial sums of A051836.
* [A051924](http://oeis.org/A051924) ([L38 program](A051924.asm)): a(n) = binomial(2*n,n) - binomial(2*n-2,n-1); or (3n-2)*C(n-1), where C = Catalan numbers (A000108).
* [A051925](http://oeis.org/A051925) ([L06 program](A051925.asm)): a(n) = n*(2*n+5)*(n-1)/6.
* [A051936](http://oeis.org/A051936) ([L04 program](A051936.asm)): Truncated triangular numbers: a(n) = n*(n+1)/2 - 9.
* [A051937](http://oeis.org/A051937) ([L09 program](A051937.asm)): Truncated triangular pyramid numbers: a(n) = Sum_{k=4..n} k*(k+1)/2-9.
* [A051938](http://oeis.org/A051938) ([L04 program](A051938.asm)): Truncated triangular numbers: a(n) = n*(n+1)/2 - 18.
* [A051939](http://oeis.org/A051939) ([L10 program](A051939.asm)): Truncated triangular pyramid numbers: a(n) = Sum_{k=6..n}(k*(k+1)/2 - 18).
* [A051940](http://oeis.org/A051940) ([L04 program](A051940.asm)): Truncated triangular numbers: n*(n+1)/2 - 3*t*(t+1)/2 with t=4.
...
* [A051947](http://oeis.org/A051947) ([L14 program](A051947.asm)): Partial sums of A034263.
...
* [A052181](http://oeis.org/A052181) ([L10 program](A052181.asm)): Partial sums of A050483.
...
* [A052747](http://oeis.org/A052747) ([L73 program](A052747.asm)): a(0) = a(1) = a(2) = 0; a(n) = n!/(n-2) for n > 2.
* [A052749](http://oeis.org/A052749) ([L07 program](A052749.asm)): 2n*S2(n-1,2).
* [A052762](http://oeis.org/A052762) ([L03 program](A052762.asm)): Products of 4 consecutive integers: a(n) = n*(n-1)*(n-2)*(n-3).
* [A052768](http://oeis.org/A052768) ([L08 program](A052768.asm)): A simple grammar.
* [A052771](http://oeis.org/A052771) ([L08 program](A052771.asm)): E.g.f.: x^3*exp(x)^2.
* [A052780](http://oeis.org/A052780) ([L14 program](A052780.asm)): Expansion of e.g.f. x^2*exp(4*x).
* [A052787](http://oeis.org/A052787) ([L03 program](A052787.asm)): A simple grammar. Product of 5 consecutive integers.
* [A052794](http://oeis.org/A052794) ([L08 program](A052794.asm)): E.g.f.: -x^5*log(1-x).
* [A052796](http://oeis.org/A052796) ([L10 program](A052796.asm)): E.g.f.: x^4*exp(x)^2.
* [A052800](http://oeis.org/A052800) ([L06 program](A052800.asm)): E.g.f.: x^5*exp(x)-x^5.
...
* [A052905](http://oeis.org/A052905) ([L04 program](A052905.asm)): a(n) = (n^2 + 7*n + 2)/2.
...
* [A052975](http://oeis.org/A052975) ([L23 program](A052975.asm)): Expansion of (1-2*x)*(1-x)/(1-5*x+6*x^2-x^3).
...
* [A053127](http://oeis.org/A053127) ([L10 program](A053127.asm)): Binomial coefficients C(2*n-4,5).
* [A053128](http://oeis.org/A053128) ([L06 program](A053128.asm)): Binomial coefficients C(2*n-5,6).
* [A053129](http://oeis.org/A053129) ([L06 program](A053129.asm)): Binomial coefficients C(2*n-6,7).
* [A053130](http://oeis.org/A053130) ([L06 program](A053130.asm)): Binomial coefficients C(2*n-7,8).
* [A053131](http://oeis.org/A053131) ([L08 program](A053131.asm)): Binomial coefficients C(2*n-8,9).
* [A053132](http://oeis.org/A053132) ([L09 program](A053132.asm)): One half of binomial coefficients C(2*n-4,5).
* [A053133](http://oeis.org/A053133) ([L08 program](A053133.asm)): One half of binomial coefficients binomial(2*n-8,9).
* [A053134](http://oeis.org/A053134) ([L04 program](A053134.asm)): Binomial coefficients C(2*n+4,4).
* [A053135](http://oeis.org/A053135) ([L05 program](A053135.asm)): Binomial coefficients C(2*n+6,6).
* [A053136](http://oeis.org/A053136) ([L07 program](A053136.asm)): Binomial coefficients C(2*n+7,7).
* [A053137](http://oeis.org/A053137) ([L04 program](A053137.asm)): Binomial coefficients C(2*n+8,8).
* [A053138](http://oeis.org/A053138) ([L04 program](A053138.asm)): Binomial coefficients C(2*n+9,9).
...
* [A053156](http://oeis.org/A053156) ([L16 program](A053156.asm)): Number of 2-element intersecting families (with not necessary distinct sets) whose union is an n-element set.
...
* [A053208](http://oeis.org/A053208) ([L05 program](A053208.asm)): Row sums of A053207.
...
* [A053310](http://oeis.org/A053310) ([L16 program](A053310.asm)): a(n) = (n+3)*binomial(n+8, 8)/3.
* [A053311](http://oeis.org/A053311) ([L08 program](A053311.asm)): Partial sums of A000285.
* [A053347](http://oeis.org/A053347) ([L17 program](A053347.asm)): a(n) = binomial(n+7, 7)*(n+4)/4.
...
* [A053501](http://oeis.org/A053501) ([L06 program](A053501.asm)): Number of degree-n permutations of order dividing 11.
...
* [A053618](http://oeis.org/A053618) ([L09 program](A053618.asm)): a(n) = ceiling(binomial(n,4)/n).
* [A053625](http://oeis.org/A053625) ([L03 program](A053625.asm)): Product of 6 consecutive integers.
* [A053637](http://oeis.org/A053637) ([L07 program](A053637.asm)): a(n) = ceiling(2^(n-1)/n).
* [A053638](http://oeis.org/A053638) ([L16 program](A053638.asm)): a(n) = ceiling(2^n/n).
* [A053639](http://oeis.org/A053639) ([L17 program](A053639.asm)): a(n) = ceiling(2^(n+1)/n).
* [A053643](http://oeis.org/A053643) ([L09 program](A053643.asm)): a(n) = ceiling(binomial(n,6)/n).
...
* [A053731](http://oeis.org/A053731) ([L09 program](A053731.asm)): a(n) = ceiling(binomial(n,8)/n).
* [A053733](http://oeis.org/A053733) ([L05 program](A053733.asm)): a(n) = ceiling(binomial(n,9)/n).
...
* [A053796](http://oeis.org/A053796) ([L04 program](A053796.asm)): n^2+n modulo 5.
...
* [A054071](http://oeis.org/A054071) ([L26 program](A054071.asm)): Position of 1 in the permutation of 1,2,...,n obtained by ordering the fractional parts {h*sqrt(2)} for h=1,2,...,n.
...
* [A054113](http://oeis.org/A054113) ([L27 program](A054113.asm)): T(2n,n), array T as in A054110.
...
* [A054147](http://oeis.org/A054147) ([L13 program](A054147.asm)): a(n) = T(2n,n), array T as in A054144.
...
* [A054334](http://oeis.org/A054334) ([L14 program](A054334.asm)): 1/512 of 11th unsigned column of triangle A053120 (T-Chebyshev, rising powers, zeros omitted).
...
* [A054556](http://oeis.org/A054556) ([L05 program](A054556.asm)): a(n) = 4*n^2 - 9*n + 6.
* [A054559](http://oeis.org/A054559) ([L04 program](A054559.asm)): Number of labeled pure 2-complexes on n nodes (0-simplexes) with 5 2-simplexes and 8 1-simplexes.
* [A054563](http://oeis.org/A054563) ([L07 program](A054563.asm)): a(n) = n*(n^2 - 1)*(n + 2)*(n^2 + 4*n + 6)/72.
...
* [A054621](http://oeis.org/A054621) ([L07 program](A054621.asm)): Number of ways to color vertices of a heptagon using <= n colors, allowing only rotations.
* [A054644](http://oeis.org/A054644) ([L08 program](A054644.asm)): Number of labeled pure 2-complexes on n nodes with 3 2-simplexes.
* [A054650](http://oeis.org/A054650) ([L19 program](A054650.asm)): Nearest integer to 2^(n-1)/n.
* [A054776](http://oeis.org/A054776) ([L05 program](A054776.asm)): a(n) = 3*n*(3*n-1)*(3*n-2).
* [A054777](http://oeis.org/A054777) ([L07 program](A054777.asm)): a(n) = 4*n*(4*n-1)*(4*n-2)*(4*n-3).
* [A054778](http://oeis.org/A054778) ([L04 program](A054778.asm)): 5n*(5n-1)*(5n-2)*(5n-3)*(5n-4).
* [A054779](http://oeis.org/A054779) ([L05 program](A054779.asm)): 6n*(6n-1)*(6n-2)*(6n-3)*(6n-4)*(6n-5).
* [A054849](http://oeis.org/A054849) ([L22 program](A054849.asm)): a(n) = 2^(n-5)*binomial(n,5). Number of 5D hypercubes in an n-dimensional hypercube.
...
* [A055341](http://oeis.org/A055341) ([L52 program](A055341.asm)): Number of mobiles (circular rooted trees) with n nodes and 3 leaves.
...
* [A055504](http://oeis.org/A055504) ([L12 program](A055504.asm)): n*(n-1)*(n-2)*(n-3)*(n-4)*(2*n-1)/72.
* [A055523](http://oeis.org/A055523) ([L11 program](A055523.asm)): Longest other leg of a Pythagorean triangle with n as length of a leg.
...
* [A055562](http://oeis.org/A055562) ([L28 program](A055562.asm)): a(n) = least number greater than a(n-1) not the sum of an earlier pair of consecutive terms, a(0) = 2.
...
* [A055610](http://oeis.org/A055610) ([L08 program](A055610.asm)): A companion sequence to A011896.
* [A055642](http://oeis.org/A055642) ([L10 program](A055642.asm)): Number of digits in decimal expansion of n.
...
* [A055846](http://oeis.org/A055846) ([L27 program](A055846.asm)): a(n) = 25*6^(n-2), with a(0)=1 and a(1)=4.
* [A055848](http://oeis.org/A055848) ([L14 program](A055848.asm)): Expansion of (1+5*x)/(1-x)^10.
...
* [A056001](http://oeis.org/A056001) ([L14 program](A056001.asm)): A second-order recursive sequence.
* [A056003](http://oeis.org/A056003) ([L11 program](A056003.asm)): A second-order recursive sequence.
...
* [A056106](http://oeis.org/A056106) ([L06 program](A056106.asm)): Second spoke of a hexagonal spiral.
...
* [A056115](http://oeis.org/A056115) ([L04 program](A056115.asm)): a(n) = n*(n+11)/2.
* [A056119](http://oeis.org/A056119) ([L04 program](A056119.asm)): a(n) = n*(n+13)/2.
* [A056120](http://oeis.org/A056120) ([L14 program](A056120.asm)): a(n) = (3^3)*4^(n-3) with a(0)=1, a(1)=1 and a(2)=7.
* [A056121](http://oeis.org/A056121) ([L04 program](A056121.asm)): a(n) = n*(n + 15)/2.
...
* [A056126](http://oeis.org/A056126) ([L04 program](A056126.asm)): a(n) = n*(n + 17)/2.
...
* [A056309](http://oeis.org/A056309) ([L11 program](A056309.asm)): Number of reversible strings with n beads using exactly two different colors.
...
* [A056488](http://oeis.org/A056488) ([L23 program](A056488.asm)): Number of periodic palindromes using a maximum of six different symbols.
...
* [A056530](http://oeis.org/A056530) ([L07 program](A056530.asm)): Sequence remaining after third round of Flavius Josephus sieve; remove every fourth term of A047241.
...
* [A056791](http://oeis.org/A056791) ([L16 program](A056791.asm)): Weight of binary expansion of n + length of binary expansion of n.
* [A056792](http://oeis.org/A056792) ([L15 program](A056792.asm)): Minimal number of steps to get from 0 to n by (a) adding 1 or (b) multiplying by 2.
...
* [A057049](http://oeis.org/A057049) ([L25 program](A057049.asm)): Let R(i,j) be the rectangle with antidiagonals 1; 2,3; 4,5,6; ...; each k is an R(i(k),j(k)) and A057049(n) = i(n^2).
...
* [A057552](http://oeis.org/A057552) ([L15 program](A057552.asm)): a(n) = Sum_{k=0..n} C(2k+2,k).
...
* [A057788](http://oeis.org/A057788) ([L15 program](A057788.asm)): Expansion of (1+x)/(1-x)^12.
...
* [A058065](http://oeis.org/A058065) ([L39 program](A058065.asm)): Complement of A057843.
...
* [A058319](http://oeis.org/A058319) ([L81 program](A058319.asm)): Coefficients (multiplied by 48) in Alternative Extended Simpson's rule for numerical integration.
...
* [A058919](http://oeis.org/A058919) ([L11 program](A058919.asm)): a(n) = n^4/2 - n^3 + 3n^2/2 - n + 1.
...
* [A059031](http://oeis.org/A059031) ([L10 program](A059031.asm)): Fifth main diagonal of A059026: a(n) = B(n+4,n) = lcm(n+4,n)/(n+4) + lcm(n+4,n)/n - 1 for all n >= 1.
* [A059100](http://oeis.org/A059100) ([L03 program](A059100.asm)): a(n) = n^2 + 2.
* [A059132](http://oeis.org/A059132) ([L31 program](A059132.asm)): A hierarchical sequence (W2{2}c - see A059126).
* [A059133](http://oeis.org/A059133) ([L12 program](A059133.asm)): A hierarchical sequence (S(W2{2}c) - see A059126).
* [A059134](http://oeis.org/A059134) ([L31 program](A059134.asm)): A hierarchical sequence (W2{3}c - see A059126).
* [A059137](http://oeis.org/A059137) ([L31 program](A059137.asm)): A hierarchical sequence (W3{2,2}cc - see A059126).
* [A059139](http://oeis.org/A059139) ([L31 program](A059139.asm)): A hierarchical sequence (W2{2}*c - see A059126).
* [A059141](http://oeis.org/A059141) ([L31 program](A059141.asm)): A hierarchical sequence (W2{3}*c - see A059126).
* [A059144](http://oeis.org/A059144) ([L31 program](A059144.asm)): A hierarchical sequence (W3{2,2}*cc - see A059126).
...
* [A059154](http://oeis.org/A059154) ([L06 program](A059154.asm)): A hierarchical sequence (W'2{3}c - see A059126).
* [A059157](http://oeis.org/A059157) ([L07 program](A059157.asm)): A hierarchical sequence (W'3{2,2}cc - see A059126).
* [A059159](http://oeis.org/A059159) ([L05 program](A059159.asm)): A hierarchical sequence (W'2{2}*c) - see A059126).
* [A059161](http://oeis.org/A059161) ([L05 program](A059161.asm)): A hierarchical sequence (W'2{3}*c - see A059126).
* [A059162](http://oeis.org/A059162) ([L08 program](A059162.asm)): A hierarchical sequence (S(W'2{3}*c) - see A059126).
* [A059164](http://oeis.org/A059164) ([L05 program](A059164.asm)): A hierarchical sequence (W'3{2,2}*cc - see A059126).
...
* [A059173](http://oeis.org/A059173) ([L39 program](A059173.asm)): Maximal number of regions into which 4-space can be divided by n hyper-spheres.
...
* [A059224](http://oeis.org/A059224) ([L23 program](A059224.asm)): a(n) = 2^(n-3)*(n + 3)*(2*n - 3).
...
* [A059329](http://oeis.org/A059329) ([L51 program](A059329.asm)): Number of 3 X 3 matrices, with elements from {0,...,n}, having the property that the middle element of each of the eight 3-element horizontal, vertical and diagonal lines equals the average of the two end elements.
* [A059387](http://oeis.org/A059387) ([L15 program](A059387.asm)): Jordan function J_n(6) (see A059379).
...
* [A059553](http://oeis.org/A059553) ([L14 program](A059553.asm)): Beatty sequence for Gamma(2/3).
...
* [A059568](http://oeis.org/A059568) ([L132 program](A059568.asm)): Beatty sequence for 1 - 1/log(log(2)).
...
* [A059721](http://oeis.org/A059721) ([L09 program](A059721.asm)): Mean of first six positive powers of n, i.e., (n + n^2 + n^3 + n^4 + n^5 + n^6)/6.
...
* [A059839](http://oeis.org/A059839) ([L13 program](A059839.asm)): a(n) = n^8 + n^6 + n^4 + n^2 + 1.
...
* [A059939](http://oeis.org/A059939) ([L04 program](A059939.asm)): a(n) = floor(log_2(n+1) - 1).
* [A059952](http://oeis.org/A059952) ([L27 program](A059952.asm)): Ordering of a deck of 52 cards after an in-shuffle.
...
* [A060008](http://oeis.org/A060008) ([L03 program](A060008.asm)): a(n) = 9*binomial(n,4) = 3n*(n-1)*(n-2)*(n-3)/8.
...
* [A060091](http://oeis.org/A060091) ([L31 program](A060091.asm)): Number of 4-block ordered bicoverings of an unlabeled n-set.
...
* [A060197](http://oeis.org/A060197) ([L17 program](A060197.asm)): Start at n, repeatedly apply pi(x) until reach 0; a(n) = number of steps to reach 0.
* [A060275](http://oeis.org/A060275) ([L09 program](A060275.asm)): At least two unordered triples of positive numbers have sum n and equal products.
...
* [A060446](http://oeis.org/A060446) ([L09 program](A060446.asm)): Number of ways to color vertices of a pentagon using <= n colors, allowing rotations and reflections.
* [A060453](http://oeis.org/A060453) ([L74 program](A060453.asm)): Dot product of the squares and the quarter-squares: a(n) = sum(i=1..n, i^2 * floor(i^2/4)).
...
* [A060469](http://oeis.org/A060469) ([L115 program](A060469.asm)): Smallest positive a(n) such that number of solutions to a(n) = a(j)+a(k) j<k<n is one or less.
...
* [A060494](http://oeis.org/A060494) ([L03 program](A060494.asm)): a(n) = floor(n^4/64).
...
* [A060541](http://oeis.org/A060541) ([L05 program](A060541.asm)): C(4n,4).
* [A060544](http://oeis.org/A060544) ([L05 program](A060544.asm)): Centered 9-gonal (also known as nonagonal or enneagonal) numbers. Every third triangular number, starting with a(1)=1.
* [A060546](http://oeis.org/A060546) ([L04 program](A060546.asm)): a(n) = 2^ceiling(n/2).
...
* [A060557](http://oeis.org/A060557) ([L20 program](A060557.asm)): Row sums of triangle A060556.
...
* [A060584](http://oeis.org/A060584) ([L07 program](A060584.asm)): Compare ultimate and penultimate digits of n base 3, i.e., 0 if n mod 3 = floor(n/3) mod 3, 1 otherwise; also 0 if (n mod 9) is a multiple of 4, 1 otherwise.
...
* [A060589](http://oeis.org/A060589) ([L12 program](A060589.asm)): a(n) = 2*(2^n-1)*3^(n-1).
...
* [A060784](http://oeis.org/A060784) ([L20 program](A060784.asm)): Number of double tangents of order n.
* [A060785](http://oeis.org/A060785) ([L05 program](A060785.asm)): a(n) = 3*(n-2)*(5*n -11).
...
* [A060820](http://oeis.org/A060820) ([L07 program](A060820.asm)): (2*n-1)^2 + (2*n)^2.
...
* [A060834](http://oeis.org/A060834) ([L05 program](A060834.asm)): a(n) = 6*n^2 + 6*n + 31.
* [A060836](http://oeis.org/A060836) ([L04 program](A060836.asm)): Number of permutations of n letters where exactly 5 change position.
...
* [A060885](http://oeis.org/A060885) ([L21 program](A060885.asm)): a(n) = Sum_{j=0..10} n^j.
...
* [A060891](http://oeis.org/A060891) ([L05 program](A060891.asm)): a(n) = n^6 - n^3 + 1.
* [A060892](http://oeis.org/A060892) ([L11 program](A060892.asm)): n^8-n^6+n^4-n^2+1.
...
* [A061003](http://oeis.org/A061003) ([L18 program](A061003.asm)): Nearest integer to n^5/25.
* [A061004](http://oeis.org/A061004) ([L24 program](A061004.asm)): Nearest integer to n^6/36.
* [A061005](http://oeis.org/A061005) ([L24 program](A061005.asm)): (Nearest integer to n^6/36) / 2.
...
* [A061316](http://oeis.org/A061316) ([L08 program](A061316.asm)): a(n) = n*(n+1)*(n^2 + n + 4)/4.
...
* [A061349](http://oeis.org/A061349) ([L35 program](A061349.asm)): Sum of antidiagonals of A060736.
...
* [A061495](http://oeis.org/A061495) ([L16 program](A061495.asm)): a(n) = lcm(3n+1, 3n+2, 3n+3).
...
* [A061506](http://oeis.org/A061506) ([L20 program](A061506.asm)): a(n) = lcm(6n+2, 6n+4, 6n+6).
...
* [A061761](http://oeis.org/A061761) ([L06 program](A061761.asm)): a(n) = 2^n + 2*n - 1.
...
* [A061792](http://oeis.org/A061792) ([L05 program](A061792.asm)): 49*(n*(n+1)/2)+6.
* [A061793](http://oeis.org/A061793) ([L05 program](A061793.asm)): a(n) = 25*n*(n + 1)/2 + 3.
...
* [A062189](http://oeis.org/A062189) ([L13 program](A062189.asm)): a(n) = 2 * 3^(n-2)*n*(1+2*n).
...
* [A062346](http://oeis.org/A062346) ([L05 program](A062346.asm)): Consider 2n tennis players; a(n) is the number of matches needed to let every possible pair play each other.
* [A062383](http://oeis.org/A062383) ([L05 program](A062383.asm)): a(0) = 1: for n>0, a(n) = 2^floor(log_2(n)+1) or a(n) = 2*a(floor(n/2)).
* [A062392](http://oeis.org/A062392) ([L09 program](A062392.asm)): a(n) = n^4 - (n-1)^4 + (n-2)^4 - ... 0^4.
...
* [A062561](http://oeis.org/A062561) ([L09 program](A062561.asm)): a(n) = 3*binomial(2*n, n-1).
...
* [A062722](http://oeis.org/A062722) ([L06 program](A062722.asm)): a(n) = ceiling(n/3)*round(n/4).
...
* [A062741](http://oeis.org/A062741) ([L03 program](A062741.asm)): 3 times pentagonal numbers: 3*n*(3*n-1)/2.
* [A062748](http://oeis.org/A062748) ([L04 program](A062748.asm)): Fourth column (r=3) of FS(3) staircase array A062745.
* [A062749](http://oeis.org/A062749) ([L17 program](A062749.asm)): Sixth column (r=5) of FS(3) staircase array A062745.
* [A062781](http://oeis.org/A062781) ([L03 program](A062781.asm)): Number of arithmetic progressions of four terms and any mean which can be extracted from the set of the first n positive integers.
* [A062783](http://oeis.org/A062783) ([L05 program](A062783.asm)): a(n) = 3*n*(4*n-1).
* [A062786](http://oeis.org/A062786) ([L05 program](A062786.asm)): Centered 10-gonal numbers.
* [A062828](http://oeis.org/A062828) ([L11 program](A062828.asm)): a(n) = gcd(2n, n(n+1)/2).
* [A062938](http://oeis.org/A062938) ([L06 program](A062938.asm)): a(n) = n*(n+1)*(n+2)*(n+3)+1, which equals (n^2 +3*n + 1)^2.
* [A062947](http://oeis.org/A062947) ([L22 program](A062947.asm)): C(n,[n/7]).
* [A062966](http://oeis.org/A062966) ([L28 program](A062966.asm)): a(n) = C(3+n, n) + C(4+n, n) + C(5+n, n) + C(6+n, n).
* [A062988](http://oeis.org/A062988) ([L04 program](A062988.asm)): a(n) = binomial(n+6,5) - 1.
* [A062989](http://oeis.org/A062989) ([L06 program](A062989.asm)): a(n) = C(n+6, 6) - n - 1.
...
* [A063151](http://oeis.org/A063151) ([L04 program](A063151.asm)): Dimension of the space of weight 2n cusp forms for Gamma_0( 83 ).
* [A063152](http://oeis.org/A063152) ([L04 program](A063152.asm)): Dimension of the space of weight 2n cusp forms for Gamma_0( 84 ).
...
* [A063158](http://oeis.org/A063158) ([L04 program](A063158.asm)): Dimension of the space of weight 2n cusp forms for Gamma_0( 90 ).
...
* [A063164](http://oeis.org/A063164) ([L04 program](A063164.asm)): Dimension of the space of weight 2n cusp forms for Gamma_0( 96 ).
...
* [A063235](http://oeis.org/A063235) ([L17 program](A063235.asm)): Dimension of the space of weight 2n cuspidal newforms for Gamma_0( 83 ).
...
* [A063258](http://oeis.org/A063258) ([L04 program](A063258.asm)): a(n) = binomial(n+5,4) - 1.
* [A063267](http://oeis.org/A063267) ([L28 program](A063267.asm)): Eighth column (k=7) of septinomial array A063265.
...
* [A063497](http://oeis.org/A063497) ([L07 program](A063497.asm)): Number of atoms in first n shells of type I hyperfullerene.
...
* [A063823](http://oeis.org/A063823) ([L05 program](A063823.asm)): G.f.: (1-2*x^2-3*x^3)/((1-x^3)*(1-2*x))
...
* [A063916](http://oeis.org/A063916) ([L35 program](A063916.asm)): G.f.: (1 + Sum_{ i >= 0 } 2^i*x^(2^(i+1)-1)) / (1-x)^3.
...
* [A064056](http://oeis.org/A064056) ([L53 program](A064056.asm)): Seventh column of quintinomial coefficients.
...
* [A064200](http://oeis.org/A064200) ([L03 program](A064200.asm)): a(n) = 12*n*(n-1).
...
* [A064322](http://oeis.org/A064322) ([L15 program](A064322.asm)): Triply triangular numbers.
...
* [A064718](http://oeis.org/A064718) ([L06 program](A064718.asm)): A Beatty sequence for 2^i + 2^-i where i = sqrt(-1).
* [A064724](http://oeis.org/A064724) ([L04 program](A064724.asm)): A Beatty sequence for 2^sqrt(2).
...
* [A065330](http://oeis.org/A065330) ([L11 program](A065330.asm)): a(n) = max { k | gcd(n, k) = k and gcd(k, 6) = 1 }.
* [A065331](http://oeis.org/A065331) ([L04 program](A065331.asm)): Largest 3-smooth divisor of n.
* [A065332](http://oeis.org/A065332) ([L12 program](A065332.asm)): 3-smooth numbers in their natural position, gaps filled with 0.
...
* [A065942](http://oeis.org/A065942) ([L10 program](A065942.asm)): Central column of triangle A065941.
* [A065949](http://oeis.org/A065949) ([L04 program](A065949.asm)): Bessel polynomial {y_n}'''(0).
...
* [A066377](http://oeis.org/A066377) ([L38 program](A066377.asm)): Number of numbers m <= n such that floor(sqrt(m)) divides m.
...
* [A066394](http://oeis.org/A066394) ([L28 program](A066394.asm)): Coordination sequence for ReO_3 net with respect to oxygen atom O_1.
...
* [A066492](http://oeis.org/A066492) ([L51 program](A066492.asm)): A056524(n)/11.
...
* [A066796](http://oeis.org/A066796) ([L16 program](A066796.asm)): a(n) = Sum_{i=1..n} binomial(2*i,i).
...
* [A067046](http://oeis.org/A067046) ([L22 program](A067046.asm)): a(n) = lcm(n, n+1, n+2)/6.
...
* [A067411](http://oeis.org/A067411) ([L06 program](A067411.asm)): Third column of triangle A067410 and second column of A067417.
...
* [A067699](http://oeis.org/A067699) ([L27 program](A067699.asm)): Number of comparisons made in a version of the sorting algorithm QuickSort for an array of size n with n identical elements.
...
* [A067761](http://oeis.org/A067761) ([L07 program](A067761.asm)): Positive integers divisible by 5 but not by 7.
...
* [A069072](http://oeis.org/A069072) ([L05 program](A069072.asm)): a(n) = (2n+1)*(2n+2)*(2n+3).
...
* [A069080](http://oeis.org/A069080) ([L13 program](A069080.asm)): a(n) = (2n+1)(2n+2)(2n+6)(2n+7).
* [A069099](http://oeis.org/A069099) ([L05 program](A069099.asm)): Centered heptagonal numbers.
* [A069125](http://oeis.org/A069125) ([L05 program](A069125.asm)): a(n) = (11*n^2 - 11*n + 2)/2.
* [A069126](http://oeis.org/A069126) ([L05 program](A069126.asm)): Centered 13-gonal numbers.
* [A069127](http://oeis.org/A069127) ([L05 program](A069127.asm)): Centered 14-gonal numbers.
* [A069128](http://oeis.org/A069128) ([L05 program](A069128.asm)): Centered 15-gonal numbers: a(n) = (15*n^2 - 15*n + 2)/2.
* [A069129](http://oeis.org/A069129) ([L05 program](A069129.asm)): Centered 16-gonal numbers.
* [A069130](http://oeis.org/A069130) ([L05 program](A069130.asm)): Centered 17-gonal numbers: (17*n^2 - 17*n + 2)/2.
* [A069131](http://oeis.org/A069131) ([L05 program](A069131.asm)): Centered 18-gonal numbers.
* [A069132](http://oeis.org/A069132) ([L05 program](A069132.asm)): Centered 19-gonal numbers.
* [A069133](http://oeis.org/A069133) ([L05 program](A069133.asm)): Centered 20-gonal (or icosagonal) numbers.
* [A069140](http://oeis.org/A069140) ([L05 program](A069140.asm)): a(n) = (4n-1)*4n*(4n+1).
* [A069173](http://oeis.org/A069173) ([L05 program](A069173.asm)): Centered 22-gonal numbers.
* [A069174](http://oeis.org/A069174) ([L05 program](A069174.asm)): Centered 23-gonal numbers.
* [A069178](http://oeis.org/A069178) ([L05 program](A069178.asm)): Centered 21-gonal numbers.
* [A069190](http://oeis.org/A069190) ([L05 program](A069190.asm)): Centered 24-gonal numbers.
...
* [A069755](http://oeis.org/A069755) ([L25 program](A069755.asm)): Frobenius number of the numerical semigroup generated by 3 consecutive triangular numbers.
* [A069756](http://oeis.org/A069756) ([L06 program](A069756.asm)): Frobenius number of the numerical semigroup generated by consecutive squares.
* [A069759](http://oeis.org/A069759) ([L10 program](A069759.asm)): Frobenius number of the numerical semigroup generated by consecutive hex numbers.
...
* [A070414](http://oeis.org/A070414) ([L07 program](A070414.asm)): a(n) = 7^n mod 30.
...
* [A070421](http://oeis.org/A070421) ([L07 program](A070421.asm)): a(n) = 7^n mod 38.
...
* [A070434](http://oeis.org/A070434) ([L03 program](A070434.asm)): a(n) = n^2 mod 11.
...
* [A070438](http://oeis.org/A070438) ([L03 program](A070438.asm)): a(n) = n^2 mod 15.
* [A070439](http://oeis.org/A070439) ([L03 program](A070439.asm)): a(n) = n^2 mod 16.
* [A070440](http://oeis.org/A070440) ([L03 program](A070440.asm)): a(n) = n^2 mod 18.
* [A070441](http://oeis.org/A070441) ([L07 program](A070441.asm)): n^2 mod 19.
...
* [A070468](http://oeis.org/A070468) ([L09 program](A070468.asm)): a(n) = n^2 mod 46.
...
* [A070477](http://oeis.org/A070477) ([L09 program](A070477.asm)): a(n) = n^3 mod 15.
...
* [A070482](http://oeis.org/A070482) ([L04 program](A070482.asm)): a(n) = n^3 mod 20.
...
* [A070501](http://oeis.org/A070501) ([L09 program](A070501.asm)): a(n) = n^3 mod 39.
...
* [A070506](http://oeis.org/A070506) ([L06 program](A070506.asm)): a(n) = n^3 mod 44.
* [A070507](http://oeis.org/A070507) ([L21 program](A070507.asm)): a(n) = n^3 mod 45.
* [A070508](http://oeis.org/A070508) ([L05 program](A070508.asm)): a(n) = n^3 mod 46.
...
* [A070532](http://oeis.org/A070532) ([L05 program](A070532.asm)): a(n) = n^4 mod 14.
...
* [A070590](http://oeis.org/A070590) ([L06 program](A070590.asm)): n^4 mod 47.
...
* [A070612](http://oeis.org/A070612) ([L03 program](A070612.asm)): n^5 mod 28.
...
* [A070630](http://oeis.org/A070630) ([L05 program](A070630.asm)): n^5 mod 47.
...
* [A070638](http://oeis.org/A070638) ([L03 program](A070638.asm)): n^6 mod 15.
...
* [A070644](http://oeis.org/A070644) ([L07 program](A070644.asm)): n^6 mod 21.
...
* [A070686](http://oeis.org/A070686) ([L08 program](A070686.asm)): n^6 mod 46.
...
* [A070702](http://oeis.org/A070702) ([L04 program](A070702.asm)): a(n) = n^7 mod 20.
...
* [A070725](http://oeis.org/A070725) ([L03 program](A070725.asm)): n^7 mod 45.
...
* [A071061](http://oeis.org/A071061) ([L17 program](A071061.asm)): Abjad values of the Arabic letters in the traditional order for abjad calculations.
...
* [A071236](http://oeis.org/A071236) ([L05 program](A071236.asm)): a(n) = (n^10 + n^5)/2.
...
* [A071274](http://oeis.org/A071274) ([L19 program](A071274.asm)): A071273 divided by 11.
* [A071279](http://oeis.org/A071279) ([L04 program](A071279.asm)): Kissing number of regular n-gon.
* [A071282](http://oeis.org/A071282) ([L05 program](A071282.asm)): Denominators of Peirce sequence of order 3.
...
* [A071400](http://oeis.org/A071400) ([L10 program](A071400.asm)): Rounded volume of a regular octahedron with edge length n.
...
* [A071521](http://oeis.org/A071521) ([L24 program](A071521.asm)): Number of 3-smooth numbers <= n.
...
* [A071910](http://oeis.org/A071910) ([L12 program](A071910.asm)): a(n) = t(n)*t(n+1)*t(n+2), where t() are the triangular numbers.
...
* [A072100](http://oeis.org/A072100) ([L48 program](A072100.asm)): Column 2 of the array m(i,1)=m(1,j)=1 m(i,j)=m(i-1,j-1)+m(i-1,j+1) (a(n)=m(n,2)).
...
* [A072557](http://oeis.org/A072557) ([L29 program](A072557.asm)): Let w(n) be defined by the following recurrence: w(1)=w(2)=w(3)=1, w(n)=(w(n-1)*w(n-2)+(w(n-1)+w(n-2))/3) / w(n-3); sequence gives values of n such that w(n) is an integer.
...
* [A072819](http://oeis.org/A072819) ([L05 program](A072819.asm)): Variance of time for a random walk starting at 0 to reach one of the boundaries at +n or -n for the first time.
...
* [A073663](http://oeis.org/A073663) ([L40 program](A073663.asm)): Total number of branches of length k (k>=1) in all ordered trees with n+k edges (it is independent of k).
...
* [A073850](http://oeis.org/A073850) ([L26 program](A073850.asm)): Cumulative sum of initial digits of (n base 4).
* [A073851](http://oeis.org/A073851) ([L17 program](A073851.asm)): Cumulative sum of initial digits of (n base 5).
...
* [A074148](http://oeis.org/A074148) ([L06 program](A074148.asm)): a(n) = n + floor(n^2/2).
...
* [A074227](http://oeis.org/A074227) ([L04 program](A074227.asm)): Duplicate of A042965.
...
* [A074280](http://oeis.org/A074280) ([L03 program](A074280.asm)): Duplicate of A000523.
...
* [A074330](http://oeis.org/A074330) ([L43 program](A074330.asm)): a(n)=sum(k=1,n,2^b(k)) where b(k) denotes the number of 1's in the binary representation of k.
...
* [A074502](http://oeis.org/A074502) ([L12 program](A074502.asm)): 1^n + 2^n + 6^n.
* [A074503](http://oeis.org/A074503) ([L13 program](A074503.asm)): a(n) = 1^n + 2^n + 7^n.
...
* [A074511](http://oeis.org/A074511) ([L11 program](A074511.asm)): a(n) = 1^n + 4^n + 5^n.
* [A074512](http://oeis.org/A074512) ([L09 program](A074512.asm)): a(n) = 1^n + 4^n + 6^n.
* [A074513](http://oeis.org/A074513) ([L12 program](A074513.asm)): a(n) = 1^n + 4^n + 7^n.
* [A074516](http://oeis.org/A074516) ([L10 program](A074516.asm)): a(n) = 1^n + 5^n + 6^n.
* [A074517](http://oeis.org/A074517) ([L14 program](A074517.asm)): a(n) = 1^n + 5^n + 7^n.
* [A074520](http://oeis.org/A074520) ([L09 program](A074520.asm)): 1^n + 6^n + 7^n.
...
* [A074601](http://oeis.org/A074601) ([L08 program](A074601.asm)): a(n) = 2^n + 6^n.
* [A074602](http://oeis.org/A074602) ([L13 program](A074602.asm)): a(n) = 2^n + 7^n.
...
* [A074611](http://oeis.org/A074611) ([L09 program](A074611.asm)): 4^n + 5^n.
* [A074612](http://oeis.org/A074612) ([L05 program](A074612.asm)): a(n) = 4^n + 6^n.
* [A074613](http://oeis.org/A074613) ([L09 program](A074613.asm)): a(n) = 4^n + 7^n.
* [A074615](http://oeis.org/A074615) ([L10 program](A074615.asm)): a(n) = 5^n + 6^n.
* [A074616](http://oeis.org/A074616) ([L07 program](A074616.asm)): a(n) = 5^n + 7^n.
* [A074619](http://oeis.org/A074619) ([L07 program](A074619.asm)): 6^n + 7^n.
* [A074701](http://oeis.org/A074701) ([L20 program](A074701.asm)): Numbers n such that n = sum( d dividing phi(n), mu(phi(d))*phi(n)/d ).
* [A074723](http://oeis.org/A074723) ([L17 program](A074723.asm)): Largest power of 2 dividing F(3n) where F(k) is the k-th Fibonacci number.
...
* [A074922](http://oeis.org/A074922) ([L24 program](A074922.asm)): Number of ways of arranging n chords on a circle (handshakes between 2n people across a table) with exactly 2 simple intersections.
...
* [A075104](http://oeis.org/A075104) ([L06 program](A075104.asm)): Greatest common divisor of n and integer part of log_2(n).
...
* [A075543](http://oeis.org/A075543) ([L23 program](A075543.asm)): a[n] = a[n-1] + digit sum(n) - 1.
...
* [A075897](http://oeis.org/A075897) ([L20 program](A075897.asm)): 1 if binary weight of n is 1 or 2, otherwise 0.
* [A076024](http://oeis.org/A076024) ([L11 program](A076024.asm)): a(n) = (2^n + 4)*(2^n - 1)/6.
...
* [A076538](http://oeis.org/A076538) ([L04 program](A076538.asm)): Numerators a(n) of fractions slowly converging to e: let a(1) = 0, b(n) = n - a(n); if (a(n) + 1) / b(n) < e then a(n+1) = a(n) + 1, else a(n+1)= a(n).
* [A076540](http://oeis.org/A076540) ([L22 program](A076540.asm)): Number of branches in all ordered trees with n edges.
...
* [A076816](http://oeis.org/A076816) ([L17 program](A076816.asm)): Squares modulo triangular numbers: n^2 minus the greatest triangular number smaller than or equal to n^2.
...
* [A077071](http://oeis.org/A077071) ([L43 program](A077071.asm)): Row sums of A077070.
* [A077121](http://oeis.org/A077121) ([L29 program](A077121.asm)): Number of integer squares <= n^3.
...
* [A077429](http://oeis.org/A077429) ([L16 program](A077429.asm)): a(n) = floor(log_10(n^2)).
* [A077430](http://oeis.org/A077430) ([L15 program](A077430.asm)): a(n) = floor(log_10(2*n^2)) + 1.
* [A077433](http://oeis.org/A077433) ([L04 program](A077433.asm)): Number of separating zeros to represent A077431.
...
* [A077834](http://oeis.org/A077834) ([L91 program](A077834.asm)): Expansion of 1/(1 - 2*x - 2*x^2 - 3*x^3).
* [A077842](http://oeis.org/A077842) ([L80 program](A077842.asm)): Expansion of (1-x)/(1-2*x-2*x^2-3*x^3).
...
* [A078112](http://oeis.org/A078112) ([L07 program](A078112.asm)): Coefficients a(n) in the unique expansion sin(1) = Sum[a(n)/n!, n>=1], where a(n) satisfies 0<=a(n)<n.
...
* [A079034](http://oeis.org/A079034) ([L07 program](A079034.asm)): Determinant of M(n), the n X n matrix defined by m(i,i)=1, m(i,j)=i-j.
...
* [A079044](http://oeis.org/A079044) ([L17 program](A079044.asm)): Numbers n such that sum(k=0,n,sin(k/Pi)) < 0.
...
* [A079309](http://oeis.org/A079309) ([L17 program](A079309.asm)): a(n) = C(1,1) + C(3,2) + C(5,3) + ... + C(2n-1,n).
...
* [A079420](http://oeis.org/A079420) ([L41 program](A079420.asm)): Duplicate of A076895.
...
* [A079795](http://oeis.org/A079795) ([L28 program](A079795.asm)): Duplicate of A052037.
...
* [A079948](http://oeis.org/A079948) ([L15 program](A079948.asm)): First differences of A079000.
...
* [A080030](http://oeis.org/A080030) ([L26 program](A080030.asm)): a(n) is taken to be the smallest positive integer not already present which is consistent with the condition "n is a member of the sequence if and only if a(n) is congruent to 1 mod 3".
...
* [A080075](http://oeis.org/A080075) ([L31 program](A080075.asm)): Proth numbers: of the form k*2^m + 1 for k odd, m >= 1 and 2^m > k.
...
* [A080095](http://oeis.org/A080095) ([L22 program](A080095.asm)): Let sum(k>=0, k^n/(2*k+1)!) = (x(n)*e + y(n)/e)/z(n), where x(n) and z(n) are >0, then a(n)=z(n).
* [A080097](http://oeis.org/A080097) ([L21 program](A080097.asm)): a(n) = Fibonacci(n+2)^2 - 1.
...
* [A080354](http://oeis.org/A080354) ([L40 program](A080354.asm)): First differences of A080353.
...
* [A080600](http://oeis.org/A080600) ([L26 program](A080600.asm)): a(n) = ceiling(n*(3 + sqrt(13))/2).
...
* [A080663](http://oeis.org/A080663) ([L05 program](A080663.asm)): a(n) = 3*n^2 - 1.
...
* [A080800](http://oeis.org/A080800) ([L04 program](A080800.asm)): Similar to A080799 but count only division steps.
...
* [A080855](http://oeis.org/A080855) ([L05 program](A080855.asm)): a(n) = (9*n^2 - 3*n + 2)/2.
...
* [A080880](http://oeis.org/A080880) ([L11 program](A080880.asm)): a(n)*a(n+3) - a(n+1)*a(n+2) = 2^n, given a(0)=1, a(1)=2, a(2)=2.
...
* [A081135](http://oeis.org/A081135) ([L07 program](A081135.asm)): 5th binomial transform of (0,0,1,0,0,0,...).
* [A081136](http://oeis.org/A081136) ([L10 program](A081136.asm)): 6th binomial transform of (0,0,1,0,0,0,........).
* [A081144](http://oeis.org/A081144) ([L06 program](A081144.asm)): Starting at 1, four-fold convolution of A000400 (powers of 6).
* [A081168](http://oeis.org/A081168) ([L44 program](A081168.asm)): Differences of Beatty sequence for square root of 10.
* [A081181](http://oeis.org/A081181) ([L09 program](A081181.asm)): Staircase on Pascal's triangle.
* [A081186](http://oeis.org/A081186) ([L08 program](A081186.asm)): 4th binomial transform of (1,0,1,0,1,...), A059841.
* [A081187](http://oeis.org/A081187) ([L08 program](A081187.asm)): 5th binomial transform of (1,0,1,0,1,...), A059841.
* [A081188](http://oeis.org/A081188) ([L13 program](A081188.asm)): 6th binomial transform of (1,0,1,0,1,.....), A059841.
...
* [A081205](http://oeis.org/A081205) ([L19 program](A081205.asm)): Staircase on Pascal's triangle.
...
* [A081288](http://oeis.org/A081288) ([L23 program](A081288.asm)): a(n) is the minimal i such that A000108(i) > n.
* [A081294](http://oeis.org/A081294) ([L04 program](A081294.asm)): Expansion of (1-2*x)/(1-4*x).
* [A081335](http://oeis.org/A081335) ([L11 program](A081335.asm)): a(n) = (6^n + 2^n)/2.
...
* [A081405](http://oeis.org/A081405) ([L10 program](A081405.asm)):   a(n) = (n+1)*a(n-2) with a(0) = a(1) = 1.
* [A081406](http://oeis.org/A081406) ([L18 program](A081406.asm)): a(n) = (n+1)*a(n-3), a(0)=a(1)=a(2)=1 for n>1.
* [A081407](http://oeis.org/A081407) ([L14 program](A081407.asm)): 4th-order non-linear ("factorial") recursion: a(0)=a(1)=a(2)=a(3)=1, a(n) = (n+1)*a(n-4).
* [A081408](http://oeis.org/A081408) ([L13 program](A081408.asm)): a(n) = (n+1)*a(n-5), with a(0)=a(1)=a(2)=a(3)=a(4)=1.
...
* [A081492](http://oeis.org/A081492) ([L31 program](A081492.asm)): Sum of terms in n-th row of A081491.
...
* [A081567](http://oeis.org/A081567) ([L19 program](A081567.asm)): Second binomial transform of F(n+1).
...
* [A081587](http://oeis.org/A081587) ([L06 program](A081587.asm)): Third row of Pascal-(1,4,1) array A081579.
* [A081589](http://oeis.org/A081589) ([L06 program](A081589.asm)): Third row of Pascal-(1,5,1) array A081580.
...
* [A081599](http://oeis.org/A081599) ([L05 program](A081599.asm)): Let n = 10x + y where 0 <= y <= 9, x >= 0. Then a(n) = 8x+y.
* [A081600](http://oeis.org/A081600) ([L03 program](A081600.asm)): Let n = 10x + y where 0 <= y <= 9, x >= 0. Then a(n) = 9x+y.
* [A081604](http://oeis.org/A081604) ([L08 program](A081604.asm)): Number of digits in ternary representation of n.
* [A081609](http://oeis.org/A081609) ([L30 program](A081609.asm)): Number of numbers <= n having at least one 1 in their ternary representation.
* [A081611](http://oeis.org/A081611) ([L22 program](A081611.asm)): Number of numbers <= n having no 2 in their ternary representation.
* [A081631](http://oeis.org/A081631) ([L13 program](A081631.asm)): 2*2^n-(-2)^n.
* [A081632](http://oeis.org/A081632) ([L09 program](A081632.asm)): 2*3^n-(-1)^n.
* [A081654](http://oeis.org/A081654) ([L11 program](A081654.asm)): a(n) = 2*4^n - 0^n.
* [A081655](http://oeis.org/A081655) ([L05 program](A081655.asm)): 2*5^n-1.
* [A081656](http://oeis.org/A081656) ([L21 program](A081656.asm)): 2*6^n-2^n.
...
* [A081661](http://oeis.org/A081661) ([L31 program](A081661.asm)): Partial sums of A081660.
* [A081662](http://oeis.org/A081662) ([L21 program](A081662.asm)): Partial sums of n + Fibonacci(n+1).
* [A081674](http://oeis.org/A081674) ([L09 program](A081674.asm)): Generalized Poly-Bernoulli numbers.
...
* [A081753](http://oeis.org/A081753) ([L24 program](A081753.asm)): a(n) = floor(n/12) if n==2 (mod 12); a(n)=floor(n/12)+1 otherwise.
...
* [A082045](http://oeis.org/A082045) ([L55 program](A082045.asm)): Diagonal sums of number array A082043.
* [A082047](http://oeis.org/A082047) ([L52 program](A082047.asm)): Diagonal sums of number array A082046.
* [A082106](http://oeis.org/A082106) ([L05 program](A082106.asm)): Main diagonal of number array A082105.
* [A082107](http://oeis.org/A082107) ([L57 program](A082107.asm)): Diagonal sums of number array A082105.
...
* [A082114](http://oeis.org/A082114) ([L51 program](A082114.asm)): Diagonal sums of number array A082110.
...
* [A082450](http://oeis.org/A082450) ([L04 program](A082450.asm)): a(n) = 5*(n^2-n+2)/2.
* [A082482](http://oeis.org/A082482) ([L16 program](A082482.asm)): Floor of (2^n-1)/n.
...
* [A082662](http://oeis.org/A082662) ([L25 program](A082662.asm)): Numbers k such that A001227(k) = A082647(k).
...
* [A082964](http://oeis.org/A082964) ([L21 program](A082964.asm)): a(n) = m given by arctan(tan(n)) = n - m*Pi.
...
* [A083026](http://oeis.org/A083026) ([L06 program](A083026.asm)): Numbers that are congruent to {0, 2, 4, 5, 7, 9, 11} mod 12.
...
* [A083030](http://oeis.org/A083030) ([L11 program](A083030.asm)): Numbers that are congruent to {0, 4, 7} mod 12.
...
* [A083045](http://oeis.org/A083045) ([L16 program](A083045.asm)): Main diagonal of table A083044.
...
* [A083222](http://oeis.org/A083222) ([L14 program](A083222.asm)): a(n) = (4*5^n + (-5)^n)/5.
...
* [A083374](http://oeis.org/A083374) ([L06 program](A083374.asm)): a(n) = n^2 * (n^2 - 1)/2.
...
* [A083424](http://oeis.org/A083424) ([L18 program](A083424.asm)): a(n) = (5*4^n + (-2)^n)/6.
...
* [A083544](http://oeis.org/A083544) ([L29 program](A083544.asm)): a(n) = maximal value of the sum of Mobius function values over a block of n consecutive natural numbers.
...
* [A084175](http://oeis.org/A084175) ([L14 program](A084175.asm)): Jacobsthal oblong numbers.
...
* [A084477](http://oeis.org/A084477) ([L15 program](A084477.asm)): Number of fault-free tilings of a 4 X 3n rectangle with right trominoes.
...
* [A084526](http://oeis.org/A084526) ([L19 program](A084526.asm)): The length of each successively larger, indecomposable, 'prime' 3-ball ground-state site swap given in A084521, i.e., the number of digits in each term of A084522.
...
* [A084626](http://oeis.org/A084626) ([L06 program](A084626.asm)): Floor(C(n+6,6)/C(n+2,2)).
...
* [A084861](http://oeis.org/A084861) ([L90 program](A084861.asm)): Expansion of (1-3x+4x^2-3x^3+x^4)/(1-2x)^2.
...
* [A085025](http://oeis.org/A085025) ([L07 program](A085025.asm)): a(n) = (5*n+1)*(5*n+6).
...
* [A085046](http://oeis.org/A085046) ([L06 program](A085046.asm)): a(n) = n^2 - (1 + (-1)^n)/2.
* [A085058](http://oeis.org/A085058) ([L30 program](A085058.asm)): a(n) = A001511(n+1) + 1.
* [A085060](http://oeis.org/A085060) ([L18 program](A085060.asm)): Integer reached in A085058.
* [A085062](http://oeis.org/A085062) ([L16 program](A085062.asm)): A085060(n)/9 - 1/3.
...
* [A085423](http://oeis.org/A085423) ([L06 program](A085423.asm)): a(n) = floor(log_2(3n)).
* [A085449](http://oeis.org/A085449) ([L13 program](A085449.asm)): Horadam sequence (0,1,4,2).
* [A085461](http://oeis.org/A085461) ([L12 program](A085461.asm)): Number of 5-tuples (v1,v2,v3,v4,v5) of nonnegative integers less than n such that v1 <= v5, v2 <= v5, v2 <= v4 and v3 <= v4.
...
* [A085744](http://oeis.org/A085744) ([L03 program](A085744.asm)): a(n) = A000217(n^3) - n^3.
...
* [A085960](http://oeis.org/A085960) ([L17 program](A085960.asm)): Size of the largest code of length 4 and minimum distance 3 over an alphabet of size n. This is usually denoted by A_{n}(4,3).
* [A086090](http://oeis.org/A086090) ([L13 program](A086090.asm)): 2^n+n3^n.
* [A086112](http://oeis.org/A086112) ([L23 program](A086112.asm)): Denominator of the mean deviation of a discrete uniform distribution on n elements.
...
* [A086115](http://oeis.org/A086115) ([L16 program](A086115.asm)): Number of 5 X n (0,1) matrices such that each row and each column is nondecreasing or nonincreasing.
...
* [A086299](http://oeis.org/A086299) ([L10 program](A086299.asm)): a(n) = if n is 7-smooth then 1 else 0: characteristic function of 7-smooth numbers.
* [A086302](http://oeis.org/A086302) ([L10 program](A086302.asm)): a(n) = 4*n^4 + 24*n^3 + 48*n^2 + 36*n + 8.
...
* [A086358](http://oeis.org/A086358) ([L13 program](A086358.asm)): Digital root of n!.
* [A086377](http://oeis.org/A086377) ([L27 program](A086377.asm)): a(1)=1; a(n)=a(n-1)+2 if n is in the sequence; a(n)=a(n-1)+2 if n and (n-1) are not in the sequence; a(n)=a(n-1)+3 if n is not in the sequence but (n-1) is in the sequence.
...
* [A086640](http://oeis.org/A086640) ([L08 program](A086640.asm)): Arrange n^2 octagons that each have area 7 so that they leave (n-1)^2 square gaps each with area 2; a(n) is the total area of these polygons.
...
* [A086760](http://oeis.org/A086760) ([L06 program](A086760.asm)): a(n) = 8n^2 + 88n + 43.
...
* [A086858](http://oeis.org/A086858) ([L13 program](A086858.asm)): Let f(n) be the inverse of the function g(x) = x^x. Then a(n) = floor(f(n)).
...
* [A087057](http://oeis.org/A087057) ([L23 program](A087057.asm)): Smallest number whose square is larger than 2*n^2.
...
* [A087088](http://oeis.org/A087088) ([L40 program](A087088.asm)): If all the 1's are removed the sequence is the same as the original with every term one greater than before. It is the simplest nontrivial sequence with this property.
...
* [A087192](http://oeis.org/A087192) ([L23 program](A087192.asm)): a(n) = ceiling(a(n-1)*4/3), with a(1) = 1.
...
* [A087348](http://oeis.org/A087348) ([L07 program](A087348.asm)): a(n) = 10*n^2 - 6*n + 1.
* [A087404](http://oeis.org/A087404) ([L13 program](A087404.asm)): a(n) = 4a(n-1) + 5a(n-2).
* [A087405](http://oeis.org/A087405) ([L76 program](A087405.asm)): First differences of A087404: a(n)=A087404(n)-A087404(n-1), a(0)=A087404(0).
...
* [A087539](http://oeis.org/A087539) ([L26 program](A087539.asm)): First differences of A011849.
...
* [A088037](http://oeis.org/A088037) ([L20 program](A088037.asm)): Smallest square k == 1 (mod some n-th power), k > 1.
...
* [A088218](http://oeis.org/A088218) ([L08 program](A088218.asm)): Total number of leaves in all rooted ordered trees with n edges.
...
* [A088481](http://oeis.org/A088481) ([L05 program](A088481.asm)): Numbers n such that the lunar product of the distinct lunar prime divisors of n is > n.
...
* [A088625](http://oeis.org/A088625) ([L03 program](A088625.asm)): 14*C(n,8).
* [A088626](http://oeis.org/A088626) ([L03 program](A088626.asm)): 42*C(n,10).
...
* [A088720](http://oeis.org/A088720) ([L28 program](A088720.asm)): Unique monotone sequence satisfying a(a(a(n))) = 2n.
* [A088721](http://oeis.org/A088721) ([L24 program](A088721.asm)): Unique monotone sequence satisfying a(a(a(a(n)))) = 2n.
...
* [A088837](http://oeis.org/A088837) ([L06 program](A088837.asm)): Numerator of sigma(2*n)/sigma(n). Denominator see in A038712.
...
* [A088923](http://oeis.org/A088923) ([L18 program](A088923.asm)): Duplicate of A011539.
...
* [A089072](http://oeis.org/A089072) ([L09 program](A089072.asm)): Triangle read by rows: T(n,k) = k^n, n>=1, 1<=k<=n.
* [A089080](http://oeis.org/A089080) ([L24 program](A089080.asm)): Sequence is S(infinity) where S(1)={1,2} and S(n)=S(n-1)S'(n-1), where S'(k) is obtained from S(k) by replacing the single 1 with the least integer not occurring in S(k).
...
* [A089108](http://oeis.org/A089108) ([L05 program](A089108.asm)): Convoluted convolved Fibonacci numbers G_4^(r).
...
* [A089186](http://oeis.org/A089186) ([L21 program](A089186.asm)): Decreases from 9 * 10^k down to 1, restarting at 9 * 10^(k+1).
...
* [A089574](http://oeis.org/A089574) ([L44 program](A089574.asm)): Column 4 of an array closely related to A083480. (Both arrays have shape sequence A083479).
* [A089598](http://oeis.org/A089598) ([L13 program](A089598.asm)): G.f.: (1+x^2+x^3)/(1-x^3)^2.
* [A089608](http://oeis.org/A089608) ([L10 program](A089608.asm)): a(n) = ((-1)^(n+1)*A002425(n)) modulo 6.
...
* [A089781](http://oeis.org/A089781) ([L38 program](A089781.asm)): Successive coprime numbers with distinct successive differences: gcd(a(k+1),a(k)) = gcd(a(m+1),a(m)) = 1 and a(k+1)-a(k) = a(m+1)-a(m) <==> m=k.
...
* [A089830](http://oeis.org/A089830) ([L34 program](A089830.asm)): Expansion of (1-3*x+6*x^2-5*x^3+3*x^4-x^5)/(1-x)^6.
...
* [A090040](http://oeis.org/A090040) ([L19 program](A090040.asm)): (3*6^n + 2^n)/4.
...
* [A090168](http://oeis.org/A090168) ([L07 program](A090168.asm)): Floor( 3n/2 ) - floor( 2n/3 ).
...
* [A090386](http://oeis.org/A090386) ([L19 program](A090386.asm)): Fifth diagonal (m=4) of triangle A084938; a(n) = A084938(n+4,n) = (n^4 + 18*n^3 + 131*n^2 + 426*n)/24.
...
* [A090638](http://oeis.org/A090638) ([L12 program](A090638.asm)): Duplicate of A073869.
...
* [A090739](http://oeis.org/A090739) ([L30 program](A090739.asm)): Exponent of 2 in 9^n - 1.
...
* [A091086](http://oeis.org/A091086) ([L05 program](A091086.asm)): a(n) = A000975(n) mod 10.
* [A091090](http://oeis.org/A091090) ([L28 program](A091090.asm)): In binary representation: number of editing steps (delete, insert, or substitute) to transform n into n + 1.
...
* [A091954](http://oeis.org/A091954) ([L31 program](A091954.asm)): Number of odd proper divisors of n. That is, the number of odd divisors of n that are less than n.
* [A091972](http://oeis.org/A091972) ([L33 program](A091972.asm)): G.f.: (1 + x^5 ) / ( (1-x^3)*(1-x^4)).
...
* [A092094](http://oeis.org/A092094) ([L33 program](A092094.asm)): a(n) = Sum_{i=0,1,2,..; n-k*i >= -n} |n-k*i| for k=3.
...
* [A092200](http://oeis.org/A092200) ([L07 program](A092200.asm)): Expansion of (1+2x)/((1-x)(1-x^3)).
...
* [A092286](http://oeis.org/A092286) ([L04 program](A092286.asm)): Fourth diagonal (m=3) of triangle A084938; a(n) = A084938(n+3,n) = (n^3 + 9*n^2 + 26*n)/6.
...
* [A092443](http://oeis.org/A092443) ([L63 program](A092443.asm)): Sequence arising from enumeration of domino tilings of Aztec Pillow-like regions.
...
* [A092521](http://oeis.org/A092521) ([L19 program](A092521.asm)): a(n) = 8*a(n-1) - 8*a(n-2) + a(n-3).
* [A092525](http://oeis.org/A092525) ([L14 program](A092525.asm)): To binary representation of n, append as many ones as there are trailing zeros.
...
* [A092757](http://oeis.org/A092757) ([L25 program](A092757.asm)): Partial sums of round(log_2(n)).
...
* [A092898](http://oeis.org/A092898) ([L29 program](A092898.asm)): Expansion of (1 - 4*x + 4*x^2 - 4*x^3)/(1 - 4*x).
...
* [A093361](http://oeis.org/A093361) ([L25 program](A093361.asm)): Add/multiply sequence, see example.
...
* [A093566](http://oeis.org/A093566) ([L13 program](A093566.asm)): a(n) = n*(n-1)*(n-2)*(n-3)*(n^2-3*n-2)/48.
...
* [A093616](http://oeis.org/A093616) ([L22 program](A093616.asm)): a(n) = smallest k such that k*n has exactly as many divisors as n^2.
...
* [A094041](http://oeis.org/A094041) ([L07 program](A094041.asm)): Beatty sequence for e^Pi - Pi^e - i^i.
...
* [A094626](http://oeis.org/A094626) ([L52 program](A094626.asm)): Expansion of x*(1+x)/((1-x)*(1-10*x^2)).
* [A094627](http://oeis.org/A094627) ([L67 program](A094627.asm)): Expansion of (1+x)^2/((1-x)*(1-10*x^2)).
...
* [A094823](http://oeis.org/A094823) ([L05 program](A094823.asm)): If n = c0 + c1*10 + c2*10^2 + ...cn*10^n then a(n) = c0 + c1*13 + c2*13^2 + ...cn*13^k.
...
* [A094914](http://oeis.org/A094914) ([L08 program](A094914.asm)): Absolute value of n^2 + n - 1354363.
* [A094941](http://oeis.org/A094941) ([L19 program](A094941.asm)): n! times coefficient of Pi^[n/2] in volume of n-dimensional unit ball.
...
* [A095129](http://oeis.org/A095129) ([L10 program](A095129.asm)): Jac(n)(2Jac(n)-1).
...
* [A095266](http://oeis.org/A095266) ([L22 program](A095266.asm)): A sequence generated from the Narayana triangle considered as a matrix, or from Pascal's triangle.
...
* [A095662](http://oeis.org/A095662) ([L25 program](A095662.asm)): Seventh column (m=6) of (1,3)-Pascal triangle A095660.
* [A095667](http://oeis.org/A095667) ([L09 program](A095667.asm)): Fifth column (m=4) of (1,4)-Pascal triangle A095666.
* [A095668](http://oeis.org/A095668) ([L11 program](A095668.asm)): Sixth column (m=5) of (1,4)-Pascal triangle A095666.
...
* [A095915](http://oeis.org/A095915) ([L15 program](A095915.asm)): Each number is twice times the product of the digits of the previous number.
...
* [A096026](http://oeis.org/A096026) ([L05 program](A096026.asm)): Numbers n such that (n+j) mod (2+j) = 1 for j from 0 to 8 and (n+9) mod 11 <> 1.
...
* [A096230](http://oeis.org/A096230) ([L04 program](A096230.asm)): Period 5: repeat [9, 7, 5, 3, 1].
* [A096268](http://oeis.org/A096268) ([L08 program](A096268.asm)): Period-doubling sequence (or period-doubling word): fixed point of the morphism 0 -> 01, 1 -> 00.
...
* [A096400](http://oeis.org/A096400) ([L09 program](A096400.asm)): Number of equivalence classes of triangles having equal angles of integral degrees and smallest angle = n.
* [A096431](http://oeis.org/A096431) ([L24 program](A096431.asm)): Denominator of (9*(n^4 - 2*n^3 + 2*n^2 - n) + 2)/(2*(2*n - 1)).
...
* [A097070](http://oeis.org/A097070) ([L10 program](A097070.asm)): Consider all compositions (ordered partitions) of n into n parts, allowing zeros. E.g., for n = 3 we get 300, 030, 003, 210, 120, 201, 102, 021, 012, 111. Then a(n) is the total number of 1's.
...
* [A097165](http://oeis.org/A097165) ([L21 program](A097165.asm)): Expansion of (1-3x)/((1-x)(1-4x)(1-5x)).
...
* [A097362](http://oeis.org/A097362) ([L04 program](A097362.asm)): a(n) = (n+1)/2 if n is odd, n+2 otherwise.
* [A097383](http://oeis.org/A097383) ([L27 program](A097383.asm)): Minimum total number of comparisons to find each of the values 1 through n using a binary search with 3-way comparisons (less than, equal and greater than).
* [A097384](http://oeis.org/A097384) ([L40 program](A097384.asm)): Total number of comparisons to find each of the values 1 through n using a binary search with 3-way comparisons (less than, equal and greater than), always choosing the mid-most value to compare to.
...
* [A097408](http://oeis.org/A097408) ([L20 program](A097408.asm)): Initial decimal digit of n^4.
...
* [A097613](http://oeis.org/A097613) ([L81 program](A097613.asm)): a(n) = binomial(2n-3,n-1) + binomial(2n-2,n-2).
...
* [A098077](http://oeis.org/A098077) ([L29 program](A098077.asm)): a(n) = n^2*(n+1)*(2*n+1)/3.
...
* [A098140](http://oeis.org/A098140) ([L29 program](A098140.asm)): 63-gonal numbers: a(n) = n*(61*n - 59)/2.
...
* [A098457](http://oeis.org/A098457) ([L07 program](A098457.asm)): Farey Bisection Expansion of sqrt(7).
...
* [A098844](http://oeis.org/A098844) ([L07 program](A098844.asm)): a(1)=1, a(n) = n*a(floor(n/2)).
...
* [A099578](http://oeis.org/A099578) ([L07 program](A099578.asm)): a(n) = binomial(floor((3n+2)/2), floor(n/2)).
...
* [A099892](http://oeis.org/A099892) ([L36 program](A099892.asm)): XOR BINOMIAL transform of A003188 (Gray code numbers); also the main diagonal of the XOR difference triangle A099891.
...
* [A099921](http://oeis.org/A099921) ([L15 program](A099921.asm)): a(n) = 5*Fibonacci(n)^2.

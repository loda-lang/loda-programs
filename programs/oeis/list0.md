...
* [A017126](http://oeis.org/A017126) ([L05 program](A017126.asm)): a(n) = (8*n + 5)^2.
...
* [A079043](http://oeis.org/A079043) ([L29 program](A079043.asm)): a(0)=1, then the fractional part of Pi*a(n) decreases monotonically to zero.

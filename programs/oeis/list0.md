...
* [A011795](http://oeis.org/A011795) ([L06 program](A011795.asm)): a(n) = floor(C(n,4)/5).
...
* [A011940](http://oeis.org/A011940) ([L07 program](A011940.asm)): a(n) = floor(n(n-1)(n-2)(n-3)/30).

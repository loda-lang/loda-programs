...
* [A027470](http://oeis.org/A027470) ([L10 program](A027470.asm)): 225*(n-1)*(n-2)/2.
...
* [A046717](http://oeis.org/A046717) ([L06 program](A046717.asm)): a(n) = 2*a(n-1) + 3*a(n-2), a(0) = a(1) = 1.
...
* [A047558](http://oeis.org/A047558) ([L10 program](A047558.asm)): Numbers that are congruent to {1, 3, 6, 7} mod 8.

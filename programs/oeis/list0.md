...
* [A001019](http://oeis.org/A001019) ([L02 program](A001019.asm)): Powers of 9: a(n) = 9^n.
...
* [A002452](http://oeis.org/A002452) ([L03 program](A002452.asm)): a(n) = (9^n - 1)/8.
...
* [A017306](http://oeis.org/A017306) ([L07 program](A017306.asm)): a(n) = (10*n + 3)^2.
...
* [A024079](http://oeis.org/A024079) ([L12 program](A024079.asm)): a(n) = 7^n - n^4.
...
* [A044387](http://oeis.org/A044387) ([L18 program](A044387.asm)): Numbers n such that string 5,5 occurs in the base 10 representation of n but not of n-1.
...
* [A052386](http://oeis.org/A052386) ([L04 program](A052386.asm)): Number of integers from 1 to 10^n-1 that lack 0 as a digit.
...
* [A069073](http://oeis.org/A069073) ([L12 program](A069073.asm)): a(n) = n*(4n^2 - 1)^2.
...
* [A069078](http://oeis.org/A069078) ([L07 program](A069078.asm)): a(n) = n(4*n^4 + 1).
...
* [A070260](http://oeis.org/A070260) ([L14 program](A070260.asm)): Third diagonal of triangle defined in A051537.
...
* [A070662](http://oeis.org/A070662) ([L07 program](A070662.asm)): n^6 mod 39.
...
* [A070960](http://oeis.org/A070960) ([L06 program](A070960.asm)): a(1) = 1; a(n) = n!*(3/2) for n>=2.
...
* [A072863](http://oeis.org/A072863) ([L17 program](A072863.asm)): a(n) = 2^(n-3)*(n^2+3*n+8).
...
* [A074506](http://oeis.org/A074506) ([L08 program](A074506.asm)): a(n) = 1^n + 3^n + 4^n.
* [A074507](http://oeis.org/A074507) ([L09 program](A074507.asm)): a(n) = 1^n + 3^n + 5^n.
* [A074510](http://oeis.org/A074510) ([L10 program](A074510.asm)): a(n) = 1^n + 3^n + 8^n.
...
* [A087290](http://oeis.org/A087290) ([L05 program](A087290.asm)): Number of pairs of polynomials (f,g) in GF(3)[x] satisfying deg(f) <= n, deg(g) <= n and gcd(f,g) = 1.
...
* [A088841](http://oeis.org/A088841) ([L09 program](A088841.asm)): Numerator of quotient=sigma[7n]/sigma[n].
...
* [A089086](http://oeis.org/A089086) ([L06 program](A089086.asm)): Greatest common divisor of n^2-5 and n^2+5.

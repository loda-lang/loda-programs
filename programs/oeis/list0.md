...
* [A000042](http://oeis.org/A000042) ([L06 program](A000042.asm)): Unary representation of natural numbers.
...
* [A001048](http://oeis.org/A001048) ([L04 program](A001048.asm)): a(n) = n! + (n-1)!.
...
* [A002275](http://oeis.org/A002275) ([L04 program](A002275.asm)): Repunits: (10^n - 1)/9. Often denoted by R_n.
...
* [A014131](http://oeis.org/A014131) ([L11 program](A014131.asm)): a(n) = 2*a(n-1) if n odd else 2*a(n-1) + 6.
...
* [A017306](http://oeis.org/A017306) ([L08 program](A017306.asm)): a(n) = (10*n + 3)^2.
...
* [A030495](http://oeis.org/A030495) ([L04 program](A030495.asm)): a(n) = (n+1)!+ n.
...
* [A033338](http://oeis.org/A033338) ([L07 program](A033338.asm)): [ 18/n ].
...
* [A047855](http://oeis.org/A047855) ([L05 program](A047855.asm)): a(n) = T(7,n), array T given by A047848.
...
* [A052386](http://oeis.org/A052386) ([L05 program](A052386.asm)): Number of integers from 1 to 10^n-1 that lack 0 as a digit.
...
* [A067724](http://oeis.org/A067724) ([L07 program](A067724.asm)): a(n) = 5*n^2 + 10*n.
...
* [A070514](http://oeis.org/A070514) ([L07 program](A070514.asm)): Final digit of n^4: n^4 mod 10.
...
* [A070539](http://oeis.org/A070539) ([L05 program](A070539.asm)): a(n) = n^4 mod 20.
...
* [A073553](http://oeis.org/A073553) ([L06 program](A073553.asm)): Number of Fibonacci numbers F(k), k <= 10^n, which end in 5.
...
* [A078309](http://oeis.org/A078309) ([L07 program](A078309.asm)): Numbers that are congruent to {1, 4, 7} mod 10.
...
* [A080457](http://oeis.org/A080457) ([L08 program](A080457.asm)): a(1)=3; for n>1, a(n)=a(n-1) if n is already in the sequence, a(n)=a(n-1)+4 otherwise.
...
* [A080512](http://oeis.org/A080512) ([L12 program](A080512.asm)): a(n) = n if n is odd, a(n) = 3*n/2 if n is even.
...
* [A081600](http://oeis.org/A081600) ([L04 program](A081600.asm)): Let n = 10x + y where 0 <= y <= 9, x >= 0. Then a(n) = 9x+y.
...
* [A083217](http://oeis.org/A083217) ([L05 program](A083217.asm)): (2*5^n+(-1)^n)/3.
...
* [A084556](http://oeis.org/A084556) ([L07 program](A084556.asm)): n occurs n! times.
...
* [A085046](http://oeis.org/A085046) ([L07 program](A085046.asm)): a(1) = 1, a(2) = 3, then a(2n) = (a(2n-1)*a(2n+1))^1/2 and a(2n+1) = {a(2n) + a(2n+2)}/2. Even-indexed terms are the geometric mean, and odd-indexed terms are the arithmetic mean, of their neighbors.
...
* [A087290](http://oeis.org/A087290) ([L06 program](A087290.asm)): Number of pairs of polynomials (f,g) in GF(3)[x] satisfying deg(f) <= n, deg(g) <= n and gcd(f,g) = 1.
...
* [A087292](http://oeis.org/A087292) ([L07 program](A087292.asm)): Number of pairs of polynomials (f,g) in GF(3)[x] satisfying 1 <= deg(f) < =n, 1 <= deg(g) <= n and gcd(f,g) = 1.
...
* [A088666](http://oeis.org/A088666) ([L08 program](A088666.asm)): a(n) = (n^4 + 1) mod 10.
...
* [A093142](http://oeis.org/A093142) ([L06 program](A093142.asm)): Expansion of (1-5x)/((1-x)(1-10x)).

...
* [A002088](http://oeis.org/A002088) ([L25 program](002/A002088.asm)): Sum of totient function: a(n) = Sum_{k=1..n} phi(k), cf. A000010.
...
* [A002618](http://oeis.org/A002618) ([L10 program](002/A002618.asm)): a(n) = n*phi(n).
...
* [A003434](http://oeis.org/A003434) ([L09 program](003/A003434.asm)): Number of iterations of phi(x) at n needed to reach 1.
...
* [A003958](http://oeis.org/A003958) ([L24 program](003/A003958.asm)): If n = Product p(k)^e(k) then a(n) = Product (p(k)-1)^e(k).
...
* [A005728](http://oeis.org/A005728) ([L24 program](005/A005728.asm)): Number of fractions in Farey series of order n.
...
* [A006996](http://oeis.org/A006996) ([L05 program](006/A006996.asm)): C(2n,n) mod 3.
...
* [A007088](http://oeis.org/A007088) ([L05 program](007/A007088.asm)): The binary numbers (or binary words, or binary vectors): numbers written in base 2.
...
* [A007586](http://oeis.org/A007586) ([L09 program](007/A007586.asm)): 11-gonal (or hendecagonal) pyramidal numbers: n*(n+1)*(3*n-2)/2.
...
* [A009195](http://oeis.org/A009195) ([L09 program](009/A009195.asm)): a(n) = gcd(n, phi(n)).
...
* [A010554](http://oeis.org/A010554) ([L09 program](010/A010554.asm)): a(n) = phi(phi(n)), where phi is the Euler totient function.
...
* [A011755](http://oeis.org/A011755) ([L21 program](011/A011755.asm)): a(n) = Sum_{k=1..n} k*phi(k).
...
* [A014017](http://oeis.org/A014017) ([L06 program](014/A014017.asm)): Inverse of 8th cyclotomic polynomial.
...
* [A014730](http://oeis.org/A014730) ([L03 program](014/A014730.asm)): Squares of odd Lucas numbers.
...
* [A015613](http://oeis.org/A015613) ([L12 program](015/A015613.asm)): a(n) = Sum_{i=1..n} phi(i) * (ceiling(n/i) - floor(n/i)).
* [A015614](http://oeis.org/A015614) ([L14 program](015/A015614.asm)): a(n) = -1 + Sum_{i=1..n} phi(i).
...
* [A016035](http://oeis.org/A016035) ([L10 program](016/A016035.asm)): a(n) = Sum_{j|n, 1 < j < n} phi(j). Also a(n) = n - phi(n) - 1 for n > 1.
...
* [A018805](http://oeis.org/A018805) ([L16 program](018/A018805.asm)): Number of elements in the set {(x,y): 1 <= x,y <= n, gcd(x,y)=1}.
...
* [A023022](http://oeis.org/A023022) ([L06 program](023/A023022.asm)): Number of partitions of n into two relatively prime parts. After initial term, this is the "half-totient" function phi(n)/2 (A000010(n)/2).
...
* [A023896](http://oeis.org/A023896) ([L10 program](023/A023896.asm)): Sum of positive integers in smallest positive reduced residue system modulo n. a(1) = 1 by convention.
...
* [A026484](http://oeis.org/A026484) ([L05 program](026/A026484.asm)): Erroneous version of A026488.
...
* [A027659](http://oeis.org/A027659) ([L06 program](027/A027659.asm)): a(n) = binomial(n+2,2) + binomial(n+3,3) + binomial(n+4,4) + binomial(n+5,5).
...
* [A030195](http://oeis.org/A030195) ([L25 program](030/A030195.asm)): a(n) = 3*a(n-1) + 3*a(n-2), a(0)=0, a(1)=1.
...
* [A032358](http://oeis.org/A032358) ([L10 program](032/A032358.asm)): Number of iterations of phi(n) needed to reach 2.
...
* [A033270](http://oeis.org/A033270) ([L07 program](033/A033270.asm)): Number of odd primes <= n.
...
* [A033879](http://oeis.org/A033879) ([L02 program](033/A033879.asm)): Deficiency of n, or 2n - (sum of divisors of n).
...
* [A037225](http://oeis.org/A037225) ([L05 program](037/A037225.asm)): a(n) = phi(2n+1).
...
* [A037834](http://oeis.org/A037834) ([L04 program](037/A037834.asm)): Sum{|d(i)-d(i-1)|: i=1,...,m}, where Sum{d(i)*2^i: i=0,1,...,m} is base 2 representation of n.
...
* [A039650](http://oeis.org/A039650) ([L10 program](039/A039650.asm)): Prime reached by iterating f(x) = phi(x)+1 on n.
...
* [A040828](http://oeis.org/A040828) ([L06 program](040/A040828.asm)): Continued fraction for sqrt(858).
...
* [A043640](http://oeis.org/A043640) ([L05 program](043/A043640.asm)): Numbers n such that base 10 representation has exactly 4 runs.
* [A043641](http://oeis.org/A043641) ([L25 program](043/A043641.asm)): Numbers n such that base 10 representation has exactly 5 runs.
* [A043642](http://oeis.org/A043642) ([L05 program](043/A043642.asm)): Numbers n such that base 10 representation has exactly 6 runs.
* [A043643](http://oeis.org/A043643) ([L25 program](043/A043643.asm)): Numbers n such that base 10 representation has exactly 7 runs.
* [A043644](http://oeis.org/A043644) ([L05 program](043/A043644.asm)): Numbers n such that base 10 representation has exactly 8 runs.
...
* [A045534](http://oeis.org/A045534) ([L23 program](045/A045534.asm)): Squarefree self-avoiding walks in 2 dimensions.
...
* [A046151](http://oeis.org/A046151) ([L09 program](046/A046151.asm)): a(n) = n*phi(n) - 1.
* [A046152](http://oeis.org/A046152) ([L10 program](046/A046152.asm)): a(n) = n*phi(n) + 1.
...
* [A046699](http://oeis.org/A046699) ([L05 program](046/A046699.asm)): a(1) = a(2) = 1, a(n) = a(n - a(n-1)) + a(n-1 - a(n-2)) if n > 2.
...
* [A047485](http://oeis.org/A047485) ([L15 program](047/A047485.asm)): Numbers that are congruent to {0, 3, 5, 7} mod 8.
...
* [A049108](http://oeis.org/A049108) ([L10 program](049/A049108.asm)): a(n) is the number of iterations of Euler phi function needed to reach 1 starting at n (n is counted).
* [A049115](http://oeis.org/A049115) ([L12 program](049/A049115.asm)): If n is a power of 2, then a(n) = 0; otherwise, a(n) is the number of iterations of the Euler phi function that must be repeatedly applied to n to reach 1.
...
* [A049454](http://oeis.org/A049454) ([L15 program](049/A049454.asm)): a(n) = 1 + Sum_{i=1..n} phi(i)^2.
...
* [A049559](http://oeis.org/A049559) ([L08 program](049/A049559.asm)): a(n) = gcd(n - 1, phi(n)).
...
* [A049617](http://oeis.org/A049617) ([L18 program](049/A049617.asm)): a(n)=Sum{((-1)^i)*T(i,2n-i): i=0,1,...,2n}, array T as in A049615.
...
* [A049628](http://oeis.org/A049628) ([L60 program](049/A049628.asm)): a(n)=Sum{T(i,n-i): i=0,1,...,n}, array T as in A049627.
...
* [A049690](http://oeis.org/A049690) ([L16 program](049/A049690.asm)): a(n) = Sum_{k=1..n} phi(2*k), where phi = Euler totient function, cf. A000010.
* [A049696](http://oeis.org/A049696) ([L26 program](049/A049696.asm)): a(n)=T(n,n), array T as in A049695.
* [A049701](http://oeis.org/A049701) ([L58 program](049/A049701.asm)): Duplicate of A005598.
* [A049703](http://oeis.org/A049703) ([L57 program](049/A049703.asm)): a(0) = 0; for n>0, a(n) = A005598(n)/2.
...
* [A049806](http://oeis.org/A049806) ([L14 program](049/A049806.asm)): Number of Farey fractions of order n that are <=1/2; cf. A049805.

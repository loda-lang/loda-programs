...
* [A002089](http://oeis.org/A002089) ([program](A002089.asm)): a(n) = 11*4^n.
...
* [A002699](http://oeis.org/A002699) ([program](A002699.asm)): a(n) = n*2^(2*n-1).
...
* [A003261](http://oeis.org/A003261) ([program](A003261.asm)): Woodall (or Riesel) numbers: n*2^n - 1.
...
* [A003500](http://oeis.org/A003500) ([program](A003500.asm)): a(n) = 4*a(n-1) - a(n-2) with a(0) = 2, a(1) = 4.
...
* [A005010](http://oeis.org/A005010) ([program](A005010.asm)): a(n) = 9*2^n.
* [A005015](http://oeis.org/A005015) ([program](A005015.asm)): 11*2^n.
* [A005029](http://oeis.org/A005029) ([program](A005029.asm)): 13*2^n.
* [A005030](http://oeis.org/A005030) ([program](A005030.asm)): a(n) = 5*3^n.
...
* [A006589](http://oeis.org/A006589) ([program](A006589.asm)): a(n) = (n+3)*2^n-1.
...
* [A007052](http://oeis.org/A007052) ([program](A007052.asm)): Number of order-consecutive partitions of n.
...
* [A007583](http://oeis.org/A007583) ([program](A007583.asm)): a(n) = (2^(2*n + 1) + 1)/3.
...
* [A008728](http://oeis.org/A008728) ([program](A008728.asm)): Molien series for 3-dimensional group [2,n ] = *22n.
...
* [A013730](http://oeis.org/A013730) ([program](A013730.asm)): a(n) = 2^(3n+1).
...
* [A014480](http://oeis.org/A014480) ([program](A014480.asm)): Expansion of (1+2*x)/(1-2*x)^2.
...
* [A024023](http://oeis.org/A024023) ([program](A024023.asm)): a(n) = 3^n - 1.
...
* [A025192](http://oeis.org/A025192) ([program](A025192.asm)): a(0)=1; a(n) = 2*3^(n-1) for n >= 1.
...
* [A027471](http://oeis.org/A027471) ([program](A027471.asm)): a(n) = (n-1)*3^(n-2), n > 0.
...
* [A029858](http://oeis.org/A029858) ([program](A029858.asm)): a(n) = (3^n - 3)/2.
...
* [A033488](http://oeis.org/A033488) ([program](A033488.asm)): a(n) = n*(n+1)*(n+2)*(n+3)/6.
...
* [A036294](http://oeis.org/A036294) ([program](A036294.asm)): a(n) = n * 8^n.
...
* [A048489](http://oeis.org/A048489) ([program](A048489.asm)): a(n) = 7 * 2^n - 6.
* [A048490](http://oeis.org/A048490) ([program](A048490.asm)): a(n)=T(7,n), array T given by A048483.
* [A048491](http://oeis.org/A048491) ([program](A048491.asm)): a(n) = T(8,n), array T given by A048483.
...
* [A048497](http://oeis.org/A048497) ([program](A048497.asm)): a(n) = 2^(n-1)*(4*n - 6) + 4.
...
* [A049624](http://oeis.org/A049624) ([program](A049624.asm)): Essentially the same as A032766.
...
* [A050915](http://oeis.org/A050915) ([program](A050915.asm)): a(n) = n*4^n + 1.
...
* [A051667](http://oeis.org/A051667) ([program](A051667.asm)): a(n) = 6*2^n - 4*n - 6.
...
* [A052481](http://oeis.org/A052481) ([program](A052481.asm)): a(n) = 2^n*(binomial(n,2) + 1).
...
* [A054492](http://oeis.org/A054492) ([program](A054492.asm)): a(n) = 3*a(n-1) - a(n-2), a(0)=1, a(1)=6.
...
* [A055588](http://oeis.org/A055588) ([program](A055588.asm)): a(n) = 3a(n-1) - a(n-2) - 1 with a(0)=1, a(1)=2.
...
* [A056449](http://oeis.org/A056449) ([program](A056449.asm)): a(n) = 3^floor((n+1)/2).
...
* [A061278](http://oeis.org/A061278) ([program](A061278.asm)): a(n) = 5*a(n-1) - 5*a(n-2) + a(n-3) with a(1) = 1 and a(k) = 0 if k <= 0.
...
* [A069403](http://oeis.org/A069403) ([program](A069403.asm)): a(n) = 2*Fibonacci(2*n+1)-1.
...
* [A074227](http://oeis.org/A074227) ([program](A074227.asm)): Duplicate of A042965.
...
* [A081007](http://oeis.org/A081007) ([program](A081007.asm)): Fibonacci(4n+1)-1, or Fibonacci(2n)*Lucas(2n+1).
...
* [A081294](http://oeis.org/A081294) ([program](A081294.asm)): Expansion of (1-2*x)/(1-4*x).
...
* [A083420](http://oeis.org/A083420) ([program](A083420.asm)): a(n) = 2*4^n - 1.
...
* [A085409](http://oeis.org/A085409) ([program](A085409.asm)): Sum of three solutions of the Diophantine equation x^2 - y^2 = z^3.
...
* [A092811](http://oeis.org/A092811) ([program](A092811.asm)): Expansion of (1-4*x)/(1-8*x).
...
* [A095264](http://oeis.org/A095264) ([program](A095264.asm)): a(n) = 2^(n+2) - 3*n - 4.
...
* [A096045](http://oeis.org/A096045) ([program](A096045.asm)): a(n) = B(2*n,2)/B(2*n) (see comment).
...
* [A098713](http://oeis.org/A098713) ([program](A098713.asm)): a(n) = (2n+1)*2^(2n+1) - 1.
...
* [A099003](http://oeis.org/A099003) ([program](A099003.asm)): Number of 4 X n 0-1 matrices avoiding simultaneously the right angled numbered polyomino patterns (ranpp) (00;1), (10;0) and (11;0).

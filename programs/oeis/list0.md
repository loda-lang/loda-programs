...
* [A001091](http://oeis.org/A001091) ([L14 program](A001091.asm)): a(n) = 8a(n-1) - a(n-2); a(0) = 1, a(1) = 4.
...
* [A002798](http://oeis.org/A002798) ([L22 program](A002798.asm)): a(n) = a(n-2)+a(n-3)-a(n-5).
...
* [A004923](http://oeis.org/A004923) ([L14 program](A004923.asm)): Floor of n*phi^8, where phi is the golden ratio, A001622.
* [A004925](http://oeis.org/A004925) ([L19 program](A004925.asm)): Floor of n*phi^10, where phi is the golden ratio, A001622.
* [A004927](http://oeis.org/A004927) ([L20 program](A004927.asm)): Floor of n*phi^12, where phi is the golden ratio, A001622.
...
* [A004960](http://oeis.org/A004960) ([L14 program](A004960.asm)): a(n) = ceiling(n*phi^5), where phi is the golden ratio, A001622.
* [A004963](http://oeis.org/A004963) ([L09 program](A004963.asm)): a(n) = ceiling(n*phi^8), where phi is the golden ratio, A001622.
* [A004964](http://oeis.org/A004964) ([L26 program](A004964.asm)): a(n) = ceiling(n*phi^9), where phi is the golden ratio, A001622.
* [A004965](http://oeis.org/A004965) ([L23 program](A004965.asm)): a(n) = ceiling(n*phi^10), where phi is the golden ratio, A001622.
* [A004967](http://oeis.org/A004967) ([L09 program](A004967.asm)): a(n) = ceiling(n*phi^12), where phi is the golden ratio, A001622.
* [A004968](http://oeis.org/A004968) ([L22 program](A004968.asm)): a(n) = ceiling(n*phi^13), where phi is the golden ratio, A001622.
* [A004972](http://oeis.org/A004972) ([L22 program](A004972.asm)): a(n) = ceiling(n*phi^17), where phi is the golden ratio, A001622.
...
* [A011763](http://oeis.org/A011763) ([L10 program](A011763.asm)): Days in year in Gregorian calendar.
...
* [A013574](http://oeis.org/A013574) ([L18 program](A013574.asm)): Minimal scope of an (n,2) difference triangle.
...
* [A016851](http://oeis.org/A016851) ([L16 program](A016851.asm)): (5n)^3.
...
* [A020703](http://oeis.org/A020703) ([L23 program](A020703.asm)): Take the sequence of natural numbers (A000027) and reverse successive subsequences of lengths 1,3,5,7,...
...
* [A024926](http://oeis.org/A024926) ([L18 program](A024926.asm)): a(n) = sum of [ p(k)/k ], k = 1,2,3,...,n.
...
* [A026049](http://oeis.org/A026049) ([L21 program](A026049.asm)): a(n) = dot_product(1,2,...,n)*(7,8,...,n,1,2,3,4,5,6).
...
* [A027000](http://oeis.org/A027000) ([L20 program](A027000.asm)): a(n) = Lucas(2n+3) - (6n+4).
...
* [A027138](http://oeis.org/A027138) ([L20 program](A027138.asm)): a(n) = Sum{(k+1)*T(n,2n-k)}, 0<=k<=2n, T given by A027113.
...
* [A028438](http://oeis.org/A028438) ([L22 program](A028438.asm)): Golc sequence in base 8. Left to right concatenation of n,int(log_8(n)),int(log_8(int(log_8(n)))),... in base8.
* [A028439](http://oeis.org/A028439) ([L20 program](A028439.asm)): Golc sequence in base 9. Left to right concatenation of n,int(log_9(n)),int(log_9(int(log_9(n)))),... in base9.
* [A028440](http://oeis.org/A028440) ([L24 program](A028440.asm)): Golc sequence in base 10. Left to right concatenation of n,int(log_10(n)),int(log_10(int(log_10(n)))),... in base 10.
...
* [A028837](http://oeis.org/A028837) ([L18 program](A028837.asm)): Iterated sum of digits of n is a square.
...
* [A040506](http://oeis.org/A040506) ([L08 program](A040506.asm)): Continued fraction for sqrt(530).
...
* [A043628](http://oeis.org/A043628) ([L11 program](A043628.asm)): Numbers n such that base 8 representation has exactly 6 runs.
* [A043630](http://oeis.org/A043630) ([L11 program](A043630.asm)): Numbers n such that base 8 representation has exactly 8 runs.
* [A043633](http://oeis.org/A043633) ([L11 program](A043633.asm)): Numbers n such that base 9 representation has exactly 4 runs.
* [A043635](http://oeis.org/A043635) ([L11 program](A043635.asm)): Numbers n such that base 9 representation has exactly 6 runs.
* [A043637](http://oeis.org/A043637) ([L11 program](A043637.asm)): Numbers n such that base 9 representation has exactly 8 runs.
...
* [A043644](http://oeis.org/A043644) ([L14 program](A043644.asm)): Numbers n such that base 10 representation has exactly 8 runs.
...
* [A043659](http://oeis.org/A043659) ([L18 program](A043659.asm)): Numbers n such that base 13 representation has exactly 4 runs.
...
* [A043669](http://oeis.org/A043669) ([L29 program](A043669.asm)): Numbers n such that base 15 representation has exactly 2 runs.
...
* [A043704](http://oeis.org/A043704) ([L29 program](A043704.asm)): Numbers n such that number of runs in the base 15 representation of n is even.
...
* [A047405](http://oeis.org/A047405) ([L18 program](A047405.asm)): Numbers that are congruent to {0, 1, 2, 3, 6} mod 8.
...
* [A047415](http://oeis.org/A047415) ([L28 program](A047415.asm)): Numbers that are congruent to {1, 3, 4, 6} mod 8.
...
* [A047508](http://oeis.org/A047508) ([L16 program](A047508.asm)): Numbers that are congruent to {1, 4, 6, 7} mod 8.
...
* [A047839](http://oeis.org/A047839) ([L16 program](A047839.asm)): a(n) = n + floor( sqrt(2*n) ).
...
* [A051941](http://oeis.org/A051941) ([L10 program](A051941.asm)): Truncated triangular pyramid numbers: a(n)=sum(k*(k+1)/2-30,k=8..n).
...
* [A059826](http://oeis.org/A059826) ([L14 program](A059826.asm)): a(n) = (n^2 - n + 1)*(n^2 + n + 1).
...
* [A060641](http://oeis.org/A060641) ([L23 program](A060641.asm)): Surround numbers of a length 2n zig-zag.
...
* [A063118](http://oeis.org/A063118) ([L17 program](A063118.asm)): Dimension of the space of weight 2n cusp forms for Gamma_0(50).
* [A063120](http://oeis.org/A063120) ([L07 program](A063120.asm)): Dimension of the space of weight 2n cusp forms for Gamma_0( 52 ).
* [A063121](http://oeis.org/A063121) ([L17 program](A063121.asm)): Dimension of the space of weight 2n cusp forms for Gamma_0( 53 ).
...
* [A063157](http://oeis.org/A063157) ([L16 program](A063157.asm)): Dimension of the space of weight 2n cusp forms for Gamma_0( 89 ).
* [A063158](http://oeis.org/A063158) ([L13 program](A063158.asm)): Dimension of the space of weight 2n cusp forms for Gamma_0( 90 ).
* [A063159](http://oeis.org/A063159) ([L21 program](A063159.asm)): Dimension of the space of weight 2n cusp forms for Gamma_0( 91 ).
...
* [A063232](http://oeis.org/A063232) ([L14 program](A063232.asm)): Dimension of the space of weight 2n cuspidal newforms for Gamma_0( 77 ).
...
* [A063243](http://oeis.org/A063243) ([L14 program](A063243.asm)): Duplicate of A063232.
...
* [A067870](http://oeis.org/A067870) ([L17 program](A067870.asm)): Numbers k such that k and 3^k end with the same digit.
* [A068037](http://oeis.org/A068037) ([L09 program](A068037.asm)): Number of subsets of {1,2,3,...,n} that sum to 0 mod 16.
* [A068073](http://oeis.org/A068073) ([L12 program](A068073.asm)): Period 4 sequence [ 1, 2, 3, 2, ...].
...
* [A074231](http://oeis.org/A074231) ([L18 program](A074231.asm)): Numbers n such that Kronecker(8,n) = mu(gcd(8,n)).
...
* [A074837](http://oeis.org/A074837) ([L21 program](A074837.asm)): Numbers n such that the penultimate 3 divisors of n sum to n.
...
* [A077425](http://oeis.org/A077425) ([L15 program](A077425.asm)): a(n) == 1 (mod 4) (see A016813), but not a square (i.e., not in A000290).
...
* [A081555](http://oeis.org/A081555) ([L15 program](A081555.asm)): a(n)=6a(n-1)-a(n-2)-4, a(0)=3, a(1)=7.
...
* [A085259](http://oeis.org/A085259) ([L19 program](A085259.asm)): Integer part of the conversion from Centigrade to Fahrenheit.
...
* [A088648](http://oeis.org/A088648) ([L34 program](A088648.asm)): a(1) = 1, then the smallest odd number not occurring earlier such that the concatenation a(r), a(s) is composite for all s > r.
...
* [A092841](http://oeis.org/A092841) ([L14 program](A092841.asm)): Numerator of I(n)=(integral_{x=0 to 1/(4^n)}(1-x^.5)^2 dx). E.g. I(3)=323/24576. The denominator is b(n)=96*16^(n-1). E.g. b(3)=24576.

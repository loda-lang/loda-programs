...
; Formula: a(n) = ((d(3*n)+1)/(c(3*n)/(10^n)+1))%10, b(n) = 4*c(n-1)+3*d(n-1)+b(n-1), b(2) = 19, b(1) = 3, b(0) = 0, c(n) = 7*c(n-1)+4*d(n-1)+b(n-1), c(2) = 31, c(1) = 4, c(0) = 0, d(n) = (2*c(n-1)+d(n-1))/4, d(2) = 2, d(1) = 0, d(0) = 1

...
; Formula: a(n) = 2*b(n-1)+c(n-1)+1, a(3) = 5, a(2) = 2, a(1) = 1, a(0) = 0, b(n) = b(n-1)+c(n-1), b(3) = 3, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = 2*c(n-1)-c(n-3)-a(n-2)+c(n-2)+a(n-3), c(5) = 15, c(4) = 8, c(3) = 4, c(2) = 2, c(1) = 1, c(0) = 0

...
; Formula: a(n) = 2*b(n-1)+c(n-1)+1, a(3) = 5, a(2) = 2, a(1) = 1, a(0) = 0, b(n) = b(n-1)+b(n-2)+d(n-2)+1, b(3) = 3, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = b(n-1)+d(n-1)+1, c(3) = 4, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = d(n-1)+d(n-2)+1, d(3) = 4, d(2) = 2, d(1) = 1, d(0) = 0

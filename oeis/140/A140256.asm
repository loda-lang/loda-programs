...
; Formula: a(n) = min(A126988(n),1)*((gcd(max(A126988(min(A126988(n),1)*(n-1)+1)-1,0)+1,2^(max(A126988(min(A126988(n),1)*(n-1)+1)-1,0)+1)-2)-1)*(-2*truncate((A143731(max(A126988(min(A126988(n),1)*(n-1)+1)-1,0))+1)/2)+A143731(max(A126988(min(A126988(n),1)*(n-1)+1)-1,0))+1)+1)

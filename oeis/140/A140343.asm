...
; Formula: a(n) = b(max(n-3,0))/5, b(n) = 3*e(n-1)+2*d(n-1)-b(n-1)+c(n-1)-5, b(3) = 45, b(2) = 20, b(1) = 5, b(0) = 0, c(n) = c(n-1)+d(n-1), c(3) = 10, c(2) = 10, c(1) = 5, c(0) = 0, d(n) = -b(n-1)+d(n-1), d(3) = -20, d(2) = 0, d(1) = 5, d(0) = 5, e(n) = 3*e(n-1)-3*e(n-2)+5, e(3) = 50, e(2) = 20, e(1) = 5, e(0) = 0

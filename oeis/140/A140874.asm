...
; Formula: a(n) = 2*binomial(floor((sqrtint(8*n-8)-1)/2)+2,-binomial(floor((sqrtint(8*n-8)-1)/2)+1,2)+n)-binomial(floor((sqrtint(8*n-8)-1)/2)+4,-binomial(floor((sqrtint(8*n-8)-1)/2)+1,2)+n)

...
; Formula: a(n) = A121362(n+1)*(-A001511(n+1)+2)*(-1)^n

mov $1,-1
pow $1,$0
mov $2,$0
add $2,1
seq $2,1511 ; The ruler function: exponent of the highest power of 2 dividing 2n. Equivalently,  the 2-adic valuation of 2n.
sub $2,2
mul $2,-1
add $0,1

...
; Formula: a(n) = d(n+1), b(n) = 2*c(n-1)+2*d(n-1), b(3) = 64, b(2) = 12, b(1) = 2, b(0) = 0, c(n) = 4*d(n-1)+b(n-1)+c(n-1)+e(n-1), c(3) = 116, c(2) = 18, c(1) = 5, c(0) = 0, d(n) = b(n-1)+c(n-1)+e(n-1), d(3) = 60, d(2) = 14, d(1) = 1, d(0) = 1, e(n) = 4*d(n-1)+2*c(n-1)+2*d(n-1)+b(n-1)+c(n-1)+e(n-1), e(3) = 180, e(2) = 30, e(1) = 7, e(0) = 1

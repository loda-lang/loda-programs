...
; 0,1,2,2,4,3,3,5,5,6,5,5,5,6,6,6,7,7,7,7,6,8,9,6,5,8,7,9,8,9,6,8,8,9,7,9,8,8,10,8,8,11,8,6,10,12,10,9,9,11,9,8,8,8,8,11,9,9,8,9,8,12,7,8,7,10,8,7,9,9,10,9,10,8,9,10,11,9,11,7
; Formula: a(n) = A081308(A000040(n+1)-1)

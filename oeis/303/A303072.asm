...
; Formula: a(n) = (c(n+1)+1)^2, b(n) = -b(n-1)-e(n-1)+b(n-2)+b(n-5)+d(n-1)+e(n-2)+e(n-3)+1, b(7) = 3, b(6) = 2, b(5) = 2, b(4) = 1, b(3) = 1, b(2) = 0, b(1) = 1, b(0) = 0, c(n) = -b(n-2)+b(n-1)+d(n-2)+e(n-1), c(5) = 3, c(4) = 3, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = b(n-1), d(5) = 1, d(4) = 1, d(3) = 0, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = 2*b(n-1)-d(n-1)+e(n-1), e(5) = 4, e(4) = 3, e(3) = 1, e(2) = 2, e(1) = 0, e(0) = 0

...
; Formula: a(n) = c(n+2), b(n) = 2*b(n-1), b(3) = 8, b(2) = 4, b(1) = 2, b(0) = 1, c(n) = max(d(n-2),1)*(b(n-1)+max(d(n-2),1)), c(3) = 21, c(2) = 3, c(1) = 6, c(0) = 0, d(n) = max(d(n-1),1)+max(d(n-2),1), d(3) = 7, d(2) = 4, d(1) = 3, d(0) = 0

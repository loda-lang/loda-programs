...
; Formula: a(n) = truncate((d(n+2)-9)/6)+1, b(n) = 2*c(n-1)+c(n-2), b(4) = 102, b(3) = 27, b(2) = 6, b(1) = 3, b(0) = 0, c(n) = 3*c(n-1)+3*c(n-2)+c(n-3), c(4) = 174, c(3) = 45, c(2) = 12, c(1) = 3, c(0) = 1, d(n) = 3*c(n-1)-d(n-1)+b(n-1), d(3) = 33, d(2) = 9, d(1) = 3, d(0) = 0

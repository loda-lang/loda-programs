...
; Formula: a(n) = min(n,n%2)*c(n)+b(n), b(n) = -2*d(n-2)*b(n-2)+c(n-2), b(7) = 23, b(6) = 23, b(5) = -5, b(4) = -5, b(3) = 1, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = b(n-2)*(-4*d(n-2)-2)+c(n-2)*(-2*d(n-2)-1), c(7) = 35, c(6) = 35, c(5) = 3, c(4) = 3, c(3) = -3, c(2) = -3, c(1) = 1, c(0) = 1, d(n) = d(n-2)+1, d(7) = 3, d(6) = 3, d(5) = 2, d(4) = 2, d(3) = 1, d(2) = 1, d(1) = 0, d(0) = 0

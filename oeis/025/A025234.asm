...
; Formula: a(n) = d(n)/2+1, b(n) = b(n-1)+d(n-1)+2, b(5) = 82, b(4) = 26, b(3) = 10, b(2) = 2, b(1) = 2, b(0) = 0, c(n) = f1(n-1), c(5) = 42, c(4) = 16, c(3) = 2, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = 2*e(n-1)-f(n-1)+b(n-1)+c(n-1), d(5) = 164, d(4) = 54, d(3) = 14, d(2) = 6, d(1) = -2, d(0) = 0, e(n) = -f(n-1)+b(n-1)+c(n-1)+d(n-1)+e(n-1)+2, e(5) = 166, e(4) = 54, e(3) = 16, e(2) = 6, e(1) = 0, e(0) = 0, f(n) = -b(n-1)-d(n-1)-f(n-1)+c(n-1)-2, f(5) = -52, f(4) = -14, f(3) = -10, f(2) = 2, f(1) = -4, f(0) = 2, f1(n) = b(n-1)+d(n-1)+e(n-1)+2, f1(5) = 136, f1(4) = 42, f1(3) = 16, f1(2) = 2, f1(1) = 2, f1(0) = 0

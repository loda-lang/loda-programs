...
; Formula: a(n) = (n-1)*(max(truncate(A062876(n)/4)-2,0)+2)-A151799((n-1)*(max(truncate(A062876(n)/4)-2,0)+2)+max(truncate(A062876(n)/4)-2,0))-10*truncate(((n-1)*(max(truncate(A062876(n)/4)-2,0)+2)-A151799((n-1)*(max(truncate(A062876(n)/4)-2,0)+2)+max(truncate(A062876(n)/4)-2,0))+max(truncate(A062876(n)/4)-2,0)+A194899(1)-1)/10)+max(truncate(A062876(n)/4)-2,0)+A194899(1)-2

...
; Formula: a(n) = d(n+1), b(n) = c(n-2)+e(n-2)+f(n-2)+1, b(6) = 8, b(5) = 5, b(4) = 3, b(3) = 2, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = max(e(n-2),1), c(6) = 5, c(5) = 2, c(4) = 1, c(3) = 1, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = b(n-1), d(6) = 5, d(5) = 3, d(4) = 2, d(3) = 1, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = b(n-1)+e(n-1)+f(n-1), e(6) = 16, e(5) = 9, e(4) = 5, e(3) = 2, e(2) = 1, e(1) = 0, e(0) = 0, f(n) = b(n-2), f(6) = 3, f(5) = 2, f(4) = 1, f(3) = 1, f(2) = 0, f(1) = 0, f(0) = 0

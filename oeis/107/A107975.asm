...
; Formula: a(n) = a(n-1)+truncate(b(n-1)/c(n-1)), a(2) = 10, a(1) = 5, a(0) = 0, b(n) = 10*(-truncate(b(n-1)/c(n-1))*c(n-1)+b(n-1))*10^logint(a(n-1)+truncate(b(n-1)/c(n-1)),10)+a(n-1)+truncate(b(n-1)/c(n-1)), b(2) = 10, b(1) = 5, b(0) = 5, c(n) = c(n-1)*10^logint(a(n-1)+truncate(b(n-1)/c(n-1)),10), c(2) = 10, c(1) = 1, c(0) = 1

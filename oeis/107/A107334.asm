...
; Formula: a(n) = 2*b(n-1)+2*c(n-1), a(3) = 20, a(2) = 10, a(1) = 2, a(0) = 3, b(n) = 2*b(n-2)+2*c(n-2)+b(n-1), b(3) = 13, b(2) = 3, b(1) = 1, b(0) = 1, c(n) = 2*b(n-2)+2*c(n-2)+b(n-1)+c(n-1), c(3) = 20, c(2) = 7, c(1) = 4, c(0) = 0

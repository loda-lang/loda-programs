...
; Formula: a(n) = b(n-1), a(5) = -1, a(4) = -1, a(3) = 0, a(2) = 0, a(1) = 1, a(0) = 0, b(n) = (-a(n-1)-a(n-2)+c(n-1)+c(n-2))/(-1), b(5) = -1, b(4) = -1, b(3) = -1, b(2) = 0, b(1) = 0, b(0) = 1, c(n) = -b(n-3)-d(n-2)+b(n-1)+b(n-2)+c(n-2), c(5) = -1, c(4) = 0, c(3) = 0, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = -c(n-1)+a(n-1)+d(n-1), d(5) = -2, d(4) = -1, d(3) = -1, d(2) = 0, d(1) = 0, d(0) = 0

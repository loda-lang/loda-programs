...
; Formula: a(n) = c(n+5), b(n) = c(n-2), b(7) = 0, b(6) = 1, b(5) = 0, b(4) = 0, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = e(n-2), c(7) = 1, c(6) = 1, c(5) = 0, c(4) = 1, c(3) = 0, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = b(n-1), d(7) = 1, d(6) = 0, d(5) = 0, d(4) = 0, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = -f(n-2)+b(n-1)+c(n-1)+d(n-2)+e(n-1)+1, e(7) = 3, e(6) = 2, e(5) = 1, e(4) = 1, e(3) = 0, e(2) = 1, e(1) = 0, e(0) = 0, f(n) = -f(n-1)+d(n-1)+2, f(7) = 2, f(6) = 0, f(5) = 2, f(4) = 0, f(3) = 2, f(2) = 0, f(1) = 2, f(0) = 0

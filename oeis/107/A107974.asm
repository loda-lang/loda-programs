...
; Formula: a(n) = a(n-1)+truncate(b(n-1)/c(n-1)), a(2) = 6, a(1) = 3, a(0) = 1, b(n) = 10*(-truncate(b(n-1)/c(n-1))*c(n-1)+b(n-1))*10^logint(a(n-1)+truncate(b(n-1)/c(n-1)),10)+a(n-1)+truncate(b(n-1)/c(n-1)), b(2) = 6, b(1) = 3, b(0) = 2, c(n) = c(n-1)*10^logint(a(n-1)+truncate(b(n-1)/c(n-1)),10), c(2) = 1, c(1) = 1, c(0) = 1

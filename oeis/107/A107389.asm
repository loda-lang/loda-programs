...
; Formula: a(n) = b(n-1), a(3) = 2, a(2) = -1, a(1) = 1, a(0) = 0, b(n) = 3*b(n-1)+2*d(n-1)+c(n-1)+2, b(3) = 5, b(2) = 2, b(1) = -1, b(0) = 1, c(n) = b(n-1), c(3) = 2, c(2) = -1, c(1) = 1, c(0) = 0, d(n) = 3*b(n-1)+d(n-1)+1, d(3) = 6, d(2) = -1, d(1) = 1, d(0) = -3

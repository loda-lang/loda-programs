...
; Formula: a(n) = c(n)+3, b(n) = b(n-1)+d(n-1)+4, b(4) = 141, b(3) = 46, b(2) = 16, b(1) = 5, b(0) = 1, c(n) = d(n-1), c(4) = 91, c(3) = 26, c(2) = 7, c(1) = 0, c(0) = 0, d(n) = 2*b(n-1)+c(n-1)+d(n-1)+e(n-1)+3, d(4) = 289, d(3) = 91, d(2) = 26, d(1) = 7, d(0) = 0, e(n) = b(n-1)+c(n-1)+d(n-1)+e(n-1)+5, e(4) = 245, e(3) = 77, e(2) = 23, e(1) = 6, e(0) = 0

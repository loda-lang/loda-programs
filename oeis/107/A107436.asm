...
; Formula: a(n) = truncate(c(n-1)/b(n-1)), a(2) = 2, a(1) = 1, a(0) = 1, b(n) = truncate(c(n-1)/b(n-1))*b(n-1), b(2) = 6, b(1) = 3, b(0) = 3, c(n) = truncate(c(n-1)/b(n-1))*c(n-1)+b(n-1), c(2) = 15, c(1) = 6, c(0) = 3

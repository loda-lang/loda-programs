...
; Formula: a(n) = c(max(n-1,0))/4, b(n) = 4*b(n-1)+2*b(n-1)+2*d(n-1), b(2) = 220, b(1) = 36, b(0) = 6, c(n) = 2*b(n-1)+2*c(n-1), c(2) = 96, c(1) = 12, c(0) = 0, d(n) = min(2*b(n-1)+d(n-1),3)-1, d(2) = 2, d(1) = 2, d(0) = 0

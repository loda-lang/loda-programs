...
; Formula: a(n) = 2*c(n)+4, b(n) = b(n-1)+c(n-1)+2, b(3) = 50, b(2) = 11, b(1) = 2, b(0) = 0, c(n) = 2*c(n-1)+e(n-1)+7, c(3) = 165, c(2) = 37, c(1) = 7, c(0) = 0, d(n) = -b(n-1)-c(n-1)-d(n-1)-2, d(3) = -41, d(2) = -9, d(1) = -2, d(0) = 0, e(n) = 4*e(n-1)-2*d(n-1)+16, e(3) = 370, e(2) = 84, e(1) = 16, e(0) = 0

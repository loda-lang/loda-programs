...
; Formula: a(n) = A156552(truncate((A181819(A181811(truncate((A057335(2*n+1)-1)/A293810(A057335(2*n+1)-1))+1)*(truncate((A057335(2*n+1)-1)/A293810(A057335(2*n+1)-1))+1))-3)/2)+1)

...
; Formula: a(n) = c(n)+1, b(n) = b(n-1)+c(n-2)+1, b(6) = 28, b(5) = 13, b(4) = 5, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = 3*b(n-2)-e(n-1)-f(n-1)+b(n-1)+b(n-3)+c(n-1)+c(n-4)+1, c(8) = 296, c(7) = 144, c(6) = 60, c(5) = 31, c(4) = 14, c(3) = 7, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = 4*b(n-1), d(6) = 52, d(5) = 20, d(4) = 12, d(3) = 8, d(2) = 4, d(1) = 0, d(0) = 0, e(n) = -f(n-1)+e(n-1), e(6) = -20, e(5) = -8, e(4) = -4, e(3) = 0, e(2) = 0, e(1) = 0, e(0) = 0, f(n) = -e(n-1)-f(n-1)+d(n-1), f(6) = 16, f(5) = 12, f(4) = 4, f(3) = 4, f(2) = 0, f(1) = 0, f(0) = 0

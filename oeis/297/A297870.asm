...
; Formula: a(n) = 2*b(n-1)-e(n-1)+d(n-1)+a(n-1), a(4) = 11, a(3) = 2, a(2) = 3, a(1) = 1, a(0) = 0, b(n) = 2*b(n-1)-c(n-1)-e(n-1)+d(n-1), b(4) = 0, b(3) = 3, b(2) = -1, b(1) = 1, b(0) = 0, c(n) = 3*d(n-1)+2*b(n-1)-2*c(n-1)-3*e(n-1), c(4) = -3, c(3) = 9, c(2) = -4, c(1) = 3, c(0) = 0, d(n) = 2*b(n-1)-e(n-1)+d(n-1)+a(n-1), d(4) = 11, d(3) = 2, d(2) = 3, d(1) = 1, d(0) = 1, e(n) = 2*b(n-1)-e(n-1)+d(n-1), e(4) = 9, e(3) = -1, e(2) = 2, e(1) = 1, e(0) = 0

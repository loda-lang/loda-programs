...
; Formula: a(n) = f(n+4)/2, b(n) = 2*c(n-1)+2*f(n-2)+b(n-2)+b(n-3)+f(n-1)+f(n-3), b(6) = 120, b(5) = 54, b(4) = 14, b(3) = 6, b(2) = 4, b(1) = 0, b(0) = 0, c(n) = 2*e(n-1)+2, c(6) = 74, c(5) = 38, c(4) = 18, c(3) = 2, c(2) = 2, c(1) = 2, c(0) = 0, d(n) = 2*f(n-1)+b(n-1)+d(n-1), d(6) = 126, d(5) = 36, d(4) = 18, d(3) = 8, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = 2*f(n-1)+b(n-1)+d(n-1), e(6) = 126, e(5) = 36, e(4) = 18, e(3) = 8, e(2) = 0, e(1) = 0, e(0) = 0, f(n) = c(n-1), f(6) = 38, f(5) = 18, f(4) = 2, f(3) = 2, f(2) = 2, f(1) = 0, f(0) = 0

...
; Formula: a(n) = binomial(floor((sqrtint(8*n)+1)/2)+1,-binomial(floor((sqrtint(8*n)+1)/2),2)+n+1)*(-binomial(floor((sqrtint(8*n)+1)/2),2)+n+1)-binomial(floor((sqrtint(8*n)+1)/2)+1,-binomial(floor((sqrtint(8*n)+1)/2),2)+n+1)

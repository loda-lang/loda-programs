...
; Formula: a(n) = truncate((32*c(n)+64)/3)-21, b(n) = truncate((-c(n-1)+b(n-1)+120)/2), b(2) = 81, b(1) = 58, b(0) = 0, c(n) = 4*c(n-1)*gcd(d(n-1)+truncate((-c(n-1)+b(n-1)+120)/2)-1,4)^2, c(2) = 1024, c(1) = 16, c(0) = 4, d(n) = floor((gcd(d(n-1)+truncate((-c(n-1)+b(n-1)+120)/2)-1,4)^2)/2), d(2) = 8, d(1) = 0, d(0) = 0

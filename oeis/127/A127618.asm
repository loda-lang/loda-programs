...
; Formula: a(n) = truncate(b(n)/2), b(n) = d(n-1)+2, b(2) = 11, b(1) = 2, b(0) = 2, c(n) = 3*c(n-1)+2*b(n-1)+d(n-1)+1, c(2) = 29, c(1) = 5, c(0) = 0, d(n) = 5*c(n-1)+4*b(n-1)+d(n-1)+1, d(2) = 43, d(1) = 9, d(0) = 0

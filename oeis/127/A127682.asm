...
; Formula: a(n) = b(n-1)+1, a(4) = 1, a(3) = 1, a(2) = 1, a(1) = 1, a(0) = 0, b(n) = -truncate((b(n-1)+b(n-3)+1)/(b(n-2)+b(n-4)+2))*(b(n-2)+b(n-4)+2)+b(n-1)+b(n-3)+1, b(6) = 1, b(5) = 0, b(4) = 1, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0

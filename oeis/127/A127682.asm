...
; Formula: a(n) = c(n-1), b(n) = -truncate((b(n-1)+b(n-3)+1)/(b(n-2)+b(n-4)+2))*(b(n-2)+b(n-4)+2)+b(n-1)+b(n-3)+1, b(6) = 1, b(5) = 0, b(4) = 1, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = b(n-1)+1, c(4) = 1, c(3) = 1, c(2) = 1, c(1) = 1, c(0) = 0

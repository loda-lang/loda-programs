...
; Formula: a(n) = d(n-1)+1, a(4) = 1, a(3) = 1, a(2) = 1, a(1) = 1, a(0) = 0, b(n) = c(n-1)+1, b(4) = 2, b(3) = 2, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = c(n-1)%(c(n-2)+1)+c(n-3)%(c(n-4)+1)+1, c(4) = 2, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = c(n-1)%b(n-1), d(4) = 1, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0

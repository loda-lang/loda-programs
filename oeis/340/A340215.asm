...
; Formula: a(n) = -c(n-5)+a(n-1)+a(n-2)+a(n-6)+c(n-3), a(10) = 203, a(9) = 119, a(8) = 70, a(7) = 41, a(6) = 24, a(5) = 14, a(4) = 8, a(3) = 5, a(2) = 3, a(1) = 2, a(0) = 1, b(n) = a(n-1), b(5) = 8, b(4) = 5, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = -c(n-1)+b(n-1), c(5) = 3, c(4) = 2, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0

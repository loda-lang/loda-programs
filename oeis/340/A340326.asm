...
; Formula: a(n) = d(n+1), b(n) = e(n-1)*b(n-1)-b(n-1)+d(n-1), b(4) = 3, b(3) = 1, b(2) = 0, b(1) = -1, b(0) = 1, c(n) = c(n-1)+e(n-1), c(4) = 4, c(3) = 2, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = b(n-1)+c(n-1)+e(n-1), d(4) = 5, d(3) = 2, d(2) = 1, d(1) = 1, d(0) = 0, e(n) = -e(n-1)+max(e(n-1),2), e(4) = 0, e(3) = 2, e(2) = 0, e(1) = 2, e(0) = 0

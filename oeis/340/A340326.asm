...
; Formula: a(n) = c(n+1), b(n) = d(n-1)*b(n-1)-b(n-1)+c(n-1), b(4) = 3, b(3) = 1, b(2) = 0, b(1) = -1, b(0) = 1, c(n) = d(n-2)*b(n-2)-d(n-2)-2*b(n-2)+c(n-1)+c(n-2)+max(d(n-2),2), c(5) = 7, c(4) = 5, c(3) = 2, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = -d(n-1)+max(d(n-1),2), d(4) = 0, d(3) = 2, d(2) = 0, d(1) = 2, d(0) = 0

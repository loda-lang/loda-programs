...
; Formula: a(n) = b(n-1)+c(n-1)+d(n-1), a(4) = 7, a(3) = 5, a(2) = 2, a(1) = 1, a(0) = 1, b(n) = d(n-1)*b(n-1)-b(n-1)+a(n-1), b(4) = 2, b(3) = 3, b(2) = 1, b(1) = 0, b(0) = -1, c(n) = c(n-1)+d(n-1), c(4) = 4, c(3) = 4, c(2) = 2, c(1) = 2, c(0) = 0, d(n) = -d(n-1)+max(d(n-1),2), d(4) = 2, d(3) = 0, d(2) = 2, d(1) = 0, d(0) = 2

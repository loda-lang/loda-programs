...
; Formula: a(n) = b(n-1)+c(n-1), b(n) = 2*b(n-1)*2^(n-1), b(3) = 64, b(2) = 8, b(1) = 2, b(0) = 1, c(n) = (b(n-1)+c(n-1))*(2^(n-1)+d(n-1)), c(3) = 119, c(2) = 9, c(1) = 1, c(0) = 0, d(n) = 2^(n-1)+d(n-1), d(3) = 7, d(2) = 3, d(1) = 1, d(0) = 0

...
; Formula: a(n) = truncate(gcd(0,2*truncate(truncate((((2*n+1)!)^2)/gcd(A129814(2*n),((2*n+1)!)^2))/(-(2*n)^2+1)))/gcd(2*truncate(truncate((((2*n+1)!)^2)/gcd(A129814(2*n),((2*n+1)!)^2))/(-(2*n)^2+1)),2^(2*n)))

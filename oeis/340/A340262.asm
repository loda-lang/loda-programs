...
; Formula: a(n) = gcd(binomial(-floor((sqrtint(8*n+8)+1)/2),truncate((-binomial(floor((sqrtint(8*n+8)+1)/2),2)+n+1)/2))*(binomial(-1,-binomial(floor((sqrtint(8*n+8)+1)/2),2)+n+1)<=0),0)

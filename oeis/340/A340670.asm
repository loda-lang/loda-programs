...
; Formula: a(n) = c(n)+1, b(n) = 8*d(n-1)+4*e(n-1)-2*b(n-1), b(4) = -8, b(3) = -8, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = -2*d(n-1)+c(n-1), c(4) = 4, c(3) = 2, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 4*d(n-2)+2*e(n-2)-b(n-2)-c(n-2)-1, d(4) = -5, d(3) = -1, d(2) = -1, d(1) = 0, d(0) = 0, e(n) = 4*d(n-1)+2*e(n-1)-2*b(n-1), e(4) = 4, e(3) = -4, e(2) = 0, e(1) = 0, e(0) = 0

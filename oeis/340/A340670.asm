...
; Formula: a(n) = c(n)+1, b(n) = 8*d(n-1)+4*f(n-1)-2*b(n-1), b(4) = -8, b(3) = -8, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = -2*d(n-1)+c(n-1), c(4) = 4, c(3) = 2, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = -e(n-1)+b(n-1), d(4) = -5, d(3) = -1, d(2) = -1, d(1) = 0, d(0) = 0, e(n) = 4*d(n-1)+2*f(n-1)-b(n-1)+c(n-1)+1, e(4) = -1, e(3) = -3, e(2) = 1, e(1) = 1, e(0) = 0, f(n) = 4*d(n-1)+2*f(n-1)-2*b(n-1), f(4) = 4, f(3) = -4, f(2) = 0, f(1) = 0, f(0) = 0

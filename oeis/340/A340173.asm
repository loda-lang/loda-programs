...
; Formula: a(n) = 8*e(n+2)+8, b(n) = 15*b(n-1)+c(n-1)+1, b(3) = 7219, b(2) = 478, b(1) = 31, b(0) = 2, c(n) = 3*c(n-1)+12, c(3) = 156, c(2) = 48, c(1) = 12, c(0) = 0, d(n) = 7*d(n-1)+3*b(n-1), d(3) = 2379, d(2) = 135, d(1) = 6, d(0) = 0, e(n) = 7*d(n-1), e(3) = 945, e(2) = 42, e(1) = 0, e(0) = 0

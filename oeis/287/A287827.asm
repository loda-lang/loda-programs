...
; Formula: a(n) = 6*a(n-1)+4*c(n-1)+2*b(n-1)-3*d(n-1)+e(n-1), a(4) = 6404, a(3) = 742, a(2) = 86, a(1) = 10, a(0) = 1, b(n) = 2*b(n-1)+2*c(n-1), b(4) = 1348, b(3) = 156, b(2) = 18, b(1) = 2, b(0) = 0, c(n) = 5*a(n-1)+2*c(n-1)-3*d(n-1)+b(n-1)+e(n-1), c(4) = 4470, c(3) = 518, c(2) = 60, c(1) = 7, c(0) = 1, d(n) = 2*a(n-1)-2*d(n-1)+e(n-1), d(4) = 1190, d(3) = 138, d(2) = 16, d(1) = 2, d(0) = 0, e(n) = -d(n-1)+e(n-1), e(4) = -156, e(3) = -18, e(2) = -2, e(1) = 0, e(0) = 0

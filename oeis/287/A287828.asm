...
; Formula: a(n) = 6*a(n-1)+4*c(n-1)+2*b(n-1)-d(n-1), a(3) = 776, a(2) = 88, a(1) = 10, a(0) = 1, b(n) = 2*b(n-1)+2*c(n-1), b(3) = 160, b(2) = 18, b(1) = 2, b(0) = 0, c(n) = 5*a(n-1)+2*c(n-1)-d(n-1)+b(n-1), c(3) = 546, c(2) = 62, c(1) = 7, c(0) = 1, d(n) = 4*a(n-1)-d(n-1), d(3) = 316, d(2) = 36, d(1) = 4, d(0) = 0

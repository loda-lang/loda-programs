...
; Formula: a(n) = 3*a(n-1)+2*c(n-1)-d(n-1)-2*b(n-1), a(3) = 59, a(2) = 17, a(1) = 5, a(0) = 1, b(n) = b(n-1)+c(n-1), b(3) = 15, b(2) = 4, b(1) = 1, b(0) = 0, c(n) = 2*c(n-1)+a(n-1), c(3) = 39, c(2) = 11, c(1) = 3, c(0) = 1, d(n) = 2*a(n-1)-d(n-1)-2*b(n-1), d(3) = 20, d(2) = 6, d(1) = 2, d(0) = 0

...
; Formula: a(n) = 7*a(n-1)+2*c(n-1)-2*d(n-1)+b(n-1), a(3) = 561, a(2) = 71, a(1) = 9, a(0) = 1, b(n) = 2*b(n-1)+2*c(n-1), b(3) = 128, b(2) = 16, b(1) = 2, b(0) = 0, c(n) = 6*a(n-1)-2*d(n-1), c(3) = 378, c(2) = 48, c(1) = 6, c(0) = 1, d(n) = 3*a(n-1)-d(n-1), d(3) = 189, d(2) = 24, d(1) = 3, d(0) = 0

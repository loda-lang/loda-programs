...
; Formula: a(n) = c(n)+3, b(n) = 2*d(n-1)+c(n-1)+7, b(3) = 243, b(2) = 45, b(1) = 7, b(0) = 0, c(n) = b(n-1)+e(n-1)+1, c(3) = 194, c(2) = 28, c(1) = 2, c(0) = 0, d(n) = 3*c(n-1)+3*d(n-1)+b(n-1)+e(n-1)+17, d(3) = 606, d(2) = 104, d(1) = 18, d(0) = 0, e(n) = 4*d(n-1)+2*b(n-1)+2*c(n-1)+2*e(n-1)+18, e(3) = 876, e(2) = 148, e(1) = 20, e(0) = 1

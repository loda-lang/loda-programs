...
; Formula: a(n) = b(n+44)-270, b(n) = -truncate(A100892(A003726(b(n-1)+c(n-1)+829))/4)+b(n-1)+7, b(1) = 7, b(0) = 0, c(n) = -truncate(A100892(A003726(b(n-1)+c(n-1)+829))/4)+7, c(1) = 7, c(0) = 0

...
; Formula: a(n) = 9*a(n-1)+2*c(n-1)-3*d(n-1)+b(n-1)+e(n-1), a(4) = 9621, a(3) = 1005, a(2) = 105, a(1) = 11, a(0) = 1, b(n) = 2*b(n-1)+2*c(n-1), b(4) = 1840, b(3) = 192, b(2) = 20, b(1) = 2, b(0) = 0, c(n) = 8*a(n-1)-3*d(n-1)+e(n-1), c(4) = 6968, c(3) = 728, c(2) = 76, c(1) = 8, c(0) = 1, d(n) = 4*a(n-1)-2*d(n-1)+e(n-1), d(4) = 3292, d(3) = 344, d(2) = 36, d(1) = 4, d(0) = 0, e(n) = -d(n-1)+e(n-1), e(4) = -384, e(3) = -40, e(2) = -4, e(1) = 0, e(0) = 0

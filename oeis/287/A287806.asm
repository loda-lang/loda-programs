...
; Formula: a(n) = c(n)+1, b(n) = b(n-1)+c(n-1)+1, b(3) = 34, b(2) = 8, b(1) = 2, b(0) = 1, c(n) = 2*b(n-1)+2*c(n-1)+d(n-1)+2, c(3) = 113, c(2) = 25, c(1) = 5, c(0) = 0, d(n) = 4*c(n-1)+3*b(n-1)+2*d(n-1)-2*b(n-2)-2*c(n-2)+3, d(3) = 203, d(2) = 45, d(1) = 9, d(0) = 1

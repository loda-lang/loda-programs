...
; Formula: a(n) = 9*a(n-1)+2*c(n-1)-d(n-1)+b(n-1), a(3) = 1081, a(2) = 109, a(1) = 11, a(0) = 1, b(n) = 2*b(n-1)+2*c(n-1), b(3) = 200, b(2) = 20, b(1) = 2, b(0) = 0, c(n) = 8*a(n-1)-d(n-1), c(3) = 792, c(2) = 80, c(1) = 8, c(0) = 1, d(n) = 8*a(n-1)-d(n-1), d(3) = 792, d(2) = 80, d(1) = 8, d(0) = 0

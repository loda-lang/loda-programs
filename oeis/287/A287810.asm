...
; Formula: a(n) = 5*a(n-1)+2*c(n-1)-d(n-1)+b(n-1), a(3) = 241, a(2) = 41, a(1) = 7, a(0) = 1, b(n) = 2*b(n-1)+2*c(n-1), b(3) = 72, b(2) = 12, b(1) = 2, b(0) = 0, c(n) = 4*a(n-1)-d(n-1), c(3) = 140, c(2) = 24, c(1) = 4, c(0) = 1, d(n) = 4*a(n-1)-d(n-1), d(3) = 140, d(2) = 24, d(1) = 4, d(0) = 0

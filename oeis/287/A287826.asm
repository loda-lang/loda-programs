...
; Formula: a(n) = 6*a(n-1)+4*c(n-1)-2*d(n-1)-4*b(n-1), a(3) = 708, a(2) = 84, a(1) = 10, a(0) = 1, b(n) = b(n-1)+c(n-1), b(3) = 77, b(2) = 9, b(1) = 1, b(0) = 0, c(n) = 4*c(n-1)+4*a(n-1)-d(n-1)-2*b(n-1), c(3) = 574, c(2) = 68, c(1) = 8, c(0) = 1, d(n) = 2*a(n-1)-d(n-1)-2*b(n-1), d(3) = 134, d(2) = 16, d(1) = 2, d(0) = 0

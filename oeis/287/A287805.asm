...
; Formula: a(n) = 3*a(n-1)+2*c(n-1)-2*d(n-1)+b(n-1), a(3) = 73, a(2) = 19, a(1) = 5, a(0) = 1, b(n) = 2*b(n-1)+2*c(n-1), b(3) = 32, b(2) = 8, b(1) = 2, b(0) = 0, c(n) = 2*a(n-1)-2*d(n-1), c(3) = 30, c(2) = 8, c(1) = 2, c(0) = 1, d(n) = -d(n-1)+a(n-1), d(3) = 15, d(2) = 4, d(1) = 1, d(0) = 0

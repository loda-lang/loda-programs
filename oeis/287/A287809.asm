...
; Formula: a(n) = 5*a(n-1)+2*c(n-1)-3*d(n-1)+b(n-1)+e(n-1), a(4) = 1231, a(3) = 219, a(2) = 39, a(1) = 7, a(0) = 1, b(n) = 2*b(n-1)+2*c(n-1), b(4) = 384, b(3) = 68, b(2) = 12, b(1) = 2, b(0) = 0, c(n) = 4*a(n-1)-3*d(n-1)+e(n-1), c(4) = 696, c(3) = 124, c(2) = 22, c(1) = 4, c(0) = 1, d(n) = 2*a(n-1)-2*d(n-1)+e(n-1), d(4) = 314, d(3) = 56, d(2) = 10, d(1) = 2, d(0) = 0, e(n) = -d(n-1)+e(n-1), e(4) = -68, e(3) = -12, e(2) = -2, e(1) = 0, e(0) = 0

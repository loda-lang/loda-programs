...
; Formula: a(n) = 4*c(n-1)+4*a(n-1)+2*b(n-1)-d(n-1), a(3) = 366, a(2) = 54, a(1) = 8, a(0) = 1, b(n) = 2*b(n-1)+2*c(n-1), b(3) = 96, b(2) = 14, b(1) = 2, b(0) = 0, c(n) = 3*a(n-1)+2*c(n-1)-d(n-1)+b(n-1), c(3) = 230, c(2) = 34, c(1) = 5, c(0) = 1, d(n) = 2*a(n-1)-d(n-1), d(3) = 94, d(2) = 14, d(1) = 2, d(0) = 0

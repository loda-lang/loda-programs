...
; Formula: a(n) = 6*c(n-1)+5*a(n-1)+3*b(n-1)-d(n-1), a(3) = 1043, a(2) = 107, a(1) = 11, a(0) = 1, b(n) = 2*b(n-1)+2*c(n-1), b(3) = 196, b(2) = 20, b(1) = 2, b(0) = 0, c(n) = 4*c(n-1)+4*a(n-1)+2*b(n-1)-d(n-1), c(3) = 760, c(2) = 78, c(1) = 8, c(0) = 1, d(n) = 2*a(n-1)-d(n-1), d(3) = 194, d(2) = 20, d(1) = 2, d(0) = 0

...
; Formula: a(n) = 4*c(n-1)+2*b(n-1)+2*a(n-1), a(2) = 28, a(1) = 6, a(0) = 1, b(n) = 2*b(n-1)+2*c(n-1), b(2) = 10, b(1) = 2, b(0) = 0, c(n) = 6*c(n-1)-6*c(n-2), c(5) = 1476, c(4) = 312, c(3) = 66, c(2) = 14, c(1) = 3, c(0) = 1

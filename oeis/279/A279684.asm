...
; Formula: a(n) = -b(n-2)-d(n-1)-2*truncate((-b(n-2)-d(n-1)+c(n-1)+1)/2)+a(n-1)+b(n-1)+c(n-1)+e(n-1)+2, a(5) = 87, a(4) = 37, a(3) = 15, a(2) = 5, a(1) = 3, a(0) = 1, b(n) = 4*b(n-3)+2*b(n-1)-b(n-2)+4, b(6) = 140, b(5) = 56, b(4) = 24, b(3) = 12, b(2) = 4, b(1) = 0, b(0) = 0, c(n) = 2*a(n-1), c(5) = 74, c(4) = 30, c(3) = 10, c(2) = 6, c(1) = 2, c(0) = 0, d(n) = b(n-2)+d(n-1)+1, d(5) = 21, d(4) = 8, d(3) = 3, d(2) = 2, d(1) = 1, d(0) = 0, e(n) = a(n-1)+e(n-1), e(5) = 61, e(4) = 24, e(3) = 9, e(2) = 4, e(1) = 1, e(0) = 0

...
; Formula: a(n) = (2*a(n-2)-b(n-2)-c(n-1)+1)%2+a(n-1)+b(n-1)+d(n-1)+1, a(5) = 87, a(4) = 37, a(3) = 15, a(2) = 5, a(1) = 3, a(0) = 1, b(n) = 4*c(n-1)+b(n-1), b(5) = 56, b(4) = 24, b(3) = 12, b(2) = 4, b(1) = 0, b(0) = 0, c(n) = b(n-2)+c(n-1)+1, c(5) = 21, c(4) = 8, c(3) = 3, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = a(n-1)+d(n-1), d(5) = 61, d(4) = 24, d(3) = 9, d(2) = 4, d(1) = 1, d(0) = 0

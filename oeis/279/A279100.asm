...
; Formula: a(n) = min(n+1,(n+1)%2)*c(n+1)+b(n+1)+floor((n+1)/2)-2, b(n) = 2*b(n-2)+c(n-2), b(3) = 4, b(2) = 4, b(1) = 1, b(0) = 1, c(n) = 3*c(n-2)-c(n-4), c(6) = 18, c(5) = 7, c(4) = 7, c(3) = 3, c(2) = 3, c(1) = 2, c(0) = 2

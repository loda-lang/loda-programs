...
; Formula: a(n) = sqrtnint(2*(2*n+1)^2,2)*sqrtnint(2*(2*n+3)^2,2)-2*truncate((sqrtnint(2*(2*n+1)^2,2)*sqrtnint(2*(2*n+3)^2,2)+sqrtnint(2*(2*n+1)^2,2)+1)/2)+sqrtnint(2*(2*n+1)^2,2)+2

...
; Formula: a(n) = 2*f(n-1)-2, b(n) = 2*b(n-1)+2*c(n-2)+c(n-1)+1, b(6) = 111, b(5) = 52, b(4) = 24, b(3) = 11, b(2) = 5, b(1) = 2, b(0) = 1, c(n) = 3*c(n-2)+2*c(n-3)+1, c(5) = 4, c(4) = 1, c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 2*c(n-1)+f(n-1)+1, d(4) = 16, d(3) = 7, d(2) = 4, d(1) = 2, d(0) = 0, e(n) = b(n-1)+1, e(4) = 12, e(3) = 6, e(2) = 3, e(1) = 2, e(0) = 0, f(n) = 2*c(n-1)-e(n-1)+b(n-1)+d(n-1)+f(n-1)+1, f(4) = 28, f(3) = 13, f(2) = 6, f(1) = 3, f(0) = 1

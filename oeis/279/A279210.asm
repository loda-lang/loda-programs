...
; Formula: a(n) = A351563(A181819(A181811(truncate((A057335(A030101(n))-1)/A293810(A057335(A030101(n))-1))+1)*(truncate((A057335(A030101(n))-1)/A293810(A057335(A030101(n))-1))+1)))

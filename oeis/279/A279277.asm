...
; Formula: a(n) = b(n+1), b(n) = 2*b(n-1)+c(n-1)+d(n-1), b(3) = 12, b(2) = 4, b(1) = 1, b(0) = 0, c(n) = e(n-1), c(3) = 3, c(2) = 2, c(1) = 0, c(0) = 2, d(n) = 2*b(n-1)-d(n-1)+c(n-1)+d(n-1), d(3) = 10, d(2) = 2, d(1) = 2, d(0) = -1, e(n) = b(n-1)+c(n-1)+e(n-1), e(3) = 9, e(2) = 3, e(1) = 2, e(0) = 0

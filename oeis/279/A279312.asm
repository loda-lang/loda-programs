...
; Formula: a(n) = b(n)+1, b(n) = 2*d(n-1)+1, b(3) = 7, b(2) = 3, b(1) = 1, b(0) = 0, c(n) = 2*d(n-1)+2*d(n-2)-2*c(n-1)+1, c(3) = 3, c(2) = 3, c(1) = 0, c(0) = 0, d(n) = 2*c(n-2)+2*d(n-1)-2*d(n-2)+1, d(3) = 5, d(2) = 3, d(1) = 1, d(0) = 0

...
; Formula: a(n) = -a(n-1)+a(n-1)+b(n-1)+c(n-1), a(2) = 8, a(1) = -3, a(0) = 1, b(n) = -a(n-1)-b(n-1)-c(n-1)+a(n-1)+b(n-1), b(2) = -6, b(1) = 2, b(0) = -1, c(n) = 2*a(n-1)-a(n-1)-b(n-1)-2*c(n-1), c(2) = -17, c(1) = 6, c(0) = -2

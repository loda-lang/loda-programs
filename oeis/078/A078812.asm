...
; Formula: a(n) = gcd(binomial(2*binomial(floor((sqrtint(8*n+8)+1)/2),2)-2*n-2,-n+binomial(floor((sqrtint(8*n+8)+1)/2),2)+floor((sqrtint(8*n+8)+1)/2)-1),binomial(2*binomial(floor((sqrtint(8*n+8)+1)/2),2)-2*n-2,-n+binomial(floor((sqrtint(8*n+8)+1)/2),2)+floor((sqrtint(8*n+8)+1)/2)-1))

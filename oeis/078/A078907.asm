...
; Formula: a(n) = c(2*n), b(n) = truncate((3*b(n-2))/(d(n-2)-1))+1, b(5) = 4, b(4) = 4, b(3) = -2, b(2) = -2, b(1) = 1, b(0) = 1, c(n) = c(n-2)+truncate((3*b(n-2))/(d(n-2)-1))+1, c(5) = 3, c(4) = 3, c(3) = -1, c(2) = -1, c(1) = 1, c(0) = 1, d(n) = d(n-2)-1, d(5) = -2, d(4) = -2, d(3) = -1, d(2) = -1, d(1) = 0, d(0) = 0

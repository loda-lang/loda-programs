...
; Formula: a(n) = 3*n+2*floor((110*n+110)/34)-2*truncate((2*floor((110*n+110)/34)+2*n+truncate((4*n+2*floor((110*n+110)/34)+5)/2)+3)/2)+truncate((4*n+2*floor((110*n+110)/34)+5)/2)+4

...
; Formula: a(n) = 3*c(n-1)-3*a(n-1)-3*c(n-1)+a(n-1)+c(n-1), a(2) = 4, a(1) = -2, a(0) = 1, b(n) = a(n-1)+b(n-1), b(2) = -1, b(1) = 1, b(0) = 0, c(n) = -a(n-1)-c(n-1)+a(n-1)+b(n-1)+c(n-1), c(2) = 1, c(1) = 0, c(0) = 0

...
; 1,1,2,1,2,1,3,1,2,1,1,2,1,1,2,2,2,1,2,1,2,3,1,2,4,1,1,1,2,1,3,1,1,2,1,7,1,1,1,1,2,2,3,1,2,1,2,1,1,1,3,2,1,2,1,4,1,2,1,2,1,3,1,1,1,2,1,2,3,1,1,3,1,2,1,2,3,2,6,1,2,2,1,3,1,2,3,5,1,1,3,1,4,2,1,1,1,2,3,1
; Formula: a(n) = A067132(A055394(n)-1)-1

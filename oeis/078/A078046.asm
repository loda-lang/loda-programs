...
; Formula: a(n) = truncate(b(n+1)/2), b(n) = 2*c(n-1)+2*d(n-1)-b(n-1), b(2) = -4, b(1) = 2, b(0) = 0, c(n) = -c(n-1)-c(n-2)+c(n-3), c(5) = 3, c(4) = -3, c(3) = 1, c(2) = 1, c(1) = -1, c(0) = 1, d(n) = -d(n-2)-2*c(n-2), d(3) = 2, d(2) = -2, d(1) = 0, d(0) = 0

...
; Formula: a(n) = b(n+1), b(n) = 2*c(n-1)+2*d(n-1)-2*b(n-1)-2*d(n-1)+b(n-1)+d(n-1), b(2) = -3, b(1) = 1, b(0) = 0, c(n) = 2*b(n-1)+2*d(n-1)-2*b(n-1)-2*c(n-1)+2*(-2*d(n-1))+c(n-1)+d(n-1), c(2) = 1, c(1) = -1, c(0) = 0, d(n) = -b(n-1)-d(n-1)+d(n-1), d(2) = -1, d(1) = 0, d(0) = 1

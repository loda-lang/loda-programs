...
; Formula: a(n) = (b(n)+c(n)-2887)/2000+1, b(n) = 10*b(n-2)+13, b(2) = 24443, b(1) = 4443, b(0) = 2443, c(n) = 2*d(n-2)+4, c(2) = 4444, c(1) = 2444, c(0) = 444, d(n) = 10*d(n-2)+20, d(2) = 22220, d(1) = 12220, d(0) = 2220

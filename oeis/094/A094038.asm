...
; Formula: a(n) = b(n-1)+a(n-1), a(4) = 24, a(3) = 8, a(2) = 2, a(1) = 1, a(0) = 0, b(n) = 5*b(n-2)+2*c(n-2)-2*c(n-1)-2*d(n-2)+b(n-1)+a(n-2), b(4) = 60, b(3) = 16, b(2) = 6, b(1) = 1, b(0) = 1, c(n) = 2*c(n-1)-2*d(n-1), c(4) = -48, c(3) = -12, c(2) = -4, c(1) = 0, c(0) = 0, d(n) = 2*b(n-1), d(4) = 32, d(3) = 12, d(2) = 2, d(1) = 2, d(0) = 0

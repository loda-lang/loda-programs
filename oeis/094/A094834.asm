...
; Formula: a(n) = 4*a(n-1)-b(n-1)-truncate(c(n-1)/4), a(2) = 21, a(1) = 5, a(0) = 1, b(n) = 2*b(n-1)+truncate(c(n-1)/4), b(2) = -3, b(1) = -2, b(0) = -1, c(n) = 4*c(n-1)-4*b(n-2)-4*truncate(c(n-2)/4), c(3) = 84, c(2) = 20, c(1) = 4, c(0) = 0

...
; Formula: a(n) = 2*a(n-1)+b(n-1), a(5) = 10, a(4) = 6, a(3) = 1, a(2) = 1, a(1) = 0, a(0) = 0, b(n) = 3*b(n-3)+2*a(n-3)+2*b(n-2)-a(n-5)-b(n-1)-b(n-4)-b(n-5)+a(n-1), b(7) = 58, b(6) = 6, b(5) = 14, b(4) = -2, b(3) = 4, b(2) = -1, b(1) = 1, b(0) = 0

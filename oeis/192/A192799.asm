...
; Formula: a(n) = a(n-1)+c(n-1), a(5) = 5, a(4) = 2, a(3) = 2, a(2) = 0, a(1) = 1, a(0) = 0, b(n) = b(n-1)+b(n-2)+a(n-2)+c(n-2), b(5) = 7, b(4) = 4, b(3) = 1, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = 2*b(n-1)-c(n-1)+c(n-2)+c(n-3), c(5) = 7, c(4) = 3, c(3) = 0, c(2) = 2, c(1) = -1, c(0) = 1

...
; Formula: a(n) = (b(3*n+3)/(c(3*n+3)/(10^(n+1))))%10, b(n) = 7*b(n-1)-5*b(n-2)+b(n-3), b(5) = 3136, b(4) = 504, b(3) = 81, b(2) = 13, b(1) = 2, b(0) = 0, c(n) = 4*c(n-1)+2*d(n-1)+b(n-1), c(2) = 24, c(1) = 4, c(0) = 1, d(n) = 3*c(n-1)+2*d(n-1)+b(n-1), d(2) = 20, d(1) = 3, d(0) = 0

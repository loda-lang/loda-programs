...
; Formula: a(n) = 2*c(n-1)+a(n-1)+d(n-1), a(3) = 8, a(2) = 5, a(1) = 0, a(0) = 1, b(n) = 2*c(n-1)+a(n-1)+b(n-1)+d(n-1), b(3) = 13, b(2) = 5, b(1) = 0, b(0) = 0, c(n) = 2*a(n-1)+2*b(n-1)+c(n-1)+d(n-1)+1, c(3) = 20, c(2) = 4, c(1) = 2, c(0) = 0, d(n) = -d(n-1)-2*c(n-1), d(3) = -3, d(2) = -5, d(1) = 1, d(0) = -1

...
; Formula: a(n) = b(n-1), b(n) = 2*d(n-1)+c(n-1)+e(n-1), b(3) = 8, b(2) = 5, b(1) = 0, b(0) = 1, c(n) = b(n-1)+c(n-1)+d(n-1)+e(n-1), c(3) = 12, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = 2*b(n-1)+c(n-1), d(3) = 13, d(2) = 1, d(1) = 2, d(0) = 0, e(n) = c(n-1)+d(n-1)+e(n-1), e(3) = 7, e(2) = 3, e(1) = 0, e(0) = 0

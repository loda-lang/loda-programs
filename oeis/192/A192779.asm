...
; Formula: a(n) = 2*a(n-1)+d(n-1), a(5) = 12, a(4) = 7, a(3) = 1, a(2) = 1, a(1) = 0, a(0) = 0, b(n) = c(n-1), b(5) = 8, b(4) = 2, b(3) = 1, b(2) = 1, b(1) = 0, b(0) = 1, c(n) = 2*a(n-1)+b(n-1)+d(n-1), c(5) = 14, c(4) = 8, c(3) = 2, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = 2*a(n-1)-d(n-1)+b(n-1)+a(n-3)+d(n-2)+d(n-3), d(5) = 23, d(4) = -2, d(3) = 5, d(2) = -1, d(1) = 1, d(0) = 0

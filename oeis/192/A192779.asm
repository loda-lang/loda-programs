...
; Formula: a(n) = c(n-1), b(n) = 2*d(n-2)-e(n-2)+d(n-1), b(6) = 14, b(5) = 8, b(4) = 2, b(3) = 1, b(2) = 1, b(1) = 0, b(0) = 1, c(n) = 2*c(n-1)+d(n-1), c(5) = 12, c(4) = 7, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = 2*c(n-1)-d(n-1)+b(n-1)+e(n-1), d(5) = 23, d(4) = -2, d(3) = 5, d(2) = -1, d(1) = 1, d(0) = 0, e(n) = c(n-2)+d(n-1)+d(n-2), e(5) = 4, e(4) = 5, e(3) = 0, e(2) = 1, e(1) = 0, e(0) = 0

...
; Formula: a(n) = 2*a(n-1)+c(n-1), a(5) = 12, a(4) = 7, a(3) = 1, a(2) = 1, a(1) = 0, a(0) = 0, b(n) = 2*c(n-2)-d(n-2)+c(n-1), b(6) = 14, b(5) = 8, b(4) = 2, b(3) = 1, b(2) = 1, b(1) = 0, b(0) = 1, c(n) = 2*a(n-1)-c(n-1)+b(n-1)+d(n-1), c(5) = 23, c(4) = -2, c(3) = 5, c(2) = -1, c(1) = 1, c(0) = 0, d(n) = a(n-2)+c(n-1)+c(n-2), d(5) = 4, d(4) = 5, d(3) = 0, d(2) = 1, d(1) = 0, d(0) = 0

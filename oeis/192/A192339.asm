...
; Formula: a(n) = 4*a(n-2)+2*a(n-1)+b(n-3)+c(n-3), a(4) = 37, a(3) = 11, a(2) = 3, a(1) = 1, a(0) = 0, b(n) = 2*b(n-1)+b(n-2), b(4) = 17, b(3) = 7, b(2) = 3, b(1) = 1, b(0) = 1, c(n) = 2*b(n-1)+c(n-1), c(3) = 10, c(2) = 4, c(1) = 2, c(0) = 0

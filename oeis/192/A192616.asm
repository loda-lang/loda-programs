...
; Formula: a(n) = a(n-1)+a(n-2)+b(n-2)+c(n-1)+c(n-2)+d(n-1), a(5) = 6, a(4) = 2, a(3) = 1, a(2) = 1, a(1) = 0, a(0) = 1, b(n) = b(n-1)+c(n-1), b(5) = -2, b(4) = 3, b(3) = -2, b(2) = 1, b(1) = -1, b(0) = 0, c(n) = -c(n-1)+a(n-1)+c(n-2)+d(n-2), c(5) = 9, c(4) = -5, c(3) = 5, c(2) = -3, c(1) = 2, c(0) = -1, d(n) = c(n-1), d(5) = -5, d(4) = 5, d(3) = -3, d(2) = 2, d(1) = -1, d(0) = 0

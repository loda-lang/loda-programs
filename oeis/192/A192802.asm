...
; Formula: a(n) = b(n-1)+a(n-1), a(3) = 13, a(2) = 4, a(1) = 1, a(0) = 0, b(n) = 3*b(n-1)-2*a(n-1)-2*d(n-1), b(3) = 29, b(2) = 9, b(1) = 3, b(0) = 1, c(n) = 2*c(n-1)-b(n-1)+a(n-1)+d(n-1), c(3) = -20, c(2) = -5, c(1) = -1, c(0) = 0, d(n) = 2*c(n-1)-b(n-1)+a(n-1)+d(n-1), d(3) = -20, d(2) = -5, d(1) = -1, d(0) = 0

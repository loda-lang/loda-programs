...
; Formula: a(n) = 2*a(n-1)+c(n-1), a(5) = 8, a(4) = 5, a(3) = 1, a(2) = 1, a(1) = 0, a(0) = 0, b(n) = 3*a(n-3)+2*c(n-2)+a(n-4)+c(n-1)+c(n-3), b(10) = 309, b(9) = 142, b(8) = 57, b(7) = 29, b(6) = 10, b(5) = 6, b(4) = 2, b(3) = 1, b(2) = 1, b(1) = 0, b(0) = 1, c(n) = -c(n-1)+b(n-1)+a(n-3)+c(n-2)+c(n-3), c(5) = 7, c(4) = -2, c(3) = 3, c(2) = -1, c(1) = 1, c(0) = 0

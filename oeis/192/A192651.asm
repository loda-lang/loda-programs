...
; Formula: a(n) = 2*a(n-1)+c(n-1), a(5) = 8, a(4) = 5, a(3) = 1, a(2) = 1, a(1) = 0, a(0) = 0, b(n) = 2*a(n-2)+b(n-2)+c(n-2), b(5) = 6, b(4) = 2, b(3) = 1, b(2) = 1, b(1) = 0, b(0) = 1, c(n) = 3*a(n-3)+2*c(n-3)-c(n-1)+b(n-3)+c(n-2), c(5) = 7, c(4) = -2, c(3) = 3, c(2) = -1, c(1) = 1, c(0) = 0

...
; Formula: a(n) = d(n-1), b(n) = 2*d(n-1)+b(n-1)+e(n-1), b(3) = 8, b(2) = 5, b(1) = 0, b(0) = 1, c(n) = 2*d(n-1)+b(n-1)+c(n-1)+e(n-1), c(3) = 13, c(2) = 5, c(1) = 0, c(0) = 0, d(n) = 2*b(n-1)+2*c(n-1)+d(n-1)+e(n-1)+1, d(3) = 20, d(2) = 4, d(1) = 2, d(0) = 0, e(n) = -e(n-1)-2*d(n-1), e(3) = -3, e(2) = -5, e(1) = 1, e(0) = -1

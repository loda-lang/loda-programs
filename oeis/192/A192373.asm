...
; Formula: a(n) = 6*a(n-2)+3*b(n-2)+3*c(n-2)-c(n-2)-3*c(n-2)+a(n-2), a(3) = 8, a(2) = 7, a(1) = 0, a(0) = 1, b(n) = 3*b(n-1)+3*a(n-1), b(3) = 48, b(2) = 9, b(1) = 3, b(0) = 0, c(n) = -c(n-1)+a(n-1), c(3) = 8, c(2) = -1, c(1) = 1, c(0) = 0

...
; Formula: a(n) = 4*b(n-2)+3*c(n-2)-a(n-2)-2*a(n-1), a(3) = 10, a(2) = 2, a(1) = 1, a(0) = 0, b(n) = 3*b(n-1)+2*c(n-1), b(3) = 41, b(2) = 11, b(1) = 3, b(0) = 1, c(n) = b(n-1)+c(n-1), c(3) = 15, c(2) = 4, c(1) = 1, c(0) = 0

...
; Formula: a(n) = 2*c(n-1)+b(n-1)+d(n-1), a(5) = 7, a(4) = 2, a(3) = 1, a(2) = 1, a(1) = 0, a(0) = 1, b(n) = a(n-1), b(5) = 2, b(4) = 1, b(3) = 1, b(2) = 0, b(1) = 1, b(0) = 0, c(n) = 2*c(n-1)+d(n-1), c(5) = 6, c(4) = 1, c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = -d(n-1)+b(n-1)+c(n-1)+c(n-3)+d(n-2)+d(n-3), d(5) = -2, d(4) = 4, d(3) = -1, d(2) = 1, d(1) = 0, d(0) = 0

...
; Formula: a(n) = c(n-1), b(n) = 2*b(n-1)+d(n-1), b(5) = 6, b(4) = 1, b(3) = 1, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = 2*b(n-1)+c(n-2)+d(n-1), c(5) = 7, c(4) = 2, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 1, d(n) = 3*d(n-3)+2*b(n-3)+2*d(n-2)-b(n-5)-d(n-1)-d(n-4)-d(n-5)+b(n-1), d(7) = 6, d(6) = 14, d(5) = -2, d(4) = 4, d(3) = -1, d(2) = 1, d(1) = 0, d(0) = 0

...
; Formula: a(n) = a(n-1)+a(n-2)+b(n-2)+c(n-2), a(5) = 6, a(4) = 4, a(3) = 1, a(2) = 1, a(1) = 0, a(0) = 0, b(n) = b(n-1)+c(n-1), b(5) = 4, b(4) = 1, b(3) = 2, b(2) = 0, b(1) = 1, b(0) = 0, c(n) = -c(n-1)+a(n-1)+d(n-1), c(5) = 2, c(4) = 3, c(3) = -1, c(2) = 2, c(1) = -1, c(0) = 1, d(n) = a(n-2)+d(n-2), d(5) = 2, d(4) = 1, d(3) = 1, d(2) = 0, d(1) = 1, d(0) = 0

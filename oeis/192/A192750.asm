...
; Formula: a(n) = 5*((3*min(n,n%2)*c(n)+3*b(n)-9)/9)+1, b(n) = 2*b(n-2)+c(n-2), b(5) = 24, b(4) = 24, b(3) = 9, b(2) = 9, b(1) = 3, b(0) = 3, c(n) = b(n-2)+c(n-2), c(5) = 15, c(4) = 15, c(3) = 6, c(2) = 6, c(1) = 3, c(0) = 3

...
; Formula: a(n) = b(n-1), b(n) = b(n-1)+b(n-2)+c(n-2)+d(n-2), b(5) = 7, b(4) = 4, b(3) = 1, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = c(n-1)+d(n-1), c(5) = 5, c(4) = 2, c(3) = 2, c(2) = 0, c(1) = 1, c(0) = 0, d(n) = 3*d(n-2)-3*d(n-4)+d(n-1)+d(n-5)+d(n-6), d(8) = 55, d(7) = 32, d(6) = 10, d(5) = 7, d(4) = 3, d(3) = 0, d(2) = 2, d(1) = -1, d(0) = 1

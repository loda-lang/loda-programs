...
; Formula: a(n) = 2*a(n-1)+b(n-1)+c(n-1), a(3) = 15, a(2) = 4, a(1) = 1, a(0) = 0, b(n) = 3*a(n-2)+3*b(n-2)+2*c(n-2)-b(n-1), b(3) = 4, b(2) = 3, b(1) = 0, b(0) = 1, c(n) = 2*a(n-1)+2*b(n-1)+c(n-1), c(3) = 18, c(2) = 4, c(1) = 2, c(0) = 0

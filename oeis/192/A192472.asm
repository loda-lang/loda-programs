...
; Formula: a(n) = e(n)+1, b(n) = b(n-1)+c(n-1), b(3) = 12, b(2) = 4, b(1) = 2, b(0) = 0, c(n) = d(n-1)+e(n-1), c(3) = 20, c(2) = 8, c(1) = 2, c(0) = 2, d(n) = b(n-1)+c(n-1)+d(n-1), d(3) = 18, d(2) = 6, d(1) = 2, d(0) = 0, e(n) = 2*e(n-1)+c(n-1), e(3) = 36, e(2) = 14, e(1) = 6, e(0) = 2

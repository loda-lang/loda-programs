...
; Formula: a(n) = d(2*n+4)-1, b(n) = b(n-2)+c(n-2)+e(n-2), b(4) = 2, b(3) = 5, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = -c(n-2)+b(n-2)+c(n-2)+e(n-2)-3, c(4) = 2, c(3) = -3, c(2) = -3, c(1) = 5, c(0) = 0, d(n) = b(n-1)+c(n-1)+e(n-1), d(4) = 4, d(3) = 2, d(2) = 5, d(1) = 0, d(0) = 0, e(n) = b(n-1)+c(n-1)+e(n-1), e(4) = 4, e(3) = 2, e(2) = 5, e(1) = 0, e(0) = 0

...
; Formula: a(n) = b(n-1)+c(n-1), a(4) = 42, a(3) = 14, a(2) = 2, a(1) = 1, a(0) = 0, b(n) = 4*b(n-2)-b(n-1)+c(n-2), b(4) = 35, b(3) = -6, b(2) = 5, b(1) = -1, b(0) = 1, c(n) = 3*b(n-1)+3*b(n-2)+3*c(n-1)+3*c(n-2), c(5) = 735, c(4) = 168, c(3) = 48, c(2) = 9, c(1) = 3, c(0) = 0

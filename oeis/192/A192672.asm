...
; Formula: a(n) = sqrtint(truncate(d(n+1)/2)), b(n) = 3*b(n-1)+2*c(n-1)+truncate((2*b(n-1)+c(n-1))/(-n)), b(3) = -25, b(2) = -5, b(1) = -1, b(0) = -1, c(n) = 4*b(n-1)+3*c(n-1)+truncate((2*b(n-1)+c(n-1))/(-n)), c(3) = -38, c(2) = -8, c(1) = -2, c(0) = 0, d(n) = truncate((2*b(n-1)+c(n-1))/(-n)), d(3) = 6, d(2) = 2, d(1) = 2, d(0) = 0

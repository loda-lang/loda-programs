...
; Formula: a(n) = b(n-1)+c(n-1), a(4) = 84, a(3) = 28, a(2) = 4, a(1) = 2, a(0) = 0, b(n) = 4*b(n-2)-b(n-1)+c(n-2), b(4) = 70, b(3) = -12, b(2) = 10, b(1) = -2, b(0) = 2, c(n) = 3*b(n-1)+3*b(n-2)+3*c(n-1)+3*c(n-2), c(5) = 1470, c(4) = 336, c(3) = 96, c(2) = 18, c(1) = 6, c(0) = 0

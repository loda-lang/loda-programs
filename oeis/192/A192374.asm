...
; Formula: a(n) = 4*d(n-2)+3*b(n-2)+2*c(n-2), a(4) = 84, a(3) = 28, a(2) = 4, a(1) = 2, a(0) = 0, b(n) = 3*b(n-1)+3*d(n-1), b(4) = 372, b(3) = 66, b(2) = 24, b(1) = 0, b(0) = 0, c(n) = -c(n-1)+d(n-1), c(4) = 70, c(3) = -12, c(2) = 10, c(1) = -2, c(0) = 2, d(n) = 7*d(n-2)+3*b(n-2)-c(n-2), d(4) = 48, d(3) = 58, d(2) = -2, d(1) = 8, d(0) = 0

...
; Formula: a(n) = 2*a(n-1)-b(n-1)+c(n-1)+d(n-1), a(3) = 7, a(2) = 1, a(1) = 0, a(0) = 0, b(n) = 3*b(n-1)-2*c(n-1)-2*d(n-1), b(3) = -11, b(2) = -1, b(1) = 1, b(0) = 1, c(n) = b(n-1)+c(n-1), c(3) = 2, c(2) = 3, c(1) = 2, c(0) = 1, d(n) = 2*a(n-1)-b(n-1)+c(n-1)+d(n-1), d(3) = 7, d(2) = 1, d(1) = 0, d(0) = 0

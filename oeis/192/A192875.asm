...
; Formula: a(n) = truncate((b(n)+d(n))/2), b(n) = b(n-1)+d(n-1), b(4) = 23, b(3) = 7, b(2) = 3, b(1) = 1, b(0) = 2, c(n) = d(n-1), c(4) = 16, c(3) = 4, c(2) = 2, c(1) = -1, c(0) = 0, d(n) = 2*c(n-1)-f(n-1)+b(n-1)+d(n-1)+e(n-1)+1, d(4) = 52, d(3) = 16, d(2) = 4, d(1) = 2, d(0) = -1, e(n) = 4*b(n-1)+4*c(n-1)+4*d(n-1), e(4) = 108, e(3) = 36, e(2) = 8, e(1) = 4, e(0) = 0, f(n) = 2*c(n-1)-f(n-1)+b(n-1)+d(n-1)+e(n-1)+1, f(4) = 52, f(3) = 16, f(2) = 4, f(1) = 2, f(0) = 0

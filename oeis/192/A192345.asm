...
; Formula: a(n) = (2*b(n)+2*e(n)-2*c(n))/6, b(n) = 3*b(n-1)+3*d(n-1), b(4) = 144, b(3) = 27, b(2) = 9, b(1) = 0, b(0) = 0, c(n) = -c(n-1)+d(n-1), c(4) = 24, c(3) = -3, c(2) = 3, c(1) = 0, c(0) = 0, d(n) = 6*d(n-2)+3*b(n-2)+3*c(n-2)-c(n-2)-3*c(n-2)+d(n-2), d(4) = 24, d(3) = 21, d(2) = 0, d(1) = 3, d(0) = 0, e(n) = 6*d(n-2)+3*b(n-2)+3*c(n-2)-c(n-2)-3*c(n-2)+d(n-2), e(4) = 24, e(3) = 21, e(2) = 0, e(1) = 3, e(0) = 0

...
; Formula: a(n) = 2*a(n-1)+b(n-1)+c(n-1), a(3) = 10, a(2) = 3, a(1) = 1, a(0) = 0, b(n) = d(n-1), b(3) = 4, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = 2*a(n-1)+b(n-1), c(3) = 7, c(2) = 3, c(1) = 0, c(0) = 1, d(n) = 2*d(n-1)-c(n-1)+a(n-1)+b(n-1), d(3) = 9, d(2) = 4, d(1) = 1, d(0) = 1

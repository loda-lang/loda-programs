...
; Formula: a(n) = b(n)+d(n), b(n) = 2*b(n-1)+b(n-2), b(4) = 17, b(3) = 7, b(2) = 3, b(1) = 1, b(0) = 1, c(n) = 2*b(n-1)+c(n-1), c(3) = 10, c(2) = 4, c(1) = 2, c(0) = 0, d(n) = 4*d(n-2)+2*d(n-1)+b(n-3)+c(n-3), d(4) = 37, d(3) = 11, d(2) = 3, d(1) = 1, d(0) = 0

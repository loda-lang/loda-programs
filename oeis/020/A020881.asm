...
; Formula: a(n) = 4*truncate(b(n)/2)+2, b(n) = -2*d(n-1)+c(n-1)+3, b(2) = 8, b(1) = 3, b(0) = 0, c(n) = 2*b(n-1)+c(n-1)+1, c(2) = 8, c(1) = 1, c(0) = 0, d(n) = 2*d(n-1)-2*c(n-1)-4*b(n-1)-2, d(2) = -20, d(1) = -2, d(0) = 0

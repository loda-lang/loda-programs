...
; Formula: a(n) = f(n+5), b(n) = -f1(n-1)+b(n-1), b(6) = -4, b(5) = -1, b(4) = 0, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = 2*f(n-2)+c(n-1)+f1(n-2)+1, c(6) = 26, c(5) = 16, c(4) = 9, c(3) = 4, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = -d(n-1)+b(n-1)+e(n-1), d(6) = 5, d(5) = 3, d(4) = 1, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = c(n-1), e(6) = 16, e(5) = 9, e(4) = 4, e(3) = 1, e(2) = 0, e(1) = 0, e(0) = 0, f(n) = f(n-1)+f1(n-1)+1, f(6) = 10, f(5) = 6, f(4) = 4, f(3) = 3, f(2) = 2, f(1) = 1, f(0) = 0, f1(n) = -d(n-1)+e(n-1), f1(6) = 6, f1(5) = 3, f1(4) = 1, f1(3) = 0, f1(2) = 0, f1(1) = 0, f1(0) = 0

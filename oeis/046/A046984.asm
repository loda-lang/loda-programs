...
; Formula: a(n) = b(n+1)/10, b(n) = 2*b(n-1)+2*c(n-1), b(3) = 180, b(2) = 40, b(1) = 10, b(0) = 0, c(n) = 6*c(n-2)+6*d(n-2)+4*b(n-2)+2*c(n-1), c(3) = 260, c(2) = 50, c(1) = 10, c(0) = 5, d(n) = 6*d(n-1)+2*c(n-1), d(3) = 580, d(2) = 80, d(1) = 10, d(0) = 0

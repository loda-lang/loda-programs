...
; 2,3,3,3,3,5,2,4,4,4,3,5,2,4,5,4,2,7,2,5,4,4,3,6,3,4,4,4,3,8,2,4,5,3,4,8,2,3,4,6,3,7,2,5,6,4,2,7,2,5,4,4,3,8,4,6,3,4,2,9,2,3,6,4,4,7,2,4,5,6,2,9,2,4,6,3,3,8,2,6
; Formula: a(n) = A001222(A027760(2*n+1))

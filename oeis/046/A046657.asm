...
; Formula: a(n) = a(n-1)+A023022(n), a(0) = 1

mov $1,1
lpb $0
  mov $2,$0
  seq $2,23022 ; Number of partitions of n into two relatively prime parts. After initial term, this is the "half-totient" function phi(n)/2 (A000010(n)/2).
  sub $0,1
  add $1,$2
lpe
mov $0,$1

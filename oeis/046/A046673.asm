...
; Formula: a(n) = 2*truncate(d(n)/2), b(n) = b(n-1)+2, b(4) = 8, b(3) = 6, b(2) = 4, b(1) = 2, c(n) = c(n-1)*b(n-1)*(b(n-2)+1), c(3) = 1440, c(2) = 48, c(1) = 4, c(0) = 1, d(n) = (e(n-1)-1)*(d(n-1)*b(n-1)+c(n-1)), d(3) = 1320, d(2) = 36, d(1) = 2, d(0) = 0, e(n) = b(n-1)+2, e(3) = 8, e(2) = 6, e(1) = 4, e(0) = 3

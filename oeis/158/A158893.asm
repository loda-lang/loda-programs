...
; Formula: a(n) = 6*(-n+binomial(-floor((sqrtint(8*n)-1)/2),2)+floor((sqrtint(8*n)-1)/2)+1)*((-binomial(-floor((sqrtint(8*n)-1)/2),2)+n-1)==0)-n+binomial(-floor((sqrtint(8*n)-1)/2),2)+floor((sqrtint(8*n)-1)/2)+2

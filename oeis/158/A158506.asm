...
; Formula: a(n) = truncate((c(n+1)*b(n+1))/32), b(n) = e(n-1)*b(n-1), b(3) = 6144, b(2) = 64, b(1) = 16, b(0) = 16, c(n) = 2*c(n-1), c(3) = 16, c(2) = 8, c(1) = 4, c(0) = 2, d(n) = c(n-1)+d(n-1), d(3) = 14, d(2) = 6, d(1) = 2, d(0) = 0, e(n) = e(n-1)*c(n-1)*(c(n-1)+d(n-1)), e(3) = 10752, e(2) = 96, e(1) = 4, e(0) = 1

...
; Formula: a(n) = A081733(2*binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2)-n+truncate((sqrtint(8*n+8)-1)/2))*truncate(2^(2*binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2)-binomial(truncate((sqrtint(16*binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2)+8*truncate((sqrtint(8*n+8)-1)/2)-8*n+1)+1)/2),2)-n+truncate((sqrtint(8*n+8)-1)/2)))

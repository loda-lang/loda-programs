...
; Formula: a(n) = floor(b(7*n)/floor(floor(c(7*n)/(7^(n-1)))/2))%7, b(n) = 2*b(n-2)+2*c(n-2), b(3) = 2, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = 4*c(n-2)-2*c(n-4), c(6) = 14, c(5) = 4, c(4) = 4, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0

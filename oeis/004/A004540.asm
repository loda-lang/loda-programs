...
; Formula: a(n) = truncate((2*truncate(b(4*n)/truncate(c(4*n)/(3^n)))-6*truncate((2*truncate(b(4*n)/truncate(c(4*n)/(3^n))))/6))/2), b(n) = b(n-2)+c(n-2), b(3) = 2, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = 3*c(n-2)+b(n-2), c(3) = 4, c(2) = 4, c(1) = 1, c(0) = 1

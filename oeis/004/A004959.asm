...
; Formula: a(n) = e(n+1)-10, b(n) = (-c(n-1)+b(n-1))/2, b(3) = -4128, b(2) = -64, b(1) = -1, b(0) = 0, c(n) = 16*gcd(d(n-1)^203+(-c(n-1)+b(n-1))/2,4)*c(n-1), c(3) = 524288, c(2) = 8192, c(1) = 128, c(0) = 2, d(n) = gcd(d(n-1)^203+(-c(n-1)+b(n-1))/2,4)/2, d(3) = 2, d(2) = 2, d(1) = 2, d(0) = 5, e(n) = d(n-1)+e(n-1)+5, e(3) = 24, e(2) = 17, e(1) = 10, e(0) = 0

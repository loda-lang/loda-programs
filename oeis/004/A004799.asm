...
; Formula: a(n) = truncate(d(n)/3), b(n) = truncate((2*b(n-1)+2*c(n-1)+d(n-1))/n), b(4) = 33, b(3) = 21, b(2) = 12, b(1) = 9, b(0) = 3, c(n) = -2*b(n-1)-2*c(n-1), c(4) = -18, c(3) = -12, c(2) = -6, c(1) = -6, c(0) = 0, d(n) = 2*d(n-1)+e(n-1)+truncate((2*b(n-1)+2*c(n-1)+d(n-1))/n), d(4) = 240, d(3) = 114, d(2) = 51, d(1) = 18, d(0) = 3, e(n) = -d(n-1)-e(n-1)+truncate((2*b(n-1)+2*c(n-1)+d(n-1))/n), e(4) = -60, e(3) = -21, e(2) = -9, e(1) = 3, e(0) = 3

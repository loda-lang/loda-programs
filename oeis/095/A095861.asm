...
; Formula: a(n) = b(n)-1, b(n) = (b(n-2)+c(n-2))/(d(n-2)+1), b(7) = 2, b(6) = 2, b(5) = 2, b(4) = 2, b(3) = 1, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = 2*((b(n-4)+c(n-4))/(d(n-4)+1))+b(n-4)+c(n-4)+1, c(7) = 9, c(6) = 9, c(5) = 4, c(4) = 4, c(3) = 3, c(2) = 3, c(1) = 0, c(0) = 0, d(n) = d(n-2)+1, d(7) = 3, d(6) = 3, d(5) = 2, d(4) = 2, d(3) = 1, d(2) = 1, d(1) = 0, d(0) = 0

...
; Formula: a(n) = b(n+5), b(n) = 2*b(n-1)-c(n-4), b(5) = 1, b(4) = 0, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = 2*c(n-1)-c(n-3)-c(n-5)-2*c(n-4)+c(n-2)+1, c(6) = -5, c(5) = -4, c(4) = -3, c(3) = -2, c(2) = -1, c(1) = -1, c(0) = 0

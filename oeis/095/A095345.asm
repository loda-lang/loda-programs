...
; Formula: a(n) = 2*b(n-1)-4*truncate((-2*truncate(b(n-1)/2)+b(n-1)+2)/2)-4*truncate(b(n-1)/2)+5, b(n) = truncate(truncate((-c(n-1)+b(n-1))/2)/gcd(truncate((-c(n-1)+b(n-1))/2)+1,4)), b(1) = 0, b(0) = 0, c(n) = 4*truncate(c(n-1)/2), c(1) = 4, c(0) = 2

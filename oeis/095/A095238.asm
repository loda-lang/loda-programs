...
; Formula: a(n) = n*b(n-1), a(3) = 0, a(2) = 2, a(1) = 1, a(0) = 0, b(n) = -truncate((n*b(n-1)+c(n-1)+a(n-1))/(n+1))*(n+1)+n*b(n-1)+c(n-1)+a(n-1), b(3) = 3, b(2) = 0, b(1) = 1, b(0) = 1, c(n) = c(n-1)+a(n-1), c(3) = 3, c(2) = 1, c(1) = 0, c(0) = 0

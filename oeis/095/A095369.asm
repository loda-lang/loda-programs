...
; Formula: a(n) = f(n+2), b(n) = b(n-1)+d(n-1)+1, b(5) = 19, b(4) = 9, b(3) = 5, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = f(n-1), c(5) = 6, c(4) = 1, c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 2*d(n-2)+b(n-2)+f(n-2)+2, d(5) = 14, d(4) = 9, d(3) = 3, d(2) = 2, d(1) = 0, d(0) = 0, e(n) = -e(n-1)+b(n-1)+c(n-1), e(5) = 5, e(4) = 5, e(3) = 1, e(2) = 1, e(1) = 0, e(0) = 0, f(n) = 2*c(n-1)-2*e(n-1)+b(n-1)+f(n-1), f(5) = 7, f(4) = 6, f(3) = 1, f(2) = 1, f(1) = 0, f(0) = 0

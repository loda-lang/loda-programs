...
; Formula: a(n) = binomial((min(n,n%2)*b(n)+c(n))/3,2), b(n) = b(n-2)+c(n-2), b(5) = 12, b(4) = 12, b(3) = 6, b(2) = 6, b(1) = 6, b(0) = 6, c(n) = b(n-2)+2*c(n-2), c(5) = 18, c(4) = 18, c(3) = 6, c(2) = 6, c(1) = 0, c(0) = 0

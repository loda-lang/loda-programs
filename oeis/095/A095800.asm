...
; Formula: a(n) = truncate((truncate((-n+binomial(floor((sqrtint(8*n)-1)/2)+1,2)+floor((sqrtint(8*n)-1)/2)+gcd(-n-2*truncate((-n+binomial(floor((sqrtint(8*n)-1)/2)+1,2)+floor((sqrtint(8*n)-1)/2)+1)/2)+binomial(floor((sqrtint(8*n)-1)/2)+1,2)+floor((sqrtint(8*n)-1)/2)+1,2*n-2*binomial(floor((sqrtint(8*n)-1)/2)+1,2))+1)/2)*(2*n-2*binomial(floor((sqrtint(8*n)-1)/2)+1,2)))/2)

...
; Formula: a(n) = d(n+1), b(n) = -b(n-1)+b(n-1)+c(n-1)+d(n-1), b(2) = 9, b(1) = 3, b(0) = 0, c(n) = 2*c(n-1)-b(n-1)+b(n-1)+d(n-1), c(2) = 14, c(1) = 5, c(0) = 2, d(n) = 2*b(n-1)+2*c(n-1)-b(n-1)-d(n-1)+d(n-1), d(2) = 13, d(1) = 4, d(0) = 1

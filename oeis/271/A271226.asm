...
; Formula: a(n) = c(n+1)-1, b(n) = 3*b(n-1), b(3) = 27, b(2) = 9, b(1) = 3, b(0) = 1, c(n) = ((d(n-1)+1)^2+2*b(n-1))/b(n-1), c(3) = 4, c(2) = 3, c(1) = 3, c(0) = 0, d(n) = ((d(n-1)+1)^2+d(n-1)+2)%(3*b(n-1))-3*b(n-1), d(4) = -60, d(3) = -6, d(2) = -6, d(1) = -3, d(0) = 0

...
; Formula: a(n) = a(n-1)+d(n-1), a(3) = 13, a(2) = 4, a(1) = 1, a(0) = 1, b(n) = b(n-1)+a(n-1), b(3) = 7, b(2) = 3, b(1) = 2, b(0) = 1, c(n) = 2*c(n-1)+1, c(3) = 7, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = 2*c(n-1)+b(n-1)+a(n-1)+d(n-1)+1, d(3) = 23, d(2) = 9, d(1) = 3, d(0) = 0

...
; Formula: a(n) = d(n)+1, b(n) = -b(n-1)-c(n-1)+f(n-1)+1, b(4) = 1, b(3) = 0, b(2) = 0, b(1) = 1, b(0) = 0, c(n) = -b(n-1)+e(n-1), c(4) = -2, c(3) = -1, c(2) = -1, c(1) = 0, c(0) = 0, d(n) = -e(n-1)+b(n-1)+c(n-1)-1, d(4) = 0, d(3) = -1, d(2) = 0, d(1) = -1, d(0) = 0, e(n) = c(n-1)+d(n-1)+e(n-1), e(4) = -4, e(3) = -2, e(2) = -1, e(1) = 0, e(0) = 0, f(n) = -c(n-1)-2*b(n-1)+f(n-1), f(4) = 0, f(3) = -1, f(2) = -2, f(1) = 0, f(0) = 0

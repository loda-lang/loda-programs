...
; Formula: a(n) = b(n)+1, b(n) = -c(n-3)-c(n-6), b(8) = 7, b(7) = 4, b(6) = 2, b(5) = 2, b(4) = 0, b(3) = -1, b(2) = 0, b(1) = -1, b(0) = 0, c(n) = c(n-1)+c(n-3)+c(n-5)-1, c(7) = -15, c(6) = -9, c(5) = -6, c(4) = -4, c(3) = -2, c(2) = -1, c(1) = 0, c(0) = 0

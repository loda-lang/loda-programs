...
; Formula: a(n) = 2*b(n-1)+2*max(c(n-1)-2,0), b(n) = b(n-1)+truncate(c(n-1)/3)+2*n+9, b(4) = 51, b(3) = 33, b(2) = 18, b(1) = 5, b(0) = 0, c(n) = truncate(c(n-1)/3)+n, c(4) = 5, c(3) = 3, c(2) = 2, c(1) = 1, c(0) = 0

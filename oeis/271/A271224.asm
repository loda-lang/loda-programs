...
; Formula: a(n) = c(n+1), b(n) = 2*b(n-1)+b(n-1), b(2) = 9, b(1) = 3, b(0) = 1, c(n) = ((d(n-1)^3+5)%(2*b(n-1)+b(n-1)))/b(n-1), c(2) = 1, c(1) = 2, c(0) = 0, d(n) = (d(n-1)^3+5)%(2*b(n-1)+b(n-1))+1, d(2) = 6, d(1) = 3, d(0) = 0

...
; Formula: a(n) = if((A007947(n)^2)==1,A007947(n)^binomial(A001221(n)+A001222(n)-1,A001221(n)+1),if(binomial(A001221(n)+A001222(n)-1,A001221(n)+1)<=(-1),0,A007947(n)^binomial(A001221(n)+A001222(n)-1,A001221(n)+1)))

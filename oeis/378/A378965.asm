...
; Formula: a(n) = truncate(((min(n,n%2)*b(n)+c(n))*(min(n,n%2)*b(n)+c(n)+d(n)))/2), b(n) = 29*b(n-2)+24*c(n-2), b(5) = 13452, b(4) = 13452, b(3) = 396, b(2) = 396, b(1) = 12, b(0) = 12, c(n) = 6*b(n-2)+5*c(n-2), c(5) = 2786, c(4) = 2786, c(3) = 82, c(2) = 82, c(1) = 2, c(0) = 2, d(n) = d(n-2), d(5) = -1, d(4) = -1, d(3) = -1, d(2) = -1, d(1) = -1, d(0) = -1

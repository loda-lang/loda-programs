...
; Formula: a(n) = truncate((min(n-1,(n-1)%3)*(min(n-1,(n-1)%3)*d(n-1)+c(n-1))+b(n-1)-6)/2)+3, b(n) = 3*d(n-3)+2*b(n-3)+c(n-3), b(8) = 30, b(7) = 30, b(6) = 30, b(5) = 14, b(4) = 14, b(3) = 14, b(2) = 6, b(1) = 6, b(0) = 6, c(n) = 9*d(n-3)+7*c(n-3)+6*b(n-3), c(8) = 290, c(7) = 290, c(6) = 290, c(5) = 50, c(4) = 50, c(3) = 50, c(2) = 2, c(1) = 2, c(0) = 2, d(n) = -2*b(n-3)-2*c(n-3)-2*d(n-3), d(8) = -96, d(7) = -96, d(6) = -96, d(5) = -16, d(4) = -16, d(3) = -16, d(2) = 0, d(1) = 0, d(0) = 0

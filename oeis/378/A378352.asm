...
; Formula: a(n) = -10*truncate((floor((10^(n-1))/2)+truncate((4*b(max(4*n-3,0)))/truncate((4*c(max(4*n-3,0)))/(10^(n-1)))))/10)+floor((10^(n-1))/2)+truncate((4*b(max(4*n-3,0)))/truncate((4*c(max(4*n-3,0)))/(10^(n-1)))), b(n) = 2*b(n-1)+2*c(n-1), b(1) = 2, b(0) = 1, c(n) = 4*c(n-1)-2*c(n-2), c(3) = 14, c(2) = 4, c(1) = 1, c(0) = 0

...
; Formula: a(n) = truncate((d(n+1)-5)/2)+2, b(n) = -c(n-1)+b(n-1)+d(n-1), b(2) = 0, b(1) = 1, b(0) = 0, c(n) = 2*b(n-1)+2*d(n-1)-2*c(n-1)+max(c(n-1),1), c(2) = 3, c(1) = 3, c(0) = 0, d(n) = d(n-1)+max(c(n-1),1), d(2) = 5, d(1) = 2, d(0) = 1

...
; Formula: a(n) = c(n+2)/2, b(n) = max(e(n-2)-1,0), b(5) = 3, b(4) = 2, b(3) = 1, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = d(n-1)^2-d(n-2)^2-d(n-2)+d(n-1), c(5) = 8, c(4) = 6, c(3) = 4, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = e(n-1), d(5) = 6, d(4) = 4, d(3) = 3, d(2) = 2, d(1) = 1, d(0) = 0, e(n) = e(n-1)^0+b(n-1)+f(n-1)+1, e(5) = 9, e(4) = 6, e(3) = 4, e(2) = 3, e(1) = 2, e(0) = 1, f(n) = b(n-1)+f(n-1)+1, f(5) = 8, f(4) = 5, f(3) = 3, f(2) = 2, f(1) = 1, f(0) = 0

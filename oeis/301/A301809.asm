...
; Formula: a(n) = c(n+2)/2, b(n) = e(n-1)-1, b(5) = 7, b(4) = 4, b(3) = 2, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = d(n-1)^2-f(n-1)+d(n-1), c(5) = 18, c(4) = 6, c(3) = 4, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = e(n-1), d(5) = 8, d(4) = 5, d(3) = 3, d(2) = 2, d(1) = 1, d(0) = 0, e(n) = e(n-1)^0+b(n-1)+f1(n-1)+1, e(5) = 13, e(4) = 8, e(3) = 5, e(2) = 3, e(1) = 2, e(0) = 1, f(n) = e(n-2)^2-f(n-1)+e(n-2)+f(n-1), f(5) = 30, f(4) = 12, f(3) = 6, f(2) = 2, f(1) = 0, f(0) = 0, f1(n) = b(n-1)+f1(n-1)+1, f1(5) = 12, f1(4) = 7, f1(3) = 4, f1(2) = 2, f1(1) = 1, f1(0) = 0

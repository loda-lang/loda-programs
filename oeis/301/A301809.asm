...
; Formula: a(n) = c(n+2)/2, b(n) = d(n-1)-1, b(5) = 7, b(4) = 4, b(3) = 2, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = (d(n-3)^0+b(n-3)+e(n-3)+1)^2+d(n-3)^0-d(n-3)^2-d(n-3)+b(n-3)+e(n-3)+1, c(5) = 18, c(4) = 6, c(3) = 4, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = d(n-1)^0+b(n-1)+e(n-1)+1, d(5) = 13, d(4) = 8, d(3) = 5, d(2) = 3, d(1) = 2, d(0) = 1, e(n) = b(n-1)+e(n-1)+1, e(5) = 12, e(4) = 7, e(3) = 4, e(2) = 2, e(1) = 1, e(0) = 0

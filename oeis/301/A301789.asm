...
; Formula: a(n) = c(n+5)+2, b(n) = 2*b(n-3)+2*b(n-4)+2*e(n-4)-b(n-1)-b(n-4)-e(n-4)+b(n-1)+b(n-2)+b(n-4)+f(n-4)+2, b(5) = 20, b(4) = 11, b(3) = 6, b(2) = 3, b(1) = 2, b(0) = 1, c(n) = -d(n-1)+b(n-1)+e(n-1)+f(n-1), c(5) = 19, c(4) = 11, c(3) = 6, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = b(n-1), d(5) = 11, d(4) = 6, d(3) = 3, d(2) = 2, d(1) = 1, d(0) = 0, e(n) = b(n-1)+e(n-1), e(5) = 23, e(4) = 12, e(3) = 6, e(2) = 3, e(1) = 1, e(0) = 0, f(n) = -e(n-1)+b(n-1)+f(n-1), f(5) = 1, f(4) = 2, f(3) = 2, f(2) = 2, f(1) = 1, f(0) = 0

...
; Formula: a(n) = c(n+5)+2, b(n) = b(n-3)+d(n-1)+d(n-4)+e(n-3)+2, b(6) = 36, b(5) = 20, b(4) = 11, b(3) = 6, b(2) = 3, b(1) = 2, b(0) = 1, c(n) = b(n-1)+d(n-2)+e(n-1), c(5) = 19, c(4) = 11, c(3) = 6, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = b(n-1)+d(n-1), d(5) = 23, d(4) = 12, d(3) = 6, d(2) = 3, d(1) = 1, d(0) = 0, e(n) = -d(n-1)+b(n-1)+e(n-1), e(5) = 1, e(4) = 2, e(3) = 2, e(2) = 2, e(1) = 1, e(0) = 0

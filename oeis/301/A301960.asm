...
; Formula: a(n) = (2*(d(n+2)/2)-7)/2+5, b(n) = b(n-1)+c(n-1)+d(n-1)+2, b(5) = 128, b(4) = 48, b(3) = 18, b(2) = 6, b(1) = 2, b(0) = 0, c(n) = c(n-1)+d(n-1)+2, c(5) = 80, c(4) = 30, c(3) = 12, c(2) = 4, c(1) = 2, c(0) = 0, d(n) = 3*c(n-2)+3*d(n-2)+b(n-2)+e(n-2)+6, d(5) = 126, d(4) = 48, d(3) = 16, d(2) = 6, d(1) = 0, d(0) = 0, e(n) = c(n-1)+d(n-1)+e(n-1)+2, e(5) = 128, e(4) = 48, e(3) = 18, e(2) = 6, e(1) = 2, e(0) = 0

...
; Formula: a(n) = 4*b(n+1), b(n) = 2*b(n-1)+2*c(n-1)+2*d(n-1)+2*f(n-1)+e(n-1), b(5) = 3144, b(4) = 427, b(3) = 58, b(2) = 8, b(1) = 1, b(0) = 0, c(n) = 2*c(n-1)+2*f(n-1), c(5) = 766, c(4) = 104, c(3) = 14, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = 4*c(n-1)+4*f(n-1)+2*b(n-1)+2*d(n-1)+2*e(n-1)+2*f1(n-1), d(5) = 4876, d(4) = 662, d(3) = 90, d(2) = 12, d(1) = 2, d(0) = 0, e(n) = b(n-1)+c(n-1)+d(n-1)+f(n-1), e(5) = 1472, e(4) = 200, e(3) = 27, e(2) = 4, e(1) = 0, e(0) = 1, f(n) = 2*c(n-1)+2*f(n-1)+b(n-1)+d(n-1)+e(n-1), f(5) = 2055, f(4) = 279, f(3) = 38, f(2) = 5, f(1) = 1, f(0) = 0, f1(n) = 2*c(n-1)+2*f(n-1)+2*f1(n-1)+b(n-1)+d(n-1)+e(n-1), f1(5) = 2821, f1(4) = 383, f1(3) = 52, f1(2) = 7, f1(1) = 1, f1(0) = 0

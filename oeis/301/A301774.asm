...
; Formula: a(n) = 2*d(2*n), b(n) = d(n-3), b(4) = 1, b(3) = 1, b(2) = 2, b(1) = 0, b(0) = 0, c(n) = b(n-1)+c(n-1), c(4) = 3, c(3) = 2, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = b(n-1)+c(n-1)+d(n-1), d(4) = 6, d(3) = 3, d(2) = 1, d(1) = 1, d(0) = 1

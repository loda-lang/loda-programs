...
; Formula: a(n) = sumdigits(b(n+1),2)*sign(b(n+1))-1, b(n) = 2*bitxor(d(n-1),bitxor(c(n-1),b(n-1))), b(2) = 6, b(1) = 2, b(0) = 0, c(n) = bitxor(c(n-1),b(n-1)), c(2) = 2, c(1) = 0, c(0) = 0, d(n) = bitxor(d(n-1),bitxor(c(n-1),b(n-1))), d(2) = 3, d(1) = 1, d(0) = 1

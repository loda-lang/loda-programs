...
; Formula: a(n) = truncate(c(n+1)/2), b(n) = 3*b(n-1)+2*truncate(b(n-2)/2)-b(n-2)-2*truncate(b(n-1)/2), b(4) = 7, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = 2*b(n-1)-2*truncate(b(n-1)/2)+c(n-1), c(2) = 4, c(1) = 2, c(0) = 0

...
; Formula: a(n) = c(n)+1, b(n) = b(n-1)+b(n-2)+1, b(3) = 10, b(2) = 6, b(1) = 3, b(0) = 2, c(n) = d(n-1)+e(n-1), c(3) = 5, c(2) = 3, c(1) = 0, c(0) = 0, d(n) = b(n-1), d(3) = 6, d(2) = 3, d(1) = 2, d(0) = 0, e(n) = d(n-2)+e(n-1)+e(n-2)+1, e(3) = 6, e(2) = 2, e(1) = 1, e(0) = 0

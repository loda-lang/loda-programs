...
; Formula: a(n) = b(n+1)-1, b(n) = gcd((d(n-1)/2-c(n-1))/4+binomial(b(n-1),c(n-1)),4), b(2) = 2, b(1) = 4, b(0) = 0, c(n) = gcd((d(n-1)/2-c(n-1))/4+binomial(b(n-1),c(n-1)),4)*c(n-1), c(2) = 512, c(1) = 256, c(0) = 64, d(n) = (d(n-1)/2-c(n-1))/4, d(2) = -66, d(1) = -16, d(0) = 0

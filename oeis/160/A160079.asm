...
; Formula: a(n) = -a(n-2)+c(n-2)+3, a(4) = 3, a(3) = 2, a(2) = 4, a(1) = 1, a(0) = 0, b(n) = b(n-2)+d(n-2)+3, b(4) = 7, b(3) = 7, b(2) = 3, b(1) = 4, b(0) = 0, c(n) = b(n-1)+d(n-1), c(4) = 8, c(3) = 4, c(2) = 4, c(1) = 0, c(0) = 1, d(n) = (b(n-1)+d(n-1))%3, d(4) = 2, d(3) = 1, d(2) = 1, d(1) = 0, d(0) = 0

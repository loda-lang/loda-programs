...
; Formula: a(n) = d(n-3), b(n) = 2*n*b(n-1)*(2*n-1), b(4) = 40320, b(3) = 720, b(2) = 24, b(1) = 2, b(0) = 1, c(n) = 2*n*b(n-1)*(2*n-1)+c(n-1)*(2*n+1)^2, c(4) = 1285371, c(3) = 15371, c(2) = 299, c(1) = 11, c(0) = 1, d(n) = 2*n*b(n-1)*(2*n-1)+c(n-1)*(2*n+1)^2+d(n-1)*(2*n+3)^2, d(4) = 23364725, d(3) = 182474, d(2) = 2063, d(1) = 36, d(0) = 1

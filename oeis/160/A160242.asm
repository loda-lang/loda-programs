...
; Formula: a(n) = -10*truncate((c(4*n+1)-7)/10)+c(4*n+1)-7, b(n) = -b(n-1)+c(n-1)+truncate(b(n-1)/2), b(1) = 2, b(0) = 0, c(n) = gcd(truncate(b(n-1)/2),2)*(2*c(n-1)-2*b(n-1)+truncate(b(n-1)/2)), c(1) = 8, c(0) = 2

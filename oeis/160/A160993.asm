...
; Formula: a(n) = e(n+1), b(n) = e(n-3), b(6) = 1, b(5) = 0, b(4) = 1, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = b(n-1), c(6) = 0, c(5) = 1, c(4) = 0, c(3) = 0, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = b(n-1)+c(n-2)+d(n-1)+e(n-2), d(6) = 5, d(5) = 4, d(4) = 2, d(3) = 2, d(2) = 1, d(1) = 1, d(0) = 1, e(n) = -c(n-1)-e(n-1)+d(n-1), e(6) = 2, e(5) = 1, e(4) = 1, e(3) = 1, e(2) = 0, e(1) = 1, e(0) = 0

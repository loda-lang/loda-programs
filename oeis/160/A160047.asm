...
; Formula: a(n) = (b(max((n-1)/2+1,0))/gcd(c(max((n-1)/2+1,0)),b(max((n-1)/2+1,0))))/gcd(b(max((n-1)/2+1,0))/gcd(c(max((n-1)/2+1,0)),b(max((n-1)/2+1,0))),n+1), b(n) = n*b(n-1), b(2) = 2, b(1) = 1, b(0) = 1, c(n) = n*c(n-1)+b(n-1), c(2) = 3, c(1) = 1, c(0) = 0

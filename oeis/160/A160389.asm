...
; Formula: a(n) = ((b(3*n)+d(3*n))/(c(3*n)/(10^n)))%10, b(n) = b(n-1)+c(n-1), b(2) = -87, b(1) = 2, b(0) = 1, c(n) = 4*c(n-1)+2*b(n-1)+d(n-1)-95, c(2) = -539, c(1) = -89, c(0) = 1, d(n) = 2*c(n-1)+b(n-1)+d(n-1)-95, d(2) = -363, d(1) = -92, d(0) = 0

...
; Formula: a(n) = b(n)^min(n,n%2), b(n) = b(n-2)+2*c(n-2)+4, b(5) = 50, b(4) = 50, b(3) = 12, b(2) = 12, b(1) = 2, b(0) = 2, c(n) = 2*c(n-2)+b(n-2)+c(n-2)+6, c(5) = 69, c(4) = 69, c(3) = 17, c(2) = 17, c(1) = 3, c(0) = 3

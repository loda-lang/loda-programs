...
; Formula: a(n) = 2*truncate((-binomial(floor((sqrtint(8*n)-1)/2)+1,2)+n)/(floor((sqrtint(8*n)-1)/2)+1))-truncate((floor((sqrtint(8*n)-1)/2)+1)/(-binomial(floor((sqrtint(8*n)-1)/2)+1,2)+n))

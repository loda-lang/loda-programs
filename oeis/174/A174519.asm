...
; Formula: a(n) = truncate((-truncate((A060800(n+2)*max(A006005(n+1),2))/(max(A006005(n+1),2)+A060800(n+2)))*(max(A006005(n+1),2)+A060800(n+2))+A060800(n+2)*max(A006005(n+1),2))/2)

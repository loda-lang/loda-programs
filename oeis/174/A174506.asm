...
; Formula: a(n) = 2*truncate((d(4*n+3)-41)/41)+1, b(n) = 2*b(n-1)-b(n-2)+b(n-4), b(6) = 410, b(5) = 246, b(4) = 164, b(3) = 123, b(2) = 82, b(1) = 41, b(0) = 0, c(n) = b(n-1), c(5) = 164, c(4) = 123, c(3) = 82, c(2) = 41, c(1) = 0, c(0) = 0, d(n) = gcd(b(n-1)+c(n-1),b(n-1)), d(5) = 41, d(4) = 41, d(3) = 41, d(2) = 41, d(1) = 0, d(0) = 0

...
; Formula: a(n) = 2*((d(4*n+3)-41)/41)+1, b(n) = -c(n-1)+b(n-1), b(5) = 246, b(4) = 164, b(3) = 123, b(2) = 82, b(1) = 41, b(0) = 0, c(n) = -c(n-3)-2*b(n-3)+b(n-3)+c(n-1)+c(n-3), c(5) = -164, c(4) = -82, c(3) = -41, c(2) = -41, c(1) = -41, c(0) = -41, d(n) = gcd(2*b(n-2)-c(n-2),-c(n-2)+b(n-2)), d(5) = 41, d(4) = 41, d(3) = 41, d(2) = 41, d(1) = 0, d(0) = 0

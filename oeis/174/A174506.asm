...
; Formula: a(n) = 2*((e(4*n+3)-41)/41)+1, b(n) = -d(n-1)+b(n-1), b(5) = 246, b(4) = 164, b(3) = 123, b(2) = 82, b(1) = 41, b(0) = 0, c(n) = b(n-1), c(5) = 164, c(4) = 123, c(3) = 82, c(2) = 41, c(1) = 0, c(0) = 0, d(n) = -b(n-3)+d(n-1), d(5) = -164, d(4) = -82, d(3) = -41, d(2) = -41, d(1) = -41, d(0) = -41, e(n) = gcd(b(n-1)+c(n-1),b(n-1)), e(5) = 41, e(4) = 41, e(3) = 41, e(2) = 41, e(1) = 0, e(0) = 0

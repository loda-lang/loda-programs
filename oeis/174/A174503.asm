...
; Formula: a(n) = binomial(b(n+2),min(n+2,(n+2)%2)), b(n) = 8*d(n-2)+8, b(5) = 96, b(4) = 96, b(3) = 8, b(2) = 8, b(1) = 0, b(0) = 0, c(n) = 8*d(n-2)+c(n-2)+10, c(5) = 108, c(4) = 108, c(3) = 10, c(2) = 10, c(1) = 0, c(0) = 0, d(n) = 8*d(n-2)+c(n-2)+d(n-2)+11, d(5) = 120, d(4) = 120, d(3) = 11, d(2) = 11, d(1) = 0, d(0) = 0

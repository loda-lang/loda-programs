...
; Formula: a(n) = 11*b(n-1)-((c(n-1)^2+d(n-1)+2)%(11*b(n-1)))-3, a(3) = 578, a(2) = 94, a(1) = 6, a(0) = 0, b(n) = 11*b(n-1), b(3) = 1331, b(2) = 121, b(1) = 11, b(0) = 1, c(n) = (c(n-1)^2+d(n-1)+2)%(11*b(n-1))+3, c(3) = 753, c(2) = 27, c(1) = 5, c(0) = 0, d(n) = (c(n-1)^2+d(n-1)+2)%(11*b(n-1))-5, d(3) = 745, d(2) = 19, d(1) = -3, d(0) = 0

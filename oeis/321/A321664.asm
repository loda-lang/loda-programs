...
; Formula: a(n) = max(a(n-3)+a(n-5)+b(n-1)-1,0)+1, a(9) = 4, a(8) = 2, a(7) = 3, a(6) = 2, a(5) = 1, a(4) = 2, a(3) = 1, a(2) = 1, a(1) = 1, a(0) = 0, b(n) = -a(n-1)-b(n-1)+a(n-6)+a(n-7)+1, b(9) = 1, b(8) = 0, b(7) = 0, b(6) = 0, b(5) = 0, b(4) = -1, b(3) = 1, b(2) = -1, b(1) = 1, b(0) = 0

...
; Formula: a(n) = (a(n-1)^2+c(n-1)+2)%(8*b(n-1)+2*b(n-1)+b(n-1))+3, a(2) = 27, a(1) = 5, a(0) = 0, b(n) = 8*b(n-1)+2*b(n-1)+b(n-1), b(2) = 121, b(1) = 11, b(0) = 1, c(n) = (a(n-1)^2+c(n-1)+2)%(8*b(n-1)+2*b(n-1)+b(n-1))-5, c(2) = 19, c(1) = -3, c(0) = 0

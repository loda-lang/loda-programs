...
; Formula: a(n) = -c(n)+b(n), b(n) = 13*b(n-1), b(3) = 2197, b(2) = 169, b(1) = 13, b(0) = 1, c(n) = (d(n-1)^3+d(n-1)+4)%(13*b(n-1))+1, c(4) = 3395, c(3) = 1198, c(2) = 15, c(1) = 2, c(0) = 1, d(n) = (d(n-1)^3+d(n-1)+4)%(13*b(n-1))+1, d(4) = 3395, d(3) = 1198, d(2) = 15, d(1) = 2, d(0) = 0

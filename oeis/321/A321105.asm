...
; Formula: a(n) = -c(n)+b(n), b(n) = 13*b(n-1), b(3) = 2197, b(2) = 169, b(1) = 13, b(0) = 1, c(n) = (e(n-1)^3+d(n-1)+1)%(13*b(n-1))+1, c(3) = 1198, c(2) = 15, c(1) = 2, c(0) = 1, d(n) = (e(n-1)^3+d(n-1)+1)%(13*b(n-1))+4, d(3) = 1201, d(2) = 18, d(1) = 5, d(0) = 0, e(n) = (e(n-1)^3+d(n-1)+1)%(13*b(n-1))+1, e(3) = 1198, e(2) = 15, e(1) = 2, e(0) = 0

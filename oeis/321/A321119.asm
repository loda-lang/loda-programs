...
; Formula: a(n) = (4*min(n+1,(n+1)%2)*b(n+1)+4*c(n+1)-4)/2+2, b(n) = 2*c(n-2)+2*b(n-2)+c(n-2), b(5) = 9, b(4) = 9, b(3) = 3, b(2) = 3, b(1) = 3, b(0) = 3, c(n) = b(n-2)+2*c(n-2), c(5) = 5, c(4) = 5, c(3) = 1, c(2) = 1, c(1) = -1, c(0) = -1

...
; Formula: a(n) = 11*b(n-1)-((c(n-1)^2+d(n-1)+1)%(11*b(n-1)))-3, a(3) = 73, a(2) = 73, a(1) = 7, a(0) = 0, b(n) = 11*b(n-1), b(3) = 1331, b(2) = 121, b(1) = 11, b(0) = 1, c(n) = 2*((c(n-1)^2+d(n-1)+1)%(11*b(n-1)))+6, c(3) = 2516, c(2) = 96, c(1) = 8, c(0) = 0, d(n) = (c(n-1)^2+d(n-1)+1)%(11*b(n-1))-21, d(3) = 1234, d(2) = 24, d(1) = -20, d(0) = 0

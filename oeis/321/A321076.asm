...
; Formula: a(n) = c(n)/2, b(n) = 11*b(n-1), b(2) = 121, b(1) = 11, b(0) = 1, c(n) = 2*((c(n-1)^2+d(n-1)+1)%(11*b(n-1)))+6, c(2) = 96, c(1) = 8, c(0) = 0, d(n) = (c(n-1)^2+d(n-1)+1)%(11*b(n-1))-21, d(2) = 24, d(1) = -20, d(0) = 0

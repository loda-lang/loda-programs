...
; Formula: a(n) = sign(min(n,n%2)*b(n)+c(n))*((abs(min(n,n%2)*b(n)+c(n))-1)%3+1), b(n) = 3*b(n-2)-b(n-4), b(6) = 22, b(5) = 8, b(4) = 8, b(3) = 2, b(2) = 2, b(1) = -2, b(0) = -2, c(n) = 2*c(n-2)+b(n-2), c(3) = 6, c(2) = 6, c(1) = 4, c(0) = 4

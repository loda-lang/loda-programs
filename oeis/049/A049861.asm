...
; Formula: a(n) = c(n-1), a(4) = 8, a(3) = 5, a(2) = 3, a(1) = 2, a(0) = 0, b(n) = -c(n-2)+b(n-1)+d(n-1), b(4) = 10, b(3) = 5, b(2) = 3, b(1) = 3, b(0) = 3, c(n) = b(n-1)+d(n-1), c(4) = 15, c(3) = 8, c(2) = 5, c(1) = 3, c(0) = 2, d(n) = c(n-1)+e(n-1), d(4) = 18, d(3) = 10, d(2) = 5, d(1) = 2, d(0) = 0, e(n) = c(n-1)+e(n-1), e(4) = 18, e(3) = 10, e(2) = 5, e(1) = 2, e(0) = 0

...
; Formula: a(n) = b(n-1)+c(n-1)+a(n-1), a(4) = 5, a(3) = 3, a(2) = 2, a(1) = 1, a(0) = 0, b(n) = -c(n-2)+b(n-2)+c(n-2)+a(n-2), b(4) = 2, b(3) = 1, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = b(n-1)+c(n-1), c(4) = 2, c(3) = 1, c(2) = 1, c(1) = 1, c(0) = 1

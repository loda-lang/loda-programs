...
; Formula: a(n) = b(n-1)+c(n-1), a(4) = 10, a(3) = 5, a(2) = 3, a(1) = 2, a(0) = 2, b(n) = -a(n-2)+b(n-1)+c(n-1), b(4) = 7, b(3) = 3, b(2) = 1, b(1) = 1, b(0) = 2, c(n) = a(n-1)+d(n-1), c(4) = 12, c(3) = 7, c(2) = 4, c(1) = 2, c(0) = 0, d(n) = a(n-1)+d(n-1), d(4) = 12, d(3) = 7, d(2) = 4, d(1) = 2, d(0) = 0

...
; Formula: a(n) = b(n-1)+c(n-1), a(4) = 10, a(3) = 5, a(2) = 3, a(1) = 2, a(0) = 2, b(n) = -d(n-1)+b(n-1)+c(n-1), b(4) = 7, b(3) = 3, b(2) = 1, b(1) = 1, b(0) = 2, c(n) = a(n-1)+e(n-1), c(4) = 12, c(3) = 7, c(2) = 4, c(1) = 2, c(0) = 0, d(n) = a(n-1), d(4) = 5, d(3) = 3, d(2) = 2, d(1) = 2, d(0) = 1, e(n) = a(n-1)+e(n-1), e(4) = 12, e(3) = 7, e(2) = 4, e(1) = 2, e(0) = 0

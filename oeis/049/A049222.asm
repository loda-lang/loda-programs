...
; Formula: a(n) = d(max(n-1,0)), b(n) = 3*b(n-1)+e(n-1), b(3) = 28, b(2) = 9, b(1) = 3, b(0) = 1, c(n) = b(n-1), c(3) = 9, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = c(n-1)+d(n-1), d(3) = 4, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = c(n-1)+d(n-1)+e(n-1), e(3) = 5, e(2) = 1, e(1) = 0, e(0) = 0

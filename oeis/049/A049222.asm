...
; Formula: a(n) = c(n-1)+a(n-1), a(4) = 4, a(3) = 1, a(2) = 0, a(1) = 0, a(0) = 0, b(n) = 2*b(n-1)+b(n-1)+d(n-1), b(4) = 28, b(3) = 9, b(2) = 3, b(1) = 1, b(0) = 1, c(n) = b(n-1), c(4) = 9, c(3) = 3, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = c(n-1)+a(n-1)+d(n-1), d(4) = 5, d(3) = 1, d(2) = 0, d(1) = 0, d(0) = 0

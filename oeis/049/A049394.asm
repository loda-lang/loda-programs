...
; Formula: a(n) = (b(2*n+2)*(n+1))/5, b(n) = (5*c(n-2)*b(n-2))/(d(n-2)-1), b(5) = 75, b(4) = 75, b(3) = 5, b(2) = 5, b(1) = 1, b(0) = 1, c(n) = c(n-2)-5, c(5) = -11, c(4) = -11, c(3) = -6, c(2) = -6, c(1) = -1, c(0) = -1, d(n) = d(n-2)-1, d(5) = -2, d(4) = -2, d(3) = -1, d(2) = -1, d(1) = 0, d(0) = 0

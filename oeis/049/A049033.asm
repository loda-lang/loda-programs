...
; Formula: a(n) = b(n-1)*(2*n)^2+a(n-1)*(2*n+4)^2+c(n-1)*(2*n+2)^2, a(3) = 489280, a(2) = 4368, a(1) = 56, a(0) = 1, b(n) = b(n-1)*(2*n)^2, b(3) = 2304, b(2) = 64, b(1) = 4, b(0) = 1, c(n) = b(n-1)*(2*n)^2+c(n-1)*(2*n+2)^2, c(3) = 52480, c(2) = 784, c(1) = 20, c(0) = 1

...
; Formula: a(n) = -d(n+1)+b(n+1)+3, b(n) = b(n-1), b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = c(n-1)/2+e(n-1), c(3) = 5, c(2) = 3, c(1) = 2, c(0) = 0, d(n) = gcd(c(n-1)/2+d(n-1),2), d(3) = 1, d(2) = 2, d(1) = 1, d(0) = 1, e(n) = gcd(c(n-1)/2+d(n-1),2)*e(n-1), e(3) = 4, e(2) = 4, e(1) = 2, e(0) = 2

...
; Formula: a(n) = b(n-1)+c(n-1)+d(n-1), a(3) = 10, a(2) = 3, a(1) = 1, a(0) = 1, b(n) = 2*b(n-1)+c(n-1)+d(n-1), b(3) = 15, b(2) = 5, b(1) = 2, b(0) = 1, c(n) = 2*b(n-2)+2*c(n-1), c(3) = 8, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = b(n-1)+c(n-1)+d(n-1), d(3) = 10, d(2) = 3, d(1) = 1, d(0) = 0

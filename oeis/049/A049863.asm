...
; Formula: a(n) = c(n-1)+d(n-1), a(4) = 11, a(3) = 7, a(2) = 4, a(1) = 3, a(0) = 0, b(n) = b(n-1)+d(n-2), b(4) = 7, b(3) = 3, b(2) = 0, b(1) = 0, b(0) = 1, c(n) = b(n-1)+a(n-1), c(4) = 10, c(3) = 4, c(2) = 3, c(1) = 1, c(0) = 3, d(n) = c(n-1)+d(n-1), d(4) = 11, d(3) = 7, d(2) = 4, d(1) = 3, d(0) = 0

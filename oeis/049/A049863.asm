...
; Formula: a(n) = c(n-1)+e(n-1), a(4) = 11, a(3) = 7, a(2) = 4, a(1) = 3, a(0) = 0, b(n) = -d(n-1)+b(n-1)+a(n-1), b(4) = 7, b(3) = 3, b(2) = 0, b(1) = 0, b(0) = 1, c(n) = b(n-1)+a(n-1), c(4) = 10, c(3) = 4, c(2) = 3, c(1) = 1, c(0) = 3, d(n) = c(n-1), d(4) = 4, d(3) = 3, d(2) = 1, d(1) = 3, d(0) = 1, e(n) = c(n-1)+e(n-1), e(4) = 11, e(3) = 7, e(2) = 4, e(1) = 3, e(0) = 0

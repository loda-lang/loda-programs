...
; Formula: a(n) = b(n+2), b(n) = c(n-1), b(6) = 11, b(5) = 6, b(4) = 4, b(3) = 2, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = c(n-1)+c(n-2)+d(n-3), c(10) = 248, c(9) = 133, c(8) = 71, c(7) = 38, c(6) = 20, c(5) = 11, c(4) = 6, c(3) = 4, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = c(n-1)+d(n-1), d(6) = 24, d(5) = 13, d(4) = 7, d(3) = 3, d(2) = 1, d(1) = 0, d(0) = 0

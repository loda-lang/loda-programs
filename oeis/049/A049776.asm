...
trn $0,1
seq $0,260211 ; Irregular triangle read by rows, T(n,k) is the decimal number conversion from an n-bit symmetric binary table arranged in ascending order for n > 1.
add $0,1

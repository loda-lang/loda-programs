...
; Formula: a(n) = a(n-1)+b(n-1)+b(n-2)+c(n-1)+c(n-2)+1, a(4) = 82, a(3) = 27, a(2) = 8, a(1) = 3, a(0) = 1, b(n) = 2*a(n-1), b(3) = 16, b(2) = 6, b(1) = 2, b(0) = 0, c(n) = 2*a(n-1)+c(n-1), c(3) = 24, c(2) = 8, c(1) = 2, c(0) = 0

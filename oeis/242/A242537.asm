...
; Formula: a(n) = 2*a(n-2)+2*a(n-1)+b(n-2)+c(n-2), a(3) = 27, a(2) = 8, a(1) = 3, a(0) = 1, b(n) = 2*a(n-1)+b(n-1), b(3) = 24, b(2) = 8, b(1) = 2, b(0) = 0, c(n) = 2*a(n-1)-c(n-1)+1, c(3) = 13, c(2) = 4, c(1) = 3, c(0) = 0

...
; Formula: a(n) = -10*truncate(truncate((4*b(5*n))/(2*truncate(c(5*n)/(10^n))+2))/10)+truncate((4*b(5*n))/(2*truncate(c(5*n)/(10^n))+2)), b(n) = 3*b(n-1)-b(n-2), b(3) = 221, b(2) = 88, b(1) = 43, b(0) = 41, c(n) = 2*c(n-1)+b(n-1), c(1) = 45, c(0) = 2

...
; Formula: a(n) = ((d(3*n)+3)/(c(3*n)/(10^n)))%10, b(n) = 4*c(n-1)+2*b(n-1)+2*d(n-1), b(2) = 70, b(1) = 12, b(0) = 0, c(n) = c(n-1)/2+2*c(n-1)+b(n-1)+d(n-1), c(2) = 38, c(1) = 7, c(0) = 3, d(n) = 2*c(n-1)+2*d(n-1)+b(n-1)+c(n-1), d(2) = 51, d(1) = 9, d(0) = 0

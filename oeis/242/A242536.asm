...
; Formula: a(n) = -d(n-1)+b(n-1)+a(n-1)+c(n-1)+1, a(4) = 26, a(3) = 12, a(2) = 4, a(1) = 2, a(0) = 1, b(n) = 3*a(n-1)+b(n-1), b(4) = 57, b(3) = 21, b(2) = 9, b(1) = 3, b(0) = 0, c(n) = 2*a(n-2), c(4) = 8, c(3) = 4, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = -d(n-1)+b(n-1)+a(n-1)+c(n-1)+1, d(4) = 26, d(3) = 12, d(2) = 4, d(1) = 2, d(0) = 0

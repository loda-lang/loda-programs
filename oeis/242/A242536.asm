...
; Formula: a(n) = truncate(b(n+3)/4), b(n) = 4*c(n-2)+4*d(n-2)+2*b(n-2), b(3) = 4, b(2) = 0, b(1) = 2, b(0) = 0, c(n) = 3*c(n-2)+3*d(n-2)+2*c(n-3), c(5) = 10, c(4) = 6, c(3) = 0, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = c(n-1)+d(n-1), d(3) = 2, d(2) = 0, d(1) = 0, d(0) = 0

...
; Formula: a(n) = 3*d(n+3)-2, b(n) = b(n-2)+c(n-2)+e(n-2), b(4) = 4, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = b(n-2)+e(n-2)-2, c(4) = 3, c(3) = 1, c(2) = -1, c(1) = 0, c(0) = 1, d(n) = b(n-1)+c(n-1)+e(n-1), d(4) = 8, d(3) = 4, d(2) = 3, d(1) = 2, d(0) = 1, e(n) = b(n-1)+c(n-1)+e(n-1), e(4) = 8, e(3) = 4, e(2) = 3, e(1) = 2, e(0) = 1

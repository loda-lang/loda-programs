...
; Formula: a(n) = d(n+1), b(n) = -b(n-1)+c(n-1)+1, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = 2*b(n-2)+2*c(n-2)-b(n-2)-c(n-1)-c(n-2)-2*b(n-2)+c(n-2)+4, c(2) = 2, c(1) = 2, c(0) = 0, d(n) = 2*b(n-1)-c(n-1)-1, d(2) = -1, d(1) = -1, d(0) = 0

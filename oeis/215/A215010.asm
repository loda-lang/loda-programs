...
; Formula: a(n) = b(n)/2, b(n) = 2*c(n-1)+b(n-1)+10, b(3) = 6, b(2) = 2, b(1) = 10, b(0) = 0, c(n) = (-b(n-2)-b(n-3)-c(n-3)-2*c(n-2)-10)^c(n-1)-b(n-2)-c(n-2)-2*b(n-1)-3*c(n-1)-10, c(3) = -6, c(2) = -3, c(1) = -9, c(0) = 0

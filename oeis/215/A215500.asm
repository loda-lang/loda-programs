...
; Formula: a(n) = 2*d(n)+4, b(n) = 2*b(n-1)+e(n-1)+1, b(4) = 45, b(3) = 16, b(2) = 5, b(1) = 1, b(0) = 0, c(n) = b(n-1)+d(n-1)+e(n-1)+2, c(4) = 35, c(3) = 15, c(2) = 4, c(1) = 2, c(0) = 0, d(n) = -b(n-1)-d(n-1)-e(n-1)+c(n-1)+max(f(n-1),2*b(n-1)+e(n-1)+1)-2, d(4) = 25, d(3) = 5, d(2) = 3, d(1) = -1, d(0) = 0, e(n) = 3*e(n-1)-e(n-2)-1, e(6) = 200, e(5) = 77, e(4) = 30, e(3) = 12, e(2) = 5, e(1) = 2, e(0) = 0, f(n) = -b(n-1)-d(n-1)-e(n-1)+c(n-1)+max(f(n-1),2*b(n-1)+e(n-1)+1)-2, f(4) = 25, f(3) = 5, f(2) = 3, f(1) = -1, f(0) = 0

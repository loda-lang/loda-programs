...
; Formula: a(n) = d(n+1), b(n) = 2*b(n-4)+b(n-1)+b(n-2)+b(n-3)+4, b(3) = 3, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = b(n-1)+1, c(3) = 2, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = 2*c(n-2)+b(n-2)+1, d(3) = 3, d(2) = 1, d(1) = 0, d(0) = 0

...
; Formula: a(n) = 3*b(n), b(n) = 2*c(n-1)-b(n-1)+d(n-1), b(2) = -5, b(1) = 2, b(0) = 0, c(n) = 2*c(n-2)-2*c(n-1)+d(n-2), c(4) = 32, c(3) = -11, c(2) = 4, c(1) = -1, c(0) = 1, d(n) = -c(n-1)-d(n-1), d(2) = 2, d(1) = -1, d(0) = 0

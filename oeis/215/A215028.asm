...
; Formula: a(n) = d(n+2), b(n) = 9*b(n-1)*((n-2)/b(n-1))+b(n-1), b(5) = 10, b(4) = 10, b(3) = 10, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = n-1, c(5) = 4, c(4) = 3, c(3) = 2, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = (n-1)*(9*b(n-1)*(c(n-1)/b(n-1))+b(n-1))-d(n-1)+n-2, d(5) = 31, d(4) = 12, d(3) = 20, d(2) = 1, d(1) = 0, d(0) = 0

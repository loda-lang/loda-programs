...
; Formula: a(n) = 2*b(n-1)+c(n-1)+d(n-1), a(3) = 5, a(2) = 2, a(1) = 0, a(0) = 1, b(n) = 2*b(n-2)+b(n-1)+c(n-1)+c(n-2)+d(n-2), b(3) = 4, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = b(n-1)+c(n-1), c(3) = 2, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = 2*b(n-1)+c(n-1)+d(n-1), d(3) = 5, d(2) = 2, d(1) = 0, d(0) = 0

...
; Formula: a(n) = 2*floor((sqrtint(8*n+8)-1)/2)*binomial(max(floor((sqrtint(8*n+8)-1)/2)-2,0),-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n-1)+binomial(floor((sqrtint(8*n+8)-1)/2),-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n)

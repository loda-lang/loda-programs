...
; Formula: a(n) = a(n-1)+a(n-2)+b(n-3)+c(n-2)+1, a(5) = 25, a(4) = 11, a(3) = 5, a(2) = 2, a(1) = 1, a(0) = 0, b(n) = 2*b(n-1)-b(n-3)-c(n-3)+b(n-4)+c(n-2), b(7) = 99, b(6) = 44, b(5) = 19, b(4) = 8, b(3) = 3, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = 2*c(n-1)+1, c(5) = 31, c(4) = 15, c(3) = 7, c(2) = 3, c(1) = 1, c(0) = 0

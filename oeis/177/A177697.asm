...
; Formula: a(n) = A276085(A181819(A181811(truncate((A057335(A048678(A014311(n)))-1)/A293810(A057335(A048678(A014311(n)))-1))+1)*(truncate((A057335(A048678(A014311(n)))-1)/A293810(A057335(A048678(A014311(n)))-1))+1)))

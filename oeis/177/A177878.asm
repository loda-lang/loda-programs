...
; Formula: a(n) = (truncate((-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n)/2)+1)*(2*binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+2*truncate((-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n)/2)-2*n+floor((sqrtint(8*n+8)-1)/2)+1)

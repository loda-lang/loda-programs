...
; Formula: a(n) = truncate((b(n+2)^2-2*truncate((b(n+2)^2+truncate(truncate(truncate(binomial(2*b(n+2),b(n+2))/b(n+2))/2)/(b(n+2)^2)))/(2*b(n+2)))*b(n+2)+truncate(truncate(truncate(binomial(2*b(n+2),b(n+2))/b(n+2))/2)/(b(n+2)^2)))/2), b(n) = A151800(b(n-1)+1), b(0) = 0

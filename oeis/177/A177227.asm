...
; Formula: a(n) = 3*binomial(1,binomial(floor((sqrtint(8*n+8)-1)/2),-binomial(floor((sqrtint(8*n+8)-1)/2),2)-floor((sqrtint(8*n+8)-1)/2)+n))-binomial(floor((sqrtint(8*n+8)-1)/2),-binomial(floor((sqrtint(8*n+8)-1)/2),2)-floor((sqrtint(8*n+8)-1)/2)+n)

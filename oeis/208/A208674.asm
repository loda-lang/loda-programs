...
; Formula: a(n) = 9*(d(n)/2)+1, b(n) = 2*b(n-1)+2*b(n-2)+1, b(4) = 25, b(3) = 9, b(2) = 3, b(1) = 1, b(0) = 0, c(n) = 2*c(n-1)+2*e(n-1)+d(n-1), c(4) = 16, c(3) = 2, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 3*e(n-1)+2*b(n-1)+2*c(n-1)+d(n-1), d(4) = 36, d(3) = 8, d(2) = 2, d(1) = 0, d(0) = 0, e(n) = d(n-1), e(4) = 8, e(3) = 2, e(2) = 0, e(1) = 0, e(0) = 0

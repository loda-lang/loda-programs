...
; Formula: a(n) = 9*(c(n)/2)+1, b(n) = 2*b(n-1)+2*b(n-2)+1, b(4) = 25, b(3) = 9, b(2) = 3, b(1) = 1, b(0) = 0, c(n) = 4*b(n-3)+3*c(n-1)+3*d(n-1)-2*d(n-2)+2, c(5) = 142, c(4) = 36, c(3) = 8, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = c(n-1), d(4) = 8, d(3) = 2, d(2) = 0, d(1) = 0, d(0) = 0

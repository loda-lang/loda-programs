...
; Formula: a(n) = b(max(n-3,0)), b(n) = (d(n-1)*f(n-1)^2+c(n-1))/e(n-1), b(4) = 5837, b(3) = 27, b(2) = 5, b(1) = 2, b(0) = 1, c(n) = (c(n-3)*f(n-2)^2+c(n-2))/c(n-4), c(4) = 27, c(3) = 5, c(2) = 2, c(1) = 1, c(0) = 1, d(n) = c(n-1), d(4) = 5, d(3) = 2, d(2) = 1, d(1) = 1, d(0) = 1, e(n) = d(n-1), e(4) = 2, e(3) = 1, e(2) = 1, e(1) = 1, e(0) = 1, f(n) = c(n-1)*((d(n-1)*f(n-1)^2+c(n-1))/e(n-1)), f(4) = 29185, f(3) = 54, f(2) = 5, f(1) = 2, f(0) = 1

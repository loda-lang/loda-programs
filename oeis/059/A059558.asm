...
; Formula: a(n) = d(2*n+2), b(n) = 7*b(n-1)+7*c(n-1)-70, b(2) = -560, b(1) = -70, b(0) = 0, c(n) = (((2*d(n-1)+2)*(b(n-1)+c(n-1)-10))/(2*b(n-1)+c(n-1)-10))%2, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = (((2*d(n-1)+2)*(b(n-1)+c(n-1)-10))/(2*b(n-1)+c(n-1)-10))%2+d(n-1)+1, d(2) = 4, d(1) = 3, d(0) = 2

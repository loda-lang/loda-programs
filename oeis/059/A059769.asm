...
; Formula: a(n) = b(n+1)*(c(n+1)+d(n+1))-1, b(n) = b(n-1)+b(n-2)+1, b(3) = 4, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = c(n-1)+c(n-2)+1, c(4) = 7, c(3) = 4, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = d(n-1)+d(n-2), d(3) = 3, d(2) = 2, d(1) = 1, d(0) = 1

...
; Formula: a(n) = sumdigits(b(n+1),2)*sign(b(n+1)), b(n) = bitxor(4*c(n-1),bitxor(d(n-1),2*b(n-1))), b(2) = 14, b(1) = 2, b(0) = 1, c(n) = bitxor(4*c(n-1),bitxor(d(n-1),2*b(n-1))), c(2) = 14, c(1) = 2, c(0) = 0, d(n) = bitxor(d(n-1),2*b(n-1)), d(2) = 6, d(1) = 2, d(0) = 0

...
; Formula: a(n) = 2*max(truncate(A062876(n)/4)-2,0)-A151799(2*max(truncate(A062876(n)/4)-2,0)-2)-10*truncate((2*max(truncate(A062876(n)/4)-2,0)-A151799(2*max(truncate(A062876(n)/4)-2,0)-2)+A194899(0))/10)+A194899(0)

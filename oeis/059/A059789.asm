...
; Formula: a(n) = 2*max(truncate(A062876(n+1)/4)-2,0)-A151799(2*max(truncate(A062876(n+1)/4)-2,0)+1)-10*truncate((2*max(truncate(A062876(n+1)/4)-2,0)-A151799(2*max(truncate(A062876(n+1)/4)-2,0)+1)+A194899(1))/10)+A194899(1)

...
; Formula: a(n) = b(n-1), b(n) = truncate((b(n-1)*(2*c(n-2)+c(n-1)+1))/(n+1)), b(6) = 288, b(5) = 32, b(4) = 6, b(3) = 2, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = 2*c(n-2)+c(n-1)+1, c(6) = 63, c(5) = 32, c(4) = 15, c(3) = 8, c(2) = 3, c(1) = 2, c(0) = 0

...
; Formula: a(n) = 2*c(n-1)+2*d(n-1)+2*a(n-1)+b(n-1), a(3) = 29, a(2) = 8, a(1) = 1, a(0) = 1, b(n) = 2*d(n-1)+b(n-1)+a(n-1), b(3) = 17, b(2) = 5, b(1) = 2, b(0) = 1, c(n) = d(n-1)+a(n-1), c(3) = 10, c(2) = 2, c(1) = 1, c(0) = -1, d(n) = d(n-1)+a(n-1), d(3) = 10, d(2) = 2, d(1) = 1, d(0) = 0

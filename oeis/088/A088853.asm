...
; Formula: a(n) = a(n-1)*b(n-1)^2+c(n-1), a(3) = 19375, a(2) = 30, a(1) = 1, a(0) = 0, b(n) = 5*b(n-1), b(4) = 125, b(3) = 25, b(2) = 5, b(1) = 1, c(n) = 25*c(n-1)*b(n-2)*b(n-1), c(3) = 1953125, c(2) = 625, c(1) = 5, c(0) = 1

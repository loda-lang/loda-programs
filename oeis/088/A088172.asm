...
; Formula: a(n) = truncate((c(n+1)+33)/2)-16, b(n) = 4*b(n-1)+2*c(n-1)+1, b(2) = 23, b(1) = 5, b(0) = 1, c(n) = truncate((b(n-1)+c(n-1))/d(n-1)), c(2) = 3, c(1) = 1, c(0) = 0, d(n) = 2*d(n-1), d(2) = 4, d(1) = 2, d(0) = 1

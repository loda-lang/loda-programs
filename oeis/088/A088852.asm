...
; Formula: a(n) = a(n-1)*b(n-1)^2+c(n-1), a(3) = 5376, a(2) = 20, a(1) = 1, a(0) = 0, b(n) = 4*b(n-1), b(4) = 64, b(3) = 16, b(2) = 4, b(1) = 1, c(n) = 16*c(n-1)*b(n-2)*b(n-1), c(3) = 262144, c(2) = 256, c(1) = 4, c(0) = 1

...
; Formula: a(n) = 5*a(n-2)+2*b(n-2)-2*b(n-1)-2*c(n-2)+a(n-1)+d(n-2), a(4) = 36, a(3) = 10, a(2) = 4, a(1) = 1, a(0) = 1, b(n) = 2*b(n-1)-2*c(n-1)+1, b(4) = -25, b(3) = -5, b(2) = -1, b(1) = 1, b(0) = 0, c(n) = 2*a(n-1), c(4) = 20, c(3) = 8, c(2) = 2, c(1) = 2, c(0) = 0, d(n) = a(n-1)+d(n-1), d(4) = 16, d(3) = 6, d(2) = 2, d(1) = 1, d(0) = 0

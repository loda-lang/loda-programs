...
; Formula: a(n) = 4*d(n)+1, b(n) = 2*b(n-1)+2*e(n-2)+b(n-2)+c(n-2)+2, b(3) = 30, b(2) = 9, b(1) = 2, b(0) = 0, c(n) = e(n-1)+1, c(3) = 9, c(2) = 4, c(1) = 2, c(0) = 1, d(n) = b(n-1)+c(n-1), d(3) = 13, d(2) = 4, d(1) = 1, d(0) = 0, e(n) = 2*e(n-1)+e(n-2)+1, e(3) = 20, e(2) = 8, e(1) = 3, e(0) = 1

...
; Formula: a(n) = c(n+1), b(n) = max(b(n-1),2*n-2), b(3) = 4, b(2) = 2, b(1) = 0, b(0) = 0, c(n) = binomial(2*n+2,max(b(n-1),2*n-2))*(4*n+truncate(max(b(n-2),2*n-4)/2)-4)+c(n-1), c(3) = 690, c(2) = 60, c(1) = 0, c(0) = 0

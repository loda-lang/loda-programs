...
; Formula: a(n) = c(max(n-2,0)+3)+1, b(n) = b(n-1)+d(n-1), b(3) = 5, b(2) = 2, b(1) = 0, b(0) = 0, c(n) = 2*d(n-1)+b(n-1), c(3) = 8, c(2) = 4, c(1) = 0, c(0) = 1, d(n) = 2*d(n-2)+b(n-2)+d(n-1)+1, d(4) = 17, d(3) = 8, d(2) = 3, d(1) = 2, d(0) = 0

...
; Formula: a(n) = floor(f(n+4)/36), b(n) = 3*d(n-1)+b(n-1), b(4) = 216, b(3) = 60, b(2) = 12, b(1) = 0, b(0) = 0, c(n) = 2*c(n-1)+b(n-1)+e(n-1), c(4) = 108, c(3) = 12, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 3*d(n-1)+4, d(4) = 160, d(3) = 52, d(2) = 16, d(1) = 4, d(0) = 0, e(n) = 2*b(n-1)+2*e(n-1), e(4) = 168, e(3) = 24, e(2) = 0, e(1) = 0, e(0) = 0, f(n) = 3*c(n-1)+3*f(n-1), f(4) = 36, f(3) = 0, f(2) = 0, f(1) = 0, f(0) = 0

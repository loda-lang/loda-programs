...
; Formula: a(n) = binomial(-truncate((-binomial(truncate((sqrtint(8*n)-1)/2)+1,2)+n)/2)-n+binomial(truncate((sqrtint(8*n)-1)/2)+1,2)+truncate((sqrtint(8*n)-1)/2)-1,-n+binomial(truncate((sqrtint(8*n)-1)/2)+1,2)+truncate((sqrtint(8*n)-1)/2))

...
; Formula: a(n) = binomial(-truncate((-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n)/2)-n+binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+floor((sqrtint(8*n+8)-1)/2)-1,-n+binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+floor((sqrtint(8*n+8)-1)/2))

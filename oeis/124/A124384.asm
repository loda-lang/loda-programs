...
; Formula: a(n) = b(n)/3+1, b(n) = c(n-2)*(b(n-3)+2)+c(n-3)*(b(n-4)+2)+b(n-1), b(6) = 1480, b(5) = 328, b(4) = 88, b(3) = 28, b(2) = 10, b(1) = 4, b(0) = 1, c(n) = 2*c(n-1), c(5) = 64, c(4) = 32, c(3) = 16, c(2) = 8, c(1) = 4, c(0) = 2

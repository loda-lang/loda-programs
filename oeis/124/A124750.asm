...
; Formula: a(n) = b(n-1)+1, a(3) = 1, a(2) = 1, a(1) = 1, a(0) = 1, b(n) = -d(n-1)+c(n-1), b(3) = -1, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = -c(n-1)+b(n-2)+d(n-1)+1, c(3) = 2, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = b(n-1)+d(n-1)+1, d(3) = 3, d(2) = 2, d(1) = 1, d(0) = 0

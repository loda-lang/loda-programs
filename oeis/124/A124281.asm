...
; Formula: a(n) = c(n+1), b(n) = 2*b(n-2)+2*b(n-3)+2*d(n-3)-2*b(n-3)+2, b(4) = 8, b(3) = 2, b(2) = 2, b(1) = 0, b(0) = 0, c(n) = b(n-1)+1, c(4) = 3, c(3) = 3, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = b(n-1)+d(n-1)+1, d(4) = 8, d(3) = 5, d(2) = 2, d(1) = 1, d(0) = 0

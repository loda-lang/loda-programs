...
; Formula: a(n) = gcd(if((-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n)<=(-1),0,0^(-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n)),3)*binomial(floor((sqrtint(8*n+8)-1)/2),-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n)

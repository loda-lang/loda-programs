...
; Formula: a(n) = truncate(d(4*n)/54), b(n) = c(n-1), b(5) = 12, b(4) = -1, b(3) = 3, b(2) = 0, b(1) = 0, b(0) = 1, c(n) = d(n-1), c(5) = 0, c(4) = 12, c(3) = -1, c(2) = 3, c(1) = 0, c(0) = 0, d(n) = e(n-1), d(5) = 39, d(4) = 0, d(3) = 12, d(2) = -1, d(1) = 3, d(0) = 0, e(n) = 4*d(n-1)-3*c(n-1)-4*b(n-1)+b(n-2)+b(n-3)+e(n-1), e(6) = 120, e(5) = 10, e(4) = 39, e(3) = 0, e(2) = 12, e(1) = -1, e(0) = 3

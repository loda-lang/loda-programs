...
; Formula: a(n) = d(n+1), b(n) = -b(n-1)-c(n-3)+b(n-1)+b(n-3)+d(n-3)+e(n-3)+f(n-3), b(6) = 0, b(5) = 1, b(4) = 0, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 1, c(n) = b(n-1), c(6) = 1, c(5) = 0, c(4) = 0, c(3) = 0, c(2) = 0, c(1) = 1, c(0) = 0, d(n) = b(n-1)+d(n-1), d(6) = 1, d(5) = 0, d(4) = 0, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = -1, e(n) = 2*b(n-1)+d(n-1)+e(n-1), e(6) = 3, e(5) = 1, e(4) = 1, e(3) = 1, e(2) = 1, e(1) = 1, e(0) = 0, f(n) = -e(n-1)-f(n-1)+c(n-1), f(6) = 0, f(5) = -1, f(4) = 0, f(3) = -1, f(2) = 0, f(1) = 0, f(0) = 0

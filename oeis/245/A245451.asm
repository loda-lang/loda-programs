...
; Formula: a(n) = truncate((A057335(A341915(2^logint(2*A156552(n)+1,2)-A156552(n)+floor((2^logint(2*A156552(n)+1,2))/2)-1))-1)/A293810(A057335(A341915(2^logint(2*A156552(n)+1,2)-A156552(n)+floor((2^logint(2*A156552(n)+1,2))/2)-1))))+1

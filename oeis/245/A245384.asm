...
; Formula: a(n) = d(n)+1, b(n) = (d(n-2)+1)*(b(n-3)+1)+b(n-2)*((d(n-2)+1)*(b(n-3)+1)+b(n-3)+1)+b(n-3), b(3) = 2, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = b(n-1), c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = (d(n-1)+1)*(c(n-1)+1)+b(n-1)*((d(n-1)+1)*(c(n-1)+1)+c(n-1)+1)+c(n-1), d(3) = 7, d(2) = 2, d(1) = 1, d(0) = 0

...
; Formula: a(n) = floor(floor((3*d(max(3*n-3,0))+3)/2)/(floor(c(max(3*n-3,0))/(10^(n-1)))+1))%10, b(n) = 10*c(n-1)+8*b(n-1)+2*d(n-1), b(2) = 28, b(1) = 2, b(0) = 0, c(n) = 6*c(n-1)+4*b(n-1)+d(n-1), c(2) = 15, c(1) = 1, c(0) = 0, d(n) = c(n-1)+d(n-1), d(2) = 2, d(1) = 1, d(0) = 1

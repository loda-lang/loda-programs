...
; Formula: a(n) = d(n+1), b(n) = 2*((-c(n-1)+b(n-1)+1)/4), b(2) = -2, b(1) = 0, b(0) = 0, c(n) = gcd(2*((-c(n-1)+b(n-1)+1)/4)+binomial(d(n-1),c(n-1)),4)*c(n-1), c(2) = 16, c(1) = 8, c(0) = 2, d(n) = (gcd(2*((-c(n-1)+b(n-1)+1)/4)+binomial(d(n-1),c(n-1)),4)+2)/2, d(2) = 2, d(1) = 3, d(0) = 0

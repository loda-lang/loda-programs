...
; Formula: a(n) = b(n+5), b(n) = c(n-3), b(7) = 0, b(6) = 0, b(5) = 1, b(4) = 0, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = -c(n-6)+c(n-1)+c(n-2)+c(n-5)+c(n-7)+d(n-1)-1, c(11) = 1, c(10) = 3, c(9) = 0, c(8) = 1, c(7) = 1, c(6) = 0, c(5) = 1, c(4) = 0, c(3) = 0, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = -d(n-1)-2*c(n-1)+2, d(7) = 2, d(6) = 0, d(5) = 0, d(4) = 2, d(3) = 0, d(2) = 0, d(1) = 2, d(0) = 0

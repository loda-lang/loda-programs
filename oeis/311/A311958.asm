...
; Formula: a(n) = ((sign(n)*((n-1)%10+1))==0)+44*floor(n/10)+40*((sign(n)*((n-1)%10+1))==9)+36*((sign(n)*((n-1)%10+1))==8)+31*((sign(n)*((n-1)%10+1))==7)+27*((sign(n)*((n-1)%10+1))==6)+22*((sign(n)*((n-1)%10+1))==5)+17*((sign(n)*((n-1)%10+1))==4)+13*((sign(n)*((n-1)%10+1))==3)+8*((sign(n)*((n-1)%10+1))==2)+4*((sign(n)*((n-1)%10+1))==1)

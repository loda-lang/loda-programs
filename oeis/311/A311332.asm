...
; Formula: a(n) = max(54*floor(n/12)+50*((sign(n)*((n-1)%12+1))==11)+46*((sign(n)*((n-1)%12+1))==10)+42*((sign(n)*((n-1)%12+1))==9)+38*((sign(n)*((n-1)%12+1))==8)+33*((sign(n)*((n-1)%12+1))==7)+27*((sign(n)*((n-1)%12+1))==6)+21*((sign(n)*((n-1)%12+1))==5)+16*((sign(n)*((n-1)%12+1))==4)+12*((sign(n)*((n-1)%12+1))==3)+8*((sign(n)*((n-1)%12+1))==2)+4*((sign(n)*((n-1)%12+1))==1),1)

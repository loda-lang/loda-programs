...
; Formula: a(n) = truncate((8*n+2*max(truncate((6*truncate(floor((n+4)/3)/3)+4*n-2*floor((n+4)/3)+3)/3)-1,0)-((12*n)%(8*n+2*max(truncate((6*truncate(floor((n+4)/3)/3)+4*n-2*floor((n+4)/3)+3)/3)-1,0)+2))+2)/2)

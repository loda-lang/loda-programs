...
; Formula: a(n) = (2*A313799(n)-(12*n)%(2*A313799(n)))/2

mov $1,$0
seq $1,313799 ; Coordination sequence Gal.3.53.3 where G.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.
mul $1,2
mul $0,12
mod $0,$1
sub $1,$0

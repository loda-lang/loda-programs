...
; Formula: a(n) = ((sign(n)*((n-1)%12+1))==0)+52*floor(n/12)+48*((sign(n)*((n-1)%12+1))==11)+44*((sign(n)*((n-1)%12+1))==10)+40*((sign(n)*((n-1)%12+1))==9)+36*((sign(n)*((n-1)%12+1))==8)+31*((sign(n)*((n-1)%12+1))==7)+26*((sign(n)*((n-1)%12+1))==6)+21*((sign(n)*((n-1)%12+1))==5)+16*((sign(n)*((n-1)%12+1))==4)+12*((sign(n)*((n-1)%12+1))==3)+8*((sign(n)*((n-1)%12+1))==2)+4*((sign(n)*((n-1)%12+1))==1)

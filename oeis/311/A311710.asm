...
; Formula: a(n) = (2*A313894(n)-(16*n)/7)/2

mov $1,$0
seq $1,313894 ; Coordination sequence Gal.5.133.2 where G.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.
mul $1,2
mul $0,16
div $0,7
sub $1,$0

...
; Formula: a(n) = truncate(((-n+binomial(floor((sqrtint(8*n)-1)/2)+1,2)+floor((sqrtint(8*n)-1)/2)+1)*(3*floor((sqrtint(8*n)-1)/2)+3*n-3*binomial(floor((sqrtint(8*n)-1)/2)+1,2)+1)+3*floor((sqrtint(8*n)-1)/2)+3*n-3*binomial(floor((sqrtint(8*n)-1)/2)+1,2)+1)/2)

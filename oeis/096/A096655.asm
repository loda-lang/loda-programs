...
; Formula: a(n) = a(n-1)*(b(n-1)+c(n-1))+a(n-2)*(b(n-2)+c(n-2)), a(3) = 11, a(2) = 3, a(1) = 1, a(0) = 1, b(n) = b(n-1)+b(n-2), b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = c(n-1)+c(n-2), c(4) = 3, c(3) = 2, c(2) = 1, c(1) = 1, c(0) = 0

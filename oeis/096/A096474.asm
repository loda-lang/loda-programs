...
; Formula: a(n) = 2*truncate((-A008578(max(2*truncate(A006512(n)/2)-3,0)+3)+A159477(A159477((A008578(max(2*truncate(A006512(n)/2)-3,0)+3)==0)+A008578(max(2*truncate(A006512(n)/2)-3,0)+3)+2)+2)+10054)/2)-10054

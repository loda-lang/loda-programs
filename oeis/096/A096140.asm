...
; Formula: a(n) = -b(n-2)-2*b(n-2)-2*c(n-2)+a(n-2)+d(n-2)+3, a(4) = 29, a(3) = 10, a(2) = 3, a(1) = 1, a(0) = 0, b(n) = 2*b(n-1)+c(n-1)-2, b(4) = -42, b(3) = -16, b(2) = -6, b(1) = -2, b(0) = 0, c(n) = b(n-1)+c(n-1), c(4) = -24, c(3) = -8, c(2) = -2, c(1) = 0, c(0) = 0, d(n) = a(n-1)+d(n-1), d(4) = 14, d(3) = 4, d(2) = 1, d(1) = 0, d(0) = 0

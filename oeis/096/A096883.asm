...
; Formula: a(n) = binomial(c(n-1),b(n-1))*b(n-1)+10*a(n-1), a(2) = 101, a(1) = 10, a(0) = 1, b(n) = binomial(c(n-1),b(n-1))*b(n-1)+a(n-1), b(2) = 11, b(1) = 1, b(0) = 0, c(n) = a(n-1), c(2) = 10, c(1) = 1, c(0) = 0

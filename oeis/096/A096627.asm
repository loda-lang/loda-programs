...
; Formula: a(n) = (-10*truncate((truncate((2*d(max(3*n-9,0))-4*e(max(3*n-9,0)))/floor((c(max(3*n-9,0))+12)/(10^(n-3))))-1)/10)+truncate((2*d(max(3*n-9,0))-4*e(max(3*n-9,0)))/floor((c(max(3*n-9,0))+12)/(10^(n-3))))+9)%10, b(n) = 4*(b(n-1)==1)+4*c(n-1)+4*f(n-1)+1, b(4) = 729, b(3) = 77, b(2) = 9, b(1) = 1, b(0) = 0, c(n) = 5*c(n-1)+5*f(n-1)+4*(b(n-1)==1), c(4) = 910, c(3) = 95, c(2) = 9, c(1) = 0, c(0) = 0, d(n) = 5*c(n-1)+5*f(n-1)+4*(b(n-1)==1)+d(n-1), d(4) = 1026, d(3) = 116, d(2) = 21, d(1) = 12, d(0) = 12, e(n) = 2*c(n-1)+2*f(n-1)+2*floor((c(n-1)+e(n-1))/2), e(4) = 506, e(3) = 48, e(2) = 2, e(1) = 0, e(0) = 0, f(n) = 5*f(n-1)+4*(b(n-1)==1)+4*c(n-1)+1, f(4) = 816, f(3) = 87, f(2) = 10, f(1) = 1, f(0) = 0

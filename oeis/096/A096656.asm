...
; Formula: a(n) = a(n-1)*(b(n-1)+c(n-1))+a(n-2)*(b(n-2)+c(n-2)), a(3) = 46, a(2) = 8, a(1) = 2, a(0) = 1, b(n) = b(n-1)+b(n-2), b(3) = 5, b(2) = 3, b(1) = 2, b(0) = 1, c(n) = c(n-1)+c(n-2), c(4) = 5, c(3) = 3, c(2) = 2, c(1) = 1, c(0) = 1

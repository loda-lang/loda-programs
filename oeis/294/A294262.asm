...
; Formula: a(n) = 2*truncate((min(3*n,(3*n)%2)*b(3*n)+c(3*n))/4)+1, b(n) = 3*b(n-2)-b(n-4), b(6) = 8, b(5) = 3, b(4) = 3, b(3) = 1, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = 2*c(n-2)+b(n-2), c(3) = 2, c(2) = 2, c(1) = 1, c(0) = 1

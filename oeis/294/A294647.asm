...
; Formula: a(n) = d(n+2), b(n) = (-c(n-1)+b(n-1))/2, b(3) = -3, b(2) = -3, b(1) = -2, b(0) = -2, c(n) = c(n-1)*(((-c(n-1)+b(n-1))/2+b(n-1)+d(n-1)+e(n-1))%2+2), c(3) = 4, c(2) = 4, c(1) = 4, c(0) = 2, d(n) = ((-c(n-1)+b(n-1))/2+b(n-1)+d(n-1)+e(n-1))%2+2, d(3) = 1, d(2) = 1, d(1) = 2, d(0) = 0, e(n) = b(n-1)+e(n-1), e(3) = -7, e(2) = -4, e(1) = -2, e(0) = 0

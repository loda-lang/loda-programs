...
; Formula: a(n) = a(n-1)+b(n-1), a(4) = 21, a(3) = 6, a(2) = 2, a(1) = 1, a(0) = 1, b(n) = d(n-1)+1, b(4) = 53, b(3) = 15, b(2) = 4, b(1) = 1, b(0) = 0, c(n) = -c(n-2)+c(n-1)+d(n-2)+2, c(4) = 21, c(3) = 7, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = 4*d(n-1)-a(n-1)-b(n-1)-c(n-1)+4, d(4) = 184, d(3) = 52, d(2) = 14, d(1) = 3, d(0) = 0

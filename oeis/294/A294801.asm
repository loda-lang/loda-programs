...
; Formula: a(n) = f1(n)+1, b(n) = 2*b(n-1)+2*c(n-1)-c(n-2)+2, b(7) = 1113, b(6) = 439, b(5) = 174, b(4) = 69, b(3) = 27, b(2) = 10, b(1) = 3, b(0) = 0, c(n) = 3*c(n-1)-c(n-2), c(8) = 987, c(7) = 377, c(6) = 144, c(5) = 55, c(4) = 21, c(3) = 8, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = 3*d(n-1)-d(n-2)+1, d(8) = 609, d(7) = 232, d(6) = 88, d(5) = 33, d(4) = 12, d(3) = 4, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = 2*e(n-1)+b(n-1)+c(n-1)+d(n-1)+2, e(6) = 924, e(5) = 330, e(4) = 113, e(3) = 36, e(2) = 10, e(1) = 2, e(0) = 0, f(n) = 2*(f(n-1)/2)+2*e(n-1)+2, f(6) = 994, f(5) = 332, f(4) = 104, f(3) = 30, f(2) = 8, f(1) = 2, f(0) = 0, f1(n) = f(n-1)/2+f1(n-1), f1(6) = 238, f1(5) = 72, f1(4) = 20, f1(3) = 5, f1(2) = 1, f1(1) = 0, f1(0) = 0

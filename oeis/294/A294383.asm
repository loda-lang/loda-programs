...
; Formula: a(n) = c(n+1)+1, b(n) = b(n-1)+n+2, b(5) = 25, b(4) = 18, b(3) = 12, b(2) = 7, b(1) = 3, b(0) = 0, c(n) = (c(n-1)+1)*((2*((2*n+b(n-3)+2)/2)+max(2*((b(n-3)+n+1)/2)-4,0))/n), c(5) = 145, c(4) = 28, c(3) = 6, c(2) = 2, c(1) = 0, c(0) = 0

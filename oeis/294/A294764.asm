...
; Formula: a(n) = d(n)/2+1, b(n) = max(b(n-1),1)+n, b(5) = 16, b(4) = 11, b(3) = 7, b(2) = 4, b(1) = 2, b(0) = 0, c(n) = 2*c(n-1)+2*e(n-1)+2, c(6) = 1148, c(5) = 348, c(4) = 104, c(3) = 30, c(2) = 8, c(1) = 2, c(0) = 0, d(n) = c(n-1)+d(n-1), d(5) = 144, d(4) = 40, d(3) = 10, d(2) = 2, d(1) = 0, d(0) = 0, e(n) = b(n-1)+c(n-1)+d(n-1)+e(n-1)+1, e(5) = 225, e(4) = 69, e(3) = 21, e(2) = 6, e(1) = 1, e(0) = 0

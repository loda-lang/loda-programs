...
; Formula: a(n) = n/(c(max(n-1,0))*(min(n-1,(n-1)%2)+1)+b(max(n-1,0)))+c(max(n-1,0))*(min(n-1,(n-1)%2)+1)+b(max(n-1,0)), b(n) = 2*b(n-2)+c(n-2), b(3) = 2, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = 3*c(n-2)-c(n-4), c(6) = 8, c(5) = 3, c(4) = 3, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0

...
; Formula: a(n) = 2*b(n)-1, b(n) = -e(n-1)+d(n-1)+1, b(4) = 9, b(3) = 2, b(2) = 4, b(1) = 1, b(0) = 2, c(n) = -e(n-1)+b(n-1)+d(n-1), c(4) = 10, c(3) = 5, c(2) = 4, c(1) = 2, c(0) = 2, d(n) = c(n-1)+f(n-1), d(4) = 14, d(3) = 9, d(2) = 5, d(1) = 3, d(0) = 1, e(n) = -b(n-1)-e(n-1)+c(n-1)+d(n-1), e(4) = 11, e(3) = 1, e(2) = 4, e(1) = 0, e(0) = 1, f(n) = c(n-1)+f(n-1), f(4) = 14, f(3) = 9, f(2) = 5, f(1) = 3, f(0) = 1

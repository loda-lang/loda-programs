...
; Formula: a(n) = gcd((-c(n-2)+b(n-2))/2-1,4)/2+a(n-1), a(3) = 1, a(2) = 1, a(1) = 1, a(0) = 0, b(n) = (-c(n-1)+b(n-1))/2, b(3) = -21, b(2) = -10, b(1) = -4, b(0) = -1, c(n) = 2*gcd((-c(n-1)+b(n-1))/2-1,4)*c(n-1), c(3) = 128, c(2) = 32, c(1) = 16, c(0) = 8

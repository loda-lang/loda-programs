...
; Formula: a(n) = binomial(floor((sqrtint(8*n+8)+1)/2)+3,-binomial(floor((sqrtint(8*n+8)+1)/2),2)+n+4)+binomial(floor((sqrtint(8*n+8)+1)/2)+3,-binomial(floor((sqrtint(8*n+8)+1)/2),2)+n)

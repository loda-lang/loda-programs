...
; Formula: a(n) = -floor((sqrtint(4*n)+1)/2)+binomial(-floor((sqrtint(4*n)+1)/2)*(floor((sqrtint(4*n)+1)/2)-1)-truncate((-floor((sqrtint(4*n)+1)/2)*(floor((sqrtint(4*n)+1)/2)-1)+n+1)/2)+floor((sqrtint(4*n)+1)/2)+n+1,2)+truncate((-floor((sqrtint(4*n)+1)/2)*(floor((sqrtint(4*n)+1)/2)-1)+n+1)/2)

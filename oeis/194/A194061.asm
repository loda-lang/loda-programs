...
; Formula: a(n) = -binomial(floor((sqrtint(8*n)+1)/2),2)+floor(((-binomial(floor((sqrtint(8*n)+1)/2),2)+binomial(0,-binomial(floor((sqrtint(8*n)+1)/2),2)+n-1)+floor((sqrtint(8*n)+1)/2)+n-1)^2)/4)+n-1

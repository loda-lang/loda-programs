...
; Formula: a(n) = truncate(c(n+1)/2)+1, b(n) = truncate((-c(n-1)*(-f(n-1)+e(n-1)-1)+d(n-1))/(2*b(n-1)+2*f(n-1)-2*e(n-1)+4)), b(4) = 9, b(3) = 2, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = 2*b(n-1)+2*f(n-1)-2*e(n-1)+4, c(4) = 34, c(3) = 24, c(2) = 6, c(1) = 4, c(0) = 0, d(n) = truncate((-c(n-1)*(-f(n-1)+e(n-1)-1)+d(n-1))/(2*b(n-1)+2*f(n-1)-2*e(n-1)+4)), d(4) = 9, d(3) = 2, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = 4*b(n-1)+3*f(n-1)-4*e(n-1)+7, e(4) = 19, e(3) = 35, e(2) = 3, e(1) = 7, e(0) = 0, f(n) = 4*b(n-1)+4*f(n-1)-4*e(n-1)+8, f(4) = 68, f(3) = 48, f(2) = 12, f(1) = 8, f(0) = 0

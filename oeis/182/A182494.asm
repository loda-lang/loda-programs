...
; Formula: a(n) = (d(n+1)+9)%10, b(n) = -b(n-4)+b(n-2)+2, b(5) = 3, b(4) = 2, b(3) = 4, b(2) = 0, b(1) = 3, b(0) = 0, c(n) = b(n-1)-1, c(5) = 1, c(4) = 3, c(3) = -1, c(2) = 2, c(1) = -1, c(0) = 0, d(n) = (-c(n-1)+b(n-1))/2, d(5) = 0, d(4) = 2, d(3) = -1, d(2) = 2, d(1) = 0, d(0) = 0

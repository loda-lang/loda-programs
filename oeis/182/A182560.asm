...
; Formula: a(n) = floor(b(n)/4), b(n) = bitxor(bitand(d(n-1),c(n-1)),4*n), b(3) = 12, b(2) = 8, b(1) = 4, b(0) = 0, c(n) = b(n-1), c(3) = 8, c(2) = 4, c(1) = 0, c(0) = 0, d(n) = bitxor(bitand(d(n-1),c(n-1)),4*n), d(3) = 12, d(2) = 8, d(1) = 4, d(0) = 0

...
; Formula: a(n) = d(n)+1, b(n) = -b(n-1)-c(n-1)-d(n-1)+b(n-1)+c(n-1)+d(n-1)+max(d(n-1),3)-2, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = -max(d(n-1),3)+b(n-1)+c(n-1)+d(n-1)+2, c(2) = 3, c(1) = 1, c(0) = 1, d(n) = -b(n-1)-d(n-1)-max(d(n-1),3)+b(n-1)+c(n-1)+d(n-1)+max(d(n-1),3)+1, d(2) = 2, d(1) = 2, d(0) = 0

...
; Formula: a(n) = d(n+1)/3+1, b(n) = (-c(n-1)+b(n-1))/2, b(2) = -2, b(1) = 0, b(0) = 2, c(n) = 2*gcd(((-c(n-1)+b(n-1))/2+d(n-1))%2,4)*c(n-1), c(2) = 8, c(1) = 4, c(0) = 2, d(n) = gcd(((-c(n-1)+b(n-1))/2+d(n-1))%2,4), d(2) = 1, d(1) = 1, d(0) = 1

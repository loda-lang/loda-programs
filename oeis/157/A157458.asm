...
; Formula: a(n) = floor((sqrtint(8*n+8)-1)/2)+min(2*binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)-2*max(2*binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)-2*n+floor((sqrtint(8*n+8)-1)/2),0)-2*n+floor((sqrtint(8*n+8)-1)/2)+1,0)

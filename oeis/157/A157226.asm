...
; 0,1,1,2,1,3,1,2,1,3,1,4,1,3,2,2,1,3,1,4,2,3,1,4,1,3,1,4,1,6,1,2,2,3,2,4,1,3,2,4,1,6,1,4,2,3,1,4,1,3,2,4,1,3,2,4,2,3,1,8,1,3,2,2,2,6,1,4,2,6,1,4,1,3,2,4,2,6,1,4,1,3,1,8,2,3,2,4,1,6,2,4,2,3,2,4,1,3,2,4
; Formula: a(n) = A304182(n)/2

...
; Formula: a(n) = -sqrtint(8*truncate(10^(2*n-2))+17)-10*truncate((-sqrtint(8*truncate(10^(2*n-2))+17)-10*truncate((-sqrtint(8*truncate(10^(2*n-2))+17)-1)/10)+9)/10)-10*truncate((-sqrtint(8*truncate(10^(2*n-2))+17)-1)/10)+9

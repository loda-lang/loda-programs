...
; Formula: a(n) = (((2*b(4*n)+5)/((c(4*n)+d(4*n))/(10^n)))/5)%10, b(n) = 2*b(n-1)+2*c(n-1), b(2) = 8, b(1) = 2, b(0) = 0, c(n) = 4*c(n-1)-2*c(n-2), c(4) = 68, c(3) = 20, c(2) = 6, c(1) = 2, c(0) = 1, d(n) = (c(n-1)+d(n-1))/4, d(2) = 0, d(1) = 0, d(0) = 0

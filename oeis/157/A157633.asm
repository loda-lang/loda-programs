...
; Formula: a(n) = max(2*(-binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2)+n)*(-(-binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2)+n)*(-n+binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2)+truncate((sqrtint(8*n+8)-1)/2))+2*truncate((sqrtint(8*n+8)-1)/2)^2)*(-n+binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2)+truncate((sqrtint(8*n+8)-1)/2)),1)

...
; Formula: a(n) = 2*d(n)+1, b(n) = c(n-1)+e(n-1)+1, b(4) = 8, b(3) = 4, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = e(n-1), c(4) = 5, c(3) = 2, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = b(n-2)+c(n-2)+d(n-1)+e(n-2)+1, d(4) = 12, d(3) = 6, d(2) = 3, d(1) = 1, d(0) = 0, e(n) = b(n-1)+d(n-1), e(4) = 10, e(3) = 5, e(2) = 2, e(1) = 1, e(0) = 0

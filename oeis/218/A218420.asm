...
; Formula: a(n) = 2*d(2*n+5)+1, b(n) = c(n-2)+f1(n-2), b(6) = 6, b(5) = 3, b(4) = 1, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = f1(n-1), c(6) = 8, c(5) = 4, c(4) = 2, c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = b(n-1), d(6) = 3, d(5) = 1, d(4) = 0, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = b(n-1)+c(n-1)+e(n-1)+f(n-1)+f1(n-1)+1, e(6) = 32, e(5) = 16, e(4) = 8, e(3) = 4, e(2) = 2, e(1) = 1, e(0) = 0, f(n) = binomial(c(n-1)+f(n-1)+f1(n-1),b(n-1)+c(n-1)+e(n-1)+f(n-1)+f1(n-1)+1), f(6) = 0, f(5) = 0, f(4) = 0, f(3) = 0, f(2) = 0, f(1) = 0, f(0) = 0, f1(n) = e(n-1), f1(6) = 16, f1(5) = 8, f1(4) = 4, f1(3) = 2, f1(2) = 1, f1(1) = 0, f1(0) = 0

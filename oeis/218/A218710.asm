...
; Formula: a(n) = min(c(n)+1,17^n-b(n))-1, b(n) = (2*(b(n-1)+1)^2+b(n-1)+2)%(17*17^(n-1)), b(3) = 2927, b(2) = 37, b(1) = 3, b(0) = 0, c(n) = (2*c(n-1)^2+c(n-1)+1)%(17*17^(n-1))+1, c(3) = 2928, c(2) = 38, c(1) = 4, c(0) = 0

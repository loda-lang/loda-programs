...
; Formula: a(n) = min(d(n)+1,-c(n)+b(n))-1, b(n) = 17*b(n-1), b(2) = 289, b(1) = 17, b(0) = 1, c(n) = (2*(c(n-1)+1)^2+d(n-1)+1)%(17*b(n-1)), c(2) = 37, c(1) = 3, c(0) = 0, d(n) = (2*(c(n-1)+1)^2+d(n-1)+1)%(17*b(n-1))+1, d(2) = 38, d(1) = 4, d(0) = 0

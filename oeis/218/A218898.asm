...
; Formula: a(n) = b(n+4), b(n) = 2*b(n-2)+2*b(n-3)+c(n-3)+e(n-3), b(5) = 6, b(4) = 4, b(3) = 1, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = 2*b(n-1)-d(n-1)+c(n-1)+e(n-1), c(5) = 19, c(4) = 7, c(3) = 4, c(2) = 1, c(1) = 1, c(0) = 1, d(n) = 2*b(n-1)-d(n-1)+c(n-1), d(5) = 12, d(4) = 3, d(3) = 3, d(2) = 0, d(1) = 1, d(0) = 0, e(n) = 2*b(n-1)-d(n-1)+c(n-1)+e(n-1), e(5) = 19, e(4) = 7, e(3) = 4, e(2) = 1, e(1) = 1, e(0) = 0

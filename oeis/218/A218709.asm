...
; Formula: a(n) = min(13*b(n-1)-(((2*c(n-1))^2+d(n-1)+3)%(13*b(n-1))),((2*c(n-1))^2+d(n-1)+3)%(13*b(n-1))), a(3) = 239, a(2) = 70, a(1) = 5, a(0) = 0, b(n) = 13*b(n-1), b(3) = 2197, b(2) = 169, b(1) = 13, b(0) = 1, c(n) = ((2*c(n-1))^2+c(n-1)+4)%(13*b(n-1)), c(4) = 28322, c(3) = 1958, c(2) = 99, c(1) = 8, c(0) = 0, d(n) = ((2*d(n-1)-2)^2+d(n-1)+3)%(13*b(n-1))+1, d(4) = 28323, d(3) = 1959, d(2) = 100, d(1) = 9, d(0) = 5

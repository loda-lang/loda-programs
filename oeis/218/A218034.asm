...
; Formula: a(n) = b(n)+d(n), b(n) = b(n-1)+c(n-1), b(3) = 13, b(2) = 5, b(1) = 1, b(0) = 1, c(n) = 4*b(n-1)+c(n-1), c(3) = 28, c(2) = 8, c(1) = 4, c(0) = 0, d(n) = 12*b(n-2)+3*b(n-1)-2*c(n-1), d(3) = 11, d(2) = 7, d(1) = 3, d(0) = 0

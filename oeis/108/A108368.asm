...
; Formula: a(n) = truncate(d(n)/6), b(n) = 6*b(n-2)+6*c(n-2)+6*e(n-2)+b(n-1), b(3) = 25, b(2) = 7, b(1) = 1, b(0) = 1, c(n) = b(n-1)+c(n-1), c(3) = 9, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = 6*b(n-1)+6*c(n-1)+6*e(n-1), d(3) = 72, d(2) = 18, d(1) = 6, d(0) = 0, e(n) = b(n-1)+c(n-1)+e(n-1), e(3) = 12, e(2) = 3, e(1) = 1, e(0) = 0

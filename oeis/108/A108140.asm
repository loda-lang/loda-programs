...
; Formula: a(n) = gcd(f1(n),d(n)-1), b(n) = 2*b(n-1)+e(n-1)-1, b(5) = -22, b(4) = -9, b(3) = -4, b(2) = -2, b(1) = -1, b(0) = 0, c(n) = -b(n-1)-e(n-1)+c(n-2)+f(n-2), c(5) = 13, c(4) = 4, c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = c(n-1)+f(n-1), d(5) = 5, d(4) = 1, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = b(n-1)+e(n-1)+1, e(5) = -11, e(4) = -3, e(3) = 0, e(2) = 1, e(1) = 1, e(0) = 0, f(n) = c(n-1)+f(n-1), f(5) = 5, f(4) = 1, f(3) = 0, f(2) = 0, f(1) = 0, f(0) = 0, f1(n) = f1(n-1), f1(5) = 0, f1(4) = 0, f1(3) = 0, f1(2) = 0, f1(1) = 0, f1(0) = 0

...
; Formula: a(n) = c(n)+1, b(n) = 2*d(n-1)+2*f(n-1)-b(n-1), b(4) = -6, b(3) = -6, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = d(n-1)+f(n-1), c(4) = -6, c(3) = -3, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = -e(n-1), d(4) = 6, d(3) = -3, d(2) = -3, d(1) = 0, d(0) = 0, e(n) = 3*d(n-1)+2*f(n-1)-b(n-1)+3, e(4) = -6, e(3) = -6, e(2) = 3, e(1) = 3, e(0) = 0, f(n) = -b(n-1)+d(n-1)+f(n-1), f(4) = 0, f(3) = -3, f(2) = 0, f(1) = 0, f(0) = 0

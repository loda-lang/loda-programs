...
; Formula: a(n) = d(n)/10+1, b(n) = c(n-1), b(3) = 50, b(2) = 10, b(1) = 0, b(0) = 0, c(n) = 4*c(n-1)-c(n-2)-c(n-3)+10, c(4) = 750, c(3) = 200, c(2) = 50, c(1) = 10, c(0) = 0, d(n) = b(n-1), d(3) = 10, d(2) = 0, d(1) = 0, d(0) = 0

...
; Formula: a(n) = d(n)/10+1, b(n) = 3*b(n-1)+2*b(n-2)+c(n-2)+20, b(3) = 200, b(2) = 50, b(1) = 10, b(0) = 0, c(n) = b(n-1)+c(n-1)+10, c(3) = 90, c(2) = 30, c(1) = 10, c(0) = 0, d(n) = b(n-2), d(3) = 10, d(2) = 0, d(1) = 0, d(0) = 0

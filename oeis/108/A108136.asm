...
; Formula: a(n) = a(n-1)+b(n-1), a(3) = 6, a(2) = 1, a(1) = 1, a(0) = 1, b(n) = 5*c(n-1)+b(n-1), b(3) = 15, b(2) = 5, b(1) = 0, b(0) = 0, c(n) = 3*c(n-1)+2*c(n-2)+c(n-3), c(7) = 1382, c(6) = 381, c(5) = 105, c(4) = 29, c(3) = 8, c(2) = 2, c(1) = 1, c(0) = 0

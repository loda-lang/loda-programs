...
; Formula: a(n) = truncate((2*A365605(2*binomial(n,2)+1)*binomial(n,2)*(2*binomial(n,2)+A365605(2*binomial(n,2)+1)))/(((2*A365605(2*binomial(n,2)+1)*binomial(n,2))==0)+2*A365605(2*binomial(n,2)+1)*binomial(n,2)))

...
; Formula: a(n) = truncate(c(n+2)/3), b(n) = 3*c(n-1)+3*d(n-1)+2*e(n-1)+max(b(n-1),3), b(3) = 36, b(2) = 12, b(1) = 3, b(0) = 0, c(n) = max(b(n-1),3), c(3) = 12, c(2) = 3, c(1) = 3, c(0) = 0, d(n) = b(n-1), d(3) = 12, d(2) = 3, d(1) = 0, d(0) = 0, e(n) = c(n-1)+d(n-1)+e(n-1), e(3) = 9, e(2) = 3, e(1) = 0, e(0) = 0

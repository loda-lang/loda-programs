...
; Formula: a(n) = -b(n-2)+b(n-1)+a(n-1)+a(n-3)+c(n-3), a(8) = 38, a(7) = 20, a(6) = 10, a(5) = 5, a(4) = 3, a(3) = 2, a(2) = 1, a(1) = 0, a(0) = 0, b(n) = 2*b(n-1)-b(n-2)+b(n-4), b(8) = 28, b(7) = 17, b(6) = 10, b(5) = 6, b(4) = 4, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = a(n-1)+c(n-1), c(7) = 21, c(6) = 11, c(5) = 6, c(4) = 3, c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0

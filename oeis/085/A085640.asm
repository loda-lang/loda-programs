...
; Formula: a(n) = truncate(d(n)/2)+1, b(n) = 11*b(n-2)+4*c(n-2)+2*b(n-1)+2*e(n-2), b(4) = 477, b(3) = 91, b(2) = 17, b(1) = 3, b(0) = 1, c(n) = 3*b(n-1)+c(n-1), c(3) = 63, c(2) = 12, c(1) = 3, c(0) = 0, d(n) = 12*b(n-1)+4*c(n-1)+2*e(n-1)+d(n-1), d(3) = 384, d(2) = 72, d(1) = 12, d(0) = 0, e(n) = 6*b(n-1)+2*c(n-1)+e(n-1), e(3) = 156, e(2) = 30, e(1) = 6, e(0) = 0

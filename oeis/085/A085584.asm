...
; Formula: a(n) = c(n+1)/9+1, b(n) = 3*b(n-1)-d(n-1)+c(n-1)+1, b(3) = 35, b(2) = 14, b(1) = 5, b(0) = 1, c(n) = c(n-2)+d(n-1)+6, c(3) = 31, c(2) = 13, c(1) = 4, c(0) = 1, d(n) = 3*b(n-1)+c(n-1)+2, d(3) = 57, d(2) = 21, d(1) = 6, d(0) = 0

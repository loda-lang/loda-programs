...
; Formula: a(n) = d(n-1), a(5) = 20, a(4) = 9, a(3) = 4, a(2) = 2, a(1) = 1, a(0) = 1, b(n) = b(n-2)+d(n-3), b(5) = 5, b(4) = 3, b(3) = 1, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = -b(n-1)+c(n-1), c(5) = -5, c(4) = -2, c(3) = -1, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 2*d(n-1)-c(n-1)+b(n-1), d(5) = 45, d(4) = 20, d(3) = 9, d(2) = 4, d(1) = 2, d(0) = 1

...
; Formula: a(n) = truncate(b(n)/9)+1, b(n) = b(n-2)+c(n-1)+6, b(3) = 31, b(2) = 13, b(1) = 4, b(0) = 1, c(n) = 3*c(n-1)+3*c(n-4)-c(n-2)-3*c(n-3)+6, c(5) = 318, c(4) = 138, c(3) = 57, c(2) = 21, c(1) = 6, c(0) = 0

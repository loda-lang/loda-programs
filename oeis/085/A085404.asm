...
; Formula: a(n) = truncate((d(n+1)*c(n+1))/9), b(n) = b(n-1)*(c(n-1)+1)*(4*c(n-1)+3), b(2) = 180, b(1) = 3, b(0) = 1, c(n) = 4*c(n-1)+3, c(2) = 15, c(1) = 3, c(0) = 0, d(n) = b(n-1)*(4*c(n-1)+3), d(2) = 45, d(1) = 3, d(0) = 0

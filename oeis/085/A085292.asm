...
; Formula: a(n) = 3*c(n-1)+2*b(n-1)+2*c(n-2)+2*a(n-1)+b(n-2)+a(n-2)+6, a(3) = 119, a(2) = 28, a(1) = 9, a(0) = 1, b(n) = b(n-1)+c(n-1)+a(n-1), b(3) = 47, b(2) = 10, b(1) = 1, b(0) = -1, c(n) = -c(n-1)+a(n-1), c(3) = 19, c(2) = 9, c(1) = 0, c(0) = 1

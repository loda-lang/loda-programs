...
; Formula: a(n) = d(n-1), b(n) = b(n-1)+c(n-1)+d(n-1), b(3) = 47, b(2) = 10, b(1) = 1, b(0) = -1, c(n) = -c(n-1)+d(n-1), c(3) = 19, c(2) = 9, c(1) = 0, c(0) = 1, d(n) = 3*c(n-1)+2*b(n-1)+2*d(n-1)+e(n-1)+6, d(3) = 119, d(2) = 28, d(1) = 9, d(0) = 1, e(n) = 2*c(n-1)+b(n-1)+d(n-1), e(3) = 56, e(2) = 10, e(1) = 2, e(0) = 0

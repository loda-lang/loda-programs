...
; Formula: a(n) = 3*a(n-1)-3*b(n-1)+c(n-1), a(2) = 2512, a(1) = 44, a(0) = 1, b(n) = 48*b(n-1)+16*b(n-1)+12*a(n-1)+4*c(n-1)-12*b(n-1)-16*c(n-1)-48*a(n-1), b(2) = -41664, b(1) = -720, b(0) = -12, c(n) = 15*a(n-1)+5*c(n-1)-15*b(n-1), c(2) = 12560, c(1) = 220, c(0) = 5

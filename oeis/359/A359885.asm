...
; Formula: a(n) = d(n+1), b(n) = 48*b(n-1)+16*b(n-1)+12*d(n-1)+4*c(n-1)-12*b(n-1)-16*c(n-1)-48*d(n-1), b(2) = -720, b(1) = -12, b(0) = 0, c(n) = 15*d(n-1)+5*c(n-1)-15*b(n-1), c(2) = 220, c(1) = 5, c(0) = 1, d(n) = 3*d(n-1)-3*b(n-1)+c(n-1), d(2) = 44, d(1) = 1, d(0) = 0

...
; Formula: a(n) = b(n-1)-1, b(n) = 2*truncate(if(truncate(b(n-1)/2)==0,0,truncate(b(n-1)/2)/(4^valuation(truncate(b(n-1)/2),4)))/2)-if(truncate(b(n-1)/2)==0,0,truncate(b(n-1)/2)/(4^valuation(truncate(b(n-1)/2),4)))+b(n-1)+2, b(0) = 2

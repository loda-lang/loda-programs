...
; Formula: a(n) = truncate(d(n+1)/2), b(n) = 2*b(n-1)-4*truncate(b(n-1)/2)+c(n-1)+2, b(2) = 3, b(1) = 2, b(0) = 0, c(n) = 4*truncate(b(n-1)/2)-d(n-1)-2*b(n-1)+c(n-1)+1, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = 2*b(n-1)-4*truncate(b(n-1)/2)+d(n-1), d(2) = 0, d(1) = 0, d(0) = 0

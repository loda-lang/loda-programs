...
; Formula: a(n) = -truncate(a(n-1)/b(n-1))*b(n-1)+b(n-1)+a(n-1)+truncate((-truncate(a(n-1)/b(n-1))*b(n-1)+2*b(n-1)+a(n-1))/2)+1, a(1) = 3, a(0) = 0, b(n) = truncate((-truncate(a(n-1)/b(n-1))*b(n-1)+2*b(n-1)+a(n-1))/2)+1, b(1) = 2, b(0) = 1

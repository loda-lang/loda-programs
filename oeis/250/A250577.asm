...
; Formula: a(n) = f(2*n+9)-3, b(n) = b(n-2)+d(n-2), b(9) = 3, b(8) = 3, b(7) = 1, b(6) = 1, b(5) = 0, b(4) = 0, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = c(n-2)+e(n-2)+1, c(9) = 16, c(8) = 16, c(7) = 7, c(6) = 7, c(5) = 3, c(4) = 3, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = -d(n-2)+e(n-2), d(9) = 6, d(8) = 6, d(7) = 2, d(6) = 2, d(5) = 1, d(4) = 1, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = b(n-2)+c(n-2)+d(n-2)+e(n-2)+1, e(9) = 19, e(8) = 19, e(7) = 8, e(6) = 8, e(5) = 3, e(4) = 3, e(3) = 1, e(2) = 1, e(1) = 0, e(0) = 0, f(n) = c(n-2)+e(n-2)+f(n-2)+1, f(9) = 27, f(8) = 27, f(7) = 11, f(6) = 11, f(5) = 4, f(4) = 4, f(3) = 1, f(2) = 1, f(1) = 0, f(0) = 0

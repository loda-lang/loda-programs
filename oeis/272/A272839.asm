...
; Formula: a(n) = c(n)+1, b(n) = truncate((2*b(n-1)+2)/(c(n-1)+1)), b(3) = 0, b(2) = 1, b(1) = 2, b(0) = 0, c(n) = 8*d(n-1)+2*c(n-1)+4, c(3) = 148, c(2) = 28, c(1) = 4, c(0) = 0, d(n) = 4*d(n-1)-n+b(n-1)+3, d(3) = 45, d(2) = 11, d(1) = 2, d(0) = 0

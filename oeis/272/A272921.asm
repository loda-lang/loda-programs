...
; Formula: a(n) = 2*b(n)+1, b(n) = (2*d(n-1))^2+2*c(n-1)+2*e(n-1), b(3) = 74, b(2) = 14, b(1) = 2, b(0) = 0, c(n) = (2*d(n-2))^2+2*c(n-2)+2*e(n-2)-2*d(n-1)+c(n-1)+2, c(3) = 31, c(2) = 9, c(1) = 3, c(0) = 1, d(n) = 2*d(n-1)-1, d(3) = -7, d(2) = -3, d(1) = -1, d(0) = 0, e(n) = 2*c(n-1)+2*e(n-1), e(3) = 38, e(2) = 10, e(1) = 2, e(0) = 0

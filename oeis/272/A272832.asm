...
; Formula: a(n) = 4*((-d(n)*(-d(n)+min(n,0))-b(n)-c(n)-d(n)+min(n,0))/72)+1, b(n) = 2*b(n-1), b(3) = 8, b(2) = 4, b(1) = 2, b(0) = 1, c(n) = 4*b(n-1)+2*d(n-1)+2*e(n-1), c(3) = 688, c(2) = 176, c(1) = 16, c(0) = 0, d(n) = 2*d(n-1), d(3) = 48, d(2) = 24, d(1) = 12, d(0) = 6, e(n) = 6*b(n-1)+3*d(n-1)+3*e(n-1)+48, e(3) = 1080, e(2) = 312, e(1) = 72, e(0) = 0

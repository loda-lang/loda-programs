...
; Formula: a(n) = d(n)+4, b(n) = b(n-1)+3, b(4) = 9, b(3) = 6, b(2) = 3, b(1) = 3, b(0) = 3, c(n) = 3, c(4) = 3, c(3) = 3, c(2) = 3, c(1) = 3, c(0) = 0, d(n) = b(n-2)+truncate(c(n-2)/2)+5, d(4) = 9, d(3) = 6, d(2) = 5, d(1) = 3, d(0) = 0

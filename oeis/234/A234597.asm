...
; Formula: a(n) = e(n+1)+1, b(n) = 2*d(n-1)-e(n-1)+b(n-1)+c(n-1)+3, b(4) = 33, b(3) = 13, b(2) = 6, b(1) = 3, b(0) = 0, c(n) = 2*d(n-1)-e(n-1)+b(n-1)+f(n-1)+2, c(4) = 31, c(3) = 13, c(2) = 4, c(1) = 2, c(0) = 0, d(n) = b(n-1)+f(n-1)+1, d(4) = 26, d(3) = 12, d(2) = 5, d(1) = 1, d(0) = 0, e(n) = 2*b(n-1)+2*d(n-1)-e(n-1)+c(n-1)+4, e(4) = 47, e(3) = 20, e(2) = 10, e(1) = 4, e(0) = 0, f(n) = b(n-1)+f(n-1)+1, f(4) = 26, f(3) = 12, f(2) = 5, f(1) = 1, f(0) = 0

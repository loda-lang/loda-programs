...
; Formula: a(n) = b(n+1)+1, b(n) = 4*c(n-2)+4*c(n-3)+c(n-1)+c(n-4)+11, b(9) = 2393, b(8) = 1098, b(7) = 500, b(6) = 228, b(5) = 106, b(4) = 47, b(3) = 20, b(2) = 10, b(1) = 4, b(0) = 0, c(n) = 3*c(n-3)+c(n-1)+c(n-2)+c(n-4)+6, c(9) = 1388, c(8) = 634, c(7) = 289, c(6) = 133, c(5) = 60, c(4) = 26, c(3) = 12, c(2) = 5, c(1) = 1, c(0) = 0

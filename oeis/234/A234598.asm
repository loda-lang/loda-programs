...
; Formula: a(n) = b(n+2), b(n) = 2*c(n-2)+2*d(n-2)-c(n-2), b(4) = 35, b(3) = 18, b(2) = 9, b(1) = 2, b(0) = 2, c(n) = 4*c(n-3)+4*d(n-3)+2*c(n-2)-c(n-3)-2*c(n-2)+c(n-2)+c(n-3)+d(n-3), c(4) = 64, c(3) = 34, c(2) = 13, c(1) = 4, c(0) = 5, d(n) = c(n-1)+d(n-1), d(4) = 58, d(3) = 24, d(2) = 11, d(1) = 7, d(0) = 2

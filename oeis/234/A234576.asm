...
; Formula: a(n) = c(n+1), b(n) = 5*d(n-3)+4*b(n-3)+b(n-2), b(4) = 39, b(3) = 20, b(2) = 7, b(1) = 3, b(0) = 3, c(n) = b(n-1)+d(n-1), c(4) = 34, c(3) = 14, c(2) = 7, c(1) = 4, c(0) = 0, d(n) = 3*d(n-3)+d(n-1)+d(n-2)+d(n-4), d(4) = 34, d(3) = 14, d(2) = 7, d(1) = 4, d(0) = 1

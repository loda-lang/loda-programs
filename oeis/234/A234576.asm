...
; Formula: a(n) = b(n+1), b(n) = 3*c(n-3)+c(n-1)+c(n-2)+c(n-4), b(5) = 73, b(4) = 34, b(3) = 14, b(2) = 7, b(1) = 4, b(0) = 0, c(n) = 3*c(n-3)+c(n-1)+c(n-2)+c(n-4), c(5) = 73, c(4) = 34, c(3) = 14, c(2) = 7, c(1) = 4, c(0) = 1

...
; Formula: a(n) = floor((b(n)*10^(logint(b(n)+1,10)+1)+b(n))/gcd(10000000000000000000000000000000000000,b(n)*10^(logint(b(n)+1,10)+1)+b(n))), b(n) = b(n-1)*10^(logint(n,10)+1)+n, b(2) = 12, b(1) = 1, b(0) = 0

...
; Formula: a(n) = a(n-1)+c(n-1)+1, a(2) = 2, a(1) = 1, a(0) = 0, b(n) = 2*b(n-1)-b(n-2)+truncate((-c(n-3)+b(n-3)-1)/2)+1, b(3) = 3, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = truncate((-c(n-1)+b(n-1)-1)/2), c(2) = 0, c(1) = 0, c(0) = 0

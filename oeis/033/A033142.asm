...
; Formula: a(n) = b(n+1), b(n) = 6*b(n-1)-2*truncate(c(n-1)/2)+c(n-1), b(1) = 1, b(0) = 0, c(n) = 7*c(n-1)+6*truncate(c(n-2)/2)-2*truncate(c(n-1)/2)-3*c(n-2)-5, c(3) = 19, c(2) = 4, c(1) = 2, c(0) = 1

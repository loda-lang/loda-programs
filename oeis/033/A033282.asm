...
; Formula: a(n) = truncate((binomial(floor((sqrtint(8*n-16)-1)/2),-binomial(floor((sqrtint(8*n-16)-1)/2)+1,2)+n-3)*binomial(-binomial(floor((sqrtint(8*n-16)-1)/2)+1,2)+floor((sqrtint(8*n-16)-1)/2)+n-1,-binomial(floor((sqrtint(8*n-16)-1)/2)+1,2)+n-3))/(-binomial(floor((sqrtint(8*n-16)-1)/2)+1,2)+n-2))

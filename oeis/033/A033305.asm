...
; Formula: a(n) = -d(n-1)-e(n-1)+b(n-1)+c(n-1), a(5) = 6, a(4) = 4, a(3) = 2, a(2) = 1, a(1) = 0, a(0) = 1, b(n) = -d(n-1)-d(n-2)-e(n-1)+c(n-1)+c(n-2), b(5) = 5, b(4) = 2, b(3) = 2, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = 2*c(n-2)-d(n-3)-e(n-2)-3*d(n-2)+c(n-1)+c(n-3), c(9) = 78, c(8) = 42, c(7) = 23, c(6) = 11, c(5) = 6, c(4) = 4, c(3) = 2, c(2) = 0, c(1) = 1, c(0) = 0, d(n) = b(n-1), d(5) = 2, d(4) = 2, d(3) = 1, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = -c(n-1)+d(n-1)+e(n-1), e(5) = -4, e(4) = -2, e(3) = -1, e(2) = -1, e(1) = 0, e(0) = 0

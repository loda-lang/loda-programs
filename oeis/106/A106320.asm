...
; Formula: a(n) = 2*d(n), b(n) = ((625*b(n-1)^6)==min(625*b(n-1)^6,c(n-1)^6))+b(n-1), b(2) = 1, b(1) = 1, b(0) = 1, c(n) = ((c(n-1)^6)==min(625*b(n-1)^6,c(n-1)^6))+c(n-1), c(2) = 3, c(1) = 2, c(0) = 1, d(n) = min(625*b(n-1)^6,c(n-1)^6), d(2) = 64, d(1) = 1, d(0) = 0

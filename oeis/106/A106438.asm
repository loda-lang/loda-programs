...
; Formula: a(n) = 2*d(n-1)-c(n-1)+c(n-2)+d(n-2)+2, a(4) = 69, a(3) = 22, a(2) = 7, a(1) = 2, a(0) = 0, b(n) = b(n-1)+c(n-1), b(4) = -13, b(3) = -5, b(2) = -2, b(1) = -1, b(0) = -1, c(n) = 2*c(n-1)+b(n-1), c(4) = -21, c(3) = -8, c(2) = -3, c(1) = -1, c(0) = 0, d(n) = 3*d(n-1)+c(n-2)+d(n-2)+2, d(4) = 88, d(3) = 27, d(2) = 8, d(1) = 2, d(0) = 0

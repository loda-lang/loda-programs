...
; Formula: a(n) = -2*min(n-1,1)-2*A144338(max(n-2,0)+1)+truncate((6*min(n-1,1)+6*A144338(max(n-2,0)+1)-6*A003557(min(n-1,1)+A144338(max(n-2,0)+1)-1)-6)/6)+A000203(min(n-1,1)+A144338(max(n-2,0)+1)-1)+2

...
; Formula: a(n) = b(n)-1, b(n) = -truncate(binomial(5*n-5,4*n-4)/(4*n-3))*truncate(2^(4*n-3))+truncate(binomial(5*n,4*n)/(4*n+1))*truncate(2^(4*n+1))+b(n-2), b(2) = 2530, b(1) = 32, b(0) = 2

...
; Formula: a(n) = sqrtnint(2*truncate(b(n-1)/4)+2,n), b(n) = d(n-1)*c(n-1)+b(n-1), b(2) = 72, b(1) = 12, b(0) = 0, c(n) = d(n-1)*c(n-1), c(2) = 60, c(1) = 12, c(0) = 4, d(n) = A159477(d(n-1)), d(2) = 7, d(1) = 5, d(0) = 3

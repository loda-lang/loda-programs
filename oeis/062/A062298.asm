...
; Formula: a(n) = (-b(n+1)+d(n+1)+n+3)/2-1, b(n) = -2*binomial(gcd(c(n-1),n+1),n+1), b(3) = 0, b(2) = -2, b(1) = -2, b(0) = 0, c(n) = 2*c(n-1)-n-2, c(3) = -25, c(2) = -10, c(1) = -3, c(0) = 0, d(n) = -2*binomial(gcd(c(n-1),n+1),n+1)+d(n-1)+1, d(3) = -1, d(2) = -2, d(1) = -1, d(0) = 0

...
; Formula: a(n) = b(n-1)+b(n-4), a(7) = 1, a(6) = 0, a(5) = 0, a(4) = 0, a(3) = 0, a(2) = 0, a(1) = 1, a(0) = 0, b(n) = b(n-1)+b(n-2)+b(n-3)+b(n-4)+b(n-5)+b(n-6)+b(n-7), b(9) = 5, b(8) = 2, b(7) = 1, b(6) = 1, b(5) = 1, b(4) = 1, b(3) = 0, b(2) = -1, b(1) = -1, b(0) = 0

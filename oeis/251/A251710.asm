...
; Formula: a(n) = b(max(n-4,0)), b(n) = c(n-1)+c(n-4), b(7) = 16, b(6) = 8, b(5) = 4, b(4) = 2, b(3) = 1, b(2) = 0, b(1) = 1, b(0) = 0, c(n) = c(n-1)+c(n-2)+c(n-3)+c(n-4)+c(n-5)+c(n-6)+c(n-7), c(9) = 112, c(8) = 56, c(7) = 28, c(6) = 14, c(5) = 7, c(4) = 4, c(3) = 2, c(2) = 1, c(1) = 0, c(0) = 0

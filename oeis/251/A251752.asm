...
; Formula: a(n) = b(n+2), b(n) = c(n-1)+d(n-1)+f(n-1)-1, b(8) = 0, b(7) = 0, b(6) = 0, b(5) = 0, b(4) = 0, b(3) = 1, b(2) = 0, b(1) = -1, b(0) = 0, c(n) = d(n-2), c(8) = -3, c(7) = -2, c(6) = -1, c(5) = 0, c(4) = 0, c(3) = 0, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = -b(n-2)+e(n-2), d(8) = -12, d(7) = -6, d(6) = -3, d(5) = -2, d(4) = -1, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = 2*e(n-1)-b(n-1)+c(n-1)+d(n-1)+f(n-1)-1, e(8) = -48, e(7) = -24, e(6) = -12, e(5) = -6, e(4) = -3, e(3) = -1, e(2) = -1, e(1) = -1, e(0) = 0, f(n) = -c(n-2)-d(n-2)-f(n-2)-2*e(n-2)+b(n-2)+c(n-2)+e(n-2)+f1(n-2)+2, f(8) = 16, f(7) = 9, f(6) = 5, f(5) = 3, f(4) = 2, f(3) = 1, f(2) = 2, f(1) = 1, f(0) = 0, f1(n) = -e(n-1)-f1(n-1), f1(8) = 16, f1(7) = 8, f1(6) = 4, f1(5) = 2, f1(4) = 1, f1(3) = 0, f1(2) = 1, f1(1) = 0, f1(0) = 0

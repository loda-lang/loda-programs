...
; Formula: a(n) = -d(n-1)+b(n-1)+c(n-1)+a(n-1), a(4) = 2, a(3) = 0, a(2) = 1, a(1) = 0, a(0) = 1, b(n) = -d(n-2)+c(n-2)+a(n-2), b(4) = 1, b(3) = 1, b(2) = -1, b(1) = 0, b(0) = 1, c(n) = -d(n-1)+b(n-1)+c(n-1)+a(n-1), c(4) = 2, c(3) = 0, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = -d(n-1)+b(n-1)+c(n-1), d(4) = 2, d(3) = -1, d(2) = 1, d(1) = -1, d(0) = 2

...
; Formula: a(n) = c(n+2), b(n) = d(n-1), b(4) = 1, b(3) = 0, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = -c(n-2)+d(n-1), c(4) = 1, c(3) = 1, c(2) = 0, c(1) = -1, c(0) = 1, d(n) = b(n-1)+c(n-1)+e(n-1), d(4) = 2, d(3) = 1, d(2) = 0, d(1) = 1, d(0) = 0, e(n) = b(n-1)+c(n-1)+e(n-1), e(4) = 2, e(3) = 1, e(2) = 0, e(1) = 1, e(0) = 0

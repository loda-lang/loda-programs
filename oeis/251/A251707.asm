...
; Formula: a(n) = -d(n)+c(n), b(n) = b(n-1)+b(n-2)+b(n-3)+b(n-4)+b(n-5)+b(n-6), b(6) = 2, b(5) = 1, b(4) = 1, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = b(n-1)+b(n-2)+b(n-3)+b(n-4)+b(n-5), c(6) = 2, c(5) = 1, c(4) = 0, c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = b(n-1), d(5) = 1, d(4) = 0, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0

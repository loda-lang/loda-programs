...
; Formula: a(n) = d(n-3), a(6) = 0, a(5) = 0, a(4) = 1, a(3) = 0, a(2) = 0, a(1) = 0, a(0) = 0, b(n) = 2*a(n-1)+2*c(n-1)+b(n-1), b(6) = 5, b(5) = 3, b(4) = 1, b(3) = 1, b(2) = -1, b(1) = 1, b(0) = 1, c(n) = a(n-2)+d(n-1), c(6) = 3, c(5) = 1, c(4) = 0, c(3) = 0, c(2) = 1, c(1) = -1, c(0) = 0, d(n) = a(n-1)+b(n-1)+c(n-1), d(6) = 4, d(5) = 2, d(4) = 1, d(3) = 0, d(2) = 0, d(1) = 1, d(0) = 0

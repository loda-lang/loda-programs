...
; Formula: a(n) = -a(n-2)+b(n-2), a(6) = 5, a(5) = 3, a(4) = 2, a(3) = 0, a(2) = 0, a(1) = 1, a(0) = 1, b(n) = b(n-1)+b(n-2)+b(n-3)+b(n-4), b(8) = 93, b(7) = 48, b(6) = 25, b(5) = 13, b(4) = 7, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 0

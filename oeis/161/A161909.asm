...
; Formula: a(n) = truncate(b(n)/6), b(n) = -5*b(n-1)-6*b(n-2)-12*c(n-3)+12, b(7) = -246, b(6) = 138, b(5) = -78, b(4) = 42, b(3) = -18, b(2) = 6, b(1) = 0, b(0) = 0, c(n) = -2*c(n-1)-2*c(n-2)+3, c(6) = 7, c(5) = -5, c(4) = 3, c(3) = 1, c(2) = -1, c(1) = 2, c(0) = 0

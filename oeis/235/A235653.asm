...
; Formula: a(n) = 4*d(n+1)+4, b(n) = -e(n-1)+b(n-1)+d(n-1)+1, b(5) = 101, b(4) = 33, b(3) = 11, b(2) = 3, b(1) = 1, b(0) = 0, c(n) = -b(n-1)-e(n-1)+c(n-1)+d(n-1)+1, c(5) = 53, c(4) = 18, c(3) = 7, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = 3*c(n-1)+2*d(n-1)-e(n-1)-2*b(n-1)+f(n-1)+f1(n-1)+3, d(5) = 347, d(4) = 118, d(3) = 39, d(2) = 12, d(1) = 3, d(0) = 0, e(n) = 2*d(n-1)-2*e(n-1)+c(n-1)+2, e(5) = 154, e(4) = 51, e(3) = 18, e(2) = 5, e(1) = 2, e(0) = 0, f(n) = 3*c(n-1)+2*d(n-1)-e(n-1)-2*b(n-1)+f(n-1)+f1(n-1)+3, f(5) = 347, f(4) = 118, f(3) = 39, f(2) = 12, f(1) = 3, f(0) = 0, f1(n) = -b(n-1)+c(n-1)+f(n-1)+f1(n-1)+1, f1(5) = 157, f1(4) = 53, f1(3) = 17, f1(2) = 5, f1(1) = 1, f1(0) = 0

...
; Formula: a(n) = b(n+1)/2, b(n) = d(n-2)*(-e(n-2)+c(n-2)+n-2)+b(n-1), b(5) = 14, b(4) = 2, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = c(n-1)+n-2, c(5) = 6, c(4) = 3, c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = -e(n-1)+c(n-1)+d(n-1)+n, d(5) = 15, d(4) = 8, d(3) = 4, d(2) = 2, d(1) = 1, d(0) = 0, e(n) = 1, e(5) = 1, e(4) = 1, e(3) = 1, e(2) = 1, e(1) = 1, e(0) = 0

...
; Formula: a(n) = truncate(b(n)/2), b(n) = b(n-1)+c(n-1), b(5) = 14, b(4) = 2, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = e(n-1)*(-f(n-1)+d(n-1)+n-1), c(5) = 48, c(4) = 12, c(3) = 2, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = d(n-1)+n-2, d(5) = 6, d(4) = 3, d(3) = 1, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = -f(n-1)+d(n-1)+e(n-1)+n, e(5) = 15, e(4) = 8, e(3) = 4, e(2) = 2, e(1) = 1, e(0) = 0, f(n) = 1, f(5) = 1, f(4) = 1, f(3) = 1, f(2) = 1, f(1) = 1, f(0) = 0

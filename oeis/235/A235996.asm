...
; Formula: a(n) = c(n-1)+a(n-1), a(5) = 4, a(4) = 1, a(3) = 0, a(2) = 0, a(1) = 0, a(0) = 0, b(n) = b(n-1)+b(n-2), b(5) = 8, b(4) = 5, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = 2*e(n-2)+c(n-2)+d(n-2), c(5) = 9, c(4) = 3, c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = b(n-1)+c(n-1)+a(n-1), d(5) = 9, d(4) = 4, d(3) = 2, d(2) = 1, d(1) = 1, d(0) = 0, e(n) = 2*e(n-1)+b(n-2), e(5) = 19, e(4) = 8, e(3) = 3, e(2) = 1, e(1) = 0, e(0) = 0

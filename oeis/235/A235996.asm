...
; Formula: a(n) = c(n-1)+a(n-1), a(5) = 4, a(4) = 1, a(3) = 0, a(2) = 0, a(1) = 0, a(0) = 0, b(n) = b(n-1)+b(n-2), b(5) = 8, b(4) = 5, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = 2*c(n-1)-a(n-2)-2*b(n-3)+b(n-1)+b(n-5)+c(n-2), c(8) = 130, c(7) = 56, c(6) = 23, c(5) = 9, c(4) = 3, c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0

; A165052: A165051(n)/5
; Submitted by biodoc
; 0,0,0,0,0,0,1,0,1,2,3,4,2,1,0,1,2,3,3,2,1,0,1,2,4,3,2,1,0,1,5,4,3,2,1,0,7,7,14,21,28,35,7,0,7,14,21,28,14,7,7,14,21,28,21,14,14,14,21,28,28,21,21,21,21,28,35,28,28,28,28,28,14,14,14,21,28,35,14,7
; Formula: a(n) = truncate((-A028901(A004185(A007092(n)))+A028901(A004186(A007092(n))))/5)

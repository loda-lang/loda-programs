; A165198: Primes from integers by taking the factorial of each digit and adding them up.
...
; Formula: a(n) = A061602(A165451(n))

seq $0,165451 ; Sum of factorial of digits is prime.

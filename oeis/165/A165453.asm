...
; Formula: a(n) = c(n)/2, b(n) = (b(n-1)+d(n-1))/n, b(4) = 2, b(3) = 2, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = 2*b(n-1)+c(n-1), c(4) = 12, c(3) = 8, c(2) = 4, c(1) = 2, c(0) = 0, d(n) = 2*((b(n-2)+d(n-2))/(n-1))+b(n-2)+d(n-2)+1, d(4) = 11, d(3) = 9, d(2) = 4, d(1) = 3, d(0) = 0

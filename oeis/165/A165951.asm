...
; 0,0,0,1,1,0,0,1,3,0,3,0,0,1,5,0,3,0,1,7,0,5,3,0,0,0,5,3,0,0,5,5,0,3,0,7,0,1,11,0,5,0,13,0,0,9,3,7,5,0,0,15,0,7,0,13,0,11,0,0,3,0,3,19,0,0,3,0,5,0,0,19,9,0,3,17,0,0,0,0
; Formula: a(n) = A118235(2*A228587(A000040(max(n,2)+1)-1)-1)-1

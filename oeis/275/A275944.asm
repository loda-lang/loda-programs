...
; Formula: a(n) = floor((d(n-1)*b(n-1))/97680), b(n) = (10*c(n-1)+20)*(10*c(n-1)+gcd(b(n-1),2)+20), b(2) = 48840, b(1) = 440, b(0) = 0, c(n) = 10*c(n-1)+20, c(2) = 220, c(1) = 20, c(0) = 0, d(n) = floor((b(n-1)+d(n-1))/(10*c(n-1)+20)), d(2) = 2, d(1) = 0, d(0) = 0

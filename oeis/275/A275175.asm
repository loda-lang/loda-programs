...
; Formula: a(n) = b(max(n-5,0)), b(n) = (f(n-1)*d(n-1)+2*c(n-1))/e(n-1), b(6) = 83, b(5) = 23, b(4) = 13, b(3) = 7, b(2) = 5, b(1) = 3, b(0) = 1, c(n) = (f(n-3)*c(n-5)+2*c(n-3))/c(n-6), c(8) = 83, c(7) = 23, c(6) = 13, c(5) = 7, c(4) = 5, c(3) = 3, c(2) = 1, c(1) = 1, c(0) = 1, d(n) = c(n-2), d(6) = 5, d(5) = 3, d(4) = 1, d(3) = 1, d(2) = 1, d(1) = 1, d(0) = 1, e(n) = d(n-1), e(6) = 3, e(5) = 1, e(4) = 1, e(3) = 1, e(2) = 1, e(1) = 1, e(0) = 1, f(n) = (f(n-1)*d(n-1)+2*c(n-1))/e(n-1), f(6) = 83, f(5) = 23, f(4) = 13, f(3) = 7, f(2) = 5, f(1) = 3, f(0) = 1

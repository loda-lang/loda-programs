...
; Formula: a(n) = ((A003987(n)+n)-A002260(n))+1

mov $1,$0
seq $1,3987 ; Table of n XOR m (or Nim-sum of n and m) read by antidiagonals, i.e., with entries in the order (n,m) = (0,0), (0,1), (1,0), (0,2), (1,1), (2,0), ...
add $1,$0

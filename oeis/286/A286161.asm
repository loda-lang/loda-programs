...
; Formula: a(n) = truncate(((logint(floor((bitxor(2*n,2*n-1)+1)/2),2)+A124859(A181819(n)*A181811(A181819(n))))^2-logint(floor((bitxor(2*n,2*n-1)+1)/2),2)-3*A124859(A181819(n)*A181811(A181819(n)))+2)/2)

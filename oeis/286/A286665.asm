...
; Formula: a(n) = (b(n+2)-1)%2+1, b(n) = (-(c(n-1)/2)+b(n-1)+1)/2, b(2) = -4, b(1) = -1, b(0) = 0, c(n) = 2*gcd(2*((-(c(n-1)/2)+b(n-1)+1)/2)+2*d(n-1),4)*(c(n-1)/2), c(2) = 64, c(1) = 16, c(0) = 9, d(n) = gcd(2*((-(c(n-1)/2)+b(n-1)+1)/2)+2*d(n-1),4), d(2) = 4, d(1) = 2, d(0) = 0

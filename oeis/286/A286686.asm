...
; Formula: a(n) = 2*n-2*truncate((-2*truncate((-3*truncate(A286927(n)/4)+truncate(A286927(n+1)/4)-2)/2)-3*truncate(A286927(n)/4)+truncate(A286927(n+1)/4))/2)-2*truncate((-3*truncate(A286927(n)/4)+truncate(A286927(n+1)/4)-2)/2)-3*truncate(A286927(n)/4)+truncate(A286927(n+1)/4)+1

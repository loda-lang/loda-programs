...
; Formula: a(n) = b(n+1), b(n) = b(n-1)+d(n-1), b(3) = 6, b(2) = 3, b(1) = 2, b(0) = 2, c(n) = 2*d(n-1)+b(n-1), c(3) = 9, c(2) = 4, c(1) = 2, c(0) = 1, d(n) = c(n-1)+e(n-1), d(3) = 7, d(2) = 3, d(1) = 1, d(0) = 0, e(n) = c(n-1)+e(n-1), e(3) = 7, e(2) = 3, e(1) = 1, e(0) = 0

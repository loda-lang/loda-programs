...
; Formula: a(n) = b(n-1)+c(n-1)+1, a(4) = 13, a(3) = 8, a(2) = 5, a(1) = 3, a(0) = 2, b(n) = 2*b(n-3)+c(n-3)+2, b(4) = 7, b(3) = 4, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = b(n-1)+c(n-1)+1, c(4) = 13, c(3) = 8, c(2) = 5, c(1) = 3, c(0) = 2

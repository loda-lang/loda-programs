...
; Formula: a(n) = 3*truncate(A286927(floor(n/2))/4)-truncate(A286927(floor(n/2)+1)/4)-2*truncate((3*truncate(A286927(floor(n/2))/4)-truncate(A286927(floor(n/2)+1)/4)+n+3)/2)+n+3

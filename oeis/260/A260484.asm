...
; Formula: a(n) = truncate(b(7*n)/truncate((3*c(7*n)-2*d(7*n))/n)), b(n) = 12*b(n-1), b(2) = 144, b(1) = 12, b(0) = 1, c(n) = b(n-1)+c(n-1), c(2) = 13, c(1) = 1, c(0) = 0, d(n) = d(n-1), d(2) = 0, d(1) = 0, d(0) = 0

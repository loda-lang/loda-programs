...
; Formula: a(n) = 8*truncate(b(n+1)/9), b(n) = b(n-1)+d(n-1), b(3) = 21, b(2) = 12, b(1) = 3, b(0) = 0, c(n) = truncate((6*n+c(n-1)+1)/d(n-1)), c(3) = 2, c(2) = 1, c(1) = 3, c(0) = 2, d(n) = truncate((6*n+c(n-1)+1)/d(n-1))*d(n-1), d(3) = 18, d(2) = 9, d(1) = 9, d(0) = 3

...
; Formula: a(n) = 2*max(2*truncate(b(n-1)/3)+1,2)-1, b(n) = b(n-1)+gcd(truncate((-d(n-2)+c(n-2))/2)+1,4)+2, b(3) = 12, b(2) = 9, b(1) = 3, b(0) = 0, c(n) = truncate(truncate((-d(n-1)+c(n-1))/2)/gcd(truncate((-d(n-1)+c(n-1))/2)+1,4)), c(3) = -90, c(2) = -20, c(1) = -1, c(0) = 0, d(n) = 4*d(n-1), d(3) = 640, d(2) = 160, d(1) = 40, d(0) = 10

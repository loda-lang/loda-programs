...
; Formula: a(n) = ((b(4*n+1)*(4*n+1))/2)/c(4*n+1)+1, b(n) = 22*c(n-1)+2*b(n-1)+2*c(n-1)+2*d(n-1)-2*c(n-1), b(3) = 27806, b(2) = 790, b(1) = 22, b(0) = 0, c(n) = 22*c(n-1)+11*c(n-1)+2*b(n-1)+2*c(n-1)+2*d(n-1)-2*c(n-1), c(3) = 40489, c(2) = 1153, c(1) = 33, c(0) = 1, d(n) = 10*c(n-1)+10*d(n-1), d(3) = 15830, d(2) = 430, d(1) = 10, d(0) = 0

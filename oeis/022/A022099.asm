...
; Formula: a(n) = (8*min(n,n%2)*b(n)+8*c(n)-8)/8+1, b(n) = b(n-2)+c(n-2), b(5) = 19, b(4) = 19, b(3) = 9, b(2) = 9, b(1) = 8, b(0) = 8, c(n) = b(n-2)+2*c(n-2), c(5) = 29, c(4) = 29, c(3) = 10, c(2) = 10, c(1) = 1, c(0) = 1

...
; Formula: a(n) = (min(n,n%2)*b(n)+c(n))/2+1, b(n) = b(n-2)+c(n-2)+1, b(5) = 78, b(4) = 78, b(3) = 38, b(2) = 38, b(1) = 36, b(0) = 36, c(n) = b(n-2)+2*c(n-2)+1, c(5) = 117, c(4) = 117, c(3) = 39, c(2) = 39, c(1) = 1, c(0) = 1

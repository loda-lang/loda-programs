...
; Formula: a(n) = min(n,n%2)*b(n)+c(n)+1, b(n) = b(n-2)+c(n-2)+1, b(5) = 23, b(4) = 23, b(3) = 11, b(2) = 11, b(1) = 10, b(0) = 10, c(n) = b(n-2)+2*c(n-2)+1, c(5) = 34, c(4) = 34, c(3) = 11, c(2) = 11, c(1) = 0, c(0) = 0

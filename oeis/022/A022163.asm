...
; Formula: a(n) = d(n)+1, b(n) = b(n-1)+d(n-1)+1, b(3) = 12, b(2) = 6, b(1) = 1, b(0) = 0, c(n) = -c(n-1)+d(n-1), c(3) = 1, c(2) = 4, c(1) = 0, c(0) = 0, d(n) = 5*d(n-2)-c(n-2)+b(n-2)+5, d(3) = 26, d(2) = 5, d(1) = 4, d(0) = 0

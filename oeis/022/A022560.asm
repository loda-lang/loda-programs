...
; Formula: a(n) = c(n-1)^if(n==0,0,valuation(n,2))+b(n-1)+a(n-1), a(3) = 8, a(2) = 4, a(1) = 1, a(0) = 0, b(n) = c(n-1)^if(n==0,0,valuation(n,2))+b(n-1), b(3) = 4, b(2) = 3, b(1) = 1, b(0) = 0, c(n) = c(n-1)^if(n==0,0,valuation(n,2))+1, c(3) = 2, c(2) = 3, c(1) = 2, c(0) = 0

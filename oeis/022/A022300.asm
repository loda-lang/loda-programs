...
; Formula: a(n) = d(n+2), b(n) = (-c(n-1)+b(n-1))/2, b(2) = -12, b(1) = -8, b(0) = 0, c(n) = c(n-1)*(((-c(n-1)+b(n-1))/2+d(n-1))%2+2), c(2) = 16, c(1) = 16, c(0) = 16, d(n) = ((-c(n-1)+b(n-1))/2+d(n-1))%2+2, d(2) = 1, d(1) = 1, d(0) = -1

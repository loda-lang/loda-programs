...
; Formula: a(n) = c(n+2), b(n) = b(n-1)+c(n-1), b(3) = 5, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = 2*b(n-1)+c(n-1)+d(n-1)+e(n-1)+1, c(3) = 16, c(2) = 4, c(1) = 1, c(0) = 0, d(n) = 2*b(n-1)+2*c(n-1)+b(n-1)+d(n-1)+1, d(3) = 16, d(2) = 4, d(1) = 1, d(0) = 0, e(n) = 2*b(n-1)+2*c(n-1)+d(n-1)+e(n-1)+1, e(3) = 20, e(2) = 5, e(1) = 1, e(0) = 0

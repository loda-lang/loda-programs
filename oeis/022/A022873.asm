...
; Formula: a(n) = truncate((c(n-1)*a(n-1))/b(n-1)), a(2) = 1, a(1) = 1, a(0) = 2, b(n) = truncate((c(n-1)*a(n-1))/b(n-1))*b(n-1), b(2) = 6, b(1) = 6, b(0) = 6, c(n) = truncate((c(n-1)*a(n-1))/b(n-1))*c(n-1)+b(n-1), c(2) = 15, c(1) = 9, c(0) = 3

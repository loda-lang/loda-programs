...
; Formula: a(n) = c(n-1), b(n) = truncate((d(n-1)*c(n-1))/b(n-1))*b(n-1), b(2) = 6, b(1) = 6, b(0) = 6, c(n) = truncate((d(n-1)*c(n-1))/b(n-1)), c(2) = 1, c(1) = 1, c(0) = 2, d(n) = truncate((d(n-1)*c(n-1))/b(n-1))*d(n-1)+b(n-1), d(2) = 15, d(1) = 9, d(0) = 3

...
; Formula: a(n) = c(n)+1, b(n) = b(n-1)+d(n-1)+1, b(3) = 7, b(2) = 3, b(1) = 2, b(0) = 1, c(n) = b(n-1)+c(n-1), c(3) = 6, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = b(n-1)+c(n-1)+d(n-1)+e(n-1), d(3) = 9, d(2) = 3, d(1) = 0, d(0) = 0, e(n) = -d(n-1)-e(n-1)+e(n-1), e(3) = -3, e(2) = 0, e(1) = 0, e(0) = -1

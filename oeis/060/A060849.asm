...
; Submitted by pututu
; 2,4,4,4,6,6,6,6,6,4,14,14,4,6,10,6,10,10,8,12,18,12,6,14,14,10,34,6,24,14,14,24,24,6,12,16,16,22,8,6,10,10,12,10,18,10,6,16,8,18,10,18,6,20,20,34,18,14,10,12,30,24,8,16,14,6,36,20,12,28,12,10,12,14,20,22,22,22,14,10
; Formula: a(n) = A013632(A136548(A134612(n-1)+1))

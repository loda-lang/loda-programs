...
; Formula: a(n) = d(n)/2+2, b(n) = -b(n-1)+b(n-1)+c(n-1)+d(n-1), b(2) = 4, b(1) = 3, b(0) = -2, c(n) = -b(n-1)-c(n-1)-d(n-1)+b(n-1)+c(n-1), c(2) = -4, c(1) = 0, c(0) = 3, d(n) = -b(n-1)+d(n-1)+2, d(2) = 3, d(1) = 4, d(0) = 0

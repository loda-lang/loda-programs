...
; Formula: a(n) = ((d(4*n)+1)/(c(4*n)/(10^n)))%10, b(n) = b(n-1)+c(n-1)+d(n-1), b(2) = 5, b(1) = 1, b(0) = 0, c(n) = 2*c(n-1)+b(n-1)+d(n-1), c(2) = 7, c(1) = 2, c(0) = 1, d(n) = 2*c(n-1)+2*d(n-1)+b(n-1), d(2) = 9, d(1) = 2, d(0) = 0

...
; Formula: a(n) = 2*c(n+1)+6, b(n) = b(n-1)+b(n-2)+c(n-2)+3, b(5) = 84, b(4) = 27, b(3) = 6, b(2) = 3, b(1) = 0, b(0) = 0, c(n) = 6*b(n-1)+5*c(n-2)+4*b(n-2)+c(n-1)+15, c(5) = 627, c(4) = 186, c(3) = 48, c(2) = 15, c(1) = 0, c(0) = 0

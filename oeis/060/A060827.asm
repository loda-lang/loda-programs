...
; Formula: a(n) = -a(n-1)+b(n-1)+4, a(5) = 10, a(4) = 6, a(3) = 4, a(2) = 2, a(1) = 2, a(0) = 2, b(n) = b(n-2)+b(n-4)+c(n-3)+8, b(5) = 18, b(4) = 12, b(3) = 6, b(2) = 2, b(1) = 0, b(0) = 0, c(n) = -a(n-1)+b(n-1)+c(n-1)+4, c(5) = 24, c(4) = 14, c(3) = 8, c(2) = 4, c(1) = 2, c(0) = 0

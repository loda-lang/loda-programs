...
; Formula: a(n) = b(n-1)+1, b(n) = b(n-1)+truncate(binomial(8,truncate((truncate(max(0,A003557(n+1)-1)/A019554(max(0,A003557(n+1)-1)+1))+2)^(2*truncate(max(0,A003557(n+1)-1)/A019554(max(0,A003557(n+1)-1)+1))+3))-3)/51), b(0) = 0

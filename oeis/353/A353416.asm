...
; Formula: a(n) = A000203(if((if(((2*A064989(n)-n)%2)==0,(2*A064989(n)-n)/2,2*A064989(n)-n)-A064989(n)+n)==0,0,(if(((2*A064989(n)-n)%2)==0,(2*A064989(n)-n)/2,2*A064989(n)-n)-A064989(n)+n)/(2^valuation(if(((2*A064989(n)-n)%2)==0,(2*A064989(n)-n)/2,2*A064989(n)-n)-A064989(n)+n,2))))

...
; Formula: a(n) = d(n+1), b(n) = 2*c(n-1)+b(n-1)+d(n-1)+f(n-1), b(4) = 77, b(3) = 17, b(2) = 3, b(1) = 1, b(0) = 0, c(n) = 3*b(n-1)+2*d(n-1)+b(n-1)+e(n-1), c(4) = 106, c(3) = 17, c(2) = 6, c(1) = 0, c(0) = 0, d(n) = 2*c(n-1)+f(n-1), d(4) = 47, d(3) = 13, d(2) = 1, d(1) = 1, d(0) = 0, e(n) = 3*b(n-1)+e(n-1), e(4) = 63, e(3) = 12, e(2) = 3, e(1) = 0, e(0) = 0, f(n) = 2*c(n-1)+f(n-1), f(4) = 47, f(3) = 13, f(2) = 1, f(1) = 1, f(0) = 1

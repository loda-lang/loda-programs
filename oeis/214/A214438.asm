...
; Formula: a(n) = d(n+1), b(n) = -d(n-1)+b(n-1)+c(n-1), b(3) = 1, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = 2*b(n-2)+2*d(n-2)-b(n-2)-c(n-1)-4*d(n-2)+b(n-2)+c(n-2), c(3) = 2, c(2) = 0, c(1) = 2, c(0) = 0, d(n) = -d(n-1)+b(n-1)+d(n-1), d(3) = 2, d(2) = 1, d(1) = 1, d(0) = 0

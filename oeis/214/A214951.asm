...
; Formula: a(n) = 9*c(n-1)+b(n-1)+a(n-1), a(3) = 110, a(2) = 26, a(1) = 5, a(0) = 2, b(n) = 9*c(n-1)+b(n-1), b(3) = 84, b(2) = 21, b(1) = 3, b(0) = 3, c(n) = 8*c(n-2)+2*c(n-1)+b(n-2), c(6) = 2793, c(5) = 634, c(4) = 143, c(3) = 33, c(2) = 7, c(1) = 2, c(0) = 0

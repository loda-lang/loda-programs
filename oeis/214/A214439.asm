...
; Formula: a(n) = bitor(if(truncate(((n+2)/((-6)^valuation(n+2,-6)))/2)<=(-1),0,3^truncate(((n+2)/((-6)^valuation(n+2,-6)))/2))+2*((n+2)%2)*if(truncate(((n+2)/((-6)^valuation(n+2,-6)))/2)<=(-1),0,3^truncate(((n+2)/((-6)^valuation(n+2,-6)))/2)),5)-4

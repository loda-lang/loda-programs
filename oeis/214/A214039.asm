...
; Formula: a(n) = -c(n-1)+a(n-1)+1, a(3) = 2, a(2) = 2, a(1) = 1, a(0) = 0, b(n) = 2*truncate(b(n-1)/2)+c(n-1)+1, b(3) = 2, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = -truncate(b(n-2)/2)+a(n-1)+truncate(b(n-1)/2), c(4) = 3, c(3) = 2, c(2) = 1, c(1) = 0, c(0) = 0

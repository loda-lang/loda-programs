...
; Formula: a(n) = binomial(floor((sqrtint(8*n+8)-1)/2),-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n)*binomial(2*max(-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n-1,0),max(-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n-1,0))

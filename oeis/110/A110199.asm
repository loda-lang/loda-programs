...
; Formula: a(n) = b(n)+1, b(n) = b(n-2)+floor(binomial(d(n-2),c(n-2))/(c(n-2)+1)), b(5) = 3, b(4) = 3, b(3) = 1, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = c(n-2)+1, c(5) = 2, c(4) = 2, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = d(n-2)+2, d(5) = 6, d(4) = 6, d(3) = 4, d(2) = 4, d(1) = 2, d(0) = 2

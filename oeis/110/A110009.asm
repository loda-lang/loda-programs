...
; Formula: a(n) = c(n+1)+d(n+1), b(n) = binomial((3*b(n-1))%4+1,2)+1, b(3) = 2, b(2) = 7, b(1) = 1, b(0) = 0, c(n) = e(n-1)^((3*b(n-1))%4+1), c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = binomial(d(n-1),(3*b(n-1))%4), d(3) = 0, d(2) = 0, d(1) = 1, d(0) = 0, e(n) = e(n-1)+binomial(d(n-1),(3*b(n-1))%4), e(3) = 1, e(2) = 1, e(1) = 1, e(0) = 0

...
; Formula: a(n) = e(n)/3, b(n) = (b(n-1)*(-n+6)+c(n-1))/n+2*b(n-1), b(5) = 1911, b(4) = 858, b(3) = 333, b(2) = 105, b(1) = 24, b(0) = 3, c(n) = (b(n-1)*(-n+6)+c(n-1))/n-d(n-1), c(5) = 18, c(4) = 117, c(3) = 102, c(2) = 54, c(1) = 18, c(0) = 3, d(n) = c(n-1)+d(n-1), d(5) = 294, d(4) = 177, d(3) = 75, d(2) = 21, d(1) = 3, d(0) = 0, e(n) = c(n-1), e(5) = 117, e(4) = 102, e(3) = 54, e(2) = 18, e(1) = 3, e(0) = 0

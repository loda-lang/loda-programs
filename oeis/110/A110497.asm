...
; Formula: a(n) = a(n-1)^2+a(n-1)+b(n-1), a(5) = 28, a(4) = 5, a(3) = 2, a(2) = 1, a(1) = 1, a(0) = 1, b(n) = (a(n-3)^2+a(n-3)+b(n-3))*((a(n-3)^2+a(n-3)+b(n-3))^2+a(n-3)^2+a(n-3)+b(n-2)+b(n-3))-((a(n-3)^2+a(n-3)+b(n-3))^2+a(n-3)^2+a(n-3)+b(n-2)+b(n-3))^2-(a(n-3)^2+a(n-3)+b(n-3))^2-a(n-3)^2-a(n-3)-b(n-1)-b(n-2)-b(n-3)+a(n-3), b(5) = -17, b(4) = -2, b(3) = -1, b(2) = 0, b(1) = 0, b(0) = 0

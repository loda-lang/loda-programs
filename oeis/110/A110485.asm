...
; Formula: a(n) = c(n+1)^d(n+1), b(n) = binomial(b(n-1),(3*n-3)%4), b(4) = 0, b(3) = 0, b(2) = 0, b(1) = 1, b(0) = 0, c(n) = c(n-1)+binomial(b(n-1),(3*n-3)%4), c(4) = 1, c(3) = 1, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = (3*n-6)%4+1, d(4) = 3, d(3) = 4, d(2) = 1, d(1) = 0, d(0) = 0

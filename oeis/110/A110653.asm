...
; Formula: a(n) = d(n-1)^(-(binomial(b(n-1),2)%4)+4), a(3) = 1, a(2) = 1, a(1) = 1, a(0) = 1, b(n) = -(binomial(b(n-1),2)%4)+4, b(3) = 4, b(2) = 1, b(1) = 3, b(0) = 2, c(n) = binomial(c(n-1),binomial(b(n-1),2)%4), c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = d(n-1)+binomial(c(n-1),binomial(b(n-1),2)%4), d(3) = 2, d(2) = 1, d(1) = 1, d(0) = 1

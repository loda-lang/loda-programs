...
; Formula: a(n) = 2*b(n-1)+2*d(n-1)-e(n-1)+c(n-1)-1, a(4) = 21, a(3) = 7, a(2) = 2, a(1) = 1, a(0) = 0, b(n) = 2*b(n-1)+2*d(n-1)-e(n-1)+c(n-1)-1, b(4) = 21, b(3) = 7, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = -e(n-1), c(4) = 3, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = 2*b(n-2)+2*d(n-2)-e(n-2)+c(n-2)-1, d(4) = 7, d(3) = 2, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = -b(n-1)-d(n-1), e(4) = -9, e(3) = -3, e(2) = -1, e(1) = -1, e(0) = 0

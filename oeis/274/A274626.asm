...
; Formula: a(n) = truncate(e(n)/8), b(n) = 2*b(n-3)+2, b(6) = 6, b(5) = 6, b(4) = 6, b(3) = 2, b(2) = 2, b(1) = 2, b(0) = 0, c(n) = 2*c(n-3)+4, c(6) = 12, c(5) = 12, c(4) = 4, c(3) = 4, c(2) = 4, c(1) = 0, c(0) = 0, d(n) = 2*d(n-3)+2, d(7) = 14, d(6) = 6, d(5) = 6, d(4) = 6, d(3) = 2, d(2) = 2, d(1) = 2, d(0) = 0, e(n) = 2*d(n-2)*(c(n-3)+1)+2*b(n-2)+2*e(n-1), e(6) = 216, e(5) = 72, e(4) = 24, e(3) = 8, e(2) = 0, e(1) = 0, e(0) = 0

...
; Formula: a(n) = e(n)/8, b(n) = -c(n-1)+b(n-1)+d(n-1)+2, b(5) = 6, b(4) = 6, b(3) = 2, b(2) = 2, b(1) = 2, b(0) = 0, c(n) = -c(n-1)+b(n-1)+d(n-1)+2, c(5) = 6, c(4) = 6, c(3) = 2, c(2) = 2, c(1) = 2, c(0) = 0, d(n) = 2*d(n-3)+4, d(5) = 4, d(4) = 4, d(3) = 4, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = 2*b(n-2)*(-c(n-2)+b(n-2)+d(n-2)+1)+2*b(n-2)+2*e(n-1), e(5) = 72, e(4) = 24, e(3) = 8, e(2) = 0, e(1) = 0, e(0) = 0

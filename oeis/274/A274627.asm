...
; Formula: a(n) = f(max(n-3,0)), b(n) = (b(n-1)*(2*b(n-4)+1))/(2*b(n-5)+1), b(5) = 3, b(4) = 3, b(3) = 1, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = 2*b(n-1)+1, c(5) = 7, c(4) = 3, c(3) = 3, c(2) = 3, c(1) = 3, c(0) = 1, d(n) = 2*b(n-2)+1, d(5) = 3, d(4) = 3, d(3) = 3, d(2) = 3, d(1) = 1, d(0) = 1, e(n) = 2*b(n-3)+1, e(5) = 3, e(4) = 3, e(3) = 3, e(2) = 1, e(1) = 1, e(0) = 1, f(n) = e(n-1)*d(n-1)*c(n-1)*b(n-1), f(5) = 81, f(4) = 27, f(3) = 9, f(2) = 3, f(1) = 1, f(0) = 0

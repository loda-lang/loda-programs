...
; Formula: a(n) = A002133(n)+A129235(n)

mov $1,$0
seq $1,129235 ; a(n) = 2*sigma(n) - tau(n), where tau(n) is the number of divisors of n (A000005) and sigma(n) is the sum of divisors of n (A000203).

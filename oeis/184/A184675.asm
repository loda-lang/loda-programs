...
; Formula: a(n) = -2*truncate((truncate((-c(n-1)+b(n-1))/2)+2)/2)+a(n-1)+truncate((-c(n-1)+b(n-1))/2)+4, a(2) = 6, a(1) = 5, a(0) = 3, b(n) = truncate((-c(n-1)+b(n-1))/2)+2, b(2) = -17, b(1) = -6, b(0) = 0, c(n) = c(n-1)*(-2*truncate((truncate((-c(n-1)+b(n-1))/2)+2)/2)+truncate((-c(n-1)+b(n-1))/2)+4), c(2) = 32, c(1) = 32, c(0) = 16

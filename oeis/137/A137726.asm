...
; Formula: a(n) = d(n)+2, b(n) = b(n-1)+b(n-3), b(5) = 6, b(4) = 5, b(3) = 4, b(2) = 1, b(1) = 1, b(0) = 3, c(n) = b(n-1), c(5) = 5, c(4) = 4, c(3) = 1, c(2) = 1, c(1) = 3, c(0) = 0, d(n) = c(n-1)+c(n-2)+max(e(n-2),b(n-2)+c(n-3))+2, d(5) = 14, d(4) = 10, d(3) = 7, d(2) = 6, d(1) = 0, d(0) = 0, e(n) = c(n-1)+c(n-2)+max(e(n-2),b(n-2)+c(n-3))+2, e(5) = 14, e(4) = 10, e(3) = 7, e(2) = 6, e(1) = 0, e(0) = 0

...
; Formula: a(n) = a(n-1)*(truncate(c(n-1)/2)*b(n-1)+b(n-1)), a(3) = 2, a(2) = 1, a(1) = 1, a(0) = 1, b(n) = truncate((n-1)/2)*b(n-1)+b(n-1), b(3) = 2, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = n, c(3) = 3, c(2) = 2, c(1) = 1, c(0) = 0

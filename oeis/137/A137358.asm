...
; Formula: a(n) = c(n+1), b(n) = b(n-1)+c(n-3), b(5) = 1, b(4) = 1, b(3) = 1, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = 2*c(n-1)-b(n-3)-c(n-2)+b(n-2)+b(n-4)+c(n-6), c(7) = 15, c(6) = 10, c(5) = 6, c(4) = 3, c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0

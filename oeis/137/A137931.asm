...
; Formula: a(n) = e(n+1), b(n) = 4*d(n-1)+2*c(n-1)+2*d(n-1)+b(n-1)+gcd(2*d(n-1),2), b(3) = 54, b(2) = 20, b(1) = 2, b(0) = 0, c(n) = 2*d(n-1)+c(n-1)+d(n-1)+gcd(2*d(n-1),2), c(3) = 18, c(2) = 10, c(1) = 2, c(0) = 0, d(n) = gcd(2*d(n-1),2), d(3) = 2, d(2) = 2, d(1) = 2, d(0) = 0, e(n) = 2*b(n-1)+2*d(n-1)-c(n-1)+c(n-1)+d(n-1)+e(n-1), e(3) = 56, e(2) = 10, e(1) = 0, e(0) = 0

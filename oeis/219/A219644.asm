...
; 1,1,1,2,2,1,2,3,2,3,3,2,3,3,3,2,2,3,3,3,2,3,4,1,2,3,3,3,2,3,4,3,3,3,5,2,3,3,3,2,3,4,3,3,3,5,3,4,4,4,5,1,2,3,3,3,2,3,4,3,3,3,5,3,4,4,4,5,3,3,3,5,5,3,5,5,3,2,3,3
; Formula: a(n) = A280521(b(n-1)+1), a(1) = 1, a(0) = 1, b(n) = b(n-1)+A280521(b(n-1)+1), b(1) = 1, b(0) = 0

...
; Formula: a(n) = b(n)+6, b(n) = b(n-1)+c(n-1)+d(n-1)+e(n-1)+f(n-1)+1, b(4) = 50, b(3) = 27, b(2) = 11, b(1) = 1, b(0) = 0, c(n) = c(n-1)+max(e(n-1),d(n-1)+1)+3, c(4) = 34, c(3) = 21, c(2) = 11, c(1) = 4, c(0) = 0, d(n) = -b(n-1)-c(n-1)-d(n-1)-e(n-1)-f(n-1)+truncate((c(n-1)+f(n-1))/2)-1, d(4) = -35, d(3) = -19, d(2) = -8, d(1) = -1, d(0) = 0, e(n) = max(e(n-1),d(n-1)+1)+3, e(4) = 13, e(3) = 10, e(2) = 7, e(1) = 4, e(0) = 0, f(n) = truncate((c(n-1)+f(n-1))/2)+2, f(4) = 17, f(3) = 10, f(2) = 5, f(1) = 2, f(0) = 0

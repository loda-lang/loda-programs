...
; Formula: a(n) = b(n-1), b(n) = 10*b(n-3)+5*b(n-1)-5*b(n-4)-10*b(n-2)+b(n-5), b(16) = 2576, b(15) = 1996, b(14) = 1522, b(13) = 1140, b(12) = 837, b(11) = 601, b(10) = 421, b(9) = 287, b(8) = 190, b(7) = 122, b(6) = 76, b(5) = 46, b(4) = 27, b(3) = 15, b(2) = 8, b(1) = 3, b(0) = 3

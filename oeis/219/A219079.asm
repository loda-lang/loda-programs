...
; Formula: a(n) = c(n+1), b(n) = -e(n-1)+d(n-1)+1, b(4) = 128, b(3) = 37, b(2) = 10, b(1) = 1, b(0) = 0, c(n) = -e(n-1)+b(n-1)+d(n-1)+1, c(4) = 165, c(3) = 47, c(2) = 11, c(1) = 1, c(0) = 1, d(n) = 3*f(n-1)-e(n-1)+b(n-1)+d(n-1)+3, d(4) = 755, d(3) = 196, d(2) = 49, d(1) = 12, d(0) = 0, e(n) = 4*d(n-2)+3*b(n-2)+3*f(n-2)-e(n-1)-4*e(n-2)+7, e(4) = 259, e(3) = 69, e(2) = 13, e(1) = 3, e(0) = 0, f(n) = 3*f(n-1)-e(n-1)+b(n-1)+d(n-1)+3, f(4) = 755, f(3) = 196, f(2) = 49, f(1) = 12, f(0) = 3

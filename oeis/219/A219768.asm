...
; Formula: a(n) = b(max(n-1,0))+3, b(n) = 3*c(n-1)+3*d(n-1)+3*n+e(n-1)-3, b(4) = 53, b(3) = 26, b(2) = 11, b(1) = 3, b(0) = 0, c(n) = c(n-1)+n-1, c(4) = 6, c(3) = 3, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = c(n-1)+d(n-1)+n-1, d(4) = 11, d(3) = 5, d(2) = 2, d(1) = 1, d(0) = 1, e(n) = c(n-1)+d(n-1)+e(n-1)+n+3, e(4) = 35, e(3) = 20, e(2) = 11, e(1) = 5, e(0) = 0

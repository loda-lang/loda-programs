...
; Formula: a(n) = b(n)+3, b(n) = 2*n+b(n-1)+c(n-1)+d(n-1)+d(n-2)+3, b(5) = 100, b(4) = 59, b(3) = 32, b(2) = 14, b(1) = 4, b(0) = 0, c(n) = (n-1)^2+c(n-1)+d(n-1)+1, c(5) = 43, c(4) = 24, c(3) = 12, c(2) = 5, c(1) = 1, c(0) = 0, d(n) = min(2*n+b(n-1),2), d(5) = 2, d(4) = 2, d(3) = 2, d(2) = 2, d(1) = 2, d(0) = 0

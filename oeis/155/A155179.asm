...
; Formula: a(n) = 3*b(n-1)+3*c(n-1), a(3) = 51, a(2) = 12, a(1) = 3, a(0) = 1, b(n) = 3*b(n-1)+3*c(n-1)+b(n-2)+c(n-2), b(3) = 55, b(2) = 13, b(1) = 3, b(0) = 1, c(n) = b(n-1)+c(n-1), c(3) = 17, c(2) = 4, c(1) = 1, c(0) = 0

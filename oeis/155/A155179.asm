...
; Formula: a(n) = max(min(n,n%2)*(3*c(n)+b(n))+truncate((3*c(n))/3),1), b(n) = truncate((16*c(n-2)+4*b(n-2))/4), b(3) = 3, b(2) = 3, b(1) = 3, b(0) = 3, c(n) = 16*c(n-2)+4*b(n-2)+truncate((4*c(n-2))/4), c(3) = 12, c(2) = 12, c(1) = 0, c(0) = 0

...
; Formula: a(n) = binomial((min(n,n%2)*b(n)+c(n))/3+1,2)+1, b(n) = b(n-2)+c(n-2), b(5) = 6, b(4) = 6, b(3) = 3, b(2) = 3, b(1) = 3, b(0) = 3, c(n) = b(n-2)+2*c(n-2), c(5) = 9, c(4) = 9, c(3) = 3, c(2) = 3, c(1) = 0, c(0) = 0

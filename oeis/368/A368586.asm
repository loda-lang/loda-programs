...
; Formula: a(n) = d(n+1), b(n) = 0, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = -binomial(-n+1,3)+c(n-1), c(3) = 5, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = d(n-1)*(-n+1)-binomial(-n+b(n-1)+1,3)+c(n-1), d(3) = 3, d(2) = 1, d(1) = 0, d(0) = 0

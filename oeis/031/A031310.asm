...
; Formula: a(n) = -10*truncate((-10*truncate((truncate((10*A261138(n+1))/(-10^(n+1)))+9)/10)+truncate((10*A261138(n+1))/(-10^(n+1)))+19)/10)-10*truncate((truncate((10*A261138(n+1))/(-10^(n+1)))+9)/10)+truncate((10*A261138(n+1))/(-10^(n+1)))+19

...
; Formula: a(n) = -10*truncate((-10*truncate((truncate((10*A261138(n))/(-10^n))+9)/10)+truncate((10*A261138(n))/(-10^n))+19)/10)-10*truncate((truncate((10*A261138(n))/(-10^n))+9)/10)+truncate((10*A261138(n))/(-10^n))+19

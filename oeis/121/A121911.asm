...
; Formula: a(n) = d(n)%10, b(n) = b(n-1)+b(n-2)+b(n-3)+b(n-4)+6, b(7) = 149, b(6) = 76, b(5) = 38, b(4) = 20, b(3) = 9, b(2) = 3, b(1) = 0, b(0) = 2, c(n) = c(n-1)+c(n-2)+c(n-3)+c(n-4)+6, c(6) = 116, c(5) = 60, c(4) = 31, c(3) = 14, c(2) = 5, c(1) = 4, c(0) = 2, d(n) = b(n-1)+c(n-1)+d(n-1)+4, d(4) = 56, d(3) = 29, d(2) = 17, d(1) = 9, d(0) = 1

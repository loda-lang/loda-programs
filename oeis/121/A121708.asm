...
; Formula: a(n) = b(n+1)/gcd(c(n+1),b(n+1)), b(n) = b(n-1)+b(n-2)+1, b(3) = 4, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = max(c(n-1)*(d(n-1)+d(n-2)),1), c(4) = 6, c(3) = 2, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = d(n-1)+d(n-2), d(4) = 3, d(3) = 2, d(2) = 1, d(1) = 1, d(0) = 0

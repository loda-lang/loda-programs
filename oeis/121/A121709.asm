...
; Formula: a(n) = truncate(b(n+1)/gcd(c(n+1),b(n+1))), b(n) = b(n-1)+b(n-2)+3, b(3) = 8, b(2) = 4, b(1) = 1, b(0) = 0, c(n) = max(c(n-1)*(d(n-1)+d(n-2)+4),1), c(4) = 84, c(3) = 12, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = d(n-1)+d(n-2)+2, d(4) = 5, d(3) = 2, d(2) = 1, d(1) = -1, d(0) = 0

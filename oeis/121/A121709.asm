...
; Formula: a(n) = b(n+1)/gcd(c(n+1),b(n+1)), b(n) = 2*b(n-1)-d(n-1)+1, b(2) = 4, b(1) = 1, b(0) = 0, c(n) = max(c(n-1)*(-d(n-1)+b(n-1)+1),1), c(2) = 3, c(1) = 1, c(0) = 0, d(n) = -d(n-1)+b(n-1)-1, d(2) = 1, d(1) = -1, d(0) = 0

...
; Formula: a(n) = -binomial(-n+binomial(floor((sqrtint(8*n)+1)/2),2)+floor((sqrtint(8*n)+1)/2)+1,2)-n+binomial(floor((sqrtint(8*n)+1)/2)+1,3)+binomial(floor((sqrtint(8*n)+1)/2),2)+floor((sqrtint(8*n)+1)/2)

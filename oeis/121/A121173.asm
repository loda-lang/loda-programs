...
; Formula: a(n) = 2*truncate(d(n-1)/3)+2, b(n) = (b(n-1)+3)*(-2*truncate(c(n-1)/2)+c(n-1)+1), b(2) = 12, b(1) = 3, b(0) = 0, c(n) = -2*truncate(c(n-1)/2)+c(n-1)+1, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = -d(n-1)+b(n-1), d(2) = 3, d(1) = 0, d(0) = 0

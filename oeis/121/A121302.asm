...
; Formula: a(n) = c(n)+1, b(n) = b(n-1)+d(n-1), b(4) = -14, b(3) = -4, b(2) = -1, b(1) = 0, b(0) = 0, c(n) = 4*b(n-2)+2*b(n-4)+2*c(n-1)+2*c(n-2)-b(n-1)-c(n-3)-4*b(n-3)+c(n-4)+3, c(6) = 201, c(5) = 74, c(4) = 27, c(3) = 9, c(2) = 3, c(1) = 0, c(0) = 0, d(n) = 2*d(n-1)-c(n-1)-1, d(4) = -30, d(3) = -10, d(2) = -3, d(1) = -1, d(0) = 0

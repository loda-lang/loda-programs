...
; Formula: a(n) = 4*e(n+1), b(n) = 2*b(n-1)+c(n-1)+d(n-1)+e(n-1), b(3) = 25, b(2) = 6, b(1) = 1, b(0) = 0, c(n) = c(n-1)+d(n-1), c(3) = 8, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = 2*d(n-1)+c(n-1), d(3) = 13, d(2) = 5, d(1) = 2, d(0) = 1, e(n) = b(n-1)+c(n-1)+d(n-1)+e(n-1), e(3) = 19, e(2) = 5, e(1) = 1, e(0) = 0

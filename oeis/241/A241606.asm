...
; Formula: a(n) = d(2*n+2), b(n) = 2*b(n-1)+c(n-1)+d(n-1)+e(n-1), b(3) = 10, b(2) = 4, b(1) = 1, b(0) = 0, c(n) = b(n-1)+c(n-1), c(3) = 6, c(2) = 2, c(1) = 1, c(0) = 1, d(n) = -d(n-1)+b(n-1)+c(n-1), d(3) = 5, d(2) = 1, d(1) = 1, d(0) = 0, e(n) = -d(n-1)-e(n-1), e(3) = 0, e(2) = -1, e(1) = 0, e(0) = 0

...
; Formula: a(n) = 2*e(n)+2, b(n) = -e(n-1)+b(n-1)+d(n-1)+1, b(5) = 8, b(4) = 4, b(3) = 3, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = -e(n-1)+d(n-1)+1, c(5) = 4, c(4) = 1, c(3) = 2, c(2) = 0, c(1) = 1, c(0) = 0, d(n) = 2*d(n-1)-f(n-1)-2*e(n-1)+b(n-1)+c(n-1)+1, d(5) = 15, d(4) = 10, d(3) = 5, d(2) = 3, d(1) = 1, d(0) = 0, e(n) = 2*d(n-1)-2*e(n-1)+b(n-1)+c(n-1)+2, e(5) = 13, e(4) = 7, e(3) = 5, e(2) = 2, e(1) = 2, e(0) = 0, f(n) = 2*e(n-2)-b(n-2)-c(n-2)-f(n-1)-2*d(n-2)+f(n-2)-3, f(5) = -9, f(4) = -3, f(3) = -4, f(2) = -1, f(1) = -2, f(0) = 0

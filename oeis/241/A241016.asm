...
; Formula: a(n) = (-binomial(truncate((sqrtint(8*n)+1)/2),2)+n)*truncate((sqrtint(8*n)+1)/2)^2+binomial(truncate((sqrtint(8*n)+1)/2),2)*(truncate(binomial(truncate((sqrtint(8*n)+1)/2),2)/((-binomial(truncate((sqrtint(8*n)+1)/2),2)+n)*truncate((sqrtint(8*n)+1)/2)^2+binomial(truncate((sqrtint(8*n)+1)/2),2)))-2)+binomial(truncate((sqrtint(8*n)+1)/2),2)

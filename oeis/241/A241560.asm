...
; Formula: a(n) = -10*truncate((c(n)+9)/10)+c(n)+9, b(n) = 3*c(n-1)+2*b(n-1)+d(n-1)+e(n-1)-3, b(4) = 270, b(3) = 63, b(2) = 12, b(1) = -3, b(0) = 0, c(n) = 2*c(n-1)+b(n-1)+e(n-1)+3, c(4) = 174, c(3) = 39, c(2) = 9, c(1) = 3, c(0) = 0, d(n) = -b(n-1)-d(n-1)+f(n-1)+binomial(-c(n-1)+d(n-1)-2,2)+6, d(4) = 828, d(3) = 0, d(2) = 9, d(1) = 9, d(0) = 0, e(n) = b(n-1)+c(n-1)+e(n-1)+3, e(4) = 135, e(3) = 30, e(2) = 6, e(1) = 3, e(0) = 0, f(n) = c(n-1)+f(n-1)+binomial(-c(n-1)+d(n-1)-2,2), f(4) = 924, f(3) = 24, f(2) = 12, f(1) = 3, f(0) = 0

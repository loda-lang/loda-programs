...
; Formula: a(n) = 21*n+b(n+8)-193, b(n) = b(n-2)+c(n-2)+d(n-2)+3, b(5) = 116, b(4) = 75, b(3) = 75, b(2) = 38, b(1) = 38, b(0) = 6, c(n) = max(c(n-2)-1,0), c(5) = 3, c(4) = 4, c(3) = 4, c(2) = 5, c(1) = 5, c(0) = 6, d(n) = c(n-2)+d(n-2), d(5) = 38, d(4) = 34, d(3) = 34, d(2) = 29, d(1) = 29, d(0) = 23

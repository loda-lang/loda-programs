...
; 0,1,1,2,2,2,1,3,2,3,2,3,2,2,3,4,3,3,1,4,2,3,2,4,4,3,3,3,2,4,3,5,3,4,3,4,2,2,3,5,3,3,3,4,4,3,4,5,2,5,4,4,1,4,4,4,2,3,2,5,2,4,3,6,4,4,3,5,3,4,2,5,3,3,5,3,3,4,3,6
; Formula: a(n) = A064547(A331580(A124859(A108951(n)-1)-1))

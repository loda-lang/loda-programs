...
; 1,1,1,1,1,3,1,1,1,3,1,3,1,3,3,1,1,3,1,3,3,3,1,3,1,3,1,3,1,13,1,1,3,3,3,3,1,3,3,3,1,13,1,3,3,3,1,3,1,3,3,3,1,3,3,3,3,3,1,13,1,3,3,1,3,13,1,3,3,13,1,3,1,3,3,3,3,13,1,3
; Formula: a(n) = A000670(A001221(n+1))

...
; Formula: a(n) = (3*(c(n-1)*(a(n-1)-1)+1)^2+d(n-1)+5)%(5*b(n-1)), a(3) = 103, a(2) = 3, a(1) = 3, a(0) = 0, b(n) = 5*b(n-1), b(3) = 125, b(2) = 25, b(1) = 5, b(0) = 1, c(n) = (3*(c(n-1)*(a(n-1)-1)+1)^2+d(n-1)+5)%(5*b(n-1))+1, c(3) = 104, c(2) = 4, c(1) = 4, c(0) = 0, d(n) = (3*(c(n-1)*(a(n-1)-1)+1)^2+d(n-1)+5)%(5*b(n-1))-23, d(3) = 80, d(2) = -20, d(1) = -20, d(0) = 0

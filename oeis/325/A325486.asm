...
; Formula: a(n) = -5*truncate((3*(c(n-1)+23)^4+c(n-1)+5)/(5*b(n-1)))*b(n-1)+3*(c(n-1)+23)^4+c(n-1)+5, a(4) = 228, a(3) = 103, a(2) = 3, a(1) = 3, a(0) = 0, b(n) = 5*b(n-1), b(3) = 125, b(2) = 25, b(1) = 5, b(0) = 1, c(n) = -5*truncate((3*(c(n-1)+23)^4+c(n-1)+5)/(5*b(n-1)))*b(n-1)+3*(c(n-1)+23)^4+c(n-1)-18, c(4) = 205, c(3) = 80, c(2) = -20, c(1) = -20, c(0) = 0

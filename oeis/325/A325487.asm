...
; Formula: a(n) = (4*(c(n-1)*(a(n-1)-1)+1)^2+d(n-1))%(5*b(n-1)), a(3) = 4, a(2) = 4, a(1) = 4, a(0) = 0, b(n) = 5*b(n-1), b(3) = 125, b(2) = 25, b(1) = 5, b(0) = 1, c(n) = (4*(c(n-1)*(a(n-1)-1)+1)^2+d(n-1))%(5*b(n-1))+1, c(3) = 5, c(2) = 5, c(1) = 5, c(0) = 0, d(n) = (4*(c(n-1)*(a(n-1)-1)+1)^2+d(n-1))%(5*b(n-1))-24, d(3) = -20, d(2) = -20, d(1) = -20, d(0) = 0

...
; Formula: a(n) = -c(n)+b(n), b(n) = 5*b(n-1), b(2) = 25, b(1) = 5, b(0) = 1, c(n) = (3*c(n-1)^4+d(n-1)+5)%(5*b(n-1)), c(2) = 3, c(1) = 3, c(0) = 1, d(n) = (3*c(n-1)^4+d(n-1)+5)%(5*b(n-1))-23, d(2) = -20, d(1) = -20, d(0) = 0

...
; Formula: a(n) = -c(n)+b(n), b(n) = 5*b(n-1), b(2) = 25, b(1) = 5, b(0) = 1, c(n) = (4*c(n-1)^4+d(n-1)+5)%(5*b(n-1)), c(2) = 4, c(1) = 4, c(0) = 1, d(n) = (4*c(n-1)^4+d(n-1)+5)%(5*b(n-1))-29, d(2) = -25, d(1) = -25, d(0) = 0

...
; Formula: a(n) = d(n+2)/2+1, b(n) = b(n-1)+d(n-1)+2, b(4) = 26, b(3) = 6, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = 4*c(n-2)+4*e(n-2)+2*(2*b(n-2))+2*c(n-1)+2*c(n-2)+2*(2*d(n-2))+2*e(n-2)+e(n-2)+8, c(4) = 111, c(3) = 20, c(2) = 2, c(1) = -1, c(0) = 0, d(n) = 2*c(n-1)+2*e(n-1)+b(n-1)+d(n-1), d(4) = 106, d(3) = 18, d(2) = 2, d(1) = -1, d(0) = -1, e(n) = 2*c(n-1)+2*e(n-1)+b(n-1)+d(n-1)+3, e(4) = 109, e(3) = 21, e(2) = 5, e(1) = 2, e(0) = 0

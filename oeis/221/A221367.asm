...
; Formula: a(n) = binomial(b(n+2),min(n+2,(n+2)%2)), b(n) = 7*d(n-2)+7*1, b(7) = 700, b(6) = 700, b(5) = 77, b(4) = 77, b(3) = 7, b(2) = 7, b(1) = 0, b(0) = 0, c(n) = 7*d(n-2)+c(n-2)+9, c(7) = 790, c(6) = 790, c(5) = 88, c(4) = 88, c(3) = 9, c(2) = 9, c(1) = 0, c(0) = 0, d(n) = 7*d(n-2)+c(n-2)+d(n-2)+10, d(7) = 890, d(6) = 890, d(5) = 99, d(4) = 99, d(3) = 10, d(2) = 10, d(1) = 0, d(0) = 0

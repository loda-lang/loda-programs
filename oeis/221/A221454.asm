...
; Formula: a(n) = truncate(e(n-1)/2), b(n) = b(n-1)+c(n-1)+d(n-1), b(3) = 14, b(2) = 4, b(1) = 0, b(0) = 0, c(n) = e(n-1)+max(2*b(n-1)+c(n-1),2), c(3) = 16, c(2) = 4, c(1) = 2, c(0) = 0, d(n) = b(n-1)+c(n-1)+d(n-1)+max(2*b(n-1)+c(n-1),2), d(3) = 26, d(2) = 6, d(1) = 2, d(0) = 0, e(n) = -d(n-1)+c(n-1)+e(n-1)+max(2*b(n-1)+c(n-1),2), e(3) = 14, e(2) = 4, e(1) = 2, e(0) = 0

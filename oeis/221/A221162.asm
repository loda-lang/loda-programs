...
; Formula: a(n) = e(2*n+2), b(n) = b(n-1)+d(n-1), b(4) = 19, b(3) = 5, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = -f(n-1)+c(n-1)+e(n-1), c(4) = 14, c(3) = 5, c(2) = 2, c(1) = 1, c(0) = 1, d(n) = 2*d(n-1)-f(n-1)+b(n-1)+c(n-1)+e(n-1), d(4) = 47, d(3) = 14, d(2) = 4, d(1) = 1, d(0) = 0, e(n) = -f(n-1)+b(n-1)+c(n-1)+d(n-1)+e(n-1), e(4) = 33, e(3) = 10, e(2) = 3, e(1) = 1, e(0) = 0, f(n) = b(n-1), f(4) = 5, f(3) = 1, f(2) = 0, f(1) = 0, f(0) = 0

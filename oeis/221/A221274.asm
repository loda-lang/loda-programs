...
; Formula: a(n) = truncate(f(n+2)/81), b(n) = b(n-1)+c(n-1)+d(n-1)+9, b(4) = 216, b(3) = 81, b(2) = 27, b(1) = 9, b(0) = 0, c(n) = 2*b(n-1)+2*d(n-1)+e(n-1), c(4) = 288, c(3) = 81, c(2) = 36, c(1) = 0, c(0) = 0, d(n) = c(n-1)+9, d(4) = 90, d(3) = 45, d(2) = 9, d(1) = 9, d(0) = 0, e(n) = b(n-1)+e(n-1), e(4) = 117, e(3) = 36, e(2) = 9, e(1) = 0, e(0) = 0, f(n) = (c(n-1)+9)^2, f(4) = 8100, f(3) = 2025, f(2) = 81, f(1) = 81, f(0) = 0

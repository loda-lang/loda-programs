...
; Formula: a(n) = binomial(b(n+2),min(n+2,(n+2)%2)), b(n) = 3*d(n-2)+3, b(5) = 21, b(4) = 21, b(3) = 3, b(2) = 3, b(1) = 0, b(0) = 0, c(n) = 3*d(n-2)+c(n-2)+5, c(5) = 28, c(4) = 28, c(3) = 5, c(2) = 5, c(1) = 0, c(0) = 0, d(n) = 4*d(n-2)+c(n-2)+6, d(5) = 35, d(4) = 35, d(3) = 6, d(2) = 6, d(1) = 0, d(0) = 0

...
; Formula: a(n) = b(n-1), a(5) = 12, a(4) = 5, a(3) = 2, a(2) = 1, a(1) = 1, a(0) = 0, b(n) = b(n-1)+c(n-2)+c(n-3)+c(n-4)+3, b(5) = 26, b(4) = 12, b(3) = 5, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = c(n-1)+c(n-2)+c(n-3)+3, c(5) = 27, c(4) = 14, c(3) = 7, c(2) = 3, c(1) = 1, c(0) = 0

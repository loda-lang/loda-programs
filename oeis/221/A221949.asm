...
; Formula: a(n) = b(n-1)+c(n-1)+n-1, a(4) = 5, a(3) = 2, a(2) = 1, a(1) = 1, a(0) = 0, b(n) = 3*n+2*c(n-2)+b(n-2)-6, b(4) = 5, b(3) = 2, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = b(n-1)+c(n-1)+n-3, c(4) = 3, c(3) = 0, c(2) = -1, c(1) = -1, c(0) = 0

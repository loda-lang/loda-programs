...
; Formula: a(n) = b(n+4), b(n) = c(n-2)+1, b(7) = 6, b(6) = 4, b(5) = 3, b(4) = 2, b(3) = 1, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = c(n-1)+c(n-3)+d(n-3)+1, c(8) = 21, c(7) = 14, c(6) = 9, c(5) = 5, c(4) = 3, c(3) = 2, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = c(n-4)+d(n-3)+1, d(7) = 4, d(6) = 3, d(5) = 1, d(4) = 1, d(3) = 1, d(2) = 0, d(1) = 0, d(0) = 0

...
; Formula: a(n) = d(n-1), a(3) = 22, a(2) = 6, a(1) = 2, a(0) = 1, b(n) = b(n-2)*b(n-1), b(3) = 32, b(2) = 8, b(1) = 4, b(0) = 2, c(n) = b(n-1), c(3) = 8, c(2) = 4, c(1) = 2, c(0) = 2, d(n) = d(n-2)*c(n-1)*b(n-1)+d(n-1), d(3) = 214, d(2) = 22, d(1) = 6, d(0) = 2

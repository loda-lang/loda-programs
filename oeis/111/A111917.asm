...
; Formula: a(n) = truncate(c(n)/2)+1, b(n) = c(n-1)+d(n-1), b(3) = 9, b(2) = 6, b(1) = 4, b(0) = 1, c(n) = b(n-1)+e(n-1), c(3) = 15, c(2) = 9, c(1) = 5, c(0) = 2, d(n) = truncate(e(n-1)/(c(n-1)+d(n-1))), d(3) = 1, d(2) = 0, d(1) = 1, d(0) = 2, e(n) = b(n-1)+e(n-1), e(3) = 15, e(2) = 9, e(1) = 5, e(0) = 4

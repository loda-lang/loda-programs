...
; Formula: a(n) = (12*n+b(n-1)+c(n-1)-11)%10+a(n-1), a(3) = 10, a(2) = 6, a(1) = 1, a(0) = 0, b(n) = (12*n+b(n-1)+c(n-1)-11)%10, b(3) = 4, b(2) = 5, b(1) = 1, b(0) = 0, c(n) = 12*n+c(n-1)-11, c(3) = 39, c(2) = 14, c(1) = 1, c(0) = 0

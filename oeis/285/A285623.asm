...
; Formula: a(n) = e(n+1)+1, b(n) = (-c(n-1)+b(n-1)+1)/2, b(3) = -79, b(2) = -31, b(1) = 0, b(0) = 0, c(n) = 2*c(n-1)*gcd((-c(n-1)+b(n-1)+1)/2+d(n-1),4)^2, c(3) = 256, c(2) = 128, c(1) = 64, c(0) = 2, d(n) = gcd((-c(n-1)+b(n-1)+1)/2+d(n-1),4)/2, d(3) = 0, d(2) = 0, d(1) = 2, d(0) = 0, e(n) = d(n-1)+e(n-1)+1, e(3) = 4, e(2) = 3, e(1) = 0, e(0) = -1

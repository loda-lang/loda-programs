...
; Formula: a(n) = e(n)-2, b(n) = (-c(n-1)+b(n-1)+1)/2, b(3) = -291, b(2) = -71, b(1) = -15, b(0) = 0, c(n) = 4*gcd((-c(n-1)+b(n-1)+1)/2+d(n-1),4)*c(n-1), c(3) = 2048, c(2) = 512, c(1) = 128, c(0) = 32, d(n) = gcd((-c(n-1)+b(n-1)+1)/2+d(n-1),4)/2, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 2, e(n) = d(n-1)+e(n-1)+4, e(3) = 18, e(2) = 14, e(1) = 10, e(0) = 4

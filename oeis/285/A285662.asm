...
; Formula: a(n) = 2*e(floor((n+2)/2))+n+1, b(n) = truncate((-c(n-1)+b(n-1)+1)/2), b(3) = -129, b(2) = -4, b(1) = -1, b(0) = 0, c(n) = 2*c(n-1)*gcd(d(n-1)+truncate((-c(n-1)+b(n-1)+1)/2),4)^2, c(3) = 512, c(2) = 256, c(1) = 8, c(0) = 4, d(n) = truncate(gcd(d(n-1)+truncate((-c(n-1)+b(n-1)+1)/2),4)/2), d(3) = 0, d(2) = 2, d(1) = 0, d(0) = 0, e(n) = d(n-1)+e(n-1)+1, e(3) = 5, e(2) = 2, e(1) = 1, e(0) = 0

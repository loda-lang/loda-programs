...
; Formula: a(n) = d(n+1)/2, b(n) = (-c(n-1)+b(n-1))/2, b(2) = -34, b(1) = -4, b(0) = 0, c(n) = 2*gcd((((-c(n-1)+b(n-1))/2+d(n-1)-1)/2)%2,4)*c(n-1), c(2) = 512, c(1) = 64, c(0) = 8, d(n) = gcd((((-c(n-1)+b(n-1))/2+d(n-1)-1)/2)%2,4)/2, d(2) = 2, d(1) = 2, d(0) = 0

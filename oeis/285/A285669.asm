...
; Formula: a(n) = e(n+1)-1, b(n) = (-2*c(n-1)+b(n-1)+1)/2, b(3) = -131, b(2) = -8, b(1) = -1, b(0) = 0, c(n) = 4*gcd((-2*c(n-1)+b(n-1)+1)/2+d(n-1),4)*c(n-1), c(3) = 512, c(2) = 128, c(1) = 8, c(0) = 2, d(n) = gcd((-2*c(n-1)+b(n-1)+1)/2+d(n-1),4)/2, d(3) = 0, d(2) = 2, d(1) = 0, d(0) = 0, e(n) = d(n-1)+e(n-1)+4, e(3) = 14, e(2) = 8, e(1) = 4, e(0) = 0

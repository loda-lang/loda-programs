...
; Formula: a(n) = e(n)/2, b(n) = (-c(n-1)+b(n-1)+1)/2, b(3) = -577, b(2) = -131, b(1) = -8, b(0) = -1, c(n) = 4*gcd((-c(n-1)+b(n-1)+1)/2+d(n-1),4)*c(n-1), c(3) = 4096, c(2) = 1024, c(1) = 256, c(0) = 16, d(n) = gcd((-c(n-1)+b(n-1)+1)/2+d(n-1),4)/2, d(3) = 0, d(2) = 0, d(1) = 2, d(0) = 0, e(n) = d(n-1)+e(n-1)+2, e(3) = 10, e(2) = 8, e(1) = 4, e(0) = 2

...
; Formula: a(n) = 2*e(n)+2, b(n) = (-c(n-1)+b(n-1))/((-c(n-1)+b(n-1)+d(n-1))%2+2), b(3) = -38, b(2) = -12, b(1) = -9, b(0) = -1, c(n) = 2*c(n-1)*((-c(n-1)+b(n-1)+d(n-1))%2+2), c(3) = 256, c(2) = 64, c(1) = 16, c(0) = 8, d(n) = (-c(n-1)+b(n-1)+d(n-1))%2+2, d(3) = 2, d(2) = 2, d(1) = 1, d(0) = 2, e(n) = d(n-1)+e(n-1), e(3) = 5, e(2) = 3, e(1) = 2, e(0) = 0

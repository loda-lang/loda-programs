...
; Formula: a(n) = -2*truncate(d(2*n)/2)+d(2*n), b(n) = A039963(-b(n-1)+c(n-1)), b(2) = 1, b(1) = 1, b(0) = 0, c(n) = -b(n-1)+c(n-1)+2, c(2) = 3, c(1) = 2, c(0) = 0, d(n) = -b(n-1)+c(n-1)+d(n-1)+2, d(2) = 5, d(1) = 2, d(0) = 0

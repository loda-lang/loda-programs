...
; Formula: a(n) = sumdigits(b(n),2)*sign(b(n)), b(n) = sign(3*sign(b(n-1))*sign(2*c(n-1)*b(n-1))+sign(2*c(n-1)*b(n-1))+sign(b(n-1)))*bitxor(abs(2*c(n-1)*b(n-1)),abs(b(n-1))), b(1) = 6, b(0) = 2, c(n) = 2*c(n-1), c(1) = 2, c(0) = 1

...
; Formula: a(n) = e(n)+1, b(n) = (-c(n-1)+b(n-1))/2, b(3) = -34, b(2) = -4, b(1) = -1, b(0) = 0, c(n) = 4*c(n-1)*(((-c(n-1)+b(n-1))/2-e(n-1)+min(d(n-1),b(n-1)))%2+2), c(3) = 256, c(2) = 64, c(1) = 8, c(0) = 2, d(n) = ((-c(n-1)+b(n-1))/2-e(n-1)+min(d(n-1),b(n-1)))%2+2, d(3) = 1, d(2) = 2, d(1) = 1, d(0) = 0, e(n) = ((-c(n-1)+b(n-1))/2-e(n-1)+min(d(n-1),b(n-1)))%2+e(n-1)+2, e(3) = 4, e(2) = 3, e(1) = 1, e(0) = 0

...
; Formula: a(n) = truncate((-c(n+1)+b(n+1)+n+1)/4), b(n) = -2*binomial(gcd(d(n-1),n+1),n+1)+b(n-1)+1, b(3) = -1, b(2) = -2, b(1) = -1, b(0) = 0, c(n) = -2*binomial(gcd(d(n-1),n+1),n+1), c(3) = 0, c(2) = -2, c(1) = -2, c(0) = 0, d(n) = 2*d(n-1)-n-2, d(3) = -25, d(2) = -10, d(1) = -3, d(0) = 0

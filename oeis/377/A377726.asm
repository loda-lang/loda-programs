...
; Formula: a(n) = truncate(((min(n-1,(n-1)%2)*b(n-1)+c(n-1)-2)*(min(n-1,(n-1)%2)*b(n-1)+c(n-1)+d(n-1)))/2), b(n) = 29*b(n-2)+24*c(n-2), b(5) = 13452, b(4) = 13452, b(3) = 396, b(2) = 396, b(1) = 12, b(0) = 12, c(n) = 6*b(n-2)+5*c(n-2), c(5) = 2786, c(4) = 2786, c(3) = 82, c(2) = 82, c(1) = 2, c(0) = 2, d(n) = d(n-2), d(5) = 0, d(4) = 0, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0

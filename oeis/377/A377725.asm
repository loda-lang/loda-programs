...
; Formula: a(n) = 2*min(2*n-1,(2*n-1)%2)*c(max(2*n-1,0))+2*b(max(2*n-1,0))+1, b(n) = 3*b(n-2)+2*c(n-2), b(3) = 3, b(2) = 3, b(1) = 1, b(0) = 1, c(n) = 4*b(n-2)+3*c(n-2), c(3) = 4, c(2) = 4, c(1) = 0, c(0) = 0

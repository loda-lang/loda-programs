...
; Formula: a(n) = 4*truncate((min(n-1,(n-1)%2)*c(n-1)+b(n-1))/4)+3, b(n) = 6*c(n-2)+5*b(n-2), b(3) = 82, b(2) = 82, b(1) = 2, b(0) = 2, c(n) = 29*c(n-2)+24*b(n-2), c(3) = 396, c(2) = 396, c(1) = 12, c(0) = 12

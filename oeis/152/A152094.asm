...
; Formula: a(n) = f(max(n-1,0)), b(n) = 2*b(n-1)-c(n-1)-e(n-1)+d(n-1), b(4) = 19, b(3) = 1, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = 4*d(n-1)+2*c(n-1)+2*e(n-1)-2*d(n-1)-4*b(n-1)-4*c(n-1)-4*e(n-1), c(4) = 30, c(3) = -6, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = 8*b(n-1)+4*c(n-1)+4*d(n-1)+2*b(n-1)-c(n-1)-e(n-1)-4*c(n-1)-4*e(n-1)+d(n-1)+f(n-1), d(4) = 108, d(3) = 24, d(2) = 6, d(1) = 1, d(0) = 0, e(n) = 8*b(n-1)+4*c(n-1)+4*d(n-1)+2*b(n-1)-c(n-1)-e(n-1)-4*c(n-1)-4*e(n-1)+d(n-1), e(4) = 71, e(3) = 13, e(2) = 5, e(1) = 0, e(0) = 0, f(n) = 16*b(n-1)+8*c(n-1)+8*d(n-1)+4*b(n-1)+2*d(n-1)-2*c(n-1)-2*e(n-1)-8*c(n-1)-8*e(n-1)+f(n-1), f(4) = 179, f(3) = 37, f(2) = 11, f(1) = 1, f(0) = 1

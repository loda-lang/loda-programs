...
; Formula: a(n) = e(n+1), b(n) = (-c(n-1)+b(n-1))/2, b(3) = -2, b(2) = -1, b(1) = -1, b(0) = 0, c(n) = c(n-1)*(((-c(n-1)+b(n-1))/2+d(n-1))%2+2), c(3) = 8, c(2) = 4, c(1) = 2, c(0) = 2, d(n) = ((-c(n-1)+b(n-1))/2+d(n-1))%2+2, d(3) = 2, d(2) = 2, d(1) = 1, d(0) = 0, e(n) = ((-c(n-1)+b(n-1))/2+d(n-1))%2+e(n-1)+1, e(3) = 3, e(2) = 2, e(1) = 1, e(0) = 1

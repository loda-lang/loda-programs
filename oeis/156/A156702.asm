...
; Formula: a(n) = 2*((4*(gcd(b(n),d(n))/5)-(gcd(b(n),d(n))/5)+d(n))/5)+1, b(n) = b(n-1), b(2) = 0, b(1) = 0, b(0) = 0, c(n) = (196*d(n-1)+c(n-1))%225, c(2) = 52, c(1) = 198, c(0) = 2, d(n) = (196*d(n-1)+c(n-1))%225+d(n-1), d(2) = 251, d(1) = 199, d(0) = 1

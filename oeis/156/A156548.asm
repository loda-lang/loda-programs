...
; Formula: a(n) = (b(7*n)/(d(7*n)/(10^n)+1))%10, b(n) = b(n-1)+d(n-1), b(3) = 13, b(2) = 3, b(1) = 1, b(0) = 1, c(n) = 2*b(n-1)+2*d(n-1)-((2*b(n-2)+2*d(n-2)+c(n-2))%b(n-1))+c(n-1), c(3) = 32, c(2) = 8, c(1) = 2, c(0) = 0, d(n) = 3*d(n-1)+2*b(n-1)+c(n-1), d(3) = 44, d(2) = 10, d(1) = 2, d(0) = 0

...
; Formula: a(n) = b(n-1), b(n) = c(n-3), b(5) = 205, b(4) = 115, b(3) = 65, b(2) = 37, b(1) = 23, b(0) = 17, c(n) = 6*c(n-3)-c(n-6), c(7) = 3887, c(6) = 2173, c(5) = 1193, c(4) = 667, c(3) = 373, c(2) = 205, c(1) = 115, c(0) = 65

...
; Formula: a(n) = (b(4*n+4)/(2*(c(4*n+4)/(10^(n+1)))))%10, b(n) = 4*b(n-1)+4*c(n-1)+4*d(n-1), b(3) = 64, b(2) = 8, b(1) = 0, b(0) = 0, c(n) = 2*c(n-1)+b(n-1)+d(n-1)+2, c(3) = 24, c(2) = 6, c(1) = 2, c(0) = 0, d(n) = 3*d(n-1)-4*c(n-2)-4*d(n-2)+c(n-1), d(4) = 4, d(3) = 4, d(2) = 2, d(1) = 0, d(0) = 0

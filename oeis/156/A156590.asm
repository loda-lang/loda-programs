...
; Formula: a(n) = (b(4*n+4)/(2*(c(4*n+4)/(10^(n+1)))))%10, b(n) = 4*b(n-1)+4*c(n-1)+4*e(n-1), b(3) = 64, b(2) = 8, b(1) = 0, b(0) = 0, c(n) = 2*c(n-1)+b(n-1)+e(n-1)+2, c(3) = 24, c(2) = 6, c(1) = 2, c(0) = 0, d(n) = 2*d(n-1)-c(n-1)-e(n-1), d(3) = -12, d(2) = -2, d(1) = 0, d(0) = 0, e(n) = 2*d(n-1)+c(n-1)+e(n-1), e(3) = 4, e(2) = 2, e(1) = 0, e(0) = 0

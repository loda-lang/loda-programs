...
; Formula: a(n) = A079858(n+1)*A008280(A061579(-A002260(truncate((sqrtint(8*A061579(binomial(n+1,2))+1)+1)/2)+A061579(binomial(n+1,2))+2)+truncate((sqrtint(8*A061579(binomial(n+1,2))+1)+1)/2)+A061579(binomial(n+1,2))+A319573(truncate((sqrtint(8*A061579(binomial(n+1,2))+1)+1)/2)+A061579(binomial(n+1,2))+1)+2))

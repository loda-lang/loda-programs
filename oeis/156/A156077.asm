...
; Formula: a(n) = -(((-c(n-1)+b(n-1))/2+d(n-1))%2)+a(n-1), a(3) = 2, a(2) = 1, a(1) = 1, a(0) = 1, b(n) = (-c(n-1)+b(n-1))/2, b(3) = -5, b(2) = -2, b(1) = 0, b(0) = 3, c(n) = c(n-1)*(((-c(n-1)+b(n-1))/2+d(n-1))%2+2), c(3) = 8, c(2) = 8, c(1) = 4, c(0) = 2, d(n) = ((-c(n-1)+b(n-1))/2+d(n-1))%2+2, d(3) = 1, d(2) = 2, d(1) = 2, d(0) = 0

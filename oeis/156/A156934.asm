...
; Formula: a(n) = d(n-1)+a(n-1), a(3) = 144, a(2) = 38, a(1) = 8, a(0) = 1, b(n) = b(n-1)+c(n-1)+5, b(3) = 721, b(2) = 236, b(1) = 75, b(0) = 22, c(n) = 3*c(n-1)+12, c(3) = 1452, c(2) = 480, c(1) = 156, c(0) = 48, d(n) = b(n-1)+d(n-1)+1, d(3) = 343, d(2) = 106, d(1) = 30, d(0) = 7

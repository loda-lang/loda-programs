...
; Formula: a(n) = e(n+2), b(n) = b(n-1)+c(n-1)+5, b(3) = 75, b(2) = 22, b(1) = 5, b(0) = 0, c(n) = 3*c(n-1)+12, c(3) = 156, c(2) = 48, c(1) = 12, c(0) = 0, d(n) = b(n-1)+d(n-1)+1, d(3) = 30, d(2) = 7, d(1) = 1, d(0) = 0, e(n) = d(n-1)+e(n-1), e(3) = 8, e(2) = 1, e(1) = 0, e(0) = 0

...
; Formula: a(n) = 2*b(n)+12, b(n) = -c(n-2)+b(n-1)+b(n-2)+c(n-1)+6, b(5) = 120, b(4) = 62, b(3) = 31, b(2) = 14, b(1) = 5, b(0) = 0, c(n) = 4*c(n-2)-2*c(n-4)+5, c(7) = 281, c(6) = 151, c(5) = 79, c(4) = 41, c(3) = 20, c(2) = 9, c(1) = 3, c(0) = 0

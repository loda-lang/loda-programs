...
; Formula: a(n) = -b(n)+f(n)+1, b(n) = -b(n-1)-c(n-1)+f(n-1), b(4) = -8, b(3) = -4, b(2) = -2, b(1) = 0, b(0) = 0, c(n) = -d(n-1)+e(n-1)+2, c(4) = 24, c(3) = 11, c(2) = 5, c(1) = 2, c(0) = 0, d(n) = -e(n-1)+c(n-1)+d(n-1)-1, d(4) = -12, d(3) = -5, d(2) = -2, d(1) = -1, d(0) = 0, e(n) = -d(n-1)-f(n-1)+c(n-1)+e(n-1)+2, e(4) = 36, e(3) = 17, e(2) = 7, e(1) = 2, e(0) = 0, f(n) = -b(n-1)-c(n-1)-d(n-1), f(4) = -2, f(3) = -1, f(2) = -1, f(1) = 0, f(0) = 0

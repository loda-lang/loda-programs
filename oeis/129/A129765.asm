...
; Formula: a(n) = (b(n)/2)%2+1, b(n) = 2*gcd((d(n-1)/2-c(n-1))/4+binomial(b(n-1),c(n-1)),4), b(2) = 8, b(1) = 4, b(0) = 8, c(n) = gcd((d(n-1)/2-c(n-1))/4+binomial(b(n-1),c(n-1)),4)*c(n-1), c(2) = 2048, c(1) = 512, c(0) = 256, d(n) = (d(n-1)/2-c(n-1))/4, d(2) = -136, d(1) = -66, d(0) = -16

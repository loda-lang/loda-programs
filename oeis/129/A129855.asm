...
; Formula: a(n) = truncate((binomial(-binomial(floor((sqrtint(8*n)+1)/2),2)+n+2,2)*(-n+binomial(floor((sqrtint(8*n)+1)/2),2)+floor((sqrtint(8*n)+1)/2)+2)*(-n+binomial(floor((sqrtint(8*n)+1)/2),2)+floor((sqrtint(8*n)+1)/2)+3))/2)

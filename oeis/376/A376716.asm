...
; Formula: a(n) = b(n+1), b(n) = sign(3*sign(1)*sign(c(n-1))+sign(c(n-1))+sign(1))*bitxor(abs(c(n-1)),abs(1))+b(n-1), b(1) = 1, b(0) = 0, c(n) = sign(3*sign(1)*sign(c(n-1))+sign(c(n-1))+sign(1))*bitxor(abs(c(n-1)),abs(1))+b(n-1)+c(n-1), c(1) = 1, c(0) = 0

...
; Formula: a(n) = 8*truncate(c(n)/3), b(n) = truncate((b(n-2)*(d(n-1)*b(n-1)+c(n-1))+1)/d(n-2)), b(4) = 92752, b(3) = 340, b(2) = 16, b(1) = 4, b(0) = 1, c(n) = d(n-1)*b(n-1)+c(n-1), c(4) = 86955, c(3) = 255, c(2) = 15, c(1) = 3, c(0) = 2, d(n) = d(n-1)*b(n-1)+c(n-1), d(4) = 86955, d(3) = 255, d(2) = 15, d(1) = 3, d(0) = 1

...
; Formula: a(n) = c(n)+1, b(n) = truncate((b(n-2)*(e(n-1)*b(n-1)+d(n-1))+1)/e(n-2)), b(4) = 92752, b(3) = 340, b(2) = 16, b(1) = 4, b(0) = 1, c(n) = b(n-1), c(4) = 340, c(3) = 16, c(2) = 4, c(1) = 1, c(0) = 1, d(n) = e(n-1)*b(n-1)+d(n-1), d(4) = 86955, d(3) = 255, d(2) = 15, d(1) = 3, d(0) = 2, e(n) = e(n-1)*b(n-1)+d(n-1), e(4) = 86955, e(3) = 255, e(2) = 15, e(1) = 3, e(0) = 1

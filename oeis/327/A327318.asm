...
; Formula: a(n) = binomial(truncate((sqrtint(8*n)-1)/2)+1,-binomial(truncate((sqrtint(8*n)-1)/2)+1,2)+n-1)*(if((-n+binomial(truncate((sqrtint(8*n)-1)/2)+1,2)+truncate((sqrtint(8*n)-1)/2)+2)<=(-1),0,2^(-n+binomial(truncate((sqrtint(8*n)-1)/2)+1,2)+truncate((sqrtint(8*n)-1)/2)+2))-1)*if((-binomial(truncate((sqrtint(8*n)-1)/2)+1,2)+n-1)<=(-1),0,2^(-binomial(truncate((sqrtint(8*n)-1)/2)+1,2)+n-1))

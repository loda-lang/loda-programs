...
; Formula: a(n) = (2*(c(n-1)+1)^2+d(n-1)+17)%(5*b(n-1))+1, a(3) = 46, a(2) = 21, a(1) = 1, a(0) = 0, b(n) = 5*b(n-1), b(3) = 125, b(2) = 25, b(1) = 5, b(0) = 1, c(n) = (2*(c(n-1)+1)^2+d(n-1)+17)%(5*b(n-1)), c(3) = 45, c(2) = 20, c(1) = 0, c(0) = 0, d(n) = (2*(c(n-1)+1)^2+d(n-1)+17)%(5*b(n-1))+1, d(3) = 46, d(2) = 21, d(1) = 1, d(0) = -4

...
; Formula: a(n) = (3*(c(n-1)+1)^2+d(n-1)+20)%(4*b(n-1)+b(n-1))+1, a(3) = 79, a(2) = 4, a(1) = 4, a(0) = 0, b(n) = 4*b(n-1)+b(n-1), b(3) = 125, b(2) = 25, b(1) = 5, b(0) = 1, c(n) = (3*(c(n-1)+1)^2+d(n-1)+20)%(4*b(n-1)+b(n-1)), c(3) = 78, c(2) = 3, c(1) = 3, c(0) = 0, d(n) = (3*(c(n-1)+1)^2+d(n-1)+20)%(4*b(n-1)+b(n-1))+7, d(3) = 85, d(2) = 10, d(1) = 10, d(0) = 0

...
; Formula: a(n) = c(n+1)/2, b(n) = b(n-1)+c(n-1), b(3) = 8, b(2) = 2, b(1) = 0, b(0) = 0, c(n) = d(n-1)+max(b(n-1),2), c(3) = 14, c(2) = 6, c(1) = 2, c(0) = 0, d(n) = 2*d(n-1)+2*d(n-2)+2*max(b(n-2)+c(n-2),2)+2*max(b(n-2),2)-2*b(n-2)-2*c(n-2)-2*max(b(n-2),2), d(3) = 32, d(2) = 12, d(1) = 4, d(0) = 0

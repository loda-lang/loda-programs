...
; Formula: a(n) = truncate(c(n+1)/2), b(n) = b(n-1)+c(n-1), b(3) = 8, b(2) = 2, b(1) = 0, b(0) = 0, c(n) = 2*c(n-1)+2*c(n-2)-2*b(n-2)-2*max(b(n-3),2)+max(b(n-1),2), c(8) = 2266, c(7) = 828, c(6) = 302, c(5) = 110, c(4) = 40, c(3) = 14, c(2) = 6, c(1) = 2, c(0) = 0

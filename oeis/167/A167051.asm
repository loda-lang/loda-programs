...
; Formula: a(n) = d(n)+1, b(n) = -2*truncate((b(n-1)+d(n-1))/2)+b(n-1)+d(n-1), b(3) = 0, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = (2*c(n-1)+2*d(n-1))*(-2*truncate((b(n-1)+d(n-1))/2)+b(n-1)+d(n-1)+truncate(e(n-1)/(-2))), c(3) = 0, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = 2*d(n-1)-2*truncate((b(n-1)+d(n-1))/2)+b(n-1)+c(n-1)+truncate(e(n-1)/(-2))+1, d(3) = 6, d(2) = 3, d(1) = 1, d(0) = 0, e(n) = -2*truncate((b(n-1)+d(n-1))/2)+b(n-1)+d(n-1)+truncate(e(n-1)/(-2)), e(3) = 0, e(2) = 1, e(1) = 0, e(0) = 0

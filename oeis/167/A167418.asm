...
; Formula: a(n) = d(n+3)/196, b(n) = 98*c(n-2)+b(n-1)+98, b(3) = 196, b(2) = 98, b(1) = 0, b(0) = 0, c(n) = b(n-1)+c(n-1)+d(n-1), c(3) = 98, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 2*b(n-1)+2*d(n-1), d(3) = 196, d(2) = 0, d(1) = 0, d(0) = 0

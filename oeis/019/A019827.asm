...
; Formula: a(n) = -10*truncate(truncate(truncate(b(5*n+5)/2)/truncate(c(5*n+5)/(10^(n+1))))/10)+truncate(truncate(b(5*n+5)/2)/truncate(c(5*n+5)/(10^(n+1)))), b(n) = 3*b(n-1)-b(n-2), b(3) = 23, b(2) = 9, b(1) = 4, b(0) = 3, c(n) = 2*c(n-1)+b(n-1), c(1) = 5, c(0) = 1

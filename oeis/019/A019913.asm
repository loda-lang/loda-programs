...
; Formula: a(n) = (d(4*n+4)/(c(4*n+4)/(10^(n+1))))%10, b(n) = 2*b(n-1)+2*c(n-1), b(2) = 6, b(1) = 2, b(0) = 1, c(n) = 3*c(n-1)+b(n-1)+c(n-1), c(2) = 6, c(1) = 1, c(0) = 0, d(n) = c(n-1)+d(n-1), d(2) = 1, d(1) = 0, d(0) = 0

...
; Formula: a(n) = c(n+2)/2, b(n) = b(n-1)+d(n-1), b(5) = 33, b(4) = 12, b(3) = 4, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = f1(n-1), c(5) = 162, c(4) = 60, c(3) = 22, c(2) = 8, c(1) = 3, c(0) = 1, d(n) = -b(n-1)-d(n-1)-f(n-1)+b(n-1)+c(n-1)+d(n-1)+e(n-1), d(5) = 56, d(4) = 21, d(3) = 8, d(2) = 3, d(1) = 1, d(0) = 0, e(n) = -f(n-1)+c(n-1)+e(n-1), e(5) = 56, e(4) = 21, e(3) = 8, e(2) = 3, e(1) = 1, e(0) = 0, f(n) = -f(n-1)+b(n-1)+c(n-1)+e(n-1), f(5) = 68, f(4) = 25, f(3) = 9, f(2) = 3, f(1) = 1, f(0) = 0, f1(n) = 2*c(n-1)+2*e(n-1)+2*f1(n-1)-2*f(n-1), f1(5) = 436, f1(4) = 162, f1(3) = 60, f1(2) = 22, f1(1) = 8, f1(0) = 3

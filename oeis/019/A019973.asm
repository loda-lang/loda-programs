...
; Formula: a(n) = -10*truncate(truncate(b(4*n)/truncate(c(4*n)/(10^n)))/10)+truncate(b(4*n)/truncate(c(4*n)/(10^n))), b(n) = 2*c(n-1)+b(n-1), b(1) = 16, b(0) = 10, c(n) = 3*c(n-1)+b(n-1), c(1) = 19, c(0) = 3

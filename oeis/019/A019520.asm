...
; Formula: a(n) = d(n+2), b(n) = 9*b(n-1)*((2*n-2)/b(n-1))+b(n-1), b(4) = 10, b(3) = 10, b(2) = 10, b(1) = 10, b(0) = 1, c(n) = 2*n, c(4) = 8, c(3) = 6, c(2) = 4, c(1) = 2, c(0) = 1, d(n) = d(n-1)*(9*(9*b(n-2)*(c(n-2)/b(n-2))+b(n-2))*((2*n-2)/(9*b(n-2)*(c(n-2)/b(n-2))+b(n-2)))+9*b(n-2)*(c(n-2)/b(n-2))+b(n-2))+2*n-2, d(4) = 246, d(3) = 24, d(2) = 2, d(1) = 0, d(0) = 0

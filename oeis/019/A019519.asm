...
; Formula: a(n) = d(n+2), b(n) = 9*b(n-1)*((2*n-3)/b(n-1))+b(n-1), b(4) = 10, b(3) = 10, b(2) = 10, b(1) = 1, b(0) = 1, c(n) = 2*n-1, c(4) = 7, c(3) = 5, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = d(n-1)*(9*b(n-1)*(c(n-1)/b(n-1))+b(n-1))+2*n-3, d(4) = 135, d(3) = 13, d(2) = 1, d(1) = 0, d(0) = 0

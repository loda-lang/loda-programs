...
; Formula: a(n) = -truncate(truncate(truncate(2^truncate(A062876(n)/4))/max(truncate(A062876(n)/4),2))/max(truncate(A062876(n)/4),2))*max(truncate(A062876(n)/4),2)+truncate(truncate(2^truncate(A062876(n)/4))/max(truncate(A062876(n)/4),2))

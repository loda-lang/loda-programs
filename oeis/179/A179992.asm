...
; Formula: a(n) = c(n)+1, b(n) = n^2+b(n-2)+d(n-2)+1, b(3) = 16, b(2) = 5, b(1) = 2, b(0) = 0, c(n) = (n+1)^2+b(n-1)+d(n-1), c(3) = 36, c(2) = 15, c(1) = 4, c(0) = 1, d(n) = (n+1)^2+b(n-1)+d(n-1), d(3) = 36, d(2) = 15, d(1) = 4, d(0) = 0

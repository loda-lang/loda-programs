...
; Formula: a(n) = b(n+2), b(n) = c(n-1)+c(n-2), b(5) = 108, b(4) = 22, b(3) = 6, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = 10*c(n-2)+4*c(n-3)+2*c(n-1), c(6) = 1720, c(5) = 368, c(4) = 92, c(3) = 16, c(2) = 6, c(1) = 0, c(0) = 0

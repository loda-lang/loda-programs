...
; Formula: a(n) = b(n+2), b(n) = c(n-1)+d(n-1), b(3) = 6, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = 6*c(n-2)+4*b(n-2)+2*d(n-2), c(3) = 6, c(2) = 0, c(1) = 1, c(0) = 0, d(n) = 6*c(n-1)+4*b(n-1)+2*d(n-1), d(3) = 16, d(2) = 6, d(1) = 0, d(0) = 0

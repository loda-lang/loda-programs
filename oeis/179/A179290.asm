...
; Formula: a(n) = -10*truncate(truncate(d(2*n)/(truncate(e(2*n)/(10^n))+1))/10)+truncate(d(2*n)/(truncate(e(2*n)/(10^n))+1)), b(n) = 4*e(n-1)+2*b(n-1)+2*c(n-1)+2*d(n-1), b(3) = 816, b(2) = 40, b(1) = 2, b(0) = 0, c(n) = 64*c(n-3)+24*c(n-1)-16*c(n-4)-76*c(n-2), c(7) = 157632384, c(6) = 7715072, c(5) = 377600, c(4) = 18480, c(3) = 904, c(2) = 44, c(1) = 2, c(0) = 0, d(n) = 12*e(n-1)+6*d(n-1)+4*b(n-1)+4*c(n-1), d(3) = 2280, d(2) = 112, d(1) = 6, d(0) = 1, e(n) = 12*e(n-1)+5*d(n-1)+4*b(n-1)+4*c(n-1), e(3) = 2168, e(2) = 106, e(1) = 5, e(0) = 0

...
; Formula: a(n) = truncate((b(n)+e(n))/gcd(d(n),b(n)+e(n))), b(n) = 6*b(n-1)-4*b(n-2), b(4) = 376, b(3) = 72, b(2) = 14, b(1) = 3, b(0) = 1, c(n) = 1, c(3) = 1, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = 6*d(n-1)-4*d(n-2), d(5) = 1592, d(4) = 304, d(3) = 58, d(2) = 11, d(1) = 2, d(0) = 1, e(n) = d(n-1)*(3*c(n-1)+1)+b(n-1), e(3) = 58, e(2) = 11, e(1) = 2, e(0) = 0

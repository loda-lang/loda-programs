...
; Formula: a(n) = d(n+1), b(n) = -b(n-1)-c(n-1)-10*d(n-1)+b(n-1)+c(n-1), b(2) = -10, b(1) = 0, b(0) = 0, c(n) = 10*c(n-1)+10, c(2) = 110, c(1) = 10, c(0) = 0, d(n) = 10*d(n-1)+2*b(n-1)+2*c(n-1)-b(n-1)-c(n-1)-10*d(n-1)+1, d(2) = 11, d(1) = 1, d(0) = 0

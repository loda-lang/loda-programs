...
; Formula: a(n) = -10*truncate(sqrtint(truncate((6*truncate(10^(2*n-2))-floor(truncate(10^(2*n-2))/2))/2))/10)+sqrtint(truncate((6*truncate(10^(2*n-2))-floor(truncate(10^(2*n-2))/2))/2))

...
; Formula: a(n) = 10*c(n)+1, b(n) = 10*(b(n-2)%2)+10*d(n-2)+7, b(2) = 17, b(1) = 8, b(0) = 0, c(n) = 10*(b(n-2)%2)+10*d(n-2), c(2) = 10, c(1) = 1, c(0) = 0, d(n) = 10*((d(n-2)+7)%2)+10*d(n-1), d(2) = 100, d(1) = 10, d(0) = 1

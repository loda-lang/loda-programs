...
; 1,1,2,2,2,2,2,4,3,2,2,4,3,4,3,4,3,6,4,6,5,4,4,8,5,5,4,6,4,8,5,8,6,6,5,8,5,7,5,7,5,10,6,9,7,8,6,12,7,10,7,9,7,13,8,10,8,8,7,14,8,10,8,11,8,13,8,12,9,11,9,15,10,12,10,13,10,16,10,14
; Formula: a(n) = A056169(A001783(n+1)-1)+1

...
; Formula: a(n) = c(n+4)+1, b(n) = 2*(2*b(n-1))+2*d(n-1)+2*f(n-1)-b(n-1)-c(n-1)-d(n-1)-e(n-1)-f(n-1)-2*d(n-1)-4*b(n-1)+d(n-1)+e(n-1)+1, b(4) = -5, b(3) = -1, b(2) = -2, b(1) = 1, b(0) = 0, c(n) = -c(n-1)-d(n-1)-2*b(n-1)+b(n-1)+c(n-1)+d(n-1)+e(n-1)+2, c(4) = 12, c(3) = 7, c(2) = 3, c(1) = 2, c(0) = 0, d(n) = 2*b(n-1)-b(n-1)-d(n-1)-e(n-1)+c(n-1)+d(n-1)-2, d(4) = -5, d(3) = -4, d(2) = -1, d(1) = -2, d(0) = 0, e(n) = 2*b(n-1)+2*c(n-1)+2*d(n-1)+2*e(n-1)-c(n-1)-e(n-1)-2*d(n-1)-4*b(n-1)+b(n-1)+d(n-1)+2, e(4) = 15, e(3) = 9, e(2) = 3, e(1) = 2, e(0) = 0, f(n) = 2*b(n-1)+2*d(n-1)-c(n-1)-d(n-1)-e(n-1)-f(n-1)-2*d(n-1)-4*b(n-1)+b(n-1)+e(n-1)+f(n-1), f(4) = -2, f(3) = 0, f(2) = -1, f(1) = 0, f(0) = 0

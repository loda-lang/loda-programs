...
; Formula: a(n) = e(n-2)+5, b(n) = -b(n-1)-b(n-2)-c(n-2)-d(n-2)-e(n-2)-4, b(4) = -9, b(3) = -5, b(2) = -3, b(1) = -1, b(0) = 0, c(n) = -b(n-1)+e(n-1)+3, c(4) = 24, c(3) = 14, c(2) = 7, c(1) = 3, c(0) = 0, d(n) = -e(n-1)+b(n-1)+c(n-1)-1, d(4) = -8, d(3) = -5, d(2) = -2, d(1) = -1, d(0) = 0, e(n) = c(n-1)+d(n-1)+e(n-1)+3, e(4) = 28, e(3) = 16, e(2) = 8, e(1) = 3, e(0) = 0

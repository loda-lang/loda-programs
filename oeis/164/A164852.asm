...
; Formula: a(n) = c(n)+f(n), b(n) = b(n-1)+b(n-2), b(4) = 5, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = 10*c(n-2)+b(n-1)+d(n-1), c(4) = 125, c(3) = 113, c(2) = 12, c(1) = 11, c(0) = 1, d(n) = b(n-1), d(4) = 3, d(3) = 2, d(2) = 1, d(1) = 1, d(0) = 0, e(n) = 10*e(n-2)+b(n-2)+b(n-3), e(4) = 113, e(3) = 12, e(2) = 11, e(1) = 1, e(0) = 1, f(n) = e(n-1), f(4) = 12, f(3) = 11, f(2) = 1, f(1) = 1, f(0) = 0

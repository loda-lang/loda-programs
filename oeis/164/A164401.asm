...
; Formula: a(n) = b(n-1)+c(n-2)+d(n-1)+d(n-2)+a(n-1), a(5) = 25, a(4) = 14, a(3) = 8, a(2) = 4, a(1) = 2, a(0) = 1, b(n) = c(n-2), b(5) = 4, b(4) = 2, b(3) = 1, b(2) = 1, b(1) = 0, b(0) = 1, c(n) = d(n-1)+e(n-1)+e(n-2)+e(n-3), c(8) = 81, c(7) = 45, c(6) = 25, c(5) = 14, c(4) = 8, c(3) = 4, c(2) = 2, c(1) = 1, c(0) = 1, d(n) = b(n-1)+d(n-1), d(5) = 5, d(4) = 3, d(3) = 2, d(2) = 1, d(1) = 1, d(0) = 0, e(n) = c(n-1)+d(n-1), e(5) = 11, e(4) = 6, e(3) = 3, e(2) = 2, e(1) = 1, e(0) = 0

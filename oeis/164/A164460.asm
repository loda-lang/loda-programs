...
; Formula: a(n) = c(n+5), b(n) = -d(n-1)-e(n-1)+b(n-1)+c(n-1), b(5) = 5, b(4) = 3, b(3) = 2, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = -e(n-3)-2*d(n-3)+c(n-1)+c(n-2)+c(n-3)+1, c(5) = 13, c(4) = 8, c(3) = 4, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = -d(n-1)+b(n-1)+c(n-1), d(5) = 7, d(4) = 4, d(3) = 2, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = d(n-1), e(5) = 4, e(4) = 2, e(3) = 1, e(2) = 0, e(1) = 0, e(0) = 0

...
; Formula: a(n) = c(n-1)+a(n-1)+3, a(4) = 143, a(3) = 80, a(2) = 45, a(1) = 25, a(0) = 14, b(n) = (-(c(n-1)+2)*(-a(n-1)+e(n-1))+d(n-1)*(b(n-1)+a(n-1)+1))/(b(n-1)+a(n-1)+1), b(4) = 53, b(3) = 28, b(2) = 14, b(1) = 6, b(0) = 2, c(n) = b(n-1)+a(n-1)+1, c(4) = 109, c(3) = 60, c(2) = 32, c(1) = 17, c(0) = 8, d(n) = (-(c(n-1)+2)*(-a(n-1)+e(n-1))+d(n-1)*(b(n-1)+a(n-1)+1))/(b(n-1)+a(n-1)+1), d(4) = 53, d(3) = 28, d(2) = 14, d(1) = 6, d(0) = 2, e(n) = c(n-1)+3, e(4) = 63, e(3) = 35, e(2) = 20, e(1) = 11, e(0) = 7

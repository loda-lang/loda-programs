...
; Formula: a(n) = f(n+3), b(n) = (-(c(n-1)+2)*(-f(n-1)+e(n-1))+d(n-1)*(b(n-1)+f(n-1)+1))/(b(n-1)+f(n-1)+1), b(4) = 6, b(3) = 2, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = b(n-1)+f(n-1)+1, c(4) = 17, c(3) = 8, c(2) = 4, c(1) = 1, c(0) = 0, d(n) = (-(c(n-1)+2)*(-f(n-1)+e(n-1))+d(n-1)*(b(n-1)+f(n-1)+1))/(b(n-1)+f(n-1)+1), d(4) = 6, d(3) = 2, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = c(n-1)+3, e(4) = 11, e(3) = 7, e(2) = 4, e(1) = 3, e(0) = 0, f(n) = c(n-1)+f(n-1)+3, f(4) = 25, f(3) = 14, f(2) = 7, f(1) = 3, f(0) = 0

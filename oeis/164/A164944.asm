...
; Formula: a(n) = d(n+2), b(n) = truncate((2*n-2)/b(n-1))*b(n-1)+b(n-1), b(4) = 8, b(3) = 8, b(2) = 4, b(1) = 2, b(0) = 1, c(n) = 2*n, c(4) = 8, c(3) = 6, c(2) = 4, c(1) = 2, c(0) = 1, d(n) = d(n-1)*(truncate(c(n-1)/b(n-1))*b(n-1)+b(n-1))+2*n-2, d(4) = 166, d(3) = 20, d(2) = 2, d(1) = 0, d(0) = 0

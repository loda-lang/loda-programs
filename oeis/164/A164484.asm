...
; Formula: a(n) = (-n+b(n+2)+f(n+2)-2)/2+6, b(n) = d(n-1)+d(n-2)+4, b(5) = 47, b(4) = 29, b(3) = 17, b(2) = 9, b(1) = 4, b(0) = 0, c(n) = d(n-1)+2, c(5) = 29, c(4) = 18, c(3) = 11, c(2) = 6, c(1) = 3, c(0) = 1, d(n) = 2*d(n-3)+d(n-2)+10, d(5) = 44, d(4) = 27, d(3) = 16, d(2) = 9, d(1) = 4, d(0) = 1, e(n) = c(n-1), e(5) = 18, e(4) = 11, e(3) = 6, e(2) = 3, e(1) = 1, e(0) = 0, f(n) = b(n-1)+e(n-1)+2, f(5) = 42, f(4) = 25, f(3) = 14, f(2) = 7, f(1) = 2, f(0) = 0

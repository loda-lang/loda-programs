...
; Formula: a(n) = truncate((-n+b(n+2)+e(n+2)-2)/2)+6, b(n) = b(n-2)+c(n-1)+c(n-3)+6, b(5) = 47, b(4) = 29, b(3) = 17, b(2) = 9, b(1) = 4, b(0) = 0, c(n) = 2*c(n-3)+c(n-2)+6, c(6) = 46, c(5) = 29, c(4) = 18, c(3) = 11, c(2) = 6, c(1) = 3, c(0) = 1, d(n) = c(n-1), d(5) = 18, d(4) = 11, d(3) = 6, d(2) = 3, d(1) = 1, d(0) = 0, e(n) = b(n-1)+d(n-1)+2, e(5) = 42, e(4) = 25, e(3) = 14, e(2) = 7, e(1) = 2, e(0) = 0

...
; Formula: a(n) = c(max(n-1,0)), b(n) = b(n-1)+b(n-2), b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = 100*c(n-2)+2*b(n-2)+d(n-2), c(3) = 10103, c(2) = 102, c(1) = 101, c(0) = 1, d(n) = b(n-1), d(3) = 2, d(2) = 1, d(1) = 1, d(0) = 0

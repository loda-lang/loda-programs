...
; Formula: a(n) = gcd((-binomial(floor((sqrtint(8*n-8)-1)/2)+1,2)+n-1)^4,(-n+binomial(floor((sqrtint(8*n-8)-1)/2)+1,2)+floor((sqrtint(8*n-8)-1)/2)+3)*(-binomial(floor((sqrtint(8*n-8)-1)/2)+1,2)+floor((sqrtint(8*n-8)-1)/2)+n+1))

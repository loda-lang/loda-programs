...
; Formula: a(n) = truncate(c(n+5)/2), b(n) = b(n-1)+f(n-1), b(4) = 6, b(3) = 2, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = 2*d(n-1)-2*e(n-1)+b(n-1)+c(n-1)+f(n-1)+2, c(4) = 16, c(3) = 8, c(2) = 4, c(1) = 2, c(0) = 0, d(n) = -b(n-1)-d(n-1)+c(n-1)+e(n-1), d(4) = 6, d(3) = 4, d(2) = 2, d(1) = 0, d(0) = 0, e(n) = c(n-1), e(4) = 8, e(3) = 4, e(2) = 2, e(1) = 0, e(0) = 0, f(n) = -b(n-1)-d(n-1)+c(n-1)+e(n-1), f(4) = 6, f(3) = 4, f(2) = 2, f(1) = 0, f(0) = 0

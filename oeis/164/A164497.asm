...
; Formula: a(n) = e(n+2)+4, b(n) = 2*d(n-1)+2*e(n-1)-b(n-1)-c(n-1)-e(n-1)-2*d(n-1)+b(n-1)+d(n-1)+f(n-1)-1, b(4) = -15, b(3) = -8, b(2) = -3, b(1) = -1, b(0) = 0, c(n) = -b(n-1)-c(n-1)-d(n-1)+c(n-1)+d(n-1)+e(n-1)+3, c(4) = 28, c(3) = 15, c(2) = 8, c(1) = 3, c(0) = 0, d(n) = -d(n-1)-e(n-1)+b(n-1)+c(n-1)+d(n-1)-2, d(4) = -12, d(3) = -6, d(2) = -4, d(1) = -2, d(0) = 0, e(n) = 2*c(n-1)+2*d(n-1)+2*e(n-1)-b(n-1)-c(n-1)-e(n-1)-2*d(n-1)+b(n-1)+d(n-1)+4, e(4) = 30, e(3) = 17, e(2) = 9, e(1) = 4, e(0) = 0, f(n) = 2*d(n-1)-b(n-1)-c(n-1)-e(n-1)-2*d(n-1)+e(n-1)+f(n-1)-1, f(4) = -18, f(3) = -10, f(2) = -4, f(1) = -1, f(0) = 0

...
; Formula: a(n) = b(n+6)+1, b(n) = (-(c(n-1)+3)*(-f(n-1)+e(n-1))+d(n-1))/(b(n-1)+f(n-1)+1), b(4) = 4, b(3) = 1, b(2) = -3, b(1) = -3, b(0) = 0, c(n) = b(n-1)+f(n-1)+1, c(4) = 13, c(3) = 5, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = (-(c(n-1)+3)*(-f(n-1)+e(n-1))+d(n-1))/(b(n-1)+f(n-1)+1), d(4) = 4, d(3) = 1, d(2) = -3, d(1) = -3, d(0) = 0, e(n) = c(n-1)+3, e(4) = 8, e(3) = 4, e(2) = 4, e(1) = 3, e(0) = 1, f(n) = c(n-1)+f(n-1)+3, f(4) = 19, f(3) = 11, f(2) = 7, f(1) = 3, f(0) = 0

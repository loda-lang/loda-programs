...
; Formula: a(n) = d(n+2)+4, b(n) = 2*b(n-1)-b(n-1)-c(n-1)-d(n-1)-2*b(n-1)+d(n-1)+e(n-1)-1, b(3) = -7, b(2) = -3, b(1) = -1, b(0) = 0, c(n) = -c(n-1)-2*b(n-1)+b(n-1)+c(n-1)+d(n-1)+2, c(3) = 14, c(2) = 7, c(1) = 2, c(0) = 0, d(n) = 2*(2*b(n-1))+2*c(n-1)+2*d(n-1)-b(n-1)-c(n-1)-d(n-1)-2*b(n-1)+4, d(3) = 17, d(2) = 9, d(1) = 4, d(0) = 0, e(n) = -b(n-1)-c(n-1)-d(n-1)-2*b(n-1)+b(n-1)+d(n-1)+e(n-1)-1, e(3) = -4, e(2) = -2, e(1) = -1, e(0) = 0

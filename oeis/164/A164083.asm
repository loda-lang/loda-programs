...
; Formula: a(n) = 149*((n-1)>=4)+135*((n-1)>=3)+104*((n-1)>=5)+85*((n-1)>=2)+33*((n-1)>=1)+24*((n-1)>=6)-((n-1)>=17)-3*((n-1)>=16)-6*((n-1)>=15)-14*((n-1)>=14)-25*((n-1)>=13)-45*((n-1)>=12)-55*((n-1)>=7)-72*((n-1)>=11)-98*((n-1)>=10)-103*((n-1)>=8)-114*((n-1)>=9)+7

...
; Formula: a(n) = d(n+5), b(n) = -b(n-1)-c(n-3)+b(n-1)+b(n-3)+d(n-3)+e(n-3)+f(n-3)+2, b(6) = 12, b(5) = 8, b(4) = 5, b(3) = 3, b(2) = 2, b(1) = 2, b(0) = 1, c(n) = b(n-1), c(6) = 8, c(5) = 5, c(4) = 3, c(3) = 2, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = b(n-1)+d(n-1), d(6) = 21, d(5) = 13, d(4) = 8, d(3) = 5, d(2) = 3, d(1) = 1, d(0) = 0, e(n) = b(n-1)+e(n-1), e(6) = 21, e(5) = 13, e(4) = 8, e(3) = 5, e(2) = 3, e(1) = 1, e(0) = 0, f(n) = -e(n-1)-f(n-1)+c(n-1), f(6) = -5, f(5) = -3, f(4) = -2, f(3) = -1, f(2) = 0, f(1) = 0, f(0) = 0

...
; Formula: a(n) = e(n+2)+4, b(n) = -c(n-1)-d(n-1)-e(n-1)-2*b(n-1)+b(n-1)+d(n-1)+e(n-1)+f(n-1)-1, b(4) = -15, b(3) = -7, b(2) = -3, b(1) = -1, b(0) = 0, c(n) = -b(n-1)-c(n-1)-d(n-1)+c(n-1)+e(n-1)+2, c(4) = 34, c(3) = 17, c(2) = 7, c(1) = 2, c(0) = 0, d(n) = -e(n-1)+b(n-1)+c(n-1)+d(n-1), d(4) = -15, d(3) = -8, d(2) = -3, d(1) = 0, d(0) = 0, e(n) = 2*b(n-1)+2*c(n-1)+2*e(n-1)-b(n-1)-c(n-1)-d(n-1)-e(n-1)+d(n-1)+4, e(4) = 31, e(3) = 17, e(2) = 9, e(1) = 4, e(0) = 0, f(n) = -c(n-1)-d(n-1)-e(n-1)-2*b(n-1)+d(n-1)+e(n-1)+f(n-1)-1, f(4) = -8, f(3) = -4, f(2) = -2, f(1) = -1, f(0) = 0

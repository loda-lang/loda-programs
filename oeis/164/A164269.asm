...
; Formula: a(n) = truncate((A010892(n)*truncate((2*A128128(n+1))/3))/2)

mov $1,$0
add $1,1
seq $1,128128 ; Expansion of chi(-q^3) / chi^3(-q) in powers of q where chi() is a Ramanujan theta function.
mul $1,2
div $1,3

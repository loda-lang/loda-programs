...
; Formula: a(n) = d(n+1), b(n) = floor((3*n-3)/b(n-1))*b(n-1)+b(n-1), b(3) = 8, b(2) = 4, b(1) = 1, b(0) = 1, c(n) = 3*n, c(3) = 9, c(2) = 6, c(1) = 3, c(0) = 0, d(n) = d(n-1)*(floor(c(n-1)/b(n-1))*b(n-1)+b(n-1))+3*n-3, d(3) = 30, d(2) = 3, d(1) = 0, d(0) = 0

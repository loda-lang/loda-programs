...
; Formula: a(n) = truncate((b(n)+d(n))/2), b(n) = 2*b(n-1)+2*c(n-2), b(5) = 272, b(4) = 128, b(3) = 60, b(2) = 28, b(1) = 12, b(0) = 6, c(n) = 2*c(n-1), c(6) = 64, c(5) = 32, c(4) = 16, c(3) = 8, c(2) = 4, c(1) = 2, c(0) = 2, d(n) = 2*d(n-1)+b(n-2), d(5) = 212, d(4) = 76, d(3) = 24, d(2) = 6, d(1) = 0, d(0) = 0

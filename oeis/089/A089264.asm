...
; Formula: a(n) = (b(n)+e(n))/2, b(n) = 2*b(n-1)+2*c(n-2), b(5) = 272, b(4) = 128, b(3) = 60, b(2) = 28, b(1) = 12, b(0) = 6, c(n) = c(n-1)+d(n-1), c(5) = 32, c(4) = 16, c(3) = 8, c(2) = 4, c(1) = 2, c(0) = 2, d(n) = c(n-1)+d(n-1), d(5) = 32, d(4) = 16, d(3) = 8, d(2) = 4, d(1) = 2, d(0) = 0, e(n) = 2*e(n-1)+b(n-2), e(5) = 212, e(4) = 76, e(3) = 24, e(2) = 6, e(1) = 0, e(0) = 0

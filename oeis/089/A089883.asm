...
; Formula: a(n) = truncate((c(n+1)+e(n+1))/2)+1, b(n) = 3*b(n-1)-b(n-2)-1, b(6) = 56, b(5) = 22, b(4) = 9, b(3) = 4, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = 2*b(n-1)+2*c(n-1)+d(n-1)+1, c(4) = 81, c(3) = 21, c(2) = 5, c(1) = 1, c(0) = 0, d(n) = 6*b(n-1)+3*d(n-1), d(4) = 114, d(3) = 30, d(2) = 6, d(1) = 0, d(0) = 0, e(n) = 2*b(n-1)+d(n-1), e(4) = 38, e(3) = 10, e(2) = 2, e(1) = 0, e(0) = 0

...
; Formula: a(n) = b(max(n-2,0))/gcd(d(max(n-2,0)),b(max(n-2,0))), b(n) = b(n-1)*(c(n-1)+1), b(2) = 10, b(1) = 2, b(0) = 1, c(n) = max(c(n-1)-2,0)+4, c(2) = 6, c(1) = 4, c(0) = 1, d(n) = d(n-1)*(c(n-1)+1)+b(n-1), d(2) = 7, d(1) = 1, d(0) = 0

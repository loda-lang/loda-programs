...
; Formula: a(n) = max((floor((sqrtint(8*n+16)-1)/2)+1)*if(((-binomial(floor((sqrtint(8*n+16)-1)/2)+1,2)+n+1)^2)==1,(-binomial(floor((sqrtint(8*n+16)-1)/2)+1,2)+n+1)^(-n+binomial(floor((sqrtint(8*n+16)-1)/2)+1,2)+floor((sqrtint(8*n+16)-1)/2)-1),if((-n+binomial(floor((sqrtint(8*n+16)-1)/2)+1,2)+floor((sqrtint(8*n+16)-1)/2)-1)<=(-1),0,(-binomial(floor((sqrtint(8*n+16)-1)/2)+1,2)+n+1)^(-n+binomial(floor((sqrtint(8*n+16)-1)/2)+1,2)+floor((sqrtint(8*n+16)-1)/2)-1)))-1,0)+1

...
; Submitted by pututu
; 2,2,2,2,2,5,3,2,3,5,2,5,2,2,2,3,2,2,2,5,3,113,3,5,3,2,29,3,2,2,3,2,5,3,3,5,2,2,5,5,2,2,2,17,11,2,7,11,19,3,3,13,2,2,2,5,2,2,11,3,2,2,5,2,11,2,2,2,5,3,3,19,2,5,5,3,5,2,19,29
; Formula: a(n) = A249800(A000040(n+2)-2)

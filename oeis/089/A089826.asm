...
; Formula: a(n) = floor(b(4*n+4)/floor(c(4*n+4)/(10^(n+1))))%10, b(n) = 2*d(n-1)+b(n-1), b(2) = 5, b(1) = 1, b(0) = 1, c(n) = 2*b(n-1)+2*d(n-1)+c(n-1), c(2) = 8, c(1) = 2, c(0) = 0, d(n) = 3*d(n-1)+2*b(n-1)+c(n-1), d(2) = 10, d(1) = 2, d(0) = 0

...
; Formula: a(n) = (b(4*n+4)/(c(4*n+4)/(10^(n+1))))%10, b(n) = 2*b(n-1)+2*c(n-1)+2*d(n-1), b(2) = 16, b(1) = 2, b(0) = 0, c(n) = 2*c(n-1)+b(n-1)+d(n-1), c(2) = 10, c(1) = 2, c(0) = 1, d(n) = 4*c(n-1)+4*d(n-1), d(2) = 24, d(1) = 4, d(0) = 0

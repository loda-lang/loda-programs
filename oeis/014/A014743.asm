...
; Formula: a(n) = a(n-1)+a(n-3)+c(n-3)+1, a(5) = 17, a(4) = 9, a(3) = 5, a(2) = 3, a(1) = 2, a(0) = 1, b(n) = a(n-1), b(5) = 9, b(4) = 5, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = -d(n-1)+a(n-1)+b(n-1)+c(n-1), c(5) = 27, c(4) = 15, c(3) = 8, c(2) = 4, c(1) = 1, c(0) = 0, d(n) = -d(n-1)+b(n-1), d(5) = 3, d(4) = 2, d(3) = 1, d(2) = 1, d(1) = 0, d(0) = 0

...
; Formula: a(n) = truncate(c(n-1)/2), b(n) = c(n-1), b(3) = 10, b(2) = 8, b(1) = 2, b(0) = 0, c(n) = truncate((-d(n-2)+c(n-1)+c(n-3))/2)+6, c(4) = 15, c(3) = 12, c(2) = 10, c(1) = 8, c(0) = 2, d(n) = -d(n-1)+b(n-1), d(3) = 6, d(2) = 2, d(1) = 0, d(0) = 0

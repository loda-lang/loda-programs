...
; Formula: a(n) = b(n+2), b(n) = b(n-2)+c(n-2)+d(n-2)+2, b(4) = 10, b(3) = 5, b(2) = 3, b(1) = 1, b(0) = 0, c(n) = -c(n-2)+b(n-2)+c(n-2)+d(n-2)+2, c(4) = 8, c(3) = 4, c(2) = 2, c(1) = 1, c(0) = 1, d(n) = b(n-1)+c(n-1)+d(n-1), d(4) = 17, d(3) = 8, d(2) = 3, d(1) = 1, d(0) = 0

...
; Formula: a(n) = b(n+2), b(n) = d(n-1), b(4) = 10, b(3) = 5, b(2) = 3, b(1) = 1, b(0) = 0, c(n) = -c(n-2)+d(n-1), c(4) = 8, c(3) = 4, c(2) = 2, c(1) = 1, c(0) = 1, d(n) = b(n-1)+c(n-1)+e(n-1)+2, d(4) = 19, d(3) = 10, d(2) = 5, d(1) = 3, d(0) = 1, e(n) = b(n-1)+c(n-1)+e(n-1), e(4) = 17, e(3) = 8, e(2) = 3, e(1) = 1, e(0) = 0

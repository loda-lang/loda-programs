...
; Formula: a(n) = d(n+3), b(n) = b(n-2)+f1(n-2)+1, b(5) = 5, b(4) = 3, b(3) = 2, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = b(n-2)+c(n-1)+f1(n-2), c(5) = 7, c(4) = 3, c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = d(n-1)+f(n-1), d(5) = 5, d(4) = 1, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = b(n-1)+f1(n-1), e(5) = 7, e(4) = 4, e(3) = 2, e(2) = 1, e(1) = 0, e(0) = 0, f(n) = c(n-1)+e(n-1)+f(n-1), f(5) = 11, f(4) = 4, f(3) = 1, f(2) = 0, f(1) = 0, f(0) = 0, f1(n) = b(n-1)+f1(n-1), f1(5) = 7, f1(4) = 4, f1(3) = 2, f1(2) = 1, f1(1) = 0, f1(0) = 0

...
; Formula: a(n) = truncate(b(2*n+1)/3), b(n) = 2*c(n-1)-2*c(n-3)-2*c(n-4)+c(n-2)+c(n-5), b(9) = 1872, b(8) = 792, b(7) = 333, b(6) = 141, b(5) = 60, b(4) = 24, b(3) = 12, b(2) = 3, b(1) = 3, b(0) = 0, c(n) = 2*c(n-1)+2*c(n-2)-2*c(n-3)-2*c(n-4)+c(n-5), c(9) = 2277, c(8) = 960, c(7) = 405, c(6) = 168, c(5) = 72, c(4) = 27, c(3) = 12, c(2) = 3, c(1) = 0, c(0) = 0

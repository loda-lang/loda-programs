...
; Formula: a(n) = -b(n-2)-c(n-2)+d(n-2)-1, a(4) = -2, a(3) = -1, a(2) = -1, a(1) = -1, a(0) = 1, b(n) = b(n-1)+c(n-1), b(4) = 1, b(3) = 2, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = a(n-1)+d(n-1)-1, c(4) = -2, c(3) = -1, c(2) = 0, c(1) = 1, c(0) = 0, d(n) = a(n-1)+d(n-1), d(4) = -1, d(3) = 0, d(2) = 1, d(1) = 2, d(0) = 1

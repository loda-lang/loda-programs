...
; Formula: a(n) = -b(n-1)+a(n-2)+c(n-2)-1, a(4) = -2, a(3) = -1, a(2) = -1, a(1) = -1, a(0) = 1, b(n) = a(n-1)+a(n-3)+b(n-1)+c(n-3)-1, b(6) = -7, b(5) = -3, b(4) = 0, b(3) = 1, b(2) = 1, b(1) = 2, b(0) = 1, c(n) = a(n-1)+c(n-1), c(4) = -1, c(3) = 0, c(2) = 1, c(1) = 2, c(0) = 1

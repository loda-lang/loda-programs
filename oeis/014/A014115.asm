...
; Formula: a(n) = 4*b(n-1)*(4^(n-1)+c(n-1)+1)*4^(n-1), a(3) = 2580480, a(2) = 1152, a(1) = 8, a(0) = 2, b(n) = 4*b(n-1)*(4^(n-1)+c(n-1)+1)*4^(n-1), b(3) = 2580480, b(2) = 1152, b(1) = 8, b(0) = 1, c(n) = 2*4^(n-1)+2*c(n-1)+2, c(3) = 70, c(2) = 18, c(1) = 4, c(0) = 0

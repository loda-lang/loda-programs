...
; Formula: a(n) = 2*b(n-1)+c(n-1)+d(n-1), a(3) = 16, a(2) = 5, a(1) = 1, a(0) = 1, b(n) = 2*b(n-1)+c(n-1)+c(n-2), b(3) = 16, b(2) = 5, b(1) = 1, b(0) = 0, c(n) = 6*b(n-2)+3*c(n-2)+3*c(n-3), c(3) = 15, c(2) = 3, c(1) = 3, c(0) = 0, d(n) = c(n-1), d(3) = 3, d(2) = 3, d(1) = 0, d(0) = 1

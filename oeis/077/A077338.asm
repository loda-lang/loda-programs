...
; Formula: a(n) = -A013636(A008578(n+1))*truncate(binomial(A000040(n+1),A064722(2*truncate(A000040(n+1)/2))+1)/A013636(A008578(n+1)))+binomial(A000040(n+1),A064722(2*truncate(A000040(n+1)/2))+1)-1

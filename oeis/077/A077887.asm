...
; Formula: a(n) = 2*c(n-1)-a(n-1)-2*b(n-1)-2*c(n-1)+b(n-1)+a(n-1)+1, a(2) = 0, a(1) = 1, a(0) = 1, b(n) = 2*c(n-1)-b(n-1)+b(n-1)+a(n-1), b(2) = -1, b(1) = 1, b(0) = 0, c(n) = 2*c(n-1)-b(n-1)-a(n-1)-2*c(n-1)+b(n-1), c(2) = -1, c(1) = -1, c(0) = 0

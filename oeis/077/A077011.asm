...
; Formula: a(n) = truncate((A057335(floor((2*if((-binomial(truncate((sqrtint(8*n-8)-1)/2)+1,2)+n-2)<=(-1),0,4^(-binomial(truncate((sqrtint(8*n-8)-1)/2)+1,2)+n-2))+2*if(truncate((sqrtint(8*n-8)-1)/2)<=(-1),0,2^truncate((sqrtint(8*n-8)-1)/2))^2)/3))-1)/A293810(A057335(floor((2*if((-binomial(truncate((sqrtint(8*n-8)-1)/2)+1,2)+n-2)<=(-1),0,4^(-binomial(truncate((sqrtint(8*n-8)-1)/2)+1,2)+n-2))+2*if(truncate((sqrtint(8*n-8)-1)/2)<=(-1),0,2^truncate((sqrtint(8*n-8)-1)/2))^2)/3))))+1

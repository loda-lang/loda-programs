...
; 1,2,2,6,2,2,2,4,12,6,2,6,6,2,2,30,6,12,4,6,8,6,2,4,30,6,4,6,4,6,8,6,4,18,4,12,18,4,6,12,6,8,10,6,12,6,4,30,18,30,6,42,18,4,6,4,4,12,4,6,30,8,12,126,6,12,16,6,8,12,6,12,36,18,30,12,8,6,4,30
; Formula: a(n) = A263027(A000203(n+1)-1)-1

...
; Formula: a(n) = gcd(min(n,0),b(n)/2)/6, b(n) = 2*c(n-1)+2*d(n-1)-b(n-1)-2*b(n-1), b(2) = 18, b(1) = -18, b(0) = 6, c(n) = 2*c(n-1)+2*d(n-1)-2*b(n-1), c(2) = 0, c(1) = -12, c(0) = 0, d(n) = -b(n-1)+d(n-1), d(2) = 12, d(1) = -6, d(0) = 0

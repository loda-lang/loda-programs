...
; Formula: a(n) = 4*(d(n)/4)+4, b(n) = -2*c(n-1)-3*b(n-1)+d(n-1)+4, b(3) = 1, b(2) = 5, b(1) = 1, b(0) = 1, c(n) = 2*b(n-1)+c(n-1)-2, c(3) = 8, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 4*b(n-1)+4*d(n-3)+2*c(n-1)+2*d(n-1)-d(n-2)-4*b(n-2)-8*c(n-3)-12*b(n-3)+16, d(4) = 88, d(3) = 40, d(2) = 12, d(1) = 4, d(0) = 0

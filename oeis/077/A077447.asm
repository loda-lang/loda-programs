...
; Formula: a(n) = c(n-1)+d(n-1), b(n) = -4*truncate(b(n-1)/4)+b(n-1)+2, b(2) = 2, b(1) = 4, b(0) = 2, c(n) = c(n-1)*(-4*truncate(b(n-1)/4)+b(n-1)+2)-c(n-2), c(2) = 10, c(1) = 6, c(0) = 2, d(n) = c(n-1), d(2) = 6, d(1) = 2, d(0) = 2

...
; Formula: a(n) = truncate(b(n)/3), b(n) = truncate((200*d(n-1)-200*c(n-1))/(2*n)), b(3) = 500100, b(2) = 15000, b(1) = 300, b(0) = 3, c(n) = -c(n-1)+d(n-1), c(3) = 15003, c(2) = 300, c(1) = 3, c(0) = 0, d(n) = d(n-1)+truncate((200*d(n-1)-200*c(n-1))/(2*n)), d(3) = 515403, d(2) = 15303, d(1) = 303, d(0) = 3

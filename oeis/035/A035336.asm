...
; Formula: a(n) = d(n)+1, b(n) = (2*((-c(n-1)+b(n-1)-2)/2))/gcd((-c(n-1)+b(n-1)-2)/2+2*c(n-1)+2,4), b(3) = -9, b(2) = -5, b(1) = -4, b(0) = -1, c(n) = 2*c(n-1)+2, c(3) = 62, c(2) = 30, c(1) = 14, c(0) = 6, d(n) = d(n-1)+gcd((-c(n-2)+b(n-2)-2)/2+2*c(n-2)+2,4)+1, d(3) = 14, d(2) = 9, d(1) = 6, d(0) = 1

...
; Formula: a(n) = 2*(d(n)/37)+1, b(n) = 10*c(n-1)+4*c(n-2)+b(n-1), b(3) = 30969, b(2) = 3515, b(1) = 407, b(0) = 0, c(n) = 8*c(n-1)+7*c(n-2), c(3) = 23088, c(2) = 2627, c(1) = 296, c(0) = 37, d(n) = 4*c(n-1)-d(n-1)+b(n-1), d(2) = 1443, d(1) = 148, d(0) = 0

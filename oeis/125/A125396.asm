...
; Formula: a(n) = 12*b(n-1)+6*a(n-1)-12*c(n-1)+2, a(2) = 62, a(1) = 8, a(0) = 1, b(n) = 12*b(n-1)+6*a(n-1)-10*c(n-1)+2, b(2) = 76, b(1) = 8, b(0) = 0, c(n) = 12*b(n-1)+6*a(n-1)-11*c(n-1)+1, c(2) = 68, c(1) = 7, c(0) = 0

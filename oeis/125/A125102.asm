...
; Formula: a(n) = binomial(floor((sqrtint(8*n+8)-1)/2),-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n)*(-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n+1)+gcd(-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n+1,2)*binomial(floor((sqrtint(8*n+8)-1)/2),-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n+1)

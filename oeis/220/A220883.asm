...
; Formula: a(n) = truncate((2*A130534(n-1)*if(((truncate((sqrtint(8*n-7)+1)/2)+1)^2)==1,(truncate((sqrtint(8*n-7)+1)/2)+1)^(-binomial(truncate((sqrtint(8*n-7)+1)/2),2)+n-1),if((-binomial(truncate((sqrtint(8*n-7)+1)/2),2)+n-1)<=(-1),0,(truncate((sqrtint(8*n-7)+1)/2)+1)^(-binomial(truncate((sqrtint(8*n-7)+1)/2),2)+n-1))))/2)

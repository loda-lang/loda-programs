...
; Formula: a(n) = b(n)+2, b(n) = 2*c(n-1)+d(n-1), b(3) = 0, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = d(n-1), c(3) = 0, c(2) = 0, c(1) = 1, c(0) = 0, d(n) = 2*d(n-3)*(2*d(n-4)+d(n-3))+4*d(n-3), d(3) = 6, d(2) = 0, d(1) = 0, d(0) = 1

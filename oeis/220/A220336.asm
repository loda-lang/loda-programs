...
; Formula: a(n) = b(n)+2, b(n) = 2*c(n-2)+c(n-1), b(4) = 16, b(3) = 0, b(2) = 4, b(1) = 2, b(0) = 0, c(n) = 2*(c(n-2)+c(n-3))*(2*c(n-4)+c(n-3))+4*c(n-3), c(7) = 0, c(6) = 576, c(5) = 0, c(4) = 0, c(3) = 16, c(2) = 0, c(1) = 0, c(0) = 2

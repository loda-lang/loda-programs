...
; Formula: a(n) = d(n+1)/2+1, b(n) = 3*b(n-2)+2*b(n-3)+b(n-1)+e(n-3), b(4) = 25, b(3) = 9, b(2) = 4, b(1) = 1, b(0) = 1, c(n) = 3*b(n-1)+e(n-1), c(4) = 39, c(3) = 16, c(2) = 5, c(1) = 3, c(0) = 0, d(n) = c(n-1)+f(n-1), d(4) = 24, d(3) = 8, d(2) = 3, d(1) = 0, d(0) = 0, e(n) = 2*b(n-1)+e(n-1), e(4) = 30, e(3) = 12, e(2) = 4, e(1) = 2, e(0) = 0, f(n) = 3*b(n-2)+e(n-2)+f(n-1), f(4) = 24, f(3) = 8, f(2) = 3, f(1) = 0, f(0) = 0

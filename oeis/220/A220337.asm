...
; Formula: a(n) = b(n)+2, b(n) = 2*d(n-2)+c(n-2), b(4) = 30, b(3) = 0, b(2) = 6, b(1) = 3, b(0) = 0, c(n) = 2*(c(n-2)+c(n-3))*(2*c(n-4)+c(n-3))+4*c(n-3), c(4) = 0, c(3) = 0, c(2) = 30, c(1) = 0, c(0) = 0, d(n) = c(n-1), d(4) = 0, d(3) = 30, d(2) = 0, d(1) = 0, d(0) = 3

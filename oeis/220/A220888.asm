...
; Formula: a(n) = b(n-1), a(5) = 11, a(4) = 2, a(3) = 0, a(2) = 0, a(1) = 0, a(0) = 0, b(n) = (-n+1)*(-n+c(n-2)+2)+b(n-1)+b(n-2), b(5) = 37, b(4) = 11, b(3) = 2, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = -n+c(n-1)+1, c(5) = -10, c(4) = -6, c(3) = -3, c(2) = -1, c(1) = 0, c(0) = 0

...
; 0,0,0,0,0,2,0,0,0,2,0,10,0,2,2,0,0,10,0,10,2,2,0,44,0,2,0,10,0,84,0,0,2,2,2,122,0,2,2,44,0,84,0,10,10,2,0,184,0,10,2,10,0,44,2,44,2,2,0,1590,0,2,10,0,2,84,0,10,2,84,0,1156,0,2,10,10,2,84,0,184
; Formula: a(n) = -truncate(A076078(n)/2)+A305564(n)

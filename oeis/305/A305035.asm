...
; Formula: a(n) = d(n)+3, b(n) = 2*c(n-2)+2, b(5) = 12, b(4) = 6, b(3) = 4, b(2) = 2, b(1) = 0, b(0) = 0, c(n) = 2*c(n-3)+c(n-1)+3, c(6) = 30, c(5) = 17, c(4) = 10, c(3) = 5, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = (b(n-2)+2)/(b(n-1)+1)+2*c(n-1), d(5) = 20, d(4) = 10, d(3) = 4, d(2) = 4, d(1) = 0, d(0) = 1

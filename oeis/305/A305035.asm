...
; Formula: a(n) = e(n)+3, b(n) = 2*b(n-3)+2*d(n-3)+4, b(5) = 12, b(4) = 6, b(3) = 4, b(2) = 2, b(1) = 0, b(0) = 0, c(n) = b(n-1)+d(n-1)+1, c(5) = 17, c(4) = 10, c(3) = 5, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = b(n-1)+d(n-1)+1, d(5) = 17, d(4) = 10, d(3) = 5, d(2) = 2, d(1) = 1, d(0) = 0, e(n) = (b(n-2)+2)/(b(n-1)+1)+2*c(n-1), e(5) = 20, e(4) = 10, e(3) = 4, e(2) = 4, e(1) = 0, e(0) = 1

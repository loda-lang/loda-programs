...
; Formula: a(n) = e(n)+3, b(n) = 2*c(n-2)+2*d(n-2)+2, b(5) = 20, b(4) = 10, b(3) = 4, b(2) = 2, b(1) = 0, b(0) = -2, c(n) = 2*c(n-3)+2*d(n-3)+4, c(5) = 12, c(4) = 6, c(3) = 4, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = c(n-1)+d(n-1)+1, d(5) = 17, d(4) = 10, d(3) = 5, d(2) = 2, d(1) = 1, d(0) = 0, e(n) = (c(n-2)+2)/(b(n-2)+3)+2*c(n-2)+2*d(n-2)+2, e(5) = 20, e(4) = 10, e(3) = 4, e(2) = 4, e(1) = 0, e(0) = 1

...
; Formula: a(n) = ((sign(n)*((n-1)%10+1))==0)+2*((sign(n)*((n-1)%10+1))==4)+2*((sign(n)*((n-1)%10+1))==3)+2*((sign(n)*((n-1)%10+1))==2)+2*((sign(n)*((n-1)%10+1))==1)-2*(bitor(sign(n)*((n-1)%10+1),1)==9)-2*(bitor(sign(n)*((n-1)%10+1),1)==7)

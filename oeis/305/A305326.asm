...
; Formula: a(n) = (b(4*n)/(c(4*n)/(10^n)))%10, b(n) = 2*b(n-1)+2*c(n-1)+b(n-1)+d(n-1), b(2) = 34, b(1) = 8, b(0) = 2, c(n) = 2*c(n-1)+b(n-1), c(2) = 16, c(1) = 4, c(0) = 1, d(n) = b(n-1)+d(n-1), d(2) = 10, d(1) = 2, d(0) = 0

...
; Formula: a(n) = f(n)/2+1, b(n) = 2*d(n-1)-c(n-1)+e(n-1)-1, b(4) = -2, b(3) = 3, b(2) = -1, b(1) = 0, b(0) = 0, c(n) = -c(n-1)+e(n-1)-1, c(4) = -2, c(3) = 1, c(2) = -1, c(1) = 0, c(0) = -1, d(n) = -2*d(n-1)+c(n-1)+f(n-1)+1, d(4) = 6, d(3) = 0, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = b(n-1)+c(n-1)+e(n-1)+1, e(4) = 5, e(3) = 0, e(2) = 1, e(1) = 0, e(0) = 0, f(n) = 2*c(n-1)+2*f(n-1)+2, f(4) = 12, f(3) = 4, f(2) = 2, f(1) = 0, f(0) = 0

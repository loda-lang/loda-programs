...
; Formula: a(n) = d(n)/2+1, b(n) = 3*b(n-2)+2*c(n-3)+1, b(6) = -5, b(5) = 6, b(4) = -2, b(3) = 1, b(2) = -1, b(1) = 0, b(0) = -1, c(n) = -2*c(n-1)+b(n-1)+d(n-1)+1, c(4) = 6, c(3) = 0, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = 2*b(n-1)+2*d(n-1)+2, d(4) = 12, d(3) = 4, d(2) = 2, d(1) = 0, d(0) = 0

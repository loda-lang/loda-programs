...
; Formula: a(n) = truncate((2*binomial(floor((sqrtint(8*n)+1)/2),2)-2*n+floor((sqrtint(8*n)+1)/2))/gcd(4*n-4*binomial(floor((sqrtint(8*n)+1)/2),2),2*binomial(floor((sqrtint(8*n)+1)/2),2)-2*n+floor((sqrtint(8*n)+1)/2)))

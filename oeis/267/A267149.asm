...
lpb $1
  ...
  mov $0,$2
  sub $0,$1
  seq $0,267148 ; Number of ON (black) cells in the n-th iteration of the "Rule 105" elementary cellular automaton starting with a single ON (black) cell.
  mul $0,46913735177
  div $0,46913735171
  add $3,$0
lpe

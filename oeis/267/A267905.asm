...
; Formula: a(n) = e(n)/4+1, b(n) = max(2*d(n-1)+b(n-1),1), b(3) = 17, b(2) = 7, b(1) = 3, b(0) = 1, c(n) = max(c(n-1),b(n-1)+d(n-1)), c(3) = 12, c(2) = 5, c(1) = 2, c(0) = 1, d(n) = max(c(n-1),b(n-1)+d(n-1)), d(3) = 12, d(2) = 5, d(1) = 2, d(0) = 1, e(n) = 2*b(n-1)+2*e(n-1), e(3) = 50, e(2) = 18, e(1) = 6, e(0) = 2

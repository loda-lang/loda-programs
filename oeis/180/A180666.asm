...
; Formula: a(n) = 2*a(n-1)+b(n-1)+floor((((d(n-1)==0)+c(n-1))*(d(n-1)==0))/2), a(3) = 6, a(2) = 2, a(1) = 1, a(0) = 0, b(n) = 3*b(n-1)-b(n-2)+floor((((d(n-2)==0)+c(n-2))*(d(n-2)==0))/2), b(5) = 24, b(4) = 9, b(3) = 3, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = (d(n-1)==0)+c(n-1), c(3) = 3, c(2) = 2, c(1) = 2, c(0) = 1, d(n) = floor((((d(n-1)==0)+c(n-1))*(d(n-1)==0))/2), d(3) = 1, d(2) = 0, d(1) = 1, d(0) = 0

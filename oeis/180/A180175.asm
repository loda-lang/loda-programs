...
; Formula: a(n) = b(n+1), b(n) = c(n-1)+d(n-1), b(3) = 101, b(2) = 10, b(1) = 1, b(0) = 0, c(n) = c(n-1)+c(n-2)+d(n-2), c(4) = 112, c(3) = 11, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = 10*d(n-1), d(3) = 1000, d(2) = 100, d(1) = 10, d(0) = 1

...
; Formula: a(n) = f(n+2), b(n) = d(n-4), b(9) = 3, b(8) = 2, b(7) = 2, b(6) = 1, b(5) = 0, b(4) = 0, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = d(n-2), c(8) = 5, c(7) = 3, c(6) = 2, c(5) = 2, c(4) = 1, c(3) = 0, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = -d(n-9)+d(n-1)+d(n-3), d(13) = 64, d(12) = 44, d(11) = 31, d(10) = 22, d(9) = 15, d(8) = 10, d(7) = 7, d(6) = 5, d(5) = 3, d(4) = 2, d(3) = 2, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = -d(n-1)-e(n-1)+b(n-2)+d(n-7)+2, e(11) = -9, e(10) = -6, e(9) = -3, e(8) = -2, e(7) = -2, e(6) = -1, e(5) = 0, e(4) = 0, e(3) = 0, e(2) = 1, e(1) = 1, e(0) = 0, f(n) = b(n-1)+c(n-1)+e(n-1), f(8) = 3, f(7) = 2, f(6) = 2, f(5) = 1, f(4) = 0, f(3) = 1, f(2) = 1, f(1) = 0, f(0) = 0

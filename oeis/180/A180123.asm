...
; Formula: a(n) = e(n+1), b(n) = (-c(n-1)+b(n-1))/2, b(3) = -273, b(2) = -34, b(1) = -4, b(0) = 0, c(n) = 2*gcd((-c(n-1)+b(n-1))/2+(d(n-1)/2)*((-c(n-1)+b(n-1))/2),4)*c(n-1), c(3) = 2048, c(2) = 512, c(1) = 64, c(0) = 8, d(n) = gcd((-c(n-1)+b(n-1))/2+(d(n-1)/2)*((-c(n-1)+b(n-1))/2),4)/2, d(3) = 1, d(2) = 2, d(1) = 2, d(0) = 0, e(n) = d(n-1)+e(n-1)+2, e(3) = 10, e(2) = 6, e(1) = 2, e(0) = 0

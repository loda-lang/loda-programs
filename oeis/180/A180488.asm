...
; Formula: a(n) = truncate(b(n)/2), b(n) = 3*b(n-2)+b(n-1)+b(n-3)+c(n-2), b(4) = 47, b(3) = 19, b(2) = 7, b(1) = 3, b(0) = 1, c(n) = 2*d(n-1)+c(n-1), c(3) = 10, c(2) = 4, c(1) = 2, c(0) = 0, d(n) = 3*d(n-2)+c(n-3)+d(n-1)+d(n-3), d(5) = 47, d(4) = 19, d(3) = 7, d(2) = 3, d(1) = 1, d(0) = 1

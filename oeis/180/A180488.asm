...
; Formula: a(n) = truncate(b(n+2)/2), b(n) = c(n-2), b(5) = 18, b(4) = 6, b(3) = 2, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = 2*c(n-1)+2*c(n-2)-2*c(n-3)+c(n-4)+2, c(6) = 304, c(5) = 120, c(4) = 46, c(3) = 18, c(2) = 6, c(1) = 2, c(0) = 0

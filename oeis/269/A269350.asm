...
; Formula: a(n) = d(n+1)%10, b(n) = (-c(n-1)+b(n-1))/2, b(2) = -1, b(1) = 0, b(0) = 3, c(n) = c(n-1)*(((-c(n-1)+b(n-1))/2+d(n-1))%2+2)^7, c(2) = 256, c(1) = 2, c(0) = 2, d(n) = (((-c(n-1)+b(n-1))/2+d(n-1))%2+2)^7, d(2) = 128, d(1) = 1, d(0) = -1

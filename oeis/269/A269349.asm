...
; Formula: a(n) = 6*(d(n+1)/64)+1, b(n) = (-c(n-1)+b(n-1))/2, b(2) = -1, b(1) = -1, b(0) = 0, c(n) = c(n-1)*gcd(((-c(n-1)+b(n-1))/2+d(n-1))%2,4)^3, c(2) = 128, c(1) = 2, c(0) = 2, d(n) = gcd(((-c(n-1)+b(n-1))/2+d(n-1))%2,4)^3, d(2) = 64, d(1) = 1, d(0) = 0

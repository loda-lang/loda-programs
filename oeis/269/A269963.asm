...
; Formula: a(n) = b(n)+1, b(n) = 2*b(n-1)+d(n-1)+1, b(4) = 36, b(3) = 15, b(2) = 6, b(1) = 1, b(0) = 0, c(n) = 2*truncate((2*b(n-1)+2*e(n-1)+3)/2)+2*truncate((d(n-1)+1)/2), c(4) = 58, c(3) = 22, c(2) = 10, c(1) = 2, c(0) = 2, d(n) = -d(n-1)-2*b(n-1)+c(n-1)+f(n-1)+1, d(4) = 8, d(3) = 5, d(2) = 2, d(1) = 3, d(0) = 0, e(n) = truncate((2*b(n-1)+2*e(n-1)+3)/2), e(4) = 26, e(3) = 10, e(2) = 3, e(1) = 1, e(0) = 0, f(n) = c(n-1)+f(n-1)+2, f(4) = 44, f(3) = 20, f(2) = 8, f(1) = 4, f(0) = 0

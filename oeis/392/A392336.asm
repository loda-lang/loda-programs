...
; Formula: a(n) = truncate((4*min(n,n%2)*(6*b(n)+2*c(n)-2)+8*truncate((3*b(n))/3)-6)/4)+3, b(n) = 20*b(n-2)+4*c(n-2), b(3) = 12, b(2) = 12, b(1) = 1, b(0) = 1, c(n) = 16*b(n-2)+4*c(n-2), c(3) = 8, c(2) = 8, c(1) = -2, c(0) = -2

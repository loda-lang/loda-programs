...
; Formula: a(n) = b(n+3), b(n) = b(n-1)+c(n-1)+d(n-1)+e(n-1)+f(n-1), b(4) = 108, b(3) = 32, b(2) = 10, b(1) = 3, b(0) = 2, c(n) = 3*c(n-1)+e(n-2)+e(n-3), c(7) = 1698, c(6) = 510, c(5) = 154, c(4) = 46, c(3) = 14, c(2) = 4, c(1) = 1, c(0) = 0, d(n) = 2*d(n-1)+2*e(n-1), d(7) = 2108, d(6) = 644, d(5) = 188, d(4) = 60, d(3) = 16, d(2) = 6, d(1) = 1, d(0) = 0, e(n) = 5*e(n-2)+2*e(n-1)-2*e(n-3), e(7) = 1422, e(6) = 410, e(5) = 134, e(4) = 34, e(3) = 14, e(2) = 2, e(1) = 2, e(0) = 0, f(n) = b(n-1)+c(n-1)+d(n-1)+e(n-1)+f(n-1), f(4) = 108, f(3) = 32, f(2) = 10, f(1) = 3, f(0) = 1

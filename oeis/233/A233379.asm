...
; Formula: a(n) = 13*(d(2*n+1)-3)^2-65, b(n) = c(n-1)+d(n-1), b(2) = 36, b(1) = 1, b(0) = 0, c(n) = 18*c(n-1)+18*d(n-1), c(2) = 648, c(1) = 18, c(0) = 0, d(n) = 18*c(n-1)+18*d(n-1)+b(n-1), d(2) = 649, d(1) = 18, d(0) = 1

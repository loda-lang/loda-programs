...
; Formula: a(n) = a(n-10)+truncate((-9*(max(n-10,0)+4)*(max(n-10,0)%2)+(max(n-10,0)+7)*(max(n-10,0)+4)^2+32)/144), a(9) = 0, a(8) = 0, a(7) = 0, a(6) = 0, a(5) = 0, a(4) = 0, a(3) = 0, a(2) = 0, a(1) = 0, a(0) = 0

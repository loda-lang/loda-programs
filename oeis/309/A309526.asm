...
; Formula: a(n) = b(n)/gcd(c(n),b(n)), b(n) = 6*b(n-1)+d(n-1), b(2) = 60, b(1) = 8, b(0) = 1, c(n) = max(2*c(n-1)*b(n-1),1), c(2) = 32, c(1) = 2, c(0) = 1, d(n) = 12*b(n-1)+2*d(n-1)-4*b(n-1), d(2) = 88, d(1) = 12, d(0) = 2

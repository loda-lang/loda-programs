...
; Formula: a(n) = floor(if((-binomial(floor((sqrtint(8*n)+1)/2),2)+n)<=(-1),0,3^(-binomial(floor((sqrtint(8*n)+1)/2),2)+n))/2)*if((-n+binomial(floor((sqrtint(8*n)+1)/2),2)+floor((sqrtint(8*n)+1)/2))<=(-1),0,3^(-n+binomial(floor((sqrtint(8*n)+1)/2),2)+floor((sqrtint(8*n)+1)/2)))

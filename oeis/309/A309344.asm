...
; 1,1,1,2,2,4,36,74
; Formula: a(n) = truncate(f(n-1)/2)+1, b(n) = b(n-1)+c(n-1)+d(n-1)+e(n-1), b(6) = 272, b(5) = 184, b(4) = 108, b(3) = 38, b(2) = 4, b(1) = 2, b(0) = 1, c(n) = 4*d(n-3)+2*d(n-2)-2*c(n-2)+32, c(7) = 370, c(6) = 166, c(5) = -26, c(4) = -26, c(3) = 34, c(2) = 32, c(1) = 0, c(0) = 1, d(n) = -d(n-1)+b(n-1), d(6) = 111, d(5) = 73, d(4) = 35, d(3) = 3, d(2) = 1, d(1) = 1, d(0) = 0, e(n) = c(n-1)+e(n-1), e(6) = 15, e(5) = 41, e(4) = 67, e(3) = 33, e(2) = 1, e(1) = 1, e(0) = 0, f(n) = 2*d(n-2), f(6) = 70, f(5) = 6, f(4) = 2, f(3) = 2, f(2) = 0, f(1) = 0, f(0) = 0

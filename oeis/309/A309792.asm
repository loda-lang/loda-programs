...
; Formula: a(n) = d(n+2)/2+2, b(n) = 4*c(n-2), b(5) = 4, b(4) = 4, b(3) = 8, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = b(n-2)+1, c(5) = 9, c(4) = 1, c(3) = 1, c(2) = 1, c(1) = 2, c(0) = 0, d(n) = 6*c(n-2)+b(n-2)+1, d(5) = 15, d(4) = 7, d(3) = 13, d(2) = 1, d(1) = 2, d(0) = 0

...
; Formula: a(n) = -c(n)+b(n), b(n) = 7*b(n-1), b(3) = 343, b(2) = 49, b(1) = 7, b(0) = 1, c(n) = (d(n-1)+binomial(e(n-1)+2,3)+4)%(7*b(n-1))+1, c(3) = 236, c(2) = 40, c(1) = 5, c(0) = 1, d(n) = (d(n-1)+binomial(e(n-1)+2,3)+4)%(7*b(n-1)), d(3) = 235, d(2) = 39, d(1) = 4, d(0) = 0, e(n) = ((d(n-1)+binomial(e(n-1)+2,3)+4)%(7*b(n-1))+1)^5, e(3) = 732082482176, e(2) = 102400000, e(1) = 3125, e(0) = 0

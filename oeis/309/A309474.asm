...
; Formula: a(n) = c(n+1), b(n) = 2*b(n-1)+b(n-1), b(2) = 18, b(1) = 6, b(0) = 2, c(n) = ((d(n-1)^3+5)%(2*b(n-1)+b(n-1)))/b(n-1), c(2) = 2, c(1) = 1, c(0) = 0, d(n) = (d(n-1)^3+5)%(2*b(n-1)+b(n-1))+1, d(2) = 15, d(1) = 3, d(0) = 3

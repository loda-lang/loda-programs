...
; Formula: a(n) = (d(n-1)^5+c(n-1)+2)%(7*b(n-1))+1, a(3) = 339, a(2) = 45, a(1) = 3, a(0) = 0, b(n) = 7*b(n-1), b(3) = 343, b(2) = 49, b(1) = 7, b(0) = 1, c(n) = (d(n-1)^5+c(n-1)+2)%(7*b(n-1))-7, c(3) = 331, c(2) = 37, c(1) = -5, c(0) = -1, d(n) = (d(n-1)^5+c(n-1)+2)%(7*b(n-1))+1, d(3) = 339, d(2) = 45, d(1) = 3, d(0) = 1

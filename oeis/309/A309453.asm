...
; Formula: a(n) = b(n-1)^5-7*truncate((b(n-1)^5+b(n-1)-6)/(7*7^(n-1)))*7^(n-1)+b(n-1)-5, a(4) = 1368, a(3) = 339, a(2) = 45, a(1) = 3, a(0) = 0, b(n) = b(n-1)^5-7*truncate((b(n-1)^5+b(n-1)-6)/(7*7^(n-1)))*7^(n-1)+b(n-1)-5, b(4) = 1368, b(3) = 339, b(2) = 45, b(1) = 3, b(0) = 1

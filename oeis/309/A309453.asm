...
; Formula: a(n) = (c(n-1)^5+c(n-1)-6)%(7*b(n-1))+1, a(4) = 1368, a(3) = 339, a(2) = 45, a(1) = 3, a(0) = 0, b(n) = 7*b(n-1), b(3) = 343, b(2) = 49, b(1) = 7, b(0) = 1, c(n) = (c(n-1)^5+c(n-1)-6)%(7*b(n-1))+1, c(4) = 1368, c(3) = 339, c(2) = 45, c(1) = 3, c(0) = 1

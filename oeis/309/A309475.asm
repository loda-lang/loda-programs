...
; Formula: a(n) = c(n+1), b(n) = 3*b(n-1), b(2) = 18, b(1) = 6, b(0) = 2, c(n) = truncate((d(n-1)^3-3*truncate((d(n-1)^3+5)/(3*b(n-1)))*b(n-1)+5)/b(n-1)), c(2) = 0, c(1) = 2, c(0) = 0, d(n) = d(n-1)^3-3*truncate((d(n-1)^3+5)/(3*b(n-1)))*b(n-1)+6, d(2) = 5, d(1) = 5, d(0) = -1

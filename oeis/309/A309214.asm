...
; Formula: a(n) = -c(n-1)+b(n-1)+d(n-1)+1, a(4) = 0, a(3) = -4, a(2) = -1, a(1) = 1, a(0) = 0, b(n) = -b(n-4)-2*b(n-2)-2, b(5) = 1, b(4) = 5, b(3) = -2, b(2) = -4, b(1) = 1, b(0) = 0, c(n) = 1, c(4) = 1, c(3) = 1, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = -d(n-2), d(4) = 0, d(3) = 2, d(2) = 0, d(1) = -2, d(0) = 0

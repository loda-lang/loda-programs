...
; Formula: a(n) = c(n+1), b(n) = 4*d(n-3)+3*b(n-3)+b(n-2), b(4) = 9, b(3) = 4, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = b(n-1)+d(n-1), c(4) = 8, c(3) = 4, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = b(n-1)+d(n-1), d(4) = 8, d(3) = 4, d(2) = 2, d(1) = 1, d(0) = 0

...
; Formula: a(n) = a(n-1)+b(n-1)+c(n-1)+d(n-1), a(3) = 1, a(2) = 2, a(1) = 1, a(0) = 0, b(n) = -c(n-1)+b(n-1), b(3) = -2, b(2) = -2, b(1) = -1, b(0) = 0, c(n) = b(n-1)+c(n-1), c(3) = -2, c(2) = 0, c(1) = 1, c(0) = 1, d(n) = b(n-1)+c(n-1)+d(n-1), d(3) = -1, d(2) = 1, d(1) = 1, d(0) = 0

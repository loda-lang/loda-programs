...
; Formula: a(n) = ((c(n-1)+24)^6+c(n-1)+7)%(5*b(n-1))+1, a(4) = 559, a(3) = 59, a(2) = 9, a(1) = 4, a(0) = 0, b(n) = 5*b(n-1), b(3) = 125, b(2) = 25, b(1) = 5, b(0) = 1, c(n) = ((c(n-1)+24)^6+c(n-1)+7)%(5*b(n-1))-23, c(4) = 535, c(3) = 35, c(2) = -15, c(1) = -20, c(0) = 0

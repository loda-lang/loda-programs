...
; Formula: a(n) = -b(n)-d(n)+e(n)+f(n)+1, b(n) = b(n-1)+d(n-1), b(4) = -40, b(3) = -14, b(2) = -9, b(1) = 0, b(0) = 0, c(n) = d(n-1), c(4) = -26, c(3) = -5, c(2) = -9, c(1) = 0, c(0) = -3, d(n) = 2*c(n-1)+2*e(n-1)-b(n-1)-f(n-1)+d(n-1)+1, d(4) = -23, d(3) = -26, d(2) = -5, d(1) = -9, d(0) = 0, e(n) = c(n-1)+d(n-1), e(4) = -31, e(3) = -14, e(2) = -9, e(1) = -3, e(0) = -2, f(n) = 2*c(n-1)+2*e(n-1)-b(n-1)-f(n-1)+d(n-1)+1, f(4) = -23, f(3) = -26, f(2) = -5, f(1) = -9, f(0) = 0

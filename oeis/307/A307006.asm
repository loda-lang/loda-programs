...
; Formula: a(n) = b(n)+1, b(n) = c(n-1), b(4) = 129, b(3) = 19, b(2) = 3, b(1) = 0, b(0) = 0, c(n) = n*(n+1)*(c(n-2)+1)+(n+1)*(c(n-1)+1)+d(n-1)*c(n-3)+1, c(4) = 1051, c(3) = 129, c(2) = 19, c(1) = 3, c(0) = 0, d(n) = d(n-1)

...
; 1,1,1,1,3,1,5,1,1,3,9,1,11,5,3,1,15,1,17,3,5,9,21,1,3,11,1,5,27,3,29,1,9,15,5,1,35,17,11,3,39,5,41,9,3,21,45,1,5,3,15,11,51,1,27,5,17,27,57,3,59,29,5,1,11,9,65,15,21,5,69,1,71,35,3,17,3,11,77,3
; Formula: a(n) = truncate(A184997(n+1)/gcd(A184997(n+1),A002322(n+1)))

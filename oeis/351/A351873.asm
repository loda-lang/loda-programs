...
; Formula: a(n) = e(n+1)+1, b(n) = d(n-1), b(6) = 3, b(5) = 1, b(4) = 0, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = b(n-1)+1, c(6) = 2, c(5) = 1, c(4) = 1, c(3) = 1, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = e(n-2), d(6) = 7, d(5) = 3, d(4) = 1, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = 2*c(n-3)+b(n-3)+d(n-3)+e(n-1)+2, e(6) = 15, e(5) = 11, e(4) = 7, e(3) = 3, e(2) = 1, e(1) = 0, e(0) = 0

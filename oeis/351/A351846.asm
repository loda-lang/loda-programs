...
; Formula: a(n) = truncate((-b(n+1)-2)/(-2)), b(n) = b(n-1)+gcd(truncate(d(n-2)/2),2)-1, b(3) = 0, b(2) = 0, b(1) = -1, b(0) = 0, c(n) = gcd(truncate(d(n-1)/2),2)*c(n-1), c(3) = 8, c(2) = 4, c(1) = 4, c(0) = 2, d(n) = c(n-1)+truncate(d(n-1)/2), d(3) = 6, d(2) = 5, d(1) = 2, d(0) = 0

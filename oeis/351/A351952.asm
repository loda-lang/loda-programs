...
; Formula: a(n) = truncate(A003415(A181819(A181811(truncate((A057335(A277012(n))-1)/A293810(A057335(A277012(n))))+1)*(truncate((A057335(A277012(n))-1)/A293810(A057335(A277012(n))))+1)))/A003557(A181819(A181811(truncate((A057335(A277012(n))-1)/A293810(A057335(A277012(n))))+1)*(truncate((A057335(A277012(n))-1)/A293810(A057335(A277012(n))))+1))))

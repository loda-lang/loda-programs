...
; 0,0,0,1,0,2,0,1,1,1,1,2,0,2,2,1,2,2,0,3,3,1,3,2,0,4,4,1,4,2,0,1,1,1,1,2,1,1,1,1,1,2,1,2,2,1,2,2,1,3,3,1,3,2,1,4,4,1,4,2,0,2,2,1,2,2,2,1,1,1,1,2,2,2,2,1,2,2,2,3
; Formula: a(n) = A351563(A276086(n)-1)

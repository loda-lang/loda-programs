...
lpb $2
  mov $3,$1
  seq $3,351956 ; a(n) = 1 if either n = 1 or the primorial inflation of n is equal to k * p#, where p# is the primorial (A034386) of some prime p, and 1 <= k < p, otherwise 0.
  sub $0,$3
  add $1,1
  mov $4,$0
  max $4,0

...
; Formula: a(n) = truncate(truncate((c(n)+d(n)-7)/gcd(d(n),b(n)))/2)+2, b(n) = 8*b(n-1)*2^(n-1), b(3) = 8192, b(2) = 256, b(1) = 16, b(0) = 2, c(n) = c(n-1), c(3) = 0, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 4*d(n-1)*2^(n-1)+b(n-1), d(3) = 768, d(2) = 32, d(1) = 2, d(0) = 0

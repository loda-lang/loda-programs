...
; Formula: a(n) = truncate(truncate((d(n+1)+e(n+1)-7)/gcd(e(n+1),c(n+1)))/2)+2, b(n) = 2*b(n-1), b(3) = 32, b(2) = 16, b(1) = 8, b(0) = 4, c(n) = 2*c(n-1)*b(n-1), c(3) = 8192, c(2) = 256, c(1) = 16, c(0) = 2, d(n) = d(n-1), d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = e(n-1)*b(n-1)+c(n-1), e(3) = 768, e(2) = 32, e(1) = 2, e(0) = 0

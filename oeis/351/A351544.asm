...
; 1,3,1,1,1,3,1,3,1,9,1,1,1,3,1,1,1,3,1,21,1,9,1,15,1,3,5,1,1,9,1,9,1,27,1,1,1,3,1,9,1,3,1,3,1,9,1,1,1,3,1,1,1,15,1,3,5,9,1,21,1,3,1,1,7,9,1,9,1,9,1,15,1,3,1,1,1,3,1,3
; Formula: a(n) = gcd(A003961(n+1)^40,A000203(n+1))

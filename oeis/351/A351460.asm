...
; Formula: a(n) = truncate(truncate((b(n+1)+c(n+1)-7)/gcd(c(n+1),d(n+1)))/2)+2, b(n) = b(n-1), b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = e(n-1)*c(n-1)+d(n-1), c(3) = 768, c(2) = 32, c(1) = 2, c(0) = 0, d(n) = 2*e(n-1)*d(n-1), d(3) = 8192, d(2) = 256, d(1) = 16, d(0) = 2, e(n) = 2*e(n-1), e(3) = 32, e(2) = 16, e(1) = 8, e(0) = 4

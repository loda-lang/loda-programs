; A351083: a(n) = gcd(n, A003415(A276086(n))), where A003415 is the arithmetic derivative and A276086 converts the primorial base expansion of n into its prime product form.

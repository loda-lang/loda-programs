...
; Submitted by Skillz
; 0,1,1,1,1,2,1,1,1,2,1,3,1,2,2,1,1,3,1,3,2,2,1,4,1,2,1,3,1,3,1,1,2,2,2,5,1,2,2,4,1,3,1,3,3,2,1,5,1,3,2,3,1,4,2,4,2,2,1,6,1,2,3,1,2,3,1,3,2,3,1,7,1,2,3,3,2,3,1,5
; Formula: a(n) = -A351418(n)+A000005(n+1)

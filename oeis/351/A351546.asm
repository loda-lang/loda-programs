; A351546: a(n) is the largest unitary divisor of sigma(n) such that none of its prime factors divide A003961(n), where A003961 is fully multiplicative with a(p) = nextprime(p), and sigma is the sum of divisors function.

...
; Formula: a(n) = d(n)+1, b(n) = b(n-2)+c(n-2)+e(n-2), b(4) = 6, b(3) = 4, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = -c(n-2)+2, c(4) = 1, c(3) = -1, c(2) = 1, c(1) = 3, c(0) = 1, d(n) = b(n-1)+c(n-1)+e(n-1), d(4) = 9, d(3) = 6, d(2) = 4, d(1) = 1, d(0) = 0, e(n) = b(n-1)+c(n-1)+e(n-1), e(4) = 9, e(3) = 6, e(2) = 4, e(1) = 1, e(0) = 0

...
; Formula: a(n) = c(n)/2, b(n) = 5*d(n-1)+b(n-1)+c(n-1), b(3) = 567, b(2) = 67, b(1) = 7, b(0) = 0, c(n) = 10*d(n-1), c(3) = 800, c(2) = 100, c(1) = 10, c(0) = 2, d(n) = 25*d(n-2)+5*d(n-1)-b(n-2)-c(n-2)+b(n-1), d(3) = 700, d(2) = 80, d(1) = 10, d(0) = 1

...
; Formula: a(n) = truncate(c(n)/2), b(n) = 5*e(n-1)+b(n-1)+c(n-1), b(3) = 567, b(2) = 67, b(1) = 7, b(0) = 0, c(n) = 10*e(n-1), c(3) = 800, c(2) = 100, c(1) = 10, c(0) = 2, d(n) = -5*e(n-1)+b(n-1)+c(n-1)+1, d(3) = -232, d(2) = -32, d(1) = -2, d(0) = 0, e(n) = 5*e(n-1)+2*c(n-1)-d(n-1)+b(n-1)+1, e(3) = 700, e(2) = 80, e(1) = 10, e(0) = 1

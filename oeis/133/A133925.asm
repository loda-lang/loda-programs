...
; Formula: a(n) = b(n+2), b(n) = -b(n-1)+c(n-4)+2, b(5) = 1, b(4) = 1, b(3) = 1, b(2) = 0, b(1) = 2, b(0) = 0, c(n) = -c(n-1)+c(n-3)+c(n-4)+c(n-5)+2, c(8) = 2, c(7) = 3, c(6) = 1, c(5) = 2, c(4) = 1, c(3) = 0, c(2) = 1, c(1) = 0, c(0) = 0

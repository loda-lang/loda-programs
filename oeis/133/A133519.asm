...
; Formula: a(n) = (max(A006005(n)-2,0)+2)^4-A151799((max(A006005(n)-2,0)+2)^4-3)-10*truncate(((max(A006005(n)-2,0)+2)^4-A151799((max(A006005(n)-2,0)+2)^4-3)+A194899(0)-4)/10)+A194899(0)-4

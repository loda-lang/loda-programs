...
; Formula: a(n) = -10*truncate(truncate((floor((10^(n+3)+sqrtint(5*(10^(n+3))^2))/2)+A011543(n+3)+A011545(n+3))/30000)/10)+truncate((floor((10^(n+3)+sqrtint(5*(10^(n+3))^2))/2)+A011543(n+3)+A011545(n+3))/30000)

...
; Formula: a(n) = e(n-1), b(n) = b(n-1)+d(n-1), b(4) = 6, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = 3*c(n-2)-c(n-4), c(7) = 5, c(6) = 8, c(5) = 2, c(4) = 3, c(3) = 1, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = 3*d(n-2)-d(n-4), d(6) = 5, d(5) = 8, d(4) = 2, d(3) = 3, d(2) = 1, d(1) = 1, d(0) = 1, e(n) = 2*d(n-1)+b(n-1)+c(n-1), e(4) = 10, e(3) = 5, e(2) = 4, e(1) = 2, e(0) = 1

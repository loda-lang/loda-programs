...
; 0,0,0,1,0,1,1,0,1,2,1,1,2,1,1,4,1,2,3,1,3,3,2,4,3,2,3,5,2,5,5,0,5,6,3,5,5,3,4,8,4,4,6,5,5,7,6,4,7,6,5,9,5,7,8,4,7,10,7,5,10,5,5,16,5,6,11,5,9,11,8,8,10,8,8,13,7,11,12,4
; Formula: a(n) = truncate(A159780(A019299(n))/2)

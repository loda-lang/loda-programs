...
; Formula: a(n) = b(n+1), b(n) = b(n-10)+truncate(((truncate((2*n-2)/3)+truncate((-2*n+59969538)/4)-14992383)^2+truncate((2*n-2)/3)+truncate((-2*n+59969538)/4)-14992383)/2), b(9) = 3, b(8) = 1, b(7) = 3, b(6) = 1, b(5) = 1, b(4) = 1, b(3) = 1, b(2) = 0, b(1) = 1, b(0) = 0

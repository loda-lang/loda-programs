...
; Formula: a(n) = 2*binomial(truncate((sqrtint(8*max(n-1,0)+8)-1)/2),-binomial(truncate((sqrtint(8*max(n-1,0)+8)-1)/2)+1,2)+max(n-1,0)+1)+binomial(truncate((sqrtint(8*max(n-1,0)+8)-1)/2),-binomial(truncate((sqrtint(8*max(n-1,0)+8)-1)/2)+1,2)+max(n-1,0))

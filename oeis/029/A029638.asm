...
; Formula: a(n) = binomial(truncate((sqrtint(8*max(n-1,1))-1)/2)+1,-binomial(truncate((sqrtint(8*max(n-1,1))-1)/2)+1,2)+max(n-1,1))+binomial(truncate((sqrtint(8*max(n-1,1))-1)/2),-binomial(truncate((sqrtint(8*max(n-1,1))-1)/2)+1,2)+max(n-1,1)-1)

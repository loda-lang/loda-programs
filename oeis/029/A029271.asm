...
; Formula: a(n) = b(n+1), b(n) = b(n-11)+binomial(truncate((-n+59969537)/4)+truncate((n-1)/3)-14992382,2), b(10) = 1, b(9) = 1, b(8) = 1, b(7) = 1, b(6) = 0, b(5) = 1, b(4) = 1, b(3) = 0, b(2) = 0, b(1) = 1, b(0) = 0

...
; Formula: a(n) = a(n-1)*(b(n-1)+d(n-1))+c(n-1), a(3) = 61, a(2) = 11, a(1) = 3, a(0) = 1, b(n) = b(n-1)+b(n-2), b(3) = 5, b(2) = 3, b(1) = 2, b(0) = 1, c(n) = c(n-1)*(b(n-1)+d(n-1)), c(3) = 30, c(2) = 6, c(1) = 2, c(0) = 1, d(n) = b(n-1), d(3) = 3, d(2) = 2, d(1) = 1, d(0) = 1

...
; Formula: a(n) = e(n-1), b(n) = b(n-1)+b(n-2), b(3) = 5, b(2) = 3, b(1) = 2, b(0) = 1, c(n) = c(n-1)*(2*d(n-1)+d(n-2)), c(4) = 240, c(3) = 30, c(2) = 6, c(1) = 2, c(0) = 1, d(n) = d(n-1)+d(n-2), d(4) = 5, d(3) = 3, d(2) = 2, d(1) = 1, d(0) = 1, e(n) = e(n-1)*(b(n-1)+d(n-1))+c(n-1), e(3) = 61, e(2) = 11, e(1) = 3, e(0) = 1

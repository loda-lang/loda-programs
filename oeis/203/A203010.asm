...
; Formula: a(n) = e(n-1), b(n) = b(n-1)+b(n-2), b(3) = 7, b(2) = 4, b(1) = 3, b(0) = 1, c(n) = c(n-1)*(2*d(n-1)+d(n-2)), c(4) = 924, c(3) = 84, c(2) = 12, c(1) = 3, c(0) = 1, d(n) = d(n-1)+d(n-2), d(4) = 7, d(3) = 4, d(2) = 3, d(1) = 1, d(0) = 2, e(n) = e(n-1)*(b(n-1)+d(n-1))+c(n-1), e(3) = 145, e(2) = 19, e(1) = 4, e(0) = 1

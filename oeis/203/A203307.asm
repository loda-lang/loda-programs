...
; Formula: a(n) = (2*e(n+1)+b(n+1))/4, b(n) = b(n-1), b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = c(n-1)+d(n-1), c(3) = 7, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = 2*d(n-1), d(3) = 8, d(2) = 4, d(1) = 2, d(0) = 1, e(n) = 2*e(n-1)*d(n-1)*(c(n-1)+d(n-1)), e(3) = 1344, e(2) = 24, e(1) = 2, e(0) = 1

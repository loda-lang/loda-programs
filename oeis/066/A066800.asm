...
; 1,1,2,2,3,2,4,2,4,3,4,2,6,4,3,3,5,4,6,3,4,4,4,2,6,6,6,4,6,3,8,4,4,5,6,4,9,6,6,3,8,4,8,4,6,4,4,3,8,6,5,6,6,6,6,4,6,6,4,3,12,8,4,5,6,4,8,5,4,6,8,4,12,9,6,6,8,6,8,3
; Formula: a(n) = A000005(A002322(n+1)-1)

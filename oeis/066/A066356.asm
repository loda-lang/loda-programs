...
; Formula: a(n) = d(n-1), a(3) = 2, a(2) = 1, a(1) = 1, a(0) = 0, b(n) = b(n-1)+c(n-1), b(3) = 1, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = d(n-1)*b(n-1)-b(n-1)-c(n-1), c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = d(n-1)*b(n-1)+d(n-2)*(b(n-1)+c(n-1)), d(3) = 3, d(2) = 2, d(1) = 1, d(0) = 1

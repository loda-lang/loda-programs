...
; Formula: a(n) = b(n-2)*b(n-1), a(3) = 6, a(2) = 2, a(1) = 1, a(0) = 1, b(n) = b(n-1)+c(n-1), b(3) = 7, b(2) = 3, b(1) = 2, b(0) = 1, c(n) = b(n-3)*b(n-2)*(b(n-1)+c(n-1))+b(n-2)*b(n-1)^2-b(n-1)-c(n-1), c(4) = 307, c(3) = 25, c(2) = 4, c(1) = 1, c(0) = 1

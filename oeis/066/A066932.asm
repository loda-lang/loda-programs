...
; Formula: a(n) = c(n-1), b(n) = b(n-1)+d(n-1), b(3) = 7, b(2) = 3, b(1) = 2, b(0) = 1, c(n) = b(n-2)*b(n-1), c(3) = 6, c(2) = 2, c(1) = 1, c(0) = 1, d(n) = b(n-3)*b(n-2)*(b(n-1)+d(n-1))+b(n-2)*b(n-1)^2-b(n-1)-d(n-1), d(4) = 307, d(3) = 25, d(2) = 4, d(1) = 1, d(0) = 1

...
; Formula: a(n) = A000010(n)*if(gcd(A000010(n),A000010(n+1))==0,A000010(n+1),if((A000010(n+1)%gcd(A000010(n),A000010(n+1)))==0,A000010(n+1)/gcd(A000010(n),A000010(n+1)),A000010(n+1)))

...
; Formula: a(n) = -10*truncate(truncate((12*b(max(4*n-3,0))+d(max(4*n-3,0)))/truncate((6*b(max(4*n-3,0))-3*e(max(4*n-3,0)))/(10^(n-1))))/10)+truncate((12*b(max(4*n-3,0))+d(max(4*n-3,0)))/truncate((6*b(max(4*n-3,0))-3*e(max(4*n-3,0)))/(10^(n-1)))), b(n) = 6*b(n-1)-4*b(n-2), b(5) = 2848, b(4) = 544, b(3) = 104, b(2) = 20, b(1) = 4, b(0) = 1, c(n) = 4*b(n-1)+2*c(n-1), c(3) = 128, c(2) = 24, c(1) = 4, c(0) = 0, d(n) = b(n-1)+d(n-1), d(3) = 25, d(2) = 5, d(1) = 1, d(0) = 0, e(n) = -c(n-1)-2*b(n-1)+e(n-1), e(3) = -78, e(2) = -14, e(1) = -2, e(0) = 0

...
; Formula: a(n) = A124859(A181819(truncate((A057335(A341915(A335858(n)))-1)/A293810(A057335(A341915(A335858(n)))))+1)*A181811(A181819(truncate((A057335(A341915(A335858(n)))-1)/A293810(A057335(A341915(A335858(n)))))+1)))

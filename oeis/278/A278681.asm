...
; Formula: a(n) = truncate(b(n+2)/6), b(n) = 4*b(n-1)+3*e(n-1)+2*c(n-1)+2*d(n-1), b(3) = 96, b(2) = 18, b(1) = 3, b(0) = 0, c(n) = truncate((4*b(n-1))/2), c(3) = 36, c(2) = 6, c(1) = 0, c(0) = 0, d(n) = c(n-1), d(3) = 6, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = 2*e(n-1)+c(n-1)+d(n-1), e(3) = 14, e(2) = 4, e(1) = 2, e(0) = 1

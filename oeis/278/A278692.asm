...
; Formula: a(n) = b(n+2), b(n) = b(n-1)+c(n-1), b(4) = 49, b(3) = 14, b(2) = 4, b(1) = 1, b(0) = 0, c(n) = 2*c(n-1)+2*d(n-1)-c(n-2)-d(n-2)+b(n-2)+1, c(4) = 122, c(3) = 35, c(2) = 10, c(1) = 3, c(0) = 1, d(n) = 2*c(n-1)+b(n-1)+d(n-1), d(4) = 117, d(3) = 33, d(2) = 9, d(1) = 2, d(0) = 0

...
; Formula: a(n) = d(n)/2, b(n) = b(n-1)+c(n-1), b(3) = 36, b(2) = 12, b(1) = 4, b(0) = 1, c(n) = 2*b(n-1)+d(n-1), c(3) = 68, c(2) = 24, c(1) = 8, c(0) = 3, d(n) = 4*b(n-2)+2*c(n-2)+2*d(n-1)-b(n-2)-c(n-2)+d(n-2), d(3) = 124, d(2) = 44, d(1) = 16, d(0) = 6

...
; Formula: a(n) = d(n+1)/2, b(n) = b(n-1)+c(n-1), b(3) = 12, b(2) = 4, b(1) = 1, b(0) = 1, c(n) = 2*b(n-1)+d(n-1), c(3) = 24, c(2) = 8, c(1) = 3, c(0) = 0, d(n) = 2*b(n-1)+2*d(n-1)-c(n-2)+b(n-2)+d(n-2), d(3) = 44, d(2) = 16, d(1) = 6, d(0) = 1

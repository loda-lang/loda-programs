...
; Formula: a(n) = -d(2*n)+b(2*n), b(n) = b(n-1)+binomial(gcd(c(n-2),n),n), b(4) = 2, b(3) = 2, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = 2*c(n-1)-n-2, c(4) = -56, c(3) = -25, c(2) = -10, c(1) = -3, c(0) = 0, d(n) = 1, d(4) = 1, d(3) = 1, d(2) = 1, d(1) = 1, d(0) = 0

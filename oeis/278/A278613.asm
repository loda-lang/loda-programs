...
; Formula: a(n) = c(n+1)/2+1, b(n) = 4*c(n-2)+4*c(n-3)+2*b(n-3)-b(n-1)+16, b(5) = 180, b(4) = 68, b(3) = 24, b(2) = 8, b(1) = 2, b(0) = 0, c(n) = 2*c(n-1)+b(n-1)+4, c(4) = 108, c(3) = 40, c(2) = 14, c(1) = 4, c(0) = 0

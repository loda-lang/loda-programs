...
; Formula: a(n) = d(n)/2, b(n) = b(n-1)+b(n-2)+c(n-2), b(4) = 2, b(3) = 1, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = d(n-1), c(4) = 0, c(3) = 0, c(2) = 0, c(1) = 0, c(0) = 1, d(n) = 2*((b(n-1)+c(n-1)+e(n-1))/2), d(4) = 0, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = 2*((b(n-1)+c(n-1)+e(n-1))/2), e(4) = 0, e(3) = 0, e(2) = 0, e(1) = 0, e(0) = 0

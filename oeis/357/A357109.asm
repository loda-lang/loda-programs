...
; Formula: a(n) = ((d(4*n)+1)/(c(4*n)/(10^n)))%10, b(n) = 2*c(n-1)+2*d(n-1)+b(n-1)+20, b(2) = 110, b(1) = 22, b(0) = 0, c(n) = 3*c(n-1)+2*d(n-1)+b(n-1)+20, c(2) = 133, c(1) = 23, c(0) = 1, d(n) = c(n-1)+d(n-1)+10, d(2) = 44, d(1) = 11, d(0) = 0

...
; Formula: a(n) = truncate(c(3*n)/truncate(b(3*n)/(10^(n-1))))%10, b(n) = 2*b(n-1)+d(n-1), b(2) = -12, b(1) = -2, b(0) = 0, c(n) = 2*b(n-1)+c(n-1)+d(n-1), c(2) = -14, c(1) = -2, c(0) = 0, d(n) = 6*b(n-1)+4*d(n-1)+2*c(n-1), d(2) = -48, d(1) = -8, d(0) = -2

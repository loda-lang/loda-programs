...
; Formula: a(n) = (-c(n+1)+e(n+1))/3, b(n) = 8*b(n-1)+4*c(n-1)-8*d(n-1), b(4) = -11688, b(3) = -1144, b(2) = -108, b(1) = -8, b(0) = 1, c(n) = 3*b(n-1)+2*c(n-1)-3*d(n-1), c(4) = -4608, c(3) = -450, c(2) = -42, c(1) = -3, c(0) = 0, d(n) = 3*d(n-1)+3*d(n-2)-2*c(n-2)-4*b(n-2), d(6) = 83232, d(5) = 8254, d(4) = 834, d(3) = 92, d(2) = 14, d(1) = 4, d(0) = 2, e(n) = e(n-1), e(4) = 0, e(3) = 0, e(2) = 0, e(1) = 0, e(0) = 0

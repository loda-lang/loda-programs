...
; 1,2,2,4,2,4,2,8,8,4,2,4,2,4,8,16,2,10,2,16,8,4,2,16,7,4,26,16,2,4,2,32,8,4,18,28,2,4,8,16,2,22,2,16,17,4,2,16,30,24,8,16,2,28,43,32,8,4,2,16,2,4,8,64,32,64,2,16,8,44,2,64,2,4,68,16,18,64,2,16
; Formula: a(n) = 2^(n+1)-truncate((2^(n+1)-1)/(n+1))*(n+1)

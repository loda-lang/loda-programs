...
; Formula: a(n) = ((b(max(4*n-1,0))+1)/(c(max(4*n-1,0))/(10^n)+1))%10, b(n) = b(n-1)+c(n-1), b(2) = 2, b(1) = 1, b(0) = 1, c(n) = 6*c(n-1)+b(n-1)+c(n-1)+d(n-1), c(2) = 9, c(1) = 1, c(0) = 0, d(n) = 3*c(n-1)+b(n-1)+c(n-1)+d(n-1), d(2) = 6, d(1) = 1, d(0) = 0

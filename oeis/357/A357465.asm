...
; Formula: a(n) = (b(4*n+4)/(c(4*n+4)/(10^(n+1))))%10, b(n) = 3*b(n-1)+2*c(n-1)+d(n-1)+4, b(2) = 16, b(1) = 4, b(0) = 0, c(n) = 3*b(n-1)+2*c(n-1)+c(n-1)+d(n-1), c(2) = 12, c(1) = 0, c(0) = 0, d(n) = c(n-1)+d(n-1), d(2) = 0, d(1) = 0, d(0) = 0

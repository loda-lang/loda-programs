...
; Formula: a(n) = floor(b(n+183)/floor(c(n+183)/(10^(n+1))))%10, b(n) = 4*c(n-1)+2*b(n-1)+2*d(n-1), b(2) = 24, b(1) = 4, b(0) = 2, c(n) = 7*c(n-1)+2*d(n-2), c(3) = 196, c(2) = 28, c(1) = 4, c(0) = 0, d(n) = c(n-1)+d(n-1), d(2) = 4, d(1) = 0, d(0) = 0

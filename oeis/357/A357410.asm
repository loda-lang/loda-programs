...
; Formula: a(n) = truncate(c(n)/4), b(n) = b(n-1)*(2*d(n-1)+1)+2*b(n-1)+c(n-1), b(3) = 354, b(2) = 34, b(1) = 6, b(0) = 2, c(n) = 2*(2*d(n-1)+1)*((b(n-2)+c(n-2))*(2*d(n-2)+1)+2*b(n-1)+c(n-1))-2*(b(n-1)+c(n-1))*(2*d(n-1)+1), c(3) = 896, c(2) = 48, c(1) = 4, c(0) = 0, d(n) = 2*d(n-1)+1, d(3) = 7, d(2) = 3, d(1) = 1, d(0) = 0

...
; Formula: a(n) = a(n-1)*(-n-1)+b(n-1), a(3) = 6, a(2) = -1, a(1) = 1, a(0) = 0, b(n) = truncate((c(n-1)+1)/3)*b(n-1), b(3) = 0, b(2) = 2, b(1) = 2, b(0) = 1, c(n) = truncate((c(n-1)+1)/3), c(3) = 0, c(2) = 1, c(1) = 2, c(0) = 7

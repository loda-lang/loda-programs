...
; Formula: a(n) = (b(3*n+3)/(c(3*n+3)/(10^(n+1))))%10, b(n) = 8*b(n-1)-5*b(n-2)+b(n-3), b(4) = 807, b(3) = 110, b(2) = 15, b(1) = 2, b(0) = 0, c(n) = 4*c(n-1)+2*d(n-1)+b(n-1), c(2) = 28, c(1) = 4, c(0) = 1, d(n) = 5*c(n-1)+3*d(n-1)+2*b(n-1), d(2) = 39, d(1) = 5, d(0) = 0

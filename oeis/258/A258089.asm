...
; Formula: a(n) = 3*b(n-1)+3*b(n-2)-a(n-3)-c(n-1)+d(n-1)-2, a(4) = 20, a(3) = 3, a(2) = 2, a(1) = 1, a(0) = 0, b(n) = 3*b(n-1)-c(n-1)+a(n-1)+d(n-1)-2, b(4) = 21, b(3) = 5, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = a(n-1), c(4) = 3, c(3) = 2, c(2) = 1, c(1) = 0, c(0) = -2, d(n) = 3*b(n-1)-c(n-1)+a(n-1)+d(n-1), d(4) = 23, d(3) = 7, d(2) = 3, d(1) = 2, d(0) = 0

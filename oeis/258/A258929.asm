...
; Formula: a(n) = e(n+1), b(n) = 5*b(n-1), b(3) = 250, b(2) = 50, b(1) = 10, b(0) = 2, c(n) = ((2*c(n-1))^2+c(n-1)+4)%(5*b(n-1)), c(4) = 1068, c(3) = 68, c(2) = 18, c(1) = 8, c(0) = 0, d(n) = ((2*d(n-1)-2)^2+d(n-1)+3)%(5*b(n-1))+1, d(4) = 1069, d(3) = 69, d(2) = 19, d(1) = 9, d(0) = 5, e(n) = min(5*b(n-1)-(((2*c(n-1))^2+d(n-1)+3)%(5*b(n-1))),((2*c(n-1))^2+d(n-1)+3)%(5*b(n-1))), e(3) = 68, e(2) = 18, e(1) = 2, e(0) = 0

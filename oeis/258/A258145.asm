...
; 1,3,2,6,7,5,3,6,4,7,2,5,8,42,6,40,9,4,7,12,41,10,5,39,8,8,3,42,11,11,6,40,9,9,4,38,43,4,7,12,7,41,2,10,10,34,5,39,44,8,8,32,13,37,42,25,3,11,6,11,35,16,40,16,45,9,9,14,33,14,4,38,43,43,7,4,12,31,12,19
; Formula: a(n) = A286380(2*min(n,114)+1)+1

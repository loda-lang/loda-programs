...
; Formula: a(n) = (b(n+2)-4)/2, b(n) = -c(n-1)-d(n-1)+d(n-1), b(3) = 8, b(2) = 4, b(1) = 0, b(0) = 0, c(n) = 2*c(n-1)+2*d(n-1), c(3) = -16, c(2) = -8, c(1) = -4, c(0) = 0, d(n) = (8*c(n-3)+8*d(n-3)+4*d(n-2)+4*max(-c(n-3)-d(n-3)+d(n-2)+d(n-3),1)+2*d(n-1)-d(n-1)-2*d(n-1)-2*d(n-2)-4*c(n-3)-4*d(n-3)+d(n-1))/2, d(3) = -2, d(2) = 0, d(1) = 0, d(0) = -2

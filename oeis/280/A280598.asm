...
; Formula: a(n) = d(2*n)+2, b(n) = max(2*d(n-2)-d(n-3)+d(n-4)+e(n-3)+1,1)+2, b(7) = 54, b(6) = 32, b(5) = 19, b(4) = 11, b(3) = 6, b(2) = 3, b(1) = 2, b(0) = 1, c(n) = b(n-1), c(5) = 11, c(4) = 6, c(3) = 3, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = b(n-1)+d(n-1)+1, d(5) = 28, d(4) = 16, d(3) = 9, d(2) = 5, d(1) = 2, d(0) = 0, e(n) = -e(n-1)+c(n-1), e(5) = 4, e(4) = 2, e(3) = 1, e(2) = 1, e(1) = 0, e(0) = 0

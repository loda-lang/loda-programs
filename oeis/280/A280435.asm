...
; Formula: a(n) = e(n)+1, b(n) = b(n-1)+b(n-2)+2, b(5) = 22, b(4) = 13, b(3) = 7, b(2) = 4, b(1) = 1, b(0) = 1, c(n) = c(n-2)+d(n-2)+9, c(5) = 70, c(4) = 38, c(3) = 20, c(2) = 9, c(1) = 2, c(0) = 0, d(n) = b(n-1)+c(n-1)+d(n-1)+8, d(5) = 135, d(4) = 76, d(3) = 41, d(2) = 20, d(1) = 9, d(0) = 0, e(n) = b(n-1)+c(n-1)+d(n-1)+8, e(5) = 135, e(4) = 76, e(3) = 41, e(2) = 20, e(1) = 9, e(0) = 0

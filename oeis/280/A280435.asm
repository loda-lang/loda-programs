...
; Formula: a(n) = f(n)+1, b(n) = b(n-1)+b(n-2)+2, b(5) = 22, b(4) = 13, b(3) = 7, b(2) = 4, b(1) = 1, b(0) = 1, c(n) = e(n-1)+3, c(5) = 70, c(4) = 38, c(3) = 20, c(2) = 9, c(1) = 2, c(0) = 0, d(n) = b(n-1)+c(n-1)+d(n-1)+8, d(5) = 135, d(4) = 76, d(3) = 41, d(2) = 20, d(1) = 9, d(0) = 0, e(n) = c(n-1)+d(n-1)+6, e(5) = 120, e(4) = 67, e(3) = 35, e(2) = 17, e(1) = 6, e(0) = 0, f(n) = b(n-1)+c(n-1)+d(n-1)+8, f(5) = 135, f(4) = 76, f(3) = 41, f(2) = 20, f(1) = 9, f(0) = 0

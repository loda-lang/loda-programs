...
; Formula: a(n) = truncate(c(n)/2), b(n) = 2*d(n-1)-c(n-1)-2*e(n-1)+b(n-1)+8, b(3) = 50, b(2) = 16, b(1) = 8, b(0) = 0, c(n) = -c(n-1)-e(n-1)+d(n-1)+4, c(3) = 16, c(2) = 2, c(1) = 4, c(0) = 0, d(n) = 3*d(n-1)-c(n-1)-2*e(n-1)+b(n-1)+14, d(3) = 92, d(2) = 36, d(1) = 14, d(0) = 0, e(n) = 3*d(n-1)-c(n-1)-3*e(n-1)+b(n-1)+12, e(3) = 68, e(2) = 22, e(1) = 12, e(0) = 0

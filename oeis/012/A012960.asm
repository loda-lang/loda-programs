...
; Formula: a(n) = b(n)+c(n), b(n) = (b(n-1)==(-3))+n*c(n-1), b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = c(n-1)+d(n-1), c(3) = -1, c(2) = 1, c(1) = 1, c(0) = 1, d(n) = (((c(n-3)+d(n-3))*(n-1)^2+d(n-1))==(-3))-c(n-1)*n^2+n*c(n-1), d(4) = 12, d(3) = -6, d(2) = -2, d(1) = 0, d(0) = 0

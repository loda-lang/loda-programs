...
; Formula: a(n) = d(n)/4, b(n) = 4*c(n-2)+2*b(n-1), b(4) = 56, b(3) = 16, b(2) = 8, b(1) = 0, b(0) = 0, c(n) = 3*c(n-2), c(4) = 18, c(3) = 0, c(2) = 6, c(1) = 0, c(0) = 2, d(n) = b(n-1), d(4) = 16, d(3) = 8, d(2) = 0, d(1) = 0, d(0) = 0

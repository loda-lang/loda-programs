...
; Formula: a(n) = b(n+1), b(n) = -b(n-1)+b(n-2)+b(n-5)+c(n-1)+d(n-2)+d(n-3)+max(2*b(n-1)-b(n-2)-b(n-5)-d(n-2)-d(n-3)-2*c(n-1)-1,0)+1, b(7) = 22, b(6) = 10, b(5) = 7, b(4) = 3, b(3) = 2, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = b(n-1), c(5) = 3, c(4) = 2, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = 2*b(n-1)-c(n-1)+d(n-1), d(5) = 10, d(4) = 6, d(3) = 3, d(2) = 2, d(1) = 0, d(0) = 0

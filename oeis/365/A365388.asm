...
; Formula: a(n) = truncate(truncate((b(n)+c(n))/gcd(c(n),d(n)))/2)+1, b(n) = b(n-1), b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = e(n-1)*c(n-1)+d(n-1), c(3) = 256, c(2) = 24, c(1) = 4, c(0) = 1, d(n) = 2*e(n-1)*d(n-1), d(3) = 1024, d(2) = 64, d(1) = 8, d(0) = 2, e(n) = 2*e(n-1), e(3) = 16, e(2) = 8, e(1) = 4, e(0) = 2

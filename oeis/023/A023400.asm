...
; Formula: a(n) = e(n+1), b(n) = b(n-1)/2+5*c(n-2)*(7*((b(n-1)/2)%2)+2), b(3) = 248, b(2) = 46, b(1) = 2, b(0) = 0, c(n) = 5*c(n-1), c(3) = 125, c(2) = 25, c(1) = 5, c(0) = 1, d(n) = 0, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = 7*((b(n-1)/2+d(n-1))%2)+2, e(3) = 9, e(2) = 9, e(1) = 2, e(0) = 0

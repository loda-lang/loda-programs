...
; Formula: a(n) = 3*e(n+1), b(n) = b(n-1)/2+c(n-1)*((b(n-1)/2+d(n-1))%2+2), b(3) = 58, b(2) = 16, b(1) = 2, b(0) = 0, c(n) = 5*c(n-1), c(3) = 125, c(2) = 25, c(1) = 5, c(0) = 1, d(n) = 2*c(n-1)*((b(n-1)/2+d(n-1))%2+2), d(3) = 100, d(2) = 30, d(1) = 4, d(0) = 0, e(n) = (b(n-1)/2+d(n-1))%2+2, e(3) = 2, e(2) = 3, e(1) = 2, e(0) = 0

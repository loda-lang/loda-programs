...
; Formula: a(n) = truncate(d(n)/2)+2, b(n) = gcd(truncate((-c(n-1)+b(n-1))/2),4)*c(n-1)+truncate((-c(n-1)+b(n-1))/2), b(2) = 20, b(1) = 4, b(0) = 0, c(n) = 5*c(n-1), c(2) = 25, c(1) = 5, c(0) = 1, d(n) = gcd(truncate((-c(n-1)+b(n-1))/2),4), d(2) = 4, d(1) = 4, d(0) = 0

...
; Formula: a(n) = e(n+1), b(n) = b(n-1)/2+c(n-1)*((b(n-1)/2+c(n-1)+d(n-1))%2+3), b(3) = 86, b(2) = 22, b(1) = 4, b(0) = 0, c(n) = 5*c(n-1), c(3) = 125, c(2) = 25, c(1) = 5, c(0) = 1, d(n) = 2*c(n-1)*((b(n-1)/2+c(n-1)+d(n-1))%2+3), d(3) = 150, d(2) = 40, d(1) = 8, d(0) = 0, e(n) = (b(n-1)/2+c(n-1)+d(n-1))%2+3, e(3) = 3, e(2) = 4, e(1) = 4, e(0) = 0

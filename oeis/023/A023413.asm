...
; Formula: a(n) = 3*d(n+1)-7, b(n) = gcd(-2*truncate((c(n-1)+truncate(b(n-1)/2))/2)+c(n-1)+truncate(b(n-1)/2)+4,4)*c(n-1)+truncate(b(n-1)/2), b(2) = 5, b(1) = 1, b(0) = 0, c(n) = 5*c(n-1), c(2) = 25, c(1) = 5, c(0) = 1, d(n) = -2*truncate((c(n-1)+truncate(b(n-1)/2))/2)+c(n-1)+truncate(b(n-1)/2)+4, d(2) = 5, d(1) = 5, d(0) = 0

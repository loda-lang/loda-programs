...
; Formula: a(n) = 2*b(n-1)+c(n-1)+2, a(3) = 13, a(2) = 5, a(1) = 1, a(0) = 0, b(n) = b(n-1)+c(n-1)+2, b(3) = 9, b(2) = 4, b(1) = 1, b(0) = 0, c(n) = 2*c(n-1)-c(n-3)-a(n-2)+c(n-2)+a(n-3)+2, c(5) = 36, c(4) = 18, c(3) = 9, c(2) = 3, c(1) = 1, c(0) = -1

...
; Formula: a(n) = d(n+1), b(n) = b(n-1)+c(n-1)+2, b(3) = 9, b(2) = 4, b(1) = 1, b(0) = 0, c(n) = 2*c(n-1)-c(n-3)-d(n-2)+c(n-2)+d(n-3)+2, c(5) = 36, c(4) = 18, c(3) = 9, c(2) = 3, c(1) = 1, c(0) = -1, d(n) = 2*b(n-1)+c(n-1)+2, d(3) = 13, d(2) = 5, d(1) = 1, d(0) = 0

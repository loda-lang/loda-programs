...
; Formula: a(n) = e(n+1), b(n) = b(n-1)/2+c(n-1)*((b(n-1)/2+2*d(n-1)+c(n-1))%2+7), b(3) = 222, b(2) = 44, b(1) = 8, b(0) = 0, c(n) = 5*c(n-1), c(3) = 125, c(2) = 25, c(1) = 5, c(0) = 1, d(n) = c(n-1)*((b(n-1)/2+2*d(n-1)+c(n-1))%2+7), d(3) = 200, d(2) = 40, d(1) = 8, d(0) = 0, e(n) = (b(n-1)/2+2*d(n-1)+c(n-1))%2+7, e(3) = 8, e(2) = 8, e(1) = 8, e(0) = 0

...
; Formula: a(n) = e(n)/2, b(n) = b(n-1)/2+5*gcd(b(n-1)/2,4)*c(n-2), b(3) = 528, b(2) = 56, b(1) = 12, b(0) = 4, c(n) = 5*c(n-1), c(3) = 625, c(2) = 125, c(1) = 25, c(0) = 5, d(n) = 0, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = gcd(b(n-1)/2+d(n-1),4), e(3) = 4, e(2) = 2, e(1) = 2, e(0) = 4

...
; Formula: a(n) = 5*((b(n-1)/2+d(n-1))%2)+2, a(3) = 2, a(2) = 2, a(1) = 7, a(0) = 2, b(n) = b(n-1)/2+5*c(n-2)*(5*((b(n-1)/2)%2)+2), b(3) = 284, b(2) = 68, b(1) = 36, b(0) = 2, c(n) = 5*c(n-1), c(3) = 625, c(2) = 125, c(1) = 25, c(0) = 5, d(n) = 0, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0

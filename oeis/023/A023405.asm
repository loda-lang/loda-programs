...
; Formula: a(n) = e(n)+2, b(n) = c(n-1)*(5*truncate(b(n-1)/2)-10*truncate(truncate(b(n-1)/2)/2)+4)+truncate(b(n-1)/2), b(3) = 236, b(2) = 22, b(1) = 4, b(0) = 0, c(n) = 5*c(n-1), c(3) = 125, c(2) = 25, c(1) = 5, c(0) = 1, d(n) = 0, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = 5*d(n-1)+5*truncate(b(n-1)/2)-10*truncate((d(n-1)+truncate(b(n-1)/2))/2)+2, e(3) = 7, e(2) = 2, e(1) = 2, e(0) = 0

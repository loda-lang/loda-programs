...
; Formula: a(n) = e(n+1), b(n) = b(n-1)/2+c(n-1)*((b(n-1)/2+c(n-1)+d(n-1))%2+5), b(3) = 164, b(2) = 28, b(1) = 6, b(0) = 0, c(n) = 5*c(n-1), c(3) = 125, c(2) = 25, c(1) = 5, c(0) = 1, d(n) = 2*c(n-1)*((b(n-1)/2+c(n-1)+d(n-1))%2+5), d(3) = 300, d(2) = 50, d(1) = 12, d(0) = 0, e(n) = (b(n-1)/2+c(n-1)+d(n-1))%2+5, e(3) = 6, e(2) = 5, e(1) = 6, e(0) = 0

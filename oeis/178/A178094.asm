...
; Formula: a(n) = gcd(b(n),min(n,0))+1, b(n) = (d(n-1)*c(n-1)+c(n-1))%8-b(n-1)+b(n-1)-1, b(4) = 4, b(3) = 2, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = b(n-2)+1, c(4) = 2, c(3) = 1, c(2) = 1, c(1) = 1, c(0) = 1, d(n) = (d(n-1)*c(n-1)+c(n-1))%8+b(n-1), d(4) = 7, d(3) = 4, d(2) = 2, d(1) = 1, d(0) = 0

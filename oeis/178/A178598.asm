...
; Formula: a(n) = d(n+2)+1, b(n) = b(n-1)*(((n-1)^(n-1)-1)/b(n-1))+b(n-1), b(3) = 4, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = n, c(3) = 3, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = (c(n-1)^(n-1)-1)/b(n-1), d(3) = 3, d(2) = 0, d(1) = 0, d(0) = 0

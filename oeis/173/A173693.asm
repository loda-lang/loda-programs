...
; Formula: a(n) = truncate((b(n)+1)/2), b(n) = b(n-2)+c(n-2), b(4) = 1, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = c(n-1)+c(n-4)+c(n-7), c(8) = 3, c(7) = 2, c(6) = 1, c(5) = 1, c(4) = 1, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0

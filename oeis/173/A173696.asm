...
; Formula: a(n) = (d(n+2)-1)/2+1, b(n) = d(n-1), b(6) = 3, b(5) = 2, b(4) = 1, b(3) = 1, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = -d(n-1)+b(n-1), c(6) = -1, c(5) = -1, c(4) = 0, c(3) = -1, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = e(n-2)+f(n-2), d(6) = 4, d(5) = 3, d(4) = 2, d(3) = 1, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = e(n-1)+f(n-1), e(6) = 6, e(5) = 4, e(4) = 3, e(3) = 2, e(2) = 1, e(1) = 1, e(0) = 1, f(n) = -d(n-2)+b(n-2)+c(n-2)+e(n-2)+f(n-2), f(6) = 3, f(5) = 2, f(4) = 1, f(3) = 1, f(2) = 1, f(1) = 0, f(0) = 0

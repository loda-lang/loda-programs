...
; Formula: a(n) = max(c(max(n-1,0)),d(max(n-1,0))), b(n) = b(n-1)+d(n-1), b(3) = 4, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = 2*d(n-1), c(3) = 6, c(2) = 0, c(1) = 2, c(0) = 0, d(n) = 2*d(n-2)+b(n-2)+d(n-2), d(3) = 1, d(2) = 3, d(1) = 0, d(0) = 1

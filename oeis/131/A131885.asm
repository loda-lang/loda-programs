...
; Formula: a(n) = max(2*f(n)-1,0)+1, b(n) = b(n-1)+d(n-1), b(4) = 4, b(3) = 1, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = b(n-1), c(4) = 1, c(3) = 0, c(2) = 0, c(1) = 0, c(0) = 1, d(n) = 2*d(n-1)-d(n-2)+b(n-4)+d(n-4)+e(n-2), d(5) = 10, d(4) = 6, d(3) = 3, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = c(n-1)+e(n-1), e(4) = 1, e(3) = 1, e(2) = 1, e(1) = 1, e(0) = 0, f(n) = c(n-1)+e(n-1)+f(n-1), f(4) = 4, f(3) = 3, f(2) = 2, f(1) = 1, f(0) = 0

...
; Formula: a(n) = floor((sqrtint(8*n+8)-1)/2)*binomial(0,-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n)+binomial(0,binomial(-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n+1,floor((sqrtint(8*n+8)-1)/2)))+1

...
; Formula: a(n) = -binomial(truncate((sqrtint(8*n)-1)/2)+1,2)-2*truncate((-n+binomial(truncate((sqrtint(8*n)-1)/2)+1,2)+truncate((sqrtint(8*n)-1)/2)+1)/2)+truncate((sqrtint(8*n)-1)/2)+n

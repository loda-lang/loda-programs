...
; Formula: a(n) = -b(n-2)-c(n-2)+a(n-1)+a(n-2)+2, a(4) = 25, a(3) = 13, a(2) = 6, a(1) = 3, a(0) = 1, b(n) = b(n-2)+c(n-2)-2, b(4) = -6, b(3) = -4, b(2) = -2, b(1) = -2, b(0) = 0, c(n) = b(n-1)+c(n-1), c(4) = -8, c(3) = -4, c(2) = -2, c(1) = 0, c(0) = 0

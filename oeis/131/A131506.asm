...
; Formula: a(n) = 2*d(n+1)+5, b(n) = -b(n-1)+c(n-1)+truncate(b(n-1)/2), b(3) = 9, b(2) = 7, b(1) = 2, b(0) = 0, c(n) = gcd(truncate(b(n-1)/2),2)*(2*c(n-1)-2*b(n-1)+truncate(b(n-1)/2)), c(3) = 15, c(2) = 13, c(1) = 8, c(0) = 2, d(n) = d(n-1)+gcd(truncate(b(n-2)/2),2)-1, d(3) = 0, d(2) = 0, d(1) = -1, d(0) = 0

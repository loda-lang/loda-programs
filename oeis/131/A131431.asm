...
; Formula: a(n) = (((-n+binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2)+truncate((sqrtint(8*n+8)-1)/2))==0)+3*n-3*binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2))*((-n+binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2)+truncate((sqrtint(8*n+8)-1)/2))==0)

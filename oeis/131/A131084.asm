...
; Formula: a(n) = 2*binomial(floor((sqrtint(8*n)+1)/2)-2,-binomial(floor((sqrtint(8*n)+1)/2),2)+n-2)-binomial(floor((sqrtint(8*n)+1)/2)-3,-binomial(floor((sqrtint(8*n)+1)/2),2)+n-3)

...
; Formula: a(n) = 2*b(n-1)+c(n-1), a(3) = 14, a(2) = 6, a(1) = 3, a(0) = 1, b(n) = b(n-1)+c(n-1), b(3) = 11, b(2) = 3, b(1) = 3, b(0) = 0, c(n) = b(n-1)+d(n-1), c(3) = 8, c(2) = 8, c(1) = 0, c(0) = 3, d(n) = 2*d(n-2)-c(n-2)+b(n-1)+d(n-1), d(3) = 18, d(2) = 5, d(1) = 5, d(0) = 0

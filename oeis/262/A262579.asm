...
; Formula: a(n) = d(n+1), b(n) = 9*truncate(max(e(n-2),1)/b(n-1))*b(n-1)+b(n-1), b(4) = 10, b(3) = 10, b(2) = 10, b(1) = 1, b(0) = 1, c(n) = max(e(n-1),1), c(4) = 4, c(3) = 3, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = d(n-1)*(9*truncate(c(n-1)/b(n-1))*b(n-1)+b(n-1))+max(e(n-2),1), d(4) = 123, d(3) = 12, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = (max(e(n-2),1)==7)+max(e(n-1),1)+1, e(4) = 5, e(3) = 4, e(2) = 3, e(1) = 2, e(0) = 0

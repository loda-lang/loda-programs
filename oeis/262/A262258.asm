...
; Formula: a(n) = min(n-1,(n-1)%2)*c(n-1)+b(n-1), b(n) = c(n-2)*(d(n-2)+2), b(5) = 6, b(4) = 6, b(3) = 2, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = 2*c(n-2), c(5) = 4, c(4) = 4, c(3) = 2, c(2) = 2, c(1) = 1, c(0) = 1, d(n) = d(n-2)+1, d(5) = 2, d(4) = 2, d(3) = 1, d(2) = 1, d(1) = 0, d(0) = 0

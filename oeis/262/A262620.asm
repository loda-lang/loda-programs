...
; Formula: a(n) = 4*c(n)-3, b(n) = -2*n*truncate((2*n+b(n-1)-2)/(2*n))+2*n+b(n-1)-2, b(2) = 3, b(1) = 1, b(0) = 1, c(n) = -2*n*truncate((2*n+b(n-1)-2)/(2*n))+2*n+b(n-1)+c(n-1)-2, c(2) = 5, c(1) = 2, c(0) = 1

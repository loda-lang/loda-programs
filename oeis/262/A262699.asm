...
; Formula: a(n) = floor(max(0,n-1)/((floor((n-1)/2)==0)+floor((n-1)/2)))^((floor((n-1)/2)==0)+floor((n-1)/2))+binomial((floor((n-1)/2)==0)+floor((n-1)/2),floor(max(0,n-1)/((floor((n-1)/2)==0)+floor((n-1)/2)))^((floor((n-1)/2)==0)+floor((n-1)/2)))

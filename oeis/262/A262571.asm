...
; Formula: a(n) = c(n+2), b(n) = 9*b(n-1)*(n/b(n-1))+b(n-1), b(3) = 10, b(2) = 10, b(1) = 10, b(0) = 1, c(n) = c(n-1)*(9*(9*b(n-2)*((n-1)/b(n-2))+b(n-2))*(n/(9*b(n-2)*((n-1)/b(n-2))+b(n-2)))+9*b(n-2)*((n-1)/b(n-2))+b(n-2))+n, c(3) = 23, c(2) = 2, c(1) = 0, c(0) = 0

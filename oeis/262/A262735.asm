...
; Formula: a(n) = c(n)/2, b(n) = d(n-1), b(3) = 4, b(2) = 2, b(1) = 0, b(0) = 0, c(n) = e(n-1), c(3) = 4, c(2) = 2, c(1) = 2, c(0) = 0, d(n) = b(n-1)+d(n-1)+e(n-1), d(3) = 10, d(2) = 4, d(1) = 2, d(0) = 0, e(n) = b(n-1)+e(n-1)+e(n-2), e(3) = 8, e(2) = 4, e(1) = 2, e(0) = 2

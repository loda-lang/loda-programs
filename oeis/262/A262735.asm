...
; Formula: a(n) = truncate(c(n)/2), b(n) = b(n-1)+b(n-2)+d(n-2), b(4) = 10, b(3) = 4, b(2) = 2, b(1) = 0, b(0) = 0, c(n) = d(n-1), c(3) = 4, c(2) = 2, c(1) = 2, c(0) = 0, d(n) = b(n-1)+d(n-1)+d(n-2), d(3) = 8, d(2) = 4, d(1) = 2, d(0) = 2

...
; Formula: a(n) = d(n+2), b(n) = d(n-1), b(7) = 55, b(6) = 26, b(5) = 12, b(4) = 6, b(3) = 3, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = b(n-1), c(7) = 26, c(6) = 12, c(5) = 6, c(4) = 3, c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = e(n-2)+3, d(7) = 115, d(6) = 55, d(5) = 26, d(4) = 12, d(3) = 6, d(2) = 3, d(1) = 1, d(0) = 0, e(n) = 2*e(n-1)+b(n-1)+c(n-1)+d(n-1)+f(n-1)+3, e(7) = 495, e(6) = 236, e(5) = 112, e(4) = 52, e(3) = 23, e(2) = 9, e(1) = 3, e(0) = 0, f(n) = -b(n-2)-d(n-2)-e(n-2)-f(n-2)+f1(n-2)-2, f(7) = -154, f(6) = -73, f(5) = -35, f(4) = -16, f(3) = -7, f(2) = -2, f(1) = -1, f(0) = 0, f1(n) = -e(n-1)-f1(n-1)-2, f1(7) = -161, f1(6) = -77, f1(5) = -37, f1(4) = -17, f1(3) = -8, f1(2) = -3, f1(1) = -2, f1(0) = 0

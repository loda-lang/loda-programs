...
; Formula: a(n) = b(n+2), b(n) = c(n-2)+3, b(7) = 115, b(6) = 55, b(5) = 26, b(4) = 12, b(3) = 6, b(2) = 3, b(1) = 1, b(0) = 0, c(n) = 2*c(n-1)+2*c(n-4)-c(n-6)-c(n-9)+d(n-3)+d(n-4)+2, c(11) = 9372, c(10) = 4499, c(9) = 2159, c(8) = 1035, c(7) = 495, c(6) = 236, c(5) = 112, c(4) = 52, c(3) = 23, c(2) = 9, c(1) = 3, c(0) = 0, d(n) = -c(n-1)-d(n-1)-2, d(7) = -161, d(6) = -77, d(5) = -37, d(4) = -17, d(3) = -8, d(2) = -3, d(1) = -2, d(0) = 0

...
; Formula: a(n) = c(n)+1, b(n) = e(n-1)*d(n-1)+d(n-1)-1, b(3) = 2, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = b(n-1), c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = b(n-2)+1, d(3) = 1, d(2) = 1, d(1) = 1, d(0) = 1, e(n) = e(n-1)*d(n-1)+b(n-1)+d(n-1), e(3) = 4, e(2) = 2, e(1) = 1, e(0) = 0

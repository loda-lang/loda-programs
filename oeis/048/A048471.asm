...
; Formula: a(n) = truncate(2^(-binomial(truncate((sqrtint(8*n+16)-1)/2)+1,2)+n))*floor(truncate(3^(-n+binomial(truncate((sqrtint(8*n+16)-1)/2)+1,2)+truncate((sqrtint(8*n+16)-1)/2)))/2)+1

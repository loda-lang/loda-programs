...
; Formula: a(n) = c(n-1), a(3) = 0, a(2) = 1, a(1) = 0, a(0) = 0, b(n) = b(n-3)*b(n-1)+b(n-2), b(6) = 3, b(5) = 2, b(4) = 1, b(3) = 1, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = c(n-3)*b(n-2)+c(n-2), c(3) = 1, c(2) = 0, c(1) = 1, c(0) = 0

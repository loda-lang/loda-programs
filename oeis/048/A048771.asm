...
; Formula: a(n) = truncate((d(n+2)-7)/2), b(n) = 2*b(n-1)+b(n-2), b(4) = 42, b(3) = 17, b(2) = 8, b(1) = 1, b(0) = 0, c(n) = 2*c(n-1)+c(n-2), c(3) = 17, c(2) = 8, c(1) = 1, c(0) = 6, d(n) = b(n-1)+c(n-1)+d(n-1), d(2) = 9, d(1) = 7, d(0) = 1

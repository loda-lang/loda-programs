...
; Formula: a(n) = truncate(d(n+2)/2), b(n) = bitxor(bitxor(b(n-1)+c(n-1),b(n-1)),4*b(n-1)), b(2) = 238, b(1) = 34, b(0) = 8, c(n) = bitxor(bitxor(b(n-1)+c(n-1),b(n-1)),4*b(n-1)), c(2) = 238, c(1) = 34, c(0) = 2, d(n) = b(n-1), d(2) = 34, d(1) = 8, d(0) = 0

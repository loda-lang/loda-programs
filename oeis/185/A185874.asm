...
; Formula: a(n) = truncate((truncate(((3*floor((sqrtint(8*n)-1)/2)-n+binomial(floor((sqrtint(8*n)-1)/2)+1,2)+7)*(-binomial(floor((sqrtint(8*n)-1)/2)+1,2)+n)^2+(-binomial(floor((sqrtint(8*n)-1)/2)+1,2)+n)*(3*floor((sqrtint(8*n)-1)/2)-n+binomial(floor((sqrtint(8*n)-1)/2)+1,2)+7))/6)*(-n+binomial(floor((sqrtint(8*n)+3)/2),2)+1))/2)

...
; Formula: a(n) = -binomial(max(2*binomial(floor((sqrtint(8*n)-1)/2)+1,2)-2*n+floor((sqrtint(8*n)-1)/2)+3,0)+1,3)+binomial(-n+binomial(floor((sqrtint(8*n)-1)/2)+1,2)+floor((sqrtint(8*n)-1)/2)+4,3)

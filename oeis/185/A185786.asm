...
; Formula: a(n) = truncate((binomial(-binomial(floor((sqrtint(8*n)-1)/2)+1,2)+n+3,-binomial(floor((sqrtint(8*n)-1)/2)+1,2)+n-1)*binomial(-n+binomial(floor((sqrtint(8*n)-1)/2)+1,2)+floor((sqrtint(8*n)-1)/2)+5,4)*(4*floor((sqrtint(8*n)-1)/2)+20))/20)

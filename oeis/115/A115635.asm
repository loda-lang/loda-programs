...
; Formula: a(n) = b(n)/2+1, b(n) = (c(n-1)+d(n-1)-10)%4+c(n-2)+d(n-2)-9, b(3) = -3, b(2) = -12, b(1) = -1, b(0) = 0, c(n) = -c(n-1)-c(n-2)-d(n-1)-d(n-2)+19, c(3) = 3, c(2) = 12, c(1) = 9, c(0) = 0, d(n) = (c(n-1)+d(n-1)-10)%4, d(3) = -1, d(2) = -3, d(1) = -2, d(0) = 0

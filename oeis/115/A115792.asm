...
; Formula: a(n) = truncate(c(n+1)/4), b(n) = max(b(n-1)-2,0)+max(b(n-2)-2,0)+max(b(n-3)-2,0)+3, b(3) = 4, b(2) = 3, b(1) = 0, b(0) = 0, c(n) = max(b(n-1)-2,0)+max(b(n-2)-2,0)+3, c(3) = 4, c(2) = 3, c(1) = 3, c(0) = 0

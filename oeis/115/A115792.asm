...
; Formula: a(n) = c(n+1)/4, b(n) = c(n-1)+max(b(n-1)-2,0), b(3) = 4, b(2) = 3, b(1) = 0, b(0) = 0, c(n) = -c(n-2)+c(n-2)+max(c(n-2)+max(b(n-2)-2,0)-2,0)+max(b(n-2)-2,0)+3, c(3) = 4, c(2) = 3, c(1) = 3, c(0) = 0

...
; Formula: a(n) = 21*c(n+2), b(n) = 7*b(n-1), b(3) = 343, b(2) = 49, b(1) = 7, b(0) = 1, c(n) = max(d(n-2),1)^3+49*c(n-1)*b(n-2), c(3) = 855, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = 7*b(n-1)+max(d(n-1),1), d(3) = 400, d(2) = 57, d(1) = 8, d(0) = 0

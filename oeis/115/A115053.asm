...
; Formula: a(n) = 8*b(n-1)+8*truncate(c(n-1)/8)+c(n-1), a(2) = -48, a(1) = 9, a(0) = 0, b(n) = -c(n-1)-7*b(n-1)-8*truncate(c(n-1)/8), b(2) = 40, b(1) = -8, b(0) = 1, c(n) = 8*b(n-1)+8*truncate(c(n-1)/8), c(2) = -56, c(1) = 8, c(0) = 1

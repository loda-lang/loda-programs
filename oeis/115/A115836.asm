...
; Formula: a(n) = ((-c(n-1)+b(n-1))/2+min(d(n-1),b(n-1)))%2+a(n-1)+2, a(3) = 5, a(2) = 4, a(1) = 2, a(0) = 1, b(n) = (-c(n-1)+b(n-1))/2, b(3) = -2, b(2) = -1, b(1) = -1, b(0) = 0, c(n) = c(n-1)*(((-c(n-1)+b(n-1))/2+min(d(n-1),b(n-1)))%2+2), c(3) = 4, c(2) = 4, c(1) = 2, c(0) = 2, d(n) = ((-c(n-1)+b(n-1))/2+min(d(n-1),b(n-1)))%2+2, d(3) = 1, d(2) = 2, d(1) = 1, d(0) = 0

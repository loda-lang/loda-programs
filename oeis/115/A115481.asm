...
; Formula: a(n) = 50*(c(n)/5)+10, b(n) = 5*b(n-1), b(3) = 3125, b(2) = 625, b(1) = 125, b(0) = 25, c(n) = max(d(n-2),1)^3+25*c(n-1)*b(n-2), c(3) = 762908916, c(2) = 242916, c(1) = 341, c(0) = 1, d(n) = 5*b(n-1)+max(d(n-1),1), d(3) = 3906, d(2) = 781, d(1) = 156, d(0) = 31

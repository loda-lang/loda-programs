...
; Formula: a(n) = 50*(c(n+2)/5)+10, b(n) = 5*b(n-1), b(3) = 125, b(2) = 25, b(1) = 5, b(0) = 1, c(n) = max(d(n-2),1)^3+5*c(n-1)*b(n-1), c(3) = 341, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = 5*b(n-1)+max(d(n-1),1), d(3) = 156, d(2) = 31, d(1) = 6, d(0) = 0

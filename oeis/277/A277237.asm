...
; Formula: a(n) = 2*c(n)-((c(n)-2)/2)-1, b(n) = 4*b(n-2)+b(n-1), b(7) = 311, b(6) = 123, b(5) = 47, b(4) = 19, b(3) = 7, b(2) = 3, b(1) = 1, b(0) = 0, c(n) = 2*b(n-1)+2*c(n-1), c(6) = 434, c(5) = 170, c(4) = 66, c(3) = 26, c(2) = 10, c(1) = 4, c(0) = 1

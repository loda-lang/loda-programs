...
; Formula: a(n) = b(n+3)/2, b(n) = -e(n-1)+b(n-1)+d(n-1), b(4) = 8, b(3) = 2, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = 2*d(n-1)-2*e(n-1)+b(n-1)+f(n-1), c(4) = 16, c(3) = 5, c(2) = 1, c(1) = 0, c(0) = 1, d(n) = 2*d(n-1)+2*f(n-1)-2*e(n-1)+b(n-1)+c(n-1), d(4) = 23, d(3) = 7, d(2) = 2, d(1) = 1, d(0) = 0, e(n) = c(n-1), e(4) = 5, e(3) = 1, e(2) = 0, e(1) = 1, e(0) = 0, f(n) = 4*f(n-1)+2*f(n-3)-f(n-4)-3*f(n-2), f(8) = 773, f(7) = 239, f(6) = 74, f(5) = 23, f(4) = 7, f(3) = 2, f(2) = 1, f(1) = 1, f(0) = 0

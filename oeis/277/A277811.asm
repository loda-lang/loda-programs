...
; Formula: a(n) = A181819(A181811(A057335(sign(3*sign(n-1)*sign(2*n-1)+sign(2*n-1)+sign(n-1))*bitxor(abs(n-1),abs(2*n-1))))*A057335(sign(3*sign(n-1)*sign(2*n-1)+sign(2*n-1)+sign(n-1))*bitxor(abs(n-1),abs(2*n-1))))

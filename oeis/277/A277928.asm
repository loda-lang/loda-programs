...
; Formula: a(n) = max((b(n-1)^2+d(n-1))/c(n-1)-1,0), a(4) = 0, a(3) = 15, a(2) = 0, a(1) = 2, a(0) = 1, b(n) = -2*b(n-1), b(4) = -16, b(3) = 8, b(2) = -4, b(1) = 2, b(0) = -1, c(n) = -b(n-2), c(4) = 4, c(3) = -2, c(2) = 1, c(1) = -2, c(0) = 1, d(n) = max(((4*b(n-3))^2+d(n-1))/(-b(n-3))-1,0), d(4) = 0, d(3) = 15, d(2) = 0, d(1) = 2, d(0) = 2

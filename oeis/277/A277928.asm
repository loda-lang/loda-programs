...
; Formula: a(n) = max(truncate((b(n-1)^2+c(n-1))/(-b(n-3)))-1,0), a(4) = 0, a(3) = 15, a(2) = 0, a(1) = 2, a(0) = 1, b(n) = -2*b(n-1), b(4) = -16, b(3) = 8, b(2) = -4, b(1) = 2, b(0) = -1, c(n) = max(truncate((b(n-1)^2+c(n-1))/(-b(n-3)))-1,0), c(4) = 0, c(3) = 15, c(2) = 0, c(1) = 2, c(0) = 2

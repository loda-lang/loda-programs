...
; Formula: a(n) = truncate((8*b(4*n)+8*d(4*n))/truncate((3*c(4*n))/(4*n))), b(n) = 4*c(n-1)+4*d(n-1)+2*b(n-1)+2, b(3) = 110, b(2) = 18, b(1) = 2, b(0) = 0, c(n) = 3*c(n-1)+2*d(n-1)+b(n-1)+2, c(3) = 68, c(2) = 12, c(1) = 2, c(0) = 0, d(n) = 2*c(n-1)+d(n-1)+1, d(3) = 31, d(2) = 6, d(1) = 1, d(0) = 0

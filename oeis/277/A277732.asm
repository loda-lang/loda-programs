...
; Formula: a(n) = e(n+1), b(n) = (-c(n-1)+b(n-1)-5)/4, b(3) = -66, b(2) = -5, b(1) = -2, b(0) = 0, c(n) = c(n-1)*gcd((d(n-1)*((-c(n-1)+b(n-1)-5)/4))^2+(-c(n-1)+b(n-1)-5)/4,4)^2, c(3) = 1024, c(2) = 256, c(1) = 16, c(0) = 4, d(n) = gcd((d(n-1)*((-c(n-1)+b(n-1)-5)/4))^2+(-c(n-1)+b(n-1)-5)/4,4)/2, d(3) = 1, d(2) = 2, d(1) = 1, d(0) = 0, e(n) = d(n-1)+e(n-1)+1, e(3) = 6, e(2) = 3, e(1) = 1, e(0) = 0

...
; Formula: a(n) = bitxor(4*max(0,sign(3*sign(n-1)*sign(2*n-1)+sign(2*n-1)+sign(n-1))*bitxor(abs(n-1),abs(2*n-1))),max(0,sign(3*sign(n-1)*sign(2*n-1)+sign(2*n-1)+sign(n-1))*bitxor(abs(n-1),abs(2*n-1))))

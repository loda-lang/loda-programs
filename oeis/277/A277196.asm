...
; Formula: a(n) = A107079(A181819(A181811(truncate((A057335(A003714(n))-1)/A293810(A057335(A003714(n))-1))+1)*(truncate((A057335(A003714(n))-1)/A293810(A057335(A003714(n))-1))+1)))

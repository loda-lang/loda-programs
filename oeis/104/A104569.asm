...
; Formula: a(n) = floor((sqrtint(8*n)-1)/2)%2+2*floor((sqrtint(8*n)-1)/2)-n-2*truncate((-binomial(floor((sqrtint(8*n)-1)/2)+1,2)+n-1)/2)+binomial(floor((sqrtint(8*n)-1)/2)+1,2)+2

...
; Formula: a(n) = binomial(-n+binomial(floor((sqrtint(8*n)-1)/2)+1,2)+floor((sqrtint(8*n)-1)/2)+3,2)*(-binomial(floor((sqrtint(8*n)-1)/2)+1,2)+n-1)+truncate(binomial(2*n-2*binomial(floor((sqrtint(8*n)-1)/2)+1,2)-2*floor((sqrtint(8*n)-1)/2)-4,3)/(-4))

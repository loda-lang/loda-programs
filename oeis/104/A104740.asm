...
; Formula: a(n) = e(n+2), b(n) = -b(n-1)-c(n-1)+c(n-1)+e(n-1), b(3) = -1, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = (2*c(n-1)+2*e(n-1)-b(n-1)-c(n-1))/4+3*e(n-1)-3*d(n-1), c(3) = 3, c(2) = 2, c(1) = 3, c(0) = 0, d(n) = 3*e(n-1)-3*d(n-1), d(3) = 3, d(2) = 0, d(1) = 3, d(0) = 0, e(n) = ((2*c(n-1)+2*e(n-1)-b(n-1)-c(n-1))/4+6*e(n-1)-6*d(n-1))/2, e(3) = 3, e(2) = 1, e(1) = 3, e(0) = 1

...
; Formula: a(n) = truncate(((-n+binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+floor((sqrtint(8*n+8)-1)/2))*(3*floor((sqrtint(8*n+8)-1)/2)-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n+2)+3*floor((sqrtint(8*n+8)-1)/2)-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n+2)/2)

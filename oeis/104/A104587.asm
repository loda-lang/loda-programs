...
; Formula: a(n) = truncate(((2*bitxor(floor((sqrtint(8*n+8)-1)/2),-1)-n+binomial(floor((sqrtint(8*n+8)-1)/2),2)-1)*(2*bitxor(floor((sqrtint(8*n+8)-1)/2),-1)-binomial(floor((sqrtint(8*n+8)-1)/2),2)+n+1)+2*bitxor(floor((sqrtint(8*n+8)-1)/2),-1)-binomial(floor((sqrtint(8*n+8)-1)/2),2)+n+1)/2)

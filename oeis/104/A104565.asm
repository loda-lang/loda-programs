...
; Formula: a(n) = d(2*n), b(n) = (c(n-2)*(b(n-2)+f(n-2)))/(e(n-2)-1)+d(n-2), b(9) = -12, b(8) = -12, b(7) = 7, b(6) = 7, b(5) = -3, b(4) = -3, b(3) = 1, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = c(n-2)+2, c(9) = 8, c(8) = 8, c(7) = 6, c(6) = 6, c(5) = 4, c(4) = 4, c(3) = 2, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = (c(n-2)*(b(n-2)+f(n-2)))/(e(n-2)-1)-2*d(n-2), d(9) = -6, d(8) = -6, d(7) = -2, d(6) = -2, d(5) = 3, d(4) = 3, d(3) = -2, d(2) = -2, d(1) = 1, d(0) = 1, e(n) = e(n-2)-1, e(9) = -6, e(8) = -6, e(7) = -5, e(6) = -5, e(5) = -4, e(4) = -4, e(3) = -3, e(2) = -3, e(1) = -2, e(0) = -2, f(n) = d(n-2), f(9) = -2, f(8) = -2, f(7) = 3, f(6) = 3, f(5) = -2, f(4) = -2, f(3) = 1, f(2) = 1, f(1) = 0, f(0) = 0

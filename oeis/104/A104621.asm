...
; Formula: a(n) = 2*c(n+2)-1, b(n) = f(n-3), b(6) = 2, b(5) = 1, b(4) = 4, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = f(n-1), c(6) = 8, c(5) = 4, c(4) = 2, c(3) = 1, c(2) = 4, c(1) = 0, c(0) = 0, d(n) = 2*b(n-1)+2*e(n-1)+d(n-1)-3, d(6) = 15, d(5) = 8, d(4) = -1, d(3) = 0, d(2) = -5, d(1) = -2, d(0) = 1, e(n) = b(n-2)+f(n-1), e(6) = 12, e(5) = 4, e(4) = 2, e(3) = 1, e(2) = 4, e(1) = 0, e(0) = 0, f(n) = b(n-1)+d(n-1)+e(n-1)+3, f(6) = 16, f(5) = 8, f(4) = 4, f(3) = 2, f(2) = 1, f(1) = 4, f(0) = 0

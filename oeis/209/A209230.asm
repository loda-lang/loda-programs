...
; Formula: a(n) = c(n)/2+1, b(n) = 4*b(n-1)+2*b(n-4)-4*b(n-2), b(10) = 11704, b(9) = 4584, b(8) = 1796, b(7) = 704, b(6) = 276, b(5) = 108, b(4) = 42, b(3) = 16, b(2) = 6, b(1) = 2, b(0) = 0, c(n) = b(n-1)+c(n-1), c(4) = 25, c(3) = 9, c(2) = 3, c(1) = 1, c(0) = 1

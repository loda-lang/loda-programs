...
; Formula: a(n) = truncate((truncate((binomial(truncate((sqrtint(8*n)-1)/2),-binomial(truncate((sqrtint(8*n)-1)/2)+1,2)+n-1)*(-binomial(truncate((sqrtint(8*n)-1)/2)+1,2)+truncate((sqrtint(8*n)-1)/2)+n+1))/(-binomial(truncate((sqrtint(8*n)-1)/2)+1,2)+n))*truncate(2^(-binomial(truncate((sqrtint(8*n)-1)/2)+1,2)+n)))/4)

...
; Formula: a(n) = d(n+1), b(n) = -d(n-2)+b(n-1)+c(n-2)+f(n-2)+1, b(5) = 11, b(4) = 6, b(3) = 3, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = b(n-1)+e(n-1), c(5) = 10, c(4) = 4, c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = -d(n-1)+b(n-1)+c(n-1)+f(n-1)+1, d(5) = 16, d(4) = 8, d(3) = 4, d(2) = 2, d(1) = 1, d(0) = 0, e(n) = b(n-1)+e(n-1), e(5) = 10, e(4) = 4, e(3) = 1, e(2) = 0, e(1) = 0, e(0) = 0, f(n) = b(n-1)+e(n-1)+f(n-1)+2, f(5) = 25, f(4) = 13, f(3) = 7, f(2) = 4, f(1) = 2, f(0) = 0

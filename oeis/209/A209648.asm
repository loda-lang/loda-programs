...
; Formula: a(n) = 22*e(2*n), b(n) = b(n-1)+c(n-2)+f(n-2)+1, b(5) = 31, b(4) = 15, b(3) = 6, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = 3*n+c(n-2)+f(n-2)+1, c(5) = 31, c(4) = 21, c(3) = 14, c(2) = 7, c(1) = 3, c(0) = 0, d(n) = c(n-1)+f(n-1)+1, d(5) = 23, d(4) = 16, d(3) = 9, d(2) = 5, d(1) = 1, d(0) = 0, e(n) = b(n-1)+d(n-1)+e(n-1), e(5) = 53, e(4) = 22, e(3) = 7, e(2) = 1, e(1) = 0, e(0) = 0, f(n) = (c(n-1)+f(n-1)+1)^0, f(5) = 1, f(4) = 1, f(3) = 1, f(2) = 1, f(1) = 1, f(0) = 0

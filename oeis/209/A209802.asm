...
; Formula: a(n) = b(n)-1, b(n) = b(n-1)+A166234(n), b(0) = 1
...
lpb $0
  mov $1,$0
  seq $1,166234 ; The inverse of the constant 1 function under the exponential convolution (also called the exponential Möbius function).
  sub $0,1
  add $2,$1
lpe
mov $0,$2

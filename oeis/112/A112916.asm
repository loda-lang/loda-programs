...
; Formula: a(n) = if((n+2)==0,2*A088716(n+1),if(((2*A088716(n+1))%(n+2))==0,(2*A088716(n+1))/(n+2),2*A088716(n+1)))

mov $1,$0
add $1,2
add $0,1
seq $0,88716 ; G.f. satisfies: A(x) = 1 + x*A(x)*d/dx[x*A(x)] = 1 + x*A(x)^2 + x^2*A(x)*A'(x).
mul $0,2
dif $0,$1

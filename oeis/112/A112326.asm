...
; Formula: a(n) = 2*truncate((truncate(2^(-binomial(truncate((sqrtint(8*n)-1)/2)+1,2)+n+2))*binomial(2*truncate((sqrtint(8*n)-1)/2)-n+binomial(truncate((sqrtint(8*n)-1)/2)+1,2)+2,truncate((sqrtint(8*n)-1)/2)+1))/8)

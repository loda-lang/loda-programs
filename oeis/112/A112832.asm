...
; Formula: a(n) = truncate(((-truncate(c(n+2)/b(n+2))*b(n+2)+c(n+2))*(-truncate(c(n+2)/b(n+2))*b(n+2)+min(n+2,(n+2)%2)*b(n+2)+c(n+2)))/18)+1, b(n) = 2*c(n-2)+b(n-2), b(3) = 6, b(2) = 6, b(1) = 0, b(0) = 0, c(n) = 3*c(n-2)+b(n-2), c(3) = 9, c(2) = 9, c(1) = 3, c(0) = 3

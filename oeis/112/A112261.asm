...
; Formula: a(n) = -b(n)+min(n,0), b(n) = 4*c(n-1)+4*d(n-1)-2*b(n-1), b(2) = -12, b(1) = 0, b(0) = 2, c(n) = 4*c(n-1)+2*d(n-1)-2*b(n-1), c(2) = -10, c(1) = -2, c(0) = 0, d(n) = -b(n-1)+d(n-1), d(2) = -1, d(1) = -1, d(0) = 1

...
; Formula: a(n) = c(n)/2+1, b(n) = (-8*n*b(n-1)*(2*n-1))/(2*n+d(n-1)), b(3) = -640, b(2) = 64, b(1) = -8, b(0) = 2, c(n) = (-8*n*b(n-1)*(2*n-1))/(2*n+d(n-1))+c(n-1), c(3) = -584, c(2) = 56, c(1) = -8, c(0) = 0, d(n) = 2*n+d(n-1), d(3) = 12, d(2) = 6, d(1) = 2, d(0) = 0

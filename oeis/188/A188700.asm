...
; Formula: a(n) = d(n+2)/2+1, b(n) = b(n-1)+d(n-1)+2, b(5) = 242, b(4) = 62, b(3) = 20, b(2) = 4, b(1) = 2, b(0) = 0, c(n) = e(n-2), c(5) = 26, c(4) = 6, c(3) = 2, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 5*e(n-1)-f(n-1)+b(n-1)+c(n-1)+e(n-1), d(5) = 606, d(4) = 178, d(3) = 40, d(2) = 14, d(1) = 0, d(0) = 0, e(n) = -f(n-1)+b(n-1)+c(n-1)+d(n-1)+e(n-1)+2, e(5) = 336, e(4) = 90, e(3) = 26, e(2) = 6, e(1) = 2, e(0) = 0, f(n) = -e(n-1)-f(n-1)+c(n-1)+e(n-1), f(5) = 4, f(4) = 2, f(3) = 0, f(2) = 0, f(1) = 0, f(0) = 0

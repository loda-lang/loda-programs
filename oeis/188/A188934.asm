...
; Formula: a(n) = (d(3*n+5)/(c(3*n+5)/(10^n)))%10, b(n) = b(n-1)+c(n-1), b(2) = 10, b(1) = 2, b(0) = 0, c(n) = 4*c(n-1)+2*b(n-1), c(2) = 36, c(1) = 8, c(0) = 2, d(n) = 4*c(n-1)+2*b(n-1)+d(n-1), d(2) = 44, d(1) = 8, d(0) = 0

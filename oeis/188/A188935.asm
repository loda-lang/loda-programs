...
; Formula: a(n) = -10*truncate(truncate(b(3*n)/(truncate(c(3*n)/(10^n))+1))/10)+truncate(b(3*n)/(truncate(c(3*n)/(10^n))+1)), b(n) = b(n-1)+c(n-1), b(1) = 1, b(0) = 1, c(n) = 6*c(n-1)+3*b(n-1), c(1) = 3, c(0) = 0

...
; Formula: a(n) = truncate((A004957(truncate((2*floor((n+83)/2)-floor((floor((n+83)/2)+1)/7)+1)/3)+n-24)+A276886(A004957(truncate((2*floor((n+83)/2)-floor((floor((n+83)/2)+1)/7)+1)/3)+n-24))+40)/2)-19

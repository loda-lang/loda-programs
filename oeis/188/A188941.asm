...
; Formula: a(n) = -10*truncate(truncate((2*b(3*n))/(truncate(c(3*n)/(10^n))+1))/10)+truncate((2*b(3*n))/(truncate(c(3*n)/(10^n))+1)), b(n) = b(n-1)+c(n-1), b(1) = 2, b(0) = 2, c(n) = 8*c(n-1)+4*b(n-1), c(1) = 8, c(0) = 0

...
; Formula: a(n) = -10*truncate(truncate((c(4*n)+2)/truncate(b(4*n)/(10^n)))/10)+truncate((c(4*n)+2)/truncate(b(4*n)/(10^n))), b(n) = 2*b(n-1)+c(n-1)+truncate(b(n-1)/2), b(1) = 12, b(0) = 1, c(n) = 2*b(n-1)+c(n-1), c(1) = 12, c(0) = 10

...
; Formula: a(n) = truncate((sqrtint((truncate((2*floor((n+82)/2)-floor((floor((n+82)/2)+1)/7)+1)/3)+n-25)*(5*truncate((2*floor((n+82)/2)-floor((floor((n+82)/2)+1)/7)+1)/3)+5*n-125))+truncate((2*floor((n+82)/2)-floor((floor((n+82)/2)+1)/7)+1)/3)+n-25)/2)+truncate((2*floor((n+82)/2)-floor((floor((n+82)/2)+1)/7)+1)/3)+n-24

...
; Formula: a(n) = -10*truncate(truncate(b(4*n)/(truncate(c(4*n)/(10^n))+1))/10)+truncate(b(4*n)/(truncate(c(4*n)/(10^n))+1)), b(n) = 4*truncate((b(n-1)+c(n-1))/5), b(1) = 0, b(0) = 1, c(n) = 4*c(n-1)+2*b(n-1), c(1) = 2, c(0) = 0

...
; Formula: a(n) = d(n-1)+a(n-1)+2, a(3) = 10, a(2) = 8, a(1) = 2, a(0) = 0, b(n) = truncate((-c(n-1)+b(n-1))/2), b(3) = -24, b(2) = -16, b(1) = -1, b(0) = 0, c(n) = c(n-1)*gcd(-2*truncate((d(n-1)+truncate((-c(n-1)+b(n-1))/2)-1)/2)+d(n-1)+truncate((-c(n-1)+b(n-1))/2)-1,4)^2, c(3) = 32, c(2) = 32, c(1) = 32, c(0) = 2, d(n) = floor((gcd(-2*truncate((d(n-1)+truncate((-c(n-1)+b(n-1))/2)-1)/2)+d(n-1)+truncate((-c(n-1)+b(n-1))/2)-1,4)^2)/4), d(3) = 0, d(2) = 0, d(1) = 4, d(0) = 0

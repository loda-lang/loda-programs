...
; Formula: a(n) = truncate(e(n)/2), b(n) = truncate((-c(n-1)+b(n-1))/2), b(3) = -24, b(2) = -16, b(1) = -1, b(0) = 0, c(n) = c(n-1)*gcd(-2*truncate((d(n-1)+truncate((-c(n-1)+b(n-1))/2)-1)/2)+d(n-1)+truncate((-c(n-1)+b(n-1))/2)-1,4)^2, c(3) = 32, c(2) = 32, c(1) = 32, c(0) = 2, d(n) = truncate(gcd(-2*truncate((d(n-1)+truncate((-c(n-1)+b(n-1))/2)-1)/2)+d(n-1)+truncate((-c(n-1)+b(n-1))/2)-1,4)/2), d(3) = 0, d(2) = 0, d(1) = 2, d(0) = 0, e(n) = d(n-1)+e(n-1)+2, e(3) = 8, e(2) = 6, e(1) = 2, e(0) = 0

...
; Formula: a(n) = truncate((d(n+2)-3)/2)+1, b(n) = A080339(c(n-1)+gcd(b(n-1),c(n-1))+1), b(2) = 1, b(1) = 1, b(0) = 0, c(n) = c(n-1)+gcd(b(n-1),c(n-1))+1, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = c(n-1), d(2) = 1, d(1) = 0, d(0) = 0

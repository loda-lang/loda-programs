...
; Formula: a(n) = c(n-1)+1, b(n) = d(n-1), b(3) = 5, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = (c(n-1)*b(n-1)-e(n-1)+b(n-1)+d(n-1))^2, c(3) = 2704, c(2) = 25, c(1) = 4, c(0) = 0, d(n) = c(n-1)*b(n-1)-e(n-1)+b(n-1)+d(n-1), d(3) = 52, d(2) = 5, d(1) = 2, d(0) = 1, e(n) = c(n-1)*b(n-1)-e(n-1)+b(n-1)+d(n-1), e(3) = 52, e(2) = 5, e(1) = 2, e(0) = 0

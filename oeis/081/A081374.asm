...
; Formula: a(n) = b(n+2), b(n) = c(n-2)+1, b(4) = 2, b(3) = 2, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = e(n-1), c(4) = 9, c(3) = 4, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = 2*b(n-1)+d(n-1), d(4) = 8, d(3) = 4, d(2) = 2, d(1) = 0, d(0) = 0, e(n) = 2*b(n-1)+c(n-1)+d(n-1)+e(n-1), e(4) = 21, e(3) = 9, e(2) = 4, e(1) = 1, e(0) = 1

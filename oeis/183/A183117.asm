...
; Formula: a(n) = f(n-1), a(5) = 53, a(4) = 19, a(3) = 7, a(2) = 3, a(1) = 1, a(0) = 0, b(n) = -d(n-1)+e(n-1)+f(n-1)-3, b(5) = 35, b(4) = 11, b(3) = 3, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = 2*b(n-1)+f(n-1), c(5) = 75, c(4) = 25, c(3) = 9, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = -e(n-1)+d(n-1)+f(n-1), d(5) = 68, d(4) = 24, d(3) = 8, d(2) = 2, d(1) = -1, d(0) = 1, e(n) = c(n-1), e(5) = 25, e(4) = 9, e(3) = 3, e(2) = 1, e(1) = 0, e(0) = 3, f(n) = max(2*b(n-1)+2*f(n-1)+c(n-1),3), f(5) = 153, f(4) = 53, f(3) = 19, f(2) = 7, f(1) = 3, f(0) = 1

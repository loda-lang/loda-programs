...
; Formula: a(n) = 2*b(n-1)+e(n-1), a(4) = 19, a(3) = 7, a(2) = 3, a(1) = 1, a(0) = 0, b(n) = -c(n-1)+d(n-1)+e(n-1)-4, b(4) = 6, b(3) = 1, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = -d(n-1)+c(n-1)+e(n-1)+1, c(4) = 25, c(3) = 10, c(2) = 3, c(1) = -1, c(0) = 0, d(n) = a(n-1), d(4) = 7, d(3) = 3, d(2) = 1, d(1) = 0, d(0) = 3, e(n) = max(2*b(n-1)+2*e(n-1)+a(n-1),3), e(4) = 43, e(3) = 17, e(2) = 7, e(1) = 3, e(0) = 1

...
; Formula: a(n) = d(n-1)+e(n-1)+max(-c(n-1)+b(n-1)-1,0)+n-4, b(n) = b(n-1)+n+3, b(4) = 22, b(3) = 15, b(2) = 9, b(1) = 4, b(0) = 0, c(n) = max(-b(n-1)-n+c(n-1)-3,0)+n+3, c(4) = 7, c(3) = 6, c(2) = 5, c(1) = 4, c(0) = 0, d(n) = b(n-1)+d(n-1)+n+3, d(4) = 50, d(3) = 28, d(2) = 13, d(1) = 4, d(0) = 0, e(n) = max(e(n-1)-4,0)+2, e(4) = 2, e(3) = 2, e(2) = 2, e(1) = 3, e(0) = 5

...
; Formula: a(n) = a(n-1)+max(c(n-1),1), a(4) = 30, a(3) = 11, a(2) = 4, a(1) = 1, a(0) = 0, b(n) = (-c(n-1)+b(n-1))%2, b(4) = -1, b(3) = 0, b(2) = -1, b(1) = 0, b(0) = 0, c(n) = 2*c(n-1)+2*c(n-2)-2*b(n-2)-2*d(n-2)-2*max(c(n-2),1)+d(n-1)+max(c(n-1),1)-2, c(5) = 153, c(4) = 53, c(3) = 19, c(2) = 7, c(1) = 3, c(0) = 0, d(n) = min(d(n-1)+2,4), d(4) = 4, d(3) = 4, d(2) = 4, d(1) = 2, d(0) = 0

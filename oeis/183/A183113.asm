...
; Formula: a(n) = truncate((-d(n-1)+c(n-1))/e(n-1))*e(n-1)-c(n-1)+d(n-1)+e(n-1), a(4) = 21, a(3) = 7, a(2) = 3, a(1) = 1, a(0) = 0, b(n) = 2*a(n-1)+e(n-1), b(4) = 38, b(3) = 13, b(2) = 4, b(1) = 1, b(0) = 0, c(n) = -d(n-1)+c(n-1)+e(n-1), c(4) = 27, c(3) = 7, c(2) = 1, c(1) = -1, c(0) = 1, d(n) = b(n-1), d(4) = 13, d(3) = 4, d(2) = 1, d(1) = 0, d(0) = 3, e(n) = 2*a(n-1)+2*e(n-1)+b(n-1), e(4) = 75, e(3) = 24, e(2) = 7, e(1) = 2, e(0) = 1

...
; Formula: a(n) = max(c(n-1),1), a(4) = 19, a(3) = 7, a(2) = 3, a(1) = 1, a(0) = 0, b(n) = -c(n-1)-2*truncate((-c(n-1)+b(n-1))/2)+b(n-1), b(4) = -1, b(3) = 0, b(2) = -1, b(1) = 0, b(0) = 0, c(n) = 2*c(n-1)+2*c(n-2)-2*n-2*b(n-2)-2*max(c(n-2),1)+max(c(n-1),1)+4, c(5) = 159, c(4) = 55, c(3) = 19, c(2) = 7, c(1) = 3, c(0) = 0

...
; Formula: a(n) = truncate(c(n)/3)+1, b(n) = 2*b(n-1)+3, b(4) = 45, b(3) = 21, b(2) = 9, b(1) = 3, b(0) = 0, c(n) = 2*b(n-1)+2*b(n-2)+d(n-1)+e(n-1)+3, c(4) = 111, c(3) = 33, c(2) = 9, c(1) = 0, c(0) = 0, d(n) = 4*b(n-3)+2*b(n-2)+2*d(n-2)+2*e(n-2)-d(n-1)+3, d(5) = 144, d(4) = 33, d(3) = 12, d(2) = -3, d(1) = 0, d(0) = 0, e(n) = 2*b(n-1)+2*b(n-2)+e(n-1)+3, e(4) = 99, e(3) = 36, e(2) = 9, e(1) = 0, e(0) = 0

...
; Formula: a(n) = 2*b(n-1)+e(n-1), a(4) = 25, a(3) = 9, a(2) = 3, a(1) = 1, a(0) = 0, b(n) = -c(n-1)+d(n-1)+e(n-1)-3, b(4) = 11, b(3) = 3, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = -d(n-1)+c(n-1)+e(n-1), c(4) = 24, c(3) = 8, c(2) = 2, c(1) = -1, c(0) = 1, d(n) = a(n-1), d(4) = 9, d(3) = 3, d(2) = 1, d(1) = 0, d(0) = 3, e(n) = max(2*b(n-1)+2*e(n-1)+a(n-1),3), e(4) = 53, e(3) = 19, e(2) = 7, e(1) = 3, e(0) = 1

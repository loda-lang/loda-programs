...
; Formula: a(n) = d(n-1)+3, b(n) = 3*b(n-2)-b(n-3)-b(n-4)+b(n-1)+2, b(7) = 181, b(6) = 85, b(5) = 40, b(4) = 18, b(3) = 8, b(2) = 3, b(1) = 1, b(0) = 0, c(n) = -e(n-1)+d(n-1)+1, c(3) = 5, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = 2*c(n-1)+2*d(n-1)-e(n-1)+b(n-1)+3, d(3) = 24, d(2) = 10, d(1) = 3, d(0) = 0, e(n) = 2*d(n-1)-2*e(n-1)+b(n-1)+c(n-1)+2, e(3) = 15, e(2) = 6, e(1) = 2, e(0) = 0

...
; Formula: a(n) = b(n)+f(n)-1, b(n) = -d(n-1)+e(n-1)+f(n-1)-3, b(4) = 6, b(3) = 2, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = 2*b(n-1)+f(n-1), c(4) = 16, c(3) = 5, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = -e(n-1)+d(n-1)+f(n-1), d(4) = 15, d(3) = 5, d(2) = 1, d(1) = -1, d(0) = 1, e(n) = c(n-1), e(4) = 5, e(3) = 2, e(2) = 1, e(1) = 0, e(0) = 3, f(n) = 2*b(n-1)+2*f(n-1)+c(n-1), f(4) = 33, f(3) = 12, f(2) = 5, f(1) = 2, f(0) = 1

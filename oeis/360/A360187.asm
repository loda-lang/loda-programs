...
; Formula: a(n) = b(n-1), a(4) = 113, a(3) = 13, a(2) = 3, a(1) = 1, a(0) = 1, b(n) = truncate((b(n-2)^2+2*c(n-1)*b(n-3)*b(n-1))/b(n-4)), b(4) = 1525, b(3) = 113, b(2) = 13, b(1) = 3, b(0) = 1, c(n) = 8*c(n-1)-6*truncate((4*c(n-1))/3), c(4) = 4, c(3) = 2, c(2) = 4, c(1) = 2, c(0) = 1

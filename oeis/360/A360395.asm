...
; Formula: a(n) = truncate(c(max(2*n-2,0))/2)+1, b(n) = truncate(truncate((-10*4^(n-1)+b(n-1))/2)/gcd(truncate((-10*4^(n-1)+b(n-1))/2)+1,4)), b(3) = -90, b(2) = -20, b(1) = -1, b(0) = 0, c(n) = c(n-1)+gcd(truncate((-10*4^(n-2)+b(n-2))/2)+1,4)+2, c(3) = 13, c(2) = 10, c(1) = 4, c(0) = 0

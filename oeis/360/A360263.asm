...
; Formula: a(n) = b(n+1), b(n) = 2*c(n-1)+d(n-1)+e(n-1)+1, b(3) = 8, b(2) = 3, b(1) = 1, b(0) = 0, c(n) = 2*c(n-2)+2*c(n-3)+d(n-2)+d(n-3)+2, c(3) = 3, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = c(n-1)+d(n-1)+e(n-1)+1, d(3) = 7, d(2) = 3, d(1) = 1, d(0) = 0, e(n) = 2*c(n-1)+d(n-1)+1, e(3) = 6, e(2) = 2, e(1) = 1, e(0) = 0

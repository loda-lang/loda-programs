...
; Formula: a(n) = (-truncate(c(n+2)/b(n+2))*b(n+2)+c(n+2))*(-truncate(c(n+2)/b(n+2))*b(n+2)+min(n+2,(n+2)%2)*b(n+2)+c(n+2))-5, b(n) = 3*b(n-2)-b(n-4), b(6) = 29, b(5) = 11, b(4) = 11, b(3) = 4, b(2) = 4, b(1) = 1, b(0) = 1, c(n) = 2*c(n-2)+b(n-2), c(3) = 7, c(2) = 7, c(1) = 3, c(0) = 3

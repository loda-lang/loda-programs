...
; Formula: a(n) = d(n+2)-2, b(n) = f(n-1)+max(-binomial(e(n-1),b(n-1))+b(n-1)+d(n-1)+1,2), b(4) = 58, b(3) = 21, b(2) = 8, b(1) = 2, b(0) = 0, c(n) = f(n-1), c(4) = 18, c(3) = 6, c(2) = 3, c(1) = 0, c(0) = 0, d(n) = c(n-1)+binomial(e(n-1),b(n-1))+max(-binomial(e(n-1),b(n-1))+b(n-1)+d(n-1)+1,2), d(4) = 46, d(3) = 18, d(2) = 6, d(1) = 3, d(0) = 0, e(n) = c(n-1)+max(-binomial(e(n-1),b(n-1))+b(n-1)+d(n-1)+1,2), e(4) = 46, e(3) = 18, e(2) = 5, e(1) = 2, e(0) = 0, f(n) = c(n-1)+binomial(e(n-1),b(n-1))+max(-binomial(e(n-1),b(n-1))+b(n-1)+d(n-1)+1,2), f(4) = 46, f(3) = 18, f(2) = 6, f(1) = 3, f(0) = 0

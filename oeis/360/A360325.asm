...
; 1,1,3,1,5,3,1,1,9,5,11,3,1,1,15,1,17,9,1,5,3,11,1,3,25,1,27,1,1,15,31,1,33,17,5,9,1,1,3,5,41,3,1,11,45,1,1,3,1,25,51,1,1,27,55,1,3,1,59,15,1,31,9,1,5,33,67,17,3,5,1,9,1,1,75,1,11,3,1,5
; Formula: a(n) = A064988(A295665(n))

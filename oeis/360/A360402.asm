...
; Formula: a(n) = floor((3*floor((4*n-sumdigits(n,2)-2*truncate((-sumdigits(n,2)+n)/2))/2)+gcd(sumdigits(floor((4*n-sumdigits(n,2)-2*truncate((-sumdigits(n,2)+n)/2))/2),2),2)-1)/2)+2

...
; Formula: a(n) = 2*e(n-1)+2*a(n-1)+2*a(n-2)-2*d(n-2)-2*e(n-2)+b(n-2)+2, a(6) = 414, a(5) = 125, a(4) = 38, a(3) = 12, a(2) = 4, a(1) = 1, a(0) = 0, b(n) = c(n-1), b(5) = 23, b(4) = 6, b(3) = 1, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = -d(n-1)+c(n-1)+a(n-1), c(5) = 78, c(4) = 23, c(3) = 6, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = -a(n-1)+d(n-1), d(5) = -55, d(4) = -17, d(3) = -5, d(2) = -1, d(1) = 0, d(0) = 0, e(n) = c(n-1)+e(n-1), e(5) = 30, e(4) = 7, e(3) = 1, e(2) = 0, e(1) = 0, e(0) = 0

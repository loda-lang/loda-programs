...
; Formula: a(n) = f(n+1), b(n) = 2*c(n-2)+2*e(n-2)+b(n-1)+b(n-2)+c(n-2)+f(n-2)+2, b(5) = 73, b(4) = 27, b(3) = 12, b(2) = 6, b(1) = 3, b(0) = 1, c(n) = -d(n-1)+c(n-1)+f(n-1), c(5) = 78, c(4) = 23, c(3) = 6, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = -f(n-1)+d(n-1), d(5) = -55, d(4) = -17, d(3) = -5, d(2) = -1, d(1) = 0, d(0) = 0, e(n) = c(n-1)+e(n-1), e(5) = 30, e(4) = 7, e(3) = 1, e(2) = 0, e(1) = 0, e(0) = 0, f(n) = 2*c(n-1)+2*e(n-1)+b(n-1)+f(n-1), f(5) = 125, f(4) = 38, f(3) = 12, f(2) = 4, f(1) = 1, f(0) = 0

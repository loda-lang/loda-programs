...
; Formula: a(n) = b(max(7*n-2,0))+1, b(n) = c(n-4), b(7) = 1, b(6) = 0, b(5) = 0, b(4) = 0, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = c(n-1)+c(n-7)+1, c(9) = 7, c(8) = 6, c(7) = 5, c(6) = 4, c(5) = 3, c(4) = 2, c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0

...
; Formula: a(n) = truncate(b(n-2)/2), b(n) = b(n-1)+c(n-1)+A159477((d(n-1)==0)+c(n-1)+1), b(2) = 20, b(1) = 8, b(0) = 0, c(n) = A159477((d(n-1)==0)+c(n-1)+1), c(2) = 7, c(1) = 5, c(0) = 3, d(n) = A159477((d(n-1)==0)+c(n-1)+1), d(2) = 7, d(1) = 5, d(0) = 0

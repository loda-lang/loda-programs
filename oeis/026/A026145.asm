...
; Formula: a(n) = e(n)+1, b(n) = 2*c(n-1)+truncate(b(n-1)/2), b(3) = 73, b(2) = 18, b(1) = 4, b(0) = 0, c(n) = 2*gcd(d(n-1)*b(n-1)-c(n-1)+truncate(b(n-1)/2),4)*c(n-1), c(3) = 64, c(2) = 32, c(1) = 8, c(0) = 2, d(n) = truncate(gcd(d(n-1)*b(n-1)-c(n-1)+truncate(b(n-1)/2),4)/2), d(3) = 0, d(2) = 1, d(1) = 1, d(0) = 0, e(n) = 2*d(n-1)+max(e(n-1),1)+2, e(3) = 11, e(2) = 7, e(1) = 3, e(0) = 0

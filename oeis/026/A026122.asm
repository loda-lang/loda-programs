...
; Formula: a(n) = 2*d(n+1)-e(n+1)-2*b(n+1)+c(n+1), b(n) = c(n-1), b(5) = 15, b(4) = 6, b(3) = 3, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = truncate(((n+1)*(3*c(n-2)+2*c(n-1)))/(n+3)), c(5) = 36, c(4) = 15, c(3) = 6, c(2) = 3, c(1) = 1, c(0) = 1, d(n) = b(n-2), d(5) = 3, d(4) = 1, d(3) = 1, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = b(n-3), e(5) = 1, e(4) = 1, e(3) = 0, e(2) = 0, e(1) = 0, e(0) = 0

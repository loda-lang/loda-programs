...
; Formula: a(n) = e(n+1)+1, b(n) = (-c(n-1)+b(n-1)+1)/2, b(3) = -20, b(2) = -9, b(1) = -3, b(0) = 0, c(n) = 2*gcd((-c(n-1)+b(n-1)+1)/2+d(n-1),4)*c(n-1), c(3) = 256, c(2) = 32, c(1) = 16, c(0) = 8, d(n) = gcd((-c(n-1)+b(n-1)+1)/2+d(n-1),4)/2, d(3) = 2, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = d(n-1)+e(n-1)+3, e(3) = 9, e(2) = 6, e(1) = 3, e(0) = 0

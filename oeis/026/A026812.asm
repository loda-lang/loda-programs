...
; 0,0,0,0,0,0,1,1,2,3,5,7,11,14,20,26,35,44,58,71,90,110,136,163,199,235,282,331,391,454,532,612,709,811,931,1057,1206,1360,1540,1729,1945,2172,2432,2702,3009,3331,3692,4070,4494,4935,5427,5942,6510,7104,7760,8442,9192,9975,10829,11720,12692,13702,14800,15944,17180,18467,19858,21301,22856,24473,26207,28009,29941,31943,34085,36308,38677,41134,43752,46461
; Formula: a(n) = a(n-6)+truncate(((n-6)*((n-6)*((n-6)*(n+24)+310)+180*truncate((n-6)/2)-90*n+1860))/2880)+1, a(5) = 0, a(4) = 0, a(3) = 0, a(2) = 0, a(1) = 0, a(0) = 0

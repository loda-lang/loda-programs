...
; Formula: a(n) = d(n-1)+a(n-1), a(3) = 11, a(2) = 9, a(1) = 7, a(0) = 5, b(n) = (-c(n-1)+b(n-1))/2-2, b(3) = -19, b(2) = -18, b(1) = -16, b(0) = -12, c(n) = c(n-1)*(((-c(n-1)+b(n-1))/2+d(n-1)/2)%2+2), c(3) = 32, c(2) = 16, c(1) = 16, c(0) = 16, d(n) = ((-c(n-1)+b(n-1))/2+d(n-1)/2)%2+3, d(3) = 3, d(2) = 2, d(1) = 2, d(0) = 2

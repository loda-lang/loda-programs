...
; Formula: a(n) = e(n+2), b(n) = (-c(n-1)+b(n-1))/2-2, b(3) = -16, b(2) = -12, b(1) = -4, b(0) = 3, c(n) = c(n-1)*(((-c(n-1)+b(n-1))/2+d(n-1)/2)%2+2), c(3) = 16, c(2) = 16, c(1) = 16, c(0) = 8, d(n) = ((-c(n-1)+b(n-1))/2+d(n-1)/2)%2+3, d(3) = 2, d(2) = 2, d(1) = 3, d(0) = 0, e(n) = d(n-1)+e(n-1), e(3) = 7, e(2) = 5, e(1) = 2, e(0) = 2

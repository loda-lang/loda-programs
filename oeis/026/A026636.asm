...
; Formula: a(n) = b(n+2), b(n) = c(n-1), b(6) = 6, b(5) = 4, b(4) = 2, b(3) = 1, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = c(n-2)+d(n-2), c(6) = 11, c(5) = 6, c(4) = 4, c(3) = 2, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = -c(n-4)+c(n-4)+d(n-1)+d(n-3)+d(n-4)+binomial(b(n-4),c(n-4)), d(6) = 19, d(5) = 11, d(4) = 7, d(3) = 4, d(2) = 3, d(1) = 1, d(0) = 1

...
; Formula: a(n) = -sumdigits(floor((n-1)/2),3)^2-2*truncate((-sumdigits(floor((n-1)/2),3)^2-3*truncate((-sumdigits(floor((n-1)/2),3)^2)/3)+n-1)/2)-3*truncate((-sumdigits(floor((n-1)/2),3)^2)/3)+n

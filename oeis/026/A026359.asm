...
; Formula: a(n) = e(n+1)/2, b(n) = (-c(n-1)+b(n-1))/2, b(3) = -5, b(2) = -2, b(1) = -1, b(0) = 0, c(n) = 2*gcd((-c(n-1)+b(n-1))/2+d(n-1)-3,4)*c(n-1), c(3) = 64, c(2) = 8, c(1) = 4, c(0) = 2, d(n) = gcd((-c(n-1)+b(n-1))/2+d(n-1)-3,4)/2, d(3) = 2, d(2) = 0, d(1) = 0, d(0) = 1, e(n) = d(n-1)+e(n-1)+2, e(3) = 7, e(2) = 5, e(1) = 3, e(0) = 0

...
; Formula: a(n) = b(n+1), b(n) = floor((2*c(n-1)+d(n-1))/n), b(3) = 34, b(2) = 8, b(1) = 2, b(0) = 0, c(n) = c(n-1)+floor((2*c(n-1)+d(n-1))/n), c(3) = 45, c(2) = 11, c(1) = 3, c(0) = 1, d(n) = 10*c(n-1)+5*d(n-1), d(3) = 510, d(2) = 80, d(1) = 10, d(0) = 0

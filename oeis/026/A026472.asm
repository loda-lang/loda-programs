...
; Formula: a(n) = d(n)+1, b(n) = -b(n-1)+5, b(5) = 5, b(4) = 0, b(3) = 5, b(2) = 0, b(1) = 5, b(0) = 0, c(n) = b(n-2)+b(n-4)+c(n-1)+1, c(5) = 23, c(4) = 12, c(3) = 11, c(2) = 5, c(1) = 1, c(0) = 0, d(n) = c(n-1)+1, d(5) = 13, d(4) = 12, d(3) = 6, d(2) = 2, d(1) = 1, d(0) = 0

...
; Formula: a(n) = 3*floor(((2*(-binomial(truncate((sqrtint(8*n-8)-1)/2)+1,2)+n-1)*if((-n+binomial(truncate((sqrtint(8*n-8)-1)/2)+1,2)+truncate((sqrtint(8*n-8)-1)/2)+1)<=(-1),0,2^(-n+binomial(truncate((sqrtint(8*n-8)-1)/2)+1,2)+truncate((sqrtint(8*n-8)-1)/2)+1))+1)^2)/8)+1

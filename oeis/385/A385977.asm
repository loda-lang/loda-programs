...
; Formula: a(n) = 4*truncate(((min(n-1,(n-1)%2)*b(n-1)+c(n-1))*(min(n-1,(n-1)%2)*b(n-1)+c(n-1)+2))/8), b(n) = 29*b(n-2)+24*c(n-2), b(3) = 396, b(2) = 396, b(1) = 12, b(0) = 12, c(n) = 6*b(n-2)+5*c(n-2), c(3) = 82, c(2) = 82, c(1) = 2, c(0) = 2

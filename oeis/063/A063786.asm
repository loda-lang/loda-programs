...
; Formula: a(n) = -truncate(binomial(2*floor((n+2)/6)-2*(((n+2)%6)==0),-(((n+2)%6)==0)+floor((n+2)/6))/(-(((n+2)%6)==0)+floor((n+2)/6)+1))*(((n+2)%6)==0)+floor(binomial(2*floor((n+2)/2)-2,floor((n+2)/2)-1)/floor((n+2)/2))

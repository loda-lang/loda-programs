...
; Formula: a(n) = (c(n+1)*(2*n+2)+d(n+1))/gcd(c(n+1)*(2*n+2),b(n+1)), b(n) = b(n-1)*(2*n-1), b(3) = 30, b(2) = 6, b(1) = 2, b(0) = 2, c(n) = c(n-1)*(2*n-1)+b(n-1), c(3) = 31, c(2) = 5, c(1) = 1, c(0) = -1, d(n) = d(n-1), d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0

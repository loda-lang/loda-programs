...
; Formula: a(n) = b(2*n+1)/3, b(n) = (10*d(n-1)+5*c(n-1)-5*c(n-1)-5*d(n-1))/n, b(3) = 195, b(2) = 60, b(1) = 15, b(0) = 0, c(n) = (10*d(n-1)+5*c(n-1)-5*c(n-1)-5*d(n-1))/n-c(n-1)-d(n-1), c(3) = 51, c(2) = 27, c(1) = 9, c(0) = 3, d(n) = (10*d(n-1)+5*c(n-1)-5*c(n-1)-5*d(n-1))/n+2*d(n-1)+c(n-1), d(3) = 456, d(2) = 117, d(1) = 24, d(0) = 3

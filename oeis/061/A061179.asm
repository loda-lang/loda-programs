...
; Formula: a(n) = b(2*n)/3, b(n) = (8*d(n-1)+4*c(n-1)-4*c(n-1)-4*d(n-1))/n, b(3) = 120, b(2) = 42, b(1) = 12, b(0) = 3, c(n) = (8*d(n-1)+4*c(n-1)-4*c(n-1)-4*d(n-1))/n-c(n-1)-d(n-1), c(3) = 15, c(2) = 15, c(1) = 6, c(0) = 3, d(n) = (8*d(n-1)+4*c(n-1)-4*c(n-1)-4*d(n-1))/n+2*d(n-1)+c(n-1), d(3) = 315, d(2) = 90, d(1) = 21, d(0) = 3

...
; Formula: a(n) = 2*c(n), b(n) = 2*b(n-1)+2*b(n-2)+d(n-1)+d(n-2)+2, b(3) = 69, b(2) = 21, b(1) = 6, b(0) = 2, c(n) = e(n-1)+2, c(3) = 17, c(2) = 6, c(1) = 2, c(0) = 0, d(n) = b(n-1)+d(n-1)+1, d(3) = 32, d(2) = 10, d(1) = 3, d(0) = 0, e(n) = 2*b(n-1)+d(n-1), e(3) = 52, e(2) = 15, e(1) = 4, e(0) = 0

...
; Formula: a(n) = 2*c(n), b(n) = 3*b(n-2)+2*b(n-1)+2*d(n-2)+3, b(3) = 69, b(2) = 21, b(1) = 6, b(0) = 2, c(n) = 2*b(n-2)+d(n-2)+2, c(3) = 17, c(2) = 6, c(1) = 2, c(0) = 0, d(n) = b(n-1)+d(n-1)+1, d(3) = 32, d(2) = 10, d(1) = 3, d(0) = 0

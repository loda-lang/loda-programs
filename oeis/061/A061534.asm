...
; Formula: a(n) = 2*a(n-1)+b(n-1)+c(n-1), a(2) = 9, a(1) = 3, a(0) = 1, b(n) = 3*b(n-1)-b(n-3)+b(n-2), b(4) = 42, b(3) = 13, b(2) = 4, b(1) = 1, b(0) = 0, c(n) = 3*c(n-1)-c(n-3)+c(n-2), c(3) = 22, c(2) = 7, c(1) = 2, c(0) = 1

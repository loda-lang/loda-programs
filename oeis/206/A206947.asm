...
; Formula: a(n) = b(n)-1, b(n) = b(n-1)+d(n-1), b(4) = 15, b(3) = 3, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = -d(n-1)+c(n-1)+e(n-1), c(4) = 10, c(3) = 6, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = f(n-1), d(4) = 56, d(3) = 12, d(2) = 2, d(1) = 0, d(0) = 0, e(n) = 2*e(n-1)+b(n-1)+c(n-1)+1, e(4) = 42, e(3) = 16, e(2) = 6, e(1) = 2, e(0) = 0, f(n) = 4*f(n-1)-d(n-1)+c(n-1)+e(n-1)+2, f(4) = 236, f(3) = 56, f(2) = 12, f(1) = 2, f(0) = 0

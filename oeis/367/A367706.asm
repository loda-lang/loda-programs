...
; Formula: a(n) = 24*b(n)-24*truncate(d(n)/3), b(n) = 8*b(n-1)+4*c(n-1)+7, b(2) = 175, b(1) = 11, b(0) = 0, c(n) = 20*c(n-1), c(2) = 400, c(1) = 20, c(0) = 1, d(n) = 12*b(n-1)+6*c(n-1)+3*d(n-1)+24, d(2) = 366, d(1) = 30, d(0) = 0

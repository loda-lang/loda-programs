...
; Formula: a(n) = truncate(c(n-1)/9), b(n) = 9*b(n-1)+9*d(n-1), b(2) = 225, b(1) = 9, b(0) = -1, c(n) = 10*c(n-1)+9*b(n-1)+9*d(n-1), c(2) = 315, c(1) = 9, c(0) = 0, d(n) = 8*d(n-1), d(2) = 128, d(1) = 16, d(0) = 2

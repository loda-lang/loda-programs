...
; Formula: a(n) = truncate(truncate((binomial(2*n-2*binomial(floor((sqrtint(8*n+8)+1)/2),2)+2,-binomial(floor((sqrtint(8*n+8)+1)/2),2)+n+1)*binomial(floor((sqrtint(8*n+8)+1)/2),-binomial(floor((sqrtint(8*n+8)+1)/2),2)+n+1)^2)/(2*n-2*binomial(floor((sqrtint(8*n+8)+1)/2),2)+1))/2)

...
; Formula: a(n) = 8*truncate(d(n)/6), b(n) = 8*b(n-1)+4*c(n-1)+7, b(2) = 207, b(1) = -5, b(0) = -3, c(n) = 20*c(n-1), c(2) = 1200, c(1) = 60, c(0) = 3, d(n) = 12*b(n-1)+6*c(n-1)+3*d(n-1)+24, d(2) = 342, d(1) = 6, d(0) = 0

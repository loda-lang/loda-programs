...
; Formula: a(n) = 12*d(n-1)+8, b(n) = 2*c(n-1)+2*max(4*b(n-1),2), b(2) = 88, b(1) = 6, b(0) = 0, c(n) = 20*c(n-1), c(2) = 400, c(1) = 20, c(0) = 1, d(n) = 6*c(n-1)+3*d(n-1)+3*max(4*b(n-1),2), d(2) = 228, d(1) = 12, d(0) = 0

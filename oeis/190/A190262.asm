...
; Formula: a(n) = (b(6*n)/(d(6*n)/(10^n)+1))%10, b(n) = b(n-1)+d(n-1), b(3) = 7, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = 6*d(n-2)+4*b(n-2)+2*c(n-2)-((b(n-2)+c(n-2)+d(n-2))%(b(n-2)+d(n-2)))+c(n-1), c(3) = 20, c(2) = 6, c(1) = 2, c(0) = 0, d(n) = 2*d(n-1)+b(n-1)+c(n-1), d(3) = 18, d(2) = 5, d(1) = 1, d(0) = 0

...
; Formula: a(n) = d(n+1)+2, b(n) = truncate(truncate(truncate((-c(n-1)+b(n-1))/2)/2)/gcd(truncate((-c(n-1)+b(n-1))/2)+1,4)), b(3) = -10, b(2) = -10, b(1) = 0, b(0) = 0, c(n) = 4*c(n-1), c(3) = 640, c(2) = 160, c(1) = 40, c(0) = 10, d(n) = d(n-1)+gcd(truncate((-c(n-2)+b(n-2))/2)+1,4)+3, d(3) = 13, d(2) = 9, d(1) = 2, d(0) = 0

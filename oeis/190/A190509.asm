...
; Formula: a(n) = d(n)+2, b(n) = (((-c(n-1)+b(n-1))/2)/2)/gcd((-c(n-1)+b(n-1))/2+1,4), b(3) = -40, b(2) = -10, b(1) = -10, b(0) = 0, c(n) = 4*c(n-1), c(3) = 2560, c(2) = 640, c(1) = 160, c(0) = 40, d(n) = d(n-1)+gcd((-c(n-2)+b(n-2))/2+1,4)+3, d(3) = 20, d(2) = 13, d(1) = 9, d(0) = 2

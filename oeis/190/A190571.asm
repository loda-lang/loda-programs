...
; Formula: a(n) = 2*f(n)+1, b(n) = 2*f(n-1)+b(n-1)+1, b(4) = 26, b(3) = 11, b(2) = 4, b(1) = 1, b(0) = 0, c(n) = -2*f(n-1)+c(n-1)+e(n-1)+1, c(4) = 11, c(3) = 4, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = 2*f(n-1)-e(n-1)+b(n-1)+d(n-1), d(4) = 9, d(3) = 4, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = 5*f(n-1)-c(n-1)+b(n-1)+d(n-1)+2, e(4) = 48, e(3) = 20, e(2) = 7, e(1) = 2, e(0) = 0, f(n) = -f(n-1)+c(n-1)+e(n-1)+1, f(4) = 18, f(3) = 7, f(2) = 3, f(1) = 1, f(0) = 0

...
; Formula: a(n) = (b(5*n)/(d(5*n)/(10^n)+1))%10, b(n) = b(n-1)+d(n-1), b(3) = 6, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = -((b(n-2)+c(n-2)+d(n-2))%b(n-1))+b(n-1)+c(n-1)+d(n-1), c(3) = 8, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = 2*d(n-1)+b(n-1)+c(n-1), d(3) = 13, d(2) = 4, d(1) = 1, d(0) = 0

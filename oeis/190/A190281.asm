...
; Formula: a(n) = -10*truncate(truncate(b(max(4*n-4,0))/(2*truncate(c(max(4*n-4,0))/(10^(n-1)))+1))/10)+truncate(b(max(4*n-4,0))/(2*truncate(c(max(4*n-4,0))/(10^(n-1)))+1)), b(n) = 2*e(n-1)+b(n-1), b(3) = 151, b(2) = 29, b(1) = 11, b(0) = 1, c(n) = b(n-1)+c(n-1), c(3) = 41, c(2) = 12, c(1) = 1, c(0) = 0, d(n) = 2*b(n-1)+2*c(n-1)+d(n-1), d(3) = 108, d(2) = 26, d(1) = 2, d(0) = 0, e(n) = 4*b(n-1)+4*c(n-1)+2*d(n-1)+e(n-1), e(3) = 277, e(2) = 61, e(1) = 9, e(0) = 5

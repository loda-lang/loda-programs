...
; Formula: a(n) = e(n+1), b(n) = c(n-1)+d(n-1)+e(n-2), b(4) = 11, b(3) = 3, b(2) = 3, b(1) = 0, b(0) = 1, c(n) = 2*b(n-1), c(4) = 6, c(3) = 6, c(2) = 0, c(1) = 2, c(0) = 0, d(n) = c(n-1)+d(n-1), d(4) = 8, d(3) = 2, d(2) = 2, d(1) = 0, d(0) = 0, e(n) = c(n-1)+d(n-1)+e(n-1), e(4) = 13, e(3) = 5, e(2) = 3, e(1) = 1, e(0) = 1

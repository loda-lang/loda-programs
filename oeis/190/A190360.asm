...
; Formula: a(n) = d(n+1), b(n) = e(n-1)+truncate((c(n-1)*(-e(n-1)+d(n-1)))/(b(n-1)+e(n-1)+1)), b(3) = 4, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = b(n-1)+e(n-1)+1, c(3) = 8, c(2) = 4, c(1) = 2, c(0) = 1, d(n) = c(n-1)+e(n-1)+truncate((c(n-1)*(-e(n-1)+d(n-1)))/(b(n-1)+e(n-1)+1))-1, d(3) = 7, d(2) = 3, d(1) = 1, d(0) = 0, e(n) = 2*e(n-1)+c(n-1)+truncate((c(n-1)*(-e(n-1)+d(n-1)))/(b(n-1)+e(n-1)+1))-1, e(3) = 12, e(2) = 5, e(1) = 2, e(0) = 1

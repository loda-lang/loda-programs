; A166732: The indices n such that the largest prime factor of n-th composite is equal sum of all the other prime factors of n-th composite, with multiplicity.

...
; Formula: a(n) = 4*d(n-1)+25, b(n) = gcd(-c(n-1)+b(n-1),c(n-1)+d(n-1)), b(2) = 1, b(1) = 1, b(0) = 0, c(n) = b(n-1), c(2) = 1, c(1) = 0, c(0) = 1, d(n) = c(n-1)+d(n-1)+gcd(-c(n-1)+b(n-1),c(n-1)+d(n-1)), d(2) = 4, d(1) = 3, d(0) = 1

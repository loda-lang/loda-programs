...
; Formula: a(n) = c(2*n), b(n) = truncate((b(n-2)^2+4*d(n-1)*b(n-3)*b(n-1))/b(n-4)), b(4) = 57123, b(3) = 1525, b(2) = 113, b(1) = 13, b(0) = 3, c(n) = b(n-1), c(4) = 1525, c(3) = 113, c(2) = 13, c(1) = 3, c(0) = 1, d(n) = 8*d(n-1)-3*truncate((8*d(n-1))/3), d(4) = 1, d(3) = 2, d(2) = 1, d(1) = 2, d(0) = 1

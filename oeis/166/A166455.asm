...
; Formula: a(n) = binomial(floor((sqrtint(8*n+2)-1)/2),-binomial(-floor((sqrtint(8*n+2)-1)/2),2)+n)+bitor(binomial(-floor((sqrtint(8*n+2)-1)/2),2)>=0,binomial(floor((sqrtint(8*n+2)-1)/2),-binomial(-floor((sqrtint(8*n+2)-1)/2),2)+n))-1

...
; Formula: a(n) = d(n+1), b(n) = b(n-1)+b(n-2), b(5) = 8, b(4) = 5, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = c(n-1)+c(n-2), c(6) = 8, c(5) = 5, c(4) = 3, c(3) = 2, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = c(n-1)+d(n-1)+d(n-2)+truncate((e(n-3)-1)/b(n-3)), d(5) = 5, d(4) = 2, d(3) = 1, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = truncate((e(n-1)-1)/b(n-1)), e(5) = 0, e(4) = 0, e(3) = -1, e(2) = -2, e(1) = -1, e(0) = 0

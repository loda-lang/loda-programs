...
; Formula: a(n) = e(n+1), b(n) = b(n-1)+b(n-2), b(5) = 8, b(4) = 5, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = (f(n-2)-1)/b(n-2)+c(n-2)+d(n-2), c(5) = 2, c(4) = 0, c(3) = -1, c(2) = -1, c(1) = 0, c(0) = 0, d(n) = b(n-1)+c(n-1)+d(n-1), d(5) = 10, d(4) = 5, d(3) = 3, d(2) = 2, d(1) = 1, d(0) = 0, e(n) = c(n-1)+d(n-1), e(5) = 5, e(4) = 2, e(3) = 1, e(2) = 1, e(1) = 0, e(0) = 0, f(n) = (f(n-1)-1)/b(n-1), f(5) = 0, f(4) = 0, f(3) = -1, f(2) = -2, f(1) = -1, f(0) = 0

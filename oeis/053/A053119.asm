...
; Formula: a(n) = binomial(-binomial(floor((sqrtint(8*n+8)+1)/2),2)-floor((sqrtint(8*n+8)+1)/2)+n,truncate((-binomial(floor((sqrtint(8*n+8)+1)/2),2)+n)/2))*(binomial(-1,-binomial(floor((sqrtint(8*n+8)+1)/2),2)+n)==1)

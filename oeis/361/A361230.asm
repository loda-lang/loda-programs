...
; Formula: a(n) = a(n-1)+d(n-1), a(3) = 16, a(2) = 6, a(1) = 1, a(0) = 0, b(n) = 2*d(n-1)+a(n-1)+1, b(3) = 27, b(2) = 12, b(1) = 3, b(0) = 0, c(n) = -d(n-1)+c(n-1)+1, c(3) = -13, c(2) = -4, c(1) = 0, c(0) = 0, d(n) = (-c(n-1)+b(n-1))/(a(n-1)+d(n-1))+a(n-1)+c(n-1)+d(n-1)+4, d(3) = 17, d(2) = 10, d(1) = 5, d(0) = 1

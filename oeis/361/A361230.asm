...
; Formula: a(n) = a(n-1)+c(n-1), a(3) = 16, a(2) = 6, a(1) = 1, a(0) = 0, b(n) = -c(n-1)+b(n-1)+1, b(3) = -13, b(2) = -4, b(1) = 0, b(0) = 0, c(n) = (2*c(n-2)-b(n-1)+a(n-2)+1)/(a(n-1)+c(n-1))+a(n-1)+b(n-1)+c(n-1)+4, c(3) = 17, c(2) = 10, c(1) = 5, c(0) = 1

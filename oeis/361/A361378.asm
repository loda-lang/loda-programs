...
; Formula: a(n) = b(n+2), b(n) = 2*b(n-4)-b(n-1)+b(n-3)+d(n-4), b(5) = 3, b(4) = 2, b(3) = 1, b(2) = 0, b(1) = 3, b(0) = 0, c(n) = b(n-1), c(5) = 2, c(4) = 1, c(3) = 0, c(2) = 3, c(1) = 0, c(0) = 1, d(n) = 2*b(n-1)-c(n-1)+d(n-1), d(5) = 7, d(4) = 4, d(3) = 2, d(2) = 5, d(1) = -1, d(0) = 0

...
; Formula: a(n) = truncate(b(n-1)/2)+1, b(n) = -2*truncate((c(n-1)+1)/2)+b(n-1)+c(n-1)+A054844(b(n-1)+2), b(1) = 2, b(0) = 0, c(n) = -2*truncate((c(n-1)+1)/2)+c(n-1)+A054844(b(n-1)+2), c(1) = 2, c(0) = 0

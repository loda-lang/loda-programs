...
; 1,1,1,9,1,1,1,3,8,1,1,9,1,1,1,81,1,8,1,9,1,1,1,3,18,1,16,9,1,1,1,81,1,1,1,72,1,1,1,3,1,1,1,9,8,1,1,81,32,18,1,9,1,16,1,3,1,1,1,9,1,1,8,729,1,1,1,9,1,1,1,24,1,1,18,9,1,1,1,81
; Formula: a(n) = truncate(A003959(n+1)/gcd(A034448(n+1),A003959(n+1)))

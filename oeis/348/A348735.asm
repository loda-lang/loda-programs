...
; 1,1,1,5,1,1,1,1,5,1,1,5,1,1,1,17,1,5,1,5,1,1,1,1,13,1,7,5,1,1,1,11,1,1,1,25,1,1,1,1,1,1,1,5,5,1,1,17,25,13,1,5,1,7,1,1,1,1,1,5,1,1,5,65,1,1,1,5,1,1,1,5,1,1,13,5,1,1,1,17
; Formula: a(n) = truncate(A034448(n+1)/gcd(A003959(n+1),A034448(n+1)))

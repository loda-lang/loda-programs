...
; 1,1,1,6,1,6,1,2,3,6,3,18,1,2,3,6,9,18,1,2,3,6,9,18,1,2,3,6,9,18,1,2,1,6,1,6,1,2,3,6,3,18,1,2,3,6,9,18,1,2,3,6,9,18,1,2,3,6,9,18,1,2,1,6,1,6,1,2,3,6,3,18,1,2,3,6,9,18,1,2
; Formula: a(n) = gcd(A348949(n),A276086(n))

...
; Formula: a(n) = e(n+1), b(n) = b(n-1)==d(n-1), b(4) = 1, b(3) = 0, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = (-(b(n-1)==d(n-1))+c(n-1))^(n-1)*(b(n-1)==d(n-1)), c(4) = -1, c(3) = 0, c(2) = 0, c(1) = 1, c(0) = 0, d(n) = (-(b(n-1)==d(n-1))+c(n-1))^(n-1), d(4) = -1, d(3) = 0, d(2) = 0, d(1) = 1, d(0) = 0, e(n) = (-(b(n-1)==d(n-1))+c(n-1))^(n-1)*(b(n-1)==d(n-1))+e(n-1)*(n-1), e(4) = 5, e(3) = 2, e(2) = 1, e(1) = 1, e(0) = 0

...
; 1,1,1,5,1,1,1,3,10,1,1,5,1,1,1,17,1,10,1,5,1,1,1,3,26,1,7,5,1,1,1,11,1,1,1,50,1,1,1,3,1,1,1,5,10,1,1,17,50,26,1,5,1,7,1,3,1,1,1,5,1,1,10,65,1,1,1,5,1,1,1,6,1,1,26,5,1,1,1,17
; Formula: a(n) = truncate(A034448(n+1)/gcd(A034448(n+1),A000203(n+1)))

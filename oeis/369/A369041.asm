...
; Formula: a(n) = (gcd(bitxor(n+1,floor((n+1)/2)),truncate(2^bitxor(n+1,floor((n+1)/2)))-2)-1)*(-2*truncate((A143731(bitxor(n+1,floor((n+1)/2)))+1)/2)+A143731(bitxor(n+1,floor((n+1)/2)))+1)+1

...
; Formula: a(n) = b(n+2), b(n) = c(n-5)/4+c(n-2)+2, b(9) = 57, b(8) = 32, b(7) = 18, b(6) = 10, b(5) = 6, b(4) = 3, b(3) = 2, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = c(n-5)/4+c(n-7)/4+c(n-1)+c(n-2)+c(n-4)+4, c(10) = 303, c(9) = 170, c(8) = 95, c(7) = 53, c(6) = 29, c(5) = 16, c(4) = 8, c(3) = 4, c(2) = 1, c(1) = 0, c(0) = 0

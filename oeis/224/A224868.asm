...
; Formula: a(n) = min(n+6,(n+6)%2)*c(n+6)+b(n+6)-2, b(n) = 2*b(n-4)+b(n-2)+b(n-6), b(7) = 6, b(6) = 6, b(5) = 3, b(4) = 3, b(3) = 1, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = 2*c(n-4)+c(n-2)+c(n-6), c(9) = 6, c(8) = 6, c(7) = 3, c(6) = 3, c(5) = 1, c(4) = 1, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0

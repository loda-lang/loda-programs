...
; Formula: a(n) = e(max(n-2,0))/2, b(n) = 2*b(n-1)+c(n-1)+2, b(5) = 128, b(4) = 52, b(3) = 20, b(2) = 7, b(1) = 2, b(0) = 0, c(n) = 2*c(n-1)+2, c(6) = 94, c(5) = 46, c(4) = 22, c(3) = 10, c(2) = 4, c(1) = 1, c(0) = 0, d(n) = 2*d(n-1)+b(n-1)+2, d(5) = 198, d(4) = 72, d(3) = 25, d(2) = 8, d(1) = 2, d(0) = 0, e(n) = 2*d(n-1)+2*e(n-1)+4, e(5) = 464, e(4) = 158, e(3) = 52, e(2) = 16, e(1) = 4, e(0) = 0

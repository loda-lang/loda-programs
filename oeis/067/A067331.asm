...
; Formula: a(n) = b(n+4)-1, b(n) = b(n-2)+c(n-2), b(5) = 6, b(4) = 3, b(3) = 1, b(2) = 1, b(1) = 0, b(0) = 1, c(n) = -e(n-1)+b(n-1)+c(n-1)+d(n-1)+e(n-1)+f(n-1)-1, c(5) = 20, c(4) = 10, c(3) = 5, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = e(n-1)+1, d(5) = 5, d(4) = 3, d(3) = 2, d(2) = 1, d(1) = 1, d(0) = 1, e(n) = -e(n-1)+d(n-1)+e(n-1)+f(n-1)-1, e(5) = 7, e(4) = 4, e(3) = 2, e(2) = 1, e(1) = 0, e(0) = 0, f(n) = d(n-1)+f(n-1), f(5) = 8, f(4) = 5, f(3) = 3, f(2) = 2, f(1) = 1, f(0) = 0

...
; Formula: a(n) = (-n+binomial(floor((sqrtint(8*n)-1)/2)+1,2)+floor((sqrtint(8*n)-1)/2)+2)*10^(logint(-binomial(floor((sqrtint(8*n)-1)/2)+1,2)+n,10)+1)-binomial(floor((sqrtint(8*n)-1)/2)+1,2)+n

...
; Formula: a(n) = d(n+1), b(n) = b(n-1)+b(n-2)+e(n-2)+2, b(3) = 13, b(2) = 6, b(1) = 2, b(0) = 1, c(n) = b(n-1)+e(n-1), c(3) = 12, c(2) = 5, c(1) = 2, c(0) = -1, d(n) = 2*b(n-1)+c(n-1)+2, d(3) = 19, d(2) = 8, d(1) = 3, d(0) = 0, e(n) = e(n-1)+e(n-2)+2, e(3) = 11, e(2) = 6, e(1) = 3, e(0) = 1

...
; Formula: a(n) = binomial(max(-n+binomial(floor((sqrtint(8*n)+1)/2),2)+floor((sqrtint(8*n)+1)/2)+2,-binomial(floor((sqrtint(8*n)+1)/2),2)+n+1),-max(-n+binomial(floor((sqrtint(8*n)+1)/2),2)+floor((sqrtint(8*n)+1)/2)+2,-binomial(floor((sqrtint(8*n)+1)/2),2)+n+1)+floor((sqrtint(8*n)+1)/2)+3)

...
; Formula: a(n) = floor(sqrtint(32*if((if((n%4)==0,n/4,n)%2)==0,if((n%4)==0,n/4,n)/2,if((n%4)==0,n/4,n))+32*binomial(A118235(if((if((n%4)==0,n/4,n)%2)==0,if((n%4)==0,n/4,n)/2,if((n%4)==0,n/4,n))),2)+4)/4)+1

...
; Formula: a(n) = a(n-1)+b(n-1)+c(n-1)+d(n-1)+e(n-1), a(4) = 868, a(3) = 340, a(2) = 132, a(1) = 52, a(0) = 20, b(n) = b(n-1)+e(n-1), b(4) = 246, b(3) = 94, b(2) = 38, b(1) = 14, b(0) = 6, c(n) = b(n-1)+d(n-1)+e(n-1), c(4) = 376, c(3) = 152, c(2) = 56, c(1) = 24, c(0) = 8, d(n) = -b(n-1)-d(n-1)-e(n-1)+a(n-1)+b(n-1)+c(n-1)+e(n-1), d(4) = 362, d(3) = 130, d(2) = 58, d(1) = 18, d(0) = 10, e(n) = b(n-1)+d(n-1)+e(n-1), e(4) = 376, e(3) = 152, e(2) = 56, e(1) = 24, e(0) = 8

...
; Formula: a(n) = 8*max(b(n-2),1)+4*c(n-2)+4*d(n-2)+c(n-2)+max(b(n-2),1), a(4) = 11808, a(3) = 2160, a(2) = 396, a(1) = 72, a(0) = 14, b(n) = 2*c(n-1), b(4) = 10496, b(3) = 1920, b(2) = 352, b(1) = 64, b(0) = 12, c(n) = 4*max(b(n-1),1)+2*c(n-1)+2*d(n-1), c(4) = 28672, c(3) = 5248, c(2) = 960, c(1) = 176, c(0) = 32, d(n) = 4*max(b(n-1),1)+2*c(n-1)+2*d(n-1), d(4) = 28672, d(3) = 5248, d(2) = 960, d(1) = 176, d(0) = 32

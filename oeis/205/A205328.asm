...
; Formula: a(n) = b(n+2), b(n) = 8*max(c(n-2),1)+4*d(n-2)+4*e(n-2)+d(n-2)+max(c(n-2),1), b(4) = 396, b(3) = 72, b(2) = 14, b(1) = 2, b(0) = 0, c(n) = 2*d(n-1), c(4) = 352, c(3) = 64, c(2) = 12, c(1) = 2, c(0) = 0, d(n) = 4*max(c(n-1),1)+2*d(n-1)+2*e(n-1), d(4) = 960, d(3) = 176, d(2) = 32, d(1) = 6, d(0) = 1, e(n) = 4*max(c(n-1),1)+2*d(n-1)+2*e(n-1), e(4) = 960, e(3) = 176, e(2) = 32, e(1) = 6, e(0) = 0

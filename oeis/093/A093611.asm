...
; Formula: a(n) = (-3*truncate(b(n-1)/3)+b(n-1))*(-c(n-1)+b(n-1))+c(n-1), a(2) = 3, a(1) = 1, a(0) = 0, b(n) = (-3*truncate(b(n-1)/3)+b(n-1))*(-c(n-1)+b(n-1))+b(n-1), b(2) = 4, b(1) = 2, b(0) = 1, c(n) = -c(n-1)+b(n-1), c(2) = 1, c(1) = 1, c(0) = 0

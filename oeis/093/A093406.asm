...
; Formula: a(n) = c(n+3), b(n) = b(n-1)+e(n-2), b(4) = 4, b(3) = 1, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = 2*b(n-1)+c(n-1), c(4) = 3, c(3) = 1, c(2) = 1, c(1) = 1, c(0) = 1, d(n) = c(n-1)+d(n-1), d(4) = 4, d(3) = 3, d(2) = 2, d(1) = 1, d(0) = 0, e(n) = c(n-1)+d(n-1)+e(n-1), e(4) = 10, e(3) = 6, e(2) = 3, e(1) = 1, e(0) = 0

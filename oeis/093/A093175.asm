...
; Formula: a(n) = -d(n-1)+b(n-1)+c(n-1)+a(n-1), a(4) = 30, a(3) = 16, a(2) = 9, a(1) = 4, a(0) = 1, b(n) = 2*c(n-2)-b(n-2)-c(n-2)-2*d(n-2)+b(n-2)+d(n-2)+a(n-2), b(4) = 13, b(3) = 5, b(2) = 3, b(1) = 4, b(0) = 1, c(n) = -d(n-1)+b(n-1)+c(n-1)+a(n-1), c(4) = 30, c(3) = 16, c(2) = 9, c(1) = 4, c(0) = 0, d(n) = -d(n-1)+b(n-1)+c(n-1), d(4) = 14, d(3) = 7, d(2) = 5, d(1) = 3, d(0) = -2

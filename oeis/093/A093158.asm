...
; Formula: a(n) = (((c(n+2)+d(n+2))/gcd(c(n+2),b(n+2)))/gcd(n+2,(c(n+2)+d(n+2))/gcd(c(n+2),b(n+2))))/gcd(((c(n+2)+d(n+2))/gcd(c(n+2),b(n+2)))/gcd(n+2,(c(n+2)+d(n+2))/gcd(c(n+2),b(n+2))),(n+3)^2), b(n) = n*b(n-1), b(3) = 12, b(2) = 4, b(1) = 2, b(0) = 2, c(n) = n*c(n-1)+b(n-1), c(3) = 22, c(2) = 6, c(1) = 2, c(0) = 0, d(n) = d(n-1), d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0

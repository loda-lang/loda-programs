...
; Formula: a(n) = truncate(2^truncate((truncate((4*n-2)/3)+1)/2))*(-2*truncate((truncate((4*n-2)/3)+1)/2)+truncate((4*n-2)/3)+3)+2*truncate((truncate((4*n-2)/3)+1)/2)-truncate((4*n-2)/3)-1

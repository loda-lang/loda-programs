...
; Formula: a(n) = 4*c(n-1)+2*d(n-1)+1, a(4) = 69, a(3) = 19, a(2) = 5, a(1) = 1, a(0) = 0, b(n) = 2*b(n-1), b(4) = 16, b(3) = 8, b(2) = 4, b(1) = 2, b(0) = 1, c(n) = b(n-1)+a(n-1)+a(n-2), c(4) = 32, c(3) = 10, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = 2*c(n-1)+a(n-1)+d(n-1), d(4) = 53, d(3) = 14, d(2) = 3, d(1) = 0, d(0) = 0

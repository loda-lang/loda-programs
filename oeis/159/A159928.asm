...
; Formula: a(n) = b(n)+1, b(n) = (max(d(n-1)-1,0)+2)*(c(n-1)+1)+b(n-1), b(2) = 14, b(1) = 2, b(0) = 0, c(n) = (max(d(n-1)-1,0)+2)*(c(n-1)+1)+2*c(n-1)-c(n-2), c(3) = 109, c(2) = 18, c(1) = 3, c(0) = 0, d(n) = max(d(n-1)-1,0)+2, d(2) = 3, d(1) = 2, d(0) = 0

...
; Formula: a(n) = c(n+1)/2, b(n) = (2*n*b(n-1)+2*c(n-1)-d(n-1))/2, b(3) = 19, b(2) = 4, b(1) = 1, b(0) = 1, c(n) = 2*n*b(n-1)+c(n-1), c(3) = 30, c(2) = 6, c(1) = 2, c(0) = 0, d(n) = -c(n-1)+d(n-1), d(3) = -8, d(2) = -2, d(1) = 0, d(0) = 0

...
; Formula: a(n) = -d(n)+e(n)+2, b(n) = 2*d(n-1)+2*f(n-1)-e(n-1)-1, b(4) = 1, b(3) = -1, b(2) = -2, b(1) = -1, b(0) = 0, c(n) = -b(n-1)+c(n-1)+e(n-1)+1, c(4) = 27, c(3) = 11, c(2) = 4, c(1) = 1, c(0) = 0, d(n) = -e(n-1)+b(n-1)-1, d(4) = -16, d(3) = -7, d(2) = -3, d(1) = -1, d(0) = 0, e(n) = 3*d(n-1)+2*f(n-1)-2*b(n-1)+c(n-1)+e(n-1)+1, e(4) = 37, e(3) = 14, e(2) = 4, e(1) = 1, e(0) = 0, f(n) = -2*b(n-1)+c(n-1)+d(n-1)+e(n-1)+f(n-1)+1, f(4) = 36, f(3) = 15, f(2) = 5, f(1) = 1, f(0) = 0

...
; Formula: a(n) = f1(n)+1, b(n) = c(n-1), b(7) = 9, b(6) = 3, b(5) = -1, b(4) = -2, b(3) = -1, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = -binomial(c(n-3),c(n-2))+d(n-2), c(7) = 23, c(6) = 9, c(5) = 3, c(4) = -1, c(3) = -2, c(2) = -1, c(1) = 0, c(0) = 0, d(n) = -binomial(b(n-1),c(n-1))+d(n-1)+e(n-1)+f(n-1), d(7) = 127, d(6) = 54, d(5) = 22, d(4) = 9, d(3) = 2, d(2) = -1, d(1) = -1, d(0) = 0, e(n) = d(n-1)+e(n-1)+2, e(9) = 527, e(8) = 227, e(7) = 98, e(6) = 42, e(5) = 18, e(4) = 7, e(3) = 3, e(2) = 2, e(1) = 1, e(0) = 0, f(n) = e(n-1)+f(n-1), f(7) = 73, f(6) = 31, f(5) = 13, f(4) = 6, f(3) = 3, f(2) = 1, f(1) = 0, f(0) = 0, f1(n) = -binomial(b(n-1),c(n-1))+d(n-1)+e(n-1)+f(n-1)+1, f1(7) = 128, f1(6) = 55, f1(5) = 23, f1(4) = 10, f1(3) = 3, f1(2) = 0, f1(1) = 0, f1(0) = 0

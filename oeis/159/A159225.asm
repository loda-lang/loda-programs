...
; Formula: a(n) = truncate(d(n+3)/4)-1, b(n) = 2*b(n-1)+2, b(3) = 14, b(2) = 6, b(1) = 2, b(0) = 0, c(n) = -2*truncate((c(n-1)+1)/2)+c(n-1)+1, c(3) = 1, c(2) = 0, c(1) = 1, c(0) = 0, d(n) = e(n-1)*(c(n-1)+1)+2*b(n-1)+e(n-1)+2, d(3) = 34, d(2) = 12, d(1) = 2, d(0) = 0, e(n) = e(n-1)*(c(n-1)+1)+2*b(n-1)+2, e(3) = 24, e(2) = 10, e(1) = 2, e(0) = 0

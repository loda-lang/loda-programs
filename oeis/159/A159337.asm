...
; Formula: a(n) = b(n+1)/2, b(n) = 2*(((b(n-1)+d(n-1))/(c(n-1)+f(n-1))+c(n-1)+f(n-1))/2), b(4) = 22, b(3) = 8, b(2) = 4, b(1) = 2, b(0) = 1, c(n) = b(n-1)+c(n-1)+e(n-1), c(4) = 30, c(3) = 14, c(2) = 6, c(1) = 2, c(0) = 0, d(n) = 2*d(n-1)+b(n-1), d(4) = 32, d(3) = 12, d(2) = 4, d(1) = 1, d(0) = 0, e(n) = b(n-1)+e(n-1), e(4) = 16, e(3) = 8, e(2) = 4, e(1) = 2, e(0) = 1, f(n) = c(n-1)+f(n-1), f(4) = 23, f(3) = 9, f(2) = 3, f(1) = 1, f(0) = 1

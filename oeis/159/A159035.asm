...
; Formula: a(n) = a(n-1)+c(n-1)+max(2*b(n-1)-1,0), a(2) = 2, a(1) = 1, a(0) = 1, b(n) = 2*b(n-1)-2*max(2*b(n-2)-1,0)+max(2*b(n-1)-1,0)+max(2*b(n-3)-1,0), b(4) = 9, b(3) = 3, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = 2*c(n-1)+max(2*b(n-2)-1,0), c(3) = 4, c(2) = 2, c(1) = 1, c(0) = 0

...
; Formula: a(n) = b(n)/2, b(n) = 2*(((b(n-1)%68+d(n-1))/(c(n-1)+f(n-1))+c(n-1)+f(n-1))/2), b(4) = 54, b(3) = 22, b(2) = 8, b(1) = 4, b(0) = 2, c(n) = b(n-1)+c(n-1)+e(n-1), c(4) = 68, c(3) = 30, c(2) = 14, c(1) = 6, c(0) = 2, d(n) = b(n-1)%68+2*d(n-1), d(4) = 86, d(3) = 32, d(2) = 12, d(1) = 4, d(0) = 1, e(n) = b(n-1)+e(n-1), e(4) = 38, e(3) = 16, e(2) = 8, e(1) = 4, e(0) = 2, f(n) = c(n-1)+f(n-1), f(4) = 53, f(3) = 23, f(2) = 9, f(1) = 3, f(0) = 1

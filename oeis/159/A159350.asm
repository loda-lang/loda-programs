...
; Formula: a(n) = -c(n)+e(n)+1, b(n) = 2*d(n-1)+2*f(n-1)-b(n-1), b(4) = 6, b(3) = 2, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = -b(n-1)+c(n-1)+e(n-1)+1, c(4) = 16, c(3) = 7, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = -e(n-1)+b(n-1)-1, d(4) = -9, d(3) = -4, d(2) = -2, d(1) = -1, d(0) = 0, e(n) = 3*d(n-1)+2*e(n-1)+2*f(n-1)-3*b(n-1)+c(n-1)+1, e(4) = 26, e(3) = 10, e(2) = 3, e(1) = 1, e(0) = 0, f(n) = -2*b(n-1)+c(n-1)+d(n-1)+e(n-1)+f(n-1)+1, f(4) = 18, f(3) = 8, f(2) = 3, f(1) = 1, f(0) = 0

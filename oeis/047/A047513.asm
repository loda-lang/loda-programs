...
; Formula: a(n) = a(n-1)+gcd(b(n-1)+c(n-1)+a(n-1),2), a(3) = 4, a(2) = 2, a(1) = 1, a(0) = 0, b(n) = 4*b(n-1)+2*c(n-1)+2*d(n-1)+d(n-1), b(3) = 64, b(2) = 11, b(1) = 2, b(0) = 0, c(n) = a(n-1), c(3) = 2, c(2) = 1, c(1) = 0, c(0) = 1, d(n) = 2*b(n-1)+2*d(n-1)+c(n-1), d(3) = 35, d(2) = 6, d(1) = 1, d(0) = 0

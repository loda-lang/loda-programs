...
; Formula: a(n) = 2*truncate(b(n+1)/3)+1, b(n) = 7*b(n-1)-6*b(n-3)+b(n-2)+b(n-5)+3, b(10) = 77062311, b(9) = 10975776, b(8) = 1563249, b(7) = 222648, b(6) = 31710, b(5) = 4515, b(4) = 642, b(3) = 90, b(2) = 12, b(1) = 0, b(0) = 0

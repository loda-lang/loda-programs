...
; Formula: a(n) = d(n)+1, b(n) = b(n-1)+c(n-1), b(3) = 3, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = e(n-1), c(3) = 12, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = 3*d(n-1)+b(n-1), d(3) = 13, d(2) = 4, d(1) = 1, d(0) = 0, e(n) = 4*e(n-1)+2*d(n-1)-c(n-1)+2, e(3) = 56, e(2) = 12, e(1) = 2, e(0) = 0

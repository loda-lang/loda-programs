...
; Formula: a(n) = truncate(d(n-1)/7), b(n) = b(n-2)+b(n-3), b(3) = 1, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = c(n-2)+c(n-3), c(5) = 2, c(4) = 1, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 1, d(n) = d(n-1)*(b(n-1)+c(n-1)), d(3) = 14, d(2) = 7, d(1) = 7, d(0) = 7

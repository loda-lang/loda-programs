...
; Formula: a(n) = b(n)+1, b(n) = 4*e(n-1)+3*b(n-1)+3*d(n-1)+2*c(n-1)+8, b(3) = 300, b(2) = 50, b(1) = 8, b(0) = 0, c(n) = b(n-1)+c(n-1)+d(n-1)+e(n-1)+2, c(3) = 100, c(2) = 16, c(1) = 2, c(0) = 0, d(n) = 2*e(n-1)+b(n-1)+c(n-1)+d(n-1)+2, d(3) = 114, d(2) = 18, d(1) = 2, d(0) = 0, e(n) = b(n-1)+d(n-1)+e(n-1)+2, e(3) = 84, e(2) = 14, e(1) = 2, e(0) = 0

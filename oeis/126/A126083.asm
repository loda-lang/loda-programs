...
; Formula: a(n) = -truncate(truncate((b(n+1)+c(n+1))/gcd(c(n+1),d(n+1)))/(n+1))*(n+1)+truncate((b(n+1)+c(n+1))/gcd(c(n+1),d(n+1))), b(n) = b(n-1), b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = n*c(n-1)+d(n-1), c(3) = 22, c(2) = 6, c(1) = 2, c(0) = 0, d(n) = n*d(n-1), d(3) = 12, d(2) = 4, d(1) = 2, d(0) = 2

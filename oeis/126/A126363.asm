...
; Formula: a(n) = 2*e(n)+1, b(n) = 2*b(n-1)+c(n-1)+1, b(4) = 75, b(3) = 26, b(2) = 9, b(1) = 3, b(0) = 1, c(n) = b(n-1)+d(n-1), c(4) = 65, c(3) = 22, c(2) = 7, c(1) = 2, c(0) = 0, d(n) = 1*b(n-2)+2*d(n-1)+2*d(n-2)+2, d(4) = 115, d(3) = 39, d(2) = 13, d(1) = 4, d(0) = 1, e(n) = 3*b(n-1)+c(n-1)+1, e(4) = 101, e(3) = 35, e(2) = 12, e(1) = 4, e(0) = 0

...
; Formula: a(n) = (b(n+1)+d(n+1))/gcd(d(n+1),b(n+1)+d(n+1)), b(n) = b(n-2)*(c(n-2)+2), b(5) = 8, b(4) = 8, b(3) = 2, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = c(n-2)+2, c(5) = 4, c(4) = 4, c(3) = 2, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = d(n-2)*(c(n-2)+1)+b(n-2), d(5) = 5, d(4) = 5, d(3) = 1, d(2) = 1, d(1) = 0, d(0) = 0

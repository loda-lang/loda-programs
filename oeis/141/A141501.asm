...
; Formula: a(n) = A114567(A034729(n+1))

add $0,1
seq $0,34729 ; a(n) = Sum_{ k, k|n } 2^(k-1).
seq $0,114567 ; a(n) is the number k such that the binary expansion of n mod 2^k is the postorder traversal of a binary tree, where 1 indicates a node and 0 indicates there are no children on that side.

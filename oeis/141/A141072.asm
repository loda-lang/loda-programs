...
; Formula: a(n) = f(n)/2+1, b(n) = (-e(n-1)*c(n-1)+d(n-1))/(b(n-1)+f(n-1)+1), b(4) = 0, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = b(n-1)+f(n-1)+1, c(4) = 5, c(3) = 3, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = (-e(n-1)*c(n-1)+d(n-1))/(b(n-1)+f(n-1)+1), d(4) = 0, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = (-e(n-1)*c(n-1)+d(n-1))/(b(n-1)+f(n-1)+1)+c(n-1), e(4) = 3, e(3) = 1, e(2) = 1, e(1) = 0, e(0) = 0, f(n) = 2*c(n-1)+f(n-1), f(4) = 10, f(3) = 4, f(2) = 2, f(1) = 0, f(0) = 0

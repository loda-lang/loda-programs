...
; Formula: a(n) = if((-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n)<=(-1),0,3^(-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n))+truncate((3*binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+3*floor((sqrtint(8*n+8)-1)/2)-3*n)/2)*if((-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n)<=(-1),0,3^(-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n))

...
; Formula: a(n) = 2*max(d(n),2)+4, b(n) = b(n-1)+c(n-1)+d(n-1)+4, b(2) = 15, b(1) = 4, b(0) = 0, c(n) = 4*d(n-1)+3*c(n-1)-b(n-1)+5, c(2) = 24, c(1) = 5, c(0) = 0, d(n) = 3*d(n-1)+2*c(n-1)-b(n-1)+2, d(2) = 14, d(1) = 2, d(0) = 0

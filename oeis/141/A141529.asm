...
; Formula: a(n) = A000040(-min(n,n%11)+b(n)), b(n) = b(n-11), b(21) = 10, b(20) = 10, b(19) = 10, b(18) = 10, b(17) = 10, b(16) = 10, b(15) = 10, b(14) = 10, b(13) = 10, b(12) = 10, b(11) = 10, b(10) = 10, b(9) = 10, b(8) = 10, b(7) = 10, b(6) = 10, b(5) = 10, b(4) = 10, b(3) = 10, b(2) = 10, b(1) = 10, b(0) = 10

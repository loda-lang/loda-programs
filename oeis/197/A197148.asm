...
; Formula: a(n) = (b(4*n)/(c(4*n)/(10^n)))%10, b(n) = 2*b(n-1)+2*c(n-1)+2*d(n-1), b(2) = 20, b(1) = 4, b(0) = 1, c(n) = 2*c(n-1)+b(n-1)+d(n-1), c(2) = 13, c(1) = 3, c(0) = 1, d(n) = 3*c(n-1)+3*d(n-1), d(2) = 18, d(1) = 3, d(0) = 0

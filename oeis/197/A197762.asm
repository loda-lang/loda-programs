...
; Formula: a(n) = floor(b(3*n+4)/floor(c(3*n+4)/(10^(n+1))))%10, b(n) = 6*b(n-1)+4*b(n-3)-b(n-4)-7*b(n-2), b(6) = 17844, b(5) = 3816, b(4) = 816, b(3) = 174, b(2) = 36, b(1) = 6, b(0) = 0, c(n) = 6*c(n-1)+4*c(n-3)-c(n-4)-7*c(n-2), c(5) = 4854, c(4) = 1038, c(3) = 222, c(2) = 48, c(1) = 12, c(0) = 6

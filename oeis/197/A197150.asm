...
; Formula: a(n) = (((-c(3*n)+b(3*n))/(c(3*n)/(10^n)+1)-1)%10+10)%10, b(n) = 6*b(n-1)+4*c(n-1)+2*d(n-1), b(2) = -504, b(1) = -42, b(0) = -7, c(n) = 6*b(n-1)+4*c(n-1)+2*c(n-1)+2*d(n-1), c(2) = -588, c(1) = -42, c(0) = 0, d(n) = 6*b(n-1)+4*c(n-1)+2*c(n-1)+2*d(n-1)+c(n-1)+d(n-1), d(2) = -672, d(1) = -42, d(0) = 0

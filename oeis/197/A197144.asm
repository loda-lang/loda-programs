...
; Formula: a(n) = (b(4*n)/(c(4*n)/(10^n)+1))%10, b(n) = 4*b(n-1)+4*c(n-1)+4*d(n-1)+2*c(n-1), b(2) = 120, b(1) = 12, b(0) = 3, c(n) = 8*c(n-1)+4*b(n-1)+4*d(n-1), c(2) = 144, c(1) = 12, c(0) = 0, d(n) = c(n-1)+d(n-1), d(2) = 12, d(1) = 0, d(0) = 0

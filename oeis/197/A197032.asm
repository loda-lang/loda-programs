...
; Formula: a(n) = (b(5*n)/(e(5*n)/(10^n)+1))%10, b(n) = b(n-1)+e(n-1), b(3) = 14, b(2) = 4, b(1) = 2, b(0) = 2, c(n) = b(n-1)+c(n-1)+e(n-1), c(3) = 20, c(2) = 6, c(1) = 2, c(0) = 0, d(n) = b(n-1)+c(n-1)+d(n-1)+e(n-1), d(3) = 28, d(2) = 8, d(1) = 2, d(0) = 0, e(n) = 2*e(n-1)-d(n-1)+b(n-1)+c(n-1)+d(n-1)+e(n-1), e(3) = 40, e(2) = 10, e(1) = 2, e(0) = 0

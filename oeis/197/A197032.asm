...
; Formula: a(n) = -10*truncate(truncate(b(5*n)/(truncate(d(5*n)/(10^n))+1))/10)+truncate(b(5*n)/(truncate(d(5*n)/(10^n))+1)), b(n) = b(n-1)+d(n-1), b(3) = 14, b(2) = 4, b(1) = 2, b(0) = 2, c(n) = b(n-1)+c(n-1)+d(n-1), c(3) = 20, c(2) = 6, c(1) = 2, c(0) = 0, d(n) = 3*d(n-1)+b(n-1)+c(n-1), d(3) = 40, d(2) = 10, d(1) = 2, d(0) = 0

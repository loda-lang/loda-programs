...
; Formula: a(n) = 2*truncate(d(n)/2)+2, b(n) = b(n-1)+d(n-1)+2, b(5) = 70, b(4) = 30, b(3) = 14, b(2) = 6, b(1) = 2, b(0) = 0, c(n) = e(n-2), c(5) = 20, c(4) = 8, c(3) = 4, c(2) = 0, c(1) = 0, c(0) = 2, d(n) = 2*e(n-1)-d(n-1)-f(n-1)+b(n-1)+c(n-1), d(5) = 78, d(4) = 38, d(3) = 14, d(2) = 6, d(1) = 2, d(0) = 0, e(n) = -f(n-1)+b(n-1)+c(n-1)+d(n-1)+e(n-1)+2, e(5) = 108, e(4) = 48, e(3) = 20, e(2) = 8, e(1) = 4, e(0) = 0, f(n) = -f(n-1)+c(n-1)+e(n-1), f(5) = 38, f(4) = 18, f(3) = 6, f(2) = 2, f(1) = 2, f(0) = 0

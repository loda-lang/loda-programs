...
; Formula: a(n) = ((d(4*n)+2)/(c(4*n)/(10^n)))%10, b(n) = 2*b(n-1)+2*c(n-1)+d(n-1), b(2) = 17, b(1) = 3, b(0) = 0, c(n) = 3*c(n-1)+2*b(n-1)+d(n-1), c(2) = 21, c(1) = 4, c(0) = 1, d(n) = 2*c(n-1)+d(n-1), d(2) = 11, d(1) = 3, d(0) = 1

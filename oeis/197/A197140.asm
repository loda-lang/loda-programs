...
; Formula: a(n) = (b(3*n)/(c(3*n)/(10^n)+1))%10, b(n) = 2*c(n-1)+2*e(n-1)+b(n-1), b(3) = 187, b(2) = 11, b(1) = 1, b(0) = 1, c(n) = 6*c(n-1)+4*e(n-1)+2*b(n-1), c(3) = 426, c(2) = 26, c(1) = 2, c(0) = 0, d(n) = 18*c(n-1)+14*e(n-1)+5*b(n-1)+2*d(n-1), d(3) = 1577, d(2) = 93, d(1) = 5, d(0) = 0, e(n) = 12*c(n-1)+10*e(n-1)+3*b(n-1)+d(n-1), e(3) = 1058, e(2) = 62, e(1) = 3, e(0) = 0

...
; Formula: a(n) = (A315632(n)-(1-(A315632(n)-1))-1)/5+3*n+1

mov $1,$0
seq $0,315632 ; Coordination sequence Gal.5.112.5 where G.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.
sub $0,1
mov $2,1
sub $2,$0
sub $0,$2

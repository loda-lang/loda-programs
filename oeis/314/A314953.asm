...
; Formula: a(n) = -truncate((10*n-1)/(2*n-truncate((gcd(floor(n/2)+1,2)+n)/2)+floor((n+1)/3)+gcd(floor(n/2)+1,2)+truncate((4*truncate((25*n-25)/6))/5)+3))*(2*n-truncate((gcd(floor(n/2)+1,2)+n)/2)+floor((n+1)/3)+gcd(floor(n/2)+1,2)+truncate((4*truncate((25*n-25)/6))/5)+3)+10*n

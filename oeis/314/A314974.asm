...
; Formula: a(n) = (4*A313803(n)+1)/3-2*n

mov $1,$0
mul $1,2
seq $0,313803 ; Coordination sequence Gal.6.210.2 where G.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.
mul $0,4
add $0,1
div $0,3
sub $0,$1

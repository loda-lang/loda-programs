...
; Formula: a(n) = 2*((2*n+5)/11)+A314019(n)
...
div $1,11
mul $1,2
seq $0,314019 ; Coordination sequence Gal.6.152.5 where G.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.
add $0,$1

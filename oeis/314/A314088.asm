...
; Formula: a(n) = -truncate((7*n-1)/(-2*n+floor((16*n+4*max(truncate((4*n-2*(floor((n+4)/3)%3)+3)/3),1)+4)/3)-1))*(-2*n+floor((16*n+4*max(truncate((4*n-2*(floor((n+4)/3)%3)+3)/3),1)+4)/3)-1)+10*n

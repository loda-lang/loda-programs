...
; Formula: a(n) = -truncate((7*n-1)/(4*n+max(truncate((2*floor((n+4)/3)+2*n-1)/3)-1,0)+truncate((2*floor((n+4)/3)+2)/3)))*(4*n+max(truncate((2*floor((n+4)/3)+2*n-1)/3)-1,0)+truncate((2*floor((n+4)/3)+2)/3))+10*n

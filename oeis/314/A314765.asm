...
; Formula: a(n) = (2*((2*A315212(n)+n-5)/3)+2*n+4)/2

mov $2,$0
mov $3,$0
seq $0,315212 ; Coordination sequence Gal.6.351.4 where G.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.
mov $1,5
sub $1,$0
add $0,$2
sub $0,$1

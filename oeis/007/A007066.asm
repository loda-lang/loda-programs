...
; Formula: a(n) = (e(n)-2)/2+1, b(n) = (-c(n-1)+b(n-1))/4, b(3) = -544, b(2) = -130, b(1) = -8, b(0) = 0, c(n) = c(n-1)*gcd((-c(n-1)+b(n-1))/4+binomial(d(n-1),c(n-1)),4)^2, c(3) = 32768, c(2) = 2048, c(1) = 512, c(0) = 32, d(n) = 2*(gcd((-c(n-1)+b(n-1))/4+binomial(d(n-1),c(n-1)),4)/2), d(3) = 4, d(2) = 2, d(1) = 4, d(0) = 4, e(n) = d(n-1)+e(n-1)+2, e(3) = 18, e(2) = 14, e(1) = 8, e(0) = 2

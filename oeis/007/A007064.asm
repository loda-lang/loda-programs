...
; Formula: a(n) = (2*((e(2*n+2)-3)/2)+3)/4, b(n) = (-c(n-1)+b(n-1))/4, b(3) = -130, b(2) = -8, b(1) = 0, b(0) = 0, c(n) = c(n-1)*gcd((-c(n-1)+b(n-1))/4+binomial(d(n-1),c(n-1)),4)^2, c(3) = 2048, c(2) = 512, c(1) = 32, c(0) = 2, d(n) = 2*(gcd((-c(n-1)+b(n-1))/4+binomial(d(n-1),c(n-1)),4)/2), d(3) = 2, d(2) = 4, d(1) = 4, d(0) = 0, e(n) = d(n-1)+e(n-1)+2, e(3) = 14, e(2) = 8, e(1) = 2, e(0) = 0

...
; Formula: a(n) = e(n+22)-56, b(n) = truncate((-c(n-1)+b(n-1))/2), b(3) = -6, b(2) = -4, b(1) = 0, b(0) = 3, c(n) = c(n-1)*(-2*truncate((truncate((-c(n-1)+b(n-1))/2)+truncate(d(n-1)/2))/2)+truncate((-c(n-1)+b(n-1))/2)+truncate(d(n-1)/2)+2), c(3) = 8, c(2) = 8, c(1) = 8, c(0) = 4, d(n) = -2*truncate((truncate((-c(n-1)+b(n-1))/2)+truncate(d(n-1)/2))/2)+truncate((-c(n-1)+b(n-1))/2)+truncate(d(n-1)/2)+3, d(3) = 2, d(2) = 2, d(1) = 3, d(0) = 0, e(n) = d(n-1)+e(n-1), e(3) = 5, e(2) = 3, e(1) = 0, e(0) = 0

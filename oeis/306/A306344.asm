...
; Formula: a(n) = floor(truncate(3^(-binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2)+n))/2)*floor(truncate(3^(-n+binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2)+truncate((sqrtint(8*n+8)-1)/2)))/2)+1

...
; Formula: a(n) = -10*truncate(truncate(b(4*n)/truncate((-b(4*n)+c(4*n))/(10^(n-1))))/10)+truncate(b(4*n)/truncate((-b(4*n)+c(4*n))/(10^(n-1)))), b(n) = 2*b(n-1)+2*c(n-1), b(1) = 20, b(0) = 8, c(n) = truncate(((2*c(n-1)+b(n-1))^2)/(b(n-1)+c(n-1))), c(1) = 14, c(0) = 2

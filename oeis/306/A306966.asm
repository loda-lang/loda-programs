...
; Formula: a(n) = -10*truncate(truncate(b(4*n+4)/truncate((-b(4*n+4)+c(4*n+4))/(10^n)))/10)+truncate(b(4*n+4)/truncate((-b(4*n+4)+c(4*n+4))/(10^n))), b(n) = 2*b(n-1)+2*c(n-1), b(1) = 20, b(0) = 8, c(n) = truncate(((2*c(n-1)+b(n-1))^2)/(b(n-1)+c(n-1))), c(1) = 14, c(0) = 2

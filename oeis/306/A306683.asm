...
; Formula: a(n) = truncate(b(n+2)/2)-3, b(n) = b(n-1)+e(n-1)+2, b(3) = 16, b(2) = 12, b(1) = 2, b(0) = 0, c(n) = truncate((-d(n-1)+c(n-1))/4)+2, c(3) = -1, c(2) = 1, c(1) = 2, c(0) = 0, d(n) = 2*gcd(e(n-1)+truncate((-d(n-1)+c(n-1))/4),4)*d(n-1), d(3) = 32, d(2) = 16, d(1) = 8, d(0) = 1, e(n) = 2*gcd(e(n-1)+truncate((-d(n-1)+c(n-1))/4),4), e(3) = 2, e(2) = 2, e(1) = 8, e(0) = 0

...
; Formula: a(n) = d((2*n+1)/3+1), b(n) = (-c(n-1)+b(n-1))/2, b(2) = -1, b(1) = -1, b(0) = 0, c(n) = gcd((-c(n-1)+b(n-1))/2+d(n-1),2)*c(n-1), c(2) = 4, c(1) = 2, c(0) = 2, d(n) = gcd((-c(n-1)+b(n-1))/2+d(n-1),2), d(2) = 2, d(1) = 1, d(0) = 0

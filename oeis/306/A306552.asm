...
; Formula: a(n) = -truncate(d(n+1)/c(n+1))-10*truncate((-truncate(d(n+1)/c(n+1))+c(n+1)+9)/10)+c(n+1)+9, b(n) = 10*b(n-1), b(2) = 100, b(1) = 10, b(0) = 1, c(n) = b(n-1), c(2) = 10, c(1) = 1, c(0) = 0, d(n) = -10*truncate((343*d(n-1)^10)/(10*b(n-1)))*b(n-1)+343*d(n-1)^10, d(2) = 7, d(1) = 7, d(0) = 3

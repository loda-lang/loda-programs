...
; Formula: a(n) = 5*e(n-1)+4, b(n) = d(n-1)+max(b(n-1),1)+1, b(3) = 48, b(2) = 10, b(1) = 2, b(0) = 0, c(n) = d(n-1)+1, c(3) = 38, c(2) = 8, c(1) = 1, c(0) = 0, d(n) = 4*d(n-2)+3*d(n-1)+3*max(b(n-1),1)+2*max(b(n-2),1)+d(n-3)+9, d(3) = 182, d(2) = 37, d(1) = 7, d(0) = 0, e(n) = 2*d(n-1)+2*max(b(n-1),1)+c(n-1)+2, e(3) = 104, e(2) = 21, e(1) = 4, e(0) = 0

...
; Formula: a(n) = 2*a(n-1)-b(n-1)-2*d(n-1)+c(n-1)+2, a(3) = 0, a(2) = 1, a(1) = 1, a(0) = 0, b(n) = 2*d(n-1)-2*a(n-1)+b(n-1)-2, b(3) = 1, b(2) = -1, b(1) = -1, b(0) = 1, c(n) = -b(n-1)-d(n-1)+a(n-1)+1, c(3) = 0, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = 3*a(n-1)-b(n-1)-2*d(n-1)+c(n-1)+3, d(3) = 2, d(2) = 3, d(1) = 2, d(0) = 0

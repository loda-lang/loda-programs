...
; Formula: a(n) = 2*a(n-1)-b(n-2)-a(n-2)+a(n-3)+2*n-2, a(6) = 115, a(5) = 56, a(4) = 26, a(3) = 11, a(2) = 4, a(1) = 1, a(0) = 0, b(n) = -b(n-1)-a(n-1), b(6) = -38, b(5) = -18, b(4) = -8, b(3) = -3, b(2) = -1, b(1) = 0, b(0) = 0

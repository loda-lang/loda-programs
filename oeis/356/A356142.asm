...
; Formula: a(n) = truncate(truncate((c(n)+d(n))/gcd(c(n),b(n)))/gcd(n,truncate((c(n)+d(n))/gcd(c(n),b(n))))), b(n) = n*b(n-1), b(3) = 12, b(2) = 4, b(1) = 2, b(0) = 2, c(n) = n*c(n-1)+b(n-1), c(3) = 22, c(2) = 6, c(1) = 2, c(0) = 0, d(n) = n*(n*b(n-1)+d(n-1)), d(3) = 72, d(2) = 12, d(1) = 2, d(0) = 0

...
; Formula: a(n) = truncate((2*b(n+2)+41)/2)-21, b(n) = min(c(n-1)^2,d(n-1)+binomial(2*d(n-1),2)+1), b(2) = 1, b(1) = 0, b(0) = 0, c(n) = ((c(n-1)^2)==min(c(n-1)^2,d(n-1)+binomial(2*d(n-1),2)+1))+c(n-1), c(2) = 2, c(1) = 1, c(0) = 0, d(n) = ((d(n-1)+binomial(2*d(n-1),2)+1)==min(c(n-1)^2,d(n-1)+binomial(2*d(n-1),2)+1))+d(n-1), d(2) = 1, d(1) = 0, d(0) = 0

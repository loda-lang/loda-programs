...
; Formula: a(n) = 10*a(n-1)-b(n-1)+d(n-1)+2, a(3) = 812, a(2) = 102, a(1) = 12, a(0) = 1, b(n) = 10*a(n-1)-b(n-1)+d(n-1), b(3) = 810, b(2) = 100, b(1) = 10, b(0) = 0, c(n) = -c(n-1)+d(n-1), c(3) = -100, c(2) = -10, c(1) = 0, c(0) = 0, d(n) = -c(n-1)-10*a(n-1)+b(n-1), d(3) = -910, d(2) = -110, d(1) = -10, d(0) = 0

...
; Formula: a(n) = d(n+1)/3, b(n) = 5*b(n-1)+c(n-1)+15, b(3) = 1521, b(2) = 267, b(1) = 45, b(0) = 6, c(n) = 3*b(n-1)+c(n-1)+9, c(3) = 981, c(2) = 171, c(1) = 27, c(0) = 0, d(n) = 2*d(n-1)+b(n-1)+e(n-1)+2, d(3) = 487, d(2) = 76, d(1) = 10, d(0) = 1, e(n) = b(n-1)+d(n-1)+e(n-1)+2, e(3) = 411, e(2) = 66, e(1) = 9, e(0) = 0

...
; Formula: a(n) = e(n+1), b(n) = 4*b(n-1)+4*n+4, b(4) = 788, b(3) = 192, b(2) = 44, b(1) = 8, b(0) = 0, c(n) = d(n-1), c(4) = 68, c(3) = 11, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = 4*b(n-2)+4*n+2*d(n-1)+d(n-2)+1, d(4) = 340, d(3) = 68, d(2) = 11, d(1) = 1, d(0) = 0, e(n) = 2*d(n-1)+c(n-1), e(4) = 147, e(3) = 23, e(2) = 2, e(1) = 0, e(0) = 0

...
; Formula: a(n) = ((b(3*n)+d(3*n))/(c(3*n)/(10^n)))%10, b(n) = b(n-1)+c(n-1)+d(n-1), b(2) = 13, b(1) = 2, b(0) = 1, c(n) = 4*c(n-1)+2*b(n-1)+2*d(n-1)+c(n-1)+d(n-1), c(2) = 51, c(1) = 7, c(0) = 1, d(n) = 2*c(n-1)+2*d(n-1)+b(n-1)+c(n-1), d(2) = 31, d(1) = 4, d(0) = 0

...
; Formula: a(n) = b(n-1)+d(n-1), a(3) = 20, a(2) = 6, a(1) = 2, a(0) = 3, b(n) = b(n-1)+d(n-1), b(3) = 20, b(2) = 6, b(1) = 2, b(0) = 2, c(n) = b(n-1)+b(n-2)+c(n-1)+d(n-2), c(3) = 21, c(2) = 9, c(1) = 5, c(0) = 0, d(n) = 2*b(n-1)+2*c(n-1), d(3) = 30, d(2) = 14, d(1) = 4, d(0) = 0

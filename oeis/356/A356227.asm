...
; 0,1,1,2,1,2,1,3,2,1,1,3,1,1,2,4,1,3,1,1,1,1,1,4,2,1,3,1,1,3,1,5,1,1,2,4,1,1,1,1,1,1,1,1,3,1,1,5,2,1,1,1,1,4,1,1,1,1,1,4,1,1,1,6,1,1,1,1,1,1,1,5,1,1,3,1,2,1,1,1
; Formula: a(n) = A340375(A334032(A181819(A108951(n+1)-1)-1))*(A001222(n+1)-1)+1

...
; Formula: a(n) = 2*b(n)+2, b(n) = 2*d(n-1)+b(n-1)+e(n-1), b(3) = 18, b(2) = 7, b(1) = 0, b(0) = 1, c(n) = 2*d(n-1)+b(n-1)+c(n-1)+e(n-1)+1, c(3) = 28, c(2) = 9, c(1) = 1, c(0) = 0, d(n) = 2*b(n-1)+2*c(n-1)+d(n-1)+e(n-1)+1, d(3) = 36, d(2) = 8, d(1) = 2, d(0) = 0, e(n) = -e(n-1)-2*d(n-1)+2, e(3) = -9, e(2) = -5, e(1) = 3, e(0) = -1

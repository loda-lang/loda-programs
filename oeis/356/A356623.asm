...
; Formula: a(n) = b(n+2), b(n) = c(n-1)+d(n-1), b(3) = 18, b(2) = 2, b(1) = 0, b(0) = 0, c(n) = 2*(2*c(n-1))+2*d(n-1)+d(n-1)+e(n-1)+1, c(3) = 65, c(2) = 8, c(1) = 1, c(0) = 0, d(n) = 4*c(n-1)+2*(2*d(n-1))+c(n-1)+e(n-1)+1, d(3) = 83, d(2) = 10, d(1) = 1, d(0) = 0, e(n) = c(n-1)+d(n-1)+e(n-1), e(3) = 20, e(2) = 2, e(1) = 0, e(0) = 0

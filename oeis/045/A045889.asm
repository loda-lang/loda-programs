...
; Formula: a(n) = truncate(c(n+3)/4), b(n) = 4*n+b(n-1)-4, b(3) = 12, b(2) = 4, b(1) = 0, b(0) = 0, c(n) = 2*c(n-1)+b(n-1)+d(n-1), c(3) = 4, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 2*b(n-1)+2*d(n-1), d(3) = 8, d(2) = 0, d(1) = 0, d(0) = 0

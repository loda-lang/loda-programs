...
; Formula: a(n) = d(n-1)+a(n-1)+4, a(3) = 12, a(2) = 8, a(1) = 4, a(0) = 0, b(n) = truncate((-c(n-1)+b(n-1))/2), b(3) = -73, b(2) = -18, b(1) = -4, b(0) = 0, c(n) = 4*gcd(d(n-1)+truncate((-c(n-1)+b(n-1))/2)+1,4)*c(n-1), c(3) = 2048, c(2) = 128, c(1) = 32, c(0) = 8, d(n) = floor(gcd(d(n-1)+truncate((-c(n-1)+b(n-1))/2)+1,4)/2), d(3) = 2, d(2) = 0, d(1) = 0, d(0) = 0

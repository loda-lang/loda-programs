...
; Formula: a(n) = -d(n-1)+a(n-1)+1, a(3) = 8, a(2) = 5, a(1) = 2, a(0) = 0, b(n) = truncate((-c(n-1)+b(n-1)-1)/2)*(-2*truncate((d(n-1)+truncate((-c(n-1)+b(n-1)-1)/2))/2)+d(n-1)+truncate((-c(n-1)+b(n-1)-1)/2)+2), b(3) = -3, b(2) = 0, b(1) = 2, b(0) = 3, c(n) = 2*c(n-1)+2, c(3) = 14, c(2) = 6, c(1) = 2, c(0) = 0, d(n) = -2*truncate((d(n-1)+truncate((-c(n-1)+b(n-1)-1)/2))/2)+d(n-1)+truncate((-c(n-1)+b(n-1)-1)/2)-2, d(3) = -3, d(2) = -2, d(1) = -2, d(0) = -1

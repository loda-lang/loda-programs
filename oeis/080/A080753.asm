...
; Formula: a(n) = e(n+1), b(n) = (((-c(n-1)+b(n-1)-1)/2+d(n-1))%2+2)*((-c(n-1)+b(n-1)-1)/2), b(3) = -3, b(2) = 0, b(1) = 2, b(0) = 3, c(n) = 2*c(n-1)+2, c(3) = 14, c(2) = 6, c(1) = 2, c(0) = 0, d(n) = ((-c(n-1)+b(n-1)-1)/2+d(n-1))%2-2, d(3) = -3, d(2) = -2, d(1) = -2, d(0) = -1, e(n) = -d(n-1)+e(n-1)+1, e(3) = 8, e(2) = 5, e(1) = 2, e(0) = 0

...
; Formula: a(n) = 2*truncate((b(n+2)-15)/9)+3, b(n) = b(n-1)+d(n-1), b(3) = 24, b(2) = 15, b(1) = 6, b(0) = 3, c(n) = truncate((6*n+c(n-1))/d(n-1)), c(3) = 2, c(2) = 1, c(1) = 3, c(0) = 3, d(n) = truncate((6*n+c(n-1))/d(n-1))*d(n-1), d(3) = 18, d(2) = 9, d(1) = 9, d(0) = 3

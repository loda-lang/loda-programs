...
; Formula: a(n) = truncate((c(n)*(min(n,n%2)+1)+b(n))/2), b(n) = 4*c(n-2)+2*b(n-2), b(3) = 4, b(2) = 4, b(1) = 2, b(0) = 2, c(n) = 6*c(n-2)-4*c(n-4), c(6) = 64, c(5) = 12, c(4) = 12, c(3) = 2, c(2) = 2, c(1) = 0, c(0) = 0

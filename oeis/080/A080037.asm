...
; Formula: a(n) = e(n)+2, b(n) = (-c(n-1)+b(n-1))/2-1, b(3) = -7, b(2) = -4, b(1) = -2, b(0) = 0, c(n) = c(n-1)*(min(d(n-1),b(n-1))%2+2), c(3) = 16, c(2) = 8, c(1) = 4, c(0) = 2, d(n) = min(d(n-1),b(n-1))%2+2, d(3) = 2, d(2) = 2, d(1) = 2, d(0) = 0, e(n) = min(d(n-1),b(n-1))%2+e(n-1)+2, e(3) = 6, e(2) = 4, e(1) = 2, e(0) = 0

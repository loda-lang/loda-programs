...
; Formula: a(n) = d(n+1)+2, b(n) = truncate((-2*c(n-1)+b(n-1))/2), b(2) = -13, b(1) = -3, b(0) = 0, c(n) = 4*gcd(-b(n-1)+d(n-1)+truncate((-2*c(n-1)+b(n-1))/2),2)*c(n-1), c(2) = 48, c(1) = 12, c(0) = 3, d(n) = gcd(-b(n-1)+d(n-1)+truncate((-2*c(n-1)+b(n-1))/2),2), d(2) = 1, d(1) = 1, d(0) = 0

...
; Formula: a(n) = d(n+1)+4, b(n) = (-c(n-1)+b(n-1))/2, b(2) = -4, b(1) = 0, b(0) = 3, c(n) = 4*c(n-1)*(((-c(n-1)+b(n-1))/2+min(d(n-1),b(n-1)))%2+2), c(2) = 32, c(1) = 8, c(0) = 2, d(n) = ((-c(n-1)+b(n-1))/2+min(d(n-1),b(n-1)))%2, d(2) = -1, d(1) = -1, d(0) = -1

...
; Formula: a(n) = 9*((b(n)-1)/3)+9, b(n) = b(n-1)*(c(n-1)%7+d(n-1)+4), b(2) = 36, b(1) = 4, b(0) = 1, c(n) = c(n-1)%7+b(n-1)*(c(n-1)%7+d(n-1)+4)+d(n-1)+4, c(2) = 45, c(1) = 8, c(0) = 0, d(n) = 4, d(2) = 4, d(1) = 4, d(0) = 0

...
; Formula: a(n) = 2*truncate(b(n)/3)+1, b(n) = gcd(truncate((-c(n-1)+d(n-1))/2)+1,4), b(2) = 1, b(1) = 4, b(0) = 0, c(n) = 4*c(n-1), c(2) = 160, c(1) = 40, c(0) = 10, d(n) = truncate(truncate((-c(n-1)+d(n-1))/2)/gcd(truncate((-c(n-1)+d(n-1))/2)+1,4)), d(2) = -20, d(1) = -1, d(0) = 0

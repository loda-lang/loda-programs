...
; Formula: a(n) = a(n-1)+c(n-1), a(4) = 14, a(3) = 5, a(2) = 2, a(1) = 1, a(0) = 1, b(n) = max(-c(n-1)+b(n-1)+d(n-1)-2,0), b(4) = 0, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = e(n-1), c(4) = 28, c(3) = 9, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = 2*d(n-1)-c(n-1)+b(n-1)-1, d(4) = -34, d(3) = -12, d(2) = -4, d(1) = -1, d(0) = 0, e(n) = 4*e(n-1)-c(n-1)+b(n-1)+d(n-1)-1, e(4) = 90, e(3) = 28, e(2) = 9, e(1) = 3, e(0) = 1

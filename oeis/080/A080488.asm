...
; Formula: a(n) = 3*b(n-1), b(n) = c(n-1)^2+10*max(-d(n-1)+b(n-1),0), b(2) = 121, b(1) = 11, b(0) = 1, c(n) = 10*c(n-1)+max(-d(n-1)+b(n-1),0), c(2) = 110, c(1) = 11, c(0) = 1, d(n) = c(n-1)^2+10*max(-d(n-1)+b(n-1),0)+d(n-1), d(2) = 132, d(1) = 11, d(0) = 0

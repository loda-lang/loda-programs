...
; Formula: a(n) = a(n-1)+b(n-1), a(2) = 3, a(1) = 1, a(0) = 1, b(n) = (a(n-1)+b(n-1))*(c(n-1)==a(n-1))+2*b(n-1)+a(n-1), b(2) = 5, b(1) = 2, b(0) = 0, c(n) = (a(n-1)+b(n-1))*(c(n-1)==a(n-1))+a(n-1)+b(n-1), c(2) = 3, c(1) = 2, c(0) = 1

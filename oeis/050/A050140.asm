...
; Formula: a(n) = 2*b(n+1)-n+1, b(n) = b(n-1)+e(n-1), b(3) = 3, b(2) = 2, b(1) = 0, b(0) = 0, c(n) = (-d(n-1)+c(n-1))/((-d(n-1)+c(n-1)+e(n-1))%2+2), c(3) = -6, c(2) = -5, c(1) = -1, c(0) = 0, d(n) = 2*d(n-1), d(3) = 16, d(2) = 8, d(1) = 4, d(0) = 2, e(n) = (-d(n-1)+c(n-1)+e(n-1))%2+2, e(3) = 2, e(2) = 1, e(1) = 2, e(0) = 0

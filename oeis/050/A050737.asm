...
; Formula: a(n) = 7^b(n), b(n) = c(n-1)+1, b(8) = 9, b(7) = 8, b(6) = 7, b(5) = 5, b(4) = 4, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = -d(n-1)+c(n-1)+1, c(8) = 9, c(7) = 8, c(6) = 7, c(5) = 6, c(4) = 4, c(3) = 3, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = d(n-2)+e(n-2), d(8) = -1, d(7) = 0, d(6) = 0, d(5) = 0, d(4) = -1, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = -c(n-3)+d(n-1)+d(n-3)+d(n-5)+e(n-1)+2, e(8) = -8, e(7) = -4, e(6) = -1, e(5) = 0, e(4) = 1, e(3) = 0, e(2) = -1, e(1) = 0, e(0) = 0

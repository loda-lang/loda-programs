...
; Formula: a(n) = d(n)+1, b(n) = 2*c(n-1)-b(n-1), b(3) = 8, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = 4*d(n-2)+2*b(n-2)+4, c(3) = 8, c(2) = 4, c(1) = 0, c(0) = 0, d(n) = 2*b(n-1)+2*d(n-1)+1, d(3) = 7, d(2) = 3, d(1) = 1, d(0) = 0

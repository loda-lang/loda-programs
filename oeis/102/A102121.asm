...
; Formula: a(n) = A004086(if((b(n-1)%10)==0,b(n-1)/10,b(n-1))), a(4) = 2, a(3) = 1, a(2) = 1, a(1) = 0, a(0) = 0, b(n) = if((b(n-2)%10)==0,b(n-2)/10,b(n-2))+if((b(n-3)%10)==0,b(n-3)/10,b(n-3))+A004086(if((b(n-1)%10)==0,b(n-1)/10,b(n-1))), b(6) = 13, b(5) = 7, b(4) = 4, b(3) = 2, b(2) = 1, b(1) = 1, b(0) = 0

...
; Formula: a(n) = b(n-1)+c(n-1)+d(n-1), a(3) = 11, a(2) = 6, a(1) = 2, a(0) = 1, b(n) = b(n-1)+d(n-1), b(3) = 9, b(2) = 4, b(1) = 2, b(0) = 0, c(n) = d(n-1), c(3) = 5, c(2) = 2, c(1) = 2, c(0) = 0, d(n) = 2*d(n-2)+2*d(n-3)+b(n-3)+1, d(3) = 9, d(2) = 5, d(1) = 2, d(0) = 2

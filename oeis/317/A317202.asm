...
; Formula: a(n) = floor((d(max(3*n-3,0))+3)/floor(c(max(3*n-3,0))/(10^(n-1))))%10, b(n) = 2*c(n-1)+b(n-1)+d(n-1)+6, b(2) = 58, b(1) = 8, b(0) = 0, c(n) = 5*c(n-1)+2*b(n-1)+2*d(n-1)+15, c(2) = 139, c(1) = 20, c(0) = 1, d(n) = c(n-1)+d(n-1)+3, d(2) = 27, d(1) = 4, d(0) = 0

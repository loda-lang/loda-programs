...
; Formula: a(n) = ((d(3*n)+3)/(c(3*n)/(10^n)))%10, b(n) = 2*(b(n-1)/2)+2*c(n-1)+2*d(n-1), b(2) = 62, b(1) = 2, b(0) = 0, c(n) = 2*(b(n-1)/2)+2*c(n-1)+2*d(n-1)+c(n-1)+24, c(2) = 113, c(1) = 27, c(0) = 1, d(n) = 2*(b(n-1)/2)+2*c(n-1)+2*d(n-1)+c(n-1)+d(n-1), d(2) = 92, d(1) = 3, d(0) = 0

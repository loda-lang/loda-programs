...
; Formula: a(n) = d(n+1), b(n) = 2*b(n-1)+c(n-1), b(3) = 26, b(2) = 10, b(1) = 4, b(0) = 2, c(n) = 3*c(n-1)-c(n-2), c(5) = 110, c(4) = 42, c(3) = 16, c(2) = 6, c(1) = 2, c(0) = 0, d(n) = b(n-1)+d(n-1)+e(n-1)-1, d(3) = 18, d(2) = 5, d(1) = 1, d(0) = 0, e(n) = b(n-1)+e(n-1)-1, e(3) = 13, e(2) = 4, e(1) = 1, e(0) = 0

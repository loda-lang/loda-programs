...
; Formula: a(n) = c(n-1)+d(n-1)+1, a(6) = 45, a(5) = 16, a(4) = 5, a(3) = 2, a(2) = 1, a(1) = 1, a(0) = 0, b(n) = 2*c(n-1)+b(n-1)+c(n-2)+c(n-3), b(6) = 128, b(5) = 46, b(4) = 17, b(3) = 7, b(2) = 4, b(1) = 1, b(0) = 0, c(n) = 4*c(n-3)+3*c(n-4)+2*b(n-3)+2*c(n-2)+2*c(n-5)+c(n-1)-2, c(8) = 696, c(7) = 250, c(6) = 90, c(5) = 33, c(4) = 12, c(3) = 4, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = c(n-1)-1, d(6) = 32, d(5) = 11, d(4) = 3, d(3) = 0, d(2) = 0, d(1) = -1, d(0) = 0

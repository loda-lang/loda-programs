...
; Formula: a(n) = (binomial(-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n,2)-1)*(-n+binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+gcd(0,max(floor((sqrtint(8*n+8)-1)/2)-2,0)))+max(floor((sqrtint(8*n+8)-1)/2)-2,0)

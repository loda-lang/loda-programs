...
; Formula: a(n) = b(n+3), b(n) = d(n-1), b(6) = 59, b(5) = 26, b(4) = 9, b(3) = 2, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = c(n-1)+e(n-1)+n-1, c(6) = 21, c(5) = 14, c(4) = 8, c(3) = 4, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = -e(n-1)+c(n-1)+d(n-1)+e(n-1)+f(n-1)+f1(n-1)+n-1, d(6) = 116, d(5) = 59, d(4) = 26, d(3) = 9, d(2) = 2, d(1) = 0, d(0) = 0, e(n) = -e(n-1)+n-1, e(6) = 3, e(5) = 2, e(4) = 2, e(3) = 1, e(2) = 1, e(1) = 0, e(0) = 0, f(n) = -e(n-1)+c(n-1)+e(n-1)+f(n-1)+f1(n-1)+n-1, f(6) = 57, f(5) = 33, f(4) = 17, f(3) = 7, f(2) = 2, f(1) = 0, f(0) = 0, f1(n) = n, f1(6) = 6, f1(5) = 5, f1(4) = 4, f1(3) = 3, f1(2) = 2, f1(1) = 1, f1(0) = 0

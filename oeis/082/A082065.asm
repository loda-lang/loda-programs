...
; 1,1,2,1,2,2,2,1,1,2,2,2,2,2,2,1,2,1,2,2,2,5,2,2,1,2,2,3,2,2,2,1,5,2,2,3,2,2,2,2,2,2,2,2,2,2,2,2,3,5,2,3,2,2,2,2,2,2,2,2,2,5,2,1,2,5,2,2,2,2,2,1,2,2,5,3,5,2,2,2
; Formula: a(n) = A006530(gcd(A001157(n+1),A109606(n)+1))

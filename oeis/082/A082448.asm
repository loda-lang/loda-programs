...
; Formula: a(n) = min(n,n%2)*(c(n)+min(n,n%2))+b(n), b(n) = (c(n-2)+1)*(b(n-2)+c(n-2)+1), b(5) = 14, b(4) = 14, b(3) = 5, b(2) = 5, b(1) = 4, b(0) = 4, c(n) = c(n-2)+1, c(5) = 2, c(4) = 2, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0

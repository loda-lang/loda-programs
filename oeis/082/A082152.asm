...
; Formula: a(n) = floor((4*gcd(0,-binomial(floor((sqrtint(8*n)-1)/2)+1,2)+n-1)+floor(((4*gcd(0,-binomial(floor((sqrtint(8*n)-1)/2)+1,2)+n-1)+2*floor((sqrtint(8*n)-1)/2)+3)^2)/6))/4)+1

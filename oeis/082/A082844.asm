...
; Formula: a(n) = d(n+2)+2, b(n) = (-c(n-1)+b(n-1)+1)/2, b(2) = -14, b(1) = -5, b(0) = 0, c(n) = 2*gcd((-c(n-1)+b(n-1)+1)/2+d(n-1),4)*c(n-1), c(2) = 96, c(1) = 24, c(0) = 12, d(n) = gcd((-c(n-1)+b(n-1)+1)/2+d(n-1),4)/2, d(2) = 1, d(1) = 0, d(0) = 0

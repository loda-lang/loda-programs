...
; Formula: a(n) = e(max(n-1,0))/2, b(n) = -c(n-1)+b(n-1)+d(n-1)+2, b(5) = 233, b(4) = 97, b(3) = 37, b(2) = 13, b(1) = 3, b(0) = 0, c(n) = 2*c(n-1)+1, c(5) = 31, c(4) = 15, c(3) = 7, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = 3*c(n-2)+3*d(n-2)-b(n-2)+d(n-1)+13, d(5) = 341, d(4) = 149, d(3) = 65, d(2) = 25, d(1) = 9, d(0) = 1, e(n) = 3*d(n-3)-b(n-3)-c(n-3)+9, e(5) = 68, e(4) = 32, e(3) = 12, e(2) = 6, e(1) = 2, e(0) = 0

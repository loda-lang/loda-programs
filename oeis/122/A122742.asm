...
; Formula: a(n) = truncate(d(max(n-1,0))/2), b(n) = 4*c(n-3)+2*b(n-1)+2*b(n-2)+2*c(n-2)-c(n-1)-4*b(n-3)+6, b(6) = 545, b(5) = 233, b(4) = 97, b(3) = 37, b(2) = 13, b(1) = 3, b(0) = 0, c(n) = 2*c(n-1)+1, c(5) = 31, c(4) = 15, c(3) = 7, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = 4*c(n-3)+3*b(n-2)-c(n-2)-4*b(n-3)+4, d(6) = 160, d(5) = 68, d(4) = 32, d(3) = 12, d(2) = 6, d(1) = 2, d(0) = 0

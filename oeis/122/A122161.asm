...
; Formula: a(n) = b(n+2), b(n) = -c(n-1)+d(n-1)+e(n-1), b(3) = -2, b(2) = 1, b(1) = -1, b(0) = 0, c(n) = -c(n-1)+d(n-1)+e(n-1), c(3) = -2, c(2) = 1, c(1) = -1, c(0) = 1, d(n) = d(n-1)+e(n-1), d(3) = -1, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = -c(n-2)+d(n-2)+e(n-1)+e(n-2), e(3) = 0, e(2) = -1, e(1) = 0, e(0) = 0

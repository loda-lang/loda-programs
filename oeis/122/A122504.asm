...
; Formula: a(n) = -a(n-1)+b(n-1)+d(n-1)+2, a(5) = 1, a(4) = 1, a(3) = 1, a(2) = 1, a(1) = 1, a(0) = 1, b(n) = b(n-1)+b(n-2)+c(n-2)+a(n-2), b(5) = 14, b(4) = 7, b(3) = 3, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = c(n-1)+a(n-1), c(5) = 5, c(4) = 4, c(3) = 3, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = 2*d(n-1)-a(n-2)+a(n-1)-1, d(8) = -132, d(7) = -64, d(6) = -31, d(5) = -15, d(4) = -7, d(3) = -3, d(2) = -1, d(1) = 0, d(0) = 0

...
; Formula: a(n) = c(n)+1, b(n) = b(n-1)+d(n-1)+e(n-1)+1, b(3) = 4, b(2) = 4, b(1) = 2, b(0) = 1, c(n) = -e(n-1)-1, c(3) = 1, c(2) = 0, c(1) = -1, c(0) = 0, d(n) = -e(n-2)+b(n-2), d(3) = 3, d(2) = 1, d(1) = 2, d(0) = 0, e(n) = -d(n-1)-e(n-1)-1, e(3) = 0, e(2) = -2, e(1) = -1, e(0) = 0

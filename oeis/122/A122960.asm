...
; Formula: a(n) = binomial(binomial(-n+binomial(floor((sqrtint(8*n+8)-1)/2)+1,2),binomial(-1,-n+binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+floor((sqrtint(8*n+8)-1)/2)+1)==1),-n+binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+floor((sqrtint(8*n+8)-1)/2)+1)

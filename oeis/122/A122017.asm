...
; Formula: a(n) = min(n,n%2)*c(n)+b(n), b(n) = -2*d(n-2)*b(n-2)+c(n-2), b(7) = 59, b(6) = 59, b(5) = 7, b(4) = 7, b(3) = 1, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = b(n-2)*(2*d(n-2)+4)+c(n-2)*(4*d(n-2)+5), c(7) = 1187, c(6) = 1187, c(5) = 87, c(4) = 87, c(3) = 9, c(2) = 9, c(1) = 1, c(0) = 1, d(n) = d(n-2)+1, d(7) = 3, d(6) = 3, d(5) = 2, d(4) = 2, d(3) = 1, d(2) = 1, d(1) = 0, d(0) = 0

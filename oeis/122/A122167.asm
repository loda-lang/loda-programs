...
; Formula: a(n) = 2*c(n-1)-2*e(n-1)+b(n-1)+a(n-1), a(4) = 10, a(3) = -11, a(2) = 3, a(1) = -3, a(0) = 1, b(n) = b(n-1)+d(n-1), b(4) = -8, b(3) = -1, b(2) = -2, b(1) = 0, b(0) = 0, c(n) = a(n-1), c(4) = -11, c(3) = 3, c(2) = -3, c(1) = 1, c(0) = 0, d(n) = -e(n-1)+b(n-1)+c(n-1)+d(n-1), d(4) = 3, d(3) = -7, d(2) = 1, d(1) = -2, d(0) = 0, e(n) = -e(n-1)+b(n-1)+c(n-1), e(4) = 10, e(3) = -8, e(2) = 3, e(1) = -2, e(0) = 2

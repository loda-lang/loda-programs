...
; Formula: a(n) = b(3*n+2), b(n) = 2*b(n-1)+d(n-1)+truncate(c(n-1)/(-1)), b(2) = 1, b(1) = 1, b(0) = 0, c(n) = b(n-1)+d(n-1)+truncate(c(n-1)/(-1)), c(2) = 0, c(1) = 1, c(0) = -1, d(n) = b(n-1)+d(n-1), d(2) = 1, d(1) = 0, d(0) = 0

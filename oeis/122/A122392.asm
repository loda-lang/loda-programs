...
; Formula: a(n) = b(n-1)+d(n-1)+1, a(3) = 15, a(2) = 5, a(1) = 2, a(0) = 1, b(n) = (b(n-1)+d(n-1)+1)/2, b(3) = 7, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = 2*b(n-1)+2*d(n-1)+c(n-1)+2, c(3) = 45, c(2) = 15, c(1) = 5, c(0) = 1, d(n) = 2*d(n-1)+b(n-1)+b(n-2)+c(n-2)+d(n-2)+3, d(3) = 38, d(2) = 12, d(1) = 3, d(0) = 0

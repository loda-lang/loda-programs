...
; Formula: a(n) = b(n-1)+c(n-1)+1, a(3) = 15, a(2) = 5, a(1) = 2, a(0) = 1, b(n) = (b(n-1)+c(n-1)+1)/2, b(3) = 7, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = 3*c(n-1)-c(n-2)+b(n-1)+b(n-3)+c(n-3)+2, c(4) = 115, c(3) = 38, c(2) = 12, c(1) = 3, c(0) = 0

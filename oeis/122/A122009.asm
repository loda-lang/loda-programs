...
; Formula: a(n) = b(max(n-2,0)), b(n) = 2*b(n-1)+c(n-1)+d(n-1), b(2) = 23, b(1) = 3, b(0) = 1, c(n) = 7*c(n-1)+5*d(n-1)+4*b(n-1), c(2) = 119, c(1) = 11, c(0) = 1, d(n) = 4*c(n-1)+3*d(n-1)+2*b(n-1), d(2) = 68, d(1) = 6, d(0) = 0

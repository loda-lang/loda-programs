...
; Formula: a(n) = binomial(-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n,max(truncate((floor((sqrtint(8*n+8)-1)/2)*(-n+binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+floor((sqrtint(8*n+8)-1)/2)))/2),floor(floor((sqrtint(8*n+8)-1)/2)/2)))

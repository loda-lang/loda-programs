...
; Formula: a(n) = b(n+1), b(n) = max(b(n-1),d(n-1))*(c(n-1)+1), b(2) = 6, b(1) = 2, b(0) = 1, c(n) = (c(n-1)+1)%3, c(2) = 0, c(1) = 2, c(0) = 1, d(n) = max(-d(n-2)+d(n-1),d(n-1))*(c(n-1)+1)+d(n-1), d(3) = 16, d(2) = 8, d(1) = 2, d(0) = 0

...
; Formula: a(n) = b(n+1), b(n) = max(b(n-1),d(n-1))*(c(n-1)+1), b(2) = 3, b(1) = 3, b(0) = 1, c(n) = (c(n-1)+1)%3, c(2) = 1, c(1) = 0, c(0) = 2, d(n) = max(-d(n-2)+d(n-1),d(n-1))*(c(n-1)+1)+d(n-1), d(3) = 18, d(2) = 6, d(1) = 3, d(0) = 0

...
; Formula: a(n) = max(a(n-1),c(n-1))*(b(n-1)+1), a(2) = 3, a(1) = 3, a(0) = 1, b(n) = -3*truncate((b(n-1)+1)/3)+b(n-1)+1, b(2) = 1, b(1) = 0, b(0) = 2, c(n) = max(-c(n-2)+c(n-1),c(n-1))*(b(n-1)+1)+c(n-1), c(3) = 18, c(2) = 6, c(1) = 3, c(0) = 0

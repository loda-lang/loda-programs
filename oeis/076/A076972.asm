...
; Formula: a(n) = max(d(n-1),1)+1, a(3) = 5, a(2) = 3, a(1) = 2, a(0) = 1, b(n) = b(n-1)+c(n-1), b(3) = 7, b(2) = 3, b(1) = 1, b(0) = 1, c(n) = 2*b(n-1)+c(n-1), c(3) = 10, c(2) = 4, c(1) = 2, c(0) = 0, d(n) = ((max(d(n-1),1)+1)*(2*b(n-2)+2*c(n-2)+b(n-2)))/(4*b(n-2)+2*c(n-2)+c(n-2))+max(d(n-2),1)+1, d(3) = 6, d(2) = 4, d(1) = 2, d(0) = 0

...
; Formula: a(n) = b(n+1), b(n) = 2*d(n-1)+c(n-1)+1, b(4) = 312, b(3) = 25, b(2) = 24, b(1) = 7, b(0) = 0, c(n) = d(n-1)/(c(n-1)+d(n-1)), c(4) = 0, c(3) = 1, c(2) = 0, c(1) = 1, c(0) = 0, d(n) = (c(n-2)+d(n-2))^2+d(n-2), d(4) = 156, d(3) = 155, d(2) = 12, d(1) = 11, d(0) = 3

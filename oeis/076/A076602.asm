...
; Formula: a(n) = 2*c(n-1)+b(n-1)+1, a(4) = 312, a(3) = 25, a(2) = 24, a(1) = 7, a(0) = 0, b(n) = truncate(c(n-1)/(b(n-1)+c(n-1))), b(4) = 0, b(3) = 1, b(2) = 0, b(1) = 1, b(0) = 0, c(n) = (b(n-2)+c(n-2))^2+c(n-2), c(4) = 156, c(3) = 155, c(2) = 12, c(1) = 11, c(0) = 3

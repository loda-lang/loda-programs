...
; Formula: a(n) = b(n+1)+9, b(n) = 2*d(n-1)+c(n-1), b(4) = 1851, b(3) = 52, b(2) = 51, b(1) = 2, b(0) = 0, c(n) = truncate(d(n-1)/(c(n-1)+d(n-1))), c(4) = 0, c(3) = 1, c(2) = 0, c(1) = 1, c(0) = 0, d(n) = (c(n-2)+d(n-2)+4)^2+d(n-2), d(4) = 926, d(3) = 925, d(2) = 26, d(1) = 25, d(0) = 1

...
; Formula: a(n) = truncate((c(n)+d(n)-6)/4), b(n) = -4*truncate(b(n-1)/4)+b(n-1)+2, b(2) = 4, b(1) = 2, b(0) = 0, c(n) = c(n-1)*(-4*truncate(b(n-1)/4)+b(n-1)+2)-c(n-2), c(2) = 14, c(1) = 4, c(0) = 2, d(n) = c(n-1), d(2) = 4, d(1) = 2, d(0) = 0

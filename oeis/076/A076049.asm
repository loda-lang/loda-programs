...
; Formula: a(n) = (2*e(n+1)-8)/8, b(n) = -2*c(n-1)-4*b(n-1)+b(n-1)+d(n-1)+6, b(3) = 13, b(2) = 3, b(1) = 3, b(0) = 1, c(n) = 2*b(n-1)+c(n-1)-2, c(3) = 8, c(2) = 4, c(1) = 0, c(0) = 0, d(n) = 4*b(n-1)+2*c(n-1)+d(n-1)+e(n-1)+2, d(3) = 62, d(2) = 24, d(1) = 6, d(0) = 0, e(n) = 4*b(n-1)+2*c(n-1)+e(n-1), e(3) = 36, e(2) = 16, e(1) = 4, e(0) = 0

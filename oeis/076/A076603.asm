...
; Formula: a(n) = b(n+1)+7, b(n) = 2*d(n-1)+c(n-1), b(4) = 833, b(3) = 34, b(2) = 33, b(1) = 2, b(0) = 0, c(n) = truncate(d(n-1)/(c(n-1)+d(n-1))), c(4) = 0, c(3) = 1, c(2) = 0, c(1) = 1, c(0) = 0, d(n) = (c(n-2)+d(n-2)+3)^2+d(n-2), d(4) = 417, d(3) = 416, d(2) = 17, d(1) = 16, d(0) = 1

...
; Formula: a(n) = e(n)+2, b(n) = (b(n-1)+d(n-1))%2, b(4) = 0, b(3) = 0, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = d(n-1), c(4) = 8, c(3) = 1, c(2) = 3, c(1) = 0, c(0) = 1, d(n) = 2*d(n-2)+b(n-1)+1, d(5) = 17, d(4) = 3, d(3) = 8, d(2) = 1, d(1) = 3, d(0) = 0, e(n) = b(n-1)+c(n-1)+d(n-1), e(4) = 9, e(3) = 5, e(2) = 3, e(1) = 1, e(0) = 0

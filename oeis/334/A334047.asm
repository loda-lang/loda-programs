...
; Formula: a(n) = c(n-1), a(4) = 35, a(3) = 16, a(2) = 6, a(1) = 0, a(0) = 0, b(n) = b(n-1)+c(n-1)+3, b(4) = 69, b(3) = 31, b(2) = 12, b(1) = 3, b(0) = 0, c(n) = b(n-1)+c(n-1)+d(n-1)+6, c(4) = 78, c(3) = 35, c(2) = 16, c(1) = 6, c(0) = 0, d(n) = -c(n-3)-d(n-2)+c(n-2)+d(n-1), d(4) = 15, d(3) = 6, d(2) = 1, d(1) = 1, d(0) = 0

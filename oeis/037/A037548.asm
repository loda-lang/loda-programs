...
; Formula: a(n) = b(n)+d(n)+truncate((b(n)+d(n)+truncate((b(n)+c(n)+d(n))/8))/7), b(n) = b(n-1), b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = c(n-1), c(3) = 0, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 7*d(n-1)+2*truncate(d(n-2)/2)-d(n-2)+1, d(3) = 56, d(2) = 8, d(1) = 1, d(0) = 0

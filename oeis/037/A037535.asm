...
; Formula: a(n) = b(n+1), b(n) = 10*b(n-1)-4*truncate(c(n-1)/4)+c(n-1), b(1) = 1, b(0) = 0, c(n) = 20*truncate(c(n-2)/4)+11*c(n-1)-4*truncate(c(n-1)/4)-5*c(n-2), c(3) = 57, c(2) = 6, c(1) = 1, c(0) = 1

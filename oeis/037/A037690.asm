...
; Formula: a(n) = truncate(b(n)/6), b(n) = 6*b(n-1)+6*c(n-1), b(1) = 6, b(0) = 0, c(n) = -4*truncate(truncate(if(((c(n-1)+23)%6)==0,(c(n-1)+23)/6,c(n-1)+23)/2)/4)+truncate(if(((c(n-1)+23)%6)==0,(c(n-1)+23)/6,c(n-1)+23)/2), c(1) = 2, c(0) = 1

...
; Formula: a(n) = c(n+1), b(n) = 7*b(n-1)+6*truncate(b(n-2)/2)-2*truncate(b(n-1)/2)-3*b(n-2)-2, b(3) = 26, b(2) = 5, b(1) = 1, b(0) = 0, c(n) = 6*c(n-1)-2*truncate(b(n-1)/2)+b(n-1)+1, c(1) = 1, c(0) = 0

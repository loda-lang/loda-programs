...
; Formula: a(n) = b(n+1), b(n) = 6*b(n-1)-2*truncate(c(n-1)/2)+c(n-1)+1, b(1) = 1, b(0) = 0, c(n) = 7*c(n-1)+6*truncate(c(n-2)/2)-2*truncate(c(n-1)/2)-3*c(n-2)+3, c(3) = 22, c(2) = 3, c(1) = 0, c(0) = 0

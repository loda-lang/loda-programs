...
; Formula: a(n) = d(n+1), b(n) = (2*((-c(n-1)+b(n-1)-2)/2))/gcd((-c(n-1)+b(n-1)-2)/2+2*c(n-1)+2,4), b(3) = -17, b(2) = -14, b(1) = -1, b(0) = 0, c(n) = 4*c(n-1)+4, c(3) = 212, c(2) = 52, c(1) = 12, c(0) = 2, d(n) = d(n-1)+gcd((-c(n-2)+b(n-2)-2)/2+2*c(n-2)+2,4), d(3) = 6, d(2) = 5, d(1) = 1, d(0) = 0

...
; Formula: a(n) = d(n+1), b(n) = truncate(truncate((-c(n-1)+b(n-1))/2)/gcd(truncate((-c(n-1)+b(n-1))/2)+1,4)), b(3) = -90, b(2) = -20, b(1) = -1, b(0) = 0, c(n) = 4*c(n-1), c(3) = 640, c(2) = 160, c(1) = 40, c(0) = 10, d(n) = d(n-1)+truncate(gcd(truncate((-c(n-2)+b(n-2))/2)+1,4)/2)+2, d(3) = 7, d(2) = 5, d(1) = 1, d(0) = 1

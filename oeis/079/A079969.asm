...
; Formula: a(n) = -c(n-1)+b(n-1), a(7) = 38, a(6) = 21, a(5) = 11, a(4) = 6, a(3) = 3, a(2) = 2, a(1) = 1, a(0) = 1, b(n) = 2*b(n-1)-c(n-1)-c(n-4), b(8) = 149, b(7) = 81, b(6) = 44, b(5) = 24, b(4) = 13, b(3) = 7, b(2) = 4, b(1) = 2, b(0) = 1, c(n) = -c(n-3)+b(n-3), c(7) = 11, c(6) = 6, c(5) = 3, c(4) = 2, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0

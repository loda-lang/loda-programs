...
; Formula: a(n) = b(n+2), b(n) = c(n-1), b(6) = 6, b(5) = 3, b(4) = 2, b(3) = 1, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = c(n-1)+c(n-2)+c(n-4)+c(n-5)+c(n-6), c(7) = 21, c(6) = 11, c(5) = 6, c(4) = 3, c(3) = 2, c(2) = 1, c(1) = 1, c(0) = 0

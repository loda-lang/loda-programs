...
; Formula: a(n) = b(n-1)+b(n-2)+c(n-2)+a(n-2)+1, a(5) = 13, a(4) = 7, a(3) = 4, a(2) = 2, a(1) = 1, a(0) = 1, b(n) = a(n-2), b(5) = 4, b(4) = 2, b(3) = 1, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = b(n-1)+b(n-2)+c(n-1)+a(n-1), c(5) = 21, c(4) = 11, c(3) = 5, c(2) = 2, c(1) = 1, c(0) = 0

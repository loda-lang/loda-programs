...
; Formula: a(n) = b(n+1), b(n) = -b(n-1)+b(n-3)+c(n-3)+1, b(5) = 2, b(4) = 1, b(3) = 1, b(2) = 0, b(1) = 1, b(0) = 0, c(n) = 2*b(n-1)+c(n-1)+d(n-1), c(5) = 7, c(4) = 5, c(3) = 2, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = b(n-2), d(5) = 1, d(4) = 0, d(3) = 1, d(2) = 0, d(1) = 0, d(0) = 0

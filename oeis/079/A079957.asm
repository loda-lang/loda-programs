...
; Formula: a(n) = b(n+1), b(n) = -b(n-1)-b(n-2)+c(n-2)+1, b(5) = 0, b(4) = 1, b(3) = 0, b(2) = 0, b(1) = 1, b(0) = 0, c(n) = d(n-2), c(5) = 2, c(4) = 1, c(3) = 0, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = -b(n-3)+c(n-3)+d(n-1)+1, d(5) = 3, d(4) = 2, d(3) = 2, d(2) = 1, d(1) = 0, d(0) = 0

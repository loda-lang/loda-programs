...
; Formula: a(n) = (min(b(n),n%2)*c(n)+d(n))/3, b(n) = n-2, b(5) = 3, b(4) = 2, b(3) = 1, b(2) = 0, b(1) = 1, b(0) = 0, c(n) = 2*c(n-2)+2*d(n-2), c(5) = 24, c(4) = 24, c(3) = 6, c(2) = 6, c(1) = 3, c(0) = 3, d(n) = 2*c(n-2)+2*d(n-2)+d(n-2), d(5) = 30, d(4) = 30, d(3) = 6, d(2) = 6, d(1) = 0, d(0) = 0

...
; Formula: a(n) = b(n+1), b(n) = c(n-1)+c(n-2)+c(n-3)+1, b(6) = 4, b(5) = 2, b(4) = 1, b(3) = 1, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = c(n-1)+c(n-4)+c(n-5)+c(n-6)+1, c(8) = 6, c(7) = 4, c(6) = 3, c(5) = 2, c(4) = 1, c(3) = 0, c(2) = 0, c(1) = 0, c(0) = 0

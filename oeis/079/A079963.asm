...
; Formula: a(n) = b(n+1), b(n) = 2*d(n-2)+c(n-2)+e(n-2)+1, b(5) = 2, b(4) = 1, b(3) = 1, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = d(n-1), c(5) = 1, c(4) = 0, c(3) = 0, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = d(n-1)+e(n-1), d(5) = 2, d(4) = 1, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = 3*d(n-5)+2*e(n-5)+e(n-4)+1, e(5) = 1, e(4) = 1, e(3) = 1, e(2) = 0, e(1) = 0, e(0) = 0

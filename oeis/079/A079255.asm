...
; Formula: a(n) = d(n-1)+1, b(n) = 2*c(n-1)+truncate((-c(n-1)+b(n-1))/2), b(2) = 7, b(1) = 2, b(0) = 0, c(n) = 2*c(n-1)*(-2*truncate(truncate((-c(n-1)+b(n-1))/2)/2)+truncate((-c(n-1)+b(n-1))/2)+2), c(2) = 8, c(1) = 4, c(0) = 1, d(n) = -2*truncate(truncate((-c(n-1)+b(n-1))/2)/2)+d(n-1)+truncate((-c(n-1)+b(n-1))/2)+3, d(2) = 5, d(1) = 3, d(0) = 0

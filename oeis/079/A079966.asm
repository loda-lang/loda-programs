...
; Formula: a(n) = b(n+1), b(n) = -b(n-1)+b(n-4)+d(n-3)+e(n-3)+1, b(6) = 1, b(5) = 2, b(4) = 0, b(3) = 1, b(2) = 0, b(1) = 1, b(0) = 0, c(n) = b(n-1), c(5) = 0, c(4) = 1, c(3) = 0, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = 2*e(n-1)+c(n-1)+d(n-1), d(5) = 4, d(4) = 3, d(3) = 1, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = c(n-1), e(5) = 1, e(4) = 0, e(3) = 1, e(2) = 0, e(1) = 0, e(0) = 0

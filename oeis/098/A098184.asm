...
; Formula: a(n) = 4*b(n-2)+4*a(n-2)+4*c(n-2)+a(n-1), a(3) = 17, a(2) = 5, a(1) = 1, a(0) = 1, b(n) = b(n-1)+a(n-1), b(3) = 7, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = b(n-1)+a(n-1)+c(n-1), c(3) = 10, c(2) = 3, c(1) = 1, c(0) = 0

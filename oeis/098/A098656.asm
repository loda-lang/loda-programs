...
; Formula: a(n) = (d(n)*c(n))/4, b(n) = 2*b(n-2)+4, b(3) = 12, b(2) = 4, b(1) = 4, b(0) = 0, c(n) = 2*c(n-1), c(3) = 8, c(2) = 4, c(1) = 2, c(0) = 1, d(n) = -b(n-1)+e(n-1)+2, d(3) = 2, d(2) = -2, d(1) = 2, d(0) = 0, e(n) = 2*e(n-2)+4, e(3) = 4, e(2) = 4, e(1) = 0, e(0) = 0

...
; Formula: a(n) = b(n-1), a(3) = 64, a(2) = 7, a(1) = 1, a(0) = 0, b(n) = 7*b(n-1)+2*d(n-1)+c(n-1), b(3) = 567, b(2) = 64, b(1) = 7, b(0) = 1, c(n) = b(n-1), c(3) = 64, c(2) = 7, c(1) = 1, c(0) = 0, d(n) = 7*b(n-1)+d(n-1), d(3) = 504, d(2) = 56, d(1) = 7, d(0) = 0

...
; Formula: a(n) = -(gcd(A003586(n+1),210)+2)^7-10*truncate((-(gcd(A003586(n+1),210)+2)^7-10*truncate((-(gcd(A003586(n+1),210)+2)^7+26)/10)+37)/10)-10*truncate((-(gcd(A003586(n+1),210)+2)^7+26)/10)+37

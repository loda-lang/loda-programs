...
; Formula: a(n) = d(n+1)+5, b(n) = max(b(n-1)+1,c(n-1)), b(4) = 17, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = (binomial(4*n-3,b(n-1))*(b(n-2)+1)^2)/(4*n-3)+c(n-1), c(4) = 215, c(3) = 17, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = b(n-1), d(4) = 3, d(3) = 2, d(2) = 1, d(1) = 0, d(0) = 0

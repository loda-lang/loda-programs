...
; Formula: a(n) = e(n)+2, b(n) = (-c(n-1)+b(n-1))/2, b(3) = -6, b(2) = -4, b(1) = -1, b(0) = 0, c(n) = gcd(((-c(n-1)+b(n-1))/2+d(n-1)+1)%2,4)*c(n-1), c(3) = 8, c(2) = 8, c(1) = 8, c(0) = 2, d(n) = gcd(((-c(n-1)+b(n-1))/2+d(n-1)+1)%2,4)/2, d(3) = 0, d(2) = 0, d(1) = 2, d(0) = 0, e(n) = d(n-1)+e(n-1)+1, e(3) = 5, e(2) = 4, e(1) = 1, e(0) = 0

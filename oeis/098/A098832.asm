...
; Formula: a(n) = floor(gcd(0,gcd(-binomial(floor((sqrtint(8*n)-1)/2)+1,2)+n,2)*(floor((sqrtint(8*n)-1)/2)+2)*(-binomial(floor((sqrtint(8*n)-1)/2)+1,2)-floor((sqrtint(8*n)-1)/2)+n-2))/2)

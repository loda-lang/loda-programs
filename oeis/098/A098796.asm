...
; Formula: a(n) = truncate(truncate(binomial(2*max(truncate(A062876(n-1)/4),2)-2,max(truncate(A062876(n-1)/4),2))/max(truncate(A062876(n-1)/4),2))/(max(truncate(A062876(n-1)/4),2)-1))+1

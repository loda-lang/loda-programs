...
; Formula: a(n) = a(n-1)+c(n-1)+1, a(4) = 11, a(3) = 5, a(2) = 3, a(1) = 2, a(0) = 1, b(n) = a(n-1)+1, b(4) = 6, b(3) = 4, b(2) = 3, b(1) = 2, b(0) = 1, c(n) = 2*c(n-1)-c(n-2)+a(n-4)+c(n-4)+d(n-2)+2, c(5) = 35, c(4) = 15, c(3) = 5, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = b(n-1)+d(n-1), d(4) = 10, d(3) = 6, d(2) = 3, d(1) = 1, d(0) = 0

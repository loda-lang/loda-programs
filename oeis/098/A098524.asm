...
; Formula: a(n) = b(n+1), b(n) = 2*c(n-3)+2*d(n-3)+1, b(5) = 3, b(4) = 3, b(3) = 3, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = c(n-1)+d(n-1), c(5) = 5, c(4) = 3, c(3) = 1, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = 2*b(n-2), d(5) = 6, d(4) = 2, d(3) = 2, d(2) = 0, d(1) = 0, d(0) = 1

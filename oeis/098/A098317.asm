...
; Formula: a(n) = -10*truncate(truncate((2*b(5*n))/(truncate(c(5*n)/(10^n))+1))/10)+truncate((2*b(5*n))/(truncate(c(5*n)/(10^n))+1)), b(n) = 3*b(n-1)-b(n-2), b(3) = 210, b(2) = 84, b(1) = 42, b(0) = 42, c(n) = 2*c(n-1)+b(n-1), c(1) = 42, c(0) = 0

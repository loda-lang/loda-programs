...
; Formula: a(n) = truncate((2*min(n+1,(n+1)%2)*b(n+1)+c(n+1)+min(n+1,(n+1)%2))/2), b(n) = 3*b(n-2)+2*c(n-2), b(3) = 2, b(2) = 2, b(1) = 0, b(0) = 0, c(n) = 4*b(n-2)+3*c(n-2)+4, c(3) = 7, c(2) = 7, c(1) = 1, c(0) = 1

...
; Formula: a(n) = truncate((b(n+2)-2)/2)+1, b(n) = 6*b(n-3)+3*b(n-2)+2*d(n-2), b(3) = 4, b(2) = 2, b(1) = 0, b(0) = 0, c(n) = 2*b(n-1), c(3) = 4, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 2*b(n-1)+2*c(n-1)+2*d(n-1), d(3) = 12, d(2) = 4, d(1) = 2, d(0) = 1

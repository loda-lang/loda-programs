...
; Formula: a(n) = 2*c(n-1), a(5) = 6, a(4) = 2, a(3) = 0, a(2) = 0, a(1) = 0, a(0) = 0, b(n) = b(n-1)+b(n-2), b(5) = 8, b(4) = 5, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = a(n-1)+d(n-1), c(5) = 10, c(4) = 3, c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 2*d(n-1)+b(n-2), d(6) = 43, d(5) = 19, d(4) = 8, d(3) = 3, d(2) = 1, d(1) = 0, d(0) = 0

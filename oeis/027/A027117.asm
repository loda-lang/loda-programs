...
; Formula: a(n) = d(n+2)-3, b(n) = c(n-1)+c(n-2)+2, b(5) = 99, b(4) = 46, b(3) = 19, b(2) = 6, b(1) = 1, b(0) = 0, c(n) = 4*n+c(n-1)+c(n-2)+c(n-3)+2, c(5) = 132, c(4) = 66, c(3) = 31, c(2) = 13, c(1) = 4, c(0) = 0, d(n) = 4*n+2*c(n-1)+b(n-1)+d(n-1)-1, d(5) = 355, d(4) = 158, d(3) = 62, d(2) = 19, d(1) = 3, d(0) = 0

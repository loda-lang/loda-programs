...
; Formula: a(n) = c(n-1)+d(n-1)+6, a(3) = 58, a(2) = 20, a(1) = 6, a(0) = 1, b(n) = b(n-1)+a(n-1), b(3) = 27, b(2) = 7, b(1) = 1, b(0) = 0, c(n) = b(n-1)+a(n-1)+c(n-1), c(3) = 35, c(2) = 8, c(1) = 1, c(0) = 0, d(n) = 2*d(n-1)+a(n-1)+12, d(3) = 120, d(2) = 44, d(1) = 13, d(0) = 0

...
; Formula: a(n) = b(n+3), b(n) = d(n-2)/16+1, b(4) = 1, b(3) = 1, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = 2*c(n-1)+2, c(4) = 30, c(3) = 14, c(2) = 6, c(1) = 2, c(0) = 0, d(n) = d(n-1)/16+4*c(n-1)+4, d(4) = 61, d(3) = 28, d(2) = 12, d(1) = 4, d(0) = 0

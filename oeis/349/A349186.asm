...
; Formula: a(n) = truncate((b(max(n-1,0))-2)/2)+1, b(n) = c(n-1), b(4) = 114, b(3) = 42, b(2) = 16, b(1) = 6, b(0) = 2, c(n) = truncate((-5*c(n-4)*(n-1)+c(n-1)*(4*n+14)+c(n-2)*(-2*n-4))/(n+5)), c(4) = 314, c(3) = 114, c(2) = 42, c(1) = 16, c(0) = 6

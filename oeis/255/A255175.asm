...
; Formula: a(n) = c(n+1), b(n) = (2*d(n-1)+b(n-1))%2, b(2) = 1, b(1) = -1, b(0) = -1, c(n) = -((2*d(n-1)+b(n-1))%2)+c(n-1), c(2) = 0, c(1) = 1, c(0) = 0, d(n) = 2*d(n-1)-((2*d(n-1)+b(n-1))%2)-d(n-2), d(3) = 0, d(2) = 1, d(1) = 1, d(0) = 0

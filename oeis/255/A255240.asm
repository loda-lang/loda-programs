...
; Formula: a(n) = floor(b(4*n+4)/floor(c(4*n+4)/(10^(n+1))))%10, b(n) = 2*c(n-1)+b(n-1)+d(n-1), b(2) = 11, b(1) = 2, b(0) = 0, c(n) = 4*c(n-1)+2*d(n-1)+b(n-1), c(2) = 20, c(1) = 4, c(0) = 1, d(n) = c(n-1)+d(n-1), d(2) = 5, d(1) = 1, d(0) = 0

...
; Formula: a(n) = f(n+4), b(n) = e(n-2), b(7) = 3, b(6) = 3, b(5) = 3, b(4) = 1, b(3) = 0, b(2) = 0, b(1) = 1, b(0) = 0, c(n) = b(n-1), c(7) = 3, c(6) = 3, c(5) = 1, c(4) = 0, c(3) = 0, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = -e(n-2)+e(n-4)+f(n-2), d(7) = 26, d(6) = 13, d(5) = 5, d(4) = 3, d(3) = 3, d(2) = 2, d(1) = 1, d(0) = 0, e(n) = c(n-1)+d(n-1), e(7) = 16, e(6) = 6, e(5) = 3, e(4) = 3, e(3) = 3, e(2) = 1, e(1) = 0, e(0) = 0, f(n) = b(n-1)+c(n-1)+d(n-1)+f(n-1)+f1(n-1), f(7) = 80, f(6) = 45, f(5) = 26, f(4) = 15, f(3) = 8, f(2) = 4, f(1) = 2, f(0) = 2, f1(n) = c(n-1)+d(n-1)+f1(n-1), f1(7) = 32, f1(6) = 16, f1(5) = 10, f1(4) = 7, f1(3) = 4, f1(2) = 1, f1(1) = 0, f1(0) = 0

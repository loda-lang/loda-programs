...
; Formula: a(n) = 2*b(n)+54, b(n) = 8*truncate(c(n-4)/2)+2*c(n-1)-2*b(n-3)-4*c(n-4)-8, b(5) = 28, b(4) = 16, b(3) = 8, b(2) = 4, b(1) = 1, b(0) = 0, c(n) = 6*c(n-3)+2*c(n-4)-2*truncate(c(n-1)/2)-4*truncate(c(n-4)/2)-8*truncate(c(n-3)/2)+c(n-1)+17, c(7) = 67, c(6) = 48, c(5) = 27, c(4) = 24, c(3) = 13, c(2) = 4, c(1) = 1, c(0) = 0

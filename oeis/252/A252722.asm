...
; Formula: a(n) = 2*b(n)+54, b(n) = 2*(d(n-2)%2)+c(n-2)+4, b(4) = 16, b(3) = 8, b(2) = 4, b(1) = 1, b(0) = 0, c(n) = 4*((d(n-3)%2+c(n-3)+1)%2)+4*(d(n-3)%2)+2*c(n-3)+18, c(4) = 26, c(3) = 22, c(2) = 12, c(1) = 2, c(0) = 0, d(n) = d(n-1)%2+c(n-1)+1, d(4) = 24, d(3) = 13, d(2) = 4, d(1) = 1, d(0) = 0

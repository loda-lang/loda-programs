...
; Formula: a(n) = e(n+1), b(n) = 2*b(n-1)-2*truncate(d(n-1)/2)+c(n-1)+d(n-1)+e(n-1), b(3) = 11, b(2) = 3, b(1) = 1, b(0) = 0, c(n) = 3*c(n-1)+3*e(n-1), c(3) = 15, c(2) = 3, c(1) = 0, c(0) = 0, d(n) = b(n-1)+c(n-1)+e(n-1), d(3) = 8, d(2) = 2, d(1) = 0, d(0) = 1, e(n) = -2*truncate(d(n-1)/2)+b(n-1)+c(n-1)+d(n-1)+e(n-1), e(3) = 8, e(2) = 2, e(1) = 1, e(0) = 0

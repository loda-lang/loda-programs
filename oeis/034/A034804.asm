...
; Formula: a(n) = c(n-1), a(4) = 2, a(3) = 0, a(2) = 1, a(1) = 0, a(0) = 0, b(n) = -a(n-1)+b(n-1)+1, b(4) = 3, b(3) = 2, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = gcd(b(n-1),2)*c(n-2)+a(n-2), c(4) = 1, c(3) = 2, c(2) = 0, c(1) = 1, c(0) = 0

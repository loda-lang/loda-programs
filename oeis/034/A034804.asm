...
; Formula: a(n) = a(n-1)+d(n-1), a(6) = 4, a(5) = 2, a(4) = 1, a(3) = 2, a(2) = 0, a(1) = 1, a(0) = 0, b(n) = a(n-1)+d(n-1), b(6) = 4, b(5) = 2, b(4) = 1, b(3) = 2, b(2) = 0, b(1) = 1, b(0) = 0, c(n) = c(n-1)*b(n-1)-2*truncate((c(n-1)*b(n-1)+a(n-1)+d(n-1))/2)+a(n-1)+d(n-1), c(6) = 0, c(5) = 1, c(4) = 1, c(3) = 0, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = c(n-1)*b(n-1)-d(n-1)+e(n-2)+f(n-2), d(6) = 1, d(5) = 2, d(4) = 1, d(3) = -1, d(2) = 2, d(1) = -1, d(0) = 1, e(n) = e(n-1)+f(n-1), e(6) = 2, e(5) = 1, e(4) = 2, e(3) = 0, e(2) = 1, e(1) = 0, e(0) = 0, f(n) = d(n-1), f(6) = 2, f(5) = 1, f(4) = -1, f(3) = 2, f(2) = -1, f(1) = 1, f(0) = 0

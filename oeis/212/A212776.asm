...
; Formula: a(n) = truncate(d(n+2)/2)+2, b(n) = d(n-1)+2, b(4) = 53, b(3) = 21, b(2) = 8, b(1) = 2, b(0) = 1, c(n) = 2*b(n-1)-e(n-1)+d(n-1)+f(n-1)+2, c(4) = 82, c(3) = 32, c(2) = 12, c(1) = 4, c(0) = 0, d(n) = 2*b(n-1)+c(n-1)+d(n-1)+f(n-1)+4, d(4) = 129, d(3) = 51, d(2) = 19, d(1) = 6, d(0) = 0, e(n) = c(n-1)+1, e(4) = 33, e(3) = 13, e(2) = 5, e(1) = 1, e(0) = 0, f(n) = truncate((2*b(n-1)+c(n-1)+f(n-1)+2)/(2*b(n-1)-e(n-1)+d(n-1)+f(n-1)+2)), f(4) = 0, f(3) = 0, f(2) = 0, f(1) = 1, f(0) = 0

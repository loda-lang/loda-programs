...
; Formula: a(n) = -2*truncate((A005875(n)*gcd(-2*truncate(floor((n+1)/2)/2)+floor((n+1)/2),3))/3)*(-2*truncate(floor((n+9)/2)/2)+floor((n+9)/2))+truncate((A005875(n)*gcd(-2*truncate(floor((n+1)/2)/2)+floor((n+1)/2),3))/3)

...
; Formula: a(n) = truncate((2*binomial(n+2,2)*((n+1)%2)+2*truncate((((n+1)%2+1)*(3*n-((n+1)%2)-floor((4*n+4)/2)+3)*(3*((n+1)%2)+3*n-floor((4*n+4)/2)+4))/2)+2*truncate(binomial(-2*n-2,3)/(-4))-4)/4)+1

...
; Formula: a(n) = d(n+1), b(n) = (-max(c(n-1),17)+b(n-1))/2, b(2) = -37, b(1) = -7, b(0) = 3, c(n) = 4*max(c(n-1),17)*((((-max(c(n-1),17)+b(n-1))/2+d(n-1))/2)%2+2), c(2) = 544, c(1) = 68, c(0) = 0, d(n) = (((-max(c(n-1),17)+b(n-1))/2+d(n-1))/2)%2+2, d(2) = 2, d(1) = 1, d(0) = 0

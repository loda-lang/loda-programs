...
; Formula: a(n) = (c(n+1)*(-n-1)*d(n+1)^2)/3698, b(n) = 5*b(n-1)+c(n-1)-10, b(3) = -237, b(2) = -39, b(1) = -5, b(0) = 1, c(n) = 4*b(n-1)+c(n-1)-8, c(3) = -196, c(2) = -32, c(1) = -4, c(0) = 0, d(n) = -43, d(3) = -43, d(2) = -43, d(1) = -43, d(0) = 0

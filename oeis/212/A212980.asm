...
; Formula: a(n) = a(n-1)+d(n-1), a(3) = 6, a(2) = 1, a(1) = 0, a(0) = 0, b(n) = b(n-1)==0, b(3) = 1, b(2) = 0, b(1) = 1, b(0) = 0, c(n) = b(n-1)+c(n-1)+2, c(3) = 7, c(2) = 5, c(1) = 2, c(0) = 0, d(n) = b(n-1)+c(n-1)+d(n-1)+1, d(3) = 11, d(2) = 5, d(1) = 1, d(0) = 0

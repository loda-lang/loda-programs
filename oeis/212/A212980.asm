...
; Formula: a(n) = e(n-1)+a(n-1), a(4) = 17, a(3) = 6, a(2) = 1, a(1) = 0, a(0) = 0, b(n) = b(n-1)==0, b(4) = 0, b(3) = 1, b(2) = 0, b(1) = 1, b(0) = 0, c(n) = b(n-1)+c(n-1)+2, c(4) = 8, c(3) = 5, c(2) = 3, c(1) = 0, c(0) = 0, d(n) = 2, d(4) = 2, d(3) = 2, d(2) = 2, d(1) = 2, d(0) = 0, e(n) = b(n-1)+c(n-1)+d(n-1)+e(n-1)+1, e(4) = 20, e(3) = 11, e(2) = 5, e(1) = 1, e(0) = 0

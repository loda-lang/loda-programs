...
; Formula: a(n) = c(n+1), b(n) = 7*b(n-1), b(3) = 343, b(2) = 49, b(1) = 7, b(0) = 1, c(n) = ((6*(2*d(n-1)-11)^2+d(n-1)+11)%(7*b(n-1))+2)/b(n-1), c(4) = 3, c(3) = 0, c(2) = 2, c(1) = 5, c(0) = 0, d(n) = (6*(2*d(n-1)-11)^2+d(n-1)+11)%(7*b(n-1))+7, d(4) = 1053, d(3) = 24, d(2) = 24, d(1) = 10, d(0) = 0

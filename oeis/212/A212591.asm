...
; Formula: a(n) = truncate((2*b(n)+c(n))/48), b(n) = b(n-1)+c(n-1)+6, b(1) = 6, b(0) = 0, c(n) = sign(3*sign(b(n-1)+c(n-1))*sign(b(n-1)+c(n-1)+6)+sign(b(n-1)+c(n-1)+6)+sign(b(n-1)+c(n-1)))*bitxor(abs(b(n-1)+c(n-1)),abs(b(n-1)+c(n-1)+6)), c(1) = 6, c(0) = 0

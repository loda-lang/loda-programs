...
; Formula: a(n) = f(n)+1, b(n) = b(n-1)+d(n-1), b(4) = 12, b(3) = 5, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = 2*(d(n-1)/2)+b(n-1)+e(n-1)+3, c(4) = 42, c(3) = 20, c(2) = 7, c(1) = 3, c(0) = 0, d(n) = -b(n-1)+c(n-1)+1, d(4) = 16, d(3) = 7, d(2) = 4, d(1) = 1, d(0) = 0, e(n) = b(n-1)+c(n-1)+d(n-1)+e(n-1)+4, e(4) = 64, e(3) = 28, e(2) = 12, e(1) = 4, e(0) = 0, f(n) = c(n-1)+d(n-1)+1, f(4) = 28, f(3) = 12, f(2) = 5, f(1) = 1, f(0) = 0

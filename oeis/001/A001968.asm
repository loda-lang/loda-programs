...
; Formula: a(n) = e(4*n+4)/2-2, b(n) = (-c(n-1)+b(n-1))/2+c(n-1), b(3) = 8, b(2) = 3, b(1) = 2, b(0) = 3, c(n) = c(n-1)*(((-c(n-1)+b(n-1))/2+d(n-1))%2+2), c(3) = 12, c(2) = 12, c(1) = 4, c(0) = 2, d(n) = ((-c(n-1)+b(n-1))/2+d(n-1))%2+2, d(3) = 1, d(2) = 3, d(1) = 2, d(0) = 0, e(n) = ((-c(n-1)+b(n-1))/2+d(n-1))%2+e(n-1)+3, e(3) = 9, e(2) = 7, e(1) = 3, e(0) = 0

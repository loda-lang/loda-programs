...
; Formula: a(n) = truncate(min(4*truncate((4*n-8)/4)+sqrtint((4*truncate((4*n-8)/4)+11)*(20*truncate((4*n-8)/4)+55))+11,4*truncate((4*n-8)/4)+truncate((4*truncate((4*n-8)/4)+sqrtint((4*truncate((4*n-8)/4)+11)*(20*truncate((4*n-8)/4)+55))+11)/2)+11)/2)

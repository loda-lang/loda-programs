...
; Formula: a(n) = b(n)+d(n)+f(n)-2, b(n) = -e(n-6)+b(n-1)+b(n-2)+e(n-3), b(8) = 52, b(7) = 27, b(6) = 17, b(5) = 8, b(4) = 5, b(3) = 1, b(2) = 2, b(1) = -1, b(0) = 3, c(n) = e(n-1)+e(n-2)+e(n-3)-1, c(6) = 18, c(5) = 10, c(4) = 8, c(3) = 4, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = 2*e(n-3)+b(n-3)+d(n-2)+e(n-1)+e(n-4)-2, d(6) = 28, d(5) = 18, d(4) = 9, d(3) = 6, d(2) = 2, d(1) = 3, d(0) = 0, e(n) = e(n-1)+e(n-2)+e(n-4)+e(n-5)+e(n-6)-2, e(8) = 62, e(7) = 35, e(6) = 18, e(5) = 10, e(4) = 5, e(3) = 4, e(2) = 2, e(1) = 3, e(0) = 0, f(n) = b(n-1)+c(n-1)+e(n-1), f(6) = 28, f(5) = 18, f(4) = 9, f(3) = 6, f(2) = 2, f(1) = 3, f(0) = 0

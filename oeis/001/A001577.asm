...
; Formula: a(n) = max(d(n-1),1), a(3) = 2, a(2) = 1, a(1) = 1, a(0) = 0, b(n) = b(n-1)+b(n-2), b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = c(n-1)+c(n-2), c(4) = 3, c(3) = 2, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = max(d(n-2),1)*max(d(n-1),1)*(b(n-1)+c(n-1)), d(3) = 6, d(2) = 2, d(1) = 0, d(0) = 0

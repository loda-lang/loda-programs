...
; Formula: a(n) = d(n-1), b(n) = b(n-1)+b(n-2), b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = c(n-1)+c(n-2), c(4) = 3, c(3) = 2, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = d(n-2)*d(n-1)*(b(n-1)+c(n-1)), d(3) = 6, d(2) = 2, d(1) = 1, d(0) = 1

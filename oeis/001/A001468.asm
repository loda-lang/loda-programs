...
; Formula: a(n) = gcd((-c(n-1)+b(n-1))/2-b(n-1)+a(n-1),2), a(2) = 1, a(1) = 2, a(0) = 1, b(n) = (-c(n-1)+b(n-1))/2, b(2) = -9, b(1) = -2, b(0) = -1, c(n) = 2*gcd((-c(n-1)+b(n-1))/2-b(n-1)+a(n-1),2)*c(n-1), c(2) = 32, c(1) = 16, c(0) = 4

...
; Formula: a(n) = b(n)+d(n)+f(n)-3, b(n) = b(n-2)+b(n-3)+b(n-4)+b(n-5)-1, b(6) = 4, b(5) = 4, b(4) = 3, b(3) = 1, b(2) = 2, b(1) = -1, b(0) = 3, c(n) = d(n-3)+d(n-4)-2, c(6) = 4, c(5) = 3, c(4) = 1, c(3) = 2, c(2) = 3, c(1) = 0, c(0) = 0, d(n) = d(n-2)+d(n-3)+d(n-4)+d(n-5)-4, d(7) = 12, d(6) = 10, d(5) = 5, d(4) = 5, d(3) = 4, d(2) = 2, d(1) = 3, d(0) = 0, e(n) = b(n-1), e(5) = 3, e(4) = 1, e(3) = 2, e(2) = -1, e(1) = 3, e(0) = 0, f(n) = b(n-1)+c(n-1)+e(n-1), f(5) = 5, f(4) = 5, f(3) = 4, f(2) = 2, f(1) = 3, f(0) = 0

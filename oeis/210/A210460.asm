...
; Formula: a(n) = 2*c(n-1)+b(n-1)+d(n-1), a(3) = 10, a(2) = 4, a(1) = 2, a(0) = 1, b(n) = 2*c(n-2)+b(n-2)+b(n-3)+c(n-3), b(3) = 4, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = b(n-1)+c(n-1)+d(n-1), c(3) = 7, c(2) = 3, c(1) = 1, c(0) = 1, d(n) = b(n-1)+c(n-1), d(3) = 5, d(2) = 2, d(1) = 1, d(0) = 0

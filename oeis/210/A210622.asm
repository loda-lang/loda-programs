...
; Formula: a(n) = (-10*truncate((truncate(if(((2*n-12)^2)==1,(2*n-12)^(-n+6),if((-n+6)<=(-1),0,(2*n-12)^(-n+6)))/3)+6)/10)+truncate(if(((2*n-12)^2)==1,(2*n-12)^(-n+6),if((-n+6)<=(-1),0,(2*n-12)^(-n+6)))/3)+16)%10

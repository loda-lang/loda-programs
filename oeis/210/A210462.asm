...
; Formula: a(n) = floor((5*b(3*n)+13)/(floor(c(3*n)/(10^n))+1))%10, b(n) = 4*c(n-1)+2*b(n-1)+2*d(n-1), b(2) = 12, b(1) = 2, b(0) = 1, c(n) = 6*c(n-1)+2*b(n-1)+2*d(n-1), c(2) = 16, c(1) = 2, c(0) = 0, d(n) = 2*c(n-1)+2*d(n-1), d(2) = 4, d(1) = 0, d(0) = 0

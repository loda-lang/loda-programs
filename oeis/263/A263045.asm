...
; Formula: a(n) = c(n)+1, b(n) = c(n-1)*b(n-1)+b(n-1)+d(n-2), b(4) = 1, b(3) = 1, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = d(n-1), c(3) = 0, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = 3*b(n-1)-d(n-1)+1, d(3) = 1, d(2) = 0, d(1) = 1, d(0) = 0

...
; Formula: a(n) = b(n-1), a(3) = -1, a(2) = 2, a(1) = 1, a(0) = 0, b(n) = -d(n-1)+c(n-1), b(3) = -3, b(2) = -1, b(1) = 2, b(0) = 1, c(n) = b(n-2)*(-d(n-1)+c(n-1)), c(3) = -6, c(2) = -1, c(1) = 0, c(0) = 0, d(n) = b(n-1), d(3) = -1, d(2) = 2, d(1) = 1, d(0) = -2

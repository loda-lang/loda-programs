...
; Formula: a(n) = b(n)/4+1, b(n) = 3*b(n-2)+2*b(n-1)+2*c(n-2)+2*d(n-2)+4, b(3) = 20, b(2) = 4, b(1) = 0, b(0) = 0, c(n) = b(n-1)+c(n-1)+4, c(3) = 16, c(2) = 8, c(1) = 4, c(0) = 0, d(n) = 2*b(n-1)+c(n-1)+d(n-1), d(3) = 20, d(2) = 4, d(1) = 0, d(0) = 0

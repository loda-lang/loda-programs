...
; Formula: a(n) = b(n)/4+1, b(n) = 2*b(n-1)+c(n-1)+e(n-1), b(3) = 20, b(2) = 4, b(1) = 0, b(0) = 0, c(n) = b(n-1)+d(n-1)+e(n-1)+4, c(3) = 20, c(2) = 8, c(1) = 4, c(0) = 0, d(n) = b(n-1)+d(n-1)+4, d(3) = 16, d(2) = 8, d(1) = 4, d(0) = 0, e(n) = 2*b(n-1)+d(n-1)+e(n-1), e(3) = 20, e(2) = 4, e(1) = 0, e(0) = 0

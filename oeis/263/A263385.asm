...
; Formula: a(n) = c(n+2)^2, b(n) = -e(n-1)+b(n-1)+f(n-1), b(5) = -4, b(4) = -2, b(3) = -1, b(2) = -1, b(1) = 0, b(0) = 0, c(n) = -b(n-1)-f(n-1)+d(n-1)+e(n-1), c(5) = 6, c(4) = 4, c(3) = 2, c(2) = 1, c(1) = 0, c(0) = 1, d(n) = -b(n-1)-f(n-1)-f(n-2)+e(n-1)+e(n-2), d(5) = 5, d(4) = 2, d(3) = 2, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = -b(n-1)-f(n-3)-2*f(n-2)+e(n-1)+e(n-2)+e(n-3), e(9) = 78, e(8) = 42, e(7) = 23, e(6) = 11, e(5) = 6, e(4) = 4, e(3) = 2, e(2) = 0, e(1) = 1, e(0) = 0, f(n) = d(n-1), f(5) = 2, f(4) = 2, f(3) = 1, f(2) = 0, f(1) = 0, f(0) = 0

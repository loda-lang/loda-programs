...
; Formula: a(n) = d(n+1)+1, b(n) = -b(n-1)-b(n-2)+c(n-4)+d(n-4)+1, b(7) = 2, b(6) = 2, b(5) = 0, b(4) = 1, b(3) = 0, b(2) = 0, b(1) = 1, b(0) = 0, c(n) = b(n-1)+c(n-1), c(6) = 2, c(5) = 2, c(4) = 1, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = b(n-1)+c(n-1)+c(n-2)+d(n-1), d(6) = 10, d(5) = 7, d(4) = 4, d(3) = 2, d(2) = 1, d(1) = 0, d(0) = 0

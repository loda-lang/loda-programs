...
; Formula: a(n) = e(n+1)+1, b(n) = -b(n-2)-c(n-3)+b(n-3)+d(n-3)+e(n-3), b(6) = 3, b(5) = 1, b(4) = 0, b(3) = 0, b(2) = -1, b(1) = 0, b(0) = 0, c(n) = -c(n-1)+b(n-1)+1, c(6) = 2, c(5) = 0, c(4) = 1, c(3) = 0, c(2) = 0, c(1) = 1, c(0) = 0, d(n) = c(n-1)+d(n-1), d(6) = 2, d(5) = 2, d(4) = 1, d(3) = 1, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = 2*d(n-2)+b(n-2)+e(n-1)+1, e(6) = 10, e(5) = 7, e(4) = 4, e(3) = 2, e(2) = 1, e(1) = 0, e(0) = 0

...
; Formula: a(n) = floor(((-binomial(floor((sqrtint(8*n)-1)/2)+1,2)+n-1)^2+(floor((sqrtint(8*n)-1)/2)+1)^2)/gcd(2*(-binomial(floor((sqrtint(8*n)-1)/2)+1,2)+n-1)^2,(-binomial(floor((sqrtint(8*n)-1)/2)+1,2)+n-1)^2+(floor((sqrtint(8*n)-1)/2)+1)^2))

...
; Formula: a(n) = e(n+1)-5, b(n) = (-c(n-1)+b(n-1))/2, b(3) = -264, b(2) = -16, b(1) = -1, b(0) = 0, c(n) = 16*gcd((-c(n-1)+b(n-1))/2+d(n-1),4)*c(n-1), c(3) = 8192, c(2) = 512, c(1) = 32, c(0) = 2, d(n) = gcd((-c(n-1)+b(n-1))/2+d(n-1),4)/2+1, d(3) = 1, d(2) = 1, d(1) = 1, d(0) = 0, e(n) = d(n-1)+e(n-1)+5, e(3) = 17, e(2) = 11, e(1) = 5, e(0) = 0

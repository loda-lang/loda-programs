...
; Formula: a(n) = ((b(4*n+1)*(4*n+4))/2)/c(4*n+1), b(n) = 22*c(n-1)+2*b(n-1)+2*d(n-1), b(3) = 12260, b(2) = 530, b(1) = 22, b(0) = 0, c(n) = 22*c(n-1)+b(n-1)+d(n-1), c(3) = 11707, c(2) = 507, c(1) = 22, c(0) = 1, d(n) = c(n-1)+d(n-1), d(3) = 530, d(2) = 23, d(1) = 1, d(0) = 0

...
; Formula: a(n) = d(n+338), b(n) = (-c(n-1)+b(n-1))/2, b(2) = -1279, b(1) = -510, b(0) = 3, c(n) = c(n-1)*(((-c(n-1)+b(n-1))/2+d(n-1))%2+2), c(2) = 2048, c(1) = 2048, c(0) = 1024, d(n) = ((-c(n-1)+b(n-1))/2+d(n-1))%2+2, d(2) = 1, d(1) = 2, d(0) = 0

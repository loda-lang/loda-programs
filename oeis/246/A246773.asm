...
; Formula: a(n) = ((d(3*n)+3)/(c(3*n)/(10^n)))%10, b(n) = 4*c(n-1)+2*b(n-1)+2*d(n-1), b(2) = 26, b(1) = 4, b(0) = 0, c(n) = 3*c(n-1)+b(n-1)+d(n-1), c(2) = 16, c(1) = 3, c(0) = 1, d(n) = 3*c(n-1)+2*d(n-1)+b(n-1), d(2) = 19, d(1) = 3, d(0) = 0

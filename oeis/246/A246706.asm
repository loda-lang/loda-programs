...
; Formula: a(n) = d(n+1)+1, b(n) = b(n-1)/2-b(n-1)+c(n-1), b(3) = 9, b(2) = 7, b(1) = 2, b(0) = 0, c(n) = gcd(b(n-1)/2,2)*(b(n-1)/2+2*c(n-1)-2*b(n-1)), c(3) = 15, c(2) = 13, c(1) = 8, c(0) = 2, d(n) = d(n-1)+gcd(b(n-2)/2,2)+1, d(3) = 6, d(2) = 4, d(1) = 1, d(0) = 0

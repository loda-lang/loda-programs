...
; Formula: a(n) = (b(4*n+4)/(c(4*n+4)/(10^(n+1))))%10, b(n) = 4*c(n-1)+2*b(n-1)+2*e(n-1), b(3) = 54, b(2) = 10, b(1) = 2, b(0) = 1, c(n) = 2*c(n-1)+b(n-1)+c(n-1)+e(n-1), c(3) = 33, c(2) = 6, c(1) = 1, c(0) = 0, d(n) = 2*c(n-1)+b(n-1)+c(n-1)+d(n-1)+e(n-1), d(3) = 40, d(2) = 7, d(1) = 1, d(0) = 0, e(n) = 2*c(n-1)-c(n-1)-e(n-1)+b(n-1)+c(n-1)+d(n-1)+e(n-1), e(3) = 29, e(2) = 5, e(1) = 1, e(0) = 0

...
; Formula: a(n) = b(n+2)+1, b(n) = 4*c(n-2)+4*e(n-2)+2*b(n-2)+2*d(n-2)+c(n-2), b(5) = 102, b(4) = 28, b(3) = 6, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = 2*b(n-1)+c(n-1)+2, c(5) = 78, c(4) = 20, c(3) = 6, c(2) = 4, c(1) = 2, c(0) = 0, d(n) = 4*c(n-1)+4*e(n-1)+2*b(n-1)+2*d(n-1)+c(n-1), d(5) = 372, d(4) = 102, d(3) = 28, d(2) = 6, d(1) = 0, d(0) = 0, e(n) = 2*b(n-2)+c(n-2)-1, e(5) = 17, e(4) = 3, e(3) = 1, e(2) = -1, e(1) = -1, e(0) = 0

...
; Formula: a(n) = truncate(c(n+4)/12), b(n) = 3*d(n-1)+b(n-1), b(3) = 60, b(2) = 12, b(1) = 0, b(0) = 0, c(n) = 2*c(n-1)+b(n-1)+e(n-1), c(3) = 12, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 3*d(n-1)+4, d(3) = 52, d(2) = 16, d(1) = 4, d(0) = 0, e(n) = 2*b(n-1)+2*e(n-1), e(3) = 24, e(2) = 0, e(1) = 0, e(0) = 0

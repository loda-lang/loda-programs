...
; Formula: a(n) = truncate(truncate((10*A064989(n+1)*A000203(n+1))/10)/gcd(A000203(A064989(n+1)+1)*(n-1)+A000203(A064989(n+1)+1),truncate((10*A064989(n+1)*A000203(n+1))/10)))

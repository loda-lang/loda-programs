...
; Formula: a(n) = -n+binomial(floor((sqrtint(8*n-16)-1)/2)+1,2)+bitand((-binomial(floor((sqrtint(8*n-16)-1)/2)+1,2)+n-2)*(-n+binomial(floor((sqrtint(8*n-16)-1)/2)+1,2)+floor((sqrtint(8*n-16)-1)/2)+7),-2)+3

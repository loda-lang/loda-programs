...
; Formula: a(n) = A276086(A124859(A181811(truncate((A057335(min(n,n%108))-1)/A293810(A057335(min(n,n%108))-1))+1)*(truncate((A057335(min(n,n%108))-1)/A293810(A057335(min(n,n%108))-1))+1)))

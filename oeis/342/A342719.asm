; A342719: Array read by ascending antidiagonals: T(k, n) is the sum of the consecutive positive integers from 1 to (n - 1)*k placed along the perimeter of a n-th order perimeter-magic k-gon.

...
; Formula: a(n) = f(n)+1, b(n) = 2*d(n-1)+1, b(4) = 25, b(3) = 11, b(2) = 3, b(1) = 1, b(0) = 0, c(n) = b(n-1)+c(n-1)+d(n-1)+e(n-1)+5, c(4) = 108, c(3) = 43, c(2) = 16, c(1) = 5, c(0) = 0, d(n) = -d(n-1)+c(n-1)+1, d(4) = 32, d(3) = 12, d(2) = 5, d(1) = 1, d(0) = 0, e(n) = b(n-1)+c(n-1)+e(n-1)+4, e(4) = 95, e(3) = 37, e(2) = 14, e(1) = 4, e(0) = 0, f(n) = c(n-1)+d(n-1)+2, f(4) = 57, f(3) = 23, f(2) = 8, f(1) = 2, f(0) = 0

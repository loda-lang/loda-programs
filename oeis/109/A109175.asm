...
; Formula: a(n) = d(n)+1, b(n) = 2*b(n-1)+c(n-1)+c(n-2)+5, b(5) = 265, b(4) = 108, b(3) = 43, b(2) = 16, b(1) = 5, b(0) = 0, c(n) = -c(n-1)+b(n-1)+1, c(4) = 32, c(3) = 12, c(2) = 5, c(1) = 1, c(0) = 0, d(n) = b(n-1)+c(n-1)+2, d(4) = 57, d(3) = 23, d(2) = 8, d(1) = 2, d(0) = 0

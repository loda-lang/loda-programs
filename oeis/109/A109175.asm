...
; Formula: a(n) = e(n)-1, b(n) = c(n-1), b(4) = 1, b(3) = -1, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = (d(n-1)==b(n-1))-c(n-1), c(4) = -1, c(3) = 1, c(2) = -1, c(1) = 1, c(0) = 0, d(n) = e(n-1), d(4) = 10, d(3) = 4, d(2) = 2, d(1) = 1, d(0) = 0, e(n) = f(n-1), e(4) = 25, e(3) = 10, e(2) = 4, e(1) = 2, e(0) = 1, f(n) = 2*f(n-1)-(d(n-1)==b(n-1))+b(n-1)+e(n-1), f(4) = 59, f(3) = 25, f(2) = 10, f(1) = 4, f(0) = 2

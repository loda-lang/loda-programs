...
; Formula: a(n) = a(n-1)+c(n-1), a(5) = 1, a(4) = 1, a(3) = 1, a(2) = 1, a(1) = 1, a(0) = 1, b(n) = b(n-3)+a(n-4)+c(n-1), b(6) = 2, b(5) = 1, b(4) = 1, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = b(n-1), c(5) = 1, c(4) = 0, c(3) = 0, c(2) = 0, c(1) = 0, c(0) = 0

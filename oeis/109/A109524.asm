...
; Formula: a(n) = b(n-1)%2+c(n-2)+c(n-3), a(4) = 3, a(3) = 1, a(2) = 2, a(1) = 2, a(0) = 0, b(n) = b(n-2)%2+b(n-1), b(4) = 3, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = c(n-2)+c(n-3), c(4) = 2, c(3) = 1, c(2) = 1, c(1) = 1, c(0) = 0

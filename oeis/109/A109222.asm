...
; Formula: a(n) = e(n+1)/121+1, b(n) = b(n-1)+d(n-1), b(3) = 121, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = d(n-1)+121, c(3) = 242, c(2) = 121, c(1) = 121, c(0) = 0, d(n) = 2*d(n-2)+2*d(n-3)+b(n-3)+242, d(3) = 242, d(2) = 121, d(1) = 0, d(0) = 0, e(n) = b(n-1)+c(n-1)+d(n-1), e(3) = 242, e(2) = 121, e(1) = 0, e(0) = 0

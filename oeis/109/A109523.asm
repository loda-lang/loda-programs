...
; Formula: a(n) = d(n-1)/2+2, a(3) = 2, a(2) = 2, a(1) = 2, a(0) = 0, b(n) = b(n-1)+c(n-1), b(3) = 6, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = 2*((b(n-3)+c(n-3))/2)+b(n-2)+c(n-2)+5, c(3) = 6, c(2) = 5, c(1) = 1, c(0) = 0, d(n) = b(n-1)+c(n-1), d(3) = 6, d(2) = 1, d(1) = 0, d(0) = 0

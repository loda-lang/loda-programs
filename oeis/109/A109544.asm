...
; Formula: a(n) = 3*truncate(d(n)/2)+1, b(n) = -c(n-4)+b(n-4)+c(n-5), b(6) = -4, b(5) = -2, b(4) = -2, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = -c(n-6)+c(n-1)+c(n-2), c(9) = 208, c(8) = 134, c(7) = 86, c(6) = 54, c(5) = 34, c(4) = 20, c(3) = 12, c(2) = 6, c(1) = 2, c(0) = 0, d(n) = -b(n-1), d(4) = 0, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0

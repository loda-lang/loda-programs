...
; Formula: a(n) = binomial(3*binomial(truncate((sqrtint(8*n)-1)/2)+1,2)-3*n+truncate((sqrtint(8*n)-1)/2)-1,-n+binomial(truncate((sqrtint(8*n)-1)/2)+1,2)+truncate((sqrtint(8*n)-1)/2))

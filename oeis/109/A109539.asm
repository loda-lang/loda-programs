...
; Formula: a(n) = 6*b(n)+1, b(n) = b(n-1)+b(n-3)+b(n-5)+b(n-7)+c(n-7), b(7) = 0, b(6) = 0, b(5) = 0, b(4) = 0, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = -c(n-1)+1, c(7) = 1, c(6) = 0, c(5) = 1, c(4) = 0, c(3) = 1, c(2) = 0, c(1) = 1, c(0) = 0

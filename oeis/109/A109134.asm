...
; Formula: a(n) = ((b(4*n)+1)/(c(4*n)/(10^n)))%10, b(n) = 5*b(n-1)-4*b(n-2)+b(n-3), b(5) = 351, b(4) = 86, b(3) = 21, b(2) = 5, b(1) = 1, b(0) = 0, c(n) = 5*c(n-1)-4*c(n-2)+c(n-3), c(4) = 114, c(3) = 28, c(2) = 7, c(1) = 2, c(0) = 1

...
; Formula: a(n) = d(n+2)/2, b(n) = 2*b(n-1)+2*b(n-2), b(3) = 32, b(2) = 12, b(1) = 4, b(0) = 2, c(n) = b(n-1), c(3) = 12, c(2) = 4, c(1) = 2, c(0) = 0, d(n) = 2*d(n-1)+2*d(n-2)+c(n-2), d(3) = 2, d(2) = 0, d(1) = 0, d(0) = 0

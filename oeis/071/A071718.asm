...
; Formula: a(n) = truncate(floor(binomial(2*n,n)/(n+1))/(-floor(binomial(2*n,n)/(n+1))+floor(binomial(2*n+4,n+2)/(n+3))))*(-floor(binomial(2*n,n)/(n+1))+floor(binomial(2*n+4,n+2)/(n+3)))-2*floor(binomial(2*n,n)/(n+1))+floor(binomial(2*n+4,n+2)/(n+3))

...
; Formula: a(n) = (c(n+1)+d(n+1))/gcd(c(n+1),b(n+1)), b(n) = n*b(n-1), b(3) = 6, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = n*c(n-1)+b(n-1), c(3) = 17, c(2) = 5, c(1) = 2, c(0) = 1, d(n) = d(n-1), d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0

...
; Formula: a(n) = truncate(b(n+1)/gcd(d(n+1),b(n+1))), b(n) = 4*c(n-1)+3, b(2) = 15, b(1) = 3, b(0) = 0, c(n) = 4*c(n-1)+3, c(2) = 15, c(1) = 3, c(0) = 0, d(n) = max(4*d(n-1)*c(n-1),1), d(2) = 12, d(1) = 1, d(0) = 0

...
; Formula: a(n) = b(n-1)+c(n-1)+a(n-1)+d(n-1)+e(n-1)+1, a(5) = 480, a(4) = 244, a(3) = 124, a(2) = 63, a(1) = 32, a(0) = 16, b(n) = c(n-2)+e(n-2), b(5) = 95, b(4) = 48, b(3) = 24, b(2) = 12, b(1) = 6, b(0) = 3, c(n) = e(n-1), c(5) = 124, c(4) = 63, c(3) = 32, c(2) = 16, c(1) = 8, c(0) = 4, d(n) = binomial(c(n-1)+d(n-1)+e(n-1),b(n-1)+c(n-1)+a(n-1)+d(n-1)+e(n-1)+1), d(5) = 0, d(4) = 0, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = a(n-1), e(5) = 244, e(4) = 124, e(3) = 63, e(2) = 32, e(1) = 16, e(0) = 8

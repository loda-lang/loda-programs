...
; Formula: a(n) = -truncate((10*b(n))/c(n))-10*truncate((-truncate((10*b(n))/c(n))+c(n)+9)/10)+c(n)+9, b(n) = -10*truncate((5*b(n-1)^2)/(10*c(n-1)))*c(n-1)+5*b(n-1)^2, b(1) = 5, b(0) = 1, c(n) = 10*c(n-1), c(1) = 20, c(0) = 2

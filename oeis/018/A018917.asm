...
; Formula: a(n) = max(min(n+11,(n+11)%3)-1,0)*(-c(n+11)+d(n+11))+min(min(n+11,(n+11)%3),1)*(-b(n+11)+c(n+11))+b(n+11)-4, b(n) = b(n-3)+c(n-3), b(8) = 2, b(7) = 2, b(6) = 2, b(5) = 1, b(4) = 1, b(3) = 1, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = c(n-3)+d(n-3), c(8) = 2, c(7) = 2, c(6) = 2, c(5) = 1, c(4) = 1, c(3) = 1, c(2) = 1, c(1) = 1, c(0) = 1, d(n) = b(n-3)+c(n-3)+d(n-3), d(8) = 3, d(7) = 3, d(6) = 3, d(5) = 1, d(4) = 1, d(3) = 1, d(2) = 0, d(1) = 0, d(0) = 0

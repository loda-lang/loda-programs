...
; Formula: a(n) = b(n+1)/2, b(n) = 2*c(n-1)+2*d(n-1)+b(n-1), b(3) = 58, b(2) = 12, b(1) = 2, b(0) = 0, c(n) = 2*d(n-1)+c(n-1), c(3) = 38, c(2) = 8, c(1) = 2, c(0) = 0, d(n) = 2*c(n-1)+2*d(n-1)-c(n-1)+b(n-1)+d(n-1)+e(n-1), d(3) = 77, d(2) = 15, d(1) = 3, d(0) = 1, e(n) = 2*c(n-1)+2*d(n-1)-c(n-1)+b(n-1)+e(n-1), e(3) = 62, e(2) = 12, e(1) = 2, e(0) = 0

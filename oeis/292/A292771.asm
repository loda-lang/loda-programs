...
; Formula: a(n) = truncate((-truncate((-A000010(n+1)+A000203(n+1)+2)/truncate((-A000010(n+1)+A000203(n+1)+2)^gcd(-A000010(n+1)+A000203(n+1)+2,2)))*truncate((-A000010(n+1)+A000203(n+1)+2)^gcd(-A000010(n+1)+A000203(n+1)+2,2))-A000010(n+1)+A000203(n+1)+2)/2)-1

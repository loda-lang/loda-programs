...
; Formula: a(n) = gcd(min(n,0),c(n)), b(n) = b(n-1)+b(n-2)+2, b(3) = 10, b(2) = 5, b(1) = 3, b(0) = 0, c(n) = -c(n-1)-d(n-2)+b(n-2)+c(n-2)+1, c(3) = -6, c(2) = 6, c(1) = -3, c(0) = 4, d(n) = b(n-1)+1, d(3) = 6, d(2) = 4, d(1) = 1, d(0) = 2

...
; Formula: a(n) = gcd(min(n,0),c(n)), b(n) = b(n-1)+b(n-2)+2, b(4) = 17, b(3) = 10, b(2) = 5, b(1) = 3, b(0) = 0, c(n) = -c(n-1)-e(n-1)+d(n-1), c(4) = 14, c(3) = -6, c(2) = 6, c(1) = -3, c(0) = 4, d(n) = b(n-1)+1, d(4) = 11, d(3) = 6, d(2) = 4, d(1) = 1, d(0) = 2, e(n) = -c(n-1)-e(n-1)+d(n-1)+e(n-1), e(4) = 12, e(3) = -2, e(2) = 4, e(1) = -2, e(0) = 1

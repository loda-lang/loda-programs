...
; Formula: a(n) = truncate((-truncate((A000010(n)+A000203(n)+1)/((A000010(n)+A000203(n)+1)^gcd(A000010(n)+A000203(n),2)))*(A000010(n)+A000203(n)+1)^gcd(A000010(n)+A000203(n),2)+A000010(n)+A000203(n)+2)/2)-1

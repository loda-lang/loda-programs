...
; Formula: a(n) = truncate(b(n+1)/5), b(n) = 5*d(n-1)+2*c(n-1)+b(n-1), b(3) = 205, b(2) = 35, b(1) = 5, b(0) = 0, c(n) = 5*d(n-1)+c(n-1), c(3) = 145, c(2) = 25, c(1) = 5, c(0) = 0, d(n) = 2*d(n-1)+truncate((6*d(n-1)-2*d(n-2)+b(n-1)+c(n-1))/2), d(4) = 881, d(3) = 146, d(2) = 24, d(1) = 4, d(0) = 1

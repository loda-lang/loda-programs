...
; Formula: a(n) = b(n+1)/5, b(n) = 4*d(n-1)+2*c(n-1)+b(n-1)+d(n-1), b(3) = 205, b(2) = 35, b(1) = 5, b(0) = 0, c(n) = 4*d(n-1)+c(n-1)+d(n-1), c(3) = 145, c(2) = 25, c(1) = 5, c(0) = 0, d(n) = (4*d(n-1)+2*c(n-1)-c(n-1)+b(n-1)+d(n-1)+e(n-1))/2+2*d(n-1), d(3) = 146, d(2) = 24, d(1) = 4, d(0) = 1, e(n) = (4*d(n-1)+2*c(n-1)-c(n-1)+b(n-1)+d(n-1)+e(n-1))/2, e(3) = 98, e(2) = 16, e(1) = 2, e(0) = 0

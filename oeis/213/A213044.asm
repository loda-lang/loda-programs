...
; Formula: a(n) = b(n+4), b(n) = b(n-3)+truncate((-b(n-2)+c(n-1))/2), b(4) = 1, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = -b(n-2)-b(n-3)+b(n-1)+c(n-1)+c(n-2), c(5) = 6, c(4) = 3, c(3) = 2, c(2) = 1, c(1) = 1, c(0) = 0

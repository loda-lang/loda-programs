...
; Formula: a(n) = c(n+4), b(n) = -c(n-2)+b(n-1)+b(n-2)+c(n-2), b(4) = 5, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = (-c(n-2)+b(n-2)+c(n-2))/2+d(n-2), c(4) = 1, c(3) = 0, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = c(n-1), d(4) = 0, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0

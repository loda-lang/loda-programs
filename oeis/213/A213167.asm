...
; Formula: a(n) = truncate((b(n)+c(n))/3), b(n) = b(n-1), b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = n*c(n-1)+d(n-1), c(3) = 342, c(2) = 66, c(1) = 15, c(0) = 3, d(n) = d(n-1)*(n+2), d(3) = 720, d(2) = 144, d(1) = 36, d(0) = 12

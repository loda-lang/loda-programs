...
; Formula: a(n) = truncate(b(n)/2)+1, b(n) = n*(c(n-1)+1)+2*b(n-1)+2*c(n-1)+4, b(2) = 42, b(1) = 8, b(0) = 0, c(n) = -(n-1)*(c(n-2)+1)+n*(c(n-1)+1)+3*c(n-1)+2, c(4) = 1007, c(3) = 155, c(2) = 27, c(1) = 5, c(0) = 1

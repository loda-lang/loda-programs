...
; Formula: a(n) = b(n+2)+c(n+2), b(n) = 2*b(n-1), b(4) = 16, b(3) = 8, b(2) = 4, b(1) = 2, b(0) = 1, c(n) = 2*d(n-2)+c(n-2)+2, c(4) = 9, c(3) = 5, c(2) = 3, c(1) = 1, c(0) = 1, d(n) = c(n-1)+d(n-1), d(4) = 10, d(3) = 5, d(2) = 2, d(1) = 1, d(0) = 0

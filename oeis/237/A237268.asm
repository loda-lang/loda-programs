...
; Formula: a(n) = e(n)+1, b(n) = b(n-1)+d(n-1)+2, b(4) = 53, b(3) = 19, b(2) = 6, b(1) = 1, b(0) = -1, c(n) = min(c(n-1)+1,1), c(4) = 1, c(3) = 1, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = b(n-1)+c(n-1)+d(n-1)+f(n-1)+4, d(4) = 87, d(3) = 32, d(2) = 11, d(1) = 3, d(0) = 0, e(n) = b(n-1)+c(n-1)+d(n-1)+2, e(4) = 54, e(3) = 20, e(2) = 7, e(1) = 1, e(0) = 0, f(n) = b(n-1)+c(n-1)+d(n-1)+f(n-1)+3, f(4) = 86, f(3) = 31, f(2) = 10, f(1) = 2, f(0) = 0

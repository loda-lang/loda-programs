...
; Formula: a(n) = c(2*n), b(n) = b(n-1)+d(n-1)+1, b(3) = 15, b(2) = 5, b(1) = 1, b(0) = 0, c(n) = d(n-1)+1, c(3) = 10, c(2) = 4, c(1) = 1, c(0) = 1, d(n) = 4*d(n-2)+3*d(n-3)+2*b(n-3)+d(n-1)+8, d(3) = 29, d(2) = 9, d(1) = 3, d(0) = 0

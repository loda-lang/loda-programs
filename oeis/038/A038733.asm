...
; Formula: a(n) = d(n-3), b(n) = truncate((b(n-1)*(n+6))/n), b(4) = 210, b(3) = 84, b(2) = 28, b(1) = 7, b(0) = 1, c(n) = 2*c(n-1)+d(n-1)+truncate((b(n-1)*(n+6))/n), c(4) = 643, c(3) = 188, c(2) = 47, c(1) = 9, c(0) = 1, d(n) = c(n-1)+d(n-1), d(4) = 245, d(3) = 57, d(2) = 10, d(1) = 1, d(0) = 0

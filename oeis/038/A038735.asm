...
; Formula: a(n) = b(n)+d(n), b(n) = truncate((b(n-1)*(n+12))/n), b(4) = 1820, b(3) = 455, b(2) = 91, b(1) = 13, b(0) = 1, c(n) = 2*c(n-1)+d(n-1)+truncate((b(n-1)*(n+12))/n), c(4) = 3388, c(3) = 715, c(2) = 122, c(1) = 15, c(0) = 1, d(n) = c(n-1)+d(n-1), d(4) = 853, d(3) = 138, d(2) = 16, d(1) = 1, d(0) = 0

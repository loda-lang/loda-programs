...
; Formula: a(n) = b(n-1), b(n) = 3*d(n-1)-d(n-2)+b(n-1)+c(n-1)+1, b(5) = 211, b(4) = 73, b(3) = 23, b(2) = 6, b(1) = 1, b(0) = 0, c(n) = 3*d(n-1)-d(n-2)+c(n-1)+1, c(5) = 138, c(4) = 50, c(3) = 17, c(2) = 5, c(1) = 1, c(0) = 0, d(n) = 3*d(n-1)-d(n-2)+1, d(5) = 88, d(4) = 33, d(3) = 12, d(2) = 4, d(1) = 1, d(0) = 0

...
; Formula: a(n) = d(n+1), b(n) = truncate((b(n-1)*(n+8))/n), b(4) = 495, b(3) = 165, b(2) = 45, b(1) = 9, b(0) = 1, c(n) = 2*c(n-1)+d(n-1)+truncate((b(n-1)*(n+8))/n), c(4) = 1201, c(3) = 313, c(2) = 68, c(1) = 11, c(0) = 1, d(n) = c(n-1)+d(n-1), d(4) = 393, d(3) = 80, d(2) = 12, d(1) = 1, d(0) = 0

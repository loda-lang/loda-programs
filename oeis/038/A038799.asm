...
; Formula: a(n) = 2*a(n-1)+c(n-1)+truncate((b(n-1)*(n+5))/n), a(4) = 455, a(3) = 141, a(2) = 38, a(1) = 8, a(0) = 1, b(n) = truncate((b(n-1)*(n+5))/n), b(4) = 126, b(3) = 56, b(2) = 21, b(1) = 6, b(0) = 1, c(n) = a(n-1)+c(n-1), c(4) = 188, c(3) = 47, c(2) = 9, c(1) = 1, c(0) = 0

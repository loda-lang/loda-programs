...
; Formula: a(n) = 2*a(n-1)+c(n-1)+truncate((b(n-1)*(n+8))/n), a(4) = 1201, a(3) = 313, a(2) = 68, a(1) = 11, a(0) = 1, b(n) = truncate((b(n-1)*(n+8))/n), b(4) = 495, b(3) = 165, b(2) = 45, b(1) = 9, b(0) = 1, c(n) = a(n-1)+c(n-1), c(4) = 393, c(3) = 80, c(2) = 12, c(1) = 1, c(0) = 0

...
; Formula: a(n) = c(n-3), b(n) = truncate((b(n-1)*(n+5))/n), b(4) = 126, b(3) = 56, b(2) = 21, b(1) = 6, b(0) = 1, c(n) = 2*c(n-1)+d(n-1)+truncate((b(n-1)*(n+5))/n), c(4) = 455, c(3) = 141, c(2) = 38, c(1) = 8, c(0) = 1, d(n) = c(n-1)+d(n-1), d(4) = 188, d(3) = 47, d(2) = 9, d(1) = 1, d(0) = 0

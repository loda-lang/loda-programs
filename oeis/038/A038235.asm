...
; Formula: a(n) = b(n+2), b(n) = b(n-1)+d(n-1), b(2) = 1, b(1) = 0, b(0) = 0, c(n) = 4*d(n-1)+2*b(n-1)+b(n-1)+c(n-1)+d(n-1)+1, c(2) = 7, c(1) = 1, c(0) = 0, d(n) = 4*d(n-1)+2*(2*b(n-1))+2*d(n-1)+c(n-1)+d(n-1)+1, d(2) = 9, d(1) = 1, d(0) = 0

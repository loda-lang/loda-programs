...
; Formula: a(n) = a(n-1)+c(n-1), a(2) = 85, a(1) = 10, a(0) = 1, b(n) = 4*c(n-1)+2*a(n-1)+a(n-1)+b(n-1)+c(n-1)+1, b(2) = 462, b(1) = 56, b(0) = 7, c(n) = 4*c(n-1)+2*(2*a(n-1))+2*c(n-1)+b(n-1)+c(n-1)+1, c(2) = 622, c(1) = 75, c(0) = 9

...
; Formula: a(n) = 2*a(n-1)+c(n-1)+truncate((b(n-1)*(n+6))/n), a(4) = 643, a(3) = 188, a(2) = 47, a(1) = 9, a(0) = 1, b(n) = truncate((b(n-1)*(n+6))/n), b(4) = 210, b(3) = 84, b(2) = 28, b(1) = 7, b(0) = 1, c(n) = a(n-1)+c(n-1), c(4) = 245, c(3) = 57, c(2) = 10, c(1) = 1, c(0) = 0

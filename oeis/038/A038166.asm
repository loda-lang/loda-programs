...
; Formula: a(n) = truncate(b(n)/3), b(n) = truncate((6*d(n-1))/n), b(3) = 276, b(2) = 81, b(1) = 18, b(0) = 3, c(n) = -2*c(n-1)-3*d(n-1)+truncate((6*d(n-1))/n), c(3) = -126, c(2) = -6, c(1) = 3, c(0) = 3, d(n) = 2*d(n-1)+c(n-1)+truncate((6*d(n-1))/n), d(3) = 546, d(2) = 138, d(1) = 27, d(0) = 3

...
; Formula: a(n) = binomial(floor((sqrtint(8*n+2)-1)/2),-binomial(-floor((sqrtint(8*n+2)-1)/2),2)+n)*if((-n+binomial(-floor((sqrtint(8*n+2)-1)/2),2)+floor((sqrtint(8*n+2)-1)/2))<=(-1),0,11^(-n+binomial(-floor((sqrtint(8*n+2)-1)/2),2)+floor((sqrtint(8*n+2)-1)/2)))

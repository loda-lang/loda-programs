...
; Formula: a(n) = floor((floor((sqrtint(8*n-8)+3)/2)+sqrtint(5*(floor((sqrtint(8*n-8)+3)/2)+8)^2)+8)/2)+truncate((-binomial(floor((sqrtint(8*n-8)+1)/2),2)+sqrtint(5*(-binomial(floor((sqrtint(8*n-8)+1)/2),2)+n-1)^2)+n-1)/2)-13

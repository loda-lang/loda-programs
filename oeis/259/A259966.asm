...
; Formula: a(n) = d(n)/2, b(n) = e(n-1), b(5) = 42, b(4) = 20, b(3) = 8, b(2) = 2, b(1) = 0, b(0) = 0, c(n) = -d(n-1)+b(n-1)+c(n-1)+e(n-1), c(5) = 54, c(4) = 24, c(3) = 10, c(2) = 4, c(1) = 2, c(0) = 2, d(n) = 7*e(n-2)+2*c(n-2)-d(n-1)-5*d(n-2)+f(n-1), d(5) = 68, d(4) = 32, d(3) = 14, d(2) = 4, d(1) = 0, d(0) = 0, e(n) = 3*e(n-1)-2*d(n-1)+c(n-1), e(5) = 86, e(4) = 42, e(3) = 20, e(2) = 8, e(1) = 2, e(0) = 0, f(n) = b(n-1)+f(n-1), f(5) = 30, f(4) = 10, f(3) = 2, f(2) = 0, f(1) = 0, f(0) = 0

...
; Formula: a(n) = d(n)+1, b(n) = b(n-1)+c(n-1)+1, b(3) = 1, b(2) = -1, b(1) = 0, b(0) = -2, c(n) = b(n-1)+d(n-1), c(3) = 2, c(2) = 1, c(1) = -2, c(0) = 1, d(n) = 2*d(n-2)+b(n-2)+c(n-2)+d(n-1)+3, d(3) = 6, d(2) = 3, d(1) = 1, d(0) = 0

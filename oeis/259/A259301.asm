...
; 0,0,1,1,3,3,3,2,4,4,3,4,5,7,8,5,8,7,8,9,10,10,11,12,12,14,13,13,12,15,14,14,17,14,19,17,12,18,13,19,20,22,20,23,21,15,21,21,23,25,26,23,26,26,19,23,27,24,29,27,26,28,31,29,30,25,30,29,34,30,29,35,36,36,31,35,32,42,37,42
; Formula: a(n) = A221490(A000040(n+1)-2)

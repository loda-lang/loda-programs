...
; Formula: a(n) = e(n+1), b(n) = 5*b(n-1), b(3) = 250, b(2) = 50, b(1) = 10, b(0) = 2, c(n) = ((2*c(n-1))^2+c(n-1)+4)%(5*b(n-1)), c(4) = 443, c(3) = 193, c(2) = 43, c(1) = 3, c(0) = 0, d(n) = ((2*d(n-1)-2)^2+d(n-1)+3)%(5*b(n-1))+1, d(4) = 444, d(3) = 194, d(2) = 44, d(1) = 4, d(0) = 0, e(n) = min(5*b(n-1)-(((2*c(n-1))^2+d(n-1)+3)%(5*b(n-1))),((2*c(n-1))^2+d(n-1)+3)%(5*b(n-1))), e(3) = 57, e(2) = 7, e(1) = 3, e(0) = 0

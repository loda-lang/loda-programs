...
; Formula: a(n) = -b(n)+c(n)-2, b(n) = b(n-1)+d(n-1)+e(n-1)-1, b(3) = -28, b(2) = -9, b(1) = -5, b(0) = 0, c(n) = 2*d(n-2)-d(n-3)+d(n-1)-2, c(6) = -183, c(5) = -67, c(4) = -26, c(3) = -7, c(2) = -3, c(1) = 2, c(0) = 3, d(n) = 2*d(n-1)+2*d(n-2)-d(n-3)-4, d(6) = -296, d(5) = -111, d(4) = -42, d(3) = -14, d(2) = -5, d(1) = 0, d(0) = 0, e(n) = 2*b(n-1)+d(n-1)-3, e(3) = -26, e(2) = -13, e(1) = -3, e(0) = -4

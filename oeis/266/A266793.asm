...
; Formula: a(n) = A267260(n)-n/2

mov $1,$0
div $1,2
seq $0,267260 ; Total number of ON (black) cells after n iterations of the "Rule 111" elementary cellular automaton starting with a single ON (black) cell.
sub $0,$1

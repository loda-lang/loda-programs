...
; Formula: a(n) = (c(n-1)-1)%((b(n-1)+51)/c(n-1))+1, a(2) = 2, a(1) = 1, a(0) = 1, b(n) = (b(n-1)+51)/c(n-1), b(2) = 51, b(1) = 51, b(0) = 0, c(n) = (c(n-1)-1)%((b(n-1)+51)/c(n-1))+(c(n-2)-1)%((b(n-2)+51)/c(n-2))+2, c(2) = 3, c(1) = 2, c(0) = 1

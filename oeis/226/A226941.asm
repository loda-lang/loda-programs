...
; Formula: a(n) = e(n+2), b(n) = 6*b(n-1)+c(n-1)+1, b(3) = 73, b(2) = 10, b(1) = 1, b(0) = 0, c(n) = 3*c(n-1)+3, c(3) = 39, c(2) = 12, c(1) = 3, c(0) = 0, d(n) = 10*d(n-1)+b(n-1), d(3) = 20, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = 15*e(n-1)+10*d(n-1)+b(n-1), e(3) = 35, e(2) = 1, e(1) = 0, e(0) = 0

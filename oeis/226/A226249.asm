...
; Formula: a(n) = d(n)+2, b(n) = ((-c(n-1)+b(n-1))/2)/gcd((-c(n-1)+b(n-1))/2+2*c(n-1),4), b(3) = -2, b(2) = -1, b(1) = -1, b(0) = -1, c(n) = 2*c(n-1), c(3) = 32, c(2) = 16, c(1) = 8, c(0) = 4, d(n) = (gcd((-c(n-2)+b(n-2))/2+2*c(n-2),4)-3)/2+d(n-1)+2, d(3) = 5, d(2) = 3, d(1) = 1, d(0) = 0

...
; Formula: a(n) = d(n)/4+1, b(n) = -c(n-1)+b(n-1)+d(n-1)+3, b(3) = 35, b(2) = 11, b(1) = 1, b(0) = 0, c(n) = 2*c(n-1), c(3) = 24, c(2) = 12, c(1) = 6, c(0) = 3, d(n) = 3*c(n-2)+3*d(n-2)-b(n-2)+d(n-1)+8, d(3) = 97, d(2) = 33, d(1) = 13, d(0) = 1

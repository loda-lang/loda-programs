...
; Formula: a(n) = b(max(n-1,0))+min(n-1,0), b(n) = -max(c(n-2)-2,0)+b(n-1)+b(n-2)+max(c(n-1)-2,0), b(4) = 7, b(3) = 3, b(2) = 2, b(1) = 0, b(0) = 2, c(n) = c(n-1)+c(n-2), c(4) = 8, c(3) = 5, c(2) = 3, c(1) = 2, c(0) = 1

...
; Formula: a(n) = c(max(n-1,0))+min(n-1,0), b(n) = b(n-1)+b(n-2), b(3) = 8, b(2) = 5, b(1) = 3, b(0) = 2, c(n) = e(n-1)+max(d(n-1)-2,0), c(3) = 3, c(2) = 2, c(1) = 0, c(0) = 2, d(n) = b(n-1), d(3) = 5, d(2) = 3, d(1) = 2, d(0) = 1, e(n) = e(n-1)+e(n-2)+max(d(n-2)-2,0), e(3) = 4, e(2) = 2, e(1) = 2, e(0) = 0

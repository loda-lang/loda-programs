...
; Formula: a(n) = 2*c(n), b(n) = 6*b(n-2)+3*b(n-1)-b(n-4)-3*b(n-3)+1, b(7) = 6059, b(6) = 1439, b(5) = 334, b(4) = 82, b(3) = 17, b(2) = 5, b(1) = 0, b(0) = 0, c(n) = d(n-1), c(3) = 12, c(2) = 5, c(1) = 0, c(0) = 1, d(n) = 4*c(n-1)+2*b(n-1)+2*d(n-1)+e(n-1)+1, d(3) = 65, d(2) = 12, d(1) = 5, d(0) = 0, e(n) = 2*b(n-1)+2*d(n-1)+c(n-1), e(3) = 39, e(2) = 10, e(1) = 1, e(0) = 0

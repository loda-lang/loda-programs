...
; Formula: a(n) = 2*c(n), b(n) = b(n-1)+d(n-1), b(3) = 17, b(2) = 5, b(1) = 0, b(0) = 0, c(n) = d(n-1), c(3) = 12, c(2) = 5, c(1) = 0, c(0) = 1, d(n) = 6*d(n-2)+2*b(n-1)+2*b(n-2)+2*d(n-1)+d(n-3)+1, d(3) = 65, d(2) = 12, d(1) = 5, d(0) = 0

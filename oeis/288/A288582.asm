...
; Formula: a(n) = d(n-1), a(3) = 10, a(2) = 1, a(1) = 0, a(0) = 1, b(n) = b(n-2)*b(n-1), b(3) = 100, b(2) = 10, b(1) = 10, b(0) = 1, c(n) = b(n-1), c(3) = 10, c(2) = 10, c(1) = 1, c(0) = 10, d(n) = d(n-1)*c(n-1)*b(n-1)+d(n-2), d(3) = 1001, d(2) = 10, d(1) = 1, d(0) = 0

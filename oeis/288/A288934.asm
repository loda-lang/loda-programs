...
; Formula: a(n) = (2*e(n))/8+1, b(n) = (-c(n-1)+b(n-1))/4, b(3) = -240, b(2) = -195, b(1) = -12, b(0) = 0, c(n) = c(n-1)*gcd((-c(n-1)+b(n-1))/4+binomial(d(n-1),c(n-1)),4)^2, c(3) = 12288, c(2) = 768, c(1) = 768, c(0) = 48, d(n) = 2*(gcd((-c(n-1)+b(n-1))/4+binomial(d(n-1),c(n-1)),4)/2)+2, d(3) = 6, d(2) = 2, d(1) = 6, d(0) = 6, e(n) = d(n-1)+e(n-1)+2, e(3) = 22, e(2) = 18, e(1) = 10, e(0) = 2

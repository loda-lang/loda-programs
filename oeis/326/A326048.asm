...
; 1,1,2,1,1,5,6,1,1,2,10,1,1,1,3,1,1,1,18,2,1,1,22,1,1,2,1,27,1,12,30,1,1,2,1,1,1,1,1,2,1,4,42,1,3,5,46,1,1,1,3,2,1,4,1,1,1,2,58,6,1,1,2,1,1,4,66,10,1,4,70,1,1,2,2,3,1,4,78,2
; Formula: a(n) = gcd(A326049(n),-2*n+A000203(n+1)-2)

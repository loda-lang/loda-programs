...
; Formula: a(n) = floor(A056239(A181819(A181811(truncate((A057335(A048678(n))-1)/A293810(A057335(A048678(n))))+1)*(truncate((A057335(A048678(n))-1)/A293810(A057335(A048678(n))))+1)))/gcd(A252736(A181819(A181811(truncate((A057335(A048678(n))-1)/A293810(A057335(A048678(n))))+1)*(truncate((A057335(A048678(n))-1)/A293810(A057335(A048678(n))))+1)))+1,A056239(A181819(A181811(truncate((A057335(A048678(n))-1)/A293810(A057335(A048678(n))))+1)*(truncate((A057335(A048678(n))-1)/A293810(A057335(A048678(n))))+1)))))

...
; 1,1,2,1,3,1,3,1,4,1,2,1,5,5,4,1,5,1,5,3,6,1,5,2,7,3,3,1,1,1,5,7,8,7,3,1,9,2,2,1,7,1,7,7,10,1,3,1,7,9,4,1,7,8,7,5,11,1,7,1,12,1,6,1,4,1,9,11,2,1,7,1,13,4,5,9,3,1,7,1
; Formula: a(n) = truncate(A056239(n+1)/gcd(A003963(n+1),A056239(n+1)))

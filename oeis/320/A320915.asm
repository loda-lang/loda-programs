...
; Formula: a(n) = (48*b(n-1)*((d(n-1)^3)/b(n-1))+c(n-1))%(13*b(n-1))+1, a(3) = 177, a(2) = 8, a(1) = 8, a(0) = 0, b(n) = 13*b(n-1), b(3) = 2197, b(2) = 169, b(1) = 13, b(0) = 1, c(n) = (48*b(n-1)*((d(n-1)^3)/b(n-1))+c(n-1))%(13*b(n-1)), c(3) = 176, c(2) = 7, c(1) = 7, c(0) = 3, d(n) = (48*b(n-1)*((d(n-1)^3)/b(n-1))+c(n-1))%(13*b(n-1))+1, d(3) = 177, d(2) = 8, d(1) = 8, d(0) = 12

...
; Formula: a(n) = 48*truncate((c(n-1)^3)/b(n-1))*b(n-1)-13*truncate((48*truncate((c(n-1)^3)/b(n-1))*b(n-1)+c(n-1)-1)/(13*b(n-1)))*b(n-1)+c(n-1), a(4) = 11162, a(3) = 177, a(2) = 8, a(1) = 8, a(0) = 0, b(n) = 13*b(n-1), b(3) = 2197, b(2) = 169, b(1) = 13, b(0) = 1, c(n) = 48*truncate((c(n-1)^3)/b(n-1))*b(n-1)-13*truncate((48*truncate((c(n-1)^3)/b(n-1))*b(n-1)+c(n-1)-1)/(13*b(n-1)))*b(n-1)+c(n-1), c(4) = 11162, c(3) = 177, c(2) = 8, c(1) = 8, c(0) = 12

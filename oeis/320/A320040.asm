...
; Formula: a(n) = -(-floor((n-1)/2)+binomial(floor((sqrtint(8*floor((n-1)/2)+8)-1)/2)+1,2)+floor((sqrtint(8*floor((n-1)/2)+8)-1)/2))*((floor((sqrtint(8*floor((n-1)/2)+8)-1)/2)+n-1)%2)+(-binomial(floor((sqrtint(8*floor((n-1)/2)+8)-1)/2)+1,2)+floor((n-1)/2))*((floor((sqrtint(8*floor((n-1)/2)+8)-1)/2)+n-1)%2)-floor((n-1)/2)+binomial(floor((sqrtint(8*floor((n-1)/2)+8)-1)/2)+1,2)+floor((sqrtint(8*floor((n-1)/2)+8)-1)/2)+1

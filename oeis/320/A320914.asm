...
; Formula: a(n) = 16*truncate((c(n-1)^3)/b(n-1))*b(n-1)-13*truncate((16*truncate((c(n-1)^3)/b(n-1))*b(n-1)+c(n-1)-1)/(13*b(n-1)))*b(n-1)+c(n-1), a(4) = 20794, a(3) = 1021, a(2) = 7, a(1) = 7, a(0) = 0, b(n) = 13*b(n-1), b(3) = 2197, b(2) = 169, b(1) = 13, b(0) = 1, c(n) = 16*truncate((c(n-1)^3)/b(n-1))*b(n-1)-13*truncate((16*truncate((c(n-1)^3)/b(n-1))*b(n-1)+c(n-1)-1)/(13*b(n-1)))*b(n-1)+c(n-1), c(4) = 20794, c(3) = 1021, c(2) = 7, c(1) = 7, c(0) = 1

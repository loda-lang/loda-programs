...
; Formula: a(n) = (16*b(n-1)*((d(n-1)^3)/b(n-1))+c(n-1))%(13*b(n-1))+1, a(3) = 1021, a(2) = 7, a(1) = 7, a(0) = 0, b(n) = 13*b(n-1), b(3) = 2197, b(2) = 169, b(1) = 13, b(0) = 1, c(n) = (16*b(n-1)*((d(n-1)^3)/b(n-1))+c(n-1))%(13*b(n-1)), c(3) = 1020, c(2) = 6, c(1) = 6, c(0) = 3, d(n) = (16*b(n-1)*((d(n-1)^3)/b(n-1))+c(n-1))%(13*b(n-1))+1, d(3) = 1021, d(2) = 7, d(1) = 7, d(0) = 1

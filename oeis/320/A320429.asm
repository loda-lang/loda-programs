...
; Formula: a(n) = truncate((min(n-1,(n-1)%3)*(min(n-1,(n-1)%3)*d(n-1)+c(n-1))+b(n-1))/2), b(n) = -18*c(n-3)+b(n-3), b(8) = 308, b(7) = 308, b(6) = 308, b(5) = 20, b(4) = 20, b(3) = 20, b(2) = 2, b(1) = 2, b(0) = 2, c(n) = 16*c(n-3), c(8) = -256, c(7) = -256, c(6) = -256, c(5) = -16, c(4) = -16, c(3) = -16, c(2) = -1, c(1) = -1, c(0) = -1, d(n) = -48*c(n-3), d(8) = 768, d(7) = 768, d(6) = 768, d(5) = 48, d(4) = 48, d(3) = 48, d(2) = 3, d(1) = 3, d(0) = 3

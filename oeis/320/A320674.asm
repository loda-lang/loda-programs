...
; Formula: a(n) = 2*truncate((b(n+1)-3)/3)+2, b(n) = max(d(n-1)+3,2*c(n-1)), b(3) = 9, b(2) = 6, b(1) = 3, b(0) = 0, c(n) = max(d(n-3)+3,2*c(n-3)), c(3) = 3, c(2) = 0, c(1) = 1, c(0) = 0, d(n) = max(d(n-1)+3,2*c(n-1)), d(3) = 9, d(2) = 6, d(1) = 3, d(0) = 0

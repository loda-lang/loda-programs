...
; Formula: a(n) = truncate(((2*d(n)+2*min(n,n%2))*(min(n,n%2)*b(n)+c(n))-min(n,n%2))/2)+1, b(n) = 3*b(n-2)-b(n-4), b(8) = 5, b(7) = 2, b(6) = 2, b(5) = 1, b(4) = 1, b(3) = 1, b(2) = 1, b(1) = 2, b(0) = 2, c(n) = 2*c(n-2)+b(n-2), c(5) = 1, c(4) = 1, c(3) = 0, c(2) = 0, c(1) = -1, c(0) = -1, d(n) = d(n-2)+2, d(5) = 4, d(4) = 4, d(3) = 2, d(2) = 2, d(1) = 0, d(0) = 0

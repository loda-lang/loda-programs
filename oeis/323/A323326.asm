...
; 2,3,2,2,1,1,0,2,4,4,3,5,4,4,4,4,3,5,4,4,4,4,3,5,5,5,5,5,4,4,3,3,3,3,3,5,4,4,4,6,5,5,4,4,4,4,3,3,3,3,3,3,2,2,2,4,4,4,3,5,4,4,4,4,4,4,3,3,3,3,2,4,3,3,3,3,3,3,2,4
; Formula: a(n) = 2*A208251(n)-A000720(n+1)

...
; Formula: a(n) = d(max(n-1,0))/4+1, b(n) = -c(n-1)+b(n-1)+d(n-1)+2, b(3) = 33, b(2) = 13, b(1) = 3, b(0) = 0, c(n) = 2*c(n-1)+1, c(3) = 7, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = 3*c(n-2)+3*d(n-2)-b(n-2)+d(n-1)+9, d(3) = 57, d(2) = 21, d(1) = 9, d(0) = 1

...
; 1,2,3,4,5,4,6,4,7,7,8,4,9,4,10,10,11,4,12,4,13,13,14,4,15,15,16,16,17,4,18,4,19,19,20,20,21,4,22,22,23,4,24,4,25,25,26,4,27,27,28,28,29,4,30,30,31,31,32,4,33,4,34,34,35,35,36,4,37,37,38,4,39,4,40,40,41,41,42,4
; Formula: a(n) = min(n-1,1)+A322809(max(n-2,0)+1)

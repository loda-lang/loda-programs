...
; Formula: a(n) = A008480(n+1)*(-2*truncate((truncate(A001222(n+1)/(-2*truncate(A001222(n+1)/2)+A001222(n+1)+2))+1)/2)+truncate(A001222(n+1)/(-2*truncate(A001222(n+1)/2)+A001222(n+1)+2))+1)

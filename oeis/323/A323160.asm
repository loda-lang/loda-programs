...
; 1,1,1,1,1,6,1,1,1,2,1,4,1,2,3,1,1,6,1,2,1,2,1,12,1,2,1,4,1,6,1,1,3,2,1,2,1,2,1,2,1,6,1,4,3,2,1,4,1,2,3,2,1,6,1,8,1,2,1,12,1,2,1,1,1,6,1,2,3,2,1,6,1,2,1,4,1,6,1,2
; Formula: a(n) = gcd(A034448(n+1),gcd(A323363(n),n+1))

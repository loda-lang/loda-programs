...
; Formula: a(n) = d(n)+1, b(n) = -e(n-1)+b(n-1)+d(n-1), b(3) = 4, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = 2*d(n-1)-e(n-1)+c(n-1)+1, c(3) = 14, c(2) = 4, c(1) = 1, c(0) = 0, d(n) = 3*d(n-1)+2*c(n-1)-2*e(n-1)+b(n-1)+1, d(3) = 22, d(2) = 6, d(1) = 1, d(0) = 0, e(n) = 2*d(n-1)-2*e(n-1)+b(n-1)+c(n-1), e(3) = 11, e(2) = 3, e(1) = 0, e(0) = 0

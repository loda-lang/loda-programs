...
; Formula: a(n) = b(n-1), b(n) = c(n-6), b(8) = 366667, b(7) = 36667, b(6) = 3667, b(5) = 367, b(4) = 117, b(3) = 37, b(2) = 13, b(1) = 4, b(0) = 1, c(n) = 11*c(n-1)-10*c(n-2), c(6) = 3666666667, c(5) = 366666667, c(4) = 36666667, c(3) = 3666667, c(2) = 366667, c(1) = 36667, c(0) = 3667

...
; Formula: a(n) = ((max(e(n-1),1)+1)*(b(n-1)+d(n-1)))/(2*b(n-1)+d(n-1)), a(4) = 4, a(3) = 2, a(2) = 1, a(1) = 1, a(0) = 0, b(n) = b(n-1)+d(n-1), b(4) = 17, b(3) = 7, b(2) = 3, b(1) = 1, b(0) = 1, c(n) = c(n-1)+max(c(n-2),1)+1, c(4) = 15, c(3) = 9, c(2) = 5, c(1) = 3, c(0) = 1, d(n) = 2*b(n-1)+d(n-1), d(4) = 24, d(3) = 10, d(2) = 4, d(1) = 2, d(0) = 0, e(n) = c(n-1), e(4) = 9, e(3) = 5, e(2) = 3, e(1) = 1, e(0) = 0

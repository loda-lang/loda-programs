...
; Formula: a(n) = c(n-1)+1, b(n) = d(n-1), b(3) = 6, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = 4*c(n-1)+3*d(n-4)+2*c(n-4)-d(n-5)-3*c(n-2)+1, c(5) = 131, c(4) = 41, c(3) = 13, c(2) = 4, c(1) = 1, c(0) = 0, d(n) = 3*d(n-1)+2*c(n-1)-b(n-1)+1, d(3) = 26, d(2) = 6, d(1) = 1, d(0) = 0

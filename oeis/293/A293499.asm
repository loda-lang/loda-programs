...
; Formula: a(n) = d(n)+1, b(n) = b(n-1)+c(n-1), b(3) = 2, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = e(n-1), c(3) = 6, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = 3*d(n-1)+b(n-1), d(3) = 13, d(2) = 4, d(1) = 1, d(0) = 0, e(n) = 3*e(n-1)+2*d(n-1)-c(n-1)+1, e(3) = 26, e(2) = 6, e(1) = 1, e(0) = 0

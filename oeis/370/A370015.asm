...
; Formula: a(n) = truncate((binomial(floor((sqrtint(8*n+8)-1)/2),-binomial(floor((sqrtint(8*n+8)-1)/2),2)+n)*(2*if((-binomial(floor((sqrtint(8*n+8)-1)/2),2)+n)<=(-1),0,4^(-binomial(floor((sqrtint(8*n+8)-1)/2),2)+n))+binomial(floor((sqrtint(8*n+8)-1)/2),-binomial(floor((sqrtint(8*n+8)-1)/2),2)+n))*2^binomial(floor((sqrtint(8*n+8)-1)/2),2))/3)

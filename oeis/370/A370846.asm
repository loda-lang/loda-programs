...
; Formula: a(n) = 4*e(n-1)-4*c(n-1)-4, b(n) = 5*b(n-1)-6*d(n-1)+c(n-1)-3, b(3) = 45, b(2) = -21, b(1) = -3, b(0) = 0, c(n) = -2*d(n-1)+b(n-1)+c(n-1)-3, c(3) = 21, c(2) = -9, c(1) = -3, c(0) = 0, d(n) = 9*b(n-1)-9*d(n-1), d(3) = 54, d(2) = -27, d(1) = 0, d(0) = 0, e(n) = 4*e(n-1), e(3) = 64, e(2) = 16, e(1) = 4, e(0) = 1

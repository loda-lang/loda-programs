...
; Formula: a(n) = A276085(A181819(A181811(truncate((A057335(2*A014311(n))-1)/A293810(A057335(2*A014311(n))-1))+1)*(truncate((A057335(2*A014311(n))-1)/A293810(A057335(2*A014311(n))-1))+1)))

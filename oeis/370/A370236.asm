...
; Formula: a(n) = truncate((binomial(floor((sqrtint(8*n-24)+1)/2),-binomial(floor((sqrtint(8*n-24)+1)/2),2)+n-3)*binomial(floor((sqrtint(8*n-24)+1)/2)+3,-binomial(floor((sqrtint(8*n-24)+1)/2),2)+n-2)*(floor((sqrtint(8*n-24)+1)/2)+1)*(2*n-2*binomial(floor((sqrtint(8*n-24)+1)/2),2)-6))/24)

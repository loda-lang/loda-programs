...
; Formula: a(n) = -2*truncate(d(n)/2)+d(n)+1, b(n) = truncate((-truncate(c(n-1)/b(n-1))*b(n-1)+2*b(n-1)+c(n-1))/2)+1, b(2) = 3, b(1) = 2, b(0) = 1, c(n) = -truncate(c(n-1)/b(n-1))*b(n-1)+b(n-1)+c(n-1), c(2) = 3, c(1) = 1, c(0) = 0, d(n) = b(n-1)+d(n-1), d(2) = 3, d(1) = 1, d(0) = 0

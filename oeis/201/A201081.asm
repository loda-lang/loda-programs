...
; Formula: a(n) = 2*f(n-1)+3, b(n) = b(n-1)+b(n-3)+e(n-3)+3, b(4) = 11, b(3) = 5, b(2) = 2, b(1) = 0, b(0) = 0, c(n) = 2*b(n-1)+d(n-1)+e(n-1)+3, c(4) = 32, c(3) = 16, c(2) = 8, c(1) = 3, c(0) = 2, d(n) = b(n-3)+d(n-3)+e(n-2)+3, d(5) = 21, d(4) = 11, d(3) = 6, d(2) = 3, d(1) = 2, d(0) = 0, e(n) = 2*b(n-1)+e(n-1)+3, e(4) = 26, e(3) = 13, e(2) = 6, e(1) = 3, e(0) = 0, f(n) = c(n-1)+d(n-1), f(4) = 22, f(3) = 11, f(2) = 5, f(1) = 2, f(0) = 0

...
; Formula: a(n) = truncate(c(n)/2)+1, b(n) = truncate((-16*n*b(n-1)*(2*n-1))/(2*n+d(n-1))), b(3) = -5120, b(2) = 256, b(1) = -16, b(0) = 2, c(n) = c(n-1)+truncate((-16*n*b(n-1)*(2*n-1))/(2*n+d(n-1))), c(3) = -4880, c(2) = 240, c(1) = -16, c(0) = 0, d(n) = 2*n+d(n-1), d(3) = 12, d(2) = 6, d(1) = 2, d(0) = 0

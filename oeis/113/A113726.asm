...
; Formula: a(n) = b(n+2)/2, b(n) = d(n-1), b(3) = 0, b(2) = 2, b(1) = 0, b(0) = 0, c(n) = 4*d(n-2)+2*b(n-2)-2*c(n-2)+c(n-2), c(3) = 8, c(2) = -2, c(1) = 0, c(0) = 2, d(n) = 2*b(n-1)+c(n-1), d(3) = 2, d(2) = 0, d(1) = 2, d(0) = 0

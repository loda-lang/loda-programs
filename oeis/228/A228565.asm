...
; Formula: a(n) = binomial(-1,-binomial(floor((sqrtint(8*gcd(0,n)+8)+1)/2),2)+gcd(0,n))*binomial(-binomial(floor((sqrtint(8*gcd(0,n)+8)+1)/2),2)-floor((sqrtint(8*gcd(0,n)+8)+1)/2)+gcd(0,n),truncate((-binomial(floor((sqrtint(8*gcd(0,n)+8)+1)/2),2)+gcd(0,n))/2))*if((-n+binomial(floor((sqrtint(8*n+8)+3)/2),2)-1)<=(-1),0,2^(-n+binomial(floor((sqrtint(8*n+8)+3)/2),2)-1))

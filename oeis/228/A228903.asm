...
; Formula: a(n) = d(n+2)/2, b(n) = 2*n+b(n-1)-1, b(4) = 15, b(3) = 8, b(2) = 3, b(1) = 0, b(0) = -1, c(n) = (2*n*binomial(2*n+b(n-1)-1,2*n-2))/(2*n-1), c(4) = 5720, c(3) = 84, c(2) = 4, c(1) = 2, c(0) = 0, d(n) = c(n-1)+d(n-1), d(4) = 90, d(3) = 6, d(2) = 2, d(1) = 0, d(0) = 0

...
; Formula: a(n) = d(n)+3, b(n) = b(n-1)+c(n-1)+1, b(4) = 13, b(3) = 7, b(2) = 5, b(1) = 2, b(0) = 1, c(n) = -c(n-1)+b(n-1)+1, c(4) = 3, c(3) = 5, c(2) = 1, c(1) = 2, c(0) = 0, d(n) = -n+b(n-2)+c(n-2)+n+1, d(4) = 7, d(3) = 5, d(2) = 2, d(1) = 1, d(0) = 0

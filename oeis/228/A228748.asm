...
; Formula: a(n) = a(n-1)+b(n-1)+1, a(3) = 1, a(2) = -1, a(1) = 0, a(0) = -2, b(n) = a(n-1)+c(n-1), b(3) = 3, b(2) = 1, b(1) = -2, b(0) = 1, c(n) = 2*c(n-1)-2*a(n-3)-2*b(n-3)+a(n-2)+b(n-1), c(4) = 28, c(3) = 11, c(2) = 4, c(1) = 1, c(0) = 0

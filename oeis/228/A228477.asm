...
; Formula: a(n) = d(n)+2, b(n) = b(n-1)+d(n-1)+2, b(5) = 188, b(4) = 61, b(3) = 20, b(2) = 6, b(1) = 2, b(0) = 0, c(n) = f1(n-1), c(5) = 102, c(4) = 33, c(3) = 10, c(2) = 3, c(1) = 0, c(0) = 0, d(n) = 2*e(n-1)-f(n-1)+b(n-1)+c(n-1)+2, d(5) = 384, d(4) = 125, d(3) = 39, d(2) = 12, d(1) = 2, d(0) = 0, e(n) = -f(n-1)+b(n-1)+c(n-1)+d(n-1)+e(n-1)+3, e(5) = 385, e(4) = 125, e(3) = 40, e(2) = 12, e(1) = 3, e(0) = 0, f(n) = -b(n-1)-d(n-1)-f(n-1)+c(n-1)-2, f(5) = -117, f(4) = -38, f(3) = -13, f(2) = -4, f(1) = -2, f(0) = 0, f1(n) = b(n-1)+d(n-1)+e(n-1)+3, f1(5) = 314, f1(4) = 102, f1(3) = 33, f1(2) = 10, f1(1) = 3, f1(0) = 0

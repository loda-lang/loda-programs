...
; Formula: a(n) = b(n+2)/8, b(n) = 8*b(n-1)+8*d(n-1), b(2) = 8, b(1) = 0, b(0) = 0, c(n) = -d(n-1)+b(n-1)+c(n-1)+d(n-1), c(2) = -1, c(1) = -1, c(0) = -1, d(n) = 8*b(n-1)+8*d(n-1)-c(n-1)+d(n-1), d(2) = 10, d(1) = 1, d(0) = 0

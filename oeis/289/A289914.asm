...
; Formula: a(n) = d(n)+1, b(n) = binomial(e(n-1),-d(n-1)-f(n-1)+b(n-1))+1, b(5) = 1, b(4) = 1, b(3) = 1, b(2) = 2, b(1) = 2, b(0) = 0, c(n) = 2*d(n-1)-b(n-1)-e(n-1)+c(n-1)+2, c(5) = 56, c(4) = 29, c(3) = 15, c(2) = 7, c(1) = 2, c(0) = 0, d(n) = c(n-2)+d(n-1)+2, d(5) = 34, d(4) = 17, d(3) = 8, d(2) = 4, d(1) = 2, d(0) = 0, e(n) = -b(n-1)-binomial(e(n-1),-d(n-1)-f(n-1)+b(n-1))+d(n-1)+f(n-1), e(5) = 17, e(4) = 8, e(3) = 3, e(2) = 0, e(1) = -1, e(0) = 0, f(n) = 1, f(5) = 1, f(4) = 1, f(3) = 1, f(2) = 1, f(1) = 1, f(0) = 0

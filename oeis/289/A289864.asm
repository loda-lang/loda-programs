...
; Formula: a(n) = c(n)+1, b(n) = if(((n-2)%2)==0,(n-2)/2,n-2)+2*2^(n-1)+b(n-1), b(3) = 14, b(2) = 5, b(1) = 1, b(0) = 0, c(n) = if(((n-2)%2)==0,(n-2)/2,n-2)+2*2^(n-1)+2*b(n-1)+c(n-1), c(3) = 26, c(2) = 7, c(1) = 1, c(0) = 0

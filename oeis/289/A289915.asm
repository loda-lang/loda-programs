...
; Formula: a(n) = -10*truncate(truncate(b(3*n)/(truncate(c(3*n)/(10^n))+1))/10)+truncate(b(3*n)/(truncate(c(3*n)/(10^n))+1)), b(n) = 4*e(n-1)+2*b(n-1)+2*c(n-1)+2*d(n-1), b(3) = 408, b(2) = 24, b(1) = 2, b(0) = 1, c(n) = 4*c(n-1)+4*e(n-1)+2*b(n-1)+2*d(n-1), c(3) = 464, c(2) = 28, c(1) = 2, c(0) = 0, d(n) = 12*e(n-1)+8*c(n-1)+6*d(n-1)+4*b(n-1), d(3) = 1232, d(2) = 72, d(1) = 4, d(0) = 0, e(n) = 8*e(n-1)+4*c(n-1)+3*d(n-1)+2*b(n-1), e(3) = 696, e(2) = 40, e(1) = 2, e(0) = 0

...
; Formula: a(n) = b(n+1), b(n) = c(n-3)+1, b(6) = 3, b(5) = 2, b(4) = 2, b(3) = 1, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = c(n-1)+c(n-5)+c(n-7)+2, c(9) = 22, c(8) = 16, c(7) = 11, c(6) = 8, c(5) = 5, c(4) = 3, c(3) = 2, c(2) = 1, c(1) = 1, c(0) = 0

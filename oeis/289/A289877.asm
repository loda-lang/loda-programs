...
; Formula: a(n) = d(n+1)-9, b(n) = b(n-1)+c(n-1), b(4) = 4, b(3) = 1, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = 3*n-c(n-1)-5, c(4) = 4, c(3) = 3, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = b(n-1)+c(n-1)+d(n-1)+3, d(4) = 17, d(3) = 10, d(2) = 6, d(1) = 3, d(0) = 0

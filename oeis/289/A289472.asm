...
; Formula: a(n) = b(n-1), a(3) = 17, a(2) = 1, a(1) = 1, a(0) = 0, b(n) = 4*c(n-2)*c(n-1)*b(n-2)+4*c(n-2)*b(n-2)+b(n-1), b(3) = 113, b(2) = 17, b(1) = 1, b(0) = 1, c(n) = 2*c(n-1)+1, c(3) = 15, c(2) = 7, c(1) = 3, c(0) = 1

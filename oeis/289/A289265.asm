...
; Formula: a(n) = (10^n+b(3*n)/(c(3*n)/(10^n)))%10, b(n) = 12*c(n-1)+8*c(n-3)-18*c(n-2)+b(n-1), b(5) = 46800, b(4) = 7120, b(3) = 1080, b(2) = 160, b(1) = 20, b(0) = 0, c(n) = 8*c(n-1)+4*c(n-3)-10*c(n-2), c(5) = 27600, c(4) = 4200, c(3) = 640, c(2) = 100, c(1) = 20, c(0) = 10

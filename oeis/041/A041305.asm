...
; Formula: a(n) = a(n-1)*(((sign(n)*((abs(n)-1)%6+1))==5)+((sign(n)*((abs(n)-1)%6+1))==1)+((sign(n)*((abs(n)-1)%6+1))==0)+24*((sign(n)*((abs(n)-1)%6+1))==6)+5*((sign(n)*((abs(n)-1)%6+1))==4)+5*((sign(n)*((abs(n)-1)%6+1))==2)+2*((sign(n)*((abs(n)-1)%6+1))==3))+a(n-2), a(2) = 6, a(1) = 1, a(0) = 1

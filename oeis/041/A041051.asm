...
; Formula: a(n) = a(n-1)*(truncate((100*((sign(n)*((abs(n)-1)%8+1))==8)+50*((sign(n)*((abs(n)-1)%8+1))==4)+30*((sign(n)*((abs(n)-1)%8+1))==5)+30*((sign(n)*((abs(n)-1)%8+1))==3)+10*((sign(n)*((abs(n)-1)%8+1))==0)-9)/10)+1)+a(n-2), a(2) = 2, a(1) = 1, a(0) = 1

...
; Formula: a(n) = b(n+1), b(n) = b(n-1)*(2*truncate((gcd(c(n-1),A144330(truncate((12*truncate(A010126(n-1)/3)+4*A010126(n-1))/5)*gcd(n-1,2)+gcd(n-1,2)-1))+2)/5)+A144330(truncate((12*truncate(A010126(n-1)/3)+4*A010126(n-1))/5)*gcd(n-1,2)+gcd(n-1,2)-1))+b(n-2), b(3) = 7, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = 2*truncate((gcd(c(n-1),A144330(truncate((12*truncate(A010126(n-1)/3)+4*A010126(n-1))/5)*gcd(n-1,2)+gcd(n-1,2)-1))+2)/5), c(3) = 2, c(2) = 0, c(1) = 4, c(0) = 0

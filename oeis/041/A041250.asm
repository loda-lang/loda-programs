...
; Formula: a(n) = b(n+1), b(n) = truncate(A128309(truncate(3^(gcd(truncate((4*n-3)/3),max(-truncate((4*n-3)/3)+2,0)+6)-3))%10+gcd(-truncate((4*n-3)/3),2)+truncate((truncate(3^(gcd(truncate((4*n-3)/3),max(-truncate((4*n-3)/3)+2,0)+6)-3))%10+gcd(-truncate((4*n-3)/3),2))/3))/2)*b(n-1)+b(n-2), b(2) = 12, b(1) = 11, b(0) = 1

...
; Formula: a(n) = b(n+1), b(n) = b(n-1)*(7*truncate((gcd(truncate(truncate((-4*truncate(A266313(n-1)/4)+A040329(n-1)+A266313(n-1))/2)/5),truncate(truncate((-4*truncate(A266313(n-1)/4)+A040329(n-1)+A266313(n-1))/2)/2)+1)+truncate(truncate((-4*truncate(A266313(n-1)/4)+A040329(n-1)+A266313(n-1))/2)/2))/4)+gcd(truncate(truncate((-4*truncate(A266313(n-1)/4)+A040329(n-1)+A266313(n-1))/2)/5),truncate(truncate((-4*truncate(A266313(n-1)/4)+A040329(n-1)+A266313(n-1))/2)/2)+1)+truncate(truncate((-4*truncate(A266313(n-1)/4)+A040329(n-1)+A266313(n-1))/2)/2))+b(n-2), b(2) = 13, b(1) = 12, b(0) = 1

...
; Formula: a(n) = d(n)/4, b(n) = 4*c(n-1)+4*e(n-1)-2*b(n-1), b(3) = 96, b(2) = 0, b(1) = 8, b(0) = 0, c(n) = 2*c(n-1)+2*e(n-1)+b(n-1), c(3) = 48, c(2) = 16, c(1) = 4, c(0) = 2, d(n) = 2*b(n-1), d(3) = 0, d(2) = 16, d(1) = 0, d(0) = 4, e(n) = 2*e(n-1)+b(n-1), e(3) = 16, e(2) = 8, e(1) = 0, e(0) = 0

...
; Formula: a(n) = truncate(c(n)/4), b(n) = 8*b(n-2)+4*d(n-1), b(5) = 1280, b(4) = 64, b(3) = 96, b(2) = 0, b(1) = 8, b(0) = 0, c(n) = 2*b(n-1), c(3) = 0, c(2) = 16, c(1) = 0, c(0) = 4, d(n) = 2*d(n-1)+b(n-1), d(3) = 16, d(2) = 8, d(1) = 0, d(0) = 0

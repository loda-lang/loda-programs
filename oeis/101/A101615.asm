...
; Formula: a(n) = b(n/2)/3+1, b(n) = gcd((-c(n-1)+d(n-1))/2+1,4), b(2) = 1, b(1) = 4, b(0) = 0, c(n) = 4*c(n-1), c(2) = 160, c(1) = 40, c(0) = 10, d(n) = ((-c(n-1)+d(n-1))/2)/gcd((-c(n-1)+d(n-1))/2+1,4), d(2) = -20, d(1) = -1, d(0) = 0

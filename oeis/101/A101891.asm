...
; Formula: a(n) = 2*a(n-1)+c(n-2), a(5) = 21, a(4) = 9, a(3) = 4, a(2) = 2, a(1) = 1, a(0) = 1, b(n) = b(n-1)+c(n-1), b(4) = 4, b(3) = 1, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = 3*c(n-1)-2*c(n-2)+b(n-3), c(7) = 70, c(6) = 32, c(5) = 15, c(4) = 7, c(3) = 3, c(2) = 1, c(1) = 0, c(0) = 0

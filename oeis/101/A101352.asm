...
; Formula: a(n) = truncate(b(n)/2), b(n) = 2*b(n-1)+2*c(n-1)+2*c(n-2)-2*n+4, b(6) = 280, b(5) = 138, b(4) = 66, b(3) = 30, b(2) = 12, b(1) = 4, b(0) = 0, c(n) = -n+c(n-1)+c(n-2)+2, c(6) = 2, c(5) = 3, c(4) = 3, c(3) = 3, c(2) = 2, c(1) = 2, c(0) = 1

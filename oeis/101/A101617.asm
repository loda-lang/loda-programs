...
; Formula: a(n) = b(max(n-1,0))+1, b(n) = 2*d(n-1)-b(n-1)-2*c(n-1)-2*e(n-1), b(4) = 18, b(3) = -4, b(2) = 2, b(1) = 0, b(0) = 0, c(n) = 2*d(n-1)-2*b(n-1)-2*c(n-1)-2*e(n-1), c(4) = 22, c(3) = -6, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = 4*c(n-1)+f(n-1), d(4) = -15, d(3) = 9, d(2) = 1, d(1) = 1, d(0) = 0, e(n) = 4*c(n-1), e(4) = -24, e(3) = 8, e(2) = 0, e(1) = 0, e(0) = 0, f(n) = 4*c(n-1)+f(n-1), f(4) = -15, f(3) = 9, f(2) = 1, f(1) = 1, f(0) = 1

...
; Formula: a(n) = (b(4*n+4)/(c(4*n+4)/(10^(n+1))))%10, b(n) = 2*c(n-1)+b(n-1)+e(n-1), b(3) = 110, b(2) = 20, b(1) = 10, b(0) = 0, c(n) = 3*c(n-1)+b(n-1)+e(n-1), c(3) = 140, c(2) = 30, c(1) = 10, c(0) = 0, d(n) = 2*c(n-1)+b(n-1)+d(n-1), d(3) = 110, d(2) = 30, d(1) = 0, d(0) = 0, e(n) = -e(n-1)+b(n-1)+c(n-1)+d(n-1), e(3) = 50, e(2) = 30, e(1) = -10, e(0) = 10

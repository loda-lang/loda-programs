...
; Formula: a(n) = c(n)+4, b(n) = 0, b(7) = 0, b(6) = 0, b(5) = 0, b(4) = 0, b(3) = 0, b(2) = 0, b(1) = -1, b(0) = 0, c(n) = c(n-1)*(b(n-1)+2)+b(n-1)+d(n-1)+2, c(7) = 90, c(6) = 52, c(5) = 30, c(4) = 16, c(3) = 8, c(2) = 3, c(1) = 2, c(0) = 0, d(n) = -c(n-1)-e(n-1)-f(n-1)+b(n-2)+2, d(7) = -30, d(6) = -16, d(5) = -10, d(4) = -4, d(3) = -2, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = b(n-2)+d(n-2)+2, e(7) = -8, e(6) = -2, e(5) = 0, e(4) = 2, e(3) = 1, e(2) = 2, e(1) = 0, e(0) = 0, f(n) = -c(n-1)-e(n-1)-f(n-1), f(7) = -32, f(6) = -18, f(5) = -12, f(4) = -6, f(3) = -3, f(2) = -2, f(1) = 0, f(0) = 0

...
; Formula: a(n) = d(n)+4, b(n) = 0, b(7) = 0, b(6) = 0, b(5) = 0, b(4) = 0, b(3) = 0, b(2) = 0, b(1) = -1, b(0) = 0, c(n) = b(n-1)+e(n-1)+2, c(7) = -14, c(6) = -8, c(5) = -2, c(4) = 0, c(3) = 2, c(2) = 1, c(1) = 2, c(0) = 0, d(n) = d(n-1)*(b(n-1)+2)+b(n-1)+e(n-1)+2, d(7) = 90, d(6) = 52, d(5) = 30, d(4) = 16, d(3) = 8, d(2) = 3, d(1) = 2, d(0) = 0, e(n) = -d(n-2)*(b(n-2)+2)-c(n-2)-e(n-2)+d(n-2)+f(n-2)+f1(n-2), e(7) = -30, e(6) = -16, e(5) = -10, e(4) = -4, e(3) = -2, e(2) = 0, e(1) = 0, e(0) = 0, f(n) = b(n-2)+e(n-2)+2, f(7) = -8, f(6) = -2, f(5) = 0, f(4) = 2, f(3) = 1, f(2) = 2, f(1) = 0, f(0) = 0, f1(n) = -d(n-1)-f(n-1)-f1(n-1), f1(7) = -32, f1(6) = -18, f1(5) = -12, f1(4) = -6, f1(3) = -3, f1(2) = -2, f1(1) = 0, f1(0) = 0

...
; Formula: a(n) = b(n-1)+d(n-1)+2, b(n) = b(n-1)+b(n-2)+c(n-2), b(5) = 9, b(4) = 6, b(3) = 4, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = c(n-4), c(6) = 1, c(5) = 3, c(4) = 1, c(3) = -1, c(2) = 1, c(1) = 3, c(0) = 1, d(n) = d(n-1)+d(n-2)+e(n-4), d(5) = 16, d(4) = 9, d(3) = 6, d(2) = 4, d(1) = 1, d(0) = 0, e(n) = e(n-4), e(4) = -1, e(3) = 1, e(2) = 3, e(1) = 1, e(0) = -1

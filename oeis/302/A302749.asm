...
; Formula: a(n) = min(n-1,(n-1)%2)*c(n-1)+b(n-1), b(n) = c(n-2)*(2*d(n-2)+3)+b(n-2), b(5) = 6, b(4) = 6, b(3) = 1, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = -c(n-4)*(2*d(n-4)+2)+c(n-2)*(2*d(n-2)+2)+c(n-4)*(2*d(n-4)+3)+c(n-2), c(7) = 36, c(6) = 36, c(5) = 5, c(4) = 5, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = d(n-2)+1, d(5) = 2, d(4) = 2, d(3) = 1, d(2) = 1, d(1) = 0, d(0) = 0

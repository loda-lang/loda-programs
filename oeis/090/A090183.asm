...
; Formula: a(n) = -A000040(n+1)^2-10*truncate((-A000040(n+1)^2-10*truncate((-A000040(n+1)^2+A037736(n-2)+2)/10)+A037736(n-2)+12)/10)-10*truncate((-A000040(n+1)^2+A037736(n-2)+2)/10)+A037736(n-2)+12

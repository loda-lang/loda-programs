...
; Formula: a(n) = -A000040(n+3)^2-10*truncate((-A000040(n+3)^2-10*truncate((-A000040(n+3)^2+A037736(n)+2)/10)+A037736(n)+12)/10)-10*truncate((-A000040(n+3)^2+A037736(n)+2)/10)+A037736(n)+12

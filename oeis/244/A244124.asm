...
; Formula: a(n) = truncate((-binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2)+n+1)^(-n+binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2)+truncate((sqrtint(8*n+8)-1)/2)))*truncate((-n+binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2)+binomial(0,-binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2)+n)+1)^(-binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2)+n-1))

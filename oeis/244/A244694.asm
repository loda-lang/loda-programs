...
; Formula: a(n) = f1(n+5)+1, b(n) = e(n-2), b(6) = 9, b(5) = 3, b(4) = 1, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = e(n-3), c(6) = 3, c(5) = 1, c(4) = 0, c(3) = 0, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = e(n-1), d(6) = 26, d(5) = 9, d(4) = 3, d(3) = 1, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = 3*e(n-1)-c(n-2)-e(n-3)-f(n-2)+f(n-1), e(8) = 617, e(7) = 215, e(6) = 75, e(5) = 26, e(4) = 9, e(3) = 3, e(2) = 1, e(1) = 0, e(0) = 0, f(n) = c(n-2)+1, f(6) = 1, f(5) = 1, f(4) = 1, f(3) = 1, f(2) = 1, f(1) = 1, f(0) = 0, f1(n) = 2*f1(n-1)-b(n-1)+c(n-1)+d(n-1)+e(n-1)+f(n-1), f1(6) = 110, f1(5) = 38, f1(4) = 13, f1(3) = 4, f1(2) = 1, f1(1) = 0, f1(0) = 0

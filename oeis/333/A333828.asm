...
; Formula: a(n) = truncate(c(n+1)/d(n+1)), b(n) = 20*b(n-1), b(2) = 400, b(1) = 20, b(0) = 1, c(n) = c(n-1)^5-20*truncate((c(n-1)^5)/(20*b(n-1)))*b(n-1), c(2) = 368, c(1) = 8, c(0) = 8, d(n) = b(n-1), d(2) = 20, d(1) = 1, d(0) = 0

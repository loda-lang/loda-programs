...
; Formula: a(n) = binomial(2*truncate((-n+binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2)+truncate((sqrtint(8*n+8)-1)/2))/2)-binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2)+n+1,truncate((2*truncate((-n+binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2)+truncate((sqrtint(8*n+8)-1)/2))/2))/2))

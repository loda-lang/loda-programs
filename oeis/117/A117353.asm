...
; Formula: a(n) = -d(n-1)+a(n-1)+c(n-1)+1, a(4) = 18, a(3) = 9, a(2) = 5, a(1) = 2, a(0) = 1, b(n) = -c(n-1)+a(n-1)+b(n-1)+d(n-1)-1, b(4) = 0, b(3) = 0, b(2) = -1, b(1) = 0, b(0) = 0, c(n) = -d(n-1)+c(n-1), c(4) = 8, c(3) = 3, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = -a(n-1)-2*b(n-2)+b(n-1)+1, d(4) = -6, d(3) = -5, d(2) = -1, d(1) = -2, d(0) = 0

...
; Formula: a(n) = b(n-1), b(n) = c(n-1)+d(n-1)+1, b(3) = 2, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = b(n-1)+c(n-1), c(4) = 4, c(3) = 2, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = b(n-1)*(c(n-1)+d(n-1)), d(3) = 1, d(2) = 0, d(1) = 0, d(0) = 0

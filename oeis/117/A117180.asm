...
; 4,8,9,3,16,2,4,3,25,27,4,32,4,5,4,5,3,49,2,4,2,7,3,7,64,4,8,3,4,5,81,3,8,2,4,3,2,9,4,8,4,7,4,9,3,121,4,125,2,128,3,5,8,4,9,3,4,2,8,9,3,5,2,4,3,169,9,4,7,11,4,8,4,7,3,4,2,8,3,9
; Formula: a(n) = A034684(A013929(n+1)-1)

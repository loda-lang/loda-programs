...
; Formula: a(n) = c(n-1)*(min(n-1,(n-1)%4)+1), b(n) = b(n-4)+1, b(7) = 2, b(6) = 2, b(5) = 2, b(4) = 2, b(3) = 1, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = c(n-4)*(b(n-4)+1), c(7) = 2, c(6) = 2, c(5) = 2, c(4) = 2, c(3) = 1, c(2) = 1, c(1) = 1, c(0) = 1

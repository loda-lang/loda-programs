...
; Formula: a(n) = b(n-1)+3, b(n) = sign(2*sign(c(n-1)+1)+2*sign(4)-1)*bitor(abs(c(n-1)+1),abs(4))+b(n-1)-1, b(1) = 4, b(0) = 0, c(n) = sign(2*sign(c(n-1)+1)+2*sign(4)-1)*bitor(abs(c(n-1)+1),abs(4)), c(1) = 5, c(0) = 0

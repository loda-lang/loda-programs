...
; Formula: a(n) = ((2*d(4*n)+2)/(c(4*n)/(10^n)))%10, b(n) = 4*c(n-1)+4*d(n-1)+2*b(n-1), b(2) = 28, b(1) = 4, b(0) = 0, c(n) = (2*c(n-1)+2*d(n-1)+b(n-1)+c(n-1))/2+2*c(n-1)+d(n-1), c(2) = 16, c(1) = 3, c(0) = 1, d(n) = 2*c(n-1)+d(n-1), d(2) = 8, d(1) = 2, d(0) = 0

...
; Formula: a(n) = (-n+binomial(floor(sqrtint(8*n)/2),2)+floor(sqrtint(8*n)/2)+1)*((-binomial(floor(sqrtint(8*n)/2),2)+n)<=(-n+binomial(floor(sqrtint(8*n)/2),2)+floor(sqrtint(8*n)/2)+1))

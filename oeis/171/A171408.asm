...
; Formula: a(n) = b(n-1)+c(n-1)+a(n-1), a(3) = 4, a(2) = 4, a(1) = 4, a(0) = 4, b(n) = b(n-1)+c(n-1)+a(n-1)+d(n-1), b(3) = 8, b(2) = 8, b(1) = 4, b(0) = 0, c(n) = -b(n-1)-a(n-1), c(3) = -12, c(2) = -8, c(1) = -4, c(0) = 0, d(n) = c(n-1)+a(n-1)+d(n-1), d(3) = 0, d(2) = 4, d(1) = 4, d(0) = 0

...
; Formula: a(n) = d(n)+1, b(n) = b(n-1)+b(n-2)+c(n-2)+d(n-2)-1, b(4) = 3, b(3) = 1, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = c(n-1)+d(n-1)+1, c(4) = 5, c(3) = 3, c(2) = 1, c(1) = -1, c(0) = 0, d(n) = b(n-1), d(4) = 1, d(3) = 1, d(2) = 1, d(1) = 1, d(0) = 0

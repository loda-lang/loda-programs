...
; Formula: a(n) = d(n+1), b(n) = b(n-3)+c(n-3)+d(n-3), b(4) = 2, b(3) = 1, b(2) = 0, b(1) = 1, b(0) = 0, c(n) = b(n-1)+c(n-1), c(4) = 2, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = 2*b(n-1)+2*c(n-1)+d(n-1), d(4) = 9, d(3) = 5, d(2) = 3, d(1) = 1, d(0) = 1

...
; Formula: a(n) = binomial(2*floor((sqrtint(8*n+8)-1)/2)-n+binomial(floor((sqrtint(8*n+8)-1)/2)+1,2),floor((sqrtint(8*n+8)-1)/2))+binomial(-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+floor((sqrtint(8*n+8)-1)/2)+n,-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n)

...
; Formula: a(n) = b(n+2), b(n) = b(n-1)+c(n-2)+max(c(n-3)-1,0), b(4) = 4, b(3) = 2, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = 2*c(n-1)-c(n-2)+c(n-3)+max(c(n-4)-1,0), c(5) = 9, c(4) = 5, c(3) = 3, c(2) = 2, c(1) = 1, c(0) = 0

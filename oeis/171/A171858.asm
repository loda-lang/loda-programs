...
; Formula: a(n) = e(n)+1, b(n) = 3*f(n-1)+2*d(n-1)-b(n-1)-e(n-1)-1, b(4) = -10, b(3) = -7, b(2) = -4, b(1) = -1, b(0) = 0, c(n) = -b(n-1)+c(n-1)+e(n-1), c(4) = 24, c(3) = 9, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = -e(n-1)+b(n-1), d(4) = -15, d(3) = -7, d(2) = -2, d(1) = 0, d(0) = 0, e(n) = -b(n-1)+c(n-1)+d(n-1)+e(n-1)+1, e(4) = 18, e(3) = 8, e(2) = 3, e(1) = 1, e(0) = 0, f(n) = -b(n-1)+f(n-1)-1, f(4) = 8, f(3) = 2, f(2) = -1, f(1) = -1, f(0) = 0

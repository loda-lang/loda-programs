...
; Formula: a(n) = sign(3*sign(truncate((sign(3*sign(2*a(n-1))*sign(4*b(n-1))+sign(4*b(n-1))+sign(2*a(n-1)))*bitxor(abs(4*b(n-1)),abs(2*a(n-1))))/2))*sign(2*a(n-1))+sign(2*a(n-1))+sign(truncate((sign(3*sign(2*a(n-1))*sign(4*b(n-1))+sign(4*b(n-1))+sign(2*a(n-1)))*bitxor(abs(4*b(n-1)),abs(2*a(n-1))))/2)))*bitxor(abs(2*a(n-1)),abs(truncate((sign(3*sign(2*a(n-1))*sign(4*b(n-1))+sign(4*b(n-1))+sign(2*a(n-1)))*bitxor(abs(4*b(n-1)),abs(2*a(n-1))))/2))), a(1) = 3, a(0) = 1, b(n) = truncate((sign(3*sign(2*a(n-1))*sign(4*b(n-1))+sign(4*b(n-1))+sign(2*a(n-1)))*bitxor(abs(4*b(n-1)),abs(2*a(n-1))))/2), b(1) = 1, b(0) = 0

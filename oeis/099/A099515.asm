...
; Formula: a(n) = c(2*n)+1, b(n) = 4*c(n-2)+2*b(n-2)+2*c(n-2)+2*d(n-2)-b(n-1)-2*b(n-2)-2*c(n-2)-4*c(n-2)+c(n-2)+d(n-2)+4, b(4) = 7, b(3) = 4, b(2) = 3, b(1) = 1, b(0) = 0, c(n) = -c(n-1)+b(n-1)+c(n-1), c(4) = 4, c(3) = 3, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = c(n-1)+d(n-1)+1, d(4) = 8, d(3) = 4, d(2) = 2, d(1) = 1, d(0) = 0

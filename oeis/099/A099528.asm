...
; Formula: a(n) = b(2*n)/2+1, b(n) = 2*d(n-1)-e(n-1)+c(n-1)+f(n-1)+2, b(4) = 32, b(3) = 14, b(2) = 8, b(1) = 2, b(0) = 0, c(n) = 2*d(n-1)-c(n-1)-e(n-1)+b(n-1)+c(n-1), c(4) = 22, c(3) = 10, c(2) = 6, c(1) = 0, c(0) = 0, d(n) = c(n-1)+f(n-1)+2, d(4) = 24, d(3) = 12, d(2) = 4, d(1) = 2, d(0) = 0, e(n) = 2*c(n-1)+2*d(n-1)-c(n-1)-e(n-1)+b(n-1), e(4) = 32, e(3) = 16, e(2) = 6, e(1) = 0, e(0) = 0, f(n) = c(n-1)+f(n-1)+2, f(4) = 24, f(3) = 12, f(2) = 4, f(1) = 2, f(0) = 0

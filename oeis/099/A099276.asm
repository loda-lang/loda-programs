...
; Formula: a(n) = b(n-1), a(3) = 361, a(2) = 18, a(1) = 1, a(0) = 0, b(n) = 18*b(n-1)+2*c(n-1)+b(n-2), b(3) = 7200, b(2) = 361, b(1) = 18, b(0) = 1, c(n) = 18*b(n-1)+c(n-1), c(3) = 6840, c(2) = 342, c(1) = 18, c(0) = 0

...
; Formula: a(n) = b(n-1), a(3) = 361, a(2) = 18, a(1) = 1, a(0) = 0, b(n) = 18*b(n-1)+2*d(n-1)+c(n-1), b(3) = 7200, b(2) = 361, b(1) = 18, b(0) = 1, c(n) = b(n-1), c(3) = 361, c(2) = 18, c(1) = 1, c(0) = 0, d(n) = 18*b(n-1)+d(n-1), d(3) = 6840, d(2) = 342, d(1) = 18, d(0) = 0

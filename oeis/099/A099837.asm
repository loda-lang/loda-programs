...
; Formula: a(n) = d(n+1), b(n) = binomial(b(n-1),c(n-1))+1, b(2) = 1, b(1) = 2, b(0) = 0, c(n) = -c(n-1)-binomial(d(n-1),b(n-1))+c(n-1), c(2) = 0, c(1) = -1, c(0) = 0, d(n) = c(n-1)+binomial(d(n-1),b(n-1)), d(2) = -1, d(1) = 1, d(0) = 0

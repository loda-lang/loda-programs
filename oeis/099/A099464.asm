...
; Formula: a(n) = 4*a(n-1)+2*c(n-1)+b(n-1), a(2) = 7, a(1) = 1, a(0) = 0, b(n) = 7*b(n-1)-5*b(n-2)+b(n-3), b(5) = 927, b(4) = 149, b(3) = 24, b(2) = 4, b(1) = 1, b(0) = 1, c(n) = 3*a(n-1)+2*c(n-1)+b(n-1), c(2) = 6, c(1) = 1, c(0) = 0

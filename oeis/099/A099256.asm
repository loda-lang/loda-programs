...
; Formula: a(n) = (-e(n)+c(n))/2+2, b(n) = b(n-1)+d(n-1)+e(n-1), b(3) = 22, b(2) = 4, b(1) = 6, b(0) = 0, c(n) = b(n-1)+c(n-1)+4, c(3) = 24, c(2) = 16, c(1) = 6, c(0) = 2, d(n) = -d(n-1)+b(n-1)+c(n-1)+8, d(3) = 12, d(2) = 16, d(1) = 4, d(0) = 6, e(n) = -d(n-1)-e(n-1), e(3) = -18, e(2) = 2, e(1) = -6, e(0) = 0

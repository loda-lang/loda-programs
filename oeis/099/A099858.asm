...
; Formula: a(n) = a(n-1)+c(n-1)+5, a(3) = 42, a(2) = 17, a(1) = 6, a(0) = 1, b(n) = a(n-1)+b(n-1), b(3) = 24, b(2) = 7, b(1) = 1, b(0) = 0, c(n) = 4*a(n-2)+2*b(n-2)+c(n-1)+c(n-2)+10, c(3) = 62, c(2) = 20, c(1) = 6, c(0) = 0

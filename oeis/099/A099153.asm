...
; Formula: a(n) = truncate(b(n)/15)+1, b(n) = 12*c(n-1)+3*binomial(c(n-1),2), b(3) = 467865, b(2) = 1665, b(1) = 90, b(0) = 0, c(n) = 4*c(n-1)+binomial(c(n-1),2), c(3) = 155955, c(2) = 555, c(1) = 30, c(0) = 4

...
; Formula: a(n) = truncate(b(n)/5)+1, b(n) = 4*c(n-1)+binomial(c(n-1),2), b(3) = 155955, b(2) = 555, b(1) = 30, b(0) = 0, c(n) = 4*c(n-1)+binomial(c(n-1),2), c(3) = 155955, c(2) = 555, c(1) = 30, c(0) = 4

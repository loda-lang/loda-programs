...
; Formula: a(n) = b(2*n)+1, b(n) = 2*d(n-1)-e(n-1), b(4) = 7, b(3) = 4, b(2) = 3, b(1) = 0, b(0) = 0, c(n) = 2*d(n-1)-c(n-1)-e(n-1)+b(n-1)+c(n-1), c(4) = 11, c(3) = 7, c(2) = 3, c(1) = 0, c(0) = 0, d(n) = c(n-1)+f(n-1)+2, d(4) = 18, d(3) = 9, d(2) = 4, d(1) = 2, d(0) = 0, e(n) = 2*c(n-1)+2*d(n-1)-c(n-1)-e(n-1)+b(n-1)+1, e(4) = 19, e(3) = 11, e(2) = 4, e(1) = 1, e(0) = 0, f(n) = c(n-1)+f(n-1)+2, f(4) = 18, f(3) = 9, f(2) = 4, f(1) = 2, f(0) = 0

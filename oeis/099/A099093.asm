...
; Formula: a(n) = truncate(3^(-binomial(truncate((sqrtint(8*n)-1)/2)+1,2)+n))*binomial(-binomial(truncate((sqrtint(8*n)-1)/2)+1,2)+n,-n+binomial(truncate((sqrtint(8*n)-1)/2)+1,2)+truncate((sqrtint(8*n)-1)/2))

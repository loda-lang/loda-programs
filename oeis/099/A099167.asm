...
; Formula: a(n) = 2*a(n-1)+b(n-1)+c(n-1)+1, a(2) = 15, a(1) = 4, a(0) = 1, b(n) = 2*b(n-1)+c(n-1)+1, b(2) = 10, b(1) = 3, b(0) = 1, c(n) = 2*c(n-1)+2*c(n-2)+b(n-2)+1, c(4) = 79, c(3) = 26, c(2) = 8, c(1) = 3, c(0) = 0

...
; Formula: a(n) = -2*a(n-1)-a(n-2)+b(n-2)+3, a(4) = 3, a(3) = 3, a(2) = 1, a(1) = 1, a(0) = 0, b(n) = -a(n-1)+b(n-1)+d(n-1)+3, b(4) = 25, b(3) = 14, b(2) = 7, b(1) = 3, b(0) = 0, c(n) = -d(n-1)+a(n-1)-1, c(4) = -9, c(3) = -5, c(2) = -2, c(1) = -1, c(0) = 0, d(n) = -a(n-1)+b(n-1)+c(n-1)+d(n-1)+2, d(4) = 19, d(3) = 11, d(2) = 5, d(1) = 2, d(0) = 0

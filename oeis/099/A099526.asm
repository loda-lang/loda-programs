...
; Formula: a(n) = 3*b(n-1)-d(n-1)+c(n-1)+a(n-1)+1, a(4) = 19, a(3) = 8, a(2) = 4, a(1) = 2, a(0) = 1, b(n) = -d(n-2)+c(n-2), b(4) = 3, b(3) = 1, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = 3*b(n-1)-d(n-1)+c(n-1)+a(n-1)+1, c(4) = 19, c(3) = 8, c(2) = 4, c(1) = 2, c(0) = 0, d(n) = 3*b(n-1)+1, d(4) = 4, d(3) = 1, d(2) = 1, d(1) = 1, d(0) = 0

...
; Formula: a(n) = b(n-1), a(3) = 196, a(2) = 13, a(1) = 1, a(0) = 0, b(n) = 27*b(n-2)+13*b(n-1)+2*c(n-2), b(3) = 2925, b(2) = 196, b(1) = 13, b(0) = 1, c(n) = 13*b(n-1)+c(n-1), c(3) = 2730, c(2) = 182, c(1) = 13, c(0) = 0

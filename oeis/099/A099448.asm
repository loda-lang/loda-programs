...
; Formula: a(n) = 2*b(n-1)+2*a(n-1)+c(n-1)+d(n-1)+1, a(3) = 65, a(2) = 19, a(1) = 5, a(0) = 1, b(n) = b(n-1)+a(n-1), b(3) = 26, b(2) = 7, b(1) = 2, b(0) = 1, c(n) = b(n-1)+c(n-1)+d(n-1)+1, c(3) = 20, c(2) = 7, c(1) = 2, c(0) = 0, d(n) = b(n-1)+d(n-1)+1, d(3) = 13, d(2) = 5, d(1) = 2, d(0) = 0

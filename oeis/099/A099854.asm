...
; Formula: a(n) = f(n+1), b(n) = 2*c(n-3)+2*d(n-3)-b(n-2)-c(n-3)+b(n-3)+c(n-3)+e(n-3)+3, b(6) = 15, b(5) = 8, b(4) = 5, b(3) = 3, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = b(n-1)+c(n-1), c(6) = 17, c(5) = 9, c(4) = 4, c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = c(n-1)+d(n-1)+1, d(6) = 20, d(5) = 10, d(4) = 5, d(3) = 3, d(2) = 2, d(1) = 1, d(0) = 0, e(n) = c(n-1)+d(n-1)+e(n-1)+1, e(6) = 41, e(5) = 21, e(4) = 11, e(3) = 6, e(2) = 3, e(1) = 1, e(0) = 0, f(n) = e(n-1)+f(n-1)+1, f(6) = 48, f(5) = 26, f(4) = 14, f(3) = 7, f(2) = 3, f(1) = 1, f(0) = 0

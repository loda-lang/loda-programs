...
; Formula: a(n) = f1(n+1), b(n) = d(n-1), b(6) = 15, b(5) = 8, b(4) = 5, b(3) = 3, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = b(n-1)+c(n-1), c(6) = 17, c(5) = 9, c(4) = 4, c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = -b(n-1)+c(n-1)+e(n-2)+f(n-1)+2, d(6) = 29, d(5) = 15, d(4) = 8, d(3) = 5, d(2) = 3, d(1) = 1, d(0) = 0, e(n) = c(n-1)+e(n-1)+1, e(6) = 20, e(5) = 10, e(4) = 5, e(3) = 3, e(2) = 2, e(1) = 1, e(0) = 0, f(n) = c(n-1)+e(n-1)+f(n-1)+1, f(6) = 41, f(5) = 21, f(4) = 11, f(3) = 6, f(2) = 3, f(1) = 1, f(0) = 0, f1(n) = f(n-1)+f1(n-1)+1, f1(6) = 48, f1(5) = 26, f1(4) = 14, f1(3) = 7, f1(2) = 3, f1(1) = 1, f1(0) = 0

...
; Formula: a(n) = a(n-1)*(b(n-1)+c(n-1)+d(n-1)), a(3) = 96, a(2) = 6, a(1) = 1, a(0) = 1, b(n) = b(n-1)+c(n-1)+d(n-1), b(3) = 16, b(2) = 6, b(1) = 1, b(0) = 1, c(n) = 4*b(n-1), c(3) = 24, c(2) = 4, c(1) = 4, c(0) = 0, d(n) = b(n-1)+c(n-1)+d(n-1), d(3) = 16, d(2) = 6, d(1) = 1, d(0) = 0

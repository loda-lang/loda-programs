...
; Formula: a(n) = d(n-1)*(-a(n-1)+b(n-1))+n*a(n-1)-c(n-1), a(4) = 4, a(3) = 1, a(2) = 0, a(1) = 0, a(0) = 1, b(n) = n*a(n-1)+c(n-1), b(4) = 3, b(3) = 0, b(2) = 1, b(1) = 1, b(0) = 2, c(n) = -d(n-1)*(-a(n-1)+b(n-1))+c(n-1), c(4) = 0, c(3) = -1, c(2) = 0, c(1) = 1, c(0) = 0, d(n) = 1, d(4) = 1, d(3) = 1, d(2) = 1, d(1) = 1, d(0) = -1

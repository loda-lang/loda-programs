...
; Formula: a(n) = d(n)+1, b(n) = b(n-1)+b(n-2)+1, b(6) = 20, b(5) = 12, b(4) = 7, b(3) = 4, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = c(n-1)+c(n-2)+c(n-3), c(6) = 7, c(5) = 4, c(4) = 2, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = 2*c(n-3)+b(n-2)+c(n-2)+c(n-4), d(7) = 21, d(6) = 12, d(5) = 7, d(4) = 3, d(3) = 2, d(2) = 1, d(1) = 0, d(0) = 0

...
; Formula: a(n) = b(n+4)/4, b(n) = 4*c(n-2)+2*d(n-1)+c(n-1), b(5) = 64, b(4) = 16, b(3) = 4, b(2) = 4, b(1) = 0, b(0) = 0, c(n) = 2*c(n-1)+b(n-1), c(5) = 40, c(4) = 12, c(3) = 4, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 2*f(n-1)+2, d(5) = 54, d(4) = 18, d(3) = 6, d(2) = 2, d(1) = 2, d(0) = 0, e(n) = 2*c(n-1)+b(n-1)+d(n-1)+e(n-1), e(5) = 84, e(4) = 26, e(3) = 8, e(2) = 2, e(1) = 0, e(0) = 0, f(n) = 2*c(n-1)+b(n-1)+d(n-1)+e(n-1), f(5) = 84, f(4) = 26, f(3) = 8, f(2) = 2, f(1) = 0, f(0) = 0

...
; Formula: a(n) = (d(n-1)*(a(n-1)+1)+b(n-1)+c(n-1))/e(n-1), a(7) = 139, a(6) = 25, a(5) = 10, a(4) = 4, a(3) = 1, a(2) = 1, a(1) = 1, a(0) = 1, b(n) = (d(n-1)*(a(n-1)+1)+b(n-1)+c(n-1))/e(n-1), b(7) = 139, b(6) = 25, b(5) = 10, b(4) = 4, b(3) = 1, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = b(n-1), c(7) = 25, c(6) = 10, c(5) = 4, c(4) = 1, c(3) = 1, c(2) = 1, c(1) = 1, c(0) = 1, d(n) = c(n-1), d(7) = 10, d(6) = 4, d(5) = 1, d(4) = 1, d(3) = 1, d(2) = 1, d(1) = 1, d(0) = 1, e(n) = d(n-1), e(7) = 4, e(6) = 1, e(5) = 1, e(4) = 1, e(3) = 1, e(2) = 1, e(1) = 1, e(0) = 1

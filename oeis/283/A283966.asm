...
; Formula: a(n) = d(n+1)/16, b(n) = (-c(n-1)+b(n-1))/2, b(2) = -16, b(1) = -1, b(0) = 0, c(n) = c(n-1)*gcd(((-c(n-1)+b(n-1))/2+d(n-1)+1)%2,4)^2, c(2) = 32, c(1) = 32, c(0) = 2, d(n) = gcd(((-c(n-1)+b(n-1))/2+d(n-1)+1)%2,4)^2, d(2) = 1, d(1) = 16, d(0) = 0

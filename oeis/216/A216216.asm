...
; Formula: a(n) = binomial(-2*truncate((floor((sqrtint(8*n+8)-1)/2)-1)/2)+floor((sqrtint(8*n+8)-1)/2),-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)-truncate((floor((sqrtint(8*n+8)-1)/2)-1)/2)+n)*if(truncate((floor((sqrtint(8*n+8)-1)/2)-1)/2)<=(-1),0,3^truncate((floor((sqrtint(8*n+8)-1)/2)-1)/2))

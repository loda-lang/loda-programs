...
; Formula: a(n) = sumdigits(-binomial(truncate((sqrtint(8*n-8)-1)/2)+1,2)+n-2,-n+binomial(truncate((sqrtint(8*n-8)-1)/2)+1,2)+truncate((sqrtint(8*n-8)-1)/2)+4)*sign(-binomial(truncate((sqrtint(8*n-8)-1)/2)+1,2)+n-2)

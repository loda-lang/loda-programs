...
; Formula: a(n) = floor(binomial(2*n,n)/(n+1))*(min(n+2,(n+2)%2)*c(n+2)+b(n+2)), b(n) = 2*b(n-2)+c(n-2), b(3) = 1, b(2) = 1, b(1) = -1, b(0) = -1, c(n) = 3*c(n-2)-c(n-4), c(6) = 7, c(5) = 3, c(4) = 3, c(3) = 2, c(2) = 2, c(1) = 3, c(0) = 3

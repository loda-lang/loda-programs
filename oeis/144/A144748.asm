...
; Formula: a(n) = b(n+2), b(n) = b(n-1)^2+9*(d(n-1)/b(n-1))-e(n-1), b(3) = 55, b(2) = 8, b(1) = 1, b(0) = 1, c(n) = max(c(n-1),1), c(3) = 1, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = max(c(n-1),1), d(3) = 1, d(2) = 1, d(1) = 1, d(0) = 0, e(n) = binomial(e(n-1),0)*(b(n-1)^2+9*(d(n-1)/b(n-1))-e(n-1))+binomial(e(n-1),0), e(3) = 56, e(2) = 9, e(1) = 2, e(0) = 0

...
; Formula: a(n) = truncate(2^A077070(n))

seq $0,77070 ; Triangle read by rows: T(n,k) is the power of 2 in denominator of coefficients of Legendre polynomials, where n >= 0 and 0 <= k <= n.
mov $1,2
pow $1,$0
mov $0,$1

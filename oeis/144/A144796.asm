...
; Formula: a(n) = 6*truncate((min(n-1,(n-1)%2)*c(n-1)+b(n-1))/6)+5, b(n) = truncate((1156*c(n-2)+1135*b(n-2))/55), b(3) = 4517, b(2) = 4517, b(1) = 5, b(0) = 5, c(n) = truncate((12467*c(n-2)+12240*b(n-2))/11), c(3) = 243570, c(2) = 243570, c(1) = 210, c(0) = 210

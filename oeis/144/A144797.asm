...
; Formula: a(n) = 2*b(n)+2, b(n) = b(n-1)+d(n-1)+1, b(3) = 12, b(2) = 7, b(1) = 1, b(0) = 0, c(n) = -c(n-1)+d(n-1)-1, c(3) = -2, c(2) = 5, c(1) = -1, c(0) = 0, d(n) = 3*c(n-1)+b(n-1)+b(n-2)+c(n-2)+d(n-2)+6, d(3) = 33, d(2) = 4, d(1) = 5, d(0) = 0

...
; Formula: a(n) = (b(3*n)/((c(3*n)/2)/(10^n)+1))%10, b(n) = 12*b(n-1)+2*c(n-1)+2*d(n-1), b(2) = 540, b(1) = 36, b(0) = 3, c(n) = 12*b(n-1)+4*c(n-1)+2*d(n-1), c(2) = 612, c(1) = 36, c(0) = 0, d(n) = 6*b(n-1)+2*d(n-1)+c(n-1), d(2) = 288, d(1) = 18, d(0) = 0

...
; Formula: a(n) = ((b(3*n)+d(3*n))/(c(3*n)/(10^n)))%10, b(n) = 2*c(n-1)+b(n-1)+d(n-1), b(2) = 23, b(1) = 3, b(0) = 0, c(n) = (c(n-1)+d(n-1))/2+5*c(n-1)+2*b(n-1)+2*d(n-1), c(2) = 60, c(1) = 8, c(0) = 1, d(n) = (c(n-1)+d(n-1))/2+2*c(n-1)+b(n-1)+d(n-1), d(2) = 29, d(1) = 4, d(0) = 1

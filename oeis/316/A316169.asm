...
; Formula: a(n) = (b(3*n+1)/(c(3*n+1)/(10^n)))%10, b(n) = 4*(c(n-1)/2)+4*b(n-1)+4*c(n-1)+4*d(n-1), b(2) = 152, b(1) = 24, b(0) = 0, c(n) = 2*(c(n-1)/2)+b(n-1)+c(n-1)+d(n-1), c(2) = 42, c(1) = 8, c(0) = 4, d(n) = c(n-1)/2+d(n-1), d(2) = 6, d(1) = 2, d(0) = 0

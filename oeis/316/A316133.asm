...
; Formula: a(n) = ((d(3*n)+1)/(c(3*n)/(10^n)+1))%10, b(n) = 8*c(n-1)+6*b(n-1)+2*d(n-1), b(2) = 26, b(1) = 2, b(0) = 0, c(n) = 5*c(n-1)+3*b(n-1)+d(n-1), c(2) = 14, c(1) = 1, c(0) = 0, d(n) = 9*c(n-1)+6*b(n-1)+3*d(n-1), d(2) = 30, d(1) = 3, d(0) = 1

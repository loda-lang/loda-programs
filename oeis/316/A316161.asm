...
; Formula: a(n) = (b(4*n+1)/(c(4*n+1)/(10^n)))%10, b(n) = 2*(c(n-1)/2)+2*b(n-1)+2*c(n-1)+2*d(n-1), b(2) = 130, b(1) = 30, b(0) = 0, c(n) = 2*(c(n-1)/2)+b(n-1)+c(n-1)+d(n-1), c(2) = 75, c(1) = 20, c(0) = 10, d(n) = c(n-1)/2+d(n-1), d(2) = 15, d(1) = 5, d(0) = 0

...
; Formula: a(n) = ((d(3*n)+1)/(c(3*n)/(10^n)+2))%10, b(n) = 6*b(n-1)+6*c(n-1)+2*c(n-1)+2*d(n-1), b(2) = 42, b(1) = 2, b(0) = 0, c(n) = 9*b(n-1)+9*c(n-1)+6*c(n-1)+3*d(n-1), c(2) = 72, c(1) = 3, c(0) = 0, d(n) = 6*b(n-1)+6*c(n-1)+2*c(n-1)+2*d(n-1)+c(n-1)+d(n-1), d(2) = 48, d(1) = 3, d(0) = 1

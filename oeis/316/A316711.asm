...
; Formula: a(n) = ((d(3*n)+3)/(c(3*n)/(10^n)))%10, b(n) = 2*(b(n-1)/2)+2*c(n-1)+2*d(n-1), b(2) = 50, b(1) = 0, b(0) = 0, c(n) = 3*c(n-1)+2*(b(n-1)/2)+2*d(n-1)+24, c(2) = 99, c(1) = 25, c(0) = 1, d(n) = 3*c(n-1)+3*d(n-1)+2*(b(n-1)/2), d(2) = 75, d(1) = 0, d(0) = -1

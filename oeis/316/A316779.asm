...
; Formula: a(n) = floor(d(n)/3)+1, b(n) = 3*b(n-1)+3*c(n-1), b(4) = 123, b(3) = 39, b(2) = 12, b(1) = 3, b(0) = 0, c(n) = 2*c(n-1), c(6) = 16, c(5) = 8, c(4) = 4, c(3) = 2, c(2) = 1, c(1) = 1, c(0) = 1, d(n) = b(n-1), d(4) = 39, d(3) = 12, d(2) = 3, d(1) = 0, d(0) = 0

...
; Formula: a(n) = truncate(e(max(n-1,0))/2)+1, b(n) = 5*b(n-1)-6*b(n-2), b(7) = 3517, b(6) = 1151, b(5) = 373, b(4) = 119, b(3) = 37, b(2) = 11, b(1) = 3, b(0) = 1, c(n) = 2*b(n-1)+2*c(n-1)-2*d(n-1), c(3) = 8, c(2) = 4, c(1) = 2, c(0) = 0, d(n) = 5*d(n-1)-6*d(n-2), d(7) = 3517, d(6) = 1151, d(5) = 373, d(4) = 119, d(3) = 37, d(2) = 11, d(1) = 3, d(0) = 0, e(n) = 2*b(n-1)+c(n-1), e(3) = 26, e(2) = 8, e(1) = 2, e(0) = 0

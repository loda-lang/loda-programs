...
; Formula: a(n) = d(max(n-1,0))/2+1, b(n) = 3*b(n-1)+c(n-1), b(3) = 37, b(2) = 11, b(1) = 3, b(0) = 1, c(n) = 2*c(n-1), c(3) = 8, c(2) = 4, c(1) = 2, c(0) = 0, d(n) = 2*b(n-1)+c(n-1), d(3) = 26, d(2) = 8, d(1) = 2, d(0) = 0

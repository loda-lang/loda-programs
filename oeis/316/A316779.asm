...
; Formula: a(n) = d(n)/2+1, b(n) = 2*b(n-1)+b(n-1)+c(n-1), b(4) = 37, b(3) = 11, b(2) = 3, b(1) = 1, b(0) = 1, c(n) = 4*b(n-2)+2*b(n-2)+2*c(n-1)+2*c(n-2)-2*b(n-2)-2*c(n-2)-4*b(n-2), c(4) = 8, c(3) = 4, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = 2*b(n-1)+c(n-1), d(4) = 26, d(3) = 8, d(2) = 2, d(1) = 0, d(0) = 0

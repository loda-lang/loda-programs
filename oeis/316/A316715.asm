...
; Submitted by fpar
; 1,1,2,1,3,1,2,4,2,2,1,3,1,5,3,3,2,3,1,2,4,2,2,1,6,4,4,3,4,2,3,4,2,2,1,3,1,5,3,3,2,3,1,2,7,5,5,4,5,3,4,5,3,3,2,4,2,5,3,3,2,3,1,2,4,2,2,1,6,4,4,3,4,2,3,4,2,2,1,3
; Formula: a(n) = A056973(4*A003726(n+1)+1)+1

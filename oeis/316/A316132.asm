...
; Formula: a(n) = (b(4*n+4)/(2*(c(4*n+4)/(10^(n+1)))))%10, b(n) = 2*b(n-1)+2*c(n-1)+2*d(n-1), b(3) = 240, b(2) = 40, b(1) = 20, b(0) = 0, c(n) = 3*c(n-1)+b(n-1)+d(n-1), c(3) = 200, c(2) = 40, c(1) = 10, c(0) = 0, d(n) = 6*c(n-3)+2*b(n-3)+2*d(n-3)-c(n-2)+b(n-1)+c(n-1)+d(n-2), d(4) = 520, d(3) = 80, d(2) = 40, d(1) = -10, d(0) = 10

...
; Formula: a(n) = ((2*b(4*n+2))/(c(4*n+2)/(10^n)))%10, b(n) = 2*(c(n-1)/2)+2*b(n-1)+2*c(n-1)+2*d(n-1), b(2) = 84, b(1) = 20, b(0) = 0, c(n) = 2*(c(n-1)/2)+b(n-1)+c(n-1)+d(n-1), c(2) = 48, c(1) = 13, c(0) = 7, d(n) = c(n-1)/2+d(n-1), d(2) = 9, d(1) = 3, d(0) = 0

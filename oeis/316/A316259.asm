...
; Formula: a(n) = ((d(4*n)+2)/(c(4*n)/(10^n)))%10, b(n) = 3*b(n-1)+3*d(n-1)+3, b(2) = 18, b(1) = 3, b(0) = 0, c(n) = (b(n-1)+c(n-1)+d(n-1)+1)/2+2*c(n-1)+d(n-1), c(2) = 12, c(1) = 3, c(0) = 1, d(n) = 2*c(n-1)+d(n-1), d(2) = 8, d(1) = 2, d(0) = 0

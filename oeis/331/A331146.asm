...
; Formula: a(n) = truncate((floor((sqrtint(8*n)+1)/2)*(truncate((floor((sqrtint(8*n)+1)/2)-1)/(-binomial(floor((sqrtint(8*n)+1)/2),2)-floor((sqrtint(8*n)+1)/2)+n-1))-1)+1)/(-binomial(floor((sqrtint(8*n)+1)/2),2)-floor((sqrtint(8*n)+1)/2)+n-1))+1

...
; Formula: a(n) = truncate(c(n+1)/d(n+1)), b(n) = 15*b(n-1), b(2) = 225, b(1) = 15, b(0) = 1, c(n) = c(n-1)^5-15*truncate((c(n-1)^5)/(15*b(n-1)))*b(n-1), c(2) = 99, c(1) = 9, c(0) = 9, d(n) = b(n-1), d(2) = 15, d(1) = 1, d(0) = 0

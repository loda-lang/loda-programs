...
; Formula: a(n) = binomial(-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+binomial(floor((sqrtint(8*n+8)-1)/2)-1,-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n)+n-1,-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n)

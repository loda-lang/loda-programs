...
; 1,1,1,2,1,2,1,3,2,2,1,3,1,2,4,3,1,4,1,3,4,2,1,3,2,2,3,3,1,4,1,5,4,2,4,3,1,2,4,3,1,4,1,3,7,2,1,5,2,12,4,3,1,3,8,3,4,2,1,3,1,2,7,5,8,4,1,3,4,12,1,5,1,2,4,3,4,4,1,5,3,2,1,3,8,2,4,3,1,3,8,3,4,2,8,5,1,16,7,3
; Formula: a(n) = A002487(gcd(A122111(n),A075159(A006068(A156552(n)))))

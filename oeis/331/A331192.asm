...
; Formula: a(n) = (d(n)+min(n,n%2))*(-d(n)-min(n,n%2)+c(n)), b(n) = 2*b(n-2)+c(n-2), b(7) = 55, b(6) = 55, b(5) = 21, b(4) = 21, b(3) = 8, b(2) = 8, b(1) = 3, b(0) = 3, c(n) = b(n-2)+c(n-2), c(7) = 34, c(6) = 34, c(5) = 13, c(4) = 13, c(3) = 5, c(2) = 5, c(1) = 2, c(0) = 2, d(n) = 1, d(7) = 1, d(6) = 1, d(5) = 1, d(4) = 1, d(3) = 1, d(2) = 1, d(1) = 0, d(0) = 0

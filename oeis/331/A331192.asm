...
; Formula: a(n) = (c(n-1)+min(n-1,(n-1)%2))*(-c(n-1)-min(n-1,(n-1)%2)+b(n-1)), b(n) = 3*b(n-2)-b(n-4), b(8) = 89, b(7) = 34, b(6) = 34, b(5) = 13, b(4) = 13, b(3) = 5, b(2) = 5, b(1) = 2, b(0) = 2, c(n) = 1, c(5) = 1, c(4) = 1, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0

...
; Formula: a(n) = truncate(d(n+1)/c(n+1)), b(n) = 15*b(n-1), b(2) = 225, b(1) = 15, b(0) = 1, c(n) = b(n-1), c(2) = 15, c(1) = 1, c(0) = 0, d(n) = d(n-1)^5-15*truncate((d(n-1)^5)/(15*b(n-1)))*b(n-1), d(2) = 126, d(1) = 6, d(0) = 6

...
; Formula: a(n) = truncate((binomial(floor((sqrtint(8*n+8)-1)/2),-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n)*(-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n+2)*if((-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n+2)<=(-1),0,2^(-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n+2)))/8)

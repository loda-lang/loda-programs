...
; Formula: a(n) = b(n)/4, b(n) = 2*d(n-1)*(2*n+2)+3*b(n-1)-2, b(3) = 185, b(2) = 25, b(1) = 1, b(0) = 1, c(n) = 2*c(n-1)+2, c(3) = 22, c(2) = 10, c(1) = 4, c(0) = 1, d(n) = c(n-1)+d(n-1)+1, d(3) = 18, d(2) = 7, d(1) = 2, d(0) = 0

...
; Formula: a(n) = truncate(d(n)/4), b(n) = 2*b(n-1)+c(n-1), b(2) = 6, b(1) = 2, b(0) = 0, c(n) = 3*c(n-1)-c(n-2), c(4) = 26, c(3) = 10, c(2) = 4, c(1) = 2, c(0) = 2, d(n) = (b(n-1)+c(n-1))^2+d(n-1), d(2) = 20, d(1) = 4, d(0) = 0

...
; Formula: a(n) = b(n-1)+1, a(5) = 2, a(4) = 1, a(3) = 1, a(2) = 1, a(1) = 1, a(0) = 1, b(n) = -b(n-1)+c(n-2), b(5) = 1, b(4) = 1, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = -c(n-2)+d(n-2), c(5) = 2, c(4) = 2, c(3) = 2, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = b(n-1)+d(n-1)+1, d(5) = 7, d(4) = 5, d(3) = 4, d(2) = 3, d(1) = 2, d(0) = 1

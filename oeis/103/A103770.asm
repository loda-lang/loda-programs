...
; Formula: a(n) = c(n+1)/6, b(n) = 6*(b(n-1)/2)+6*d(n-1)-6*c(n-1), b(2) = 0, b(1) = 6, b(0) = 0, c(n) = 6*(b(n-1)/2)+6*d(n-1)-6*c(n-1)+c(n-1), c(2) = 6, c(1) = 6, c(0) = 0, d(n) = 3*d(n-1), d(2) = 9, d(1) = 3, d(0) = 1

...
; Formula: a(n) = b(n-1), b(n) = -b(n-7)+b(n-1)+b(n-6), b(15) = 58, b(14) = 53, b(13) = 50, b(12) = 49, b(11) = 41, b(10) = 37, b(9) = 34, b(8) = 29, b(7) = 26, b(6) = 25, b(5) = 17, b(4) = 13, b(3) = 10, b(2) = 5, b(1) = 2, b(0) = 1

...
; Formula: a(n) = 2*c(n)+3, b(n) = 2*d(n-1)+max(b(n-1),1)+2, b(2) = -7, b(1) = 3, b(0) = 0, c(n) = c(n-1)+d(n-1)+max(b(n-1),1)+6, c(2) = 10, c(1) = 7, c(0) = 0, d(n) = -d(n-1)-max(b(n-1),1)-5, d(2) = -2, d(1) = -6, d(0) = 0

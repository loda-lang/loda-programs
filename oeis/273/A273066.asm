...
; Formula: a(n) = (b(3*n)/(c(3*n)/(10^n)))%10, b(n) = 10*d(n-1)+2*b(n-1)-8*d(n-2), b(4) = 3920, b(3) = 452, b(2) = 52, b(1) = 6, b(0) = 1, c(n) = 6*c(n-1)+2*b(n-1)+2*d(n-1), c(2) = 68, c(1) = 8, c(0) = 1, d(n) = 10*d(n-1)+4*d(n-3)-12*d(n-2), d(5) = 24968, d(4) = 2880, d(3) = 332, d(2) = 38, d(1) = 4, d(0) = 0

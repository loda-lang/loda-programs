...
; Formula: a(n) = 2*d(n)+1, b(n) = 3*b(n-1)-e(n-1)+d(n-1), b(3) = 50, b(2) = 12, b(1) = 3, b(0) = 1, c(n) = c(n-1)+e(n-1)-2, c(3) = -11, c(2) = -5, c(1) = -2, c(0) = 0, d(n) = 2*b(n-1)+2*d(n-1), d(3) = 44, d(2) = 10, d(1) = 2, d(0) = 0, e(n) = c(n-1)+e(n-1)-1, e(3) = -10, e(2) = -4, e(1) = -1, e(0) = 0

...
; Formula: a(n) = d(n)/2+1, b(n) = 4*d(n-1)+2*b(n-1)-4*e(n-1)-4, b(3) = -196, b(2) = -40, b(1) = -6, b(0) = 1, c(n) = 1, c(3) = 1, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = c(n-1)*(e(n-1)+1)+4*e(n-1)-2*b(n-1)-4*d(n-1)+c(n-1)+4, d(3) = 280, d(2) = 54, d(1) = 6, d(0) = 0, e(n) = 8*e(n-1)+2*c(n-1)-4*b(n-1)-8*d(n-1)+8, e(3) = 394, e(2) = 82, e(1) = 12, e(0) = 1

...
; Formula: a(n) = 4*b(n)+4, b(n) = -b(n-1)-e(n-1)-2*d(n-1)+max(c(n-1),1)+max(c(n-2),1)+2, b(4) = 9, b(3) = 7, b(2) = 7, b(1) = 2, b(0) = 0, c(n) = max(c(n-1),1)-1, c(4) = 0, c(3) = 0, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = -max(c(n-1),1)+d(n-1)-1, d(4) = -8, d(3) = -6, d(2) = -4, d(1) = -2, d(0) = 0, e(n) = b(n-1)+d(n-1)+e(n-1)-1, e(4) = 0, e(3) = 0, e(2) = -2, e(1) = -1, e(0) = 0

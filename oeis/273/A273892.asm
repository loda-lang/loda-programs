...
; Formula: a(n) = (truncate((-4*floor((10^logint(max(floor((9*n-9)/4),1),10))/9)+n-2)/(10^logint(max(floor((9*n-9)/4),1),10)))+2)*10^logint(max(floor((9*n-9)/4),1),10)-4*floor((10^logint(max(floor((9*n-9)/4),1),10))/9)+n-2

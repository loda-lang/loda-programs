...
; Formula: a(n) = 2*e(n)+3, b(n) = c(n-2)+2, b(5) = 6, b(4) = 4, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = -((c(n-4)+3)/(c(n-4)+3))+c(n-1)+c(n-3)+3, c(6) = 17, c(5) = 11, c(4) = 7, c(3) = 4, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = (b(n-1)+d(n-1))/(c(n-1)+1), d(5) = 0, d(4) = 0, d(3) = 1, d(2) = 1, d(1) = 2, d(0) = 1, e(n) = b(n-1)+d(n-1)+e(n-1), e(5) = 16, e(4) = 12, e(3) = 8, e(2) = 5, e(1) = 2, e(0) = 0

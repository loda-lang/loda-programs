...
; Formula: a(n) = 2*(((4*n+1)*(-b(4*n+1)+c(4*n+1)+3))/2)+1, b(n) = -b(n-1)-2*d(n-1)+b(n-1), b(2) = 2, b(1) = 0, b(0) = 0, c(n) = 2*c(n-1), c(2) = 4, c(1) = 2, c(0) = 1, d(n) = 2*d(n-1)+b(n-1)-1, d(2) = -3, d(1) = -1, d(0) = 0

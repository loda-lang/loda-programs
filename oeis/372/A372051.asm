...
; Formula: a(n) = truncate((-truncate(truncate(binomial(8*binomial(n+2,2)+3*gcd(truncate((binomial(n+2,2)-1)/2),2)-4,2)/4)/(2*binomial(n+2,2)+1))*(2*binomial(n+2,2)+1)+truncate(binomial(8*binomial(n+2,2)+3*gcd(truncate((binomial(n+2,2)-1)/2),2)-4,2)/4))/2)

...
; Formula: a(n) = (b(n)-3)/3, b(n) = b(n-1)+d(n-1), b(3) = 24, b(2) = 12, b(1) = 6, b(0) = 3, c(n) = (6*n+c(n-1))/d(n-1), c(3) = 1, c(2) = 2, c(1) = 2, c(0) = 0, d(n) = d(n-1)*((6*n+c(n-1))/d(n-1)), d(3) = 12, d(2) = 12, d(1) = 6, d(0) = 3

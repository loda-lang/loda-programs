...
; Formula: a(n) = 2*c(n-1)+2, a(3) = 12, a(2) = 4, a(1) = 2, a(0) = 1, b(n) = 2*b(n-1)+b(n-2)+truncate((2*b(n-2)-2*b(n-3))/2)+truncate((2*b(n-3)-2*b(n-4))/2)+1, b(9) = 3597, b(8) = 1336, b(7) = 496, b(6) = 184, b(5) = 68, b(4) = 25, b(3) = 9, b(2) = 3, b(1) = 1, b(0) = 0, c(n) = b(n-1)+b(n-2)+c(n-1)+c(n-2)+truncate(a(n-1)/2)+truncate(a(n-2)/2)+2, c(3) = 15, c(2) = 5, c(1) = 1, c(0) = 0

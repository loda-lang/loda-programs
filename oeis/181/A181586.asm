...
; Formula: a(n) = -a(n-2)+b(n-3)+c(n-3), a(4) = 1, a(3) = 0, a(2) = 1, a(1) = 0, a(0) = 0, b(n) = 2*b(n-2)+2*c(n-2), b(4) = 4, b(3) = 4, b(2) = 0, b(1) = 2, b(0) = 0, c(n) = b(n-1)+c(n-1), c(4) = 6, c(3) = 2, c(2) = 2, c(1) = 0, c(0) = 0

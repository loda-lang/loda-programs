...
; Formula: a(n) = 3*b(n)+3*c(n), b(n) = d(n-1), b(3) = 20, b(2) = 7, b(1) = 2, b(0) = 1, c(n) = d(n-2), c(3) = 7, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = 2*d(n-1)+2*d(n-2)+2*d(n-3)+2*d(n-4), d(4) = 178, d(3) = 60, d(2) = 20, d(1) = 7, d(0) = 2

...
; Formula: a(n) = 3*a(n-2)+a(n-1)+a(n-3)+b(n-2), a(4) = 23, a(3) = 8, a(2) = 4, a(1) = 1, a(0) = 1, b(n) = 2*c(n-1)+b(n-1), b(3) = 4, b(2) = 2, b(1) = 0, b(0) = 0, c(n) = 3*c(n-2)+b(n-3)+c(n-1)+c(n-3), c(5) = 23, c(4) = 8, c(3) = 4, c(2) = 1, c(1) = 1, c(0) = 0

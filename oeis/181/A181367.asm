...
; Formula: a(n) = -e(n)+b(n), b(n) = b(n-1)+c(n-1), b(3) = 82, b(2) = 24, b(1) = 7, b(0) = 2, c(n) = 3*c(n-1)+b(n-1), c(3) = 198, c(2) = 58, c(1) = 17, c(0) = 5, d(n) = 2*d(n-1), d(3) = 8, d(2) = 4, d(1) = 2, d(0) = 1, e(n) = d(n-1), e(3) = 4, e(2) = 2, e(1) = 1, e(0) = 0

...
; Formula: a(n) = ((c(3*n)/gcd(c(3*n)^2,b(3*n)))%2+2)%2, b(n) = -3*n*(b(n-1)+11), b(3) = -1449, b(2) = 150, b(1) = -36, b(0) = 2, c(n) = -3*n*c(n-1)+b(n-1)+d(n-1), c(3) = 412, c(2) = -29, c(1) = -1, c(0) = 1, d(n) = 1, d(3) = 1, d(2) = 1, d(1) = 1, d(0) = 0

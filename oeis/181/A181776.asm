...
; 1,1,1,1,2,1,2,1,2,2,4,1,2,2,2,2,4,2,6,2,2,4,10,1,4,2,6,2,6,2,4,2,4,4,2,2,6,6,2,2,4,2,6,4,2,10,22,2,6,4,4,2,12,6,4,2,6,6,28,2,4,4,2,4,2,4,10,4,10,2,12,2,6,6,4,6,4,2,12,2
; Formula: a(n) = A263027(A002322(n+1)-1)-1

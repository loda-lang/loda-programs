...
; Formula: a(n) = e(n)/10+1, b(n) = b(n-2)*b(n-1), b(4) = 1000, b(3) = 100, b(2) = 10, b(1) = 10, b(0) = 1, c(n) = b(n-1), c(4) = 100, c(3) = 10, c(2) = 10, c(1) = 1, c(0) = 10, d(n) = c(n-1)*b(n-1)*(d(n-2)+10), d(4) = 210000, d(3) = 6000, d(2) = 200, d(1) = 50, d(0) = 10, e(n) = d(n-1), e(4) = 6000, e(3) = 200, e(2) = 50, e(1) = 10, e(0) = 0

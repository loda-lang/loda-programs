...
; Formula: a(n) = (min(n+1,(n+1)%2)*b(n+1)+c(n+1))/3, b(n) = 2*b(n-2)+c(n-2), b(5) = 21, b(4) = 21, b(3) = 6, b(2) = 6, b(1) = 3, b(0) = 3, c(n) = 2*b(n-2)+b(n-2)+2*c(n-2), c(5) = 36, c(4) = 36, c(3) = 9, c(2) = 9, c(1) = 0, c(0) = 0

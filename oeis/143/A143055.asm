...
; Formula: a(n) = e(n-1), b(n) = 2*c(n-5)+2*c(n-6)-2*b(n-5)-2*b(n-6)+b(n-1)+b(n-2)+b(n-3)+2, b(8) = 34, b(7) = 19, b(6) = 10, b(5) = 5, b(4) = 2, b(3) = 1, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = -b(n-1)+c(n-1), c(4) = -1, c(3) = 0, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = d(n-1)+e(n-1), d(4) = 4, d(3) = 2, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = c(n-1)+d(n-1)+1, e(4) = 3, e(3) = 2, e(2) = 1, e(1) = 1, e(0) = 0

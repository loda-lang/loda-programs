...
; Formula: a(n) = d(n-1)+e(n-1)+1, a(4) = 3, a(3) = 2, a(2) = 1, a(1) = 1, a(0) = 0, b(n) = c(n-1), b(4) = 2, b(3) = 1, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = -d(n-1)+b(n-1)+e(n-1)+a(n-1), c(4) = 5, c(3) = 2, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = -b(n-1)+d(n-1), d(4) = -1, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = e(n-1)+a(n-1), e(4) = 4, e(3) = 2, e(2) = 1, e(1) = 0, e(0) = 0

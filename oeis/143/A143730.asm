...
; Formula: a(n) = 2*d(n+1)+7, b(n) = b(n-1)/2+c(n-1), b(3) = 21, b(2) = 10, b(1) = 4, b(0) = 0, c(n) = gcd(b(n-1)/2,2)*c(n-1), c(3) = 16, c(2) = 16, c(1) = 8, c(0) = 4, d(n) = d(n-1)+gcd(b(n-2)/2,2)-1, d(3) = 1, d(2) = 0, d(1) = -1, d(0) = 0

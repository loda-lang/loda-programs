...
; Formula: a(n) = truncate(gcd(0,gcd(2*n-2*binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2)+2,2)*(truncate((sqrtint(8*n+8)-1)/2)+2)*(2*n-truncate((sqrtint(8*n+8)-1)/2)-2*binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2)))/2)+1

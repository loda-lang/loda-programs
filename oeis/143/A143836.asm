...
; Formula: a(n) = truncate((A005145(truncate((sqrtint(8*truncate((sqrtint(8*n-7)+1)/2)+8*n-7)+1)/2)+truncate((sqrtint(8*n-7)+1)/2)+n+1)+A037126(truncate((sqrtint(8*truncate((sqrtint(8*n-7)+1)/2)+8*n-7)+1)/2)+truncate((sqrtint(8*n-7)+1)/2)+n))/2)

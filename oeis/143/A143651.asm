...
; Formula: a(n) = if(((-(A348477(max(3*n-3,1))==1)+A348477(max(3*n-3,1)))^2)==1,(-(A348477(max(3*n-3,1))==1)+A348477(max(3*n-3,1)))^A348477(3*n-2),if(A348477(3*n-2)<=(-1),0,(-(A348477(max(3*n-3,1))==1)+A348477(max(3*n-3,1)))^A348477(3*n-2)))+A348477(3*n-1)

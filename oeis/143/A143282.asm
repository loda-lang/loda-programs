...
; Formula: a(n) = b(n-2), a(6) = 3, a(5) = 2, a(4) = 1, a(3) = 0, a(2) = 0, a(1) = 0, a(0) = 0, b(n) = b(n-1)+d(n-1), b(6) = 9, b(5) = 5, b(4) = 3, b(3) = 2, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = b(n-5)/(-1)+c(n-1)+c(n-4)+d(n-2), c(6) = 9, c(5) = 6, c(4) = 4, c(3) = 2, c(2) = 1, c(1) = 1, c(0) = 1, d(n) = c(n-1), d(6) = 6, d(5) = 4, d(4) = 2, d(3) = 1, d(2) = 1, d(1) = 1, d(0) = 0

...
; Formula: a(n) = 3*b(n-2)+2*a(n-2)+2*c(n-2)+5, a(3) = 17, a(2) = 5, a(1) = 3, a(0) = 0, b(n) = 2*b(n-2)+2*c(n-3)+b(n-1)+b(n-3)+5, b(5) = 61, b(4) = 25, b(3) = 8, b(2) = 3, b(1) = 0, b(0) = 0, c(n) = b(n-1)+c(n-1)+3, c(3) = 12, c(2) = 6, c(1) = 3, c(0) = 0

...
; Formula: a(n) = -binomial(-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+max(floor((sqrtint(8*n+8)-1)/2)-1,0)+n,-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n-1)+binomial(-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+max(floor((sqrtint(8*n+8)-1)/2)-1,0)+n,-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n)

...
; Formula: a(n) = A279363(A181819(A181811(A057335(if((-binomial(floor((sqrtint(8*n)+1)/2),2)+n-1)<=(-1),0,2^(-binomial(floor((sqrtint(8*n)+1)/2),2)+n-1))+2^floor((sqrtint(8*n)+1)/2)))*A057335(if((-binomial(floor((sqrtint(8*n)+1)/2),2)+n-1)<=(-1),0,2^(-binomial(floor((sqrtint(8*n)+1)/2),2)+n-1))+2^floor((sqrtint(8*n)+1)/2))))-1

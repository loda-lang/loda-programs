...
; Formula: a(n) = b(n-1)+d(n-1), a(3) = 1683, a(2) = 231, a(1) = 33, a(0) = 5, b(n) = 5*b(n-1)+5*d(n-1), b(3) = 8415, b(2) = 1155, b(1) = 165, b(0) = 25, c(n) = 6*c(n-1)+b(n-1)+d(n-1), c(3) = 6633, c(2) = 825, c(1) = 99, c(0) = 11, d(n) = 3*c(n-1)+b(n-1)+d(n-1), d(3) = 4158, d(2) = 528, d(1) = 66, d(0) = 8

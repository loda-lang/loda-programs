...
; Formula: a(n) = e(n+1), b(n) = 5*b(n-1)+5*d(n-1), b(3) = 1155, b(2) = 165, b(1) = 25, b(0) = 5, c(n) = 6*c(n-1)+b(n-1)+d(n-1), c(3) = 825, c(2) = 99, c(1) = 11, c(0) = 1, d(n) = 3*c(n-1)+b(n-1)+d(n-1), d(3) = 528, d(2) = 66, d(1) = 8, d(0) = 0, e(n) = b(n-1)+d(n-1), e(3) = 231, e(2) = 33, e(1) = 5, e(0) = 0

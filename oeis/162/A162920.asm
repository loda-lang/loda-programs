...
; Formula: a(n) = max(c(n)-1,0)+1, b(n) = b(n-1)+d(n-1), b(3) = 7, b(2) = 4, b(1) = 1, b(0) = 1, c(n) = b(n-1)+c(n-1)+2, c(3) = 12, c(2) = 6, c(1) = 3, c(0) = 0, d(n) = 2*b(n-2)-d(n-1)+c(n-2)+4, d(3) = 6, d(2) = 3, d(1) = 3, d(0) = 0

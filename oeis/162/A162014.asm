...
; Formula: a(n) = d(n+1), b(n) = -4*n*(b(n-1)*(n-1)+b(n-1)), b(4) = -147456, b(3) = 2304, b(2) = -64, b(1) = 4, b(0) = -1, c(n) = n, c(4) = 4, c(3) = 3, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = d(n-1)*(c(n-1)*b(n-1)+b(n-1)), d(4) = -14155776, d(3) = -1536, d(2) = 8, d(1) = 1, d(0) = -1

...
; Formula: a(n) = 4*b(n-1)+2*c(n-1)+2*d(n-1)+4, a(4) = 102, a(3) = 36, a(2) = 12, a(1) = 4, a(0) = 1, b(n) = 3*b(n-2)+2*c(n-2)+2*d(n-2)+4, b(4) = 32, b(3) = 11, b(2) = 4, b(1) = 1, b(0) = 0, c(n) = 3*b(n-1)+c(n-1)+d(n-1)+2, c(4) = 62, c(3) = 22, c(2) = 7, c(1) = 2, c(0) = 0, d(n) = b(n-1)+d(n-1), d(4) = 16, d(3) = 5, d(2) = 1, d(1) = 0, d(0) = 0

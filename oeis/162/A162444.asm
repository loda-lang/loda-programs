...
; Formula: a(n) = truncate(truncate(binomial(2*n-2,n-1)/gcd(512*n-256,binomial(2*n-2,n-1)))/gcd((6*n-1)^12,truncate(binomial(2*n-2,n-1)/gcd(512*n-256,binomial(2*n-2,n-1)))))

...
; 1,5,9,21,25,37,53,85,89,101,117,149,165,201,261,341,345,357,373,405,421,457,517,597,613,649,709,793,853,965,1173,1365,1369,1381,1397,1429,1445,1481,1541,1621,1637,1673,1733,1817,1877,1989,2197,2389,2405,2441,2501,2585,2645,2757,2965,3161,3221,3333,3541,3765,3977,4341,5013,5461,5465,5477,5493,5525,5541,5577,5637,5717,5733,5769,5829,5913,5973,6085,6293,6485
...
lpb $1
  mov $3,$1
  seq $3,151568 ; a(0)=1, a(1)=1; a(2^i+j)=2*a(j)+a(j+1) for 0 <= j < 2^i.
  sub $1,1
  add $2,$3
lpe
mov $1,$2

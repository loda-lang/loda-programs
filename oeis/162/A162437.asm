...
; Formula: a(n) = d(n)/4+1, b(n) = b(n-2)*b(n-1), b(3) = 4, b(2) = 2, b(1) = 2, b(0) = 1, c(n) = b(n-1), c(3) = 2, c(2) = 2, c(1) = 1, c(0) = 2, d(n) = d(n-1)*c(n-1)*b(n-1)+c(n-1)*b(n-1)+d(n-2), d(3) = 83, d(2) = 18, d(1) = 7, d(0) = 2

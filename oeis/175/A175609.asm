...
; 0,0,0,0,1,1,2,1,2,2,0,1,1,1,3,1,2,3,3,2,1,3,1,1,3,1,1,1,1,2,0,4,2,2,1,2,2,2,2,1,1,1,5,4,2,1,1,4,1,2,2,3,3,4,6,4,3,3,2,2,2,1,1,2,2,3,1,2,1,2,3,2,3,2,3,6,3,2,2,1,2,1,3,2,2,2,4,2,2,2,2,4,2,3,3,4,6,4,4,3
; Formula: a(n) = A175599(A000040(n)-1)

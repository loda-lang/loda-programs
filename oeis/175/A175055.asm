...
; Submitted by PDW
; 1,3,2,7,4,6,15,8,5,12,14,31,16,9,11,24,13,28,30,63,32,17,19,10,23,48,25,27,56,29,60,62,127,64,33,35,18,39,20,22,47,96,49,51,26,55,112,57,59,120,61,124,126,255,128,65,67,34,71,36,38,79,40,21,44,46,95,192,97,99,50,103,52,54,111,224,113,115,58,119
; Formula: a(n) = A318921(A033015(n+1))

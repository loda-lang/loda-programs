...
; Formula: a(n) = truncate(((floor(n/2)*(floor(n/2)*(floor(n/2)*(floor(n/2)*(floor(n/2)*(floor(n/2)*(-floor(n/2)+7)-7)+175)-364)+2338)-2148)+5040)*(n%2)+floor(n/2)*(((floor(n/2)^2+28)*floor(n/2)^2+679)*floor(n/2)^2+4332))/5040)

...
; Formula: a(n) = bitxor(A006068(-(0==max(n-1,0))+bitxor(A006068(bitxor(A006068(max(max(max(n-1,0)-1,0)-1,0))+1,truncate((A006068(max(max(max(n-1,0)-1,0)-1,0))+1)/2))*(max(max(n-1,0)-1,0)!=0))+1,truncate((A006068(bitxor(A006068(max(max(max(n-1,0)-1,0)-1,0))+1,truncate((A006068(max(max(max(n-1,0)-1,0)-1,0))+1)/2))*(max(max(n-1,0)-1,0)!=0))+1)/2)))+1,truncate((A006068(-(0==max(n-1,0))+bitxor(A006068(bitxor(A006068(max(max(max(n-1,0)-1,0)-1,0))+1,truncate((A006068(max(max(max(n-1,0)-1,0)-1,0))+1)/2))*(max(max(n-1,0)-1,0)!=0))+1,truncate((A006068(bitxor(A006068(max(max(max(n-1,0)-1,0)-1,0))+1,truncate((A006068(max(max(max(n-1,0)-1,0)-1,0))+1)/2))*(max(max(n-1,0)-1,0)!=0))+1)/2)))+1)/2))*(n!=0)

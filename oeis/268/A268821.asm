...
; Formula: a(n) = -(0==n)+bitxor(A006068(bitxor(A006068(max(max(n-1,0)-1,0))+1,truncate((A006068(max(max(n-1,0)-1,0))+1)/2))*(max(n-1,0)!=0))+1,truncate((A006068(bitxor(A006068(max(max(n-1,0)-1,0))+1,truncate((A006068(max(max(n-1,0)-1,0))+1)/2))*(max(n-1,0)!=0))+1)/2))

...
; Formula: a(n) = c(n-1)+a(n-1)-1, a(3) = -1, a(2) = -1, a(1) = 0, a(0) = 0, b(n) = b(n-1)+c(n-1)+a(n-1)+1, b(3) = 6, b(2) = 5, b(1) = 4, b(0) = 2, c(n) = truncate((2*d(n-1)-2*a(n-1)+2)/(b(n-1)+c(n-1)+a(n-1))), c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 1, d(n) = -a(n-1)+d(n-1)+1, d(3) = 4, d(2) = 2, d(1) = 1, d(0) = 0

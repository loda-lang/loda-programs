...
; Formula: a(n) = -2*truncate(c(n)/2)+c(n), b(n) = -b(n-5)+b(n-1)+b(n-4)+b(n-6), b(9) = 5, b(8) = 4, b(7) = 3, b(6) = 2, b(5) = 1, b(4) = 1, b(3) = 1, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = b(n-5)+c(n-4), c(6) = 1, c(5) = 1, c(4) = 0, c(3) = 0, c(2) = 0, c(1) = 0, c(0) = 0

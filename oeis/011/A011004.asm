...
; Formula: a(n) = -10*truncate(truncate(d(5*n)/truncate((c(5*n)+10)/(10^n)))/10)+truncate(d(5*n)/truncate((c(5*n)+10)/(10^n))), b(n) = truncate((6*b(n-1)+2*c(n-1)+e(n-1)+14)/5), b(3) = 38, b(2) = 12, b(1) = 2, b(0) = 0, c(n) = c(n-1)+truncate((6*b(n-1)+2*c(n-1)+e(n-1)+14)/5), c(3) = 52, c(2) = 14, c(1) = 2, c(0) = 0, d(n) = c(n-1)+d(n-1)+truncate((6*b(n-1)+2*c(n-1)+e(n-1)+14)/5), d(3) = 82, d(2) = 30, d(1) = 16, d(0) = 14, e(n) = 2*c(n-1)+d(n-1)+e(n-1)+truncate((6*b(n-1)+2*c(n-1)+e(n-1)+14)/5)+14, e(3) = 186, e(2) = 76, e(1) = 30, e(0) = 0

...
; Formula: a(n) = b(n)%2, b(n) = (c(n-1)+d(n-1))/c(n-1)+2*b(n-1), b(2) = 34, b(1) = 14, b(0) = 6, c(n) = b(n-1)-1, c(2) = 13, c(1) = 5, c(0) = 4, d(n) = ((c(n-1)+d(n-1))/c(n-1)+2*b(n-1))*((c(n-1)+d(n-1))/c(n-1)), d(2) = 204, d(1) = 28, d(0) = 4

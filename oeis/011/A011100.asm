...
; Formula: a(n) = -10*truncate(truncate(d(8*n)/truncate((c(8*n)+10)/(10^n)))/10)+truncate(d(8*n)/truncate((c(8*n)+10)/(10^n))), b(n) = truncate((15*b(n-1)+2*c(n-1)+e(n-1)+f(n-1))/14), b(4) = 7, b(3) = 3, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = c(n-1)+f(n-1)+truncate((15*b(n-1)+2*c(n-1)+e(n-1)+f(n-1))/14), c(4) = 16, c(3) = 5, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = c(n-1)+d(n-1)+f(n-1)+truncate((15*b(n-1)+2*c(n-1)+e(n-1)+f(n-1))/14), d(4) = 36, d(3) = 20, d(2) = 15, d(1) = 14, d(0) = 14, e(n) = 2*c(n-1)+d(n-1)+e(n-1)+f(n-1)+truncate((15*b(n-1)+2*c(n-1)+e(n-1)+f(n-1))/14), e(4) = 91, e(3) = 50, e(2) = 29, e(1) = 14, e(0) = 0, f(n) = f(n-1)+truncate((15*b(n-1)+2*c(n-1)+e(n-1)+f(n-1))/14), f(4) = 11, f(3) = 4, f(2) = 1, f(1) = 0, f(0) = 0

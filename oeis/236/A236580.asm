...
; Formula: a(n) = 3*d(n)+1, b(n) = 4*d(n-1)+2*b(n-1)+2*c(n-1)+2*e(n-1)+b(n-1)+d(n-1)+3, b(3) = 132, b(2) = 21, b(1) = 3, b(0) = 0, c(n) = b(n-1)+c(n-1)+d(n-1)+e(n-1)+1, c(3) = 43, c(2) = 7, c(1) = 1, c(0) = 0, d(n) = 2*d(n-1)+b(n-1)+c(n-1)+e(n-1)+1, d(3) = 51, d(2) = 8, d(1) = 1, d(0) = 0, e(n) = b(n-1)+d(n-1)+e(n-1)+1, e(3) = 36, e(2) = 6, e(1) = 1, e(0) = 0

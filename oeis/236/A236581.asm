...
; Formula: a(n) = d(n)+1, b(n) = 4*d(n-1)+3*b(n-1)+2*c(n-1)+2*e(n-1)+6, b(3) = 354, b(2) = 48, b(1) = 6, b(0) = 0, c(n) = b(n-1)+c(n-1)+d(n-1)+e(n-1)+2, c(3) = 116, c(2) = 16, c(1) = 2, c(0) = 0, d(n) = 3*d(n-1)+2*b(n-1)+2*c(n-1)+2*e(n-1)+4, d(3) = 268, d(2) = 36, d(1) = 4, d(0) = 0, e(n) = b(n-1)+d(n-1)+e(n-1)+2, e(3) = 100, e(2) = 14, e(1) = 2, e(0) = 0

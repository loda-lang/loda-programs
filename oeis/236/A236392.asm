...
; Formula: a(n) = b(n-1)+c(n-1), a(4) = 4, a(3) = 2, a(2) = 1, a(1) = 1, a(0) = 0, b(n) = b(n-2)+c(n-2)+max(-b(n-2)+c(n-2),0)+max(-b(n-3)+c(n-3),0), b(5) = 4, b(4) = 3, b(3) = 2, b(2) = 1, b(1) = 0, b(0) = 1, c(n) = b(n-1)+c(n-1), c(4) = 4, c(3) = 2, c(2) = 1, c(1) = 1, c(0) = 0

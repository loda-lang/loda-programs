...
; Formula: a(n) = 2*a(n-1)+b(n-1)+c(n-1)+a(n-1)+d(n-1), a(3) = 75, a(2) = 15, a(1) = 3, a(0) = 1, b(n) = 2*a(n-1)+b(n-1)+c(n-1), b(3) = 48, b(2) = 10, b(1) = 2, b(0) = 0, c(n) = 2*a(n-1)+c(n-1), c(3) = 38, c(2) = 8, c(1) = 2, c(0) = 0, d(n) = 2*a(n-1)+b(n-1)+c(n-1)+d(n-1), d(3) = 60, d(2) = 12, d(1) = 2, d(0) = 0

...
; Formula: a(n) = c(n+1), b(n) = 2*c(n-1)+b(n-1)+d(n-1), b(3) = 8, b(2) = 3, b(1) = 1, b(0) = 0, c(n) = c(n-1)+d(n-1), c(3) = 4, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = 2*c(n-1)-c(n-1)-d(n-1)+b(n-1)+d(n-1)+e(n-1), d(3) = 7, d(2) = 3, d(1) = 0, d(0) = 1, e(n) = 2*c(n-1)-c(n-1)+b(n-1)+d(n-1)+e(n-1), e(3) = 10, e(2) = 3, e(1) = 1, e(0) = 0

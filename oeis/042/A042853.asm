...
; Formula: a(n) = a(n-1)*(10*truncate((gcd(b(n-1),A144330(truncate((12*truncate(A010126(n)/3)+4*A010126(n))/5)*gcd(n,2)+gcd(n,2)-1))+2)/5)+A144330(truncate((12*truncate(A010126(n)/3)+4*A010126(n))/5)*gcd(n,2)+gcd(n,2)-1))+a(n-2), a(3) = 31, a(2) = 15, a(1) = 1, a(0) = 1, b(n) = 5*truncate((gcd(b(n-1),A144330(truncate((12*truncate(A010126(n)/3)+4*A010126(n))/5)*gcd(n,2)+gcd(n,2)-1))+2)/5), b(3) = 0, b(2) = 5, b(1) = 0, b(0) = 0

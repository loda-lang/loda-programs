...
; Formula: a(n) = a(n-1)*(((sign(n)*((abs(n)-1)%6+1))==5)+((sign(n)*((abs(n)-1)%6+1))==1)+((sign(n)*((abs(n)-1)%6+1))==0)+48*((sign(n)*((abs(n)-1)%6+1))==6)+11*((sign(n)*((abs(n)-1)%6+1))==4)+11*((sign(n)*((abs(n)-1)%6+1))==2)+2*((sign(n)*((abs(n)-1)%6+1))==3))+a(n-2), a(2) = 12, a(1) = 1, a(0) = 1

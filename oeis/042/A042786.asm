...
; Formula: a(n) = b(n+1), b(n) = b(n-1)*(10*truncate((gcd(c(n-1),truncate((-4*truncate(A266313(3*n-3)/4)+A040329(3*n-3)+A266313(3*n-3))/2)+truncate(truncate((-4*truncate(A266313(3*n-3)/4)+A040329(3*n-3)+A266313(3*n-3))/2)/8))+2)/5)+truncate((-4*truncate(A266313(3*n-3)/4)+A040329(3*n-3)+A266313(3*n-3))/2)+truncate(truncate((-4*truncate(A266313(3*n-3)/4)+A040329(3*n-3)+A266313(3*n-3))/2)/8))+b(n-2), b(3) = 91, b(2) = 61, b(1) = 30, b(0) = 1, c(n) = 10*truncate((gcd(c(n-1),truncate((-4*truncate(A266313(3*n-3)/4)+A040329(3*n-3)+A266313(3*n-3))/2)+truncate(truncate((-4*truncate(A266313(3*n-3)/4)+A040329(3*n-3)+A266313(3*n-3))/2)/8))+2)/5), c(3) = 0, c(2) = 0, c(1) = 20, c(0) = 0

...
; Formula: a(n) = a(n-1)*(truncate((2*gcd(-6*truncate(truncate((10*truncate((2*A010225(a(n-1))*(truncate((-1)^a(n-1))+2)-1)/3)+20)/6)/6)+truncate((10*truncate((2*A010225(a(n-1))*(truncate((-1)^a(n-1))+2)-1)/3)+20)/6),truncate((10*truncate((2*A010225(a(n-1))*(truncate((-1)^a(n-1))+2)-1)/3)+20)/6)+24)+truncate((10*truncate((2*A010225(a(n-1))*(truncate((-1)^a(n-1))+2)-1)/3)+20)/6)+24)/2)-14)+a(n-2), a(1) = 2, a(0) = 1

...
; Formula: a(n) = b(n+1), b(n) = b(n-1)*(52*((sign(n-1)*((abs(n-1)-1)%5+1))==5)+26*((sign(n-1)*((abs(n-1)-1)%5+1))==0)+10*((sign(n-1)*((abs(n-1)-1)%5+1))==3)+10*((sign(n-1)*((abs(n-1)-1)%5+1))==2)+2*((sign(n-1)*((abs(n-1)-1)%5+1))==4)+2*((sign(n-1)*((abs(n-1)-1)%5+1))==1))+b(n-2), b(2) = 53, b(1) = 26, b(0) = 1

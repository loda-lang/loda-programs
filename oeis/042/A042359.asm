...
; Formula: a(n) = a(n-1)*(21*truncate((gcd(truncate(truncate((-4*truncate(min(-8*truncate(n/8)+n,8*truncate(n/8)-n+8)/4)+min(-8*truncate(n/8)+n,8*truncate(n/8)-n+8)+A040329(n))/2)/5),truncate(truncate((-4*truncate(min(-8*truncate(n/8)+n,8*truncate(n/8)-n+8)/4)+min(-8*truncate(n/8)+n,8*truncate(n/8)-n+8)+A040329(n))/2)/2)+1)+truncate(truncate((-4*truncate(min(-8*truncate(n/8)+n,8*truncate(n/8)-n+8)/4)+min(-8*truncate(n/8)+n,8*truncate(n/8)-n+8)+A040329(n))/2)/2))/4)+gcd(truncate(truncate((-4*truncate(min(-8*truncate(n/8)+n,8*truncate(n/8)-n+8)/4)+min(-8*truncate(n/8)+n,8*truncate(n/8)-n+8)+A040329(n))/2)/5),truncate(truncate((-4*truncate(min(-8*truncate(n/8)+n,8*truncate(n/8)-n+8)/4)+min(-8*truncate(n/8)+n,8*truncate(n/8)-n+8)+A040329(n))/2)/2)+1)+truncate(truncate((-4*truncate(min(-8*truncate(n/8)+n,8*truncate(n/8)-n+8)/4)+min(-8*truncate(n/8)+n,8*truncate(n/8)-n+8)+A040329(n))/2)/2))+b(n-1), a(2) = 2, a(1) = 1, a(0) = 1, b(n) = a(n-1), b(2) = 1, b(1) = 1, b(0) = 0

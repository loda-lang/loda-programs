...
; Formula: a(n) = b(n+1), b(n) = b(n-1)*(8*truncate((gcd(c(n-1),A144330(truncate((12*truncate(A010126(n-1)/3)+4*A010126(n-1))/5)*gcd(n-1,2)+gcd(n-1,2)))+2)/5)+A144330(truncate((12*truncate(A010126(n-1)/3)+4*A010126(n-1))/5)*gcd(n-1,2)+gcd(n-1,2)))+b(n-2), b(3) = 350, b(2) = 27, b(1) = 26, b(0) = 1, c(n) = 8*truncate((gcd(c(n-1),A144330(truncate((12*truncate(A010126(n-1)/3)+4*A010126(n-1))/5)*gcd(n-1,2)+gcd(n-1,2)))+2)/5), c(3) = 8, c(2) = 0, c(1) = 16, c(0) = 0

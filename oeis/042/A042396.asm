...
; Formula: a(n) = b(n+1), b(n) = b(n-1)*(((sign(n-1)*((abs(n-1)-1)%6+1))==5)+((sign(n-1)*((abs(n-1)-1)%6+1))==1)+52*((sign(n-1)*((abs(n-1)-1)%6+1))==6)+26*((sign(n-1)*((abs(n-1)-1)%6+1))==0)+12*((sign(n-1)*((abs(n-1)-1)%6+1))==4)+12*((sign(n-1)*((abs(n-1)-1)%6+1))==2)+2*((sign(n-1)*((abs(n-1)-1)%6+1))==3))+b(n-2), b(2) = 27, b(1) = 26, b(0) = 1

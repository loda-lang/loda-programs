...
; Formula: a(n) = a(n-1)*(((5*((2*A010225(a(n-1))*((-1)^n+2)-1)/3)+5)/3+2*(((5*((2*A010225(a(n-1))*((-1)^n+2)-1)/3)+5)/3)%10))/2-((A006882(((5*((2*A010225(a(n-1))*((-1)^n+2)-1)/3)+5)/3+2*(((5*((2*A010225(a(n-1))*((-1)^n+2)-1)/3)+5)/3)%10))/2+1)/(((5*((2*A010225(a(n-1))*((-1)^n+2)-1)/3)+5)/3+2*(((5*((2*A010225(a(n-1))*((-1)^n+2)-1)/3)+5)/3)%10))/2+1))%(((5*((2*A010225(a(n-1))*((-1)^n+2)-1)/3)+5)/3+2*(((5*((2*A010225(a(n-1))*((-1)^n+2)-1)/3)+5)/3)%10))/2+1))+1)+a(n-2), a(2) = 3, a(1) = 1, a(0) = 1

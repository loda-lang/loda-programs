...
; Formula: a(n) = a(n-1)*(((sign(n)*((abs(n)-1)%6+1))==4)+((sign(n)*((abs(n)-1)%6+1))==2)+((sign(n)*((abs(n)-1)%6+1))==0)+52*((sign(n)*((abs(n)-1)%6+1))==6)+3*((sign(n)*((abs(n)-1)%6+1))==5)+3*((sign(n)*((abs(n)-1)%6+1))==1)+2*((sign(n)*((abs(n)-1)%6+1))==3))+a(n-2), a(2) = 4, a(1) = 3, a(0) = 1

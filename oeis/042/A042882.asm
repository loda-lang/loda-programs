...
; Formula: a(n) = b(n+1), b(n) = A064989(A297002(5*truncate(truncate((A040329(n-1)+A266313(n-1))/2)/4)+gcd(truncate((A040329(n-1)+A266313(n-1))/2)-2,5*truncate(truncate((A040329(n-1)+A266313(n-1))/2)/4))+1)-1)*b(n-1)+b(n-2), b(2) = 156, b(1) = 31, b(0) = 1

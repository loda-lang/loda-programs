...
; Formula: a(n) = A064989(A297002(5*truncate(truncate((A040329(n)+A266313(n))/2)/4)+gcd(truncate((A040329(n)+A266313(n))/2)-2,5*truncate(truncate((A040329(n)+A266313(n))/2)/4))+1)-1)*a(n-1)+a(n-2), a(2) = 26, a(1) = 5, a(0) = 1

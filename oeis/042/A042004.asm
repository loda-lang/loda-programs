...
; Formula: a(n) = b(n+1), b(n) = b(n-1)*(8*((gcd(8*((gcd(c(n-2),A144330(gcd(n-2,2)*((4*A047249(A010126(n-2))-12)/5)+gcd(n-2,2)-1))+2)/5),A144330(gcd(n-1,2)*((4*A047249(A010126(n-1))-12)/5)+gcd(n-1,2)-1))+2)/5)-2*((gcd(8*((gcd(c(n-2),A144330(gcd(n-2,2)*((4*A047249(A010126(n-2))-12)/5)+gcd(n-2,2)-1))+2)/5),A144330(gcd(n-1,2)*((4*A047249(A010126(n-1))-12)/5)+gcd(n-1,2)-1))+2)/5)+A144330(gcd(n-1,2)*((4*A047249(A010126(n-1))-12)/5)+gcd(n-1,2)-1))+b(n-2), b(3) = 252, b(2) = 23, b(1) = 22, b(0) = 1, c(n) = 8*((gcd(c(n-1),A144330(gcd(n-1,2)*((4*A047249(A010126(n-1))-12)/5)+gcd(n-1,2)-1))+2)/5), c(3) = 8, c(2) = 0, c(1) = 16, c(0) = 0

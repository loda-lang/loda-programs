...
; Formula: a(n) = a(n-1)*(5*truncate((gcd(b(n-1),truncate((-4*truncate(A266313(3*n)/4)+A040329(3*n)+A266313(3*n))/2)+truncate(truncate((-4*truncate(A266313(3*n)/4)+A040329(3*n)+A266313(3*n))/2)/8))+2)/5)+truncate((-4*truncate(A266313(3*n)/4)+A040329(3*n)+A266313(3*n))/2)+truncate((2*gcd(0,5*truncate((gcd(b(n-1),truncate((-4*truncate(A266313(3*n)/4)+A040329(3*n)+A266313(3*n))/2)+truncate(truncate((-4*truncate(A266313(3*n)/4)+A040329(3*n)+A266313(3*n))/2)/8))+2)/5)+truncate((-4*truncate(A266313(3*n)/4)+A040329(3*n)+A266313(3*n))/2)+truncate(truncate((-4*truncate(A266313(3*n)/4)+A040329(3*n)+A266313(3*n))/2)/8))+2)/5)+truncate(truncate((-4*truncate(A266313(3*n)/4)+A040329(3*n)+A266313(3*n))/2)/8))+a(n-2), a(3) = 7, a(2) = 4, a(1) = 3, a(0) = 1, b(n) = 5*truncate((gcd(b(n-1),truncate((-4*truncate(A266313(3*n)/4)+A040329(3*n)+A266313(3*n))/2)+truncate(truncate((-4*truncate(A266313(3*n)/4)+A040329(3*n)+A266313(3*n))/2)/8))+2)/5), b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0

...
; Formula: a(n) = binomial(truncate((-1)^n)+3,2)*a(n-1)*(-10*truncate(truncate(3^(gcd(n*(truncate((-1)^n)+3),max(-n*(truncate((-1)^n)+3)+b(n-1),0)+6)-3))/10)+truncate(3^(gcd(n*(truncate((-1)^n)+3),max(-n*(truncate((-1)^n)+3)+b(n-1),0)+6)-3))+1)+a(n-2), a(3) = 57, a(2) = 7, a(1) = 1, a(0) = 1, b(n) = max(-n*(truncate((-1)^n)+3)+b(n-1),0)+6, b(3) = 6, b(2) = 6, b(1) = 6, b(0) = 0

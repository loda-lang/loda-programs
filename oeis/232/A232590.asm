...
; Formula: a(n) = 2*c(n+2), b(n) = 4*d(n-2)+2*b(n-2)+2*c(n-2)-b(n-1)-b(n-2)-d(n-2)-e(n-2)-2*b(n-2)-2*c(n-2)-4*d(n-2)+b(n-2)+c(n-2)+e(n-2), b(4) = 2, b(3) = -1, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = 2*b(n-1)-2*d(n-1)+c(n-1)+e(n-1), c(4) = 1, c(3) = 5, c(2) = 0, c(1) = 1, c(0) = 1, d(n) = -2*d(n-1)+b(n-1)+c(n-1), d(4) = -2, d(3) = 3, d(2) = -1, d(1) = 1, d(0) = 0, e(n) = 2*b(n-1)-d(n-1)+c(n-1)+e(n-1), e(4) = 4, e(3) = 4, e(2) = 1, e(1) = 1, e(0) = 0

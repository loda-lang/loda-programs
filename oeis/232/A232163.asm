...
; Formula: a(n) = c(n-1)+max(b(n-1)-2,0)+1, a(4) = 10, a(3) = 5, a(2) = 2, a(1) = 1, a(0) = 0, b(n) = 2*c(n-1)+2*c(n-2)-b(n-2)+c(n-3)+2, b(8) = 276, b(7) = 126, b(6) = 58, b(5) = 28, b(4) = 13, b(3) = 6, b(2) = 4, b(1) = 2, b(0) = 0, c(n) = c(n-1)+max(b(n-1)-2,0)+1, c(4) = 10, c(3) = 5, c(2) = 2, c(1) = 1, c(0) = 0

...
; Formula: a(n) = ((b(3*n+3)/(c(3*n+3)/(10^(n+1))))/2)%10, b(n) = 6*b(n-1)-5*b(n-2)+b(n-3), b(5) = 793, b(4) = 157, b(3) = 31, b(2) = 6, b(1) = 1, b(0) = 0, c(n) = 3*c(n-1)+2*d(n-1)+b(n-1), c(2) = 14, c(1) = 3, c(0) = 1, d(n) = 2*c(n-1)+2*d(n-1)+b(n-1), d(2) = 11, d(1) = 2, d(0) = 0

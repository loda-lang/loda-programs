...
; Formula: a(n) = floor((2*truncate(2^(-n+binomial(truncate((sqrtint(8*n)-1)/2)+1,2)+truncate((sqrtint(8*n)-1)/2)+1))*truncate(5^(-binomial(truncate((sqrtint(8*n)-1)/2)+1,2)+n-1)))/2)

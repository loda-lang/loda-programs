...
; Formula: a(n) = 2*c(n), b(n) = (-d(n-1)*c(n-1)+d(n-1)+e(n-1))/(b(n-1)+1), b(3) = 2, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = b(n-1)+1, c(3) = 1, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = (-d(n-1)*c(n-1)+d(n-1)+e(n-1))/(b(n-1)+1), d(3) = 2, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = 2*c(n-1)+e(n-1), e(3) = 4, e(2) = 2, e(1) = 0, e(0) = 0

...
; Formula: a(n) = truncate(d(n+2)/6)-2, b(n) = 6*n+b(n-1)+6, b(4) = 84, b(3) = 54, b(2) = 30, b(1) = 12, b(0) = 0, c(n) = 6*n+b(n-1)+c(n-1)+6, c(4) = 180, c(3) = 96, c(2) = 42, c(1) = 12, c(0) = 0, d(n) = 6*n+2*b(n-1)+c(n-1)+d(n-1)+6, d(4) = 426, d(3) = 192, d(2) = 66, d(1) = 12, d(0) = 0

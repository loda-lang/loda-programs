...
; Formula: a(n) = 2*f(n+3)+3, b(n) = b(n-1)+d(n-1), b(4) = 7, b(3) = 3, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = 2*b(n-1)+d(n-1)+e(n-1)+3, c(4) = 22, c(3) = 12, c(2) = 6, c(1) = 3, c(0) = 0, d(n) = -b(n-1)-d(n-1)+c(n-1)+max(f(n-1)-2,0), d(4) = 10, d(3) = 4, d(2) = 3, d(1) = 0, d(0) = 0, e(n) = 2*b(n-1)+e(n-1)+3, e(4) = 18, e(3) = 9, e(2) = 6, e(1) = 3, e(0) = 0, f(n) = c(n-1)+max(f(n-1)-2,0), f(4) = 17, f(3) = 7, f(2) = 3, f(1) = 0, f(0) = 0

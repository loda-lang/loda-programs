...
; Formula: a(n) = 5*((min(n+2,(n+2)%2)*c(n+2)+b(n+2))/3)^2-4, b(n) = 2*b(n-2)+c(n-2), b(5) = 9, b(4) = 9, b(3) = 3, b(2) = 3, b(1) = 0, b(0) = 0, c(n) = b(n-2)+c(n-2), c(5) = 6, c(4) = 6, c(3) = 3, c(2) = 3, c(1) = 3, c(0) = 3

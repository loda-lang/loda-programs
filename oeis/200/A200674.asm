...
; Formula: a(n) = 2*d(n-1)-2*c(n-1)+1, a(3) = 61, a(2) = 9, a(1) = 1, a(0) = 0, b(n) = 3*b(n-1)-6, b(3) = -78, b(2) = -24, b(1) = -6, b(0) = 0, c(n) = b(n-1)-2, c(3) = -26, c(2) = -8, c(1) = -2, c(0) = 0, d(n) = 6*d(n-1)-4*b(n-2)+10, d(3) = 166, d(2) = 22, d(1) = 2, d(0) = 0

...
; Formula: a(n) = b(n+2), b(n) = c(n-1), b(5) = 8, b(4) = 5, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = c(n-1)^0+4*d(n-4)+2*b(n-4)+2*c(n-3)+2*(2*c(n-4))-c(n-3)-c(n-4)-d(n-4)-2*b(n-4)-2*c(n-4)-4*d(n-4)+b(n-4)+c(n-2)+1, c(5) = 12, c(4) = 8, c(3) = 5, c(2) = 3, c(1) = 2, c(0) = 1, d(n) = -d(n-1)+b(n-1)+c(n-1)+d(n-1), d(5) = 13, d(4) = 8, d(3) = 5, d(2) = 3, d(1) = 1, d(0) = 0

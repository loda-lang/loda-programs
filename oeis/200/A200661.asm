...
; Formula: a(n) = b(n-1), a(5) = 17, a(4) = 12, a(3) = 8, a(2) = 5, a(1) = 3, a(0) = 2, b(n) = b(n-1)^0+4*c(n-4)+2*a(n-4)+2*b(n-3)+2*(2*b(n-4))-b(n-3)-b(n-4)-c(n-4)-2*a(n-4)-2*b(n-4)-4*c(n-4)+a(n-4)+b(n-2)+1, b(5) = 25, b(4) = 17, b(3) = 12, b(2) = 8, b(1) = 5, b(0) = 3, c(n) = -c(n-1)+a(n-1)+b(n-1)+c(n-1), c(5) = 29, c(4) = 20, c(3) = 13, c(2) = 8, c(1) = 5, c(0) = 3

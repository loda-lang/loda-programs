...
; Formula: a(n) = (c(n)*b(n))/4, b(n) = b(n-1)+d(n-2), b(4) = 2, b(3) = 2, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = c(n-1)+c(n-2), c(4) = 20, c(3) = 12, c(2) = 8, c(1) = 4, c(0) = 4, d(n) = d(n-2)+d(n-3), d(5) = 1, d(4) = 1, d(3) = 1, d(2) = 0, d(1) = 1, d(0) = 0

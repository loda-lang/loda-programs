...
; Formula: a(n) = 2^logint(2*A156552(truncate((truncate((A057335(A341915(A006068(2*n+1)))-1)/A293810(A057335(A341915(A006068(2*n+1)))))+2)/2))+1,2)-A156552(truncate((truncate((A057335(A341915(A006068(2*n+1)))-1)/A293810(A057335(A341915(A006068(2*n+1)))))+2)/2))+floor((2^logint(2*A156552(truncate((truncate((A057335(A341915(A006068(2*n+1)))-1)/A293810(A057335(A341915(A006068(2*n+1)))))+2)/2))+1,2))/2)-1

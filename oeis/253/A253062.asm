...
; Formula: a(n) = c(n+1)/4, b(n) = 2*((b(n-2)+c(n-2)+3)/2)-b(n-1)+max(2*((b(n-3)+c(n-3)+3)/2)-2*b(n-2)-4,0), b(5) = 6, b(4) = 6, b(3) = 2, b(2) = 2, b(1) = 0, b(0) = 0, c(n) = b(n-1)+c(n-1)+2, c(4) = 12, c(3) = 8, c(2) = 4, c(1) = 2, c(0) = 0

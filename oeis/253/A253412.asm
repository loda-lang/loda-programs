...
; Formula: a(n) = (b(n+2)-2)/2+1, b(n) = -d(n-2)-e(n-2)+c(n-2)+e(n-2)+f(n-2)+2, b(5) = 4, b(4) = 4, b(3) = 2, b(2) = 2, b(1) = 2, b(0) = 0, c(n) = 16*c(n-4)+16*e(n-4)+8*c(n-3)+8*e(n-4)+4*c(n-4)+2*(4*e(n-4))+2*c(n-2)+2*(2*e(n-4))+2*f(n-4)-c(n-2)-f(n-4)-2*c(n-1)-2*c(n-2)-2*c(n-4)+2*(-2*e(n-4))+2*(-4*c(n-4))-8*c(n-3)-8*c(n-4)+2*(-8*e(n-4))-16*e(n-4)+c(n-1)+c(n-2)+c(n-3)+2, c(5) = 2, c(4) = 2, c(3) = 0, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = -e(n-1)+c(n-1), d(5) = 2, d(4) = -2, d(3) = 2, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = -e(n-1)+c(n-1)+e(n-1), e(5) = 2, e(4) = 0, e(3) = 2, e(2) = 0, e(1) = 0, e(0) = 0, f(n) = 2*c(n-1)-2*e(n-1)+e(n-1)+f(n-1), f(5) = 6, f(4) = 2, f(3) = 4, f(2) = 0, f(1) = 0, f(0) = 0

...
; Formula: a(n) = truncate(b(n+2)/2), b(n) = c(n-2)+c(n-3)+e(n-3)+2, b(5) = 4, b(4) = 4, b(3) = 2, b(2) = 2, b(1) = 2, b(0) = 0, c(n) = -c(n-1)-e(n-1)+c(n-2)+c(n-5)+d(n-1)+e(n-2)+e(n-3)+2, c(7) = 4, c(6) = 4, c(5) = 2, c(4) = 2, c(3) = 0, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = c(n-1), d(5) = 2, d(4) = 0, d(3) = 2, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = 2*c(n-1)-d(n-1)+e(n-1), e(5) = 6, e(4) = 2, e(3) = 4, e(2) = 0, e(1) = 0, e(0) = 0

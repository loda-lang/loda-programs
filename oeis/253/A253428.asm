...
; Formula: a(n) = 2*b(n)+e(n)+16, b(n) = d(n-1)+19, b(3) = 44, b(2) = 21, b(1) = 19, b(0) = 0, c(n) = b(n-1)+c(n-1)+d(n-1)+e(n-1)+23, c(3) = 167, c(2) = 71, c(1) = 23, c(0) = 0, d(n) = c(n-1)+2, d(3) = 73, d(2) = 25, d(1) = 2, d(0) = 0, e(n) = b(n-1)+e(n-1)+4, e(3) = 52, e(2) = 27, e(1) = 4, e(0) = 0

...
; Formula: a(n) = 2*b(n)+d(n)+16, b(n) = c(n-1)+19, b(3) = 44, b(2) = 21, b(1) = 19, b(0) = 0, c(n) = 2*c(n-1)+23, c(5) = 361, c(4) = 169, c(3) = 73, c(2) = 25, c(1) = 2, c(0) = 0, d(n) = b(n-1)+d(n-1)+4, d(3) = 52, d(2) = 27, d(1) = 4, d(0) = 0

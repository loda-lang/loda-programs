...
; Formula: a(n) = 4*b(n-1)+2*d(n-1)+16, b(n) = c(n-1)+13, b(3) = 22, b(2) = 11, b(1) = 13, b(0) = 0, c(n) = 2*c(n-1)+15, c(5) = 177, c(4) = 81, c(3) = 33, c(2) = 9, c(1) = -2, c(0) = 0, d(n) = b(n-1)+d(n-1)+2, d(3) = 30, d(2) = 17, d(1) = 2, d(0) = 0

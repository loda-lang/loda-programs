...
; Formula: a(n) = 4*b(n)+2*e(n)+16, b(n) = d(n-1)+13, b(3) = 22, b(2) = 11, b(1) = 13, b(0) = 0, c(n) = b(n-1)+c(n-1)+d(n-1)+e(n-1)+11, c(3) = 83, c(2) = 35, c(1) = 11, c(0) = 0, d(n) = c(n-1)-2, d(3) = 33, d(2) = 9, d(1) = -2, d(0) = 0, e(n) = b(n-1)+e(n-1)+2, e(3) = 30, e(2) = 17, e(1) = 2, e(0) = 0

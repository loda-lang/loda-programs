...
; Formula: a(n) = b(2*n+2), b(n) = truncate((2*d(n-2)*b(n-2)-2*b(n-2)-2*c(n-2))/(e(n-2)-2)), b(7) = 14, b(6) = 14, b(5) = 3, b(4) = 3, b(3) = 1, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = 6*b(n-2)+6*c(n-2)+truncate((2*d(n-2)*b(n-2)-2*b(n-2)-2*c(n-2))/(e(n-2)-2)), c(7) = 338, c(6) = 338, c(5) = 51, c(4) = 51, c(3) = 7, c(2) = 7, c(1) = 0, c(0) = 0, d(n) = d(n-2)+2, d(7) = 6, d(6) = 6, d(5) = 4, d(4) = 4, d(3) = 2, d(2) = 2, d(1) = 0, d(0) = 0, e(n) = e(n-2)-2, e(7) = -6, e(6) = -6, e(5) = -4, e(4) = -4, e(3) = -2, e(2) = -2, e(1) = 0, e(0) = 0

...
; Formula: a(n) = 4*truncate((b(n-1)*(d(n-1)+12))/16)+5, b(n) = 4*d(n-3)-2*c(n-2)+10, b(4) = 20, b(3) = 8, b(2) = 2, b(1) = 0, b(0) = -2, c(n) = 4*d(n-3)-2*c(n-2)+11, c(4) = 21, c(3) = 9, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = 2*d(n-1)+4, d(4) = 60, d(3) = 28, d(2) = 12, d(1) = 4, d(0) = 0

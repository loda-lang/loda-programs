...
; Formula: a(n) = 4*((c(n)*(d(n)+12))/16)+5, b(n) = 4*d(n-2)-2*b(n-2)+8, b(4) = 40, b(3) = 20, b(2) = 8, b(1) = 2, b(0) = 0, c(n) = b(n-1), c(4) = 20, c(3) = 8, c(2) = 2, c(1) = 0, c(0) = -2, d(n) = 2*d(n-1)+4, d(4) = 60, d(3) = 28, d(2) = 12, d(1) = 4, d(0) = 0

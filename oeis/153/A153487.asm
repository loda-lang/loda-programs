...
; Formula: a(n) = floor(b(n-1)/4)+3, b(n) = 4*floor(binomial(if((2^2)==1,2^A139421(A019280(n+1)+1),if(A139421(A019280(n+1)+1)<=(-1),0,2^A139421(A019280(n+1)+1))),2)/2)+b(n-1), b(0) = 0

...
; Formula: a(n) = 2*e(n+2)+2, b(n) = b(n-1)+d(n-1), b(3) = 4, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = b(n-1)+d(n-1), c(3) = 4, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = 3*b(n-3)+3*d(n-3)+2*d(n-2)-d(n-1)+1, d(3) = 4, d(2) = 2, d(1) = 1, d(0) = 1, e(n) = b(n-1)+c(n-1)+d(n-1), e(3) = 6, e(2) = 3, e(1) = 1, e(0) = 1

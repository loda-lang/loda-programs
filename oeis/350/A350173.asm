...
; Formula: a(n) = truncate(A000040(n)^(2*binomial(0,-binomial(truncate((sqrtint(8*gcd(n-1,2))-1)/2)+1,2)+gcd(n-1,2)-1)+binomial(binomial(truncate((sqrtint(8*gcd(n-1,2))-1)/2)+1,2),-binomial(truncate((sqrtint(8*gcd(n-1,2))-1)/2)+1,2)+gcd(n-1,2)-1)+truncate((sqrtint(8*gcd(n-1,2))-1)/2)-2))

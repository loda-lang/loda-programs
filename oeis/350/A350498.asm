...
; Formula: a(n) = b(n+4)/18, b(n) = 2*c(n-3)+2*d(n-3)+b(n-2)+b(n-3), b(5) = 18, b(4) = 0, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = b(n-1)+c(n-1)+d(n-1), c(5) = 270, c(4) = 63, c(3) = 9, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = (3*n-3)^2+2*c(n-1)+2*d(n-1)+b(n-1), d(5) = 684, d(4) = 207, d(3) = 54, d(2) = 9, d(1) = 0, d(0) = 0

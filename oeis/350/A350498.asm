...
; Formula: a(n) = truncate(b(n+3)/18), b(n) = -(3*n-9)^2-c(n-2)+c(n-1), b(7) = 558, b(6) = 126, b(5) = 18, b(4) = 0, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = (3*n-6)^2+(3*n-15)^2+3*c(n-1)-(3*n-12)^2-2*c(n-3)+c(n-2)+c(n-4), c(8) = 10503, c(7) = 3249, c(6) = 972, c(5) = 270, c(4) = 63, c(3) = 9, c(2) = 0, c(1) = 0, c(0) = 0

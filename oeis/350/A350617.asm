...
; Formula: a(n) = if((a(n-1)+A151800(b(n-1)))==0,0,(a(n-1)+A151800(b(n-1)))/(2^valuation(a(n-1)+A151800(b(n-1)),2))), a(1) = 1, a(0) = 0, b(n) = if((a(n-1)+A151800(b(n-1)))==0,A151800(b(n-1)),if((A151800(b(n-1))%(a(n-1)+A151800(b(n-1))))==0,A151800(b(n-1))/(a(n-1)+A151800(b(n-1))),A151800(b(n-1)))), b(1) = 1, b(0) = 0

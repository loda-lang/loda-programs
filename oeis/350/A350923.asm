...
; Formula: a(n) = 12*floor(c(2*n)/9)+2, b(n) = 9*b(n-2)+8*c(n-2)+1, b(6) = 891, b(5) = 90, b(4) = 90, b(3) = 9, b(2) = 9, b(1) = 0, b(0) = 0, c(n) = b(n-2)+c(n-2), c(5) = 10, c(4) = 10, c(3) = 1, c(2) = 1, c(1) = 1, c(0) = 1

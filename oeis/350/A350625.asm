...
; Formula: a(n) = gcd(f(n+1)^3,0), b(n) = (b(n-2)^2-b(n-3)*b(n-1))/(-b(n-4)), b(4) = -7, b(3) = 1, b(2) = 3, b(1) = 2, b(0) = 1, c(n) = b(n-1), c(4) = 1, c(3) = 3, c(2) = 2, c(1) = 1, c(0) = -1, d(n) = -c(n-1), d(4) = -3, d(3) = -2, d(2) = -1, d(1) = 1, d(0) = 1, e(n) = d(n-1), e(4) = -2, e(3) = -1, e(2) = 1, e(1) = 1, e(0) = 1, f(n) = e(n-1), f(4) = -1, f(3) = 1, f(2) = 1, f(1) = 1, f(0) = 0

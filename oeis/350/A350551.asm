...
; Formula: a(n) = 2*a(n-2)+b(n-3)+c(n-3)+a(n-1), a(4) = 10, a(3) = 3, a(2) = 1, a(1) = 0, a(0) = 0, b(n) = 2*b(n-1)+b(n-2), b(4) = 29, b(3) = 12, b(2) = 5, b(1) = 2, b(0) = 1, c(n) = 2*b(n-1)+c(n-1), c(3) = 17, c(2) = 7, c(1) = 3, c(0) = 1

...
; Formula: a(n) = 2*truncate((d(n)*(binomial(-min(n,n%3)+b(n)+c(n)+2,binomial(b(n),-min(n,n%3)+c(n)+1))+binomial(b(n),-min(n,n%3)+c(n)+1)))/3), b(n) = b(n-3)+1, b(8) = 2, b(7) = 2, b(6) = 2, b(5) = 1, b(4) = 1, b(3) = 1, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = c(n-3), c(8) = 0, c(7) = 0, c(6) = 0, c(5) = 0, c(4) = 0, c(3) = 0, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 2*d(n-3), d(8) = 12, d(7) = 12, d(6) = 12, d(5) = 6, d(4) = 6, d(3) = 6, d(2) = 3, d(1) = 3, d(0) = 3

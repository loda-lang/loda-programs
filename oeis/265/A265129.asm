...
; Formula: a(n) = ((2*((3*c(n+1)-3)/3)+2)^2-4)/4+2, b(n) = b(n-1)*(d(n-1)/b(n-1)), b(2) = 6, b(1) = 3, b(0) = 3, c(n) = d(n-1)/b(n-1), c(2) = 2, c(1) = 1, c(0) = 0, d(n) = d(n-1)*(d(n-1)/b(n-1))+b(n-1), d(2) = 15, d(1) = 6, d(0) = 3

...
; Formula: a(n) = A115024(n+4)

add $0,4
seq $0,115024 ; Natural numbers n such that the number of prime factors of n (counted with multiplicity) is equal to the number of decimal digits of n.

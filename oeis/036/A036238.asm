...
; Formula: a(n) = -truncate(((-binomial(floor((sqrtint(8*n)-1)/2)+1,2)+n)*(-binomial(floor((sqrtint(8*n)-1)/2)+1,2)+n+1))/(floor((sqrtint(8*n)-1)/2)+3))*(floor((sqrtint(8*n)-1)/2)+3)+(-binomial(floor((sqrtint(8*n)-1)/2)+1,2)+n)*(-binomial(floor((sqrtint(8*n)-1)/2)+1,2)+n+1)

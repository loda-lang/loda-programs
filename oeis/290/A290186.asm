...
; Formula: a(n) = d(n+1), b(n) = 2*b(n-1)+2*c(n-1)-d(n-1), b(3) = 65, b(2) = 23, b(1) = 8, b(0) = 4, c(n) = b(n-1)+c(n-1), c(3) = 35, c(2) = 12, c(1) = 4, c(0) = 0, d(n) = b(n-2)+c(n-2)+d(n-1), d(3) = 17, d(2) = 5, d(1) = 1, d(0) = 0

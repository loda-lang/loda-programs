...
; Formula: a(n) = b(n+1), b(n) = -b(n-1)-d(n-1)+b(n-2)+b(n-5)+c(n-1)+d(n-2)+d(n-3)+3, b(7) = 8, b(6) = 7, b(5) = 5, b(4) = 3, b(3) = 2, b(2) = 2, b(1) = 2, b(0) = 0, c(n) = b(n-1), c(5) = 3, c(4) = 2, c(3) = 2, c(2) = 2, c(1) = 0, c(0) = 1, d(n) = 2*b(n-1)-c(n-1)+d(n-1), d(5) = 11, d(4) = 7, d(3) = 5, d(2) = 3, d(1) = -1, d(0) = 0

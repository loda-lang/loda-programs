...
; Formula: a(n) = 2*f(n+4), b(n) = -b(n-1)-c(n-1)-d(n-1), b(4) = -3, b(3) = -1, b(2) = 0, b(1) = -2, b(0) = 1, c(n) = c(n-2)+d(n-2), c(4) = 1, c(3) = 2, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = 2*c(n-1)+b(n-1)+d(n-1), d(4) = 5, d(3) = 2, d(2) = 0, d(1) = 2, d(0) = 1, e(n) = c(n-1)+d(n-1), e(4) = 4, e(3) = 1, e(2) = 2, e(1) = 1, e(0) = 0, f(n) = e(n-1), f(4) = 1, f(3) = 2, f(2) = 1, f(1) = 0, f(0) = 0

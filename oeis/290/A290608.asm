...
; Formula: a(n) = 2*e(n+4), b(n) = d(n-1), b(4) = 1, b(3) = 2, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = 2*d(n-2)-c(n-2)+d(n-1), c(7) = 16, c(6) = 9, c(5) = 4, c(4) = 5, c(3) = 2, c(2) = 0, c(1) = 2, c(0) = 1, d(n) = b(n-1)+c(n-1), d(4) = 4, d(3) = 1, d(2) = 2, d(1) = 1, d(0) = 0, e(n) = d(n-1), e(4) = 1, e(3) = 2, e(2) = 1, e(1) = 0, e(0) = 0

...
; Formula: a(n) = f(n)+1, b(n) = b(n-1)+b(n-2), b(5) = 10, b(4) = 6, b(3) = 4, b(2) = 2, b(1) = 2, b(0) = 0, c(n) = c(n-1)+d(n-2)+d(n-3)+2, c(6) = 26, c(5) = 18, c(4) = 12, c(3) = 8, c(2) = 4, c(1) = 1, c(0) = 1, d(n) = d(n-1)+d(n-2), d(6) = 10, d(5) = 6, d(4) = 4, d(3) = 2, d(2) = 2, d(1) = 0, d(0) = 2, e(n) = b(n-1)+2, e(5) = 8, e(4) = 6, e(3) = 4, e(2) = 4, e(1) = 3, e(0) = 0, f(n) = c(n-1)+e(n-1), f(5) = 18, f(4) = 12, f(3) = 8, f(2) = 4, f(1) = 1, f(0) = 0

...
; Formula: a(n) = truncate((c(n+1)+d(n+1))/gcd(n+1,c(n+1)+d(n+1))), b(n) = b(n-1)*(-3*n+2), b(3) = -56, b(2) = 8, b(1) = -2, b(0) = 2, c(n) = c(n-1)*(-3*n+6)+b(n-1), c(3) = 14, c(2) = -2, c(1) = 2, c(0) = 0, d(n) = d(n-1), d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0

...
; Formula: a(n) = c(n)+2, b(n) = b(n-1)/19+b(n-4)/19+2*(b(n-3)/19)+b(n-2)+b(n-3)+1, b(4) = 2, b(3) = 1, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = b(n-2)/19+b(n-1)+d(n-1), c(4) = 3, c(3) = 2, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = b(n-3)/19+2*(b(n-2)/19)+b(n-1)+b(n-2)+1, d(4) = 3, d(3) = 2, d(2) = 1, d(1) = 1, d(0) = 0

; A290259: Triangle read by rows: row n (>=1) contains in increasing order the integers for which the binary representation has length n, the first run of 1s has odd length, and all the other runs of 1s have even length.

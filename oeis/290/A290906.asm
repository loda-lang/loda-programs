...
; Formula: a(n) = 3*b(n-1)+3*c(n-1)+3*d(n-1)+a(n-1), a(3) = 39, a(2) = 12, a(1) = 3, a(0) = 0, b(n) = b(n-1)+a(n-1), b(3) = 16, b(2) = 4, b(1) = 1, b(0) = 1, c(n) = b(n-1)+c(n-1), c(3) = 6, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = b(n-1)+c(n-1)+d(n-1), d(3) = 9, d(2) = 3, d(1) = 1, d(0) = 0

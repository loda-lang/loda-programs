...
; Formula: a(n) = min(n,n%2)*c(n)+b(n), b(n) = -d(n-2)*b(n-2)+c(n-2), b(5) = -2, b(4) = -2, b(3) = 1, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = b(n-2)*(-d(n-2)-1)+c(n-2)*(-d(n-2)-1), c(5) = 0, c(4) = 0, c(3) = -1, c(2) = -1, c(1) = 1, c(0) = 1, d(n) = d(n-2)+1, d(5) = 2, d(4) = 2, d(3) = 1, d(2) = 1, d(1) = 0, d(0) = 0

...
; Formula: a(n) = d(n+2)/6, b(n) = 4*b(n-1)-2*e(n-1)-2, b(3) = -114, b(2) = -16, b(1) = -2, b(0) = 0, c(n) = 5*c(n-1)+15, c(3) = 465, c(2) = 90, c(1) = 15, c(0) = 0, d(n) = 3*d(n-1)-3*b(n-1), d(3) = 66, d(2) = 6, d(1) = 0, d(0) = 0, e(n) = 2*e(n-1)+c(n-1)+3, e(3) = 141, e(2) = 24, e(1) = 3, e(0) = 0

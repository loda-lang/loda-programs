...
; Formula: a(n) = 2*c(max(n-2,0)), b(n) = 2*b(n-1)+2*b(n-2), b(5) = 120, b(4) = 44, b(3) = 16, b(2) = 6, b(1) = 2, b(0) = 1, c(n) = 2*c(n-1)+2*d(n-1), c(5) = 544, c(4) = 140, c(3) = 32, c(2) = 6, c(1) = 0, c(0) = 0, d(n) = 2*max(-c(n-2)+d(n-1),1)+2*max(-c(n-3)+d(n-2),1)+b(n-1)+c(n-1), d(6) = 1480, d(5) = 448, d(4) = 132, d(3) = 38, d(2) = 10, d(1) = 3, d(0) = 0

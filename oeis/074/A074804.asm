...
; Formula: a(n) = d(n)+1, b(n) = (-c(n-1)+b(n-1))/2, b(2) = -18, b(1) = -4, b(0) = -1, c(n) = 2*gcd((-c(n-1)+b(n-1))/2+d(n-1),2)*c(n-1), c(2) = 128, c(1) = 32, c(0) = 8, d(n) = gcd((-c(n-1)+b(n-1))/2+d(n-1),2), d(2) = 2, d(1) = 2, d(0) = 2

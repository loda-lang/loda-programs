...
; Formula: a(n) = d(n+1), b(n) = -b(n-1)-e(n-1)+c(n-1)+c(n-2)-2, b(5) = 12, b(4) = 8, b(3) = 3, b(2) = -3, b(1) = -2, b(0) = 0, c(n) = d(n-1)/(b(n-1)+e(n-1)+3)-((-b(n-4)-e(n-4)+e(n-3)-3)/(b(n-3)+e(n-3)+3))-c(n-4)-c(n-5)+b(n-1)+b(n-4)+c(n-2)+e(n-1)+e(n-2)+e(n-4)+2, c(8) = 340, c(7) = 184, c(6) = 99, c(5) = 53, c(4) = 28, c(3) = 14, c(2) = 7, c(1) = 3, c(0) = 0, d(n) = d(n-1)/(b(n-1)+e(n-1)+3)+b(n-1)+3, d(5) = 11, d(4) = 6, d(3) = 0, d(2) = 1, d(1) = 3, d(0) = 0, e(n) = d(n-1)/(b(n-1)+e(n-1)+3)+2*b(n-1)+e(n-1)+6, e(5) = 42, e(4) = 20, e(3) = 8, e(2) = 8, e(1) = 6, e(0) = 0

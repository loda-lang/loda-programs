...
; Formula: a(n) = b(n-1)+b(n-2)+c(n-1)+c(n-2)+2, a(3) = 3, a(2) = 1, a(1) = 1, a(0) = 1, b(n) = A004086(b(n-2)+b(n-3)+c(n-2)+c(n-3)+2), b(3) = 1, b(2) = 1, b(1) = 1, b(0) = -1, c(n) = b(n-1)+c(n-1), c(3) = 1, c(2) = 0, c(1) = -1, c(0) = 0

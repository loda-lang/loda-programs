...
; Formula: a(n) = d(n+1)+1, b(n) = truncate(truncate(n^n)/b(n-1))*b(n-1)+b(n-1), b(3) = 30, b(2) = 5, b(1) = 1, b(0) = 1, c(n) = n+1, c(3) = 4, c(2) = 3, c(1) = 2, c(0) = 0, d(n) = truncate(truncate(c(n-1)^n)/b(n-1)), d(3) = 5, d(2) = 4, d(1) = 0, d(0) = 0

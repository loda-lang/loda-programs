...
; Formula: a(n) = c(max(n-2,0)), b(n) = b(n-1)+b(n-2), b(5) = 8, b(4) = 5, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = c(n-1)+e(n-1), c(5) = 37, c(4) = 16, c(3) = 6, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = b(n-1), d(5) = 5, d(4) = 3, d(3) = 2, d(2) = 1, d(1) = 1, d(0) = 0, e(n) = 2*b(n-3)+c(n-3)+d(n-3)+e(n-2)+e(n-3)+max(-c(n-3)-e(n-3)+e(n-1),1)+max(-c(n-3)+e(n-2),1), e(5) = 44, e(4) = 21, e(3) = 10, e(2) = 4, e(1) = 2, e(0) = 0

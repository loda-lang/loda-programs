...
; Formula: a(n) = 4*truncate((c(n+1)+d(n+1))/gcd(c(n+1),b(n+1))), b(n) = b(n-1)*(4*n-1), b(3) = 462, b(2) = 42, b(1) = 6, b(0) = 2, c(n) = c(n-1)*(4*n-1)+b(n-1), c(3) = 262, c(2) = 20, c(1) = 2, c(0) = 0, d(n) = d(n-1), d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0

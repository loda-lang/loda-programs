...
; Formula: a(n) = 3*truncate((c(n)+d(n))/gcd(c(n),b(n))), b(n) = b(n-1)*(3*n-1), b(3) = 160, b(2) = 20, b(1) = 4, b(0) = 2, c(n) = c(n-1)*(3*n-1)+b(n-1), c(3) = 132, c(2) = 14, c(1) = 2, c(0) = 0, d(n) = d(n-1), d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0

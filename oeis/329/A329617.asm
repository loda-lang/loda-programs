...
; 1,1,1,2,1,2,1,3,2,2,1,3,1,2,2,4,1,6,1,3,2,2,1,4,2,2,3,3,1,6,1,5,2,2,2,8,1,2,2,4,1,6,1,3,3,2,1,5,2,6,2,3,1,12,2,4,2,2,1,8,1,2,3,6,2,6,1,3,2,6,1,10,1,2,6,3,2,6,1,5
; Formula: a(n) = A121663(truncate(A334032(n-1)/2))

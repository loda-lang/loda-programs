...
; Formula: a(n) = truncate(truncate((c(n+1)+d(n+1))/gcd(n+1,c(n+1)+d(n+1)))/2), b(n) = 9*b(n-1), b(2) = 162, b(1) = 18, b(0) = 2, c(n) = c(n-1), c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 15*d(n-1)+b(n-1), d(2) = 48, d(1) = 2, d(0) = 0

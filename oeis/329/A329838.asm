...
; Formula: a(n) = truncate(truncate((b(max(4*n-3,0))*(max(4*n-3,0)+3))/2)/c(max(4*n-3,0))), b(n) = 11*c(n-1)+b(n-1)+d(n-1), b(3) = 1476, b(2) = 133, b(1) = 11, b(0) = 0, c(n) = 11*c(n-1), c(3) = 1331, c(2) = 121, c(1) = 11, c(0) = 1, d(n) = c(n-1)+d(n-1), d(3) = 133, d(2) = 12, d(1) = 1, d(0) = 0

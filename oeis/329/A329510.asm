...
; Formula: a(n) = 2*(a(n-1)/2)-(a(n-1)/2)-c(n-1)+b(n-1)+3, a(2) = 6, a(1) = 3, a(0) = 1, b(n) = binomial(a(n-1)/2+b(n-1)+1,11), b(2) = 0, b(1) = 0, b(0) = 0, c(n) = (2*(a(n-1)/2)+b(n-1)+c(n-1))/3-2, c(2) = -2, c(1) = -2, c(0) = 0

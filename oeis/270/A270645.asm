...
; Formula: a(n) = d(n+2), b(n) = (-c(n-1)+b(n-1))/2, b(2) = -18, b(1) = -5, b(0) = 5, c(n) = c(n-1)*(((-c(n-1)+b(n-1))/2+d(n-1))%2+2), c(2) = 64, c(1) = 32, c(0) = 16, d(n) = ((-c(n-1)+b(n-1))/2+d(n-1))%2+2, d(2) = 2, d(1) = 2, d(0) = -1

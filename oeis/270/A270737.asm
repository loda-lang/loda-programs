...
; Formula: a(n) = b(n)+1, b(n) = b(n-1)+b(n-2)+c(n-2)+d(n-2)+2, b(5) = 41, b(4) = 19, b(3) = 9, b(2) = 4, b(1) = 2, b(0) = 0, c(n) = 2*d(n-2)+c(n-1)+d(n-1)+d(n-3), c(5) = 41, c(4) = 18, c(3) = 6, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = b(n-1)+1, d(5) = 20, d(4) = 10, d(3) = 5, d(2) = 3, d(1) = 1, d(0) = 0

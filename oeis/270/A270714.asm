...
; Formula: a(n) = ((5*b(4*n+1))/(c(4*n+1)/(10^n)))%10, b(n) = 4*c(n-1)+2*b(n-1)+2*d(n-1), b(2) = 30, b(1) = 6, b(0) = 1, c(n) = 3*c(n-1)+b(n-1)+d(n-1), c(2) = 19, c(1) = 4, c(0) = 1, d(n) = c(n-1)+d(n-1), d(2) = 5, d(1) = 1, d(0) = 0

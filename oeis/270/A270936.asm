...
lpb $0
  ...
  lpb $4
    ...
    mov $7,$4
    trn $7,1
    seq $7,270934 ; Number of active (ON, black) cells in n-th stage of growth of two-dimensional cellular automaton defined by "Rule 221", based on the 5-celled von Neumann neighborhood.
    mov $9,10
    min $10,$0
    mul $7,$$9
    gcd $4,$10

...
; Formula: a(n) = b(n+3), b(n) = d(n-1), b(6) = 46, b(5) = 19, b(4) = 6, b(3) = 1, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = c(n-1)+e(n-1)+n-1, c(6) = 21, c(5) = 14, c(4) = 8, c(3) = 4, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = c(n-1)+d(n-1)+e(n-1)+f(n-1)+n-1, d(6) = 94, d(5) = 46, d(4) = 19, d(3) = 6, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = -e(n-1)+n-1, e(6) = 3, e(5) = 2, e(4) = 2, e(3) = 1, e(2) = 1, e(1) = 0, e(0) = 0, f(n) = c(n-1)+e(n-1)+f(n-1)+n-1, f(6) = 48, f(5) = 27, f(4) = 13, f(3) = 5, f(2) = 1, f(1) = 0, f(0) = 0

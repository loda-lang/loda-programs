...
; 0,1,2,3,4,2,3,4,5,4,5,6,6,7,8,3,4,5,6,5,6,7,7,8,9,6,7,8,8,9,10,9,10,11,12,4,5,6,7,6,7,8,8,9,10,7,8,9,9,10,11,10,11,12,13,8,9,10,10,11,12,11,12,13,14,12,13,14,15,16,5,6,7,8,7,8,9,9,10,11
; Formula: a(n) = truncate((A161511(truncate(A145850(A031443(n+50)+1)/16)-262144)-10)/2)

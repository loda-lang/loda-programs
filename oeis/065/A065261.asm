...
; Formula: a(n) = if(((if((n-1)==0,0,if((bitand(n-1,2)^2)<=1,n-1,(n-1)/(bitand(n-1,2)^valuation(n-1,bitand(n-1,2)))))+1)%2)==0,(if((n-1)==0,0,if((bitand(n-1,2)^2)<=1,n-1,(n-1)/(bitand(n-1,2)^valuation(n-1,bitand(n-1,2)))))+1)/2,if((n-1)==0,0,if((bitand(n-1,2)^2)<=1,n-1,(n-1)/(bitand(n-1,2)^valuation(n-1,bitand(n-1,2)))))+1)

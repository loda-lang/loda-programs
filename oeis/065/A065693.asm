...
; Formula: a(n) = truncate(c(n)/2)+1, b(n) = 5*b(n-1)+2*d(n-1)-13*b(n-2)-2, b(4) = 348, b(3) = 60, b(2) = 6, b(1) = 0, b(0) = 0, c(n) = 9*b(n-1), c(3) = 54, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 4*d(n-1), d(3) = 64, d(2) = 16, d(1) = 4, d(0) = 1

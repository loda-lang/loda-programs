...
; Formula: a(n) = floor((A000040(-binomial(floor((sqrtint(8*floor((sqrtint(8*n-15)+1)/2)+8*n-8)+1)/2),2)+floor((sqrtint(8*n-15)+1)/2)+n)+A005145(floor((sqrtint(8*n-15)+1)/2)+n))/2)

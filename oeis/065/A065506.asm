...
; Formula: a(n) = d(n+2), b(n) = b(n-1)+c(n-1), b(4) = 1, b(3) = 3, b(2) = 0, b(1) = 1, b(0) = 0, c(n) = 3*b(n-3)+3*c(n-3)+2*c(n-2)-c(n-1), c(4) = 8, c(3) = -2, c(2) = 3, c(1) = -1, c(0) = 1, d(n) = 2*d(n-1)+b(n-2)+c(n-2), d(4) = 7, d(3) = 2, d(2) = 1, d(1) = 0, d(0) = 0

...
; Formula: a(n) = 18*n-2*truncate((18*n-2*truncate((18*n+truncate((2*truncate((450*n-4)/7)-1)/5)+2)/3)+truncate((2*truncate((450*n-4)/7)-1)/5)+2)/3)-2*truncate((18*n+truncate((2*truncate((450*n-4)/7)-1)/5)+2)/3)+truncate((2*truncate((450*n-4)/7)-1)/5)+1

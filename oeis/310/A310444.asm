...
; Formula: a(n) = (n+1)/3+A313057(n)

mov $1,$0
add $1,1
div $1,3
seq $0,313057 ; Coordination sequence Gal.6.132.3 where G.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.
add $0,$1

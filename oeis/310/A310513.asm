...
; Formula: a(n) = ((21*n-1)%A313825(3*n)-n)+1

mov $1,$0
mul $1,3
seq $1,313825 ; Coordination sequence Gal.6.322.5 where G.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.
add $2,$0
mul $0,21
sub $0,1
mod $0,$1

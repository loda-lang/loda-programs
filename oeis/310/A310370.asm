...
; Formula: a(n) = max(36*floor(n/8)+32*((sign(n)*((n-1)%8+1))==7)+26*((sign(n)*((n-1)%8+1))==6)+22*((sign(n)*((n-1)%8+1))==5)+18*((sign(n)*((n-1)%8+1))==4)+14*((sign(n)*((n-1)%8+1))==3)+10*((sign(n)*((n-1)%8+1))==2)+4*((sign(n)*((n-1)%8+1))==1),1)

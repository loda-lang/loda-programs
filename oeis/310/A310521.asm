...
; Formula: a(n) = -truncate((7*n-1)/(max(2*truncate((7*n-3*truncate(floor((4*n+4)/3)/3)+floor((4*n+4)/3))/3)-1,0)+1))*(max(2*truncate((7*n-3*truncate(floor((4*n+4)/3)/3)+floor((4*n+4)/3))/3)-1,0)+1)+10*n

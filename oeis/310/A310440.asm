...
; Formula: a(n) = -truncate((7*n-1)/(2*n-truncate((gcd(binomial(n,2),2)+n)/2)+gcd(binomial(n,2),2)+truncate((12*n-2)/3)))*(2*n-truncate((gcd(binomial(n,2),2)+n)/2)+gcd(binomial(n,2),2)+truncate((12*n-2)/3))+10*n+floor((n+1)/3)

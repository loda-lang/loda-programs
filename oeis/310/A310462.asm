...
; Formula: a(n) = -A315256(n)*truncate((7*n-1)/A315256(n))+10*n

mov $1,$0
seq $1,315256 ; Coordination sequence Gal.5.111.4 where Gal.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.
mov $2,$0
mul $2,3
mul $0,7
sub $0,1

...
; Formula: a(n) = (d(n+1)*c(n+1)-8)/8+1, b(n) = b(n-1)*(c(n-1)+1)*(2*c(n-1)+c(n-1)+2), b(2) = 96, b(1) = 4, b(0) = 2, c(n) = 2*c(n-1)+c(n-1)+2, c(2) = 8, c(1) = 2, c(0) = 0, d(n) = b(n-1)*(2*c(n-1)+c(n-1)+2), d(2) = 32, d(1) = 4, d(0) = 0

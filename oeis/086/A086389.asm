...
; 1,1,2,3,2,3,3,4,3,4,2,6,4,3,4,6,2,6,4,6,4,4,3,8,5,4,4,8,2,7,4,6,6,5,4,9,4,4,4,10,2,8,6,6,6,4,3,11,5,6,4,8,4,8,6,8,4,6,2,12,6,3,8,9,4,8,4,8,4,9,2,12,6,4,8,8,4,8,5,10
; Formula: a(n) = truncate((A054844(n+3)-2)/2)+A000005(n+1)-1

...
; Formula: a(n) = e(n+1), b(n) = truncate((-c(n-1)+b(n-1)+1)/2), b(3) = -19, b(2) = -7, b(1) = 0, b(0) = 0, c(n) = 2*gcd(d(n-1)+truncate((-c(n-1)+b(n-1)+1)/2),4)*c(n-1), c(3) = 64, c(2) = 32, c(1) = 16, c(0) = 2, d(n) = truncate(gcd(d(n-1)+truncate((-c(n-1)+b(n-1)+1)/2),4)/2), d(3) = 0, d(2) = 0, d(1) = 2, d(0) = 0, e(n) = d(n-1)+e(n-1)+2, e(3) = 7, e(2) = 5, e(1) = 1, e(0) = -1

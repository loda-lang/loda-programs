...
; Formula: a(n) = d(n-1)+a(n-1)+2, a(3) = 9, a(2) = 7, a(1) = 5, a(0) = 1, b(n) = (-c(n-1)+b(n-1)+1)/2, b(3) = -41, b(2) = -19, b(1) = -7, b(0) = 0, c(n) = 2*gcd((-c(n-1)+b(n-1)+1)/2+d(n-1),4)*c(n-1), c(3) = 128, c(2) = 64, c(1) = 32, c(0) = 16, d(n) = gcd((-c(n-1)+b(n-1)+1)/2+d(n-1),4)/2, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 2

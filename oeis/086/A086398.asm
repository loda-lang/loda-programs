...
; Formula: a(n) = e(n)-1, b(n) = (-c(n-1)+b(n-1)+1)/2, b(3) = -41, b(2) = -19, b(1) = -7, b(0) = 0, c(n) = 2*gcd((-c(n-1)+b(n-1)+1)/2+d(n-1),4)*c(n-1), c(3) = 128, c(2) = 64, c(1) = 32, c(0) = 16, d(n) = gcd((-c(n-1)+b(n-1)+1)/2+d(n-1),4)/2, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 2, e(n) = d(n-1)+e(n-1)+2, e(3) = 10, e(2) = 8, e(1) = 6, e(0) = 2

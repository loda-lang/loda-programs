...
; Formula: a(n) = e(n+1)/2, b(n) = (-c(n-1)+b(n-1)-5)/4, b(3) = 117, b(2) = 26, b(1) = 0, b(0) = 0, c(n) = c(n-1)*gcd((-c(n-1)+b(n-1)-5)/4+d(n-1),4)^2, c(3) = -448, c(2) = -448, c(1) = -112, c(0) = -7, d(n) = 2*(gcd((-c(n-1)+b(n-1)-5)/4+d(n-1),4)/2), d(3) = 0, d(2) = 2, d(1) = 4, d(0) = 0, e(n) = d(n-1)+e(n-1)+2, e(3) = 12, e(2) = 8, e(1) = 2, e(0) = 0

...
; Formula: a(n) = ((d(4*n)+1)/(c(4*n)/(10^n)))%10, b(n) = b(n-1)+c(n-1)+d(n-1), b(3) = 30, b(2) = 6, b(1) = 1, b(0) = 0, c(n) = 2*c(n-1)+b(n-1)+c(n-1)+d(n-1)+e(n-1), c(3) = 60, c(2) = 13, c(1) = 3, c(0) = 1, d(n) = 2*c(n-1)+2*d(n-1)+b(n-1), d(3) = 54, d(2) = 11, d(1) = 2, d(0) = 0, e(n) = c(n-1)+e(n-1), e(3) = 17, e(2) = 4, e(1) = 1, e(0) = 0

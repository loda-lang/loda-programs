...
; Formula: a(n) = truncate((d(n)*c(n))/16), b(n) = b(n-1)*(c(n-1)+1)*(5*c(n-1)+4), b(2) = 480, b(1) = 4, b(0) = 1, c(n) = 5*c(n-1)+4, c(2) = 24, c(1) = 4, c(0) = 0, d(n) = b(n-1)*(5*c(n-1)+4), d(2) = 96, d(1) = 4, d(0) = 0

...
; 1,2,2,3,2,4,3,3,3,6,2,4,4,5,4,5,2,7,4,4,4,8,3,4,5,6,4,8,2,8,4,3,6,9,4,5,4,8,4,8,2,8,6,4,6,10,3,6,5,7,4,8,4,10,6,4,4,12,2,6,6,7,8,7,4,8,4,8,4,14,2,5,6,6,8,8,4,12,5,4
; Formula: a(n) = truncate((A054844(n+1)-2)/2)+A000005(n+3)-1

...
; Formula: a(n) = b(n+1), b(n) = 2*b(n-4)-b(n-1)+b(n-3)+d(n-4)+max(b(n-2)-1,0)+1, b(5) = 1, b(4) = 1, b(3) = 0, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = b(n-1), c(5) = 1, c(4) = 0, c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 2*b(n-1)-c(n-1)+d(n-1), d(5) = 3, d(4) = 1, d(3) = 2, d(2) = 0, d(1) = 0, d(0) = 0

...
; Formula: a(n) = 8*e(max(n-2,0)), b(n) = 3*n+b(n-1)-2, b(5) = 35, b(4) = 22, b(3) = 12, b(2) = 5, b(1) = 1, b(0) = 0, c(n) = -d(n-1)+max(c(n-1),3*n-3), c(5) = -33, c(4) = -15, c(3) = -3, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = 3*n+2*b(n-1)-d(n-1)+max(d(n-1)+n-1,1)+max(c(n-1),3*n-3)-3, d(5) = 72, d(4) = 45, d(3) = 24, d(2) = 9, d(1) = 1, d(0) = 0, e(n) = 3*n+b(n-1)+max(d(n-1)+n-1,1)-3, e(5) = 83, e(4) = 48, e(3) = 22, e(2) = 6, e(1) = 1, e(0) = 0

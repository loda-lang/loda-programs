...
; Formula: a(n) = truncate(c(n)/2), b(n) = truncate((4*b(n-1)*(2*n-1))/n)*(2*n-1), b(3) = 2400, b(2) = 72, b(1) = 4, b(0) = 1, c(n) = truncate((4*b(n-1)*(2*n-1))/n)*(2*n-1)-c(n-1), c(3) = 2330, c(2) = 70, c(1) = 2, c(0) = 2

...
; Formula: a(n) = c(n+1), b(n) = 2*n+b(n-1)+2, b(5) = 40, b(4) = 28, b(3) = 18, b(2) = 10, b(1) = 4, b(0) = 0, c(n) = truncate((2*truncate((2*n+b(n-2)+1)/2)+max(2*truncate((2*n+b(n-3)-1)/2)-4,0))/(2*n))*(c(n-1)+1), c(6) = 205, c(5) = 40, c(4) = 9, c(3) = 2, c(2) = 1, c(1) = 0, c(0) = 0

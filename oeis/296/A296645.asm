...
; Formula: a(n) = truncate(c(n+2)/2), b(n) = 4*b(n-3)+2*c(n-1), b(6) = 132, b(5) = 64, b(4) = 16, b(3) = 4, b(2) = 4, b(1) = 0, b(0) = 0, c(n) = 2*c(n-2)+b(n-2)+d(n-1)+d(n-2)+e(n-2)+2, c(6) = 170, c(5) = 58, c(4) = 24, c(3) = 8, c(2) = 2, c(1) = 2, c(0) = 0, d(n) = b(n-1)+c(n-1)+d(n-1)+e(n-1), d(6) = 218, d(5) = 72, d(4) = 24, d(3) = 10, d(2) = 2, d(1) = 0, d(0) = 0, e(n) = c(n-1), e(6) = 58, e(5) = 24, e(4) = 8, e(3) = 2, e(2) = 2, e(1) = 0, e(0) = 0

...
; Formula: a(n) = (d(n+3)-6)/2+3, b(n) = 8*b(n-3)+8*c(n-3)+4*c(n-3)+4*d(n-3)+4*e(n-3)+4*f(n-3)+2*b(n-2)+2*b(n-3)+2*d(n-3)-2*b(n-2)-2*b(n-3)-4*c(n-3)-8*c(n-3)+4, b(6) = 132, b(5) = 64, b(4) = 16, b(3) = 4, b(2) = 4, b(1) = 0, b(0) = 0, c(n) = -c(n-1)+b(n-1)+c(n-1), c(6) = 64, c(5) = 16, c(4) = 4, c(3) = 4, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 2*b(n-2)+2*c(n-2)+2*d(n-2)+2*e(n-2)+2*f(n-2)-2*c(n-2)+d(n-2)+2, d(6) = 170, d(5) = 58, d(4) = 24, d(3) = 8, d(2) = 2, d(1) = 2, d(0) = 0, e(n) = -c(n-1)+b(n-1)+c(n-1)+d(n-1)+e(n-1)+f(n-1), e(6) = 218, e(5) = 72, e(4) = 24, e(3) = 10, e(2) = 2, e(1) = 0, e(0) = 0, f(n) = d(n-1), f(6) = 58, f(5) = 24, f(4) = 8, f(3) = 2, f(2) = 2, f(1) = 0, f(0) = 0

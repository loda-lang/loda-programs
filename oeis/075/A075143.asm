...
; Formula: a(n) = truncate((c(n)+d(n))/gcd(c(n),b(n))), b(n) = b(n-1)*(5*n-1), b(3) = 1008, b(2) = 72, b(1) = 8, b(0) = 2, c(n) = c(n-1)*(5*n-1)+b(n-1), c(3) = 436, c(2) = 26, c(1) = 2, c(0) = 0, d(n) = d(n-1), d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0

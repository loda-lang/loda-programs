...
; Formula: a(n) = b(n)+4, b(n) = b(n-1)+c(n-1)+1, b(3) = 19, b(2) = 5, b(1) = 1, b(0) = 0, c(n) = 5*d(n-3)+2*d(n-1)-d(n-4)-3*d(n-2)+c(n-1), c(6) = 1218, c(5) = 416, c(4) = 140, c(3) = 45, c(2) = 13, c(1) = 3, c(0) = 0, d(n) = 6*d(n-3)+5*d(n-1)-d(n-4)-8*d(n-2), d(6) = 1538, d(5) = 526, d(4) = 181, d(3) = 63, d(2) = 22, d(1) = 7, d(0) = 0

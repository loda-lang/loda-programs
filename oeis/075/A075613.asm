...
; Formula: a(n) = binomial(-binomial(floor((sqrtint(8*floor((n-1)/2)+16)-1)/2)+1,2)+floor((sqrtint(8*floor((n-1)/2)+16)-1)/2)+floor((n-1)/2)+1,2*floor((n-1)/2)-2*binomial(floor((sqrtint(8*floor((n-1)/2)+16)-1)/2)+1,2)+2)*if(truncate((2*floor((n-1)/2)-2*binomial(floor((sqrtint(8*floor((n-1)/2)+16)-1)/2)+1,2)+2)/2)<=(-1),0,(-4)^truncate((2*floor((n-1)/2)-2*binomial(floor((sqrtint(8*floor((n-1)/2)+16)-1)/2)+1,2)+2)/2))

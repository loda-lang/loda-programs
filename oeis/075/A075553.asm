...
; Formula: a(n) = b(n+1), b(n) = d(n-1), b(4) = 1, b(3) = -1, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = -e(n-1)+c(n-1)+d(n-1), c(4) = 0, c(3) = 0, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = -d(n-1)-e(n-2)+c(n-2), d(4) = 0, d(3) = 1, d(2) = -1, d(1) = 1, d(0) = 0, e(n) = c(n-1), e(4) = 0, e(3) = 1, e(2) = 0, e(1) = 0, e(0) = 0

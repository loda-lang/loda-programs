...
; Formula: a(n) = truncate((c(n)+d(n))/gcd(c(n),b(n))), b(n) = b(n-1)*(5*n-2), b(3) = 624, b(2) = 48, b(1) = 6, b(0) = 2, c(n) = c(n-1)*(5*n-2)+b(n-1), c(3) = 334, c(2) = 22, c(1) = 2, c(0) = 0, d(n) = d(n-1), d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0

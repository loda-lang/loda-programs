...
; Formula: a(n) = b(n-1), a(5) = 6, a(4) = 3, a(3) = 1, a(2) = 1, a(1) = 1, a(0) = 0, b(n) = 2*a(n-2)+b(n-1)+c(n-2), b(5) = 10, b(4) = 6, b(3) = 3, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = b(n-2)+a(n-2), c(5) = 4, c(4) = 2, c(3) = 2, c(2) = 1, c(1) = 0, c(0) = 0

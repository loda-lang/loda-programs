...
; Formula: a(n) = truncate((c(n)+d(n))/gcd(c(n),b(n))), b(n) = b(n-1)*(3*n-2), b(3) = 56, b(2) = 8, b(1) = 2, b(0) = 2, c(n) = c(n-1)*(3*n-2)+b(n-1), c(3) = 78, c(2) = 10, c(1) = 2, c(0) = 0, d(n) = d(n-1), d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0

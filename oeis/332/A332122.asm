...
; Formula: a(n) = ((d(4*n)+1)/(c(4*n)/(10^n)))%10, b(n) = 8*c(n-1)+8*d(n-1)+4*b(n-1), b(2) = 120, b(1) = 8, b(0) = 0, c(n) = 4*c(n-1)+4*d(n-1)+2*b(n-1)+2*c(n-1)+2*d(n-1)+b(n-1)+c(n-1), c(2) = 97, c(1) = 7, c(0) = 1, d(n) = 4*c(n-1)+4*d(n-1), d(2) = 44, d(1) = 4, d(0) = 0

...
; Formula: a(n) = A181819(A181811(truncate((A057335(A323243(n))-1)/A293810(A057335(A323243(n))))+1)*(truncate((A057335(A323243(n))-1)/A293810(A057335(A323243(n))))+1)), a(1) = 1, a(0) = 0

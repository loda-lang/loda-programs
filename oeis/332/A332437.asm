...
; Formula: a(n) = ((b(3*n)+d(3*n))/(c(3*n)/(10^n)))%10, b(n) = 2*c(n-1)+b(n-1)+d(n-1), b(2) = 23, b(1) = 3, b(0) = 1, c(n) = 6*c(n-1)+3*d(n-1)+2*b(n-1), c(2) = 66, c(1) = 8, c(0) = 1, d(n) = 3*c(n-1)+2*d(n-1)+b(n-1), d(2) = 35, d(1) = 4, d(0) = 0

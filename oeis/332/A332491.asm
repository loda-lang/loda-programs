...
; Formula: a(n) = b(n-1)+d(n-1), a(3) = 7, a(2) = 2, a(1) = 1, a(0) = 3, b(n) = b(n-1)+d(n-1), b(3) = 7, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = b(n-1)+b(n-2)+c(n-1)+d(n-2), c(3) = 10, c(2) = 6, c(1) = 4, c(0) = 1, d(n) = b(n-1)+c(n-1), d(3) = 8, d(2) = 5, d(1) = 1, d(0) = 1

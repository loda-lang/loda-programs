...
; Formula: a(n) = ((sign(n)*((n-1)%12+1))==0)+66*floor(n/12)+60*((sign(n)*((n-1)%12+1))==11)+55*((sign(n)*((n-1)%12+1))==10)+49*((sign(n)*((n-1)%12+1))==9)+45*((sign(n)*((n-1)%12+1))==8)+39*((sign(n)*((n-1)%12+1))==7)+33*((sign(n)*((n-1)%12+1))==6)+27*((sign(n)*((n-1)%12+1))==5)+21*((sign(n)*((n-1)%12+1))==4)+17*((sign(n)*((n-1)%12+1))==3)+11*((sign(n)*((n-1)%12+1))==2)+6*((sign(n)*((n-1)%12+1))==1)

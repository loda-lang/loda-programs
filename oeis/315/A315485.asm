...
; Formula: a(n) = 0^n+A313262(n+6)-31

pow $1,$0
add $0,6
seq $0,313262 ; Coordination sequence Gal.6.205.1 where G.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.
sub $0,31
add $0,$1

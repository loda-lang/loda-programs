...
sub $1,2
add $0,6
seq $0,313546 ; Coordination sequence Gal.6.156.3 where G.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.
sub $0,27
add $0,$1

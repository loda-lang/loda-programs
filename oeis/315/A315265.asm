...
; Formula: a(n) = (12*n-1)%((14*n-1)%A315690(2*n)+6*n+1)+2*n+1

mul $0,2
mov $3,$0
seq $3,315690 ; Coordination sequence Gal.5.135.4 where G.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.
mov $4,$0
mul $4,3
mov $1,$0
mul $1,7

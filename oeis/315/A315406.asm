...
; Formula: a(n) = max(56*floor(n/11)+50*((sign(n)*((n-1)%11+1))==10)+45*((sign(n)*((n-1)%11+1))==9)+41*((sign(n)*((n-1)%11+1))==8)+37*((sign(n)*((n-1)%11+1))==7)+31*((sign(n)*((n-1)%11+1))==6)+25*((sign(n)*((n-1)%11+1))==5)+19*((sign(n)*((n-1)%11+1))==4)+15*((sign(n)*((n-1)%11+1))==3)+11*((sign(n)*((n-1)%11+1))==2)+6*((sign(n)*((n-1)%11+1))==1)-1,0)+1

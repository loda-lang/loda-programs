...
; Formula: a(n) = A313718(2*n)-4*n

mov $1,$0
mul $1,4
mul $0,2
seq $0,313718 ; Coordination sequence Gal.6.133.4 where G.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.
sub $0,$1

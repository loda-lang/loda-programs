...
; Formula: a(n) = b(4*n+1), b(n) = e(n-2), b(5) = 6, b(4) = 5, b(3) = 2, b(2) = 0, b(1) = 1, b(0) = 0, c(n) = -c(n-1)-2*f(n-1)+d(n-1), c(5) = 2, c(4) = -2, c(3) = -2, c(2) = 1, c(1) = 2, c(0) = 0, d(n) = (-f(n-1)+d(n-1))/2+2, d(5) = 2, d(4) = 2, d(3) = 2, d(2) = 3, d(1) = 3, d(0) = 2, e(n) = -f(n-1)+d(n-1)+e(n-1), e(5) = 6, e(4) = 5, e(3) = 6, e(2) = 5, e(1) = 2, e(0) = 0, f(n) = c(n-1)+f(n-1), f(5) = -1, f(4) = 1, f(3) = 3, f(2) = 2, f(1) = 0, f(0) = 0

...
mul $0,2
seq $0,315767 ; Coordination sequence Gal.6.627.6 where G.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.
add $1,$0
mul $1,2
sub $1,1
div $1,4

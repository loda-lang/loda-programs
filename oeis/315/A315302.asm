...
; Formula: a(n) = -truncate((24*n-1)/(8*n-2*truncate((truncate((20*n-1)/11)+1)/2)+floor((18*n)/11)+truncate((20*n-1)/11)+1))*(8*n-2*truncate((truncate((20*n-1)/11)+1)/2)+floor((18*n)/11)+truncate((20*n-1)/11)+1)+24*n

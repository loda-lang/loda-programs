...
mov $1,$0
seq $0,313872 ; Coordination sequence Gal.6.617.4 where G.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.
dif $1,2
add $1,1
mod $1,3
add $0,$1

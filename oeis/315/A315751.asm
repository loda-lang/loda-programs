...
; Formula: a(n) = ((sign(n)*((n-1)%12+1))==0)+70*floor(n/12)+64*((sign(n)*((n-1)%12+1))==11)+58*((sign(n)*((n-1)%12+1))==10)+52*((sign(n)*((n-1)%12+1))==9)+47*((sign(n)*((n-1)%12+1))==8)+41*((sign(n)*((n-1)%12+1))==7)+35*((sign(n)*((n-1)%12+1))==6)+29*((sign(n)*((n-1)%12+1))==5)+23*((sign(n)*((n-1)%12+1))==4)+18*((sign(n)*((n-1)%12+1))==3)+12*((sign(n)*((n-1)%12+1))==2)+6*((sign(n)*((n-1)%12+1))==1)

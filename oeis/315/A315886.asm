...
; Formula: a(n) = max(30*floor(n/7)+24*((sign(n)*((n-1)%7+1))==6)+22*((sign(n)*((n-1)%7+1))==5)+16*((sign(n)*((n-1)%7+1))==4)+14*((sign(n)*((n-1)%7+1))==3)+8*((sign(n)*((n-1)%7+1))==2)+6*((sign(n)*((n-1)%7+1))==1)-1,0)+1

...
; Formula: a(n) = (2*A312555(n)+1)/3+2*n

mov $1,$0
mul $1,2
seq $0,312555 ; Coordination sequence Gal.5.110.1 where G.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.
mul $0,2
add $0,1
div $0,3
add $0,$1

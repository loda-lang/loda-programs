...
; Formula: a(n) = -truncate((12*n-1)/(4*n+floor((20*n+53)/90)+floor((20*n+30)/9)+max(floor((20*n+53)/90)+floor((20*n+30)/9)-4,0)-2))*(4*n+floor((20*n+53)/90)+floor((20*n+30)/9)+max(floor((20*n+53)/90)+floor((20*n+30)/9)-4,0)-2)+14*n

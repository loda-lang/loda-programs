...
; Formula: a(n) = -10*truncate((truncate(((A078979(max(truncate(A062876(n)/4)+1,3)+1)+1)*(2*A078979(max(truncate(A062876(n)/4)+1,3)+1)+1))/4)+8)/10)+truncate(((A078979(max(truncate(A062876(n)/4)+1,3)+1)+1)*(2*A078979(max(truncate(A062876(n)/4)+1,3)+1)+1))/4)+8

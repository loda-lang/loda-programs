...
; Formula: a(n) = min(2,if((A034386(A072100(n+1))%2)==0,A034386(A072100(n+1))/2,A034386(A072100(n+1))))*if((A034386(A072100(n+1))%2)==0,A034386(A072100(n+1))/2,A034386(A072100(n+1)))

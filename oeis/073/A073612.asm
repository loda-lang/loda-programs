...
; Formula: a(n) = truncate(b(n-1)/2)+2, b(n) = b(n-1)+c(n-1)+A159477((d(n-1)==0)+c(n-1)+1), b(2) = 12, b(1) = 4, b(0) = 0, c(n) = A159477((d(n-1)==0)+c(n-1)+1), c(2) = 5, c(1) = 3, c(0) = 1, d(n) = A159477((d(n-1)==0)+c(n-1)+1), d(2) = 5, d(1) = 3, d(0) = 0

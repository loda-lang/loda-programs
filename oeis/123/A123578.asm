...
; Formula: a(n) = (c(n-1)*(d(n-1)+1))/b(n-1), a(3) = 2, a(2) = 2, a(1) = 1, a(0) = 0, b(n) = b(n-1)*((c(n-1)*(d(n-1)+1))/b(n-1)), b(3) = 12, b(2) = 6, b(1) = 3, b(0) = 3, c(n) = c(n-1)*((c(n-1)*(d(n-1)+1))/b(n-1))+b(n-1), c(3) = 36, c(2) = 15, c(1) = 6, c(0) = 3, d(n) = (d(n-1)+1)/2, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0

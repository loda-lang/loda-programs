...
; Formula: a(n) = d(n+1)+1, b(n) = b(n-1)/2+c(n-1), b(3) = 5, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = gcd(b(n-1)/2,2)*c(n-1), c(3) = 4, c(2) = 4, c(1) = 2, c(0) = 1, d(n) = d(n-1)+gcd(b(n-2)/2,2)-1, d(3) = 1, d(2) = 0, d(1) = -1, d(0) = 0

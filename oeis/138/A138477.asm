...
; Formula: a(n) = c(n)/4, b(n) = 4*d(n-1)+2*b(n-1)+2*c(n-1)+1, b(2) = 9, b(1) = 3, b(0) = 1, c(n) = 4*((-c(n-1)-1)/4)+4*d(n-1)+b(n-1)+c(n-1), c(2) = 4, c(1) = 1, c(0) = 0, d(n) = 4*((-c(n-1)-1)/4), d(2) = 0, d(1) = 0, d(0) = 0

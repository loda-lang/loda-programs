...
; Formula: a(n) = c(max(n-2,0)), b(n) = -c(n-1)-d(n-1)-1, b(3) = -6, b(2) = -3, b(1) = -1, b(0) = 0, c(n) = b(n-1)+c(n-1)+d(n-1)+e(n-1)+1, c(3) = 5, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = b(n-1)+c(n-1)+d(n-1)+1, d(3) = 3, d(2) = 2, d(1) = 1, d(0) = 0, e(n) = b(n-1)+d(n-1)+e(n-1)+1, e(3) = 2, e(2) = 2, e(1) = 1, e(0) = 0

...
; Formula: a(n) = (-a(n-1)+c(n-1))*(b(n-1)%2)+2*a(n-1), a(3) = 8, a(2) = 4, a(1) = 2, a(0) = 1, b(n) = ((-a(n-2)+c(n-2))*(b(n-2)%2)+a(n-1)+a(n-2))/8, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = a(n-1), c(3) = 4, c(2) = 2, c(1) = 1, c(0) = 0

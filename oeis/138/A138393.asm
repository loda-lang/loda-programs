...
; Formula: a(n) = 8*d(n+1)+17, b(n) = b(n-1)/2+c(n-1), b(3) = 6, b(2) = 5, b(1) = 2, b(0) = 0, c(n) = gcd(b(n-1)/2,2)*c(n-1), c(3) = 8, c(2) = 4, c(1) = 4, c(0) = 2, d(n) = d(n-1)+gcd(b(n-2)/2,2), d(3) = 3, d(2) = 2, d(1) = 0, d(0) = 0

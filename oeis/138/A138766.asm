...
; Formula: a(n) = b(n-1), a(4) = 7, a(3) = 4, a(2) = 2, a(1) = 1, a(0) = 1, b(n) = 2*b(n-1)+2*c(n-3)-a(n-3), b(4) = 11, b(3) = 7, b(2) = 4, b(1) = 2, b(0) = 1, c(n) = 2*c(n-1)-a(n-1), c(4) = -20, c(3) = -8, c(2) = -3, c(1) = -1, c(0) = 0

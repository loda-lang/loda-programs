...
; Formula: a(n) = c(n+1), b(n) = truncate((d(n-1)+A159477(b(n-1)+1))/2), b(2) = 2, b(1) = 1, b(0) = 1, c(n) = A159477(b(n-1)+1), c(2) = 2, c(1) = 2, c(0) = 0, d(n) = d(n-1)+A159477(b(n-1)+1), d(2) = 4, d(1) = 2, d(0) = 0

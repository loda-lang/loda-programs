...
; Formula: a(n) = max(c(n-1),2)*b(n-1)+max(c(n-2),2), a(3) = 18, a(2) = 6, a(1) = 1, a(0) = 0, b(n) = max(c(n-1),2), b(3) = 8, b(2) = 2, b(1) = 2, b(0) = 0, c(n) = max(c(n-2),2)*max(c(n-1),2)^2, c(3) = 128, c(2) = 8, c(1) = 0, c(0) = 0

...
; Formula: a(n) = (c(n)+7)/24, b(n) = 2*b(n-1)-c(n-1)-d(n-1), b(2) = -16, b(1) = -1, b(0) = 0, c(n) = 6*c(n-1)+6*d(n-1)+12, c(2) = 96, c(1) = 18, c(0) = 0, d(n) = -2*c(n-1)-2*d(n-1)+b(n-1)-2, d(2) = -31, d(1) = -4, d(0) = 1

...
; Formula: a(n) = d(n+1), b(n) = b(n-1)+c(n-1)+d(n-1), b(4) = 11, b(3) = 4, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = c(n-1)+d(n-1)+d(n-2), c(4) = 9, c(3) = 4, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = 2*d(n-1)-d(n-2)-d(n-3)+b(n-2), d(6) = 18, d(5) = 7, d(4) = 4, d(3) = 3, d(2) = 2, d(1) = 1, d(0) = 0

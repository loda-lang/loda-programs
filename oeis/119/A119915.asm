...
; Formula: a(n) = 2*a(n-1)+b(n-1)+1, a(3) = 13, a(2) = 4, a(1) = 1, a(0) = 0, b(n) = a(n-1)+c(n-1)+1, b(3) = 13, b(2) = 4, b(1) = 1, b(0) = 0, c(n) = 2*c(n-1)-b(n-2)-3*a(n-2)+a(n-1)+b(n-1)+2, c(3) = 22, c(2) = 8, c(1) = 2, c(0) = 0

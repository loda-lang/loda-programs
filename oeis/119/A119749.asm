...
; Formula: a(n) = c(n+1), b(n) = 2*b(n-2)-b(n-4)+b(n-1)+b(n-3), b(7) = 126, b(6) = 61, b(5) = 29, b(4) = 14, b(3) = 7, b(2) = 3, b(1) = 2, b(0) = 1, c(n) = d(n-1), c(3) = 4, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = 2*b(n-1)+d(n-3), d(4) = 15, d(3) = 7, d(2) = 4, d(1) = 1, d(0) = 1

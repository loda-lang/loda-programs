...
; Formula: a(n) = a(n-1)+c(n-1)+d(n-1)+1, a(3) = 7, a(2) = 4, a(1) = 1, a(0) = 1, b(n) = a(n-1)+b(n-1), b(3) = 6, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = 2*a(n-1)+2*b(n-1)+d(n-1)+1, c(3) = 10, c(2) = 5, c(1) = 2, c(0) = 0, d(n) = -c(n-1)-d(n-1)-1, d(3) = -3, d(2) = -3, d(1) = 0, d(0) = -1

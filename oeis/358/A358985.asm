...
; Formula: a(n) = (2*a(n-1)-b(n-1))*((3^(gcd(c(n-1),max(-c(n-1)+2,0)+6)-3))%10+((3^(gcd(c(n-1),max(-c(n-1)+2,0)+6)-3))%10)/3+1), a(2) = 180, a(1) = 18, a(0) = 10, b(n) = 2*a(n-1)-b(n-1), b(2) = 18, b(1) = 18, b(0) = 2, c(n) = 2*c(n-1)+4, c(2) = 28, c(1) = 12, c(0) = 4

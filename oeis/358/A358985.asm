...
; Formula: a(n) = b(n+1), b(n) = (2*b(n-1)-c(n-1))*((3^(gcd(d(n-1),max(-d(n-1)+2,0)+6)-3))%10+((3^(gcd(d(n-1),max(-d(n-1)+2,0)+6)-3))%10)/3+1), b(2) = 18, b(1) = 10, b(0) = 1, c(n) = 2*b(n-1)-c(n-1), c(2) = 18, c(1) = 2, c(0) = 0, d(n) = 2*d(n-1)+4, d(2) = 12, d(1) = 4, d(0) = 0

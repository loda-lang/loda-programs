...
; Formula: a(n) = a(n-1)+d(n-1)+e(n-1)+n-1, a(6) = 41, a(5) = 8, a(4) = 1, a(3) = 0, a(2) = 0, a(1) = 0, a(0) = 0, b(n) = 2*b(n-1)+d(n-1)+e(n-1)-2, b(6) = -132, b(5) = -79, b(4) = -40, b(3) = -18, b(2) = -7, b(1) = -2, b(0) = 0, c(n) = 2*c(n-1)+d(n-1)+2, c(6) = 288, c(5) = 110, c(4) = 42, c(3) = 16, c(2) = 6, c(1) = 2, c(0) = 0, d(n) = c(n-1)+d(n-1), d(6) = 176, d(5) = 66, d(4) = 24, d(3) = 8, d(2) = 2, d(1) = 0, d(0) = 0, e(n) = b(n-1)+d(n-1)+e(n-1)-1, e(6) = -52, e(5) = -38, e(4) = -21, e(3) = -10, e(2) = -4, e(1) = -1, e(0) = 0

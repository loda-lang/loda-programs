...
; Formula: a(n) = c(n-1)+a(n-1)+e(n-1)+f(n-1), a(6) = 41, a(5) = 8, a(4) = 1, a(3) = 0, a(2) = 0, a(1) = 0, a(0) = 0, b(n) = 2*b(n-1)+e(n-1)+f(n-1)-2, b(6) = -132, b(5) = -79, b(4) = -40, b(3) = -18, b(2) = -7, b(1) = -2, b(0) = 0, c(n) = c(n-1)+1, c(6) = 6, c(5) = 5, c(4) = 4, c(3) = 3, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = 2*d(n-1)+e(n-1)+2, d(6) = 288, d(5) = 110, d(4) = 42, d(3) = 16, d(2) = 6, d(1) = 2, d(0) = 0, e(n) = d(n-1)+e(n-1), e(6) = 176, e(5) = 66, e(4) = 24, e(3) = 8, e(2) = 2, e(1) = 0, e(0) = 0, f(n) = b(n-1)+e(n-1)+f(n-1)-1, f(6) = -52, f(5) = -38, f(4) = -21, f(3) = -10, f(2) = -4, f(1) = -1, f(0) = 0

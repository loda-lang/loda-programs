...
; Formula: a(n) = (b(3*n+3)/(c(3*n+3)/(10^(n+1))))%10, b(n) = 3*c(n-1)+2*d(n-1)+b(n-1), b(2) = 114, b(1) = 18, b(0) = 0, c(n) = 4*c(n-1)+2*d(n-1)+b(n-1), c(2) = 138, c(1) = 24, c(0) = 6, d(n) = 2*c(n-1)+2*d(n-1), d(2) = 72, d(1) = 12, d(0) = 0

...
; Formula: a(n) = -10*truncate(truncate(b(3*n)/(truncate(c(3*n)/(10^n))+1))/10)+truncate(b(3*n)/(truncate(c(3*n)/(10^n))+1)), b(n) = b(n-1)+c(n-1), b(2) = 3, b(1) = 1, b(0) = 1, c(n) = 5*c(n-1)+2*b(n-2)+c(n-2), c(3) = 64, c(2) = 12, c(1) = 2, c(0) = 0

...
lpb $0
  sub $0,1
  mov $1,$2
  seq $1,328632 ; Numbers n >= 0 for which A328578(n) = A257993(A276086(A276086(n))) = 2, where A276086 converts the primorial base expansion of n into its prime product form, and A257993 returns the index of the least prime not present in its argument.
  add $2,1
lpe
mov $0,$1
div $0,6

...
; Formula: a(n) = truncate(e(n)/2)+1, b(n) = -max(c(n-1),4)+truncate((-c(n-1)+b(n-1)-2)/2), b(3) = -12, b(2) = -10, b(1) = -6, b(0) = 0, c(n) = max(c(n-1),4), c(3) = 4, c(2) = 4, c(1) = 4, c(0) = 2, d(n) = d(n-1), d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = -truncate((-c(n-1)+b(n-1)-2)/2)+d(n-1)+e(n-1)+4, e(3) = 28, e(2) = 16, e(1) = 6, e(0) = 0

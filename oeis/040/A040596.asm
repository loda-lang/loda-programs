...
; Formula: a(n) = 7*truncate((gcd(0,A144330(truncate((4*A047249(A010126(n))-12)/5)*gcd(n,2)+gcd(n,2)-1))+2)/5)+A144330(truncate((4*A047249(A010126(n))-12)/5)*gcd(n,2)+gcd(n,2)-1)

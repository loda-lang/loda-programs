...
; Formula: a(n) = ((sign(n)*((n-1)%8+1))==6)+((sign(n)*((n-1)%8+1))==5)+((sign(n)*((n-1)%8+1))==3)+((sign(n)*((n-1)%8+1))==2)+28*((sign(n)*((n-1)%8+1))==8)+14*((sign(n)*((n-1)%8+1))==0)+2*((sign(n)*((n-1)%8+1))==7)+2*((sign(n)*((n-1)%8+1))==4)+2*((sign(n)*((n-1)%8+1))==1)

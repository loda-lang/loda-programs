...
; Formula: a(n) = 7*truncate((2*truncate((2*A010225(n)*((-1)^n+2)-1)/3)-1)/6)-truncate((7*truncate((2*truncate((2*A010225(n)*((-1)^n+2)-1)/3)-1)/6)+4*truncate((2*A010225(n)*((-1)^n+2)-1)/3)-10*truncate((4*truncate((2*A010225(n)*((-1)^n+2)-1)/3)-8)/10)-8)/2)-1

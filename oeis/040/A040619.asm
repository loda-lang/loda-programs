...
; Formula: a(n) = max(50*((sign(n)*((n-1)%10+1))==10)+25*((sign(n)*((n-1)%10+1))==0)+12*((sign(n)*((n-1)%10+1))==6)+12*((sign(n)*((n-1)%10+1))==4)+10*((sign(n)*((n-1)%10+1))==5)+2*((sign(n)*((n-1)%10+1))==9)+2*((sign(n)*((n-1)%10+1))==1)-1,0)+1

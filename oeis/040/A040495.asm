...
; Formula: a(n) = truncate((gcd(-6*truncate(truncate((5*truncate((2*A010225(n)*((-1)^n+2)-1)/3)+5)/3)/6)+truncate((5*truncate((2*A010225(n)*((-1)^n+2)-1)/3)+5)/3),truncate((5*truncate((2*A010225(n)*((-1)^n+2)-1)/3)+5)/3))+truncate((5*truncate((2*A010225(n)*((-1)^n+2)-1)/3)+5)/3))/2)

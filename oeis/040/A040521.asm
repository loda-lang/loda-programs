...
; Formula: a(n) = truncate((2*gcd(-6*truncate(truncate((10*truncate((2*A010225(n)*((-1)^n+2)-1)/3)+20)/6)/6)+truncate((10*truncate((2*A010225(n)*((-1)^n+2)-1)/3)+20)/6),truncate((10*truncate((2*A010225(n)*((-1)^n+2)-1)/3)+20)/6)+24)+truncate((10*truncate((2*A010225(n)*((-1)^n+2)-1)/3)+20)/6)+24)/2)-14

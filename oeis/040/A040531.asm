...
; Formula: a(n) = ((sign(n)*((n-1)%8+1))==7)+((sign(n)*((n-1)%8+1))==6)+((sign(n)*((n-1)%8+1))==4)+((sign(n)*((n-1)%8+1))==2)+((sign(n)*((n-1)%8+1))==1)+46*((sign(n)*((n-1)%8+1))==8)+23*((sign(n)*((n-1)%8+1))==0)+3*((sign(n)*((n-1)%8+1))==5)+3*((sign(n)*((n-1)%8+1))==3)

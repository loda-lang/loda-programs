...
; Formula: a(n) = 8*((gcd(0,A144330(gcd(n,2)*((4*A047249(A010126(n))-12)/5)+gcd(n,2)-1))+2)/5)-2*((gcd(0,A144330(gcd(n,2)*((4*A047249(A010126(n))-12)/5)+gcd(n,2)-1))+2)/5)+A144330(gcd(n,2)*((4*A047249(A010126(n))-12)/5)+gcd(n,2)-1)

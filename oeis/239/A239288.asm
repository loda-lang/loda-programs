...
; Formula: a(n) = (b(n+1)+d(n+1))/6, b(n) = (c(n-1)+d(n-1)+3)/2, b(4) = 9, b(3) = 5, b(2) = 3, b(1) = 1, b(0) = 0, c(n) = 2*((c(n-2)+d(n-2)+3)/2)-c(n-1)+max(2*((c(n-3)+d(n-3)+3)/2)-2*c(n-2)-2,0)+2, c(5) = 14, c(4) = 6, c(3) = 6, c(2) = 2, c(1) = 2, c(0) = 0, d(n) = c(n-1)+d(n-1)+2, d(4) = 18, d(3) = 10, d(2) = 6, d(1) = 2, d(0) = 0

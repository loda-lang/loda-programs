...
; Formula: a(n) = 2*gcd(min(n-1,0),b(max(n-1,0))), b(n) = -c(n-1)-2*b(n-1)+b(n-1)+c(n-1)+d(n-1), b(2) = 3, b(1) = -2, b(0) = 1, c(n) = -b(n-1)-c(n-1)-d(n-1)+c(n-1), c(2) = 1, c(1) = 0, c(0) = 1, d(n) = b(n-1)+c(n-1)+d(n-1), d(2) = -1, d(1) = 1, d(0) = -1

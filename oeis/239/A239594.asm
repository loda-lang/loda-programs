...
; Formula: a(n) = truncate(b(n-1)^c(n-1))+3, b(n) = b(n-2)+b(n-5)+3, b(7) = 8, b(6) = 5, b(5) = 4, b(4) = 2, b(3) = 1, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = binomial(c(n-1),0), c(5) = 1, c(4) = 1, c(3) = 1, c(2) = 1, c(1) = 1, c(0) = 0

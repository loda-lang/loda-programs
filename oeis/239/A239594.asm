...
; Formula: a(n) = c(n)^d(n)+3, b(n) = b(n-2)+b(n-5)+3, b(6) = 9, b(5) = 8, b(4) = 5, b(3) = 4, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = b(n-2), c(5) = 4, c(4) = 2, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = binomial(d(n-1),0), d(5) = 1, d(4) = 1, d(3) = 1, d(2) = 1, d(1) = 1, d(0) = 0

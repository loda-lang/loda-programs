...
; 1,1,1,2,1,3,2,3,1,4,2,5,3,5,3,4,1,5,2,7,3,8,3,7,4,7,5,8,5,7,4,5,1,6,2,9,3,11,3,10,4,11,5,13,5,12,4,9,5,9,7,12,8,13,7,11,7,10,8,11,7,9,5,6,1,7,2,11,3,14,3,13,4,15,5,18,5,17,4,13
; Formula: a(n) = A002487(A059893(A080542(max(n-1,0))))

...
; Formula: a(n) = (-b(n+1)+c(n+1))/12, b(n) = 12*c(n-1)+12*d(n-1)+6*b(n-1), b(2) = 456, b(1) = 12, b(0) = 0, c(n) = 24*c(n-1)+24*d(n-1), c(2) = 768, c(1) = 24, c(0) = 0, d(n) = 8*d(n-1), d(2) = 64, d(1) = 8, d(0) = 1

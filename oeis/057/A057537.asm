...
; Formula: a(n) = -A339094(n)*(A264668(n)-1)

mov $1,$0
seq $1,339094 ; Number of (unordered) ways of making change for n US Dollars using the current US denominations of 1$, 2$, 5$, 10$, 20$, 50$ and 100$ bills.

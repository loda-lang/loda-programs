...
; Formula: a(n) = b(n-6), a(9) = 1, a(8) = 1, a(7) = 1, a(6) = 0, a(5) = 0, a(4) = 0, a(3) = 0, a(2) = 0, a(1) = 0, a(0) = 1, b(n) = b(n-1)+b(n-7), b(10) = 4, b(9) = 3, b(8) = 2, b(7) = 1, b(6) = 1, b(5) = 1, b(4) = 1, b(3) = 1, b(2) = 1, b(1) = 1, b(0) = 0

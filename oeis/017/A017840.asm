...
; Formula: a(n) = c(n+2), b(n) = -b(n-2)-c(n-2)-c(n-4)+b(n-1)+b(n-6)+b(n-8), b(13) = -5, b(12) = -3, b(11) = -2, b(10) = -2, b(9) = -2, b(8) = -2, b(7) = -2, b(6) = -1, b(5) = 0, b(4) = 0, b(3) = 0, b(2) = -1, b(1) = -1, b(0) = 0, c(n) = -b(n-1)-c(n-1), c(8) = 1, c(7) = 1, c(6) = 0, c(5) = 0, c(4) = 0, c(3) = 0, c(2) = 1, c(1) = 0, c(0) = 0

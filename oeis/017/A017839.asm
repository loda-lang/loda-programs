...
; Formula: a(n) = b(n+5), b(n) = c(n-3), b(7) = 0, b(6) = 0, b(5) = 1, b(4) = 0, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = -c(n-2)-d(n-2)+c(n-1)+c(n-5)+c(n-7)+1, c(10) = 1, c(9) = 1, c(8) = 1, c(7) = 1, c(6) = 0, c(5) = 0, c(4) = 0, c(3) = 0, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = -c(n-1)-d(n-1)+2, d(7) = 1, d(6) = 1, d(5) = 1, d(4) = 1, d(3) = 1, d(2) = 0, d(1) = 2, d(0) = 0

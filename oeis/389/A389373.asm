...
; Formula: a(n) = d(n-1), b(n) = c(n-2), b(5) = 2, b(4) = 1, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = d(n-1), c(5) = 14, c(4) = 7, c(3) = 2, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = 4*c(n-1)+2*b(n-3)-2*c(n-2)-5*b(n-1)+b(n-2)+d(n-1)+1, d(6) = 68, d(5) = 34, d(4) = 14, d(3) = 7, d(2) = 2, d(1) = 1, d(0) = 0

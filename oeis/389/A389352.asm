...
; Formula: a(n) = 2*min(-floor(floor((sqrtint(8*n)-1)/2)/2)-n+binomial(floor((sqrtint(8*n)-1)/2)+1,2)+floor((sqrtint(8*n)-1)/2)+1,0)-binomial(floor((sqrtint(8*n)-1)/2)+1,2)-floor(floor((sqrtint(8*n)-1)/2)/2)+floor((sqrtint(8*n)-1)/2)+n-1

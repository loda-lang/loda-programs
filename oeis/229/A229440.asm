...
; Formula: a(n) = b(n)+2, b(n) = b(n-1)+e(n-1)+f(n-1)+n+2, b(6) = 291, b(5) = 126, b(4) = 51, b(3) = 20, b(2) = 8, b(1) = 3, b(0) = 0, c(n) = 2*n+c(n-1), c(6) = 42, c(5) = 30, c(4) = 20, c(3) = 12, c(2) = 6, c(1) = 2, c(0) = 0, d(n) = 2*n+c(n-1)+d(n-1)+1, d(6) = 118, d(5) = 75, d(4) = 44, d(3) = 23, d(2) = 10, d(1) = 3, d(0) = 0, e(n) = d(n-1)+e(n-1)+1, e(6) = 161, e(5) = 85, e(4) = 40, e(3) = 16, e(2) = 5, e(1) = 1, e(0) = 0, f(n) = e(n-1)+f(n-1)+n-1, f(6) = 162, f(5) = 72, f(4) = 28, f(3) = 9, f(2) = 2, f(1) = 0, f(0) = 0

...
; Formula: a(n) = d(n+5)/2, b(n) = c(n-2)^3, b(7) = 0, b(6) = 0, b(5) = 0, b(4) = 0, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = d(n-1), c(7) = 0, c(6) = 2, c(5) = 0, c(4) = 0, c(3) = 0, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = max(-b(n-3)-d(n-4)-e(n-3)-2*d(n-2)+b(n-2)+b(n-4)+c(n-2)+d(n-1)+d(n-3)+e(n-2),0), d(8) = 4, d(7) = 0, d(6) = 0, d(5) = 2, d(4) = 0, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = -b(n-1)-e(n-1)+d(n-1)+2, e(7) = 0, e(6) = 2, e(5) = 2, e(4) = 0, e(3) = 2, e(2) = 0, e(1) = 2, e(0) = 0

...
; Formula: a(n) = floor((4*b(4*n+4)+c(4*n+4))/(2*floor((4*b(4*n+4))/(10^(n+1)))))%10, b(n) = 6*b(n-1)-4*b(n-2), b(4) = 544, b(3) = 104, b(2) = 20, b(1) = 4, b(0) = 1, c(n) = floor((b(n-1)+c(n-1))/2), c(2) = 2, c(1) = 0, c(0) = 0

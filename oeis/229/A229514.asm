...
; Formula: a(n) = (b(n+4)-6)/3+3, b(n) = e(n-1), b(4) = 6, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = -e(n-1)-2*c(n-1)-2*d(n-1)+c(n-1)+d(n-1)+e(n-1), c(4) = -6, c(3) = -3, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 4*c(n-2)+4*d(n-2)+2*d(n-1)+2*e(n-2)-2*e(n-2)-4*c(n-2)-4*d(n-2)+c(n-2)+e(n-2)+3, d(4) = 21, d(3) = 9, d(2) = 3, d(1) = 0, d(0) = 0, e(n) = 2*c(n-1)+2*d(n-1)+e(n-1), e(4) = 18, e(3) = 6, e(2) = 0, e(1) = 0, e(0) = 0

...
; Formula: a(n) = e(n+1), b(n) = 2*c(n-1)+truncate((-c(n-1)+b(n-1)+1)/2), b(3) = 104, b(2) = 15, b(1) = 4, b(0) = 0, c(n) = 2*gcd(-c(n-1)+d(n-1)+truncate((-c(n-1)+b(n-1)+1)/2),4)*c(n-1), c(3) = 256, c(2) = 64, c(1) = 8, c(0) = 2, d(n) = truncate(gcd(-c(n-1)+d(n-1)+truncate((-c(n-1)+b(n-1)+1)/2),4)/2), d(3) = 1, d(2) = 2, d(1) = 1, d(0) = 0, e(n) = d(n-1)+e(n-1)+2, e(3) = 8, e(2) = 4, e(1) = 1, e(0) = -1

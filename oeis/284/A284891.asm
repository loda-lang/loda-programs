...
; Formula: a(n) = d(n+2), b(n) = 9*truncate((n+1)/b(n-1))*b(n-1)+b(n-1), b(4) = 10, b(3) = 10, b(2) = 10, b(1) = 10, b(0) = 10, c(n) = n+2, c(4) = 6, c(3) = 5, c(2) = 4, c(1) = 3, c(0) = 0, d(n) = d(n-1)*(9*truncate(c(n-1)/b(n-1))*b(n-1)+b(n-1))+n+1, d(4) = 345, d(3) = 34, d(2) = 3, d(1) = 0, d(0) = 0

...
; Formula: a(n) = binomial(max(-binomial(floor(sqrtint(8*n+16)/2),2)+n+1,1)-1,-binomial(floor(sqrtint(8*n+16)/2),2)-floor(sqrtint(8*n+16)/2)+max(-binomial(floor(sqrtint(8*n+16)/2),2)+n+1,1)+n+2)+binomial(max(-binomial(floor(sqrtint(8*n+16)/2),2)+n+1,1),-binomial(floor(sqrtint(8*n+16)/2),2)-floor(sqrtint(8*n+16)/2)+max(-binomial(floor(sqrtint(8*n+16)/2),2)+n+1,1)+n+2)

...
; Formula: a(n) = d(n)/3, b(n) = (-2*d(n-1)*c(n-1)+b(n-1))/2, b(2) = -17, b(1) = -2, b(0) = 0, c(n) = 2*d(n-1)*c(n-1), c(2) = 32, c(1) = 4, c(0) = 2, d(n) = gcd(((-2*d(n-1)*c(n-1)+b(n-1))/2+2*d(n-1))%2,4), d(2) = 1, d(1) = 4, d(0) = 1

...
; Formula: a(n) = e(n+1)+24, b(n) = (-c(n-1)+b(n-1))/2, b(3) = 97, b(2) = 221, b(1) = 452, b(0) = 907, c(n) = 2*(((-c(n-1)+b(n-1))/2-2*c(n-2)+c(n-1))%2)+2*c(n-1)+4, c(4) = 122, c(3) = 58, c(2) = 26, c(1) = 10, c(0) = 2, d(n) = 2*(((-c(n-1)+b(n-1))/2+d(n-1))%2)+4, d(3) = 6, d(2) = 6, d(1) = 6, d(0) = -1, e(n) = 2*(((-c(n-1)+b(n-1))/2+d(n-1))%2)+e(n-1)+4, e(3) = 18, e(2) = 12, e(1) = 6, e(0) = 0

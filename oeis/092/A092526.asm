...
; Formula: a(n) = (b(4*n)/(c(4*n)/(10^n)+1))%10, b(n) = 4*(d(n-1)/3)+2*b(n-1), b(2) = 4, b(1) = 2, b(0) = 1, c(n) = 4*(d(n-1)/3)+2*b(n-1)+2*c(n-1), c(2) = 8, c(1) = 2, c(0) = 0, d(n) = 8*(d(n-3)/3)+4*(d(n-1)/3)+4*d(n-1)-4*d(n-2)-8*(d(n-2)/3), d(5) = 224, d(4) = 60, d(3) = 16, d(2) = 4, d(1) = 1, d(0) = 0

...
; Formula: a(n) = d(n+1), b(n) = b(n-1)%(c(n-1)+1)+c(n-1)+1, b(3) = 1, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = (b(n-2)%(c(n-2)+1)+c(n-2)+1)%(c(n-1)+1)+b(n-2), c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = c(n-1)+1, d(3) = 1, d(2) = 1, d(1) = 1, d(0) = 0

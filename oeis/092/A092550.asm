...
; Formula: a(n) = d(n-1)+1, a(3) = 1, a(2) = 1, a(1) = 1, a(0) = 0, b(n) = -truncate(b(n-1)/(d(n-1)+1))*(d(n-1)+1)+b(n-1)+d(n-1)+1, b(3) = 1, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = b(n-1), c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = -truncate(b(n-1)/(d(n-1)+1))*(d(n-1)+1)+b(n-1)+c(n-1), d(3) = 1, d(2) = 0, d(1) = 0, d(0) = 0

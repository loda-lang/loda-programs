...
; Formula: a(n) = if(if(((2*n+2)%3)==0,(2*n+2)/3,2*n+2)==0,floor((2*n+2)/3),if((floor((2*n+2)/3)%if(((2*n+2)%3)==0,(2*n+2)/3,2*n+2))==0,floor((2*n+2)/3)/if(((2*n+2)%3)==0,(2*n+2)/3,2*n+2),floor((2*n+2)/3)))

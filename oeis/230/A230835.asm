...
; Formula: a(n) = b(n+1), b(n) = 2*d(n-1)+b(n-1)+e(n-1), b(3) = 22, b(2) = 2, b(1) = 0, b(0) = 1, c(n) = 2*b(n-1)+2*c(n-1)+2*d(n-1)+2*e(n-1)-b(n-1)-c(n-1)-d(n-1)-e(n-1)+d(n-1), c(3) = 24, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = 4*b(n-1)+4*c(n-1)+2*(4*d(n-1))+4*e(n-1)+2*e(n-1)-b(n-1)-c(n-1)-d(n-1)-e(n-1)+d(n-1)+2, d(3) = 90, d(2) = 12, d(1) = 0, d(0) = 0, e(n) = 2*b(n-1)+2*c(n-1)+2*d(n-1)+2*e(n-1)-2*b(n-1)-2*c(n-1)-2*d(n-1)-4*d(n-1)-4*e(n-1), e(3) = -40, e(2) = -4, e(1) = 2, e(0) = -1

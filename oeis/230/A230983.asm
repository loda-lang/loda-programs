...
; Formula: a(n) = e(n)+1, b(n) = -e(n-1)+b(n-1)+d(n-1)-1, b(3) = 1, b(2) = -2, b(1) = -1, b(0) = 0, c(n) = 2*max(-c(n-1)-e(n-1)+d(n-1)-1,0), c(3) = 6, c(2) = 0, c(1) = 2, c(0) = -2, d(n) = 2*c(n-1)+b(n-1)+d(n-1)+4, d(3) = 9, d(2) = 7, d(1) = 0, d(0) = 0, e(n) = -e(n-1)+b(n-1)+c(n-1)+d(n-1)+2, e(3) = 4, e(2) = 3, e(1) = 0, e(0) = 0

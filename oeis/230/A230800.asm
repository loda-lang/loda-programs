...
; Formula: a(n) = 2*d(n-1)-b(n-1)+c(n-1), a(3) = 16, a(2) = 2, a(1) = 2, a(0) = 0, b(n) = -b(n-1)+d(n-1), b(3) = 4, b(2) = -1, b(1) = 1, b(0) = 0, c(n) = 3*c(n-1)+3*d(n-1), c(3) = 36, c(2) = 9, c(1) = 3, c(0) = 0, d(n) = 2*b(n-1)+c(n-2)+d(n-2), d(5) = 31, d(4) = 20, d(3) = 1, d(2) = 3, d(1) = 0, d(0) = 1

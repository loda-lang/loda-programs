...
; Formula: a(n) = c(n-1), b(n) = -b(n-1)+e(n-1), b(3) = 4, b(2) = -1, b(1) = 1, b(0) = 0, c(n) = 2*e(n-1)-b(n-1)+d(n-1), c(3) = 16, c(2) = 2, c(1) = 2, c(0) = 0, d(n) = 3*d(n-1)+3*e(n-1), d(3) = 36, d(2) = 9, d(1) = 3, d(0) = 0, e(n) = 2*b(n-1)+d(n-2)+e(n-2), e(5) = 31, e(4) = 20, e(3) = 1, e(2) = 3, e(1) = 0, e(0) = 1

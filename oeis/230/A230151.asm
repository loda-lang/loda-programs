...
; Formula: a(n) = (b(3*n+3)/(c(3*n+3)/(10^(n+1))))%10, b(n) = 2*c(n-1)+b(n-1)+e(n-1), b(3) = 402, b(2) = 72, b(1) = 12, b(0) = 0, c(n) = 2*c(n-1)+b(n-1)+c(n-1)+e(n-1), c(3) = 492, c(2) = 90, c(1) = 18, c(0) = 6, d(n) = 2*c(n-1)+b(n-1)+c(n-1)+d(n-1)+e(n-1), d(3) = 600, d(2) = 108, d(1) = 18, d(0) = 0, e(n) = 4*c(n-1)+2*e(n-1)+b(n-1)+d(n-1), e(3) = 840, e(2) = 150, e(1) = 24, e(0) = 0

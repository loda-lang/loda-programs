...
; Formula: a(n) = c(n+2), b(n) = -e(n-1)+b(n-1)+d(n-1)+1, b(5) = 32, b(4) = 9, b(3) = 4, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = -e(n-1)+d(n-1)+1, c(5) = 23, c(4) = 5, c(3) = 3, c(2) = 0, c(1) = 1, c(0) = 0, d(n) = 2*c(n-1)+2*d(n-1)-e(n-1)+b(n-1)+f(n-1)+f1(n-1)+1, d(5) = 132, d(4) = 39, d(3) = 11, d(2) = 4, d(1) = 1, d(0) = 0, e(n) = 2*d(n-1)-2*e(n-1)+b(n-1)+c(n-1)+2, e(5) = 60, e(4) = 17, e(3) = 7, e(2) = 2, e(1) = 2, e(0) = 0, f(n) = 2*c(n-1)+2*d(n-1)-e(n-1)+b(n-1)+f(n-1)+f1(n-1)+1, f(5) = 132, f(4) = 39, f(3) = 11, f(2) = 4, f(1) = 1, f(0) = 0, f1(n) = f(n-1)+f1(n-1)-1, f1(5) = 50, f1(4) = 12, f1(3) = 2, f1(2) = -1, f1(1) = -1, f1(0) = 0

...
; Formula: a(n) = 2*b(n-1)+2*c(n-1)-d(n-1)-a(n-1)-2*b(n-1)-2*c(n-1)-2*d(n-1)-2*a(n-1)+d(n-1)+a(n-1), a(3) = 0, a(2) = 2, a(1) = 0, a(0) = 0, b(n) = b(n-1)+d(n-1)+a(n-1), b(3) = -1, b(2) = -1, b(1) = 0, b(0) = 0, c(n) = 2*b(n-1)+2*c(n-1)-d(n-1)-a(n-1)-2*b(n-1)-2*c(n-1)+d(n-1), c(3) = -2, c(2) = 0, c(1) = 0, c(0) = -1, d(n) = 2*b(n-1)+2*c(n-1)+2*d(n-1)+2*a(n-1)+d(n-1)+a(n-1)+1, d(3) = -1, d(2) = -2, d(1) = -1, d(0) = 0

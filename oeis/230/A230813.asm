...
; Formula: a(n) = e(n)/2, b(n) = b(n-1)+d(n-1)+e(n-1), b(3) = -2, b(2) = -2, b(1) = 0, b(0) = 0, c(n) = 2*b(n-1)+2*c(n-1)-d(n-1)-e(n-1)-2*b(n-1)-2*c(n-1)+d(n-1)+1, c(3) = -3, c(2) = 1, c(1) = 1, c(0) = -1, d(n) = 2*b(n-1)+2*c(n-1)+2*d(n-1)+2*e(n-1)+d(n-1)+e(n-1), d(3) = -2, d(2) = -4, d(1) = -2, d(0) = 0, e(n) = 2*b(n-1)+2*c(n-1)-d(n-1)-e(n-1)-2*b(n-1)-2*c(n-1)-2*d(n-1)-2*e(n-1)+d(n-1)+e(n-1), e(3) = 0, e(2) = 4, e(1) = 0, e(0) = 0

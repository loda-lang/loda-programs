...
; Formula: a(n) = -2*c(n-1)-2*a(n-1), a(3) = 0, a(2) = 2, a(1) = 0, a(0) = 0, b(n) = b(n-1)+c(n-1)+a(n-1), b(3) = -1, b(2) = -1, b(1) = 0, b(0) = 0, c(n) = 3*c(n-1)+2*b(n-2)-4*c(n-2)-6*a(n-2)+1, c(3) = -1, c(2) = -2, c(1) = -1, c(0) = 0

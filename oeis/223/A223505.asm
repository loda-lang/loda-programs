...
; Formula: a(n) = c(n)/2+1, b(n) = b(n-1)+c(n-1)+d(n-1), b(3) = 278, b(2) = 48, b(1) = 10, b(0) = 0, c(n) = 6*c(n-2)+4*c(n-1)+4*d(n-1)+2*b(n-1)+2*b(n-2)+8, c(3) = 1260, c(2) = 228, c(1) = 36, c(0) = 10, d(n) = 2, d(3) = 2, d(2) = 2, d(1) = 2, d(0) = 0

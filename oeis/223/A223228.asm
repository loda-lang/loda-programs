...
; Formula: a(n) = 5*(c(n+1)/12), b(n) = 16*(b(n-1)/2)+4*(b(n-1)/2)-c(n-1)-d(n-1)-4*c(n-1)-4*d(n-1)+c(n-1)+d(n-1), b(2) = -280, b(1) = -8, b(0) = 0, c(n) = 24*c(n-1)+24*d(n-1)+6*((c(n-1)+d(n-1))%2)+6*c(n-1)+6*d(n-1)-96*(b(n-1)/2), c(2) = 1884, c(1) = 60, c(0) = 0, d(n) = 16*(b(n-1)/2)-c(n-1)-d(n-1)-4*c(n-1)-4*d(n-1), d(2) = -314, d(1) = -10, d(0) = 2

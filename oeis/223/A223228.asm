...
; Formula: a(n) = 5*truncate(c(n+1)/12), b(n) = 20*truncate(b(n-1)/2)-4*c(n-1)-4*d(n-1), b(2) = -280, b(1) = -8, b(0) = 0, c(n) = 36*c(n-1)+36*d(n-1)-12*truncate((c(n-1)+d(n-1))/2)-96*truncate(b(n-1)/2), c(2) = 1884, c(1) = 60, c(0) = 0, d(n) = 16*truncate(b(n-1)/2)-5*c(n-1)-5*d(n-1), d(2) = -314, d(1) = -10, d(0) = 2

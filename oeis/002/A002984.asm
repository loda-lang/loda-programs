...
; Formula: a(n) = c(n)+1, b(n) = -c(n-1)+b(n-1)+d(n-1), b(2) = 1, b(1) = 1, b(0) = 0, c(n) = b(n-1)+d(n-1), c(2) = 2, c(1) = 1, c(0) = 0, d(n) = c(n-1)+truncate(d(n-1)/(-c(n-1)+b(n-1)+d(n-1))), d(2) = 2, d(1) = 1, d(0) = 1

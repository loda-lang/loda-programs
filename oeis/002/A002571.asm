...
; Formula: a(n) = gcd(4*c(n+1),4*c(n+1))/4, b(n) = -2*c(n-1)+b(n-1)+d(n-1), b(3) = -4, b(2) = 5, b(1) = 1, b(0) = 2, c(n) = -2*c(n-1)+c(n-2)+d(n-1), c(3) = -10, c(2) = 5, c(1) = -1, c(0) = 1, d(n) = b(n-1), d(3) = 5, d(2) = 1, d(1) = 2, d(0) = 1

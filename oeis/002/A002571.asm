...
; Formula: a(n) = truncate((b(n+1)-2)/2)+1, b(n) = 4*c(n-1)+3*d(n-1)+2*e(n-1), b(3) = 10, b(2) = 2, b(1) = 2, b(0) = 0, c(n) = 4*c(n-2)+3*c(n-3)+2*e(n-2), c(3) = 2, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = c(n-1), d(3) = 2, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = c(n-1)+d(n-1)+e(n-1), e(3) = 3, e(2) = 1, e(1) = 1, e(0) = 1

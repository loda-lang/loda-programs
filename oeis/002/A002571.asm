...
; Formula: a(n) = b(n+1), b(n) = 2*c(n-1)+c(n-1)+d(n-1)+e(n-1), b(3) = 10, b(2) = 5, b(1) = 1, b(0) = 1, c(n) = 2*c(n-2)+c(n-2)+d(n-2)+e(n-2), c(3) = 5, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = 2*c(n-1)+d(n-1)+e(n-1), d(3) = 9, d(2) = 4, d(1) = 1, d(0) = 1, e(n) = 2*c(n-1)+d(n-1), e(3) = 6, e(2) = 3, e(1) = 1, e(0) = 0

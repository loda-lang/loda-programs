...
; Formula: a(n) = 2*c(n), b(n) = -5*truncate((b(n-1)+c(n-1)+d(n-1))/5)+b(n-1)+c(n-1)+d(n-1), b(2) = 2, b(1) = 1, b(0) = 0, c(n) = b(n-1)+c(n-1)+d(n-1), c(2) = 2, c(1) = 1, c(0) = 1, d(n) = b(n-1)+d(n-1), d(2) = 1, d(1) = 0, d(0) = 0

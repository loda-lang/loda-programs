...
; Formula: a(n) = truncate(b(n)^b(n)), b(n) = -d(n-1)+c(n-1)+1, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = b(n-1)+d(n-1)+truncate((-d(n-1)+b(n-1)+c(n-1)+1)/2)+1, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = truncate((-d(n-1)+b(n-1)+c(n-1)+1)/2), d(2) = 1, d(1) = 0, d(0) = 0

...
; Formula: a(n) = truncate(b(n-1)^b(n-1)), b(n) = 3*b(n-2)+2*b(n-3)+b(n-4)+c(n-4)-5, b(7) = 23, b(6) = 11, b(5) = 6, b(4) = 3, b(3) = 2, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = 2*b(n-1)+2*c(n-1)-4, c(4) = 4, c(3) = 2, c(2) = 2, c(1) = 2, c(0) = 3

...
; Formula: a(n) = c(n-1), b(n) = f(n-1), b(4) = 16, b(3) = 4, b(2) = -2, b(1) = 0, b(0) = 1, c(n) = (b(n-1)+d(n-1))*(if((e(n-1)^2)==1,e(n-1)^e(n-1),if(e(n-1)<=(-1),0,e(n-1)^e(n-1)))+c(n-1)), c(4) = -240, c(3) = -12, c(2) = -6, c(1) = 2, c(0) = 1, d(n) = -(b(n-1)+d(n-1))*(if((e(n-1)^2)==1,e(n-1)^e(n-1),if(e(n-1)<=(-1),0,e(n-1)^e(n-1)))+c(n-1))+f(n-1), d(4) = 256, d(3) = 16, d(2) = 4, d(1) = -2, d(0) = 0, e(n) = if((e(n-1)^2)==1,e(n-1)^e(n-1),if(e(n-1)<=(-1),0,e(n-1)^e(n-1)))+f(n-1)*c(n-1), e(4) = -192, e(3) = -24, e(2) = -3, e(1) = 1, e(0) = 0, f(n) = -(b(n-1)+d(n-1))*(if((e(n-1)^2)==1,e(n-1)^e(n-1),if(e(n-1)<=(-1),0,e(n-1)^e(n-1)))+c(n-1))+f(n-1), f(4) = 256, f(3) = 16, f(2) = 4, f(1) = -2, f(0) = 0

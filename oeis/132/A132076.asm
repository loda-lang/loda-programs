...
; Formula: a(n) = (a(n-1)+truncate(d(n-1)^d(n-1)))*(b(n-1)+c(n-1)), a(4) = -240, a(3) = -12, a(2) = -6, a(1) = 2, a(0) = 1, b(n) = e(n-1), b(4) = 16, b(3) = 4, b(2) = -2, b(1) = 0, b(0) = 1, c(n) = -(a(n-1)+truncate(d(n-1)^d(n-1)))*(b(n-1)+c(n-1))+e(n-1), c(4) = 256, c(3) = 16, c(2) = 4, c(1) = -2, c(0) = 0, d(n) = e(n-1)*a(n-1)+truncate(d(n-1)^d(n-1)), d(4) = -192, d(3) = -24, d(2) = -3, d(1) = 1, d(0) = 0, e(n) = -(a(n-1)+truncate(d(n-1)^d(n-1)))*(b(n-1)+c(n-1))+e(n-1), e(4) = 256, e(3) = 16, e(2) = 4, e(1) = -2, e(0) = 0

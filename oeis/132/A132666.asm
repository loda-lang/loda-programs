...
; Formula: a(n) = truncate((sign(3*sign(truncate(2^logint(n+1,2))-1)*sign(2*n+2)+sign(2*n+2)+sign(truncate(2^logint(n+1,2))-1))*bitxor(abs(2*n+2),abs(truncate(2^logint(n+1,2))-1)))/2)-1

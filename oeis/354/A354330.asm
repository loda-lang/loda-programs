...
; Formula: a(n) = min(-binomial(n+2,3)+binomial(truncate((sqrtint(8*binomial(n+2,3)+8)-1)/2)+1,2)+truncate((sqrtint(8*binomial(n+2,3)+8)-1)/2)+1,-binomial(truncate((sqrtint(8*binomial(n+2,3)+8)-1)/2)+1,2)+binomial(n+2,3))

...
; Formula: a(n) = min(-binomial(n+2,3)+binomial(floor((sqrtint(8*binomial(n+2,3))+1)/2),2)+floor((sqrtint(8*binomial(n+2,3))+1)/2),-binomial(floor((sqrtint(8*binomial(n+2,3))+1)/2),2)+binomial(n+2,3))

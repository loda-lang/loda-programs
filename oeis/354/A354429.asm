...
; Formula: a(n) = truncate((-2*(-2*truncate(truncate((2*n-1)/2)/2)+truncate((2*n-1)/2))*(-gcd(A122045(2*n+1),2*A155585(2*n+1))+A000111(2*n+3))-gcd(A122045(2*n+1),2*A155585(2*n+1))+A000111(2*n+3))/2)

...
; Formula: a(n) = ((4*d(4*n)+9)/((5*c(4*n))/(10^n)))%10, b(n) = 4*d(n-1)+2*b(n-1)+2*c(n-1), b(2) = 12, b(1) = 2, b(0) = 0, c(n) = (2*c(n-1)+2*d(n-1)+b(n-1))/2+c(n-1)+d(n-1), c(2) = 7, c(1) = 2, c(0) = 1, d(n) = c(n-1)+d(n-1), d(2) = 3, d(1) = 1, d(0) = 0

...
; Formula: a(n) = -(A264668(n)-1)*A138302(n+1)^2

mov $1,$0
add $1,1
seq $1,138302 ; Exponentially 2^n-numbers: 1 together with positive integers k such that all exponents in prime factorization of k are powers of 2.
pow $1,2

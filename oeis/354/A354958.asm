...
; Formula: a(n) = 2*d(n)+1, b(n) = b(n-1)+binomial(c(n-3),2), b(5) = 7, b(4) = 7, b(3) = 4, b(2) = 4, b(1) = 1, b(0) = 1, c(n) = c(n-2), c(5) = 3, c(4) = 1, c(3) = 3, c(2) = 1, c(1) = 3, c(0) = 1, d(n) = c(n-1)*b(n-1)+c(n-2), d(5) = 10, d(4) = 13, d(3) = 7, d(2) = 4, d(1) = 1, d(0) = 0

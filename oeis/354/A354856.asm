...
; Formula: a(n) = b(n-1), b(n) = (b(n-1)==d(n-1))-d(n-1)+b(n-2)+c(n-2), b(5) = 2, b(4) = 1, b(3) = 1, b(2) = 0, b(1) = 0, b(0) = 1, c(n) = -c(n-1)+d(n-1)+d(n-2)+1, c(5) = 2, c(4) = 0, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = b(n-1), d(5) = 1, d(4) = 1, d(3) = 0, d(2) = 0, d(1) = 1, d(0) = 0

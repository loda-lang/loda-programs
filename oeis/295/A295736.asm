...
; Formula: a(n) = -d(n-1)-e(n-1)+c(n-1)-2, a(4) = -3, a(3) = 1, a(2) = -2, a(1) = -2, a(0) = 1, b(n) = 2*b(n-1)+2*c(n-1)-2, b(4) = -14, b(3) = -2, b(2) = 2, b(1) = 2, b(0) = 2, c(n) = e(n-1), c(4) = -3, c(3) = -4, c(2) = -2, c(1) = 0, c(0) = 0, d(n) = 2*c(n-1)-d(n-1)-e(n-2)+b(n-1)-1, d(4) = -7, d(3) = 0, d(2) = -1, d(1) = 2, d(0) = 0, e(n) = -d(n-1)+c(n-1)-2, e(4) = -6, e(3) = -3, e(2) = -4, e(1) = -2, e(0) = 0

...
; Formula: a(n) = d(n+3), b(n) = c(n-1)+d(n-1)+e(n-1)+f1(n-1), b(6) = 72, b(5) = 24, b(4) = 7, b(3) = 2, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = 2*c(n-1)+2*f1(n-1)-c(n-1)+b(n-1)+e(n-1), c(6) = 77, c(5) = 23, c(4) = 8, c(3) = 3, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 4*c(n-2)+4*f1(n-2)+2*b(n-2)+2*e(n-2)+2*f(n-2)+2*f1(n-2)-2*c(n-2)+d(n-2)+1, d(6) = 87, d(5) = 29, d(4) = 10, d(3) = 2, d(2) = 1, d(1) = 1, d(0) = 0, e(n) = c(n-1)+f1(n-1), e(6) = 33, e(5) = 10, e(4) = 4, e(3) = 1, e(2) = 0, e(1) = 0, e(0) = 0, f(n) = 2*c(n-1)+2*f1(n-1)-c(n-1)+b(n-1)+e(n-1)+f(n-1)+f1(n-1), f(6) = 125, f(5) = 38, f(4) = 13, f(3) = 4, f(2) = 0, f(1) = 0, f(0) = 0, f1(n) = d(n-1), f1(6) = 29, f1(5) = 10, f1(4) = 2, f1(3) = 1, f1(2) = 1, f1(1) = 0, f1(0) = 0

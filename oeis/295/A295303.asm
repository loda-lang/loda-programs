...
; Formula: a(n) = -2*truncate((truncate((2*n-2*A000010(A000203(n+1)-1)+2)^(2*n-2*A000010(A000203(n+1)-1)+2))-1)/2)+truncate((2*n-2*A000010(A000203(n+1)-1)+2)^(2*n-2*A000010(A000203(n+1)-1)+2))-1

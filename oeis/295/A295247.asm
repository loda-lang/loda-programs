...
; Formula: a(n) = d(n+2)/2+1, b(n) = b(n-1)+d(n-1)+2, b(5) = 104, b(4) = 34, b(3) = 12, b(2) = 4, b(1) = 2, b(0) = 0, c(n) = 2*b(n-2)+2*c(n-2)+2*d(n-2)+2*e(n-2)-c(n-2)-e(n-2)-2*f(n-2)+b(n-2)+c(n-1)+d(n-2)+e(n-2)+f(n-2)+6, c(5) = 232, c(4) = 74, c(3) = 22, c(2) = 6, c(1) = 0, c(0) = 0, d(n) = 2*e(n-1)-f(n-1)+b(n-1)+c(n-1), d(5) = 210, d(4) = 68, d(3) = 20, d(2) = 6, d(1) = 0, d(0) = 0, e(n) = -f(n-1)+b(n-1)+c(n-1)+d(n-1)+e(n-1)+2, e(5) = 212, e(4) = 68, e(3) = 22, e(2) = 6, e(1) = 2, e(0) = 0, f(n) = -f(n-1)+c(n-1)+e(n-1), f(5) = 108, f(4) = 34, f(3) = 10, f(2) = 2, f(1) = 0, f(0) = 0

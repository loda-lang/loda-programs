...
; Formula: a(n) = -2*truncate(A000120(A181819(A108951(truncate((A057335(n)-1)/A293810(A057335(n)-1))+1)))/2)+A000120(A181819(A108951(truncate((A057335(n)-1)/A293810(A057335(n)-1))+1)))

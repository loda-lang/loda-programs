...
; Formula: a(n) = -d(n-1)-e(n-1)+c(n-1)-2, a(4) = 9, a(3) = 1, a(2) = 2, a(1) = -2, a(0) = 1, b(n) = 2*b(n-1)+2*c(n-1)-2, b(4) = -70, b(3) = -34, b(2) = -14, b(1) = -6, b(0) = -2, c(n) = e(n-1), c(4) = 1, c(3) = 0, c(2) = -2, c(1) = 0, c(0) = 0, d(n) = 2*b(n-2)+2*c(n-2)-d(n-1)+e(n-2)-3, d(4) = -23, d(3) = -12, d(2) = -5, d(1) = -2, d(0) = 0, e(n) = -d(n-1)+c(n-1)-2, e(4) = 10, e(3) = 1, e(2) = 0, e(1) = -2, e(0) = 0

...
; Formula: a(n) = -d(n-1)-e(n-1)+c(n-1)-1, a(4) = 0, a(3) = 1, a(2) = -1, a(1) = -1, a(0) = 0, b(n) = 2*b(n-1)+2*c(n-1)-2, b(4) = -22, b(3) = -8, b(2) = -2, b(1) = 0, b(0) = 1, c(n) = e(n-1), c(4) = -1, c(3) = -2, c(2) = -1, c(1) = 0, c(0) = 0, d(n) = 2*c(n-1)-d(n-1)-e(n-2)+b(n-1), d(4) = -8, d(3) = -2, d(2) = -1, d(1) = 1, d(0) = 0, e(n) = -d(n-1)+c(n-1)-1, e(4) = -1, e(3) = -1, e(2) = -2, e(1) = -1, e(0) = 0

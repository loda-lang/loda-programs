...
; Formula: a(n) = (b(3*n+3)/(e(3*n+3)/(10^(n+1))))%10, b(n) = b(n-1)+c(n-1)+e(n-1)+32, b(3) = 576, b(2) = 128, b(1) = 32, b(0) = 0, c(n) = 2*c(n-1)+b(n-1)+e(n-1)+32, c(3) = 736, c(2) = 160, c(1) = 32, c(0) = 0, d(n) = 2*c(n-1)+b(n-1)+d(n-1)+e(n-1)+32, d(3) = 928, d(2) = 192, d(1) = 32, d(0) = 0, e(n) = 3*c(n-1)+2*e(n-1)+b(n-1)+d(n-1)+32, e(3) = 1344, e(2) = 256, e(1) = 32, e(0) = 0

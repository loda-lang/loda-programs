...
; Formula: a(n) = e(2*n), b(n) = b(n-2)-1, b(9) = 17, b(8) = 17, b(7) = 18, b(6) = 18, b(5) = 19, b(4) = 19, b(3) = 20, b(2) = 20, b(1) = 21, b(0) = 21, c(n) = (c(n-2)*b(n-2))/(d(n-2)+1)+c(n-2)+c(n-4), c(12) = 180775, c(11) = 46530, c(10) = 46530, c(9) = 10165, c(8) = 10165, c(7) = 1804, c(6) = 1804, c(5) = 243, c(4) = 243, c(3) = 22, c(2) = 22, c(1) = 1, c(0) = 1, d(n) = d(n-2)+1, d(9) = 4, d(8) = 4, d(7) = 3, d(6) = 3, d(5) = 2, d(4) = 2, d(3) = 1, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = c(n-2), e(9) = 1804, e(8) = 1804, e(7) = 243, e(6) = 243, e(5) = 22, e(4) = 22, e(3) = 1, e(2) = 1, e(1) = 0, e(0) = 0

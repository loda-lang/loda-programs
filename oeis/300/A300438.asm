...
; Formula: a(n) = a(n-1)+c(n-1)+d(n-1)+3, a(3) = 19, a(2) = 9, a(1) = 4, a(0) = 1, b(n) = a(n-1)+b(n-1), b(3) = 14, b(2) = 5, b(1) = 1, b(0) = 0, c(n) = 2*a(n-1)+2*b(n-1)+d(n-1)+1, c(3) = 26, c(2) = 10, c(1) = 3, c(0) = 0, d(n) = -c(n-1)-d(n-1)-1, d(3) = -8, d(2) = -3, d(1) = -1, d(0) = 0

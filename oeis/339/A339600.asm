...
; Formula: a(n) = b(n)/2+1, b(n) = 2*c(n-2)+2*d(n-2)+4, b(4) = 26, b(3) = 10, b(2) = 4, b(1) = 0, b(0) = 0, c(n) = 6*c(n-3)+4*d(n-3)+13, c(4) = 27, c(3) = 13, c(2) = 5, c(1) = 1, c(0) = 0, d(n) = 2*c(n-1)+d(n-1)+2, d(4) = 46, d(3) = 18, d(2) = 6, d(1) = 2, d(0) = 0

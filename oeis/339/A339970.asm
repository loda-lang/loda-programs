...
; Formula: a(n) = A329697(A181819(A181811(truncate((A057335(2*A048678(n))-1)/A293810(A057335(2*A048678(n))))+1)*(truncate((A057335(2*A048678(n))-1)/A293810(A057335(2*A048678(n))))+1)))

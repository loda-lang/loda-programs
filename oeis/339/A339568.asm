...
; Formula: a(n) = -100*truncate(truncate(b(max(10*n-5,0))/truncate((5*c(max(10*n-5,0)))/truncate(10^(2*n-1))))/100)+truncate(b(max(10*n-5,0))/truncate((5*c(max(10*n-5,0)))/truncate(10^(2*n-1)))), b(n) = 4*b(n-1)-2*b(n-2)+56, b(3) = 1064, b(2) = 280, b(1) = 56, b(0) = 0, c(n) = 2*b(n-1)+2*c(n-1)+112, c(1) = 112, c(0) = 0

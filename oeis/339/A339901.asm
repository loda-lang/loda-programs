...
; Submitted by bashno
; 1,1,1,1,1,3,3,3,1,5,5,5,15,3,5,15,1,3,3,3,1,9,9,9,15,15,5,15,9,45,5,45,1,1,1,1,3,3,1,3,5,1,5,5,5,15,15,15,3,3,1,3,9,9,3,9,1,15,15,15,15,9,45,45,1,9,9,9,9,27,27,27,45,45,5,45,135,135,45,135,9,27,27,27,3,81,81,81,135,27,45,135,405,405,5,405,9,9,3,9
; Formula: a(n) = A339971(n)/gcd(A339971(n),A005940(A048678(2*n))-1)

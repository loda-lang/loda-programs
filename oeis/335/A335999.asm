...
; Formula: a(n) = d(n-1)+a(n-1), a(3) = 4, a(2) = 3, a(1) = 2, a(0) = 1, b(n) = (-c(n-1)+b(n-1))/2, b(3) = -22, b(2) = -21, b(1) = -19, b(0) = -14, c(n) = c(n-1)*(((-c(n-1)+b(n-1))/2+d(n-1)/2)%2+2), c(3) = 48, c(2) = 24, c(1) = 24, c(0) = 24, d(n) = ((-c(n-1)+b(n-1))/2+d(n-1)/2)%2+2, d(3) = 2, d(2) = 1, d(1) = 1, d(0) = 1

...
; Formula: a(n) = e(n+2), b(n) = (-c(n-1)+b(n-1))/2, b(3) = -19, b(2) = -14, b(1) = -4, b(0) = 3, c(n) = c(n-1)*(((-c(n-1)+b(n-1))/2+d(n-1)/2)%2+2), c(3) = 24, c(2) = 24, c(1) = 24, c(0) = 12, d(n) = ((-c(n-1)+b(n-1))/2+d(n-1)/2)%2+2, d(3) = 1, d(2) = 1, d(1) = 2, d(0) = -1, e(n) = d(n-1)+e(n-1), e(3) = 2, e(2) = 1, e(1) = -1, e(0) = 0

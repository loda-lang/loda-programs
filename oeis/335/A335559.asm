...
; Formula: a(n) = b(n-1), a(3) = 10, a(2) = 2, a(1) = 1, a(0) = 0, b(n) = 2*b(n-1)+2*c(n-1)+2*d(n-1), b(3) = 36, b(2) = 10, b(1) = 2, b(0) = 1, c(n) = b(n-1), c(3) = 10, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = 2*b(n-1)+d(n-1), d(3) = 26, d(2) = 6, d(1) = 2, d(0) = 0

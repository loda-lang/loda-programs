...
; Formula: a(n) = max(min(n,0),-d(n)+b(n)), b(n) = c(n-2), b(4) = 3, b(3) = 1, b(2) = 0, b(1) = 0, b(0) = 1, c(n) = c(n-1)*(n+1)+c(n-2)*(n+1)+c(n-3), c(5) = 675, c(4) = 96, c(3) = 16, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = b(n-1), d(4) = 1, d(3) = 0, d(2) = 0, d(1) = 1, d(0) = 0

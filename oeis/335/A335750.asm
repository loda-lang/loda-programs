...
; Formula: a(n) = truncate(A295232(n)/gcd(binomial(2*n,n)*6^n,A295232(n)))

mov $1,$0
mov $3,$0
mul $3,2
bin $3,$0
seq $0,295232 ; Denominator of (-1)^(n+1) * (2*n)! * (2^(2*n)+1)/(B_{2*n} * 2^(4*n-1)), where B_{n} is the Bernoulli number.
mov $2,6
pow $2,$1
mul $2,$3
mov $1,$2

...
; Formula: a(n) = c(n)/2, b(n) = 3*b(n-1)-b(n-2)+1, b(6) = 88, b(5) = 33, b(4) = 12, b(3) = 4, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = 2*c(n-1)+2*d(n-1)+2*d(n-4)-c(n-3)-d(n-2)-d(n-5)+c(n-2)+c(n-4)-2, c(7) = 1045, c(6) = 355, c(5) = 117, c(4) = 37, c(3) = 11, c(2) = 3, c(1) = 1, c(0) = 1, d(n) = 2*d(n-1)+b(n-1)+1, d(4) = 21, d(3) = 8, d(2) = 3, d(1) = 1, d(0) = 0

...
; Formula: a(n) = c(n+1), b(n) = b(n-1)+b(n-2), b(5) = 8, b(4) = 5, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = b(n-1)+d(n-1)+e(n-1), c(5) = 19, c(4) = 8, c(3) = 4, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = c(n-1)+d(n-1), d(5) = 14, d(4) = 6, d(3) = 2, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = 2*e(n-1)+b(n-2), e(6) = 43, e(5) = 19, e(4) = 8, e(3) = 3, e(2) = 1, e(1) = 0, e(0) = 0

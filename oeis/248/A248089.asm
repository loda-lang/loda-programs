...
; Formula: a(n) = b(3*n+3)/2, b(n) = 2*d(n-1)-2*e(n-1)+b(n-1), b(3) = 2, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = 2*d(n-1)-2*e(n-1)+b(n-1), c(3) = 2, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 2*e(n-1)-b(n-1)-d(n-1)+c(n-1)+1, d(3) = 1, d(2) = 2, d(1) = 1, d(0) = 0, e(n) = -e(n-1)+b(n-1)+c(n-1)+d(n-1)+1, e(3) = 2, e(2) = 1, e(1) = 1, e(0) = 0

...
; Formula: a(n) = 9*a(n-1)-d(n-1)+b(n-1)+c(n-1), a(3) = 765, a(2) = 82, a(1) = 9, a(0) = 1, b(n) = a(n-1), b(3) = 82, b(2) = 9, b(1) = 1, b(0) = 0, c(n) = 9*a(n-1)+c(n-1), c(3) = 828, c(2) = 90, c(1) = 9, c(0) = 0, d(n) = 9*a(n-1)-d(n-1), d(3) = 666, d(2) = 72, d(1) = 9, d(0) = 0

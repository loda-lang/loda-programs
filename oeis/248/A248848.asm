...
; Formula: a(n) = 9*a(n-1)+a(n-2)+b(n-2)+c(n-2), a(3) = 765, a(2) = 82, a(1) = 9, a(0) = 1, b(n) = 9*a(n-1)+b(n-1), b(3) = 828, b(2) = 90, b(1) = 9, b(0) = 0, c(n) = 9*a(n-1)-c(n-1), c(3) = 666, c(2) = 72, c(1) = 9, c(0) = 0

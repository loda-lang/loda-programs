...
; Formula: a(n) = a(n-1)+d(n-1), a(4) = 1, a(3) = 0, a(2) = 0, a(1) = 0, a(0) = 0, b(n) = b(n-1)+min(b(n-2),a(n-1)+d(n-1))+1, b(4) = 5, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = b(n-1)+c(n-1)+d(n-1), c(4) = 7, c(3) = 3, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = c(n-1), d(4) = 3, d(3) = 1, d(2) = 0, d(1) = 0, d(0) = 0

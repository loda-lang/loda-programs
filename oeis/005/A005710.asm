...
; Formula: a(n) = b(n+2), b(n) = -c(n-1)+c(n-2), b(7) = 1, b(6) = 1, b(5) = 1, b(4) = 1, b(3) = 1, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = 2*c(n-1)-c(n-2)-c(n-9)+c(n-8), c(12) = -22, c(11) = -17, c(10) = -13, c(9) = -10, c(8) = -8, c(7) = -7, c(6) = -6, c(5) = -5, c(4) = -4, c(3) = -3, c(2) = -2, c(1) = -1, c(0) = 0

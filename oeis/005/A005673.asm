...
; Formula: a(n) = c(n-1), a(4) = 1, a(3) = 0, a(2) = 0, a(1) = 0, a(0) = 0, b(n) = 2*b(n-1)+2*a(n-1)-1, b(4) = -15, b(3) = -7, b(2) = -3, b(1) = -1, b(0) = 0, c(n) = -b(n-2)-c(n-1)+a(n-1), c(5) = 6, c(4) = 2, c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0

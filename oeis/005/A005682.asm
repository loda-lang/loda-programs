...
; Formula: a(n) = c(n-5), b(n) = truncate((-d(n-2)*c(n-1))/(b(n-1)+c(n-2)+d(n-2)+1)), b(3) = -1, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = b(n-1)+c(n-1)+d(n-1)+1, c(3) = 8, c(2) = 4, c(1) = 2, c(0) = 1, d(n) = c(n-1)+d(n-1), d(3) = 7, d(2) = 3, d(1) = 1, d(0) = 0

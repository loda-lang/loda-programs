...
; Formula: a(n) = b(n-1)+a(n-1)+c(n-1)+1, a(3) = 8, a(2) = 4, a(1) = 2, a(0) = 1, b(n) = truncate((-c(n-2)*a(n-1))/(b(n-1)+a(n-2)+c(n-2)+1)), b(3) = -1, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = a(n-1)+c(n-1), c(3) = 7, c(2) = 3, c(1) = 1, c(0) = 0

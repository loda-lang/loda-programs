...
; Formula: a(n) = e(n+1), b(n) = b(n-1)+c(n-1)-1, b(3) = 0, b(2) = -1, b(1) = -1, b(0) = 0, c(n) = d(n-1)+e(n-1), c(3) = 5, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = b(n-1)+c(n-1)+d(n-1), d(3) = 1, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = 2*e(n-1)+c(n-1), e(3) = 12, e(2) = 5, e(1) = 2, e(0) = 1

...
; Formula: a(n) = 2*(c(n)/3)+1, b(n) = 4*b(n-1)+e(n-1)+6, b(4) = 717, b(3) = 156, b(2) = 33, b(1) = 6, b(0) = 0, c(n) = 2*b(n-1)+d(n-1)+e(n-1)+3, c(4) = 387, c(3) = 84, c(2) = 18, c(1) = 3, c(0) = 0, d(n) = 2*c(n-1)-d(n-1)+f(n-1), d(4) = -75, d(3) = -15, d(2) = -3, d(1) = 0, d(0) = 0, e(n) = 2*b(n-1)+e(n-1)+3, e(4) = 402, e(3) = 87, e(2) = 18, e(1) = 3, e(0) = 0, f(n) = 2*c(n-1)-d(n-1)-2*e(n-1)-6*b(n-1)+f(n-1)-9, f(4) = -1194, f(3) = -258, f(2) = -54, f(1) = -9, f(0) = 0

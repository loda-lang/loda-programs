...
; Formula: a(n) = (a(n-1)*(b(n-1)+c(n-1)))/b(n-1)+a(n-2), a(3) = 6, a(2) = 3, a(1) = 2, a(0) = 0, b(n) = b(n-1)+b(n-2), b(3) = 8, b(2) = 5, b(1) = 3, b(0) = 2, c(n) = c(n-1)+c(n-2), c(4) = 8, c(3) = 5, c(2) = 3, c(1) = 2, c(0) = 1

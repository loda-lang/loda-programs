...
; Formula: a(n) = c(n+3), b(n) = 2*b(n-2)-b(n-4)-b(n-6)-2*b(n-5)+b(n-1), b(7) = 17, b(6) = 10, b(5) = 5, b(4) = 3, b(3) = 1, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = b(n-1), c(5) = 3, c(4) = 1, c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0

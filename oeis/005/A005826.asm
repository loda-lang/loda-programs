...
; Formula: a(n) = truncate((2*b(n+1))/3)-1, b(n) = 6*c(n-4)+5*c(n-1)+2*b(n-2)-2*c(n-2)-14*c(n-3)+6, b(7) = 20610, b(6) = 4509, b(5) = 990, b(4) = 213, b(3) = 48, b(2) = 9, b(1) = 3, b(0) = 0, c(n) = 5*c(n-1)-2*c(n-2)-3, c(6) = 4716, c(5) = 1035, c(4) = 228, c(3) = 51, c(2) = 12, c(1) = 3, c(0) = 0

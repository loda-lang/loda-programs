...
; Formula: a(n) = ((b(3*n+3)/5)/(c(3*n+3)/(10^(n+1))))%10, b(n) = 2*b(n-1)+2*c(n-1)+d(n-1), b(2) = 24, b(1) = 6, b(0) = 3, c(n) = 3*c(n-1)+2*b(n-1)+d(n-1), c(2) = 30, c(1) = 6, c(0) = 0, d(n) = c(n-1)+d(n-1), d(2) = 6, d(1) = 0, d(0) = 0

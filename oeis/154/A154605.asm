...
; Formula: a(n) = -10^n-10*truncate((-10^n+truncate((2*b(4*n))/(truncate(c(4*n)/(10^n))+1)))/10)+truncate((2*b(4*n))/(truncate(c(4*n)/(10^n))+1)), b(n) = 2*d(n-1)+b(n-1), b(3) = 65, b(2) = 9, b(1) = 1, b(0) = 1, c(n) = 2*b(n-1)+2*d(n-1)+c(n-1), c(3) = 86, c(2) = 12, c(1) = 2, c(0) = 0, d(n) = -truncate((-d(n-2)+d(n-1))/b(n-1))*b(n-1)+6*d(n-1)+4*b(n-1)+2*c(n-1)-d(n-2), d(4) = 1510, d(3) = 206, d(2) = 28, d(1) = 4, d(0) = 0

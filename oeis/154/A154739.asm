...
; Formula: a(n) = (b(4*n+4)/(e(4*n+4)/(10^(n+1))))%10, b(n) = 2*c(n-1)+b(n-1)+e(n-1), b(3) = -160, b(2) = -40, b(1) = -10, b(0) = -10, c(n) = 2*c(n-1)+b(n-1)+c(n-1)+e(n-1), c(3) = -210, c(2) = -50, c(1) = -10, c(0) = 0, d(n) = 2*c(n-1)-c(n-1)-e(n-1)+b(n-1)+c(n-1)+d(n-1)+e(n-1), d(3) = -180, d(2) = -40, d(1) = -10, d(0) = 0, e(n) = 2*c(n-1)-2*c(n-1)-2*e(n-1)+b(n-1)+c(n-1)+d(n-1)+e(n-1), e(3) = -110, e(2) = -20, e(1) = -10, e(0) = 0

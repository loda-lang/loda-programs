...
; Formula: a(n) = -10*truncate(truncate(b(4*n+4)/truncate(d(4*n+4)/(10^(n+1))))/10)+truncate(b(4*n+4)/truncate(d(4*n+4)/(10^(n+1)))), b(n) = 2*c(n-1)+b(n-1)+d(n-1), b(3) = -160, b(2) = -40, b(1) = -10, b(0) = -10, c(n) = 3*c(n-1)+b(n-1)+d(n-1), c(3) = -210, c(2) = -50, c(1) = -10, c(0) = 0, d(n) = 4*c(n-3)-c(n-4)+b(n-1)+c(n-1)+d(n-2)+d(n-3), d(5) = -1910, d(4) = -440, d(3) = -110, d(2) = -20, d(1) = -10, d(0) = 0

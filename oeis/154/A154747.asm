...
; Formula: a(n) = (b(3*n+3)/(2*(c(3*n+3)/(10^(n+1)))))%10, b(n) = 2*b(n-1)+2*c(n-1)+2*e(n-1), b(3) = 400, b(2) = 80, b(1) = 20, b(0) = 0, c(n) = 2*c(n-1)+b(n-1)+c(n-1)+e(n-1), c(3) = 320, c(2) = 60, c(1) = 10, c(0) = 0, d(n) = 2*c(n-1)+2*d(n-1)-c(n-1)-e(n-1)+b(n-1)+c(n-1)+e(n-1), d(3) = 280, d(2) = 40, d(1) = 0, d(0) = 0, e(n) = 4*c(n-1)+2*d(n-1)+2*e(n-1)-c(n-1)-e(n-1)+b(n-1), e(3) = 400, e(2) = 60, e(1) = 10, e(0) = 10

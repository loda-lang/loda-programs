...
; Formula: a(n) = e(n+1)+3, b(n) = 2*c(n-1)+2*d(n-1)+b(n-1)+e(n-1)+3, b(3) = 32, b(2) = 11, b(1) = 3, b(0) = 0, c(n) = 0, c(3) = 0, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = c(n-1)+d(n-1)+e(n-1)+3, d(3) = 16, d(2) = 5, d(1) = 3, d(0) = 0, e(n) = 2*c(n-1)+2*d(n-1)+b(n-1)-1, e(3) = 20, e(2) = 8, e(1) = -1, e(0) = 0

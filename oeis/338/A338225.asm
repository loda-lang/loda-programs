...
; Formula: a(n) = c(n)+1, b(n) = -b(n-1), b(2) = 2, b(1) = -2, b(0) = 2, c(n) = 3*b(n-1)+2*c(n-1)+d(n-1)+2, c(2) = 22, c(1) = 10, c(0) = 1, d(n) = 3*d(n-1)+2*b(n-1)-d(n-2)+b(n-3)+1, d(4) = 102, d(3) = 40, d(2) = 13, d(1) = 6, d(0) = 0

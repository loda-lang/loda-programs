...
; Formula: a(n) = d(n)+1, b(n) = 2*b(n-1)-n+1, b(6) = -57, b(5) = -26, b(4) = -11, b(3) = -4, b(2) = -1, b(1) = 0, b(0) = 0, c(n) = 3*c(n-1)-c(n-2)+4, c(8) = 7371, c(7) = 2813, c(6) = 1072, c(5) = 407, c(4) = 153, c(3) = 56, c(2) = 19, c(1) = 5, c(0) = 0, d(n) = 3*d(n-1)-d(n-2)+b(n-1)+c(n-2)+2, d(8) = 7569, d(7) = 2467, d(6) = 786, d(5) = 243, d(4) = 72, d(3) = 20, d(2) = 5, d(1) = 1, d(0) = 0

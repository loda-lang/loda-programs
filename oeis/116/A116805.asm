...
; Formula: a(n) = d(n+1)/2+1, b(n) = (n-2)*(n-1)+4*b(n-1)-2*b(n-2), b(4) = 246, b(3) = 70, b(2) = 20, b(1) = 6, b(0) = 2, c(n) = (n-2)*(n-1)+b(n-1)+c(n-1), c(3) = 30, c(2) = 8, c(1) = 2, c(0) = 0, d(n) = c(n-1)+d(n-1), d(3) = 10, d(2) = 2, d(1) = 0, d(0) = 0

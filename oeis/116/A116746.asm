...
; Formula: a(n) = truncate(e(n)/4)+1, b(n) = 4*c(n-1)+3*b(n-1)+2*d(n-1), b(4) = 226, b(3) = 68, b(2) = 20, b(1) = 6, b(0) = 2, c(n) = -d(n-1)+c(n-1), c(7) = -1491, c(6) = -441, c(5) = -124, c(4) = -32, c(3) = -7, c(2) = -1, c(1) = 0, c(0) = 0, d(n) = b(n-1)+d(n-1)-1, d(4) = 92, d(3) = 25, d(2) = 6, d(1) = 1, d(0) = 0, e(n) = 2*b(n-1)+2*e(n-1), e(4) = 296, e(3) = 80, e(2) = 20, e(1) = 4, e(0) = 0

...
; Formula: a(n) = d(n-1), b(n) = 3*b(n-1)+c(n-1), b(3) = 7, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = c(n-1)+e(n-1), c(3) = 12, c(2) = 4, c(1) = 1, c(0) = 0, d(n) = 3*b(n-1)+c(n-1)+d(n-1)+e(n-1), d(3) = 21, d(2) = 6, d(1) = 2, d(0) = 1, e(n) = 3*b(n-2)+3*e(n-1)-e(n-2)+c(n-2), e(4) = 65, e(3) = 22, e(2) = 8, e(1) = 3, e(0) = 1

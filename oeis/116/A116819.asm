...
; Formula: a(n) = 3*b(n-1)+c(n-1)+a(n-1)+d(n-1), a(3) = 21, a(2) = 6, a(1) = 2, a(0) = 1, b(n) = 3*b(n-1)+c(n-1), b(3) = 7, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = c(n-1)+d(n-1), c(3) = 12, c(2) = 4, c(1) = 1, c(0) = 0, d(n) = 2*d(n-1)+a(n-1), d(3) = 22, d(2) = 8, d(1) = 3, d(0) = 1

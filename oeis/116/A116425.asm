...
; Formula: a(n) = floor(b(max(3*n-3,0))/floor(c(max(3*n-3,0))/(10^(n-1))))%10, b(n) = b(n-1)+c(n-1), b(2) = 14, b(1) = 4, b(0) = 3, c(n) = 4*c(n-1)+2*b(n-1)+d(n-1), c(2) = 53, c(1) = 10, c(0) = 1, d(n) = 2*c(n-1)+b(n-1)+d(n-1), d(2) = 29, d(1) = 5, d(0) = 0

...
; Formula: a(n) = e(n)+1, b(n) = 2*b(n-1)+c(n-1)+1, b(6) = 192, b(5) = 80, b(4) = 32, b(3) = 12, b(2) = 4, b(1) = 1, b(0) = 0, c(n) = 2*c(n-1)+1, c(6) = 63, c(5) = 31, c(4) = 15, c(3) = 7, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = c(n-1)+d(n-1), d(5) = 26, d(4) = 11, d(3) = 4, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = 3*e(n-1)-e(n-2)+b(n-1)+c(n-2)+d(n-2)+1, e(7) = 2275, e(6) = 755, e(5) = 240, e(4) = 72, e(3) = 20, e(2) = 5, e(1) = 1, e(0) = 0

...
; Formula: a(n) = e(n)+1, b(n) = b(n-1)+b(n-2)+2, b(4) = 19, b(3) = 11, b(2) = 6, b(1) = 3, b(0) = 1, c(n) = 2*c(n-3)+2*d(n-3)+b(n-3)+c(n-2)+5, c(4) = 17, c(3) = 7, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = b(n-1)+c(n-1)+d(n-1)+1, d(4) = 36, d(3) = 17, d(2) = 7, d(1) = 2, d(0) = 0, e(n) = c(n-1)+d(n-1)+1, e(4) = 25, e(3) = 11, e(2) = 4, e(1) = 1, e(0) = 0

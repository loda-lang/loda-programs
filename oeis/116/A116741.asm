...
; Formula: a(n) = d(n-1)+1, b(n) = 2*b(n-1)+2*n-2, b(6) = 114, b(5) = 52, b(4) = 22, b(3) = 8, b(2) = 2, b(1) = 0, b(0) = 0, c(n) = 3*c(n-1)-c(n-2)+1, c(8) = 2583, c(7) = 986, c(6) = 376, c(5) = 143, c(4) = 54, c(3) = 20, c(2) = 7, c(1) = 2, c(0) = 0, d(n) = 3*d(n-1)-d(n-2)+b(n-1)+c(n-2)+2, d(8) = 6723, d(7) = 2287, d(6) = 756, d(5) = 240, d(4) = 72, d(3) = 20, d(2) = 5, d(1) = 1, d(0) = 0

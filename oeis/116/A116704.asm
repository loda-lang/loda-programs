...
; Formula: a(n) = f1(n)+1, b(n) = 2*f(n-1)+b(n-1)+c(n-1)+d(n-1)+e(n-1)+f2(n-1), b(6) = 511, b(5) = 133, b(4) = 33, b(3) = 7, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = c(n-1)+d(n-1)+f(n-1)+f2(n-1), c(6) = 321, c(5) = 83, c(4) = 21, c(3) = 5, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = 2*d(n-1)+c(n-1)+f(n-1)+1, d(6) = 455, d(5) = 117, d(4) = 31, d(3) = 9, d(2) = 3, d(1) = 1, d(0) = 0, e(n) = -b(n-1)-f(n-1)-f2(n-1)+e(n-1), e(6) = -334, e(5) = -80, e(4) = -16, e(3) = -2, e(2) = 0, e(1) = 0, e(0) = 0, f(n) = 2*c(n-1)+2*f(n-1)+d(n-1)+f2(n-1), f(6) = 541, f(5) = 137, f(4) = 33, f(3) = 7, f(2) = 1, f(1) = 0, f(0) = 0, f1(n) = c(n-1)+d(n-1)+f(n-1), f1(6) = 337, f1(5) = 85, f1(4) = 21, f1(3) = 5, f1(2) = 1, f1(1) = 0, f1(0) = 0, f2(n) = e(n-1), f2(6) = -80, f2(5) = -16, f2(4) = -2, f2(3) = 0, f2(2) = 0, f2(1) = 0, f2(0) = 0

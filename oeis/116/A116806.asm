...
; Formula: a(n) = truncate(b(n-1)/2)+1, b(n) = 2*b(n-1)+2*d(n-1)-2*c(n-1)+2, b(4) = 148, b(3) = 40, b(2) = 10, b(1) = 2, b(0) = 0, c(n) = 4*c(n-1)+4*d(n-2)-d(n-1)-2*d(n-3)-6*c(n-2)+b(n-3)+c(n-3)+1, c(7) = 442, c(6) = 69, c(5) = -6, c(4) = -12, c(3) = -7, c(2) = -3, c(1) = -1, c(0) = 0, d(n) = 2*d(n-1)-c(n-1)+b(n-1)+1, d(4) = 100, d(3) = 26, d(2) = 6, d(1) = 1, d(0) = 0

...
; Formula: a(n) = a(n-1)+c(n-1)+d(n-1), a(4) = 73, a(3) = 21, a(2) = 6, a(1) = 2, a(0) = 1, b(n) = -b(n-2)+b(n-1)+1, b(4) = 2, b(3) = 2, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = 2*((3*c(n-1))/2)+2*b(n-1)+2*e(n-1)+1, c(4) = 115, c(3) = 37, c(2) = 11, c(1) = 3, c(0) = 1, d(n) = c(n-1)+d(n-1), d(4) = 52, d(3) = 15, d(2) = 4, d(1) = 1, d(0) = 0, e(n) = -b(n-1)+1, e(4) = -1, e(3) = 0, e(2) = 1, e(1) = 1, e(0) = 0

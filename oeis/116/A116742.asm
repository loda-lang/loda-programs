...
; Formula: a(n) = e(n-1)+1, b(n) = 2*b(n-1)+2*d(n-1)+2*f(n-1), b(4) = 30, b(3) = 4, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = 2*c(n-1)-d(n-1)+e(n-1)+f(n-1)+1, c(4) = 98, c(3) = 26, c(2) = 6, c(1) = 1, c(0) = 0, d(n) = 2*d(n-1)-e(n-1)+b(n-1)+f(n-1)-1, d(4) = -13, d(3) = -7, d(2) = -3, d(1) = -1, d(0) = 0, e(n) = 2*e(n-1)-d(n-1)+c(n-1)+1, e(4) = 74, e(3) = 20, e(2) = 5, e(1) = 1, e(0) = 0, f(n) = -b(n-1)-2*d(n-1)+c(n-1)+e(n-1)+1, f(4) = 57, f(3) = 18, f(2) = 5, f(1) = 1, f(0) = 0

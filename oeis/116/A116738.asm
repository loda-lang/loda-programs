...
; Formula: a(n) = 2*c(n-1)+2*a(n-1)-2*b(n-1)+b(n-1)+c(n-1), a(2) = 6, a(1) = 2, a(0) = 1, b(n) = -b(n-1)+b(n-1)+c(n-1)+a(n-1), b(2) = 3, b(1) = 1, b(0) = 0, c(n) = 2*c(n-1)-b(n-1)+b(n-1)+a(n-1), c(2) = 4, c(1) = 1, c(0) = 0

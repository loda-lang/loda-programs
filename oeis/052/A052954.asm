...
; Formula: a(n) = d(n)+1, b(n) = b(n-1)/2, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = 2*d(n-1)-b(n-1)-c(n-1)-d(n-1)-e(n-1)+b(n-1)+c(n-1)+e(n-1), c(3) = 1, c(2) = 0, c(1) = 1, c(0) = 0, d(n) = 2*b(n-1)+2*c(n-1)+2*(2*d(n-1))+2*e(n-1)-2*b(n-1)-2*e(n-1)-4*d(n-1)+b(n-1)+e(n-1), d(3) = 1, d(2) = 1, d(1) = 0, d(0) = 1, e(n) = -b(n-1)-e(n-1)-2*d(n-1)+b(n-1)+c(n-1)+d(n-1)+e(n-1), e(3) = -1, e(2) = 1, e(1) = -1, e(0) = 0

...
; Formula: a(n) = d(n)*c(n)^2, b(n) = 2*b(n-1)+b(n-2), b(3) = 5, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = 2*c(n-1)+c(n-2), c(4) = 12, c(3) = 5, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = b(n-1)+c(n-1)+d(n-1), d(2) = 3, d(1) = 1, d(0) = 1

...
; Formula: a(n) = n*truncate((truncate(A000010(n)/gcd(A000010(n),-A109606(n-1)+n-1))*(-A109606(n-1)+n-1))/gcd(truncate(A000010(n)/gcd(A000010(n),-A109606(n-1)+n-1))*(-A109606(n-1)+n-1),n))

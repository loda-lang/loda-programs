...
; Formula: a(n) = f(n+4), b(n) = -e(n-1)+b(n-1)+d(n-1), b(5) = 8, b(4) = 5, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = 2*c(n-2)+2*c(n-3)+2*d(n-3)+2*e(n-3)-c(n-3)-d(n-3)-2*e(n-3)+b(n-3)+c(n-1)+c(n-3), c(5) = 9, c(4) = 3, c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = -e(n-1)+b(n-1)+c(n-1)+d(n-1), d(5) = 11, d(4) = 6, d(3) = 3, d(2) = 2, d(1) = 1, d(0) = 0, e(n) = -e(n-1)+c(n-1)+d(n-1), e(5) = 6, e(4) = 3, e(3) = 1, e(2) = 1, e(1) = 0, e(0) = 0, f(n) = c(n-1)+e(n-1), f(5) = 6, f(4) = 2, f(3) = 1, f(2) = 0, f(1) = 0, f(0) = 0

...
; Formula: a(n) = b(n+5)/3, b(n) = d(n-3), b(7) = 9, b(6) = 3, b(5) = 3, b(4) = 0, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = -e(n-2)+c(n-1)+c(n-2)+1, c(8) = 15, c(7) = 7, c(6) = 7, c(5) = 3, c(4) = 3, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = 3*c(n-2)+3*d(n-3)-3*d(n-4)-3*e(n-2)+d(n-1)+3, d(8) = 99, d(7) = 48, d(6) = 30, d(5) = 18, d(4) = 9, d(3) = 3, d(2) = 3, d(1) = 0, d(0) = 0, e(n) = -e(n-1)+c(n-1)+1, e(7) = 8, e(6) = 0, e(5) = 4, e(4) = 0, e(3) = 2, e(2) = 0, e(1) = 1, e(0) = 0

...
; Formula: a(n) = b(n+5)/3, b(n) = e(n-3), b(7) = 9, b(6) = 3, b(5) = 3, b(4) = 0, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = -f(n-1)+c(n-1)+d(n-1)+1, c(7) = 15, c(6) = 7, c(5) = 7, c(4) = 3, c(3) = 3, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = c(n-1), d(7) = 7, d(6) = 7, d(5) = 3, d(4) = 3, d(3) = 1, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = 6*d(n-4)+3*e(n-3)-3*e(n-4)-6*f(n-4)+e(n-1)+6, e(7) = 48, e(6) = 30, e(5) = 18, e(4) = 9, e(3) = 3, e(2) = 3, e(1) = 0, e(0) = 0, f(n) = -f(n-1)+d(n-1)+1, f(7) = 8, f(6) = 0, f(5) = 4, f(4) = 0, f(3) = 2, f(2) = 0, f(1) = 1, f(0) = 0

...
; Formula: a(n) = f1(n+4), b(n) = -b(n-1)-d(n-1)+f1(n-1), b(6) = 0, b(5) = -2, b(4) = 1, b(3) = 0, b(2) = 0, b(1) = -1, b(0) = 1, c(n) = 4*c(n-2)+2*d(n-2)-f1(n-2)+c(n-1)+f(n-2), c(6) = 32, c(5) = 11, c(4) = 3, c(3) = 2, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 2*c(n-1)-f1(n-1)+b(n-1)+d(n-1), d(6) = 22, d(5) = 8, d(4) = 3, d(3) = 0, d(2) = 0, d(1) = 1, d(0) = 0, e(n) = 2*c(n-1)-f1(n-1)+d(n-1), e(6) = 24, e(5) = 7, e(4) = 3, e(3) = 0, e(2) = 1, e(1) = 0, e(0) = 0, f(n) = 2*c(n-1)+d(n-1)+f(n-1), f(6) = 44, f(5) = 14, f(4) = 5, f(3) = 1, f(2) = 1, f(1) = 0, f(0) = 0, f1(n) = c(n-1)+e(n-1), f1(6) = 18, f1(5) = 6, f1(4) = 2, f1(3) = 1, f1(2) = 0, f1(1) = 0, f1(0) = 0

...
; Formula: a(n) = c(n+2)+1, b(n) = b(n-1)+b(n-2), b(3) = 8, b(2) = 5, b(1) = 3, b(0) = 2, c(n) = d(n-1)+e(n-1), c(3) = 5, c(2) = 3, c(1) = 1, c(0) = 1, d(n) = b(n-1), d(3) = 5, d(2) = 3, d(1) = 2, d(0) = 1, e(n) = d(n-2)+e(n-1)+e(n-2), e(3) = 5, e(2) = 2, e(1) = 1, e(0) = 0

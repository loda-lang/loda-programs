...
; Formula: a(n) = c(n+2)+1, b(n) = b(n-1)+b(n-2), b(3) = 8, b(2) = 5, b(1) = 3, b(0) = 2, c(n) = b(n-2)+c(n-2)+d(n-2), c(3) = 5, c(2) = 3, c(1) = 1, c(0) = 1, d(n) = b(n-3)+d(n-1)+d(n-2), d(3) = 5, d(2) = 2, d(1) = 1, d(0) = 0

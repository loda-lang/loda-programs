...
; Formula: a(n) = e(n+4), b(n) = -b(n-1)-c(n-1)-d(n-1), b(5) = -2, b(4) = -1, b(3) = 0, b(2) = 0, b(1) = -1, b(0) = 1, c(n) = 4*c(n-4)+2*b(n-4)+2*c(n-3)+2*d(n-4)-b(n-4)-c(n-4)-d(n-4)+c(n-2)+c(n-3)+c(n-4)+d(n-4), c(5) = 2, c(4) = 1, c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 2*c(n-1)+b(n-1)+d(n-1), d(5) = 3, d(4) = 2, d(3) = 0, d(2) = 0, d(1) = 1, d(0) = 0, e(n) = c(n-2)+d(n-2), e(5) = 1, e(4) = 0, e(3) = 1, e(2) = 0, e(1) = 0, e(0) = 0

...
; 0,1,1,1,1,3,1,0,1,3,1,3,1,3,3,0,1,3,1,3,3,3,1,2,1,3,0,3,1,7,1,0,3,3,3,3,1,3,3,2,1,7,1,3,3,3,1,2,1,3,3,3,1,2,3,2,3,3,1,7,1,3,3,0,3,7,1,3,3,7,1,3,1,3,3,3,3,7,1,2
; Formula: a(n) = -A304327(n)+A034444(n+1)

...
; Formula: a(n) = e(n+1), b(n) = (-4*c(n-1)+b(n-1)+1)/4, b(3) = -515, b(2) = -16, b(1) = -1, b(0) = 0, c(n) = 8*gcd((-4*c(n-1)+b(n-1)+1)/4+d(n-1),4)*c(n-1), c(3) = 8192, c(2) = 512, c(1) = 16, c(0) = 2, d(n) = gcd((-4*c(n-1)+b(n-1)+1)/4+d(n-1),4)/4, d(3) = 0, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = d(n-1)+e(n-1)+2, e(3) = 7, e(2) = 4, e(1) = 2, e(0) = 0

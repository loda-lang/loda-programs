...
; 0,1,2,1,3,1,2,4,1,2,1,3,5,1,2,6,1,4,2,3,1,7,1,2,8,1,3,2,4,1,5,9,1,2,3,1,6,2,1,4,10,1,2,3,11,1,2,5,1,7,3,4,1,2,12,1,8,2,6,1,3,13,1,2,4,14,1,5,2,3,1,9,15,1,2,4,1,3,2,7
; Formula: a(n) = A230980(A027748(n+1))

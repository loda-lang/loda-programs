...
; Formula: a(n) = 4*truncate((max(a(n-1)+1,5)^3)/b(n-1))*b(n-1)-17*truncate((4*truncate((max(a(n-1)+1,5)^3)/b(n-1))*b(n-1)+a(n-1))/(17*b(n-1)))*b(n-1)+a(n-1), a(3) = 3492, a(2) = 24, a(1) = 7, a(0) = 0, b(n) = 17*b(n-1), b(2) = 289, b(1) = 17, b(0) = 1

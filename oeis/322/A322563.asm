...
; Formula: a(n) = (4*b(n-1)*((max(c(n-1),5)^3)/b(n-1))+a(n-1))%(17*b(n-1)), a(2) = 24, a(1) = 7, a(0) = 0, b(n) = 17*b(n-1), b(2) = 289, b(1) = 17, b(0) = 1, c(n) = (4*b(n-1)*((max(c(n-1),5)^3)/b(n-1))+a(n-1))%(17*b(n-1))+1, c(2) = 25, c(1) = 8, c(0) = 0

...
; Formula: a(n) = -c(n)+b(n), b(n) = 17*b(n-1), b(2) = 289, b(1) = 17, b(0) = 1, c(n) = 2*truncate((c(n-1)^6)/b(n-1))*b(n-1)-17*truncate((2*truncate((c(n-1)^6)/b(n-1))*b(n-1)+c(n-1)-1)/(17*b(n-1)))*b(n-1)+c(n-1), c(3) = 4290, c(2) = 244, c(1) = 6, c(0) = 1

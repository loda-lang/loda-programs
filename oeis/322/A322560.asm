...
; Formula: a(n) = -d(n)+b(n), b(n) = 17*b(n-1), b(2) = 289, b(1) = 17, b(0) = 1, c(n) = (2*b(n-1)*((d(n-1)^6)/b(n-1))+c(n-1))%(17*b(n-1)), c(2) = 243, c(1) = 5, c(0) = 3, d(n) = (2*b(n-1)*((d(n-1)^6)/b(n-1))+c(n-1))%(17*b(n-1))+1, d(2) = 244, d(1) = 6, d(0) = 1

...
; Formula: a(n) = (4*b(n-1)*((c(n-1)^3)/b(n-1))+c(n-1))%(17*b(n-1))+1, a(2) = 265, a(1) = 10, a(0) = 0, b(n) = 17*b(n-1), b(2) = 289, b(1) = 17, b(0) = 1, c(n) = (4*b(n-1)*((c(n-1)^3)/b(n-1))+c(n-1))%(17*b(n-1)), c(2) = 264, c(1) = 9, c(0) = 3

...
; Formula: a(n) = (2*b(n-1)*((c(n-1)^6)/b(n-1))+c(n-1)-1)%(17*b(n-1))+1, a(4) = 43594, a(3) = 4290, a(2) = 244, a(1) = 6, a(0) = 0, b(n) = 17*b(n-1), b(3) = 4913, b(2) = 289, b(1) = 17, b(0) = 1, c(n) = (2*b(n-1)*((c(n-1)^6)/b(n-1))+c(n-1)-1)%(17*b(n-1))+1, c(4) = 43594, c(3) = 4290, c(2) = 244, c(1) = 6, c(0) = 1

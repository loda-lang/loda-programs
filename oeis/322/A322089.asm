...
; Formula: a(n) = (a(n-1)^2+c(n-1)+2)%(8*b(n-1)+5*b(n-1))+4, a(2) = 45, a(1) = 6, a(0) = 0, b(n) = 8*b(n-1)+5*b(n-1), b(2) = 169, b(1) = 13, b(0) = 1, c(n) = (a(n-1)^2+c(n-1)+2)%(8*b(n-1)+5*b(n-1))+1, c(2) = 42, c(1) = 3, c(0) = 0

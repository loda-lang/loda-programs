...
; Formula: a(n) = c(n+1)/d(n+1), b(n) = 17*b(n-1), b(3) = 4913, b(2) = 289, b(1) = 17, b(0) = 1, c(n) = (4*b(n-1)*(((c(n-1)+1)^3)/b(n-1))+c(n-1))%(17*b(n-1)), c(4) = 3492, c(3) = 3492, c(2) = 24, c(1) = 7, c(0) = 3, d(n) = b(n-1), d(3) = 289, d(2) = 17, d(1) = 1, d(0) = 0

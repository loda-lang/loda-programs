...
; Formula: a(n) = truncate(b(n+1)/c(n+1)), b(n) = 4*truncate(((b(n-1)+1)^3)/(17^(n-1)))*17^(n-1)-17*truncate((4*truncate(((b(n-1)+1)^3)/(17^(n-1)))*17^(n-1)+b(n-1))/(17*17^(n-1)))*17^(n-1)+b(n-1), b(4) = 3492, b(3) = 3492, b(2) = 24, b(1) = 7, b(0) = 3, c(n) = 17^(n-1), c(3) = 289, c(2) = 17, c(1) = 1, c(0) = 0

...
; Formula: a(n) = b(n)+1, b(n) = -truncate((b(n-1)+b(n-2)+1)/(b(n-3)+d(n-1)-1))*(b(n-3)+d(n-1)-1)+b(n-1)+b(n-2)+1, b(4) = 4, b(3) = 2, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = b(n-2), c(4) = 1, c(3) = 0, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = -b(n-1)+c(n-1)+d(n-1)-1, d(4) = -7, d(3) = -4, d(2) = -2, d(1) = -1, d(0) = 0

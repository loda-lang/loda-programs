...
; Formula: a(n) = c(max(n-1,0))-3, b(n) = 8*c(n-1)+4*b(n-1)+4*d(n-1)-8*b(n-1)+b(n-1)-16, b(2) = 18, b(1) = 10, b(0) = 2, c(n) = b(n-1)+c(n-1)-2, c(2) = 12, c(1) = 4, c(0) = 4, d(n) = 8*c(n-1)+4*b(n-1)+4*d(n-1)-8*b(n-1)-16, d(2) = 8, d(1) = 8, d(0) = 0

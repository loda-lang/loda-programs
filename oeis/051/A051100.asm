...
; Formula: a(n) = -A033203(n-1)*(A264668(n-1)-1)

#offset 1

sub $0,1
mov $1,$0
seq $1,33203 ; Primes p congruent to {1, 2, 3} (mod 8); or primes p of form x^2 + 2*y^2; or primes p such that x^2 = -2 has a solution mod p.

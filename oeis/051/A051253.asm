...
; Formula: a(n) = c(n-3), b(n) = 4*b(n-2)-4*b(n-5)-6*b(n-4)+b(n-1)-2, b(6) = 145, b(5) = 65, b(4) = 29, b(3) = 11, b(2) = 5, b(1) = 1, b(0) = 0, c(n) = 4*b(n-1)-4*b(n-4)-6*b(n-3)-2, c(5) = 80, c(4) = 36, c(3) = 18, c(2) = 6, c(1) = 4, c(0) = 1

...
; Formula: a(n) = 4*b(n-1)-4*b(n-4)-6*b(n-3)-2, a(5) = 80, a(4) = 36, a(3) = 18, a(2) = 6, a(1) = 4, a(0) = 1, b(n) = 4*b(n-2)-4*b(n-5)-6*b(n-4)+b(n-1)-2, b(6) = 145, b(5) = 65, b(4) = 29, b(3) = 11, b(2) = 5, b(1) = 1, b(0) = 0

...
; Formula: a(n) = 2*c(n-1)+b(n-1)+a(n-1)+1, a(4) = 36, a(3) = 18, a(2) = 6, a(1) = 4, a(0) = 1, b(n) = b(n-1)+a(n-1), b(4) = 29, b(3) = 11, b(2) = 5, b(1) = 1, b(0) = 0, c(n) = 2*c(n-2)+2*c(n-3)+1, c(4) = 7, c(3) = 3, c(2) = 3, c(1) = 0, c(0) = 1

...
; Formula: a(n) = a(n-1)+d(n-1), a(5) = 61, a(4) = 28, a(3) = 12, a(2) = 5, a(1) = 1, a(0) = 1, b(n) = b(n-1)+b(n-2), b(5) = 10, b(4) = 6, b(3) = 4, b(2) = 2, b(1) = 2, b(0) = 0, c(n) = b(n-1), c(5) = 6, c(4) = 4, c(3) = 2, c(2) = 2, c(1) = 0, c(0) = 2, d(n) = 2*b(n-3)+a(n-3)+c(n-3)+d(n-2)+d(n-3)+max(-a(n-3)-d(n-3)+d(n-1),1)+max(-a(n-3)+d(n-2),1), d(5) = 66, d(4) = 33, d(3) = 16, d(2) = 7, d(1) = 4, d(0) = 0

...
; Formula: a(n) = a(n-1)+c(n-1), a(5) = 61, a(4) = 28, a(3) = 12, a(2) = 5, a(1) = 1, a(0) = 1, b(n) = b(n-1)+b(n-2), b(5) = 10, b(4) = 6, b(3) = 4, b(2) = 2, b(1) = 2, b(0) = 0, c(n) = b(n-1)+a(n-1)+max(-a(n-2)+c(n-1),1)+max(-a(n-3)+c(n-2),1), c(6) = 130, c(5) = 66, c(4) = 33, c(3) = 16, c(2) = 7, c(1) = 4, c(0) = 0

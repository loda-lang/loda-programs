; A352313: a(n) is -2^(2n) times the derivative of order 2n of the logarithm of J_0(x) (the Bessel function of the first kind of order zero) evaluated at zero.
...
; Formula: a(n) = 2*A181167(max(n-1,0))*(max(n-1,0)+n)

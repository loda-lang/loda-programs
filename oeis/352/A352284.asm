...
; Formula: a(n) = 2*((-(A352313(n)*(-1)^n))/2)

mov $1,-1
pow $1,$0
seq $0,352313 ; a(n) is -2^(2n) times the derivative of order 2n of the logarithm of J_0(x) (the Bessel function of the first kind of order zero) evaluated at zero.
mul $0,$1
sub $2,$0
mov $0,$2
div $0,2

...
; Formula: a(n) = c(n+1), b(n) = -d(n-2)+b(n-1)+b(n-2)+c(n-2)+1, b(4) = 15, b(3) = 8, b(2) = 4, b(1) = 2, b(0) = 1, c(n) = b(n-1), c(4) = 8, c(3) = 4, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = -c(n-2)-d(n-1)+d(n-2), d(4) = -1, d(3) = -1, d(2) = 0, d(1) = 0, d(0) = 0

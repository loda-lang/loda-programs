...
; Formula: a(n) = d(n+1), b(n) = b(n-1)+c(n-1)+1, b(4) = 15, b(3) = 8, b(2) = 4, b(1) = 2, b(0) = 1, c(n) = -e(n-1)+b(n-1)+d(n-1), c(4) = 13, c(3) = 6, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = b(n-1), d(4) = 8, d(3) = 4, d(2) = 2, d(1) = 1, d(0) = 0, e(n) = -c(n-1)-e(n-1)+d(n-1), e(4) = -1, e(3) = -1, e(2) = 0, e(1) = 0, e(0) = 0

...
; Formula: a(n) = d(n)*c(n), b(n) = -b(n-1)-e(n-1)+d(n-1), b(3) = 2, b(2) = 0, b(1) = 1, b(0) = 0, c(n) = -e(n-1)+d(n-1), c(3) = 2, c(2) = 1, c(1) = 1, c(0) = 1, d(n) = b(n-1)+d(n-1), d(3) = 2, d(2) = 2, d(1) = 1, d(0) = 1, e(n) = -e(n-2)+d(n-2)-1, e(3) = 0, e(2) = 0, e(1) = 0, e(0) = 0

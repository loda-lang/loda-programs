...
; Formula: a(n) = 4*a(n-1)+3*b(n-1)-a(n-2)-b(n-2)-c(n-2)-4, a(6) = 1429, a(5) = 407, a(4) = 117, a(3) = 34, a(2) = 10, a(1) = 3, a(0) = 1, b(n) = 3*b(n-1)-b(n-2)-2, b(6) = -32, b(5) = -11, b(4) = -3, b(3) = 0, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = a(n-1)+c(n-1), c(4) = 48, c(3) = 14, c(2) = 4, c(1) = 1, c(0) = 0

...
; Formula: a(n) = 4*a(n-1)-a(n-2)-d(n-2)+b(n-1)+c(n-1), a(4) = 117, a(3) = 34, a(2) = 10, a(1) = 3, a(0) = 1, b(n) = 2*b(n-1)+c(n-1), b(4) = -10, b(3) = -5, b(2) = -3, b(1) = -2, b(0) = -1, c(n) = b(n-1)+c(n-1)+2, c(4) = -3, c(3) = 0, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = a(n-1)+d(n-1), d(4) = 48, d(3) = 14, d(2) = 4, d(1) = 1, d(0) = 0

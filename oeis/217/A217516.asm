...
; Formula: a(n) = -truncate((8^n)/gcd(n,2))-10*truncate((-truncate((8^n)/gcd(n,2))-10*truncate((-truncate((8^n)/gcd(n,2))+gcd(n,2)+5)/10)+gcd(n,2)+15)/10)-10*truncate((-truncate((8^n)/gcd(n,2))+gcd(n,2)+5)/10)+gcd(n,2)+15

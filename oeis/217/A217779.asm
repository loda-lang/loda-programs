...
; Formula: a(n) = 4*a(n-1)-d(n-1)+c(n-1)+e(n-1)-1, a(4) = 208, a(3) = 56, a(2) = 15, a(1) = 4, a(0) = 1, b(n) = b(n-1)+d(n-1), b(4) = 20, b(3) = 5, b(2) = 1, b(1) = 0, b(0) = 1, c(n) = -d(n-1)+c(n-1)+e(n-1)-1, c(4) = -16, c(3) = -4, c(2) = -1, c(1) = 0, c(0) = 0, d(n) = a(n-1), d(4) = 56, d(3) = 15, d(2) = 4, d(1) = 1, d(0) = -1, e(n) = 2*e(n-1)+b(n-1)+c(n-1), e(4) = 9, e(3) = 4, e(2) = 2, e(1) = 1, e(0) = 0

...
; Formula: a(n) = truncate(A276085(A181819(A181811(truncate((A057335(2*A048678(16*n-16))-1)/A293810(A057335(2*A048678(16*n-16))))+1)*(truncate((A057335(2*A048678(16*n-16))-1)/A293810(A057335(2*A048678(16*n-16))))+1)))/210)+1

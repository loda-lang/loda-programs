...
; Formula: a(n) = 25*floor(((min(n-1,(n-1)%2)*b(n-1)+c(n-1))^2)/144)+3, b(n) = 29*b(n-2)+24*c(n-2), b(3) = 348, b(2) = 348, b(1) = 12, b(0) = 12, c(n) = 6*b(n-2)+5*c(n-2), c(3) = 72, c(2) = 72, c(1) = 0, c(0) = 0

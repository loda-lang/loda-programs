...
; Formula: a(n) = truncate(A276085(A181819(A181811(truncate((A057335(2*A048678(4*n-4))-1)/A293810(A057335(2*A048678(4*n-4))))+1)*(truncate((A057335(2*A048678(4*n-4))-1)/A293810(A057335(2*A048678(4*n-4))))+1)))/6)+1

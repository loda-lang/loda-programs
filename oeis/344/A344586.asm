...
; Formula: a(n) = -A212165(n-1)*(A264668(n-1)-1)

#offset 1

sub $0,1
mov $1,$0
seq $1,212165 ; Numbers k such that the maximum exponent in its prime factorization is not less than the number of positive exponents (A051903(k) >= A001221(k)).

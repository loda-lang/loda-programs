...
; Formula: a(n) = a(n-1)*(8*n+c(n-1)-4)-a(n-1)+b(n-1), a(3) = 713, a(2) = 19, a(1) = 1, a(0) = 0, b(n) = (-a(n-1)+b(n-1))*(8*n+c(n-1)-4), b(3) = 1044, b(2) = 48, b(1) = 4, b(0) = 1, c(n) = 8*n+c(n-1)-4, c(3) = 36, c(2) = 16, c(1) = 4, c(0) = 0

...
; Formula: a(n) = -10*truncate(truncate(b(4*n)/truncate(c(4*n)/(10^n)))/10)+truncate(b(4*n)/truncate(c(4*n)/(10^n))), b(n) = 2*c(n-1)+b(n-1), b(1) = 7, b(0) = 5, c(n) = 3*c(n-1)+b(n-1), c(1) = 8, c(0) = 1

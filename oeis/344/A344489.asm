...
; Formula: a(n) = (d(n)-c(n))+1, b(n) = (b(n-2)-A060996(n-2))+A060996((n-2)+1), b(4) = 34, b(3) = 11, b(2) = 4, b(1) = 2, b(0) = 1, c(n) = b(n-2)-A060996(n-2), c(4) = -10, c(3) = -3, c(2) = -1, c(1) = 0, c(0) = 0, d(n) = d(n-1), d(4) = 0, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0

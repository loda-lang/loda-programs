...
; Formula: a(n) = truncate(d(n+1)/2), b(n) = -n*truncate((b(n-1)+1)/n)+b(n-1)+2, b(3) = 3, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = c(n-1)*(-n*truncate((b(n-1)+1)/n)+b(n-1)+2), c(3) = 6, c(2) = 2, c(1) = 2, c(0) = 2, d(n) = binomial(n,b(n-1)+1)*c(n-1), d(3) = 6, d(2) = 2, d(1) = 2, d(0) = 0

...
; Formula: a(n) = -10*truncate(truncate((2*b(3*n))/truncate(c(3*n)/(10^n)))/10)+truncate((2*b(3*n))/truncate(c(3*n)/(10^n))), b(n) = 2*b(n-2)+2*c(n-2), b(3) = 4, b(2) = 4, b(1) = 1, b(0) = 1, c(n) = 34*c(n-2)+17*b(n-2), c(3) = 51, c(2) = 51, c(1) = 1, c(0) = 1

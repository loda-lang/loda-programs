...
; Formula: a(n) = c(n)+1, b(n) = -2*truncate((b(n-1)-1)/2)+b(n-1)-1, b(2) = 0, b(1) = -1, b(0) = 0, c(n) = n*(2*truncate((b(n-1)-1)/2)-b(n-1)+c(n-1)+2)-2*truncate((b(n-1)-1)/2)+b(n-1)-1, c(2) = 4, c(1) = 1, c(0) = 0

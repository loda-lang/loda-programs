...
; Formula: a(n) = d(n)+2, b(n) = 2*truncate(b(n-1)/2)-c(n-1), b(5) = -5, b(4) = -3, b(3) = -1, b(2) = -1, b(1) = -1, b(0) = 0, c(n) = (-2*truncate(b(n-2)/2)+b(n-2))^2+c(n-2)+c(n-3), c(5) = 5, c(4) = 3, c(3) = 3, c(2) = 1, c(1) = 1, c(0) = 1, d(n) = -2*truncate(b(n-1)/2)+b(n-1)+c(n-1), d(5) = 2, d(4) = 2, d(3) = 0, d(2) = 0, d(1) = 1, d(0) = 4

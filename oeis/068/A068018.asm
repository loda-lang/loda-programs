...
; Formula: a(n) = -a(n-1)+c(n-1)+d(n-1), a(4) = 6, a(3) = 4, a(2) = 2, a(1) = 1, a(0) = 0, b(n) = -b(n-1)+d(n-1)-1, b(4) = -3, b(3) = 0, b(2) = -1, b(1) = 0, b(0) = 0, c(n) = 3*c(n-1)+3*d(n-1)-3*a(n-1), c(4) = 18, c(3) = 12, c(2) = 6, c(1) = 3, c(0) = 0, d(n) = 2*d(n-2)-2*b(n-2)-2, d(4) = 0, d(3) = -2, d(2) = 0, d(1) = 0, d(0) = 1

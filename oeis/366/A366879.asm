...
; Formula: a(n) = A327278(truncate((A057335(A341915(A006068(n)))-1)/A293810(A057335(A341915(A006068(n)))))+1)*(-2*truncate(truncate((A057335(A341915(A006068(n)))-1)/A293810(A057335(A341915(A006068(n)))))/2)+truncate((A057335(A341915(A006068(n)))-1)/A293810(A057335(A341915(A006068(n)))))+1)

...
; Formula: a(n) = c(n+2), b(n) = (b(n-1)+1)%4, b(4) = 0, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = (b(n-2)+1)%4+2*d(n-2)+c(n-2), c(5) = 4, c(4) = 4, c(3) = 2, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = (b(n-3)+1)%4+d(n-1)+d(n-2)+d(n-3), d(7) = 22, d(6) = 11, d(5) = 7, d(4) = 3, d(3) = 1, d(2) = 0, d(1) = 0, d(0) = 0

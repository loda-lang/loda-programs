...
; Formula: a(n) = truncate((truncate(truncate((A057335(A139706(truncate((22*n-8)/11)+1))-1)/A293810(A057335(A139706(truncate((22*n-8)/11)+1))))/2)+1)/gcd(n,truncate(truncate((A057335(A139706(truncate((22*n-8)/11)+1))-1)/A293810(A057335(A139706(truncate((22*n-8)/11)+1))))/2)+1))

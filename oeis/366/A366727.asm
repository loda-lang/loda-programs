...
; Formula: a(n) = max(-binomial(binomial(truncate((sqrtint(8*n)-1)/2)+1,2),2*sqrtint(floor((n-1)/2)))+binomial(truncate((sqrtint(8*binomial(truncate((sqrtint(8*n)-1)/2)+1,2)+8*truncate((sqrtint(8*n)-1)/2))-1)/2)+1,2)+truncate((sqrtint(8*binomial(truncate((sqrtint(8*n)-1)/2)+1,2)+8*truncate((sqrtint(8*n)-1)/2))-1)/2)+1,truncate((sqrtint(8*binomial(truncate((sqrtint(8*n)-1)/2)+1,2)+8*truncate((sqrtint(8*n)-1)/2))-1)/2))+4

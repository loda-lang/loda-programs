...
; Formula: a(n) = (b(n-1)+1)%4+c(n-1)+a(n-1), a(4) = 10, a(3) = 7, a(2) = 3, a(1) = 1, a(0) = 0, b(n) = (b(n-1)+1)%4, b(4) = 0, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = ((b(n-3)+1)%4+1)%4+(b(n-3)+1)%4+2*c(n-3)+2*a(n-3)+c(n-2), c(4) = 8, c(3) = 3, c(2) = 1, c(1) = 0, c(0) = 0

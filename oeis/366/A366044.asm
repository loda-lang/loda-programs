...
; Formula: a(n) = 4*truncate((b(n-4)+1)/4)-b(n-4)-4*truncate((b(n-1)+1)/4)+b(n-1)+a(n-1)+a(n-2)+a(n-3), a(7) = 67, a(6) = 35, a(5) = 19, a(4) = 10, a(3) = 7, a(2) = 3, a(1) = 1, a(0) = 0, b(n) = -4*truncate((b(n-1)+1)/4)+b(n-1)+1, b(4) = 0, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 0

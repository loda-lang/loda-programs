...
; Formula: a(n) = A056239(A375400(truncate((n-1)/A052126(n))+1))*A052126(n)
...
div $1,$0
add $1,1
seq $1,375400 ; Heinz number of the multiset of minima of maximal anti-runs in the weakly increasing prime indices of n.

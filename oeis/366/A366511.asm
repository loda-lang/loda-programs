...
; Formula: a(n) = 2*b(n-1)+c(n-1)+d(n-1)+5, b(n) = 3*b(n-1)-b(n-2), b(4) = 34, b(3) = 13, b(2) = 5, b(1) = 2, b(0) = 1, c(n) = 2*c(n-1)+b(n-1), c(2) = 8, c(1) = 3, c(0) = 1, d(n) = 2*d(n-1)+4, d(2) = 12, d(1) = 4, d(0) = 0

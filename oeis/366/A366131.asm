...
; Formula: a(n) = 2*(d(n)/3), b(n) = 3*b(n-2)+2*c(n-2), b(4) = 23, b(3) = 7, b(2) = 5, b(1) = 1, b(0) = 1, c(n) = 2*c(n-1), c(4) = 16, c(3) = 8, c(2) = 4, c(1) = 2, c(0) = 1, d(n) = 3*b(n-2), d(4) = 15, d(3) = 3, d(2) = 3, d(1) = 0, d(0) = 0

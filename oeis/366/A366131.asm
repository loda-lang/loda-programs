...
; Formula: a(n) = 2*(e(n)/3), b(n) = 3*b(n-2)+d(n-1), b(4) = 23, b(3) = 7, b(2) = 5, b(1) = 1, b(0) = 1, c(n) = b(n-1), c(4) = 7, c(3) = 5, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = 2*d(n-1), d(4) = 16, d(3) = 8, d(2) = 4, d(1) = 2, d(0) = 1, e(n) = 2*f(n-1)+c(n-1), e(4) = 15, e(3) = 3, e(2) = 3, e(1) = 0, e(0) = 0, f(n) = b(n-1), f(4) = 7, f(3) = 5, f(2) = 1, f(1) = 1, f(0) = 0

...
; Formula: a(n) = c(n+1)/2+4, b(n) = (3*gcd(-n+1,2)^2*((3^(gcd(b(n-1),max(-n+3,0)+6)+2)+1)%10))/80+b(n-2), b(3) = 2, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = gcd(c(n-1),2)*((3^(gcd(b(n-1),max(-n+3,0)+6)+2)+1)%10)-2, c(3) = 14, c(2) = 14, c(1) = 14, c(0) = 0

...
; Formula: a(n) = d(n+3)+e(n+3)-2, b(n) = (-c(n-1)+b(n-1))/2-15, b(3) = -29, b(2) = -24, b(1) = -15, b(0) = 3, c(n) = c(n-1)*(((-c(n-1)+b(n-1))/2+d(n-1))%2+2), c(3) = 4, c(2) = 4, c(1) = 4, c(0) = 2, d(n) = ((-c(n-1)+b(n-1))/2+d(n-1))%2+2, d(3) = 1, d(2) = 1, d(1) = 2, d(0) = 0, e(n) = ((-c(n-1)+b(n-1))/2+d(n-1))%2+e(n-1)+1, e(3) = 1, e(2) = 1, e(1) = 1, e(0) = 0

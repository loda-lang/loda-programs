...
; Formula: a(n) = truncate(b(n+1)/8), b(n) = 8*c(n-1)+8*d(n-1)+8*truncate(b(n-1)/2), b(2) = 392, b(1) = 8, b(0) = 0, c(n) = 36*c(n-1)+36*d(n-1), c(2) = 1620, c(1) = 36, c(0) = 0, d(n) = 9*d(n-1), d(2) = 81, d(1) = 9, d(0) = 1

...
; Formula: a(n) = ((2*b(3*n+1))/(c(3*n+1)/(10^n)))%10, b(n) = 8*b(n-1)+4*c(n-1)+2*d(n-1), b(2) = 46, b(1) = 4, b(0) = 0, c(n) = 4*b(n-1)+2*c(n-1)+c(n-1)+d(n-1), c(2) = 26, c(1) = 3, c(0) = 1, d(n) = c(n-1)+d(n-1), d(2) = 4, d(1) = 1, d(0) = 0

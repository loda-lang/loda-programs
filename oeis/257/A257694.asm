...
; Formula: a(n) = A005361(A181811(truncate(A278159(if((A277012(n)%2)==0,A277012(n)/2,A277012(n)))/A064989(A278159(if((A277012(n)%2)==0,A277012(n)/2,A277012(n))))))*truncate(A278159(if((A277012(n)%2)==0,A277012(n)/2,A277012(n)))/A064989(A278159(if((A277012(n)%2)==0,A277012(n)/2,A277012(n))))))

...
; Formula: a(n) = (b(4*n)/(c(4*n)/(10^n)+1))%10, b(n) = 6*c(n-1)+4*d(n-1)+2*b(n-1), b(2) = 16, b(1) = 2, b(0) = 1, c(n) = 8*c(n-1)+4*d(n-1)+2*b(n-1), c(2) = 20, c(1) = 2, c(0) = 0, d(n) = (2*c(n-1)+2*d(n-1))/3, d(2) = 1, d(1) = 0, d(0) = 0

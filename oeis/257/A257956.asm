...
; Formula: a(n) = d(n+1), b(n) = 2*b(n-1)+2*b(n-2), b(3) = 52, b(2) = 18, b(1) = 8, b(0) = 1, c(n) = c(n-2)+d(n-2), c(3) = -2, c(2) = 0, c(1) = -3, c(0) = 0, d(n) = b(n-1)+c(n-1)+d(n-1), d(3) = 24, d(2) = 6, d(1) = 1, d(0) = 0

...
; Formula: a(n) = binomial(floor((sqrtint(8*n+8)-1)/2),-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n)*(-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)-3*truncate((-binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)+n-18)/3)+n-17)

...
; Formula: a(n) = b(n-1)-3, b(n) = 2*b(n-1)+truncate((c(n-1)+d(n-1))/c(n-1))+8, b(2) = 53, b(1) = 17, b(0) = 4, c(n) = b(n-1)+3, c(2) = 20, c(1) = 7, c(0) = 4, d(n) = (truncate((c(n-1)+d(n-1))/c(n-1))+4)*(2*b(n-1)+truncate((c(n-1)+d(n-1))/c(n-1))+6), d(2) = 765, d(1) = 75, d(0) = 0

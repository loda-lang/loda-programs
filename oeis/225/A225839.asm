...
; Formula: a(n) = 378*floor(d(floor((3*n)/2))/97200), b(n) = 45*c(n-1)+b(n-1), b(2) = 2115, b(1) = 45, b(0) = 0, c(n) = 46*c(n-1)+b(n-1), c(2) = 2161, c(1) = 46, c(0) = 1, d(n) = 45*c(n-1), d(2) = 2070, d(1) = 45, d(0) = 0

...
; Formula: a(n) = ((-((7*d(n+1)^2)/c(n+1))+c(n+1)-1)%10+10)%10, b(n) = 10*b(n-1), b(2) = 100, b(1) = 10, b(0) = 1, c(n) = b(n-1), c(2) = 10, c(1) = 1, c(0) = 0, d(n) = (2401*d(n-1)^10)%(10*b(n-1)), d(2) = 1, d(1) = 9, d(0) = 3

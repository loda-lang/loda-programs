...
; Formula: a(n) = c(n+2), b(n) = c(n-2), b(7) = 3, b(6) = 2, b(5) = 1, b(4) = 1, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = -b(n-2)-c(n-2)-e(n-2)-2*d(n-2)+c(n-2)+d(n-2)+1, c(7) = 8, c(6) = 5, c(5) = 3, c(4) = 2, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = 2*d(n-1)-c(n-1)+b(n-1)+c(n-1)+e(n-1)-1, d(7) = -32, d(6) = -20, d(5) = -12, d(4) = -7, d(3) = -4, d(2) = -2, d(1) = -1, d(0) = 0, e(n) = -b(n-2)-e(n-2)-2*c(n-2)-2*d(n-2)+b(n-2)+c(n-2)+d(n-2)+f(n-2)+1, e(7) = 11, e(6) = 7, e(5) = 4, e(4) = 2, e(3) = 2, e(2) = 1, e(1) = 1, e(0) = 0, f(n) = -d(n-1)-f(n-1)+1, f(7) = 13, f(6) = 8, f(5) = 5, f(4) = 3, f(3) = 2, f(2) = 1, f(1) = 1, f(0) = 0

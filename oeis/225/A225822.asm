...
; Formula: a(n) = 8*(d(n)/3)+7, b(n) = ((-c(n-1)+b(n-1))/2)/gcd((-c(n-1)+b(n-1))/2+1,4), b(3) = -91, b(2) = -90, b(1) = -20, b(0) = -1, c(n) = 4*c(n-1), c(3) = 2560, c(2) = 640, c(1) = 160, c(0) = 40, d(n) = d(n-1)+gcd((-c(n-2)+b(n-2))/2+1,4)+2, d(3) = 14, d(2) = 11, d(1) = 8, d(0) = 2

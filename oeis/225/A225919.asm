...
; Formula: a(n) = truncate(c(n+2)/8)-4, b(n) = 2*d(n-1)+c(n-1)+1, b(2) = 7, b(1) = 3, b(0) = 0, c(n) = 2*b(n-1)+2*c(n-1), c(2) = 14, c(1) = 4, c(0) = 2, d(n) = truncate((2*d(n-1)-b(n-1)+c(n-1)+1)/2), d(2) = 2, d(1) = 1, d(0) = 0

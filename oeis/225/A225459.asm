...
; Formula: a(n) = d(n+1)/c(n+1), b(n) = 10*b(n-1), b(3) = 1000, b(2) = 100, b(1) = 10, b(0) = 1, c(n) = b(n-1), c(3) = 100, c(2) = 10, c(1) = 1, c(0) = 0, d(n) = (3*(b(n-1)+e(n-1))*d(n-1)^10)%(10*b(n-1)), d(3) = 517, d(2) = 17, d(1) = 7, d(0) = 3, e(n) = b(n-1)+e(n-1), e(3) = 111, e(2) = 11, e(1) = 1, e(0) = 0

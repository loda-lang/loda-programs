...
; Formula: a(n) = truncate((2*(floor((sqrtint(8*n-8)+1)/2)+1)*(-binomial(floor((sqrtint(8*n-8)+1)/2),2)+n-1))/(gcd(-binomial(floor((sqrtint(8*n-8)+1)/2),2)+floor((sqrtint(8*n-8)+1)/2)+n,2*(floor((sqrtint(8*n-8)+1)/2)+1)*(-binomial(floor((sqrtint(8*n-8)+1)/2),2)+n-1))^10))

...
; Formula: a(n) = A225471(n)*if((2^2)==1,2^(-binomial(truncate((sqrtint(8*n+1)+1)/2),2)+n),if((-binomial(truncate((sqrtint(8*n+1)+1)/2),2)+n)<=(-1),0,2^(-binomial(truncate((sqrtint(8*n+1)+1)/2),2)+n)))^2

...
; Formula: a(n) = truncate((4*truncate(floor(binomial(4^(n+1),2)/2)/gcd(A350972(2*n+1),floor(binomial(4^(n+1),2)/2))))/gcd((2*n)!,4*truncate(floor(binomial(4^(n+1),2)/2)/gcd(A350972(2*n+1),floor(binomial(4^(n+1),2)/2)))))

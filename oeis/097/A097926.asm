...
; Formula: a(n) = 2*b(n+5), b(n) = -d(n-2)+c(n-2)+e(n-2)-2, b(4) = 5, b(3) = 3, b(2) = 1, b(1) = 0, b(0) = 1, c(n) = -d(n-1)+b(n-1)+c(n-1)+e(n-1), c(4) = 14, c(3) = 8, c(2) = 5, c(1) = 4, c(0) = 0, d(n) = -d(n-1)+b(n-1)+c(n-1), d(4) = 7, d(3) = 4, d(2) = 2, d(1) = 2, d(0) = -1, e(n) = -d(n-1)+b(n-1)+c(n-1)+e(n-1)-1, e(4) = 13, e(3) = 7, e(2) = 4, e(1) = 3, e(0) = 2

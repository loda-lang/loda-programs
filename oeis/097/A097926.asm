...
; Formula: a(n) = 2*b(n), b(n) = c(n-2)+c(n-3)-4, b(6) = 18, b(5) = 9, b(4) = 5, b(3) = 3, b(2) = 1, b(1) = 0, b(0) = 1, c(n) = c(n-1)+c(n-2)+c(n-3)+c(n-4)-6, c(6) = 46, c(5) = 25, c(4) = 14, c(3) = 8, c(2) = 5, c(1) = 4, c(0) = 0

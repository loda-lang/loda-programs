...
; Formula: a(n) = d(n+64)-37, b(n) = (-c(n-1)+b(n-1))/2, b(2) = -24, b(1) = -16, b(0) = 0, c(n) = c(n-1)*(((-c(n-1)+b(n-1))/2+1)%2+2), c(2) = 32, c(1) = 32, c(0) = 32, d(n) = ((-c(n-1)+b(n-1))/2+1)%2+d(n-1)+1, d(2) = 0, d(1) = 0, d(0) = 0

...
; Formula: a(n) = d(n+64)-37, b(n) = truncate((-c(n-1)+b(n-1))/2), b(2) = -24, b(1) = -16, b(0) = 0, c(n) = c(n-1)*(-2*truncate((truncate((-c(n-1)+b(n-1))/2)+1)/2)+truncate((-c(n-1)+b(n-1))/2)+3), c(2) = 32, c(1) = 32, c(0) = 32, d(n) = -2*truncate((truncate((-c(n-1)+b(n-1))/2)+1)/2)+d(n-1)+truncate((-c(n-1)+b(n-1))/2)+2, d(2) = 0, d(1) = 0, d(0) = 0

...
; Formula: a(n) = e(n+2), b(n) = -b(n-1)-c(n-1)-d(n-1)+e(n-1)+f(n-1), b(4) = 11, b(3) = -3, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = -c(n-1)+1, c(4) = 0, c(3) = 1, c(2) = 0, c(1) = 1, c(0) = 0, d(n) = -b(n-1)-c(n-1)-d(n-1)+e(n-1)+f(n-1), d(4) = 11, d(3) = -3, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = -c(n-1)-f(n-1), e(4) = -6, e(3) = 1, e(2) = -2, e(1) = 0, e(0) = 0, f(n) = -e(n-1)-2*f(n-1)+b(n-1)+d(n-1)+1, f(4) = -16, f(3) = 5, f(2) = -1, f(1) = 1, f(0) = 0

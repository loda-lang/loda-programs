...
; Formula: a(n) = 2*c(n-3)+a(n-1), a(4) = 3, a(3) = 1, a(2) = 1, a(1) = 1, a(0) = 1, b(n) = a(n-1)+b(n-1), b(4) = 4, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = a(n-1)+b(n-1)+c(n-1), c(4) = 10, c(3) = 6, c(2) = 3, c(1) = 1, c(0) = 0

...
; Formula: a(n) = -a(n-1)+b(n-1)+1, a(4) = 0, a(3) = 1, a(2) = 0, a(1) = 1, a(0) = 0, b(n) = truncate(c(n-3)/(b(n-2)+1)), b(4) = 0, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = a(n-1)+c(n-1), c(4) = 2, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0

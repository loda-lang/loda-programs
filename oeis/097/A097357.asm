...
; Formula: a(n) = truncate((sumdigits(b(n-1),2)*sign(b(n-1)))/2), b(n) = bitxor(bitxor(max(c(n-1),2*b(n-1)),bitxor(b(n-1),2*b(n-1))),2*bitxor(b(n-1),2*b(n-1))), b(1) = 27, b(0) = 5, c(n) = bitxor(bitxor(max(c(n-1),2*b(n-1)),bitxor(b(n-1),2*b(n-1))),2*bitxor(b(n-1),2*b(n-1))), c(1) = 27, c(0) = 0

...
; Formula: a(n) = a(n-1)+a(n-2)+b(n-2), a(4) = 5, a(3) = 2, a(2) = 2, a(1) = 1, a(0) = 1, b(n) = -a(n-1)-b(n-1)+c(n-1), b(4) = 2, b(3) = -2, b(2) = 1, b(1) = -1, b(0) = 0, c(n) = c(n-1)+c(n-2), c(4) = 3, c(3) = 2, c(2) = 1, c(1) = 1, c(0) = 0

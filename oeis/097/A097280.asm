...
; Formula: a(n) = 2*truncate((min(n,n%2)*c(n)+b(n)-3)/3)+5, b(n) = 2*b(n-2)+c(n-2), b(3) = 9, b(2) = 9, b(1) = 3, b(0) = 3, c(n) = 3*c(n-2)-c(n-4), c(6) = 39, c(5) = 15, c(4) = 15, c(3) = 6, c(2) = 6, c(1) = 3, c(0) = 3

...
; Formula: a(n) = 2*a(n-1)-b(n-1)+c(n-2), a(4) = 7, a(3) = 5, a(2) = 1, a(1) = 1, a(0) = 0, b(n) = 2*c(n-2)-2*b(n-1), b(4) = -6, b(3) = 6, b(2) = -2, b(1) = 2, b(0) = 0, c(n) = b(n-1)+c(n-1), c(4) = 7, c(3) = 1, c(2) = 3, c(1) = 1, c(0) = 1

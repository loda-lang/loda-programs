...
; Formula: a(n) = ((d(3*n)+1)/(2*(c(3*n)/(10^n))+1))%10, b(n) = 8*b(n-1)+8*c(n-1), b(2) = 160, b(1) = 8, b(0) = 1, c(n) = 8*b(n-1)+8*c(n-1)+4*b(n-1)+4*c(n-1)+2*c(n-1), c(2) = 264, c(1) = 12, c(0) = 0, d(n) = c(n-1)+d(n-1), d(2) = 12, d(1) = 0, d(0) = 0

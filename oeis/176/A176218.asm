...
; Formula: a(n) = 2*truncate(10^(2*n-2))-10*truncate((2*truncate(10^(2*n-2))+sqrtnint(4*truncate(10^(2*n-2))+floor(truncate(10^(2*n-2))/2),2))/10)+sqrtnint(4*truncate(10^(2*n-2))+floor(truncate(10^(2*n-2))/2),2)

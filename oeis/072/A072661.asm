...
; 0,1,0,2,1,0,3,2,4,1,0,2,3,0,5,4,6,1,4,3,2,8,1,0,2,5,0,7,6,4,5,4,6,3,0,9,8,10,1,8,3,2,12,1,0,2,7,8,5,4,6,5,4,7,6,16,1,0,2,9,0,11,10,4,9,8,10,3,0,13,12,14,1,12,3,2,8,9,8,10
; Formula: a(n) = A059905(truncate(A087808(A022340(n))/2))

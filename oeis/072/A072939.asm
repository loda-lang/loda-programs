...
; Formula: a(n) = gcd((-c(n-2)+b(n-2))/2+1,4)/2+a(n-1)+2, a(3) = 11, a(2) = 9, a(1) = 7, a(0) = 3, b(n) = ((-c(n-1)+b(n-1))/2)/gcd((-c(n-1)+b(n-1))/2+1,4), b(3) = -91, b(2) = -90, b(1) = -20, b(0) = -1, c(n) = 4*c(n-1), c(3) = 2560, c(2) = 640, c(1) = 160, c(0) = 40

...
; Formula: a(n) = -10*truncate(truncate(b(4*n+4)/truncate(d(4*n+4)/(10^(n+1))))/10)+truncate(b(4*n+4)/truncate(d(4*n+4)/(10^(n+1)))), b(n) = b(n-1)+e(n-1), b(3) = -88, b(2) = -22, b(1) = 0, b(0) = 0, c(n) = b(n-1)+c(n-1)+e(n-1), c(3) = -110, c(2) = -22, c(1) = 0, c(0) = 0, d(n) = b(n-1)+c(n-1)+d(n-1)+e(n-1), d(3) = -132, d(2) = -22, d(1) = 0, d(0) = 0, e(n) = 2*e(n-1)+b(n-1)+c(n-1)+d(n-1)-22, e(3) = -220, e(2) = -66, e(1) = -22, e(0) = 0

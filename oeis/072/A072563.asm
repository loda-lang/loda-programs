...
; Formula: a(n) = 2*c(n)+9, b(n) = 4*d(n-1)+3*e(n-1)+b(n-1), b(3) = 8, b(2) = 7, b(1) = -2, b(0) = 1, c(n) = (2*c(n-1)+b(n-1)+e(n-1))/2, c(3) = 3, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = (2*c(n-1)+b(n-1)+e(n-1))/2+2*c(n-1)-d(n-1)+b(n-1)+e(n-1), d(3) = 8, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = -e(n-1)-2*d(n-1)+2, e(3) = 1, e(2) = -1, e(1) = 3, e(0) = -1

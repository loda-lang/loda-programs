...
; Formula: a(n) = max(b(2*n),2)/2, b(n) = c(n-1), b(3) = 0, b(2) = 2, b(1) = 0, b(0) = 1, c(n) = 2*b(n-1)+d(n-1), c(3) = 6, c(2) = 0, c(1) = 2, c(0) = 0, d(n) = 2*c(n-1)-c(n-2)-2*b(n-2)+d(n-1), d(3) = 0, d(2) = 2, d(1) = 0, d(0) = 0

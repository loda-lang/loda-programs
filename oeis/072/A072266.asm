...
; Formula: a(n) = b(2*n), b(n) = 2*c(n-2)-c(n-1)+c(n-3), b(7) = 1, b(6) = 10, b(5) = 0, b(4) = 3, b(3) = 0, b(2) = 1, b(1) = 0, b(0) = 1, c(n) = 5*c(n-2)-2*c(n-5)-5*c(n-4)+c(n-3), c(9) = 265, c(8) = 163, c(7) = 65, c(6) = 42, c(5) = 16, c(4) = 11, c(3) = 4, c(2) = 3, c(1) = 1, c(0) = 1

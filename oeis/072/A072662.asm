...
; 0,0,1,0,1,2,0,1,0,2,3,2,1,4,0,1,0,3,2,2,3,0,4,5,4,1,6,0,1,4,2,3,2,3,8,0,1,0,5,2,4,5,0,6,7,6,1,4,4,5,4,3,6,2,3,0,8,9,8,1,10,0,1,8,2,3,2,5,12,0,1,0,7,2,6,7,8,4,5,4
; Formula: a(n) = A059906(truncate(A087808(A022340(n))/2))

...
; Formula: a(n) = A008966(max(n,1))*(max(n,1)-1)-2*truncate((A008966(max(n,1))*(max(n,1)-1)-2*truncate((A008966(max(n,1))*(max(n,1)-1)-229)/2)-227)/2)-2*truncate((A008966(max(n,1))*(max(n,1)-1)-229)/2)+a(n-1)-227, a(0) = 1

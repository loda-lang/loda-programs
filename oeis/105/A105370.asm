...
; Formula: a(n) = b(n)+c(n), b(n) = -4*d(n-1)-5*c(n-1)+e(n-1), b(3) = -5, b(2) = 3, b(1) = -2, b(0) = 1, c(n) = -4*d(n-2)-5*c(n-2)+e(n-2), c(3) = 3, c(2) = -2, c(1) = 1, c(0) = 0, d(n) = -5*c(n-1)-5*d(n-1)+e(n-1), d(3) = -10, d(2) = 5, d(1) = -2, d(0) = 0, e(n) = -5*c(n-1)-5*d(n-1), e(3) = -15, e(2) = 5, e(1) = 0, e(0) = -2

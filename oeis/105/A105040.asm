...
; Formula: a(n) = truncate(c(max(2*n-1,0))/2), b(n) = b(n-1)*(truncate((-((2*floor((gcd(7*n-6,4)^4)/12)+12)%6)+floor((gcd(7*n-6,4)^4)/12)+3)/3)+2)+b(n-2), b(2) = 31, b(1) = 3, b(0) = 1, c(n) = b(n-1), c(2) = 3, c(1) = 1, c(0) = 0

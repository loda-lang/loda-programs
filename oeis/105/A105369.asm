...
; Formula: a(n) = -4*c(n-1)-5*b(n-1)+d(n-1), a(3) = -5, a(2) = 3, a(1) = -2, a(0) = 1, b(n) = -4*c(n-2)-5*b(n-2)+d(n-2), b(3) = 3, b(2) = -2, b(1) = 1, b(0) = 0, c(n) = -5*b(n-1)-5*c(n-1)+d(n-1), c(3) = -10, c(2) = 5, c(1) = -2, c(0) = 0, d(n) = -5*b(n-1)-5*c(n-1), d(3) = -15, d(2) = 5, d(1) = 0, d(0) = -2

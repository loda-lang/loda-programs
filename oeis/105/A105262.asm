...
; Formula: a(n) = d(n)/2+1, b(n) = b(n-1)+d(n-1)+2, b(5) = 124, b(4) = 40, b(3) = 14, b(2) = 4, b(1) = 2, b(0) = 0, c(n) = b(n-2)+d(n-2)+e(n-2)+2, c(5) = 66, c(4) = 22, c(3) = 6, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = 2*e(n-1)-f(n-1)+b(n-1)+c(n-1), d(5) = 250, d(4) = 82, d(3) = 24, d(2) = 8, d(1) = 0, d(0) = 0, e(n) = -f(n-1)+b(n-1)+c(n-1)+d(n-1)+e(n-1)+2, e(5) = 252, e(4) = 82, e(3) = 26, e(2) = 8, e(1) = 2, e(0) = 0, f(n) = -b(n-1)-d(n-1)-f(n-1)+c(n-1)-2, f(5) = -78, f(4) = -24, f(3) = -10, f(2) = -2, f(1) = -2, f(0) = 0

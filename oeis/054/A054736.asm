...
; Formula: a(n) = d(n-1)+4, b(n) = -d(n-1)+c(n-1)+1, b(2) = 5, b(1) = 5, b(0) = 0, c(n) = b(n-1)+d(n-1)+truncate((-d(n-1)+b(n-1)+c(n-1)+5)/2)+4, c(2) = 20, c(1) = 8, c(0) = 4, d(n) = truncate((-d(n-1)+b(n-1)+c(n-1)+5)/2), d(2) = 7, d(1) = 4, d(0) = 0

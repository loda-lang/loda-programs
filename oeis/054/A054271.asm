...
; Formula: a(n) = (max(truncate(A062876(n)/4)-2,0)+2)^2-A151799((max(truncate(A062876(n)/4)-2,0)+2)^2-3)-10*truncate(((max(truncate(A062876(n)/4)-2,0)+2)^2-A151799((max(truncate(A062876(n)/4)-2,0)+2)^2-3)+A194899(1)-4)/10)+A194899(1)-4

...
; Formula: a(n) = truncate(e(n-1)/2), b(n) = 4*c(n-1)+4*d(n-1)+3*b(n-1)-2, b(3) = 50, b(2) = 8, b(1) = 2, b(0) = 0, c(n) = 4*d(n-1)+3*c(n-1)+2*b(n-1)-4, c(3) = 36, c(2) = 4, c(1) = 0, c(0) = 0, d(n) = b(n-1)+d(n-1), d(3) = 11, d(2) = 3, d(1) = 1, d(0) = 1, e(n) = 14*truncate(e(n-1)/2)+4*c(n-1)+4*d(n-1)+3*b(n-1)-2, e(3) = 204, e(2) = 22, e(1) = 2, e(0) = 0

...
; Formula: a(n) = b(n+1)/2, b(n) = 5*c(n-2)+4*b(n-2)+2*c(n-3)+2*d(n-2)+b(n-3)+2, b(5) = 80, b(4) = 26, b(3) = 10, b(2) = 2, b(1) = 2, b(0) = 0, c(n) = b(n-1)+c(n-1), c(5) = 40, c(4) = 14, c(3) = 4, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = b(n-1)+c(n-1)+d(n-1), d(5) = 60, d(4) = 20, d(3) = 6, d(2) = 2, d(1) = 0, d(0) = 0

...
; Formula: a(n) = -d(n)+b(n)-1, b(n) = 3*b(n-1)-b(n-2), b(5) = 55, b(4) = 21, b(3) = 8, b(2) = 3, b(1) = 1, b(0) = 0, c(n) = 2*c(n-1)+1, c(3) = 15, c(2) = 7, c(1) = 3, c(0) = 1, d(n) = c(n-1), d(3) = 7, d(2) = 3, d(1) = 1, d(0) = 0

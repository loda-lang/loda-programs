...
; Formula: a(n) = binomial(floor((sqrtint(8*n)-1)/2),-binomial(floor((sqrtint(8*n)-1)/2)+1,2)+n-1)*if(((-binomial(floor((sqrtint(8*n)-1)/2)+1,2)+n)%2)==0,(-binomial(floor((sqrtint(8*n)-1)/2)+1,2)+n)/2,-binomial(floor((sqrtint(8*n)-1)/2)+1,2)+n)

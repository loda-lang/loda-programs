...
; 1,2,3,3,4,5,5,7,4,6,6,9,7,7,9,11,10,8,12,9,13,5,10,13,9,15,14,15,9,14,16,10,18,19,17,13,18,10,19,11,16,21,12,15,24,19,17,22,16,22,12,23,24,6,19,20,29,21,21,26,22,25,13,30,27,11,26,25,19,34,23,14,25,25,30,28,22,28,21,14
; Formula: a(n) = A322584(A025487(n+1)-1)

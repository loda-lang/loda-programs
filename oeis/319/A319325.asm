...
; Formula: a(n) = 2*((c(n+2)-3)/3)+2, b(n) = -b(n-1)-d(n-1)-2*c(n-1)+b(n-1)+c(n-1), b(4) = -14, b(3) = -3, b(2) = -1, b(1) = 0, b(0) = 0, c(n) = 6*c(n-1)+3*b(n-1)+3*d(n-1), c(4) = 78, c(3) = 15, c(2) = 3, c(1) = 0, c(0) = 0, d(n) = b(n-1)+f(n-1), d(4) = -4, d(3) = -1, d(2) = 0, d(1) = 1, d(0) = 0, e(n) = -c(n-1)-d(n-1)+e(n-1), e(4) = -18, e(3) = -4, e(2) = -1, e(1) = 0, e(0) = 0, f(n) = min(d(n-1)+e(n-1),b(n-1)+f(n-1)), f(4) = -5, f(3) = -1, f(2) = 0, f(1) = 0, f(0) = 1

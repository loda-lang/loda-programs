...
; Formula: a(n) = a(n-1)*(-d(n-1)+b(n-1)+c(n-1)+1), a(3) = 40, a(2) = 8, a(1) = 2, a(0) = 1, b(n) = b(n-2)%2+b(n-1)+1, b(3) = 5, b(2) = 4, b(1) = 2, b(0) = 1, c(n) = b(n-1)%2+a(n-1), c(3) = 8, c(2) = 2, c(1) = 2, c(0) = 0, d(n) = a(n-1), d(3) = 8, d(2) = 2, d(1) = 1, d(0) = 0

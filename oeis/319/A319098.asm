...
; Formula: a(n) = 4*truncate((c(n-1)^3)/b(n-1))*b(n-1)-7*truncate((4*truncate((c(n-1)^3)/b(n-1))*b(n-1)+c(n-1)-1)/(7*b(n-1)))*b(n-1)+c(n-1), a(4) = 824, a(3) = 138, a(2) = 40, a(1) = 5, a(0) = 0, b(n) = 7*b(n-1), b(3) = 343, b(2) = 49, b(1) = 7, b(0) = 1, c(n) = 4*truncate((c(n-1)^3)/b(n-1))*b(n-1)-7*truncate((4*truncate((c(n-1)^3)/b(n-1))*b(n-1)+c(n-1)-1)/(7*b(n-1)))*b(n-1)+c(n-1), c(4) = 824, c(3) = 138, c(2) = 40, c(1) = 5, c(0) = 1

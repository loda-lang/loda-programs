...
; Formula: a(n) = (4*b(n-1)*((d(n-1)^3)/b(n-1))+c(n-1))%(7*b(n-1))+1, a(3) = 138, a(2) = 40, a(1) = 5, a(0) = 0, b(n) = 7*b(n-1), b(3) = 343, b(2) = 49, b(1) = 7, b(0) = 1, c(n) = (4*b(n-1)*((d(n-1)^3)/b(n-1))+c(n-1))%(7*b(n-1)), c(3) = 137, c(2) = 39, c(1) = 4, c(0) = 0, d(n) = (4*b(n-1)*((d(n-1)^3)/b(n-1))+c(n-1))%(7*b(n-1))+1, d(3) = 138, d(2) = 40, d(1) = 5, d(0) = 1

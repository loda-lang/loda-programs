...
; Formula: a(n) = (c(n-1)^3+c(n-1)-7)%(7*b(n-1))+1, a(4) = 808, a(3) = 122, a(2) = 24, a(1) = 3, a(0) = 0, b(n) = 7*b(n-1), b(3) = 343, b(2) = 49, b(1) = 7, b(0) = 1, c(n) = (c(n-1)^3+c(n-1)-7)%(7*b(n-1))+1, c(4) = 808, c(3) = 122, c(2) = 24, c(1) = 3, c(0) = 1

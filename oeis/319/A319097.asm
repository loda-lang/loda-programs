...
; Formula: a(n) = (d(n-1)^3+c(n-1)+1)%(5*b(n-1)+2*b(n-1))+1, a(3) = 122, a(2) = 24, a(1) = 3, a(0) = 0, b(n) = 5*b(n-1)+2*b(n-1), b(3) = 343, b(2) = 49, b(1) = 7, b(0) = 1, c(n) = (d(n-1)^3+c(n-1)+1)%(5*b(n-1)+2*b(n-1))-7, c(3) = 114, c(2) = 16, c(1) = -5, c(0) = 0, d(n) = (d(n-1)^3+c(n-1)+1)%(5*b(n-1)+2*b(n-1))+1, d(3) = 122, d(2) = 24, d(1) = 3, d(0) = 1

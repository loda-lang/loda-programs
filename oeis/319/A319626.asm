...
; 1,2,3,4,5,3,7,8,9,10,11,6,13,14,5,16,17,9,19,20,21,22,23,12,25,26,27,28,29,5,31,32,33,34,7,9,37,38,39,40,41,21,43,44,15,46,47,24,49,50,51,52,53,27,55,56,57,58,59,10,61,62,63,64,65,33,67,68,69,14,71,18,73,74,25,76,11,39,79,80
; Formula: a(n) = truncate((n+1)/gcd(A064989(n+1),n+1))

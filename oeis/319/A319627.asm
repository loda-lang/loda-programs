...
; 1,1,2,1,3,1,5,1,4,3,7,1,11,5,2,1,13,2,17,3,10,7,19,1,9,11,8,5,23,1,29,1,14,13,3,1,31,17,22,3,37,5,41,7,4,19,43,1,25,9,26,11,47,4,21,5,34,23,53,1,59,29,20,1,33,7,61,13,38,3,67,1,71,31,6,17,5,11,73,3
; Formula: a(n) = truncate(A064989(n+1)/gcd(A064989(n+1),n+1))

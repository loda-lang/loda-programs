...
; Formula: a(n) = -c(n)+b(n), b(n) = 7*b(n-1), b(4) = 2401, b(3) = 343, b(2) = 49, b(1) = 7, b(0) = 1, c(n) = (2*e(n-1)^3+d(n-1))%(7*b(n-1))+12*n-11, c(4) = 1632, c(3) = 260, c(2) = 15, c(1) = 1, c(0) = 1, d(n) = (2*e(n-1)^3+d(n-1))%(7*b(n-1)), d(4) = 1595, d(3) = 235, d(2) = 2, d(1) = 0, d(0) = 0, e(n) = (2*e(n-1)^3+d(n-1))%(7*b(n-1))+12*n-11, e(4) = 1632, e(3) = 260, e(2) = 15, e(1) = 1, e(0) = 0

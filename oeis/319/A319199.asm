...
; Formula: a(n) = -c(n)+b(n), b(n) = 7*b(n-1), b(4) = 2401, b(3) = 343, b(2) = 49, b(1) = 7, b(0) = 1, c(n) = -7*truncate((2*d(n-1)^3-12*n+d(n-1)+23)/(7*b(n-1)))*b(n-1)+12+2*d(n-1)^3+d(n-1), c(5) = 13637, c(4) = 1632, c(3) = 260, c(2) = 15, c(1) = 1, c(0) = 1, d(n) = -7*truncate((2*d(n-1)^3-12*n+d(n-1)+23)/(7*b(n-1)))*b(n-1)+12+2*d(n-1)^3+d(n-1), d(5) = 13637, d(4) = 1632, d(3) = 260, d(2) = 15, d(1) = 1, d(0) = 0

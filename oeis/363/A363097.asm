...
; Formula: a(n) = A132857(max(n-1,0))+n

mov $1,$0
trn $0,1
seq $0,132857 ; a(0)=1. a(n) = phi(n+a(n-1)), for n>=1, where phi(m) is the number of positive integers which are <= m and are coprime to m.
add $0,$1

...
; Formula: a(n) = b(n+1), b(n) = min(c(n-1)^2,4*binomial(d(n-1),2)+1), b(2) = 1, b(1) = 0, b(0) = 0, c(n) = ((c(n-1)^2)==min(c(n-1)^2,4*binomial(d(n-1),2)+1))+c(n-1), c(2) = 2, c(1) = 1, c(0) = 0, d(n) = ((4*binomial(d(n-1),2)+1)==min(c(n-1)^2,4*binomial(d(n-1),2)+1))+d(n-1), d(2) = 2, d(1) = 1, d(0) = 1

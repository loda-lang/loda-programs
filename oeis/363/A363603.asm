; A363603: allocated for Enrique Navarrete
...
; Formula: a(n) = (b(n+2)-6)/2+3, b(n) = 3*d(n-1)+2*b(n-1)+2*n-2*c(n-1), b(3) = 40, b(2) = 6, b(1) = 0, b(0) = 0, c(n) = 2*c(n-1), c(3) = 8, c(2) = 4, c(1) = 2, c(0) = 1, d(n) = 3*d(n-1)+2*n, d(3) = 36, d(2) = 10, d(1) = 2, d(0) = 0

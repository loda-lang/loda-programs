...
; Formula: a(n) = 2*d(n)-1, b(n) = (-c(n-1)+b(n-1))/2, b(3) = -21, b(2) = -10, b(1) = -4, b(0) = -1, c(n) = 2*gcd((-c(n-1)+b(n-1))/2-1,4)*c(n-1), c(3) = 128, c(2) = 32, c(1) = 16, c(0) = 8, d(n) = gcd((-c(n-2)+b(n-2))/2-1,4)/2+d(n-1)+2, d(3) = 9, d(2) = 7, d(1) = 5, d(0) = 2

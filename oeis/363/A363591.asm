...
; Formula: a(n) = b(n+1)-1, b(n) = 3*e(n-1)-2*c(n-1)+b(n-1)+c(n-1)+d(n-1)+2, b(3) = 66, b(2) = 13, b(1) = 1, b(0) = 0, c(n) = 2*c(n-1), c(3) = 8, c(2) = 4, c(1) = 2, c(0) = 1, d(n) = c(n-1)+d(n-1)+2, d(3) = 13, d(2) = 7, d(1) = 3, d(0) = 0, e(n) = 3*e(n-1)+c(n-1)+d(n-1)+2, e(3) = 61, e(2) = 16, e(1) = 3, e(0) = 0

...
; Formula: a(n) = c(n)+1, b(n) = 6*n-1, b(4) = 23, b(3) = 17, b(2) = 11, b(1) = 5, b(0) = 0, c(n) = c(n-1)+d(n-1)+e(n-1)+7, c(4) = 49, c(3) = 31, c(2) = 19, c(1) = 7, c(0) = 0, d(n) = -d(n-1)-e(n-1)+b(n-1)-7, d(4) = -1, d(3) = -1, d(2) = -7, d(1) = -7, d(0) = 0, e(n) = 12*n+2*d(n-1)-2*b(n-1)+e(n-1), e(4) = 24, e(3) = 12, e(2) = 12, e(1) = 12, e(0) = 0

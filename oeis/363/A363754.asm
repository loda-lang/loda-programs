...
; Formula: a(n) = truncate(d(2*n)/4), b(n) = 2*c(n-1)+2*e(n-1)+d(n-1), b(3) = 39, b(2) = 10, b(1) = 1, b(0) = 0, c(n) = 6*c(n-2)+3*c(n-1)-c(n-4)-3*c(n-3)+1, c(9) = 108888, c(8) = 25728, c(7) = 6059, c(6) = 1439, c(5) = 334, c(4) = 82, c(3) = 17, c(2) = 5, c(1) = 0, c(0) = 0, d(n) = e(n-1), d(3) = 12, d(2) = 5, d(1) = 0, d(0) = 1, e(n) = 4*d(n-1)+2*c(n-1)+2*e(n-1)+b(n-1)+1, e(3) = 65, e(2) = 12, e(1) = 5, e(0) = 0

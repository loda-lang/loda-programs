...
; Formula: a(n) = b(n-3), b(n) = c(n-2), b(4) = 55, b(3) = 14, b(2) = 3, b(1) = 1, b(0) = 0, c(n) = truncate((c(n-2)*(n-1)*(-83*n+936)+c(n-1)*((n-1)*(9*n-276)+588)+c(n-3)*((n-1)*(130*n-392)+132))/(d(n-1)*((n-1)*(9*n-276)+588)+126)), c(5) = 2016, c(4) = 644, c(3) = 195, c(2) = 55, c(1) = 14, c(0) = 3, d(n) = d(n-1), d(4) = 0, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0

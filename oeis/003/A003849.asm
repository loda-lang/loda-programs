...
; Formula: a(n) = -truncate((sqrtint(5*(n+2)^2)+n)/2)-2*truncate((-truncate((sqrtint(5*(n+2)^2)+n)/2)+sqrtint(5*truncate((sqrtint(5*(n+2)^2)+n)/2)^2))/2)+sqrtint(5*truncate((sqrtint(5*(n+2)^2)+n)/2)^2)

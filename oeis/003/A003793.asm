...
; Formula: a(n) = truncate((truncate(b(n+1)/2)*gcd(n,2))/2), b(n) = c(n-1)*b(n-1)*(2*c(n-1)+d(n-1)), b(2) = 48, b(1) = 2, b(0) = 1, c(n) = 3*c(n-1), c(2) = 9, c(1) = 3, c(0) = 1, d(n) = 2*c(n-1)+d(n-1), d(2) = 8, d(1) = 2, d(0) = 0

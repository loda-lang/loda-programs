...
; Formula: a(n) = 3*b(n-1), b(n) = 4*b(n-1)+4*d(n-1)+2*c(n-1), b(2) = 66, b(1) = 10, b(0) = 1, c(n) = 2*b(n-1)+2*d(n-1)+c(n-1), c(2) = 33, c(1) = 5, c(0) = 1, d(n) = 2*b(n-1)+2*d(n-1), d(2) = 28, d(1) = 4, d(0) = 1

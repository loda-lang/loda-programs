...
; Formula: a(n) = b(n+1)+1, b(n) = (d(n-1)/c(n-1))/2+b(n-1)+1, b(3) = 6, b(2) = 3, b(1) = 1, b(0) = 0, c(n) = c(n-1)*((d(n-1)/c(n-1))/2+b(n-1)+1), c(3) = 18, c(2) = 3, c(1) = 1, c(0) = 1, d(n) = e(n-1)*((d(n-1)/c(n-1))/2+b(n-1)+1)+c(n-1)+e(n-1), d(3) = 94, d(2) = 13, d(1) = 3, d(0) = 0, e(n) = e(n-1)*((d(n-1)/c(n-1))/2+b(n-1)+1)+c(n-1)+e(n-1), e(3) = 94, e(2) = 13, e(1) = 3, e(0) = 1

...
; Formula: a(n) = d(n+1), b(n) = 2*b(n-1)-e(n-1)+c(n-1)+d(n-1), b(4) = 55, b(3) = 16, b(2) = 5, b(1) = 1, b(0) = 0, c(n) = 2*d(n-1)-2*e(n-1), c(4) = 30, c(3) = 8, c(2) = 2, c(1) = 2, c(0) = 0, d(n) = 2*b(n-1)+2*c(n-1)+2*d(n-1)-e(n-1)-2*e(n-1)+c(n-1)+d(n-1)+f(n-1), d(4) = 144, d(3) = 43, d(2) = 15, d(1) = 4, d(0) = 0, e(n) = 2*b(n-1)+2*c(n-1)+2*d(n-1)-e(n-1)-2*e(n-1)+c(n-1)+d(n-1), e(4) = 101, e(3) = 28, e(2) = 11, e(1) = 3, e(0) = -1, f(n) = 2*b(n-1)+2*c(n-1)+2*d(n-1)-e(n-1)-2*e(n-1)+c(n-1)+d(n-1)+f(n-1), f(4) = 144, f(3) = 43, f(2) = 15, f(1) = 4, f(0) = 1

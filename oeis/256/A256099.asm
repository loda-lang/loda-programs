...
; Formula: a(n) = (b(4*n)/(c(4*n)/(10^n)+1))%10, b(n) = b(n-1)+c(n-1)+d(n-1), b(2) = 2, b(1) = 1, b(0) = 1, c(n) = 2*c(n-1)+b(n-1)+c(n-1)+d(n-1), c(2) = 4, c(1) = 1, c(0) = 0, d(n) = 2*c(n-1)+2*d(n-1), d(2) = 2, d(1) = 0, d(0) = 0

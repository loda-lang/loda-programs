...
; Formula: a(n) = -10*truncate(truncate(b(4*n)/(truncate(c(4*n)/(10^n))+1))/10)+truncate(b(4*n)/(truncate(c(4*n)/(10^n))+1)), b(n) = b(n-1)+c(n-1)+d(n-1), b(2) = 2, b(1) = 1, b(0) = 1, c(n) = 8*c(n-4)+4*c(n-1)+4*c(n-2)-12*c(n-3), c(5) = 296, c(4) = 68, c(3) = 16, c(2) = 4, c(1) = 1, c(0) = 0, d(n) = 2*c(n-1)+2*d(n-1), d(2) = 2, d(1) = 0, d(0) = 0

...
; Formula: a(n) = -10*truncate(truncate(b(4*n)/(truncate(c(4*n)/(10^n))+1))/10)+truncate(b(4*n)/(truncate(c(4*n)/(10^n))+1)), b(n) = b(n-1)+c(n-1)+1, b(1) = 2, b(0) = 1, c(n) = 2*b(n-1)+2*c(n-1)+2*truncate(c(n-1)/3), c(1) = 2, c(0) = 0

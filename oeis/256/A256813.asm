...
; Formula: a(n) = b(n+7), b(n) = (c(n-1)*(-e(n-1)+d(n-1)))/(b(n-1)^5+1)+e(n-1), b(4) = 8, b(3) = 4, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = b(n-1)^5+1, c(4) = 1025, c(3) = 33, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = ((b(n-2)^5+1)*(-((c(n-2)*(-e(n-2)+d(n-2)))/(b(n-2)^5+1))-2*e(n-2)+d(n-1)))/(((c(n-2)*(-e(n-2)+d(n-2)))/(b(n-2)^5+1)+e(n-2))^5+1)+e(n-2), d(4) = 4, d(3) = 2, d(2) = 1, d(1) = 1, d(0) = 0, e(n) = (c(n-1)*(-e(n-1)+d(n-1)))/(b(n-1)^5+1)+2*e(n-1), e(4) = 16, e(3) = 8, e(2) = 4, e(1) = 2, e(0) = 1

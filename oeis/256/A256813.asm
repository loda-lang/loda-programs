...
; Formula: a(n) = b(n+6), b(n) = d(n-1)+truncate((c(n-1)*(-2*d(n-2)+d(n-3)))/((-d(n-2)+d(n-1))^5+1)), b(5) = 16, b(4) = 8, b(3) = 4, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = (-d(n-2)+d(n-1))^5+1, c(5) = 32769, c(4) = 1025, c(3) = 33, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = 2*d(n-1)+truncate(((-2*d(n-2)+d(n-3))*((-d(n-3)+d(n-2))^5+1))/((-d(n-2)+d(n-1))^5+1)), d(5) = 32, d(4) = 16, d(3) = 8, d(2) = 4, d(1) = 2, d(0) = 1

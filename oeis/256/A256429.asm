...
; Formula: a(n) = 5*d(n)+1, b(n) = b(n-1)+c(n-1)-1, b(3) = 1, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = 4*d(n-2)-b(n-2)-c(n-2)+3, c(3) = 5, c(2) = 1, c(1) = 1, c(0) = 1, d(n) = b(n-1)+c(n-1)+d(n-1)-1, d(3) = 3, d(2) = 2, d(1) = 1, d(0) = 0

...
; Formula: a(n) = b(max(n-1,0))+min(n-1,(n-1)%3)-1, b(n) = b(n-3)+c(n-3)+3, b(8) = 9, b(7) = 9, b(6) = 9, b(5) = 5, b(4) = 5, b(3) = 5, b(2) = 2, b(1) = 2, b(0) = 2, c(n) = b(n-6)+c(n-6)+1, c(8) = 3, c(7) = 3, c(6) = 3, c(5) = 1, c(4) = 1, c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0

...
; Formula: a(n) = 4*b(n-1)-3, b(n) = if((c(n-1)+2)==0,0,if(((n+1)^2)<=1,c(n-1)+2,(c(n-1)+2)/((n+1)^valuation(c(n-1)+2,n+1))))+b(n-1), b(2) = 3, b(1) = 2, b(0) = 1, c(n) = if((c(n-1)+2)==0,0,if(((n+1)^2)<=1,c(n-1)+2,(c(n-1)+2)/((n+1)^valuation(c(n-1)+2,n+1)))), c(2) = 1, c(1) = 1, c(0) = 0

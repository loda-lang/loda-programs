...
; Formula: a(n) = f(n)+1, b(n) = b(n-1)+d(n-1)+1, b(4) = 68, b(3) = 33, b(2) = 10, b(1) = 4, b(0) = 0, c(n) = -c(n-1)+d(n-1), c(4) = 14, c(3) = 20, c(2) = 2, c(1) = 3, c(0) = 0, d(n) = 3*c(n-1)+b(n-1)+b(n-2)+c(n-2)+d(n-2)+6, d(4) = 133, d(3) = 34, d(2) = 22, d(1) = 5, d(0) = 3, e(n) = b(n-1)+c(n-1)+d(n-1)+1, e(4) = 88, e(3) = 35, e(2) = 13, e(1) = 4, e(0) = 0, f(n) = 3*c(n-1)+b(n-1)+e(n-1)+5, f(4) = 133, f(3) = 34, f(2) = 22, f(1) = 5, f(0) = 0

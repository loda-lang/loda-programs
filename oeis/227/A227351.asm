...
; 0,1,3,7,2,15,6,4,31,14,12,8,5,63,30,28,24,13,16,9,11,127,62,60,56,29,48,25,27,32,17,19,23,10,255,126,124,120,61,112,57,59,96,49,51,55,26,64,33,35,39,18,47,22,20,511,254,252,248,125,240,121,123,224,113,115,119,58,192,97,99,103,50,111,54,52,128,65,67,71
; Formula: a(n) = A006068(truncate(A087808(A022340(n))/2))

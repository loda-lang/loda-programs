...
; Formula: a(n) = 2*d(n-1), a(6) = 56, a(5) = 30, a(4) = 16, a(3) = 8, a(2) = 4, a(1) = 2, a(0) = 1, b(n) = -f(n-2)+e(n-1)-2, b(7) = -90, b(6) = -50, b(5) = -27, b(4) = -14, b(3) = -7, b(2) = -3, b(1) = 0, b(0) = 0, c(n) = -f(n-3)+e(n-2)-4, c(8) = -92, c(7) = -52, c(6) = -29, c(5) = -16, c(4) = -9, c(3) = -5, c(2) = -2, c(1) = -2, c(0) = 0, d(n) = (b(n-1)+e(n-1)-2)/10+2*d(n-1), d(6) = 51, d(5) = 28, d(4) = 15, d(3) = 8, d(2) = 4, d(1) = 2, d(0) = 1, e(n) = c(n-1)+e(n-1)-1, e(6) = -40, e(5) = -23, e(4) = -13, e(3) = -7, e(2) = -4, e(1) = -1, e(0) = 0, f(n) = -c(n-1)-e(n-1)+f(n-1)+1, f(6) = 88, f(5) = 48, f(4) = 25, f(3) = 12, f(2) = 5, f(1) = 1, f(0) = 0

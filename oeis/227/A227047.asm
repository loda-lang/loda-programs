...
; Formula: a(n) = (min(n+1,(n+1)%2)*c(n+1)+b(n+1)+4)/4-1, b(n) = 2*b(n-2)+c(n-2)-1, b(5) = 5, b(4) = 5, b(3) = 2, b(2) = 2, b(1) = 0, b(0) = 0, c(n) = b(n-2)+c(n-2)-1, c(5) = 3, c(4) = 3, c(3) = 2, c(2) = 2, c(1) = 3, c(0) = 3

...
; Formula: a(n) = (d(n)/2)%4, b(n) = 3*c(n-1)+2*b(n-1)+d(n-1)-1, b(3) = 204, b(2) = 22, b(1) = 3, b(0) = 2, c(n) = 6*c(n-1)+3*b(n-1), c(3) = 336, c(2) = 45, c(1) = 6, c(0) = 0, d(n) = 4*c(n-1)+2*b(n-1)+2*e(n-1)-d(n-1)-5, d(3) = 221, d(2) = 26, d(1) = -1, d(0) = 0, e(n) = 2*c(n-1)-d(n-1)+b(n-1)+e(n-1)-2, e(3) = 98, e(2) = 14, e(1) = 0, e(0) = 0

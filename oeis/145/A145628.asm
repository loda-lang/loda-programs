...
; Formula: a(n) = (c(2*n+2)+d(2*n+2))/gcd(c(2*n+2),b(2*n+2)), b(n) = n*b(n-1), b(3) = 6, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = 11*n*c(n-1)+11*b(n-1), c(3) = 8371, c(2) = 253, c(1) = 11, c(0) = 0, d(n) = d(n-1), d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0

...
; Formula: a(n) = truncate((3*binomial(floor((sqrtint(8*n-8)-1)/2)+2,-binomial(floor((sqrtint(8*n-8)-1)/2)+1,2)+n)*binomial(floor((sqrtint(8*n-8)-1)/2)+3,-binomial(floor((sqrtint(8*n-8)-1)/2)+1,2)+n-2))/(-binomial(floor((sqrtint(8*n-8)-1)/2)+1,2)+n+1))

...
; Formula: a(n) = truncate((b(n)-300)/120)+2, b(n) = 300*d(n-1), b(2) = 90900, b(1) = 300, b(0) = 0, c(n) = 300*d(n-1)+c(n-1), c(2) = 91202, c(1) = 302, c(0) = 2, d(n) = 301*d(n-1)+c(n-1), d(2) = 91505, d(1) = 303, d(0) = 1

...
; Formula: a(n) = c(n)+1, b(n) = 3*b(n-4)+2*b(n-3)+2*d(n-4)+2*e(n-4)+b(n-2)+4, b(5) = 28, b(4) = 14, b(3) = 4, b(2) = 3, b(1) = 2, b(0) = 1, c(n) = b(n-1), c(5) = 14, c(4) = 4, c(3) = 3, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = b(n-1)+d(n-1)+2, d(5) = 34, d(4) = 18, d(3) = 12, d(2) = 7, d(1) = 3, d(0) = 0, e(n) = b(n-1)+e(n-1), e(5) = 24, e(4) = 10, e(3) = 6, e(2) = 3, e(1) = 1, e(0) = 0

...
; Formula: a(n) = d(n)+1, b(n) = c(n-1)+c(n-2)+2, b(5) = 28, b(4) = 14, b(3) = 4, b(2) = 3, b(1) = 2, b(0) = 1, c(n) = c(n-1)+c(n-2)+c(n-3)+c(n-4)+c(n-5)+6, c(7) = 141, c(6) = 70, c(5) = 36, c(4) = 17, c(3) = 9, c(2) = 3, c(1) = -1, c(0) = 2, d(n) = b(n-1), d(5) = 14, d(4) = 4, d(3) = 3, d(2) = 2, d(1) = 1, d(0) = 0

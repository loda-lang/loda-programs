...
; Formula: a(n) = 2*truncate(b(max(2*n-2,0))/gcd(c(max(2*n-2,0)),b(max(2*n-2,0)))), b(n) = b(n-1)*(n+2), b(2) = 12, b(1) = 3, b(0) = 1, c(n) = 14*truncate(c(n-1)/2)*(n+2)+14*b(n-1), c(2) = 434, c(1) = 14, c(0) = 0

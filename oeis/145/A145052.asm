...
; Formula: a(n) = 2*b(n)+3, b(n) = 2*((b(n-2)+b(n-3)+c(n-3)+6)/2)+2*((b(n-3)+c(n-3)+3)/2)-b(n-1)-2*b(n-2)+4, b(4) = 12, b(3) = 6, b(2) = 4, b(1) = 2, b(0) = 0, c(n) = b(n-1)+c(n-1)+3, c(4) = 24, c(3) = 15, c(2) = 8, c(1) = 3, c(0) = 0

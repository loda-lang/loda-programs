; A145391: Number of sublattices of index n of a 2D centered rectangular lattice fixed by the c2mm (cmm) Patterson symmetry operations of the parent lattice.

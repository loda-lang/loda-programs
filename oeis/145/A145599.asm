...
; Formula: a(n) = truncate(truncate((20*binomial(floor((sqrtint(8*n-24)-1)/2)+4,-binomial(floor((sqrtint(8*n-24)-1)/2)+1,2)+n)*binomial(floor((sqrtint(8*n-24)-1)/2)+5,-binomial(floor((sqrtint(8*n-24)-1)/2)+1,2)+n-4))/(-binomial(floor((sqrtint(8*n-24)-1)/2)+1,2)+n+1))/4)

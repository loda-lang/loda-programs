...
; Formula: a(n) = 2*truncate(b(max(2*n-2,0))/gcd(c(max(2*n-2,0)),b(max(2*n-2,0)))), b(n) = b(n-1)*(n+2), b(2) = 12, b(1) = 3, b(0) = 1, c(n) = 22*truncate(c(n-1)/2)*(n+2)+22*b(n-1), c(2) = 1034, c(1) = 22, c(0) = 0

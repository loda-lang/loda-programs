...
; Formula: a(n) = truncate((gcd(0,n)*(truncate((A057335(A341915(A006068(n)))-1)/A293810(A057335(A341915(A006068(n)))))+1))/(gcd(n,truncate((A057335(A341915(A006068(n)))-1)/A293810(A057335(A341915(A006068(n)))))+1)^2))

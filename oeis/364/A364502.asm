...
; Formula: a(n) = truncate(A181819(A181811(truncate((A057335(n-1)-1)/A293810(A057335(n-1)))+1)*(truncate((A057335(n-1)-1)/A293810(A057335(n-1)))+1))/gcd(n,A181819(A181811(truncate((A057335(n-1)-1)/A293810(A057335(n-1)))+1)*(truncate((A057335(n-1)-1)/A293810(A057335(n-1)))+1))))

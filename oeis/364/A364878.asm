...
; Formula: a(n) = A181811(truncate((A057335(2*truncate(2^truncate((sqrtint(8*n+8)-1)/2))-truncate(2^(-binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2)+n))-1)-1)/A293810(A057335(2*truncate(2^truncate((sqrtint(8*n+8)-1)/2))-truncate(2^(-binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2)+n))-1)-1))+1)*(truncate((A057335(2*truncate(2^truncate((sqrtint(8*n+8)-1)/2))-truncate(2^(-binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2)+n))-1)-1)/A293810(A057335(2*truncate(2^truncate((sqrtint(8*n+8)-1)/2))-truncate(2^(-binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2)+n))-1)-1))+1)

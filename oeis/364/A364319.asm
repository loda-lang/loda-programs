...
; Formula: a(n) = (-c(n)+e(n))/4, b(n) = -2*c(n-1)-4*b(n-1)+b(n-1)+d(n-1)+6, b(3) = 15, b(2) = 1, b(1) = 3, b(0) = 1, c(n) = 2*b(n-1)+c(n-1)-2, c(3) = 4, c(2) = 4, c(1) = 0, c(0) = 0, d(n) = 4*b(n-1)+2*c(n-1)+d(n-1)+e(n-1), d(3) = 48, d(2) = 20, d(1) = 4, d(0) = 0, e(n) = 4*b(n-1)+2*c(n-1)+e(n-1), e(3) = 28, e(2) = 16, e(1) = 4, e(0) = 0

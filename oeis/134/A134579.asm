...
; Formula: a(n) = if((min(n,18)^2)==1,min(n,18)^(-min(n,18)+A285109(A010055(max(0,min(n,18)-1)+1)*(min(n,18)-1)+1)),if((-min(n,18)+A285109(A010055(max(0,min(n,18)-1)+1)*(min(n,18)-1)+1))<=(-1),0,min(n,18)^(-min(n,18)+A285109(A010055(max(0,min(n,18)-1)+1)*(min(n,18)-1)+1))))

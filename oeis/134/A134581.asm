...
; Formula: a(n) = a(n-1)+c(n-1)+1, a(5) = 4, a(4) = 4, a(3) = 3, a(2) = 2, a(1) = 1, a(0) = 0, b(n) = 2*b(n-1)-b(n-2)+c(n-1)+1, b(9) = -120, b(8) = -39, b(7) = 1, b(6) = 14, b(5) = 14, b(4) = 10, b(3) = 6, b(2) = 3, b(1) = 1, b(0) = 0, c(n) = 2*c(n-1)-b(n-3)-2*c(n-2), c(8) = -42, c(7) = -28, c(6) = -14, c(5) = -5, c(4) = -1, c(3) = 0, c(2) = 0, c(1) = 0, c(0) = 0

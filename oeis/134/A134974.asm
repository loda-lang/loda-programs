...
; Formula: a(n) = -10*truncate(truncate((4*b(5*n))/(truncate(c(5*n)/(10^n))+2))/10)+truncate((4*b(5*n))/(truncate(c(5*n)/(10^n))+2)), b(n) = 3*b(n-1)-b(n-2), b(3) = 205, b(2) = 82, b(1) = 41, b(0) = 41, c(n) = 2*c(n-1)+b(n-1), c(1) = 41, c(0) = 0

...
; Formula: a(n) = b(n-1)+3, b(n) = -b(n-1)+b(n-2)+c(n-2)+d(n-2)+1, b(5) = 4, b(4) = 4, b(3) = 1, b(2) = 2, b(1) = 0, b(0) = 1, c(n) = c(n-1)+d(n-1), c(5) = 8, c(4) = 6, c(3) = 2, c(2) = 2, c(1) = 0, c(0) = 0, d(n) = -d(n-1)+d(n-2)+d(n-3)+max(d(n-1),2), d(5) = 4, d(4) = 2, d(3) = 4, d(2) = 0, d(1) = 2, d(0) = 0

...
; Formula: a(n) = d(n+1), b(n) = b(n-1)+b(n-2), b(5) = 8, b(4) = 5, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = c(n-2)+d(n-2)+n-1, c(5) = 12, c(4) = 6, c(3) = 3, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = b(n-1)+c(n-1)+d(n-1), d(5) = 22, d(4) = 11, d(3) = 5, d(2) = 2, d(1) = 1, d(0) = 0

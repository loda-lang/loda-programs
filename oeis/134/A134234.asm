...
; Formula: a(n) = truncate((-2)^min(2*truncate((sqrtint(8*n)-1)/2)-n+binomial(truncate((sqrtint(8*n)-1)/2),2)+1,1))*binomial(-n+binomial(truncate((sqrtint(8*n)-1)/2),2),min(2*truncate((sqrtint(8*n)-1)/2)-n+binomial(truncate((sqrtint(8*n)-1)/2),2)+1,1))

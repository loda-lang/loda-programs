...
; Formula: a(n) = d(n)/4+2, b(n) = 2*e(n-1)+7, b(4) = 59, b(3) = 41, b(2) = 13, b(1) = 7, b(0) = 0, c(n) = 2*e(n-1)-c(n-1)-d(n-1)+b(n-1)+1, c(4) = -9, c(3) = 19, c(2) = -3, c(1) = 1, c(0) = 0, d(n) = 4*e(n-1)+2*c(n-1)-2*b(n-1)+d(n-1)+16, d(4) = 160, d(3) = 84, d(2) = 32, d(1) = 16, d(0) = 0, e(n) = -e(n-2)+c(n-1)+d(n-1), e(5) = 125, e(4) = 86, e(3) = 26, e(2) = 17, e(1) = 3, e(0) = 0

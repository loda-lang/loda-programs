...
; Formula: a(n) = truncate((floor((sqrtint(8*n)-1)/2)+2)/(min(-binomial(floor((sqrtint(8*n)-1)/2)+1,2)+n-1,-n+binomial(floor((sqrtint(8*n)-1)/2)+1,2)+floor((sqrtint(8*n)-1)/2)+1)+1))-1

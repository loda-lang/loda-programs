...
; Formula: a(n) = 27*truncate(d(n+5)/256)+14, b(n) = -e(n-1)+b(n-1)+d(n-1), b(4) = 200, b(3) = 40, b(2) = 8, b(1) = 0, b(0) = 0, c(n) = 2*b(n-1)-e(n-1)+d(n-1), c(4) = 240, c(3) = 48, c(2) = 8, c(1) = 0, c(0) = 0, d(n) = 8*c(n-1)+8*f(n-1), d(4) = 1152, d(3) = 192, d(2) = 32, d(1) = 8, d(0) = 0, e(n) = 4*c(n-1), e(4) = 192, e(3) = 32, e(2) = 0, e(1) = 0, e(0) = 0, f(n) = 4*c(n-1)+4*f(n-1), f(4) = 576, f(3) = 96, f(2) = 16, f(1) = 4, f(0) = 1

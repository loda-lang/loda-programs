...
; Formula: a(n) = binomial(truncate((max(-n+binomial(floor((sqrtint(8*n)+1)/2),2)+floor((sqrtint(8*n)+1)/2)+3,-binomial(floor((sqrtint(8*n)+1)/2),2)+n+2)+1)/2),-truncate(max(-n+binomial(floor((sqrtint(8*n)+1)/2),2)+floor((sqrtint(8*n)+1)/2)+3,-binomial(floor((sqrtint(8*n)+1)/2),2)+n+2)/2)+truncate((max(-n+binomial(floor((sqrtint(8*n)+1)/2),2)+floor((sqrtint(8*n)+1)/2)+3,-binomial(floor((sqrtint(8*n)+1)/2),2)+n+2)+1)/2))-1

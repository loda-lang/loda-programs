...
; Formula: a(n) = -binomial(truncate((sqrtint(8*n)-1)/2)+1,2)-3*truncate((-binomial(truncate((sqrtint(8*n)-1)/2)+1,2)+truncate((sqrtint(8*n)-1)/2)+n-1)/3)+truncate((sqrtint(8*n)-1)/2)+n-1

...
; Formula: a(n) = e(n)/4, b(n) = max(-2*c(n-1)-3*b(n-1)+d(n-1)-6,0), b(3) = 2, b(2) = 0, b(1) = 0, b(0) = 1, c(n) = 2*b(n-1)+c(n-1), c(3) = 2, c(2) = 2, c(1) = 2, c(0) = 0, d(n) = 4*b(n-1)+4*max(-2*c(n-3)-3*b(n-3)+d(n-3)-6,0)+2*c(n-1)+2*d(n-1)-d(n-2)-4*b(n-2), d(4) = 48, d(3) = 24, d(2) = 12, d(1) = 4, d(0) = 0, e(n) = 4*b(n-1)+2*c(n-1)+e(n-1), e(3) = 12, e(2) = 8, e(1) = 4, e(0) = 0

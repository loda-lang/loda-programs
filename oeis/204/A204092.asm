...
; Formula: a(n) = 2*c(n)+1, b(n) = 2*b(n-1)+2, b(2) = 6, b(1) = 2, b(0) = 0, c(n) = 4*c(n-1)+2*b(n-1)+d(n-1)+1, c(2) = 8, c(1) = 1, c(0) = 0, d(n) = 5*d(n-1)+4*b(n-2)-2*d(n-2)+5, d(4) = 104, d(3) = 15, d(2) = 0, d(1) = -1, d(0) = 0

...
; Formula: a(n) = truncate((2*min(n-2,(n-2)%2)*b(max(n-2,0))+2*b(max(n-2,0)))/4), b(n) = 3*b(n-2)+2*c(n-2), b(3) = 2, b(2) = 2, b(1) = 0, b(0) = 0, c(n) = 4*b(n-2)+3*c(n-2), c(3) = 3, c(2) = 3, c(1) = 1, c(0) = 1

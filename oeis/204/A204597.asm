...
; Formula: a(n) = c(n+1)+1, b(n) = (((((e(n-4)/2-e(n-4)+b(n-4))^2)/2-(e(n-4)/2-e(n-4)+b(n-4))^2+b(n-3))^2)/2-(((e(n-4)/2-e(n-4)+b(n-4))^2)/2-(e(n-4)/2-e(n-4)+b(n-4))^2+b(n-3))^2+b(n-2))^2+2*(((((e(n-4)/2-e(n-4)+b(n-4))^2)/2-(e(n-4)/2-e(n-4)+b(n-4))^2+b(n-3))^2)/2-(((e(n-4)/2-e(n-4)+b(n-4))^2)/2-(e(n-4)/2-e(n-4)+b(n-4))^2+b(n-3))^2+b(n-2))^2+2*(((e(n-4)/2-e(n-4)+b(n-4))^2)/2-(e(n-4)/2-e(n-4)+b(n-4))^2+b(n-3))^2+2*(e(n-4)/2-e(n-4)+b(n-4))^2+2*b(n-4)+2*e(n-4)+2*f(n-4)-(((((e(n-4)/2-e(n-4)+b(n-4))^2)/2-(e(n-4)/2-e(n-4)+b(n-4))^2+b(n-3))^2)/2-(((e(n-4)/2-e(n-4)+b(n-4))^2)/2-(e(n-4)/2-e(n-4)+b(n-4))^2+b(n-3))^2+b(n-2))^2-(e(n-4)/2-e(n-4)+b(n-4))^2-b(n-2)-f(n-4)-2*b(n-1)-2*b(n-3)-2*b(n-4)-2*e(n-4)+b(n-1)+b(n-3)+1, b(5) = 2, b(4) = 2, b(3) = 2, b(2) = 0, b(1) = 1, b(0) = 0, c(n) = (e(n-1)/2-e(n-1)+b(n-1))^2-d(n-1)+f(n-1), c(5) = 1, c(4) = 2, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = -e(n-1)+b(n-1), d(5) = 1, d(4) = 1, d(3) = -1, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = (e(n-1)/2-e(n-1)+b(n-1))^2, e(5) = 1, e(4) = 1, e(3) = 1, e(2) = 1, e(1) = 0, e(0) = 0, f(n) = -e(n-1)+b(n-1)+f(n-1), f(5) = 2, f(4) = 1, f(3) = 0, f(2) = 1, f(1) = 0, f(0) = 0

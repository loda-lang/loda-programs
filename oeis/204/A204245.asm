...
; Formula: a(n) = a(n-1)*(n*b(n-1)+b(n-1))+c(n-1), a(3) = 84, a(2) = 4, a(1) = 1, a(0) = 1, b(n) = n*b(n-1)+b(n-1), b(3) = 24, b(2) = 6, b(1) = 2, b(0) = 1, c(n) = c(n-1)*(n*b(n-1)+b(n-1)), c(3) = -288, c(2) = -12, c(1) = -2, c(0) = -1

...
; Formula: a(n) = d(n+3), b(n) = d(n-1)+e(n-1), b(6) = 94, b(5) = 30, b(4) = 8, b(3) = 2, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = 2*f(n-1)+e(n-1)+1, c(7) = 253, c(6) = 106, c(5) = 45, c(4) = 19, c(3) = 8, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = 2*b(n-1)+c(n-1)+d(n-1), d(6) = 156, d(5) = 51, d(4) = 16, d(3) = 4, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = b(n-1)+c(n-1)+d(n-1), e(6) = 126, e(5) = 43, e(4) = 14, e(3) = 4, e(2) = 1, e(1) = 0, e(0) = 0, f(n) = 2*f(n-1)+1, f(7) = 127, f(6) = 63, f(5) = 31, f(4) = 15, f(3) = 7, f(2) = 3, f(1) = 1, f(0) = 0

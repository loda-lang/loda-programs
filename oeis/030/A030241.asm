...
; Formula: a(n) = c(n+1), b(n) = (-max(c(n-1)-1,0)*(max(c(n-2)-1,0)-1)+2)/(b(n-1)+d(n-1)+max(c(n-1)-1,0)+1), b(4) = 0, b(3) = 1, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = b(n-1)+d(n-1)+max(c(n-1)-1,0)+1, c(4) = 4, c(3) = 3, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = (d(n-1)+1)/10, d(4) = 0, d(3) = 0, d(2) = 0, d(1) = 0, d(0) = 0

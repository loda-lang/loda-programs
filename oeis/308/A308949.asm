...
; Formula: a(n) = b(n+1)/gcd(c(n+1),b(n+1)), b(n) = 2*b(n-1)+d(n-1), b(2) = 4, b(1) = 1, b(0) = 0, c(n) = max(2*c(n-1)*b(n-1),1), c(2) = 2, c(1) = 1, c(0) = 0, d(n) = 8*b(n-1)+2*d(n-1), d(2) = 12, d(1) = 2, d(0) = 1

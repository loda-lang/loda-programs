...
; Formula: a(n) = e(n+1), b(n) = (-c(n-1)*(-2*f(n-1)+e(n-1)-1)+d(n-1))/(b(n-1)+f(n-1)+1), b(4) = 5, b(3) = 2, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = b(n-1)+f(n-1)+1, c(4) = 10, c(3) = 5, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = (-c(n-1)*(-2*f(n-1)+e(n-1)-1)+d(n-1))/(b(n-1)+f(n-1)+1), d(4) = 5, d(3) = 2, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = b(n-1)+c(n-1)+1, e(4) = 8, e(3) = 4, e(2) = 2, e(1) = 1, e(0) = 0, f(n) = b(n-1)+c(n-1)+f(n-1)+1, f(4) = 15, f(3) = 7, f(2) = 3, f(1) = 1, f(0) = 0

...
; Formula: a(n) = 3*d(n)+1, b(n) = 2*d(n-1)-c(n-1)-2*b(n-1)+b(n-1)+1, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = 2*b(n-1)+c(n-1), c(2) = 3, c(1) = 1, c(0) = -1, d(n) = 2*b(n-1)+2*d(n-1)+c(n-1), d(2) = 5, d(1) = 1, d(0) = 0

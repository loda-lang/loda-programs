...
; Formula: a(n) = ((b(4*n+4)/4)/(c(4*n+4)/(10^(n+1))))%10, b(n) = 2*b(n-1)+2*c(n-1)+e(n-1), b(3) = 62, b(2) = 10, b(1) = 2, b(0) = 1, c(n) = 2*b(n-1)+2*c(n-1)+c(n-1)+e(n-1), c(3) = 74, c(2) = 12, c(1) = 2, c(0) = 0, d(n) = 2*b(n-1)+2*c(n-1)+c(n-1)+d(n-1)+e(n-1), d(3) = 88, d(2) = 14, d(1) = 2, d(0) = 0, e(n) = 4*c(n-1)+2*b(n-1)+2*e(n-1)+d(n-1), e(3) = 118, e(2) = 18, e(1) = 2, e(0) = 0

...
; Formula: a(n) = -10*truncate(truncate(truncate(b(4*n+4)/4)/truncate(c(4*n+4)/(10^(n+1))))/10)+truncate(truncate(b(4*n+4)/4)/truncate(c(4*n+4)/(10^(n+1)))), b(n) = 8*b(n-1)+8*b(n-3)-2*b(n-4)-12*b(n-2), b(6) = 15412, b(5) = 2452, b(4) = 390, b(3) = 62, b(2) = 10, b(1) = 2, b(0) = 1, c(n) = 8*c(n-1)+8*c(n-3)-2*c(n-4)-12*c(n-2), c(6) = 18328, c(5) = 2916, c(4) = 464, c(3) = 74, c(2) = 12, c(1) = 2, c(0) = 0

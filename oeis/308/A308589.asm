...
; Formula: a(n) = 2*b(n-1)+2*c(n-1)-2*a(n-1)+a(n-1)+c(n-1), a(2) = 7, a(1) = 3, a(0) = 0, b(n) = 2*c(n-1)-a(n-1)+b(n-1), b(2) = 3, b(1) = 2, b(0) = 0, c(n) = 2*c(n-1)-a(n-1)+a(n-1)+b(n-1), c(2) = 6, c(1) = 2, c(0) = 1

...
; Formula: a(n) = d(n+1), b(n) = b(n-1)+b(n-2)+4, b(5) = 48, b(4) = 28, b(3) = 16, b(2) = 8, b(1) = 4, b(0) = 0, c(n) = c(n-1)+d(n-1), c(5) = 81, c(4) = 30, c(3) = 10, c(2) = 3, c(1) = 1, c(0) = 1, d(n) = b(n-1)+c(n-1)+max(-c(n-2)+d(n-1)+2,1)+max(-c(n-3)+d(n-2)+2,1)-2, d(6) = 260, d(5) = 118, d(4) = 51, d(3) = 20, d(2) = 7, d(1) = 2, d(0) = 0

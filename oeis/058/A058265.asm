...
; Formula: a(n) = ((b(3*n)+d(3*n))/(c(3*n)/(10^n)))%10, b(n) = b(n-1)+c(n-1)+d(n-1), b(2) = 11, b(1) = 2, b(0) = 1, c(n) = 4*c(n-1)+3*d(n-1)+2*b(n-1), c(2) = 37, c(1) = 6, c(0) = 1, d(n) = 2*c(n-1)+2*d(n-1)+b(n-1), d(2) = 20, d(1) = 3, d(0) = 0

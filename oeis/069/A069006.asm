...
; Formula: a(n) = d(n+1)/3, b(n) = 3*c(n-2)-c(n-4)+b(n-1)+b(n-2)+6, b(8) = 9255, b(7) = 2628, b(6) = 753, b(5) = 210, b(4) = 63, b(3) = 15, b(2) = 6, b(1) = 0, b(0) = 0, c(n) = 3*c(n-1)+3*c(n-2)-c(n-4)-4*c(n-3)+c(n-5)+3, c(6) = 2010, c(5) = 567, c(4) = 162, c(3) = 42, c(2) = 12, c(1) = 0, c(0) = 0, d(n) = b(n-1)+c(n-1)+d(n-1)+3, d(5) = 315, d(4) = 87, d(3) = 27, d(2) = 6, d(1) = 3, d(0) = 0

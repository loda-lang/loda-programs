...
; Formula: a(n) = f(n)+1, b(n) = b(n-1)+d(n-1)+1, b(4) = 84, b(3) = 28, b(2) = 9, b(1) = 2, b(0) = 0, c(n) = d(n-1)+1, c(4) = 56, c(3) = 19, c(2) = 7, c(1) = 2, c(0) = 1, d(n) = 4*d(n-2)+3*d(n-3)+2*b(n-3)+d(n-1)+10, d(4) = 159, d(3) = 55, d(2) = 18, d(1) = 6, d(0) = 1, e(n) = b(n-1)+c(n-1)+d(n-1)+1, e(4) = 103, e(3) = 35, e(2) = 11, e(1) = 3, e(0) = 0, f(n) = 2*c(n-1)+b(n-1)+d(n-1)+e(n-1)+3, f(4) = 159, f(3) = 55, f(2) = 18, f(1) = 6, f(0) = 0

...
; Formula: a(n) = truncate(((binomial(A000040(n+1),A064722(2*truncate(A000040(n+1)/2))+1)-1)^2-A013636(A008578(n+1))*truncate(((binomial(A000040(n+1),A064722(2*truncate(A000040(n+1)/2))+1)-1)^2)/A013636(A008578(n+1))))/A000040(n))

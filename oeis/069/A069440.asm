...
; Formula: a(n) = truncate(c(n+1)/4), b(n) = 2*b(n-1)+2*e(n-1)+d(n-1)+4, b(4) = 152, b(3) = 60, b(2) = 22, b(1) = 6, b(0) = 0, c(n) = 8*e(n-2)+4*b(n-2)+4*c(n-1), c(4) = 352, c(3) = 64, c(2) = 8, c(1) = 0, c(0) = 0, d(n) = 2*e(n-1)+b(n-1)+2, d(4) = 64, d(3) = 26, d(2) = 10, d(1) = 4, d(0) = 0, e(n) = -2*truncate((b(n-1)+d(n-1)+e(n-1)+4)/2)+b(n-1)+d(n-1)+e(n-1)+4, e(4) = 1, e(3) = 1, e(2) = 1, e(1) = 1, e(0) = 1

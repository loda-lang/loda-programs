...
; Formula: a(n) = 2*a(n-1)-(b(n-1)/2), a(7) = 30, a(6) = 12, a(5) = 4, a(4) = 1, a(3) = 0, a(2) = 0, a(1) = 0, a(0) = 0, b(n) = 2*c(n-2), b(7) = -20, b(6) = -12, b(5) = -8, b(4) = -4, b(3) = -2, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = 2*c(n-1)+2*c(n-4)+2*a(n-6)-((2*c(n-6))/2)-(b(n-6)/2)-2*c(n-3), c(7) = -27, c(6) = -16, c(5) = -10, c(4) = -6, c(3) = -4, c(2) = -2, c(1) = -1, c(0) = 0

...
; Formula: a(n) = 2*a(n-1)-(b(n-1)/2), a(7) = 30, a(6) = 12, a(5) = 4, a(4) = 1, a(3) = 0, a(2) = 0, a(1) = 0, a(0) = 0, b(n) = c(n-1), b(7) = -20, b(6) = -12, b(5) = -8, b(4) = -4, b(3) = -2, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = 2*(c(n-7)/2)+2*c(n-1)+2*c(n-4)+2*a(n-5)-2*(c(n-6)/2)-2*c(n-3)-2*a(n-6), c(10) = -142, c(9) = -88, c(8) = -54, c(7) = -32, c(6) = -20, c(5) = -12, c(4) = -8, c(3) = -4, c(2) = -2, c(1) = 0, c(0) = 0

...
; 2,2,2,2,5,5,2,2,7,7,3,3,2,2,2,2,5,5,11,3,2,2,7,7,2,2,2,2,5,5,2,2,3,3,3,3,2,2,5,5,2,2,2,2,3,3,13,13,2,2,2,2,17,5,2,2,3,3,7,7,2,2,2,2,3,3,3,5,2,2,7,7,2,2,2,2,11,11,5,5
; Formula: a(n) = A126773(A055204(n+2)-1)

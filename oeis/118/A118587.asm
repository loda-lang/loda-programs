...
; Formula: a(n) = 2*e(n+1)+17, b(n) = b(n-1)+c(n-1)+d(n-1)+19, b(3) = 150, b(2) = 59, b(1) = 19, b(0) = 0, c(n) = c(n-1)+51, c(3) = 108, c(2) = 57, c(1) = 6, c(0) = 0, d(n) = 15, d(3) = 15, d(2) = 15, d(1) = 15, d(0) = 0, e(n) = -c(n-1)+b(n-1)+e(n-1), e(3) = 15, e(2) = 13, e(1) = 0, e(0) = 0

...
; Formula: a(n) = c(n+2), b(n) = -b(n-1)-d(n-2)+c(n-2)-2, b(4) = -1, b(3) = -1, b(2) = -1, b(1) = -1, b(0) = 0, c(n) = -b(n-1)-c(n-1)+d(n-1), c(4) = -1, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = 2*b(n-2)+2*c(n-2)-b(n-1)-2*d(n-2), d(4) = -1, d(3) = -1, d(2) = 1, d(1) = 0, d(0) = 0

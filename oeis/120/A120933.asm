...
; Formula: a(n) = 2^max(-n+binomial(floor((sqrtint(8*n)-1)/2)+1,2)+floor((sqrtint(8*n)-1)/2),0)+(-binomial(floor((sqrtint(8*n)-1)/2)+1,2)+binomial(0,-n+binomial(floor((sqrtint(8*n)-1)/2)+1,2)+floor((sqrtint(8*n)-1)/2)+1)+n-1)*2^max(-n+binomial(floor((sqrtint(8*n)-1)/2)+1,2)+floor((sqrtint(8*n)-1)/2),0)

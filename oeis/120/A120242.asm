...
; Formula: a(n) = A212652(A082662(n))

#offset 1

seq $0,82662 ; Numbers k such that the odd part of k is less than sqrt(2k).
seq $0,212652 ; a(n) is the least positive integer M such that n = T(M) - T(k), for k an integer, 0 <= k <= M, where T(r) = A000217(r) is the r-th triangular number.

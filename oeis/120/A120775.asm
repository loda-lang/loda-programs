...
; Formula: a(n) = truncate((min(3*n-2,(3*n-2)%2)*b(max(3*n-2,0))+c(max(3*n-2,0)))/2)+1, b(n) = 3*b(n-2)-b(n-4)+2, b(6) = 16, b(5) = 5, b(4) = 5, b(3) = 1, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = 2*c(n-2)+b(n-2)+2, c(3) = 4, c(2) = 4, c(1) = 1, c(0) = 1

...
; Formula: a(n) = (c(n+1)-3)/2, b(n) = (2*max(b(n-2)-4,0))/2+2*max(b(n-2)-4,0)+d(n-2)+7, b(2) = 7, b(1) = 8, b(0) = 0, c(n) = 2*max(b(n-1)-4,0)+3, c(2) = 11, c(1) = 3, c(0) = 4, d(n) = (2*max(b(n-1)-4,0))/2+d(n-1), d(2) = 4, d(1) = 0, d(0) = 0

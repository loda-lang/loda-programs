...
; Formula: a(n) = b(n-1)+c(n-1), a(3) = 57, a(2) = 11, a(1) = 2, a(0) = 0, b(n) = 5*c(n-1)+3*b(n-1)+2*b(n-2)+2*c(n-2), b(3) = 221, b(2) = 43, b(1) = 8, b(0) = 1, c(n) = 2*c(n-1)+b(n-1), c(3) = 71, c(2) = 14, c(1) = 3, c(0) = 1

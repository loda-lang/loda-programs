...
; Formula: a(n) = d(n)/7, b(n) = (-c(n-1)+b(n-1))/2+1, b(2) = -10, b(1) = -7, b(0) = 0, c(n) = c(n-1)*(((-c(n-1)+b(n-1))/2+1)%2+2)^3, c(2) = 128, c(1) = 16, c(0) = 16, d(n) = (((-c(n-1)+b(n-1))/2+1)%2+2)^3, d(2) = 8, d(1) = 1, d(0) = 8

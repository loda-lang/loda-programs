...
; Formula: a(n) = truncate(d(n)/2), b(n) = 2*b(n-2)+2*c(n-2)+2*e(n-1), b(7) = 252, b(6) = 116, b(5) = 52, b(4) = 24, b(3) = 10, b(2) = 4, b(1) = 1, b(0) = 1, c(n) = 4*e(n-2)+2*c(n-4)-4*e(n-4)+c(n-1)+c(n-2), c(9) = 896, c(8) = 422, c(7) = 198, c(6) = 92, c(5) = 42, c(4) = 18, c(3) = 8, c(2) = 4, c(1) = 2, c(0) = 0, d(n) = 2*b(n-1)+2*c(n-1), d(6) = 188, d(5) = 84, d(4) = 36, d(3) = 16, d(2) = 6, d(1) = 2, d(0) = 0, e(n) = 2*e(n-1), e(7) = 64, e(6) = 32, e(5) = 16, e(4) = 8, e(3) = 4, e(2) = 2, e(1) = 1, e(0) = 0

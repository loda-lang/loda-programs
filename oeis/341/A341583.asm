...
; Formula: a(n) = d(n)/2, b(n) = d(n-1)+e(n-1)+f(n-1)+f1(n-1), b(6) = 116, b(5) = 52, b(4) = 24, b(3) = 10, b(2) = 4, b(1) = 1, b(0) = 1, c(n) = 2*b(n-1)-c(n-2)-d(n-2)+c(n-1), c(6) = 92, c(5) = 42, c(4) = 18, c(3) = 8, c(2) = 4, c(1) = 2, c(0) = 0, d(n) = 2*b(n-1)+2*c(n-1), d(6) = 188, d(5) = 84, d(4) = 36, d(3) = 16, d(2) = 6, d(1) = 2, d(0) = 0, e(n) = e(n-1)+f1(n-1), e(6) = 16, e(5) = 8, e(4) = 4, e(3) = 2, e(2) = 1, e(1) = 1, e(0) = 0, f(n) = e(n-1)+f(n-1)+f1(n-1), f(6) = 32, f(5) = 16, f(4) = 8, f(3) = 4, f(2) = 2, f(1) = 1, f(0) = 0, f1(n) = f(n-1), f1(6) = 16, f1(5) = 8, f1(4) = 4, f1(3) = 2, f1(2) = 1, f1(1) = 0, f1(0) = 1

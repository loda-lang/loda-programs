...
; 0,1,1,0,1,2,1,0,0,2,1,1,1,2,2,0,1,1,1,2,2,2,1,1,0,2,0,2,1,4,1,0,2,2,2,0,1,2,2,1,1,4,1,2,1,2,1,0,0,1,2,2,1,0,2,1,2,2,1,3,1,2,1,0,2,4,1,2,2,4,1,0,1,2,1,2,2,4,1,1
; Formula: a(n) = (gcd(A010052(n+1),2)-1)*(-A341596(n)+A034444(n+1))

...
; Formula: a(n) = c(n-1)+d(n-1)+e(n-1), a(5) = 20, a(4) = 10, a(3) = 5, a(2) = 2, a(1) = 1, a(0) = 0, b(n) = -c(n-1)+b(n-1)+d(n-1)+1, b(5) = 12, b(4) = 7, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = -c(n-1)+b(n-1)+d(n-1)+1, c(5) = 12, c(4) = 7, c(3) = 3, c(2) = 2, c(1) = 1, c(0) = 1, d(n) = 2*c(n-3)-b(n-3)-c(n-3)-d(n-3)+b(n-3)+c(n-3)+d(n-1)+d(n-2)+d(n-3)+1, d(5) = 22, d(4) = 11, d(3) = 6, d(2) = 2, d(1) = 1, d(0) = 0, e(n) = c(n-2), e(5) = 3, e(4) = 2, e(3) = 1, e(2) = 1, e(1) = 0, e(0) = 0

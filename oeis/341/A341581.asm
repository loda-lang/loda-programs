...
; Formula: a(n) = d(n+1), b(n) = -c(n-1)+b(n-1)+e(n-1)+1, b(5) = 7, b(4) = 3, b(3) = 2, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = -c(n-1)+b(n-1)+e(n-1)+1, c(5) = 7, c(4) = 3, c(3) = 2, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = c(n-1)+c(n-3)+e(n-1), d(5) = 10, d(4) = 5, d(3) = 2, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = 2*c(n-3)+c(n-1)+e(n-1), e(5) = 11, e(4) = 6, e(3) = 2, e(2) = 1, e(1) = 0, e(0) = 0

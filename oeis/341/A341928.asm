...
; Formula: a(n) = e(n)+3, b(n) = 2*d(n-1)+2*max(c(n-1),7)+b(n-1)+2, b(3) = 128, b(2) = 42, b(1) = 18, b(0) = 0, c(n) = d(n-1)+max(c(n-1),7)+2, c(3) = 44, c(2) = 13, c(1) = 10, c(0) = 0, d(n) = 3*d(n-2)+3*max(c(n-2),7)+b(n-2)+5, d(3) = 56, d(2) = 29, d(1) = 1, d(0) = 1, e(n) = 3*d(n-1)+3*max(c(n-1),7)+b(n-1)+4, e(3) = 172, e(2) = 55, e(1) = 28, e(0) = 0

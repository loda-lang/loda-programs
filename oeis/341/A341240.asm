...
; Formula: a(n) = truncate(d(n)/2)+1, b(n) = 3*b(n-1)+2*truncate(c(n-1)/b(n-1)), b(2) = 9, b(1) = 3, b(0) = 1, c(n) = b(n-1)*(2*b(n-1)+2*truncate(c(n-1)/b(n-1))), c(2) = 18, c(1) = 2, c(0) = 0, d(n) = 2*b(n-1)+2*truncate(c(n-1)/b(n-1)), d(2) = 6, d(1) = 2, d(0) = 0

...
; Formula: a(n) = c(n-1)+1, b(n) = 2*c(n-1)+d(n-1)+3, b(2) = 34, b(1) = 19, b(0) = 0, c(n) = b(n-1)+c(n-1)+d(n-1)+3, c(2) = 42, c(1) = 11, c(0) = 8, d(n) = 2*d(n-1)+2*d(n-2)-d(n-3)+4, d(5) = 441, d(4) = 165, d(3) = 64, d(2) = 21, d(1) = 9, d(0) = 0

...
; Formula: a(n) = A035513(n+1)+A356874(A130452(n+1))

mov $1,$0
add $1,1
seq $1,130452 ; Triangle read by rows: A097806 * A130321 as infinite lower triangular matrices.
...
add $1,1
add $0,1
seq $0,35513 ; Wythoff array read by falling antidiagonals.
sub $0,1
add $0,$1

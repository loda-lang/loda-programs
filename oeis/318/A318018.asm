...
; Formula: a(n) = c(max(2*n-2,0))+2, b(n) = b(n-1)+b(n-3)+d(n-1)+3, b(9) = 252, b(8) = 151, b(7) = 90, b(6) = 53, b(5) = 30, b(4) = 17, b(3) = 9, b(2) = 3, b(1) = 1, b(0) = 0, c(n) = b(n-1)+3, c(7) = 56, c(6) = 33, c(5) = 20, c(4) = 12, c(3) = 6, c(2) = 4, c(1) = 2, c(0) = 0, d(n) = b(n-3)+d(n-3)+4, d(6) = 17, d(5) = 11, d(4) = 7, d(3) = 4, d(2) = 4, d(1) = 2, d(0) = 0

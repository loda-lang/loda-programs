...
; Formula: a(n) = d(2*n)+2, b(n) = b(n-3)+c(n-3)+e(n-3)+3, b(6) = 20, b(5) = 12, b(4) = 6, b(3) = 4, b(2) = 2, b(1) = 0, b(0) = 1, c(n) = b(n-1)+c(n-1)+e(n-1), c(6) = 53, c(5) = 30, c(4) = 17, c(3) = 9, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = b(n-2)+c(n-2)+e(n-2)+3, d(6) = 33, d(5) = 20, d(4) = 12, d(3) = 6, d(2) = 4, d(1) = 2, d(0) = 0, e(n) = c(n-3)+e(n-3)+4, e(6) = 17, e(5) = 11, e(4) = 7, e(3) = 4, e(2) = 4, e(1) = 2, e(0) = 0

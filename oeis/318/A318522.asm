...
; Formula: a(n) = (d(4*n+4)/(c(4*n+4)/(10^(n+1))))%10, b(n) = 4*c(n-1)+2*b(n-1)+2*d(n-1), b(2) = 8, b(1) = 2, b(0) = 1, c(n) = 5*c(n-1)+b(n-1)+d(n-1), c(2) = 7, c(1) = 1, c(0) = 0, d(n) = c(n-1)+d(n-1), d(2) = 1, d(1) = 0, d(0) = 0

...
; Formula: a(n) = A000203(if((truncate((if((gcd(0,5*n+4)^2)<=1,0,valuation((5*n+4)^(5*n+4),gcd(0,5*n+4)))-9)/5)+1)==0,0,(truncate((if((gcd(0,5*n+4)^2)<=1,0,valuation((5*n+4)^(5*n+4),gcd(0,5*n+4)))-9)/5)+1)/(2^valuation(truncate((if((gcd(0,5*n+4)^2)<=1,0,valuation((5*n+4)^(5*n+4),gcd(0,5*n+4)))-9)/5)+1,2))))

...
; Formula: a(n) = c(n-1)+2, b(n) = d(n-1)+f(n-1), b(6) = -4, b(5) = -2, b(4) = -3, b(3) = 0, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = -b(n-1)+c(n-1)+e(n-1)+f1(n-1)+1, c(6) = 89, c(5) = 44, c(4) = 20, c(3) = 9, c(2) = 4, c(1) = 1, c(0) = 0, d(n) = -d(n-1)-e(n-1)-f(n-1)+1, d(6) = -27, d(5) = -12, d(4) = -4, d(3) = -3, d(2) = -1, d(1) = 1, d(0) = 0, e(n) = c(n-1)+d(n-1)+e(n-1)+1, e(6) = 65, e(5) = 32, e(4) = 15, e(3) = 8, e(2) = 4, e(1) = 1, e(0) = 0, f(n) = -b(n-1)+f1(n-1), f(6) = 12, f(5) = 8, f(4) = 2, f(3) = 0, f(2) = 1, f(1) = 0, f(0) = 0, f1(n) = c(n-2)+1, f1(6) = 21, f1(5) = 10, f1(4) = 5, f1(3) = 2, f1(2) = 1, f1(1) = 1, f1(0) = 0

...
; 1,2,2,4,2,6,2,8,4,14,2,12,2,26,10,16,2,18,2,28,22,58,2,24,4,74,8,52,2,42,2,32,46,106,10,36,2,122,62,56,2,78,2,116,20,158,2,48,4,98,94,148,2,54,34,104,118,214,2,84,2,226,44,64,46,174,2,212,146,182,2,72,2,302,50,244,22,222,2,112
; Formula: a(n) = A348717(A290641(n+1)-1)

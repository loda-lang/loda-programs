...
; Formula: a(n) = truncate(e(n)/2), b(n) = 2*c(n-1)+b(n-1)+e(n-1)+1, b(3) = 6, b(2) = 3, b(1) = 2, b(0) = 1, c(n) = truncate((2*d(n-1)-2*e(n-1)+2)/(2*c(n-1)+b(n-1)+e(n-1)+1)), c(3) = 2, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = -e(n-1)+d(n-1)+1, d(3) = 7, d(2) = 4, d(1) = 1, d(0) = 0, e(n) = 2*c(n-1)+e(n-1)-2, e(3) = 0, e(2) = -2, e(1) = -2, e(0) = 0

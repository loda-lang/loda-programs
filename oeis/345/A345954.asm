...
; Formula: a(n) = truncate(c(n)/3), b(n) = 3*d(n-1)+b(n-1)+f(n-1), b(4) = 57, b(3) = 15, b(2) = 3, b(1) = 0, b(0) = 0, c(n) = 2*c(n-1)+b(n-1)+e(n-1), c(4) = 27, c(3) = 3, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 3*d(n-1)+1, d(4) = 40, d(3) = 13, d(2) = 4, d(1) = 1, d(0) = 0, e(n) = 2*b(n-1)+2*e(n-1), e(4) = 42, e(3) = 6, e(2) = 0, e(1) = 0, e(0) = 0, f(n) = max(f(n-1),b(n-1)+f(n-1)), f(4) = 18, f(3) = 3, f(2) = 0, f(1) = 0, f(0) = 0

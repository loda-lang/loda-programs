...
; Formula: a(n) = d(n+1), b(n) = 4*d(n-2), b(4) = 4, b(3) = 4, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = b(n-2)/2+4*d(n-2)+c(n-1), c(4) = 9, c(3) = 5, c(2) = 1, c(1) = 1, c(0) = 1, d(n) = c(n-1), d(4) = 5, d(3) = 1, d(2) = 1, d(1) = 1, d(0) = 0

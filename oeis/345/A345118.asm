...
; Formula: a(n) = b(n-1)+c(n-1)+d(n-1)+e(n-1)+4, a(4) = 34, a(3) = 20, a(2) = 11, a(1) = 4, a(0) = 0, b(n) = 2*((b(n-3)+e(n-3)+5)%2)-b(n-3)+b(n-1)+b(n-2)+5, b(5) = 34, b(4) = 20, b(3) = 11, b(2) = 4, b(1) = 0, b(0) = 0, c(n) = (b(n-1)+e(n-1)+5)%2+d(n-1)+1, c(4) = 11, c(3) = 9, c(2) = 5, c(1) = 2, c(0) = 0, d(n) = 2*((b(n-2)+e(n-2)+5)%2)+d(n-2)+5, d(4) = 14, d(3) = 9, d(2) = 7, d(1) = 4, d(0) = 0, e(n) = (b(n-1)+e(n-1)+5)%2, e(4) = 1, e(3) = 1, e(2) = 0, e(1) = 1, e(0) = 0

...
; Formula: a(n) = floor((sqrtint(min(n,n%2)*c(n)+b(n))+1)/2), b(n) = 2*b(n-2)+c(n-2)+1, b(3) = 4, b(2) = 4, b(1) = 0, b(0) = 0, c(n) = 3*c(n-2)-c(n-4)+1, c(6) = 19, c(5) = 7, c(4) = 7, c(3) = 3, c(2) = 3, c(1) = 3, c(0) = 3

...
; Formula: a(n) = c(n+1), b(n) = -b(n-1)+d(n-1), b(4) = 2, b(3) = 0, b(2) = 0, b(1) = 1, b(0) = 0, c(n) = 2*d(n-2)-b(n-2), c(4) = 0, c(3) = 1, c(2) = 2, c(1) = -1, c(0) = 0, d(n) = 2*d(n-3)-b(n-3)+d(n-1), d(4) = 3, d(3) = 2, d(2) = 0, d(1) = 1, d(0) = 1

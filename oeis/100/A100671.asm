...
; Formula: a(n) = e(n+1)-8, b(n) = b(n-1)+c(n-1)+d(n-1), b(3) = 88, b(2) = 24, b(1) = 8, b(0) = 8, c(n) = 2*c(n-1)+b(n-1)+d(n-1), c(3) = 120, c(2) = 32, c(1) = 8, c(0) = 0, d(n) = 2*c(n-1)+b(n-1)+d(n-1), d(3) = 120, d(2) = 32, d(1) = 8, d(0) = 0, e(n) = (max(e(n-1),7)*(b(n-1)+c(n-1)+d(n-1)))/(2*c(n-1)+b(n-1)+d(n-1))+max(e(n-1),7)-5, e(3) = 12, e(2) = 10, e(1) = 9, e(0) = 0

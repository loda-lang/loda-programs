...
; 1,2,2,3,2,2,2,3,3,2,2,3,2,2,2,5,2,3,2,3,2,2,2,3,3,2,3,3,2,2,2,5,2,2,2,3,2,2,2,3,2,2,2,3,3,2,2,5,3,3,2,3,2,3,2,3,2,2,2,3,2,2,3,7,2,2,2,3,2,2,2,3,2,2,3,3,2,2,2,5
; Formula: a(n) = A136548(A067132(n+1)+1)

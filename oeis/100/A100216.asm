...
; Formula: a(n) = -a(n-2)-c(n-2)-d(n-2)-max(b(n-2)+c(n-2)-12,0)-2*b(n-2)+a(n-1)+6, a(4) = 26, a(3) = 16, a(2) = 9, a(1) = 4, a(0) = 1, b(n) = 2*b(n-1)+c(n-1)-3, b(4) = -45, b(3) = -21, b(2) = -9, b(1) = -3, b(0) = 0, c(n) = max(b(n-1)+c(n-1)-12,0), c(4) = 0, c(3) = 0, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = a(n-1)+d(n-1), d(4) = 30, d(3) = 14, d(2) = 5, d(1) = 1, d(0) = 0

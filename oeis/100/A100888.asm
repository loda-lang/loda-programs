...
; Formula: a(n) = c(n+1), b(n) = -b(n-1)+f(n-1), b(4) = 2, b(3) = 3, b(2) = 1, b(1) = 0, b(0) = 1, c(n) = -e(n-1)+b(n-1)+d(n-1), c(4) = 7, c(3) = 2, c(2) = 1, c(1) = 3, c(0) = 0, d(n) = c(n-1)+f(n-1), d(4) = 7, d(3) = 5, d(2) = 4, d(1) = 1, d(0) = 2, e(n) = c(n-1), e(4) = 2, e(3) = 1, e(2) = 3, e(1) = 0, e(0) = 0, f(n) = c(n-1)+f(n-1), f(4) = 7, f(3) = 5, f(2) = 4, f(1) = 1, f(0) = 1

...
; Formula: a(n) = c(n+1), b(n) = -b(n-1)+d(n-1), b(4) = 2, b(3) = 3, b(2) = 1, b(1) = 0, b(0) = 1, c(n) = 2*d(n-2)-b(n-2), c(4) = 7, c(3) = 2, c(2) = 1, c(1) = 3, c(0) = 0, d(n) = 2*d(n-3)-b(n-3)+d(n-1), d(4) = 7, d(3) = 5, d(2) = 4, d(1) = 1, d(0) = 1

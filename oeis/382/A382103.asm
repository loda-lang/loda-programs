...
; Formula: a(n) = 10^(n+1)-truncate((truncate((-c(2*n+2)+d(2*n+2))/floor((2*c(2*n+2))/(10^(n+1))))-1)/3)-10*truncate((10^(n+1)-truncate((truncate((-c(2*n+2)+d(2*n+2))/floor((2*c(2*n+2))/(10^(n+1))))-1)/3)+3)/10)+3, b(n) = 5*(b(n-1)==0)+5*c(n-1)+5*d(n-1), b(2) = 50, b(1) = 5, b(0) = 0, c(n) = 6*c(n-1)+6*d(n-1)+5*(b(n-1)==0), c(2) = 60, c(1) = 5, c(0) = 0, d(n) = 6*d(n-1)+5*(b(n-1)==0)+5*c(n-1), d(2) = 55, d(1) = 5, d(0) = 0

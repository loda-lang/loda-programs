...
; Formula: a(n) = d(3*n), b(n) = -b(n-1)+b(n-1)+c(n-1)+e(n-1), b(4) = 4, b(3) = 5, b(2) = 4, b(1) = 2, b(0) = 0, c(n) = -b(n-2)-c(n-2)+c(n-1)+c(n-2)+e(n-2), c(4) = 1, c(3) = 3, c(2) = 3, c(1) = 2, c(0) = 1, d(n) = -b(n-1)+c(n-1)+e(n-1), d(4) = -1, d(3) = 1, d(2) = 2, d(1) = 2, d(0) = 1, e(n) = -b(n-1)+c(n-1)+e(n-1), e(4) = -1, e(3) = 1, e(2) = 2, e(1) = 2, e(0) = 1

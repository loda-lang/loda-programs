...
; Formula: a(n) = (b(n-1)+a(n-1))/(-1)+c(n-1), a(3) = 1, a(2) = -1, a(1) = -1, a(0) = 1, b(n) = (b(n-2)+a(n-2))/(-1)+(b(n-3)+a(n-3))/(-1)+a(n-2), b(3) = -2, b(2) = 0, b(1) = 1, b(0) = 0, c(n) = (b(n-1)+a(n-1))/(-1), c(3) = 1, c(2) = 0, c(1) = -1, c(0) = 0

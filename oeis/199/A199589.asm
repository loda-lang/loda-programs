...
; Formula: a(n) = ((d(4*n)+1)/(c(4*n)/(10^n)))%10, b(n) = (4*c(n-1)+2*b(n-1)+2*d(n-1))/2, b(2) = 17, b(1) = 2, b(0) = 0, c(n) = 4*c(n-1)+2*b(n-1)+2*c(n-1)+2*d(n-1)+b(n-1)+c(n-1)+d(n-1), c(2) = 58, c(1) = 7, c(0) = 1, d(n) = c(n-1)+d(n-1), d(2) = 8, d(1) = 1, d(0) = 0

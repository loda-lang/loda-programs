...
; Formula: a(n) = -binomial(floor((sqrtint(8*n)-1)/2)+1,2)-gcd(-n+binomial(floor((sqrtint(8*n)-1)/2)+1,2)+floor((sqrtint(8*n)-1)/2)+1,floor((sqrtint(8*n)-1)/2)+1)+floor((sqrtint(8*n)-1)/2)+n+1

...
; Formula: a(n) = truncate((b(n-1)+e(n-1))/2), b(n) = 2*c(n-1)*b(n-2), b(3) = 16, b(2) = 4, b(1) = 2, b(0) = 1, c(n) = 2*c(n-1), c(3) = 8, c(2) = 4, c(1) = 2, c(0) = 1, d(n) = 2*d(n-2)*c(n-2), d(3) = 4, d(2) = 2, d(1) = 1, d(0) = 1, e(n) = 2*d(n-1)*c(n-1)*b(n-1), e(3) = 64, e(2) = 8, e(1) = 2, e(0) = 0

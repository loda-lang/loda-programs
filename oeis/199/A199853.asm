...
; Formula: a(n) = (-b(n)-2*c(n)-2)/(3/(c(n)+3)+2)+1, b(n) = b(n-1), b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = d(n-1)/(-1)+2*c(n-1)+e(n-1), c(3) = 3, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = d(n-1)/(-1)+c(n-1)+e(n-1), d(3) = 2, d(2) = 0, d(1) = 1, d(0) = -1, e(n) = c(n-1)+e(n-1), e(3) = 2, e(2) = 1, e(1) = 0, e(0) = 0

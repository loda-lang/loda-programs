...
; Formula: a(n) = -b(n-1)+c(n-1)+d(n-1), a(4) = -1, a(3) = 1, a(2) = 2, a(1) = 2, a(0) = 1, b(n) = c(n-1)+d(n-1), b(4) = 4, b(3) = 5, b(2) = 4, b(1) = 2, b(0) = 0, c(n) = -b(n-2)+c(n-1)+d(n-2), c(4) = 1, c(3) = 3, c(2) = 3, c(1) = 2, c(0) = 1, d(n) = -b(n-1)+c(n-1)+d(n-1), d(4) = -1, d(3) = 1, d(2) = 2, d(1) = 2, d(0) = 1

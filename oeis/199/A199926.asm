...
; Formula: a(n) = b(max(n-3,0)), b(n) = -d(n-1)-d(n-2)+c(n-1)+c(n-2), b(5) = 4, b(4) = 2, b(3) = 1, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = -b(n-3)-e(n-2)+b(n-1)+b(n-2)+c(n-2), c(5) = 6, c(4) = 3, c(3) = 3, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = b(n-1), d(5) = 2, d(4) = 1, d(3) = 1, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = -c(n-1)+d(n-1)+e(n-1), e(5) = -5, e(4) = -3, e(3) = -1, e(2) = -1, e(1) = 0, e(0) = 0

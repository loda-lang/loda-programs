...
; Formula: a(n) = c(max(n-3,0)), b(n) = d(n-1)+truncate((c(n-1)*(-d(n-1)+c(n-2)+2))/(b(n-1)+d(n-1)+1)), b(3) = 3, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = b(n-1)+d(n-1)+1, c(3) = 5, c(2) = 3, c(1) = 2, c(0) = 0, d(n) = c(n-1)+d(n-1), d(3) = 6, d(2) = 3, d(1) = 1, d(0) = 1

...
; Formula: a(n) = b(n-1)+c(n-1)+1, a(5) = 5, a(4) = 3, a(3) = 2, a(2) = 0, a(1) = 0, a(0) = 0, b(n) = ((b(n-2)+c(n-2)+1)*(-a(n-2)-c(n-2)+a(n-2)+2))/(b(n-1)+a(n-2)+c(n-2)+1)+a(n-2)+c(n-2), b(5) = 3, b(4) = 1, b(3) = 1, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = a(n-1)+c(n-1), c(5) = 6, c(4) = 3, c(3) = 1, c(2) = 1, c(1) = 1, c(0) = 1

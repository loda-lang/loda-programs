...
; Formula: a(n) = b(max(n-2,0)), b(n) = (c(n-1)*(-d(n-1)+c(n-2)+1))/(b(n-1)+d(n-1)+1)+d(n-1), b(3) = 4, b(2) = 2, b(1) = 1, b(0) = 0, c(n) = b(n-1)+d(n-1)+1, c(3) = 8, c(2) = 4, c(1) = 2, c(0) = 0, d(n) = c(n-1)+d(n-1)+1, d(3) = 10, d(2) = 5, d(1) = 2, d(0) = 1

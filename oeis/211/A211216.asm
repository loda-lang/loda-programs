...
; Formula: a(n) = f1(2*n), b(n) = b(n-1)+d(n-1), b(5) = 1, b(4) = -2, b(3) = 0, b(2) = -1, b(1) = 0, b(0) = 0, c(n) = f1(n-1), c(5) = 2, c(4) = 0, c(3) = 1, c(2) = 0, c(1) = 1, c(0) = 0, d(n) = 2*e(n-1)-d(n-1)-f(n-1)+c(n-1), d(5) = -5, d(4) = 3, d(3) = -2, d(2) = 1, d(1) = -1, d(0) = 0, e(n) = -f(n-1)+b(n-1)+c(n-1)+d(n-1)+e(n-1), e(5) = -1, e(4) = 0, e(3) = -1, e(2) = 0, e(1) = -1, e(0) = 0, f(n) = -f(n-1)+b(n-1)+c(n-1)+e(n-1), f(5) = -4, f(4) = 2, f(3) = -2, f(2) = 1, f(1) = -1, f(0) = 1, f1(n) = -f(n-1)+c(n-1)+e(n-1)+f1(n-1), f1(5) = 0, f1(4) = 2, f1(3) = 0, f1(2) = 1, f1(1) = 0, f1(0) = 1

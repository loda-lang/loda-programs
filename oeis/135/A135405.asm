...
; Formula: a(n) = if(((2*bitxor(n,1))^2)<=1,2*bitxor(n,1)+binomial(n,2)+2,(2*bitxor(n,1)+binomial(n,2)+2)/((2*bitxor(n,1))^valuation(2*bitxor(n,1)+binomial(n,2)+2,2*bitxor(n,1))))-1

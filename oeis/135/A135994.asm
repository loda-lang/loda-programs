...
; Formula: a(n) = -b(n-2)+b(n-1)+a(n-1)+c(n-1)+1, a(4) = -3, a(3) = 6, a(2) = -1, a(1) = 2, a(0) = 0, b(n) = -b(n-1)+b(n-2)+c(n-2)+1, b(4) = 11, b(3) = -6, b(2) = 4, b(1) = -2, b(0) = 1, c(n) = c(n-1)+c(n-2)+1, c(4) = 1, c(3) = 0, c(2) = 0, c(1) = -1, c(0) = 0

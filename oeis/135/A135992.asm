...
; Formula: a(n) = truncate((min(n+1,(n+1)%2)*(-d(n+1)+c(n+1))+b(n+1))/3), b(n) = 2*b(n-2)+c(n-2), b(5) = 9, b(4) = 9, b(3) = 3, b(2) = 3, b(1) = 0, b(0) = 0, c(n) = 3*c(n-2)-c(n-4), c(8) = 39, c(7) = 15, c(6) = 15, c(5) = 6, c(4) = 6, c(3) = 3, c(2) = 3, c(1) = 3, c(0) = 3, d(n) = 2*b(n-2)+c(n-2), d(5) = 9, d(4) = 9, d(3) = 3, d(2) = 3, d(1) = 0, d(0) = 0

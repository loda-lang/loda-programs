...
; Formula: a(n) = b(n-1), a(5) = 10, a(4) = 4, a(3) = 3, a(2) = 2, a(1) = 1, a(0) = 0, b(n) = c(n-1)+c(n-2), b(5) = 20, b(4) = 10, b(3) = 4, b(2) = 3, b(1) = 2, b(0) = 1, c(n) = b(n-1)+d(n-2)+e(n-1), c(5) = 26, c(4) = 13, c(3) = 7, c(2) = 3, c(1) = 1, c(0) = 2, d(n) = b(n-1)+d(n-1), d(5) = 20, d(4) = 10, d(3) = 6, d(2) = 3, d(1) = 1, d(0) = 0, e(n) = b(n-1)+e(n-1), e(5) = 20, e(4) = 10, e(3) = 6, e(2) = 3, e(1) = 1, e(0) = 0

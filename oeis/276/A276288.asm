...
; Formula: a(n) = b(n-1)+d(n-1), a(3) = 4, a(2) = 1, a(1) = 1, a(0) = 0, b(n) = -max(3*c(n-1)-b(n-1)-d(n-1),0)+b(n-1)+d(n-1), b(3) = 4, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = d(n-1), c(3) = 3, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 4*max(2*d(n-2)-b(n-2)-d(n-1)+max(3*c(n-2)-b(n-2)-d(n-2),0),0)+3*b(n-2)+3*d(n-2), d(3) = 3, d(2) = 3, d(1) = 0, d(0) = 0

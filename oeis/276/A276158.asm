...
; Formula: a(n) = max(6*n-6*binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2),1)*(-n+binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2)+truncate((sqrtint(8*n+8)-1)/2))+max(6*n-6*binomial(truncate((sqrtint(8*n+8)-1)/2)+1,2),1)

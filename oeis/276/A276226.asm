...
; Formula: a(n) = b(n-1)+d(n-1), a(3) = 22, a(2) = 8, a(1) = 6, a(0) = 0, b(n) = b(n-1)+d(n-1), b(3) = 22, b(2) = 8, b(1) = 6, b(0) = 1, c(n) = 2*b(n-2)+2*d(n-2)+b(n-2)+c(n-1)+d(n-2), c(3) = 44, c(2) = 20, c(1) = 2, c(0) = 0, d(n) = 2*b(n-1)+c(n-1), d(3) = 36, d(2) = 14, d(1) = 2, d(0) = 5

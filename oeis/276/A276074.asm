...
; Formula: a(n) = A048675(truncate((A181819(A181811(truncate((A057335(A277012(n))-1)/A293810(A057335(A277012(n))))+1)*(truncate((A057335(A277012(n))-1)/A293810(A057335(A277012(n))))+1))-1)/(floor(sqrtint(4*(floor(max(0,A181819(A181811(truncate((A057335(A277012(n))-1)/A293810(A057335(A277012(n))))+1)*(truncate((A057335(A277012(n))-1)/A293810(A057335(A277012(n))))+1))-1)/A019554(max(0,A181819(A181811(truncate((A057335(A277012(n))-1)/A293810(A057335(A277012(n))))+1)*(truncate((A057335(A277012(n))-1)/A293810(A057335(A277012(n))))+1))-1)+1))+1)^2)/2)^2))+1)

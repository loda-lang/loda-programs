...
; Formula: a(n) = A048675(truncate((A181819(A108951(truncate((A057335(A277012(n))-1)/A293810(A057335(A277012(n))-1))+1))-1)/(truncate(sqrtint(4*(truncate(max(0,A181819(A108951(truncate((A057335(A277012(n))-1)/A293810(A057335(A277012(n))-1))+1))-1)/A019554(max(0,A181819(A108951(truncate((A057335(A277012(n))-1)/A293810(A057335(A277012(n))-1))+1))-1)+1))+1)^2)/2)^2))+1)

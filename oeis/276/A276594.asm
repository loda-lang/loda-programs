...
; Formula: a(n) = truncate(truncate((gcd(0,n+1)+A350972(max(n,0)+n+1)-1)/gcd(A350972(max(n,0)+n+1),A052653(2*n+2)))/gcd(A016750(n+1),truncate((gcd(0,n+1)+A350972(max(n,0)+n+1)-1)/gcd(A350972(max(n,0)+n+1),A052653(2*n+2)))))

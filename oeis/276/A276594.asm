...
; Formula: a(n) = truncate(truncate((gcd(0,(n+1)%23)+A350972((n+1)%23+max((n+1)%23-1,0))-1)/gcd(A350972((n+1)%23+max((n+1)%23-1,0)),A052653(2*((n+1)%23))))/gcd(A016750((n+1)%23),truncate((gcd(0,(n+1)%23)+A350972((n+1)%23+max((n+1)%23-1,0))-1)/gcd(A350972((n+1)%23+max((n+1)%23-1,0)),A052653(2*((n+1)%23))))))

...
; Formula: a(n) = b(n-1)+d(n-1)+a(n-1), a(3) = 464, a(2) = 22, a(1) = 1, a(0) = 0, b(n) = 20*b(n-1)+c(n-1), b(3) = 8410, b(2) = 410, b(1) = 20, b(0) = 1, c(n) = 21*c(n-1)-10*c(n-2), c(5) = 1813510, c(4) = 88410, c(3) = 4310, c(2) = 210, c(1) = 10, c(0) = 0, d(n) = 12*d(n-1)-10*d(n-2)+b(n-1), d(4) = 17498, d(3) = 784, d(2) = 32, d(1) = 1, d(0) = 0

...
; Formula: a(n) = d(n+1), b(n) = (-c(n-1)+b(n-1))/2, b(2) = -4, b(1) = -1, b(0) = 0, c(n) = 4*gcd((-c(n-1)+b(n-1))/2+2*d(n-1),2)*c(n-1), c(2) = 64, c(1) = 8, c(0) = 2, d(n) = gcd((-c(n-1)+b(n-1))/2+2*d(n-1),2)+2, d(2) = 4, d(1) = 3, d(0) = 0

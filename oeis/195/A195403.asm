...
; Formula: a(n) = ((2*b(4*n+4))/((c(4*n+4)+d(4*n+4))/(10^(n+1))))%10, b(n) = b(n-1)+c(n-1)+e(n-1), b(3) = 58, b(2) = 12, b(1) = 2, b(0) = 0, c(n) = 2*c(n-1)+b(n-1)+e(n-1), c(3) = 74, c(2) = 16, c(1) = 4, c(0) = 2, d(n) = 2*c(n-1)+b(n-1)+d(n-1)+e(n-1), d(3) = 94, d(2) = 20, d(1) = 4, d(0) = 0, e(n) = 2*c(n-1)+2*e(n-1)+b(n-1)+c(n-1)+d(n-1), e(3) = 140, e(2) = 30, e(1) = 6, e(0) = 0

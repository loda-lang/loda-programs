...
; Formula: a(n) = ((40*b(4*n+9))/(c(4*n+9)/(10^max(n-1,0))))%10, b(n) = 2*c(n-1)+b(n-1)+e(n-1), b(3) = -190, b(2) = -40, b(1) = -10, b(0) = -10, c(n) = 3*c(n-1)+b(n-1)+e(n-1), c(3) = -240, c(2) = -50, c(1) = -10, c(0) = 0, d(n) = 3*c(n-1)+2*d(n-1)-((c(n-1)+e(n-1))/2)+b(n-1)+e(n-1), d(3) = -310, d(2) = -60, d(1) = -10, d(0) = 0, e(n) = 3*c(n-1)+2*d(n-1)-2*((c(n-1)+e(n-1))/2)+b(n-1)+e(n-1), e(3) = -260, e(2) = -50, e(1) = -10, e(0) = 0

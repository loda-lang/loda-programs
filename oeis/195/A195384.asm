...
; Formula: a(n) = (b(4*n+4)/(10*(c(4*n+4)/(10^(n+1)))))%10, b(n) = 4*d(n-2)+2*b(n-2), b(7) = 512, b(6) = 512, b(5) = 32, b(4) = 32, b(3) = 0, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = 2*c(n-2)+2*d(n-2)+b(n-2), c(7) = 296, c(6) = 296, c(5) = 20, c(4) = 20, c(3) = 2, c(2) = 2, c(1) = 1, c(0) = 1, d(n) = 12*d(n-2)+8*b(n-2)+8*c(n-2)+4*d(n-4), d(9) = 28416, d(8) = 28416, d(7) = 1792, d(6) = 1792, d(5) = 112, d(4) = 112, d(3) = 8, d(2) = 8, d(1) = 0, d(0) = 0

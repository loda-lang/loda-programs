...
; Formula: a(n) = truncate((b(n)-7)/2)+3, b(n) = 3*sign(3*sign(3)*sign(b(n-1))+sign(b(n-1))+sign(3))*bitxor(abs(b(n-1)),abs(3))-sign(3*sign(3)*sign(b(n-2))+sign(b(n-2))+sign(3))*bitxor(abs(b(n-2)),abs(3))+b(n-1), b(3) = 67, b(2) = 17, b(1) = 7, b(0) = 2

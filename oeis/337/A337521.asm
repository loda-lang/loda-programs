...
; Formula: a(n) = d(n-1), a(3) = 17, a(2) = 4, a(1) = 1, a(0) = 1, b(n) = b(n-1)+b(n-2), b(3) = 7, b(2) = 4, b(1) = 3, b(0) = 1, c(n) = c(n-1)+c(n-2), c(4) = 7, c(3) = 4, c(2) = 3, c(1) = 1, c(0) = 2, d(n) = d(n-1)*(b(n-1)+c(n-1))+d(n-2), d(3) = 123, d(2) = 17, d(1) = 4, d(0) = 1

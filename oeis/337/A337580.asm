...
; Formula: a(n) = truncate(d(n)/2), b(n) = b(n-1)^2, b(2) = 16, b(1) = 4, b(0) = 2, c(n) = truncate((2*c(n-1)+b(n-1))/2)*b(n-1)^2+c(n-1), c(2) = 100, c(1) = 4, c(0) = 0, d(n) = 2*c(n-1)+b(n-1), d(2) = 12, d(1) = 2, d(0) = 0

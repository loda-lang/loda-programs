...
; Formula: a(n) = c(n)+1, b(n) = 1, b(3) = 1, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = -n*truncate((d(n-1)*(b(n-1)+c(n-1)))/n)+d(n-1)*(b(n-1)+c(n-1)), c(3) = 2, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = d(n-1)*(b(n-1)+c(n-1)), d(3) = 2, d(2) = 1, d(1) = 1, d(0) = 1

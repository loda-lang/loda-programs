...
; Formula: a(n) = ((d(3*n)+1)/(c(3*n)/(10^n)))%10, b(n) = 6*c(n-1)+3*b(n-1)+3*d(n-1), b(2) = 39, b(1) = 6, b(0) = 0, c(n) = 3*c(n-1)+b(n-1)+d(n-1), c(2) = 16, c(1) = 3, c(0) = 1, d(n) = c(n-1)+d(n-1), d(2) = 4, d(1) = 1, d(0) = 0

...
; Formula: a(n) = -A000040(n+2)*truncate(truncate((A000040(n+1)*(A159477(A000040(n+1))-1)-A159477(A000040(n+1))+1)/4)/A000040(n+2))+truncate((A000040(n+1)*(A159477(A000040(n+1))-1)-A159477(A000040(n+1))+1)/4)

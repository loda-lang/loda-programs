...
; Formula: a(n) = -e(n-1)+b(n-1)+a(n-1)+d(n-1), a(4) = 12, a(3) = 8, a(2) = 2, a(1) = 2, a(0) = 1, b(n) = 2*a(n-1)+b(n-1), b(4) = 26, b(3) = 10, b(2) = 6, b(1) = 2, b(0) = 0, c(n) = -e(n-1)+b(n-1)+a(n-1)+d(n-1), c(4) = 12, c(3) = 8, c(2) = 2, c(1) = 2, c(0) = 0, d(n) = c(n-1), d(4) = 8, d(3) = 2, d(2) = 2, d(1) = 0, d(0) = 1, e(n) = -e(n-1)+b(n-1)+a(n-1)+d(n-1), e(4) = 12, e(3) = 8, e(2) = 2, e(1) = 2, e(0) = 0

...
; Formula: a(n) = e(n-1), b(n) = 2*b(n-2)+1, b(3) = 3, b(2) = 3, b(1) = 1, b(0) = 1, c(n) = (2*d(n-1)+1)*(c(n-1)*b(n-1)+e(n-1)*(2*d(n-1)+1)), c(3) = 288, c(2) = 24, c(1) = 2, c(0) = 1, d(n) = 2*d(n-2)+1, d(3) = 3, d(2) = 1, d(1) = 1, d(0) = 0, e(n) = c(n-1)*b(n-1)+e(n-1)*(2*d(n-1)+1), e(3) = 96, e(2) = 8, e(1) = 2, e(0) = 1

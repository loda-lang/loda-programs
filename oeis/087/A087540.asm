...
; Formula: a(n) = c(n-1)*b(n-1)+a(n-1)*(2*d(n-1)+1), a(3) = 8, a(2) = 2, a(1) = 1, a(0) = 1, b(n) = 2*b(n-2)+1, b(3) = 3, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = (2*d(n-1)+1)*(c(n-1)*b(n-1)+a(n-1)*(2*d(n-1)+1)), c(3) = 24, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = 2*d(n-2)+1, d(3) = 1, d(2) = 1, d(1) = 0, d(0) = 0

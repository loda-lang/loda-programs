...
; Formula: a(n) = d(n+29), b(n) = (-c(n-1)+b(n-1))/2, b(2) = -2, b(1) = 0, b(0) = 1, c(n) = c(n-1)*(((-c(n-1)+b(n-1))/2+d(n-1))%2+2), c(2) = 8, c(1) = 4, c(0) = 2, d(n) = ((-c(n-1)+b(n-1))/2+d(n-1))%2+2, d(2) = 2, d(1) = 2, d(0) = 0

...
; Formula: a(n) = 2*b(n-1)+2*c(n-1)+2*d(n-1), a(3) = 28, a(2) = 8, a(1) = 2, a(0) = 1, b(n) = 2*b(n-1)+c(n-1)+d(n-1), b(3) = 20, b(2) = 6, b(1) = 2, b(0) = 1, c(n) = 2*c(n-1)-2*c(n-2)-2*d(n-2), c(3) = -4, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 2*b(n-1)+2*c(n-1)+2*d(n-1), d(3) = 28, d(2) = 8, d(1) = 2, d(0) = 0

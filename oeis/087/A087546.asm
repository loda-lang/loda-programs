...
; Formula: a(n) = c(n-1)+1, b(n) = d(n-1), b(2) = 38, b(1) = 1, b(0) = 1, c(n) = truncate((c(n-1)*b(n-1)+b(n-1)+d(n-1))/2), c(2) = 20, c(1) = 1, c(0) = 0, d(n) = max(c(n-1)*b(n-1)+b(n-1)+d(n-1),38), d(2) = 40, d(1) = 38, d(0) = 1

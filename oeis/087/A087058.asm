...
; Formula: a(n) = (e(n+1)/2+1)^2, b(n) = (-c(n-1)+b(n-1)+1)/2, b(3) = -54, b(2) = -14, b(1) = -5, b(0) = 0, c(n) = 2*gcd((-c(n-1)+b(n-1)+1)/2+d(n-1),4)*c(n-1), c(3) = 192, c(2) = 96, c(1) = 24, c(0) = 12, d(n) = gcd((-c(n-1)+b(n-1)+1)/2+d(n-1),4)/2, d(3) = 0, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = 2*d(n-1)+e(n-1)+2, e(3) = 8, e(2) = 4, e(1) = 2, e(0) = 0

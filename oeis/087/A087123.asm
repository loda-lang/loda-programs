...
; Formula: a(n) = b(n-1), a(4) = 2, a(3) = 5, a(2) = 1, a(1) = 2, a(0) = 1, b(n) = (b(n-2)^2+d(n-2)^0)/b(n-4), b(4) = 13, b(3) = 2, b(2) = 5, b(1) = 1, b(0) = 2, c(n) = b(n-2), c(4) = 5, c(3) = 1, c(2) = 2, c(1) = 1, c(0) = 1, d(n) = (b(n-1)^2+d(n-1)^0)/c(n-1), d(4) = 5, d(3) = 13, d(2) = 2, d(1) = 5, d(0) = 0

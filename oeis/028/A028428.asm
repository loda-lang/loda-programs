...
; Formula: a(n) = d(n)-1, b(n) = 6*b(n-1)*((n+1)/b(n-1))+b(n-1), b(4) = 7, b(3) = 7, b(2) = 7, b(1) = 7, b(0) = 7, c(n) = n+2, c(4) = 6, c(3) = 5, c(2) = 4, c(1) = 3, c(0) = 2, d(n) = (6*(6*b(n-2)*(c(n-2)/b(n-2))+b(n-2))*((n+1)/(6*b(n-2)*(c(n-2)/b(n-2))+b(n-2)))+6*b(n-2)*(c(n-2)/b(n-2))+b(n-2))*(d(n-1)/(6*b(n-2)*(c(n-2)/b(n-2))+b(n-2)))+n+2, d(4) = 6, d(3) = 5, d(2) = 4, d(1) = 3, d(0) = 2

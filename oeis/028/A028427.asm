...
; Formula: a(n) = d(n+2)-1, b(n) = 5*b(n-1)*((n-1)/b(n-1))+b(n-1), b(4) = 6, b(3) = 6, b(2) = 6, b(1) = 1, b(0) = 1, c(n) = n, c(4) = 4, c(3) = 3, c(2) = 2, c(1) = 1, c(0) = 0, d(n) = (5*b(n-1)*(c(n-1)/b(n-1))+b(n-1))*(d(n-1)/b(n-1))+n, d(4) = 4, d(3) = 3, d(2) = 2, d(1) = 0, d(0) = 0

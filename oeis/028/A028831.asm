...
; Formula: a(n) = 2*b(n-2)+a(n-2)+b(n-3)+6, a(7) = 159, a(6) = 83, a(5) = 43, a(4) = 22, a(3) = 11, a(2) = 7, a(1) = 3, a(0) = 1, b(n) = b(n-1)+b(n-2)+b(n-3)+b(n-4)+6, b(8) = 329, b(7) = 170, b(6) = 87, b(5) = 44, b(4) = 22, b(3) = 11, b(2) = 4, b(1) = 1, b(0) = 0

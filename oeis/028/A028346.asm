...
; Formula: a(n) = b(n)/3, b(n) = (4*c(n-1)+4*d(n-1)-4*c(n-1))/n, b(3) = 84, b(2) = 36, b(1) = 12, b(0) = 3, c(n) = (4*c(n-1)+4*d(n-1)-4*c(n-1))/n-c(n-1), c(3) = 57, c(2) = 27, c(1) = 9, c(0) = 3, d(n) = (4*c(n-1)+4*d(n-1)-4*c(n-1))/n+c(n-1)+d(n-1), d(3) = 174, d(2) = 63, d(1) = 18, d(0) = 3

...
; Formula: a(n) = 6*truncate((5*truncate((56*floor((10*n+29)/11)+44*floor((10*n+41)/11)+152)/5)-90)/2)-20*truncate((2*truncate((5*truncate((56*floor((10*n+29)/11)+44*floor((10*n+41)/11)+152)/5)-90)/2))/10)-230

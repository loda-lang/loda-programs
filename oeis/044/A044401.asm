...
; Formula: a(n) = 8*((5*floor((56*floor((10*n+29)/11)+44*floor((10*n+41)/11)+152)/5))%4)+5*floor((56*floor((10*n+29)/11)+44*floor((10*n+41)/11)+152)/5)-450

...
; Formula: a(n) = 10*truncate((5*floor((56*floor((10*n+9)/11)+44*floor((10*n+21)/11)+152)/5)-90)/2)-16*truncate((2*truncate((5*floor((56*floor((10*n+9)/11)+44*floor((10*n+21)/11)+152)/5)-90)/2))/4)+1

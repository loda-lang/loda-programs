...
; Formula: a(n) = truncate((58*truncate((5*truncate((56*floor((10*n+9)/11)+44*floor((10*n+21)/11)+152)/5)-90)/2)-104*truncate((2*truncate((5*truncate((56*floor((10*n+9)/11)+44*floor((10*n+21)/11)+152)/5)-90)/2))/4)+15)/3)-2

...
; Formula: a(n) = (20*((2*((5*((56*((10*n+9)/11)+44*((10*n+21)/11)+152)/5)-90)/2))%4)+6*((2*((5*((56*((10*n+9)/11)+44*((10*n+21)/11)+152)/5)-90)/2))%4)+6*((5*((56*((10*n+9)/11)+44*((10*n+21)/11)+152)/5)-90)/2)+15)/3-2

...
; Formula: a(n) = (20*((2*((5*((56*((10*n+9)/11)+44*((10*n+21)/11)+152)/5)-90)/2))%4)^2+6*((2*((5*((56*((10*n+9)/11)+44*((10*n+21)/11)+152)/5)-90)/2))%4)^2+6*((5*((56*((10*n+9)/11)+44*((10*n+21)/11)+152)/5)-90)/2)+13)/3+1

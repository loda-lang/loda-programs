...
; Formula: a(n) = truncate((6*floor((50*floor((7*floor((10*n+37)/11)+5*floor((10*n+25)/11)+4)/2))/3)-8*truncate((2*floor((50*floor((7*floor((10*n+37)/11)+5*floor((10*n+25)/11)+4)/2))/3)-150)/4)-450)/2)-167

...
; Formula: a(n) = 75*truncate((56*floor((10*n+49)/11)+44*floor((10*n+61)/11)+152)/5)-28*truncate((10*truncate((56*floor((10*n+49)/11)+44*floor((10*n+61)/11)+152)/5)-180)/4)-1811

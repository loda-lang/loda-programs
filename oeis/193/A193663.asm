...
; Formula: a(n) = 9*c(n-2)-a(n-2)+b(n-2)+d(n-2), a(4) = 17, a(3) = 9, a(2) = 1, a(1) = 1, a(0) = 0, b(n) = b(n-1)+c(n-1), b(4) = 10, b(3) = 2, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = d(n-1), c(4) = 15, c(3) = 8, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = 8*c(n-1)-a(n-1)+d(n-1), d(4) = 70, d(3) = 15, d(2) = 8, d(1) = 1, d(0) = 1

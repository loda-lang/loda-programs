...
; Formula: a(n) = min(n-2,(n-2)%2)*c(n-2)+b(n-2), b(n) = 2*truncate((b(n-4)*(-2*d(n-4)-2))/(d(n-4)+2)), b(6) = 0, b(5) = 2, b(4) = 2, b(3) = 0, b(2) = 0, b(1) = -1, b(0) = -1, c(n) = truncate((2*c(n-4)*(-2*d(n-2)-2))/(d(n-2)+2)), c(6) = -3, c(5) = 0, c(4) = 0, c(3) = 1, c(2) = 1, c(1) = 0, c(0) = 0, d(n) = d(n-2)+1, d(5) = 2, d(4) = 2, d(3) = 1, d(2) = 1, d(1) = 0, d(0) = 0

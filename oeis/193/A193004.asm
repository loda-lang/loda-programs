...
; Formula: a(n) = 2*c(n)+1, b(n) = 6*n+b(n-2)+d(n-2)+e(n-2)-2, b(4) = 45, b(3) = 23, b(2) = 10, b(1) = 4, b(0) = 0, c(n) = b(n-1)+e(n-1), c(4) = 37, c(3) = 14, c(2) = 4, c(1) = 0, c(0) = 0, d(n) = 3*n+d(n-1), d(4) = 30, d(3) = 18, d(2) = 9, d(1) = 3, d(0) = 0, e(n) = b(n-1)+e(n-1), e(4) = 37, e(3) = 14, e(2) = 4, e(1) = 0, e(0) = 0

...
; Formula: a(n) = max(truncate(A084471(4*truncate(2^truncate((sqrtint(8*min(n,87)+8)-1)/2))-2*truncate(2^(-binomial(truncate((sqrtint(8*min(n,87)+8)-1)/2)+1,2)+min(n,87)))+1)/4),1)

...
; Formula: a(n) = -truncate((3*c(n)^7)/b(n))-10*truncate((-truncate((3*c(n)^7)/b(n))+b(n))/10)+b(n)+9, b(n) = 10^(n-1), b(2) = 10, b(1) = 1, b(0) = 0, c(n) = (3*c(n-1)^10)%(10*10^(n-1)), c(2) = 47, c(1) = 7, c(0) = 3

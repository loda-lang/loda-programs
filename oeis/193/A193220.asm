...
; Formula: a(n) = truncate(truncate(truncate(((n+3)*((n+3)*(2*n+6)-2))/2)/gcd(n,truncate(((n+3)*((n+3)*(2*n+6)-2))/2)))/gcd(truncate(truncate(((n+3)*((n+3)*(2*n+6)-2))/2)/gcd(n,truncate(((n+3)*((n+3)*(2*n+6)-2))/2))),n+1))

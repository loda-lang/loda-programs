...
; Formula: a(n) = min(2*b(n-1)^2,3*c(n-1)^2), a(2) = 2, a(1) = 0, a(0) = 0, b(n) = ((2*b(n-1)^2)==min(2*b(n-1)^2,3*c(n-1)^2))+b(n-1), b(2) = 2, b(1) = 1, b(0) = 0, c(n) = ((3*c(n-1)^2)==min(2*b(n-1)^2,3*c(n-1)^2))+c(n-1), c(2) = 1, c(1) = 1, c(0) = 0

...
; Formula: a(n) = ((21*b(4*n+4))/(c(4*n+4)/(10^(n+1))))%10, b(n) = 4*c(n-1)+2*b(n-1)+2*d(n-1)-472432, b(2) = -3307024, b(1) = -472432, b(0) = 0, c(n) = 3*c(n-1)+b(n-1)+d(n-1)-354324, c(2) = -2125944, c(1) = -354324, c(0) = 0, d(n) = 2*c(n-1)+2*d(n-1)-236216, d(2) = -1417296, d(1) = -236216, d(0) = 0

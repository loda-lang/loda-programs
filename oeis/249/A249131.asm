...
; Formula: a(n) = min(n,n%2)*c(n)+b(n), b(n) = b(n-2)*(2*d(n-2)+3)+c(n-2), b(7) = 361, b(6) = 361, b(5) = 37, b(4) = 37, b(3) = 5, b(2) = 5, b(1) = 1, b(0) = 1, c(n) = b(n-2)*(2*d(n-2)+4)+c(n-2)*(2*d(n-2)+4), c(7) = 1112, c(6) = 1112, c(5) = 102, c(4) = 102, c(3) = 12, c(2) = 12, c(1) = 2, c(0) = 2, d(n) = d(n-2)+1, d(7) = 3, d(6) = 3, d(5) = 2, d(4) = 2, d(3) = 1, d(2) = 1, d(1) = 0, d(0) = 0

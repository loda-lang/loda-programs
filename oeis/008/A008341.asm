...
; Formula: a(n) = b(n-1), b(n) = truncate(b(n-1)/gcd(b(n-1),c(n-1)+c(n-2)))*truncate((c(n-1)+c(n-2))/gcd(b(n-1),c(n-1)+c(n-2))), b(3) = 2, b(2) = 1, b(1) = 1, b(0) = 1, c(n) = c(n-1)+c(n-2), c(3) = 2, c(2) = 1, c(1) = 1, c(0) = 0

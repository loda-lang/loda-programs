...
; Formula: a(n) = 3*b(n-1)+3*b(n-2)+b(n-3)-1, a(7) = 129, a(6) = 49, a(5) = 18, a(4) = 8, a(3) = 2, a(2) = 1, a(1) = 1, a(0) = 0, b(n) = 3*b(n-2)+3*b(n-3)+b(n-1)+b(n-4)-1, b(8) = 208, b(7) = 79, b(6) = 30, b(5) = 12, b(4) = 4, b(3) = 2, b(2) = 1, b(1) = 0, b(0) = 0

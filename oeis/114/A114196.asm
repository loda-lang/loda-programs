...
; Formula: a(n) = b(n+1)/10, b(n) = 2*c(n-1)+b(n-1), b(3) = 100, b(2) = 30, b(1) = 10, b(0) = 0, c(n) = 3*d(n-2)+2*c(n-1)+b(n-1)+c(n-2), c(3) = 125, c(2) = 35, c(1) = 10, c(0) = 5, d(n) = 3*d(n-1)+c(n-1), d(3) = 110, d(2) = 25, d(1) = 5, d(0) = 0

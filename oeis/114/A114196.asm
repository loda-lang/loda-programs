...
; Formula: a(n) = truncate(b(n+1)/10), b(n) = 3*b(n-1)+2*c(n-2), b(4) = 350, b(3) = 100, b(2) = 30, b(1) = 10, b(0) = 0, c(n) = 6*c(n-1)-c(n-3)-8*c(n-2), c(7) = 28145, c(6) = 7200, c(5) = 1825, c(4) = 455, c(3) = 110, c(2) = 25, c(1) = 5, c(0) = 0

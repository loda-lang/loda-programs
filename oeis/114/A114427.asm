...
; Formula: a(n) = -10*truncate(truncate((c(3*n)+1)/(truncate(b(3*n)/(10^n))+1))/10)+truncate((c(3*n)+1)/(truncate(b(3*n)/(10^n))+1)), b(n) = 9*b(n-1)+4*c(n-1)-2*c(n-2)-6*b(n-2), b(4) = 3262, b(3) = 352, b(2) = 38, b(1) = 4, b(0) = 0, c(n) = 2*b(n-1)+c(n-1), c(2) = 9, c(1) = 1, c(0) = 1

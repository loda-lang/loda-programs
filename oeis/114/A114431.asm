...
; Formula: a(n) = ((2*b(4*n))/((c(4*n)+d(4*n))/(10^n)))%10, b(n) = b(n-1)+c(n-1)+d(n-1), b(2) = 12, b(1) = 2, b(0) = 1, c(n) = 3*c(n-1)+2*b(n-1)+d(n-1), c(2) = 24, c(1) = 5, c(0) = 1, d(n) = 3*c(n-1)+2*b(n-1)+2*d(n-1), d(2) = 29, d(1) = 5, d(0) = 0

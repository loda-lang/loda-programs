...
; Formula: a(n) = d(n-1), b(n) = 3*b(n-1)-b(n-2)+4, b(4) = 119, b(3) = 43, b(2) = 14, b(1) = 3, b(0) = -1, c(n) = 2*c(n-1)+b(n-1)+8, c(2) = 25, c(1) = 7, c(0) = 0, d(n) = (c(n-1)+4)^2+d(n-1), d(2) = 137, d(1) = 16, d(0) = 0

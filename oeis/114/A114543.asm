...
; Formula: a(n) = truncate(d(n)/1536), b(n) = 768*b(n-2)+768*c(n-2)+2*b(n-1), b(3) = 4616, b(2) = 1540, b(1) = 2, b(0) = 1, c(n) = 4*c(n-2), c(3) = 0, c(2) = 4, c(1) = 0, c(0) = 1, d(n) = 1536*e(n-2)+768*b(n-1), d(3) = 1185792, d(2) = 1536, d(1) = 1536, d(0) = 0, e(n) = 4*e(n-2), e(3) = 8, e(2) = 0, e(1) = 2, e(0) = 0

...
; Formula: a(n) = c(n-2)+binomial(a(n-2),b(n-2)%2)-1, a(4) = 2, a(3) = 2, a(2) = 0, a(1) = 2, a(0) = 1, b(n) = b(n-2)%2+b(n-1), b(4) = 3, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = a(n-1), c(4) = 2, c(3) = 0, c(2) = 2, c(1) = 1, c(0) = 0

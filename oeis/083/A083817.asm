...
; Formula: a(n) = d(n-2)+binomial(d(n-1),-d(n-1)+c(n-1))-1, a(4) = 2, a(3) = 2, a(2) = 0, a(1) = 2, a(0) = 1, b(n) = b(n-2)%2+b(n-1), b(4) = 3, b(3) = 3, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = b(n-1)%2+a(n-1), c(4) = 3, c(3) = 0, c(2) = 3, c(1) = 2, c(0) = 0, d(n) = a(n-1), d(4) = 2, d(3) = 0, d(2) = 2, d(1) = 1, d(0) = 0

...
; 0,4,68,80,1092,1104,1284,1296,1344,17476,17488,17668,17680,17728,20548,20560,20740,20752,20800,21508,21520,21568,21760,279620,279632,279812,279824,279872,282692,282704,282884,282896,282944,283652,283664,283712
; Formula: a(n) = truncate(A145812(A014486(n)+1)/2)

...
; Formula: a(n) = -10*truncate(b(n)/10)+b(n), b(n) = 2*b(n-3)+b(n-1)+b(n-2)+gcd(c(n-3),b(n-3)), b(5) = 6, b(4) = 2, b(3) = 1, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = gcd(c(n-1),b(n-1)), c(4) = 1, c(3) = 1, c(2) = 0, c(1) = 0, c(0) = 0

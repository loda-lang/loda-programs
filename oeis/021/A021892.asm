...
; Formula: a(n) = b(n)%10, b(n) = c(n-1), b(4) = 2, b(3) = 1, b(2) = 1, b(1) = 0, b(0) = 0, c(n) = 2*b(n-2)+c(n-1)+c(n-2)+gcd(d(n-2),b(n-2)), c(4) = 6, c(3) = 2, c(2) = 1, c(1) = 1, c(0) = 0, d(n) = gcd(d(n-1),b(n-1)), d(4) = 1, d(3) = 1, d(2) = 0, d(1) = 0, d(0) = 0

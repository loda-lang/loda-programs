...
; Formula: a(n) = 2*truncate((-truncate((sqrtint(8*binomial(6*truncate((A154115(n-1)-2)/2)+16,2))-1)/2)+binomial(truncate((sqrtint(8*binomial(6*truncate((A154115(n-1)-2)/2)+16,2))-1)/2)+1,2)-27)/9)+5

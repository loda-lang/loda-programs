...
; Formula: a(n) = (10*n-1)%A315641(n)+1

mov $1,$0
seq $1,315641 ; Coordination sequence Gal.6.208.4 where G.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.
mul $0,10
sub $0,1
mod $0,$1
add $0,1

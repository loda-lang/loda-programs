...
; Formula: a(n) = (8*n-1)%A315676(n)+2*n+1

mov $1,$0
seq $1,315676 ; Coordination sequence Gal.4.75.4 where G.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.
mov $2,$0
mul $2,2
mul $0,8
sub $0,1

...
; Formula: a(n) = -truncate((7*n-1)/(-truncate((gcd(floor(n/2),2)+n)/2)+floor((13*n)/12)+gcd(floor(n/2),2)+truncate((43*n-1)/12)+n))*(-truncate((gcd(floor(n/2),2)+n)/2)+floor((13*n)/12)+gcd(floor(n/2),2)+truncate((43*n-1)/12)+n)+10*n

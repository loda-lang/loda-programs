...
; Formula: a(n) = (2*A314249(n)-(4*n)/7)/2

mov $1,$0
seq $0,314249 ; Coordination sequence Gal.4.136.1 where G.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.
mul $0,2
mul $1,4
div $1,7
sub $0,$1

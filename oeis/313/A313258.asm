...
; Formula: a(n) = -truncate((7*n-1)/(-2*n+truncate((8*truncate((21*n+4*truncate(floor(n/2)/4)-floor(n/2)-1)/4)+10)/6)))*(-2*n+truncate((8*truncate((21*n+4*truncate(floor(n/2)/4)-floor(n/2)-1)/4)+10)/6))+10*n

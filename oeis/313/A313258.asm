...
; Formula: a(n) = ((5*n-2*truncate(truncate((sign(n)*((n-1)%8+1)-4)/2)/2)+truncate((sign(n)*((n-1)%8+1)-4)/2))==0)+5*n-2*truncate(truncate((sign(n)*((n-1)%8+1)-4)/2)/2)+truncate((sign(n)*((n-1)%8+1)-4)/2)

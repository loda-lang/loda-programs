...
; Formula: a(n) = (4*n+3)/7+A313251(n)

mov $1,$0
mul $1,4
add $1,3
div $1,7
seq $0,313251 ; Coordination sequence Gal.6.203.1 where G.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.
add $0,$1

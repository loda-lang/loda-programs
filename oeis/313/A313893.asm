...
; Formula: a(n) = -truncate((10*n-1)/(truncate((21*n+4*truncate(floor(n/2)/4)-floor(n/2)-1)/4)+1))*(truncate((21*n+4*truncate(floor(n/2)/4)-floor(n/2)-1)/4)+1)+10*n+floor((4*n+3)/7)

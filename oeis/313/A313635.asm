...
; Formula: a(n) = ((sign(n)*((n-1)%8+1))==0)+40*floor(n/8)+35*((sign(n)*((n-1)%8+1))==7)+30*((sign(n)*((n-1)%8+1))==6)+26*((sign(n)*((n-1)%8+1))==5)+20*((sign(n)*((n-1)%8+1))==4)+14*((sign(n)*((n-1)%8+1))==3)+10*((sign(n)*((n-1)%8+1))==2)+5*((sign(n)*((n-1)%8+1))==1)

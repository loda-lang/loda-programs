...
; Formula: a(n) = ((sign(n)*((n-1)%12+1))==0)+52*floor(n/12)+47*((sign(n)*((n-1)%12+1))==11)+42*((sign(n)*((n-1)%12+1))==10)+38*((sign(n)*((n-1)%12+1))==9)+34*((sign(n)*((n-1)%12+1))==8)+30*((sign(n)*((n-1)%12+1))==7)+26*((sign(n)*((n-1)%12+1))==6)+22*((sign(n)*((n-1)%12+1))==5)+18*((sign(n)*((n-1)%12+1))==4)+14*((sign(n)*((n-1)%12+1))==3)+10*((sign(n)*((n-1)%12+1))==2)+5*((sign(n)*((n-1)%12+1))==1)

...
; Formula: a(n) = (7*n-1)%A315474(n)+3*n+1

mov $1,$0
seq $1,315474 ; Coordination sequence Gal.6.341.5 where G.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.
mov $2,$0
mul $2,3
mul $0,7
sub $0,1

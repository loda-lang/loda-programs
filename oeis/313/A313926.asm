...
; Formula: a(n) = ((sign(n)*((n-1)%8+1))==0)+44*floor(n/8)+39*((sign(n)*((n-1)%8+1))==7)+34*((sign(n)*((n-1)%8+1))==6)+28*((sign(n)*((n-1)%8+1))==5)+22*((sign(n)*((n-1)%8+1))==4)+16*((sign(n)*((n-1)%8+1))==3)+10*((sign(n)*((n-1)%8+1))==2)+5*((sign(n)*((n-1)%8+1))==1)

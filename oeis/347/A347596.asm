...
; Formula: a(n) = -b(n-1)+c(n-1), a(2) = -2, a(1) = -1, a(0) = 1, b(n) = 6*c(n-1)-2*b(n-1)-8*truncate(c(n-1)/4), b(2) = -4, b(1) = 2, b(0) = 2, c(n) = 4*c(n-1)-2*b(n-1)-8*truncate(c(n-1)/4), c(2) = -4, c(1) = 0, c(0) = 1

...
; Formula: a(n) = binomial(b(n-1)+binomial(b(n-1),-min(n-1,(n-1)%3)+c(n-1))+1,-min(n-1,(n-1)%3)+c(n-1)+2)+binomial(b(n-1),-min(n-1,(n-1)%3)+c(n-1)), b(n) = b(n-3)+1, b(5) = 1, b(4) = 1, b(3) = 1, b(2) = 0, b(1) = 0, b(0) = 0, c(n) = c(n-3), c(5) = 0, c(4) = 0, c(3) = 0, c(2) = 0, c(1) = 0, c(0) = 0

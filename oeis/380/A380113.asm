...
; Formula: a(n) = -truncate(binomial(2*truncate((sqrtint(8*n+8)-1)/2),-binomial(truncate((sqrtint(8*n+8)-1)/2),2)+n)/2)*((-binomial(truncate((sqrtint(8*n+8)-1)/2),2)+n)==truncate((sqrtint(8*n+8)-1)/2))+binomial(2*truncate((sqrtint(8*n+8)-1)/2),-binomial(truncate((sqrtint(8*n+8)-1)/2),2)+n)

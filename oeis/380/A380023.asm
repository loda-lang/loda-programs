...
; Formula: a(n) = c(n)+e(n), b(n) = c(n-1), b(3) = 2, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = c(n-2)*c(n-1)+max(c(n-3)*c(n-2)*(-c(n-4)*c(n-3)+c(n-2)),-c(n-3)*c(n-2)+c(n-1)), c(5) = 30, c(4) = 8, c(3) = 3, c(2) = 2, c(1) = 1, c(0) = 1, d(n) = e(n-1)*c(n-1)*b(n-1), d(3) = 2, d(2) = 1, d(1) = 0, d(0) = 0, e(n) = max(d(n-1),e(n-1)), e(3) = 1, e(2) = 1, e(1) = 1, e(0) = 1

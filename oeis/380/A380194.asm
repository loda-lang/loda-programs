...
; Formula: a(n) = max((((sign(b(n-1))*((abs(b(n-1))-1)%10+1))==3)+((sign(b(n-1))*((abs(b(n-1))-1)%10+1))==1))*c(n-1)^2,1), a(2) = 1, a(1) = 1, a(0) = 0, b(n) = max((((sign(b(n-1))*((abs(b(n-1))-1)%10+1))==3)+((sign(b(n-1))*((abs(b(n-1))-1)%10+1))==1))*b(n-2)^2,1)*b(n-1)+b(n-2), b(2) = 2, b(1) = 1, b(0) = 1, c(n) = b(n-1), c(2) = 1, c(1) = 1, c(0) = 0

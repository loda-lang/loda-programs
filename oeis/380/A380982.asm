...
; Formula: a(n) = -10*truncate(truncate(b(max(4*n-2,0))/truncate((-d(max(4*n-2,0))+b(max(4*n-2,0)))/(10^n)))/10)+truncate(b(max(4*n-2,0))/truncate((-d(max(4*n-2,0))+b(max(4*n-2,0)))/(10^n))), b(n) = 2*b(n-1)+max(e(n-1),c(n-1)), b(3) = 40, b(2) = 8, b(1) = 2, b(0) = 1, c(n) = 4*b(n-1)+2*c(n-1)+2*max(e(n-1),c(n-1)), c(3) = 128, c(2) = 24, c(1) = 4, c(0) = 0, d(n) = -max(e(n-1),c(n-1))-2*b(n-1)+d(n-1), d(3) = -50, d(2) = -10, d(1) = -2, d(0) = 0, e(n) = max(e(n-1),c(n-1)), e(3) = 24, e(2) = 4, e(1) = 0, e(0) = 0

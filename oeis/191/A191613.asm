...
; 0,0,1,1,2,1,2,1,2,2,2,1,4,2,2,2,4,2,3,2,2,2,2,1,4,4,3,2,4,2,4,3,2,4,4,2,6,3,4,2,6,2,4,2,4,2,2,2,4,4,4,4,4,3,4,2,3,4,2,2,8,4,2,4,4,2,4,4,2,4,4,2,9,6,4,3,4,4,4,2
; Formula: a(n) = A069157(A263027(n-1)-1)

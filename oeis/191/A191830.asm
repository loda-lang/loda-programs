...
; Formula: a(n) = c(max(n-1,0)), b(n) = b(n-1)+b(n-2), b(3) = 2, b(2) = 1, b(1) = 1, b(0) = 0, c(n) = b(n-2)+c(n-2)+d(n-2), c(3) = 4, c(2) = 1, c(1) = 2, c(0) = 0, d(n) = b(n-3)+d(n-1)+d(n-2), d(3) = 4, d(2) = 3, d(1) = 1, d(0) = 1

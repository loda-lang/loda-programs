...
; Formula: a(n) = -e(n-1)+b(n-1)+c(n-1)+d(n-1)+a(n-1)+1, a(5) = 3, a(4) = 0, a(3) = 0, a(2) = 0, a(1) = -1, a(0) = 0, b(n) = b(n-1)+d(n-1), b(5) = -8, b(4) = 3, b(3) = -4, b(2) = 0, b(1) = -2, b(0) = 0, c(n) = c(n-1)+c(n-2)+d(n-3)+1, c(6) = 8, c(5) = -2, c(4) = 2, c(3) = -1, c(2) = 0, c(1) = 0, c(0) = 0, d(n) = 2*a(n-1)-d(n-1)-e(n-1)+c(n-1), d(5) = 21, d(4) = -11, d(3) = 7, d(2) = -4, d(1) = 2, d(0) = -2, e(n) = -e(n-1)+b(n-1)+c(n-1)+a(n-1), e(5) = 13, e(4) = -8, e(3) = 3, e(2) = -3, e(1) = 0, e(0) = 0

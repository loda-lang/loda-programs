...
; Formula: a(n) = e(n)+1, b(n) = -e(n-1)+b(n-1)+d(n-1)-2, b(3) = 3, b(2) = 0, b(1) = -2, b(0) = 0, c(n) = 2*max(-c(n-1)-e(n-1)+d(n-1)-2,0), c(3) = 0, c(2) = 4, c(1) = 0, c(0) = 1, d(n) = 2*c(n-1)+b(n-1)+d(n-1)+4, d(3) = 20, d(2) = 8, d(1) = 6, d(0) = 0, e(n) = -e(n-1)+b(n-1)+c(n-1)+d(n-1)+1, e(3) = 10, e(2) = 3, e(1) = 2, e(0) = 0

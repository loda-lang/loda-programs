...
; Formula: a(n) = 8*c(n), b(n) = 16*c(n-1)+4*b(n-1), b(3) = 512, b(2) = 64, b(1) = 0, b(0) = 0, c(n) = 4*e(n-1)-2*d(n-1), c(3) = 260, c(2) = 16, c(1) = 4, c(0) = 0, d(n) = 2*e(n-1)-d(n-1), d(3) = 130, d(2) = 8, d(1) = 2, d(0) = 0, e(n) = 12*c(n-1)+5*e(n-1)+2*b(n-1)-2*d(n-1), e(3) = 649, e(2) = 69, e(1) = 5, e(0) = 1

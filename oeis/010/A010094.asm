...
; Formula: a(n) = A008280(A061579(-A002260(truncate((sqrtint(8*A061579(n-1)+1)+1)/2)+A061579(n-1)+1)+truncate((sqrtint(8*A061579(n-1)+1)+1)/2)+A061579(n-1)+A319573(truncate((sqrtint(8*A061579(n-1)+1)+1)/2)+A061579(n-1)+1)+2))

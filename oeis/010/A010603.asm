...
; Formula: a(n) = ((b(3*n+3)/5)/((c(3*n+3)/(10^(n+1)))/2))%10, b(n) = 2*b(n-1)+2*c(n-1)+d(n-1)+10, b(2) = 78, b(1) = 12, b(0) = 1, c(n) = 2*b(n-1)+2*c(n-1)+c(n-1)+d(n-1)+20, c(2) = 110, c(1) = 22, c(0) = 0, d(n) = c(n-1)+d(n-1), d(2) = 22, d(1) = 0, d(0) = 0

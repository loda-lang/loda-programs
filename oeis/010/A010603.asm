...
; Formula: a(n) = floor(floor(b(3*n)/5)/floor(floor(c(3*n)/(10^n))/2))%10, b(n) = 2*b(n-1)+2*c(n-1)+d(n-1), b(2) = 242, b(1) = 44, b(0) = 0, c(n) = 3*c(n-1)+2*b(n-1)+d(n-1), c(2) = 308, c(1) = 66, c(0) = 22, d(n) = c(n-1)+d(n-1), d(2) = 88, d(1) = 22, d(0) = 0

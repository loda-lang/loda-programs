...
; Formula: a(n) = -10*truncate(truncate((4*b(4*n))/(truncate(c(4*n)/(10^n))+1))/10)+truncate((4*b(4*n))/(truncate(c(4*n)/(10^n))+1)), b(n) = 4*c(n-1)+2*b(n-1), b(1) = 14, b(0) = 7, c(n) = 6*c(n-1)-4*c(n-2), c(3) = 224, c(2) = 42, c(1) = 7, c(0) = 0

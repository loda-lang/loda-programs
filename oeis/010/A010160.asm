...
; Formula: a(n) = floor(((truncate(3^(gcd(n,max(-n+2,0)+6)-3))%10+21*floor((truncate(3^(gcd(n,max(-n+2,0)+6)-3))%10)/3)+gcd(-n+1,2))*(((truncate(3^(gcd(n,max(-n+2,0)+6)-3))%10+21*floor((truncate(3^(gcd(n,max(-n+2,0)+6)-3))%10)/3)+gcd(-n+1,2))^2)%3)+1)/3)+1

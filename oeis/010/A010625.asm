...
; Formula: a(n) = floor((3*b(max(3*n-3,0)))/(floor(c(max(3*n-3,0))/(10^(n-1)))+1))%10, b(n) = b(n-1)+c(n-1), b(2) = 6, b(1) = 1, b(0) = 1, c(n) = 4*c(n-1)+b(n-1)+d(n-1)+4, c(2) = 26, c(1) = 5, c(0) = 0, d(n) = 2*c(n-1)+b(n-1)+d(n-1), d(2) = 12, d(1) = 1, d(0) = 0

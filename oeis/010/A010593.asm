...
; Formula: a(n) = (((-c(3*n)+b(3*n))/(c(3*n)/(10^n)+1)-1)%10+10)%10, b(n) = 4*c(n-1)+2*(d(n-1)/3)+2*b(n-1), b(2) = -92, b(1) = -14, b(0) = -7, c(n) = 6*c(n-1)+2*(d(n-1)/3)+2*b(n-1), c(2) = -120, c(1) = -14, c(0) = 0, d(n) = 7*c(n-1)+3*(d(n-1)/3)+2*b(n-1), d(2) = -138, d(1) = -14, d(0) = 0

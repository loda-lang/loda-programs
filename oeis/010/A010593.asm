...
; Formula: a(n) = (-10*truncate((truncate((-c(max(3*n-3,0))+b(max(3*n-3,0)))/(truncate(c(max(3*n-3,0))/(10^(n-1)))+1))-1)/10)+truncate((-c(max(3*n-3,0))+b(max(3*n-3,0)))/(truncate(c(max(3*n-3,0))/(10^(n-1)))+1))+9)%10, b(n) = 4*c(n-1)+2*b(n-1)+2*truncate(d(n-1)/3), b(2) = -92, b(1) = -14, b(0) = -7, c(n) = 6*c(n-1)+2*b(n-1)+2*truncate(d(n-1)/3), c(2) = -120, c(1) = -14, c(0) = 0, d(n) = 7*c(n-1)+3*truncate(d(n-1)/3)+2*b(n-1), d(2) = -138, d(1) = -14, d(0) = 0

...
; Formula: a(n) = floor((3*d(max(4*n-4,0))+4)/floor(c(max(4*n-4,0))/(10^(n-1))))%10, b(n) = 8*c(n-1)+8*d(n-1)+4*b(n-1), b(2) = 296, b(1) = 24, b(0) = 0, c(n) = 7*c(n-1)+6*d(n-1)+3*b(n-1), c(2) = 242, c(1) = 20, c(0) = 2, d(n) = 2*c(n-1)+d(n-1), d(2) = 45, d(1) = 5, d(0) = 1

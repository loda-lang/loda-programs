...
; Formula: a(n) = ((3*d(4*n)+4)/(c(4*n)/(10^n)))%10, b(n) = 8*c(n-1)+8*d(n-1)+4*b(n-1), b(2) = 296, b(1) = 24, b(0) = 0, c(n) = 7*c(n-1)+6*d(n-1)+3*b(n-1), c(2) = 242, c(1) = 20, c(0) = 2, d(n) = 2*c(n-1)+d(n-1), d(2) = 45, d(1) = 5, d(0) = 1

...
; Formula: a(n) = -10*truncate(truncate((2*b(4*n+2))/truncate(c(4*n+2)/(10^n)))/10)+truncate((2*b(4*n+2))/truncate(c(4*n+2)/(10^n))), b(n) = 2*b(n-1)+2*c(n-1), b(1) = 14, b(0) = 0, c(n) = 4*c(n-1)-2*c(n-2), c(3) = 140, c(2) = 42, c(1) = 14, c(0) = 7

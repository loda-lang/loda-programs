...
; Formula: a(n) = ((sign(n)*((n-1)%8+1))==5)+((sign(n)*((n-1)%8+1))==3)+16*((sign(n)*((n-1)%8+1))==8)+8*((sign(n)*((n-1)%8+1))==0)+4*((sign(n)*((n-1)%8+1))==4)+3*((sign(n)*((n-1)%8+1))==7)+3*((sign(n)*((n-1)%8+1))==6)+3*((sign(n)*((n-1)%8+1))==2)+3*((sign(n)*((n-1)%8+1))==1)

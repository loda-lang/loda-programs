...
; Formula: a(n) = truncate((2*truncate(if((truncate((A057335(A341915(A006068(A156552(2*n))))-1)/A293810(A057335(A341915(A006068(A156552(2*n))))))+1)==0,0,(truncate((A057335(A341915(A006068(A156552(2*n))))-1)/A293810(A057335(A341915(A006068(A156552(2*n))))))+1)/(2^valuation(truncate((A057335(A341915(A006068(A156552(2*n))))-1)/A293810(A057335(A341915(A006068(A156552(2*n))))))+1,2)))/2)+1)/2)+1

...
; Formula: a(n) = e(n)+3, b(n) = b(n-1)+d(n-1)+e(n-1)+2, b(4) = 43, b(3) = 18, b(2) = 7, b(1) = 2, b(0) = 0, c(n) = -c(n-1)+e(n-1)+1, c(4) = 16, c(3) = 7, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = -b(n-1)-d(n-1)+f(n-1), d(4) = 5, d(3) = 1, d(2) = 0, d(1) = 0, d(0) = 0, e(n) = b(n-1)+c(n-1)+e(n-1)+3, e(4) = 50, e(3) = 22, e(2) = 9, e(1) = 3, e(0) = 0, f(n) = 2*c(n-1)+2*f(n-1)+2, f(4) = 64, f(3) = 24, f(2) = 8, f(1) = 2, f(0) = 0

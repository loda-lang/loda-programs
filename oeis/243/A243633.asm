...
; Formula: a(n) = b(max(n-1,0)), b(n) = 4*b(n-1)-4*b(n-2)+b(n-4)+c(n-2)+d(n-3), b(4) = 56, b(3) = 21, b(2) = 8, b(1) = 3, b(0) = 1, c(n) = b(n-1), c(3) = 8, c(2) = 3, c(1) = 1, c(0) = 0, d(n) = c(n-1)+d(n-1), d(3) = 4, d(2) = 1, d(1) = 0, d(0) = 0

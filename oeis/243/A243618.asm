...
; Formula: a(n) = truncate((3*(2*binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)-2*n+floor((sqrtint(8*n+8)-1)/2)+1)*(2*binomial(floor((sqrtint(8*n+8)-1)/2)+1,2)-2*n+floor((sqrtint(8*n+8)-1)/2)+2)+6*binomial(floor((sqrtint(8*n+8)-1)/2)+2,2))/6)

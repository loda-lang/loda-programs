...
; Formula: a(n) = b(n-1), a(4) = 2, a(3) = 1, a(2) = -1, a(1) = 1, a(0) = 2, b(n) = truncate((b(n-1)*(-c(n-1)+e(n-1)))/d(n-1)), b(4) = -2, b(3) = 2, b(2) = 1, b(1) = -1, b(0) = 1, c(n) = b(n-1), c(4) = 2, c(3) = 1, c(2) = -1, c(1) = 1, c(0) = 1, d(n) = b(n-2), d(4) = 1, d(3) = -1, d(2) = 1, d(1) = 2, d(0) = 1, e(n) = truncate((b(n-1)*(-c(n-1)+e(n-1)))/d(n-1)), e(4) = -2, e(3) = 2, e(2) = 1, e(1) = -1, e(0) = 0

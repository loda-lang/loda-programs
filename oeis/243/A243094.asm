...
; Formula: a(n) = b(n)+1, b(n) = d(n-1)+1, b(4) = 18, b(3) = 7, b(2) = 4, b(1) = 1, b(0) = 0, c(n) = 3*c(n-3)+c(n-1)+c(n-2)+c(n-4)+6, c(4) = 34, c(3) = 15, c(2) = 7, c(1) = 2, c(0) = 0, d(n) = 5*c(n-3)+4*d(n-3)+d(n-2)+14, d(4) = 42, d(3) = 17, d(2) = 6, d(1) = 3, d(0) = 0

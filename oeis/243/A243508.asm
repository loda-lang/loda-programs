...
; Formula: a(n) = ((b(3*n+3)/(c(3*n+3)/(5*10^n)))/2)%10, b(n) = 2*b(n-1)+2*d(n-1), b(2) = 24, b(1) = 2, b(0) = 0, c(n) = b(n-1)+c(n-1), c(2) = 2, c(1) = 0, c(0) = 0, d(n) = 12*d(n-3)+9*d(n-1)-18*d(n-2), d(5) = 18018, d(4) = 2766, d(3) = 426, d(2) = 66, d(1) = 10, d(0) = 1

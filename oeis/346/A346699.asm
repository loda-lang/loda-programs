...
; 0,1,2,1,3,2,4,2,2,3,5,3,6,4,3,2,7,3,8,4,4,5,9,3,3,6,4,5,10,4,11,3,5,7,4,3,12,8,6,4,13,5,14,6,5,9,15,4,4,4,7,7,16,4,5,5,8,10,17,4,18,11,6,3,6,6,19,8,9,5,20,4,21,12,5,9,5,7,22,5
; Formula: a(n) = A064415(A181819(A108951(n+1)))

; A346635: Numbers whose division (or multiplication) by their greatest prime factor is a perfect square. Numbers n such that n*A006530(n) is a perfect square.

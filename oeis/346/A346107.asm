...
; Formula: a(n) = A181811(truncate(A064989(A276086(A181811(n+1)*(n+1)))/gcd(A064989(A276086(A181811(n+1)*(n+1))),A276086(A181811(n+1)*(n+1))))+1)*(truncate(A064989(A276086(A181811(n+1)*(n+1)))/gcd(A064989(A276086(A181811(n+1)*(n+1))),A276086(A181811(n+1)*(n+1))))+1)

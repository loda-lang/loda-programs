...
; 0,1,2,1,3,1,4,2,2,1,5,3,6,1,2,2,7,3,8,4,2,1,9,2,3,1,4,5,10,4,11,3,2,1,3,3,12,1,2,2,13,5,14,6,5,1,15,4,4,4,2,7,16,3,3,2,2,1,17,3,18,1,6,3,3,6,19,8,2,5,20,4,21,1,5,9,4,7,22,5
; Formula: a(n) = A056239(A346703(n)-1)

...
; Formula: a(n) = 7*a(n-1)+5*a(n-3)-14*a(n-2)+b(n-2)+c(n-2), a(6) = 9529, a(5) = 2487, a(4) = 632, a(3) = 154, a(2) = 35, a(1) = 7, a(0) = 1, b(n) = b(n-1)+c(n-1), b(4) = 44, b(3) = 9, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = a(n-1), c(4) = 154, c(3) = 35, c(2) = 7, c(1) = 1, c(0) = 0

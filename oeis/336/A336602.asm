...
; Formula: a(n) = 4*a(n-1)-d(n-1)+c(n-1)+e(n-1), a(4) = 632, a(3) = 154, a(2) = 35, a(1) = 7, a(0) = 1, b(n) = b(n-1)+d(n-1), b(4) = 44, b(3) = 9, b(2) = 2, b(1) = 1, b(0) = 1, c(n) = -d(n-1)+c(n-1)+e(n-1), c(4) = 16, c(3) = 14, c(2) = 7, c(1) = 3, c(0) = 2, d(n) = a(n-1), d(4) = 154, d(3) = 35, d(2) = 7, d(1) = 1, d(0) = 0, e(n) = 2*e(n-1)+b(n-1)+c(n-1), e(4) = 97, e(3) = 37, e(2) = 14, e(1) = 5, e(0) = 1

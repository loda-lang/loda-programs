...
lpb $2
  ...
  lpb $3
    ...
    lpe
    mov $7,$6
    seq $7,313165 ; Coordination sequence Gal.6.190.3 where Gal.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.
    add $7,1
    lpb $3
      dif $3,$6
      mul $5,$7

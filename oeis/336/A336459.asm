...
; 1,1,7,1,1,7,5,1,7,13,7,7,1,5,5,1,13,7,7,1,7,91,5,7,1,1,5,5,1,65,7,13,31,5,31,7,5,7,5,13,1,7,7,7,7,65,31,7,5,1,65,19,5,5,65,5,31,13,7,5,1,7,35,1,7,403,7,13,7,403,65,7,19,5,7,7,7,5,31,1
; Formula: a(n) = A336457(A000203(n+1)-1)

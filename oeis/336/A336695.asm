...
; 0,0,2,0,1,2,2,0,1,3,2,4,3,4,4,0,3,2,2,3,3,4,4,2,0,3,3,4,1,5,3,0,2,4,2,2,3,2,4,3,3,3,4,5,3,5,2,6,4,2,5,4,4,4,5,4,4,3,2,4,3,3,4,0,5,6,3,1,3,6,5,2,5,4,6,3,3,4,4,5
; Formula: a(n) = A331410(A000203(n)+1)

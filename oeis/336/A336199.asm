...
; Formula: a(n) = ((2*b(4*n+4))/(c(4*n+4)/(10^(n+1))))%10, b(n) = 4*((c(n-1)+e(n-1))/3)+2*b(n-1)-2*d(n-1), b(3) = -32, b(2) = -4, b(1) = 0, b(0) = 0, c(n) = 4*((c(n-1)+e(n-1))/3)+2*((c(n-1)+e(n-1))/3)+2*b(n-1)+2*c(n-1)-2*d(n-1)-8, c(3) = -176, c(2) = -38, c(1) = -8, c(0) = 0, d(n) = 8*((c(n-1)+e(n-1))/3)+2*b(n-1)+2*c(n-1)-d(n-1)-2*d(n-1)+b(n-1)+d(n-1)-8, d(3) = -240, d(2) = -48, d(1) = -8, d(0) = 0, e(n) = (c(n-1)+e(n-1))/3+8*((c(n-1)+e(n-1))/3)+2*b(n-1)+2*c(n-1)-d(n-1)-2*d(n-1)+b(n-1)+d(n-1)-8, e(3) = -270, e(2) = -53, e(1) = -8, e(0) = 0

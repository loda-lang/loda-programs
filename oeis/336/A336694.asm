...
; 0,0,1,0,2,2,2,0,2,3,2,3,2,2,2,0,3,1,3,4,3,3,2,3,0,4,2,4,3,3,3,0,4,3,4,3,3,3,4,4,4,2,3,2,4,3,4,3,3,4,3,4,3,4,3,4,4,4,3,4,4,2,4,0,2,4,4,5,2,4,3,4,3,4,3,5,2,4,4,3
; Formula: a(n) = A329697(A000203(n+1))

...
; 1,2,3,2,1,4,5,2,1,2,3,4,1,6,7,2,1,2,3,2,1,4,5,4,1,2,3,6,1,8,9,2,1,2,3,2,1,4,5,2,1,2,3,4,1,6,7,4,1,2,3,2,1,4,5,6,1,2,3,8,1,10,11,2,1,2,3,2,1,4,5,2,1,2,3,4,1,6,7,2
; Formula: a(n) = (n-1)%2+2*A089309(n)-1

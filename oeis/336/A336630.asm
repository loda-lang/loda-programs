...
; Formula: a(n) = 2*d(n), b(n) = 3*b(n-2)+2*c(n-2)+b(n-1), b(3) = 21, b(2) = 7, b(1) = 4, b(0) = 1, c(n) = b(n-1)+c(n-1), c(3) = 12, c(2) = 5, c(1) = 1, c(0) = 0, d(n) = 2*b(n-1)+c(n-1), d(3) = 19, d(2) = 9, d(1) = 2, d(0) = 0

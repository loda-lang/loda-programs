...
; Formula: a(n) = (((c(n-1)+1)^2+d(n-1)+5)%(4*b(n-1)+b(n-1))+1)/b(n-1), a(3) = 1, a(2) = 1, a(1) = 2, a(0) = 2, b(n) = 4*b(n-1)+b(n-1), b(3) = 625, b(2) = 125, b(1) = 25, b(0) = 5, c(n) = ((c(n-1)+1)^2+d(n-1)+5)%(4*b(n-1)+b(n-1)), c(3) = 161, c(2) = 36, c(1) = 11, c(0) = 1, d(n) = ((c(n-1)+1)^2+d(n-1)+5)%(4*b(n-1)+b(n-1))+1, d(3) = 162, d(2) = 37, d(1) = 12, d(0) = 2

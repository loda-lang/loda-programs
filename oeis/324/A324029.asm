...
; Formula: a(n) = c(n+1), b(n) = 5*b(n-1), b(3) = 125, b(2) = 25, b(1) = 5, b(0) = 1, c(n) = ((d(n-1)^2+d(n-1)+5)%(5*b(n-1))+1)/b(n-1), c(4) = 1, c(3) = 1, c(2) = 2, c(1) = 2, c(0) = 0, d(n) = (d(n-1)^2+d(n-1)+5)%(5*b(n-1))+1, d(4) = 162, d(3) = 37, d(2) = 12, d(1) = 2, d(0) = 0

...
; Formula: a(n) = c(n+1), b(n) = 5*b(n-1), b(3) = 125, b(2) = 25, b(1) = 5, b(0) = 1, c(n) = (((d(n-1)+1)^2+e(n-1)+5)%(5*b(n-1))+1)/b(n-1), c(3) = 1, c(2) = 2, c(1) = 2, c(0) = 0, d(n) = ((d(n-1)+1)^2+e(n-1)+5)%(5*b(n-1)), d(3) = 36, d(2) = 11, d(1) = 1, d(0) = 0, e(n) = ((d(n-1)+1)^2+e(n-1)+5)%(5*b(n-1))+1, e(3) = 37, e(2) = 12, e(1) = 2, e(0) = 0

...
; Formula: a(n) = 2*A181819(A181811(truncate((A057335(n)-1)/A293810(A057335(n)))+1)*(truncate((A057335(n)-1)/A293810(A057335(n)))+1))-truncate((84*A000203(A181819(A181811(truncate((A057335(n)-1)/A293810(A057335(n)))+1)*(truncate((A057335(n)-1)/A293810(A057335(n)))+1)))-79)/84)-1

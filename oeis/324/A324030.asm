...
; Formula: a(n) = c(n+1), b(n) = 5*b(n-1), b(3) = 125, b(2) = 25, b(1) = 5, b(0) = 1, c(n) = (((2*d(n-1)+2)^2+e(n-1)+23)%(5*b(n-1))+1)/b(n-1), c(3) = 3, c(2) = 2, c(1) = 3, c(0) = 0, d(n) = ((2*d(n-1)+2)^2+e(n-1)+23)%(5*b(n-1)), d(3) = 87, d(2) = 12, d(1) = 2, d(0) = 0, e(n) = ((2*d(n-1)+2)^2+e(n-1)+23)%(5*b(n-1))+1, e(3) = 88, e(2) = 13, e(1) = 3, e(0) = 0

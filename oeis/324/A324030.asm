...
; Formula: a(n) = c(n+1), b(n) = 5*b(n-1), b(3) = 125, b(2) = 25, b(1) = 5, b(0) = 1, c(n) = (((2*d(n-1))^2+d(n-1)+23)%(5*b(n-1))+1)/b(n-1), c(4) = 3, c(3) = 3, c(2) = 2, c(1) = 3, c(0) = 0, d(n) = ((2*d(n-1))^2+d(n-1)+23)%(5*b(n-1))+1, d(4) = 463, d(3) = 88, d(2) = 13, d(1) = 3, d(0) = 0

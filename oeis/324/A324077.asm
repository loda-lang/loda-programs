...
; Formula: a(n) = (2*(13*b(n-1)+a(n-1))^4+c(n-1)-7)%(13*b(n-1)), a(2) = 28, a(1) = 2, a(0) = 0, b(n) = 13*b(n-1), b(2) = 169, b(1) = 13, b(0) = 1, c(n) = (2*(13*b(n-1)+a(n-1))^4+c(n-1)-7)%(13*b(n-1))+1, c(2) = 29, c(1) = 3, c(0) = -4

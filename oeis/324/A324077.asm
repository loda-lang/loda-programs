...
; Formula: a(n) = -13*truncate((2*(13*b(n-1)+a(n-1))^4+a(n-1)-6)/(13*b(n-1)))*b(n-1)+2*(13*b(n-1)+a(n-1))^4+a(n-1)-6, a(3) = 1211, a(2) = 28, a(1) = 2, a(0) = 0, b(n) = 13*b(n-1), b(2) = 169, b(1) = 13, b(0) = 1

; A324027: One of the two successive approximations up to 5^n for the 5-adic integer sqrt(-6). This is the 2 (mod 5) case (except for n = 0).
...
; Formula: a(n) = (a(n-1)^2+a(n-1)+5)%(5*5^(n-1))+1, a(3) = 37, a(2) = 12, a(1) = 2, a(0) = 0

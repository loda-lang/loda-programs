...
; Formula: a(n) = c(n-1)^2-5*truncate((c(n-1)^2+c(n-1)+5)/(5*b(n-1)))*b(n-1)+c(n-1)+6, a(4) = 162, a(3) = 37, a(2) = 12, a(1) = 2, a(0) = 0, b(n) = 5*b(n-1), b(3) = 125, b(2) = 25, b(1) = 5, b(0) = 1, c(n) = c(n-1)^2-5*truncate((c(n-1)^2+c(n-1)+5)/(5*b(n-1)))*b(n-1)+c(n-1)+6, c(4) = 162, c(3) = 37, c(2) = 12, c(1) = 2, c(0) = 0

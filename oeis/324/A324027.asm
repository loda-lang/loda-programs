...
; Formula: a(n) = ((c(n-1)+1)^2+d(n-1)+5)%(5*b(n-1))+1, a(3) = 37, a(2) = 12, a(1) = 2, a(0) = 0, b(n) = 5*b(n-1), b(3) = 125, b(2) = 25, b(1) = 5, b(0) = 1, c(n) = ((c(n-1)+1)^2+d(n-1)+5)%(5*b(n-1)), c(3) = 36, c(2) = 11, c(1) = 1, c(0) = 0, d(n) = ((c(n-1)+1)^2+d(n-1)+5)%(5*b(n-1))+1, d(3) = 37, d(2) = 12, d(1) = 2, d(0) = 0

...
; 1,2,1,2,1,1,1,8,3,4,1,1,1,1,1,8,1,2,1,4,1,1,1,4,1,4,3,1,1,1,1,16,1,4,1,27,1,1,1,64,1,1,1,1,1,1,1,2,1,8,1,4,1,1,1,1,1,4,1,1,1,1,9,16,1,1,1,4,1,1,1,96,1,4,1,1,1,1,1,64
; Formula: a(n) = truncate(A211776(n+1)/gcd(A211776(n+1),A206032(n+1)))

...
; Formula: a(n) = 13*b(n-1)-((2*(13*b(n-1)+c(n-1))^4+d(n-1)-7)%(13*b(n-1))), a(3) = 986, a(2) = 141, a(1) = 11, a(0) = 0, b(n) = 13*b(n-1), b(3) = 2197, b(2) = 169, b(1) = 13, b(0) = 1, c(n) = (2*(13*b(n-1)+c(n-1))^4+c(n-1)-6)%(13*b(n-1)), c(4) = 3408, c(3) = 1211, c(2) = 28, c(1) = 2, c(0) = 0, d(n) = (2*(13*b(n-1)+d(n-1)-1)^4+d(n-1)-7)%(13*b(n-1))+1, d(4) = 3409, d(3) = 1212, d(2) = 29, d(1) = 3, d(0) = -4

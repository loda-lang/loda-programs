...
; Formula: a(n) = -c(n)+f(n), b(n) = 5*b(n-1), b(4) = 625, b(3) = 125, b(2) = 25, b(1) = 5, b(0) = 1, c(n) = (3*(d(n-1)+1)^2+e(n-1)+5)%(5*b(n-1))+1, c(4) = 109, c(3) = 109, c(2) = 9, c(1) = 4, c(0) = 0, d(n) = (3*(d(n-1)+1)^2+e(n-1)+5)%(5*b(n-1)), d(4) = 108, d(3) = 108, d(2) = 8, d(1) = 3, d(0) = 0, e(n) = (3*(d(n-1)+1)^2+e(n-1)+5)%(5*b(n-1))-23, e(4) = 85, e(3) = 85, e(2) = -15, e(1) = -20, e(0) = 0, f(n) = 5*b(n-1), f(4) = 625, f(3) = 125, f(2) = 25, f(1) = 5, f(0) = 0

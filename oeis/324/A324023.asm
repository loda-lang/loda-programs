...
; Formula: a(n) = -c(n)+e(n), b(n) = 5*b(n-1), b(4) = 625, b(3) = 125, b(2) = 25, b(1) = 5, b(0) = 1, c(n) = -5*truncate((3*(d(n-1)+24)^2+d(n-1)+5)/(5*b(n-1)))*b(n-1)+3*(d(n-1)+24)^2+d(n-1)+6, c(5) = 1359, c(4) = 109, c(3) = 109, c(2) = 9, c(1) = 4, c(0) = 0, d(n) = -5*truncate((3*(d(n-1)+24)^2+d(n-1)+5)/(5*b(n-1)))*b(n-1)+3*(d(n-1)+24)^2+d(n-1)-18, d(5) = 1335, d(4) = 85, d(3) = 85, d(2) = -15, d(1) = -20, d(0) = 0, e(n) = 5*b(n-1), e(4) = 625, e(3) = 125, e(2) = 25, e(1) = 5, e(0) = 0

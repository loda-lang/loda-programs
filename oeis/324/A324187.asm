...
; Formula: a(n) = -A000203(truncate((A057335(A341915(A006068(n)))-1)/A293810(A057335(A341915(A006068(n)))))+1)*truncate(A094471(truncate((A057335(A341915(A006068(n)))-1)/A293810(A057335(A341915(A006068(n)))))+1)/A000203(truncate((A057335(A341915(A006068(n)))-1)/A293810(A057335(A341915(A006068(n)))))+1))+A094471(truncate((A057335(A341915(A006068(n)))-1)/A293810(A057335(A341915(A006068(n)))))+1)

...
; Formula: a(n) = truncate((-A000203(n+2)*truncate(A094471(n+1)/A000203(n+2))+A094471(n+1))/(n+1))*(n+1)+A000203(n+2)*truncate(A094471(n+1)/A000203(n+2))-A094471(n+1)+A000203(n+2)

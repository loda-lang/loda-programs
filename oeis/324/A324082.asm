...
; Formula: a(n) = (3*(c(n-1)+1)^4+d(n-1)-1)%(12*b(n-1)+b(n-1))+1, a(3) = 575, a(2) = 68, a(1) = 3, a(0) = 0, b(n) = 12*b(n-1)+b(n-1), b(3) = 2197, b(2) = 169, b(1) = 13, b(0) = 1, c(n) = (3*(c(n-1)+1)^4+d(n-1)-1)%(12*b(n-1)+b(n-1)), c(3) = 574, c(2) = 67, c(1) = 2, c(0) = 0, d(n) = (3*(c(n-1)+1)^4+d(n-1)-1)%(12*b(n-1)+b(n-1))-8, d(3) = 566, d(2) = 59, d(1) = -6, d(0) = 0

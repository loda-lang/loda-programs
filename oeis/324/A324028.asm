...
; Formula: a(n) = (2*c(n-1))^2-5*truncate(((2*c(n-1))^2+c(n-1)+23)/(5*b(n-1)))*b(n-1)+c(n-1)+24, a(4) = 463, a(3) = 88, a(2) = 13, a(1) = 3, a(0) = 0, b(n) = 5*b(n-1), b(3) = 125, b(2) = 25, b(1) = 5, b(0) = 1, c(n) = (2*c(n-1))^2-5*truncate(((2*c(n-1))^2+c(n-1)+23)/(5*b(n-1)))*b(n-1)+c(n-1)+24, c(4) = 463, c(3) = 88, c(2) = 13, c(1) = 3, c(0) = 0

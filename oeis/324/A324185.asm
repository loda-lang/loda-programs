...
; Formula: a(n) = 2*truncate((A057335(A341915(A006068(n)))-1)/A293810(A057335(A341915(A006068(n)))))-truncate((84*A000203(truncate((A057335(A341915(A006068(n)))-1)/A293810(A057335(A341915(A006068(n)))))+1)-79)/84)+1

...
; Formula: a(n) = -5*truncate((3*(c(n-1)+24)^2+c(n-1)+5)/(5*b(n-1)))*b(n-1)+3*(c(n-1)+24)^2+c(n-1)+6, a(4) = 109, a(3) = 109, a(2) = 9, a(1) = 4, a(0) = 0, b(n) = 5*b(n-1), b(3) = 125, b(2) = 25, b(1) = 5, b(0) = 1, c(n) = -5*truncate((3*(c(n-1)+24)^2+c(n-1)+5)/(5*b(n-1)))*b(n-1)+3*(c(n-1)+24)^2+c(n-1)-18, c(4) = 85, c(3) = 85, c(2) = -15, c(1) = -20, c(0) = 0

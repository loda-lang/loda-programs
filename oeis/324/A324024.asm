...
; Formula: a(n) = (3*(c(n-1)+1)^2+d(n-1)+5)%(5*b(n-1))+1, a(3) = 109, a(2) = 9, a(1) = 4, a(0) = 0, b(n) = 5*b(n-1), b(3) = 125, b(2) = 25, b(1) = 5, b(0) = 1, c(n) = (3*(c(n-1)+1)^2+d(n-1)+5)%(5*b(n-1)), c(3) = 108, c(2) = 8, c(1) = 3, c(0) = 0, d(n) = (3*(c(n-1)+1)^2+d(n-1)+5)%(5*b(n-1))-23, d(3) = 85, d(2) = -15, d(1) = -20, d(0) = 0

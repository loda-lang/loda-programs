...
; Formula: a(n) = c(n+1)/36, b(n) = 2*b(n-1)-c(n-1)-d(n-1), b(2) = -108, b(1) = -6, b(0) = 0, c(n) = 18*c(n-1)+18*d(n-1)-6*b(n-1), c(2) = 1764, c(1) = 108, c(0) = 0, d(n) = -2*c(n-1)-2*d(n-1)+b(n-1), d(2) = -198, d(1) = -12, d(0) = 6

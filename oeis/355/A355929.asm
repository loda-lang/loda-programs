...
; Formula: a(n) = -floor((n-1)/(floor(sqrtint(4*(floor(max(0,n-1)/A019554(max(0,n-1)+1))+1)^2)/2)^2))+truncate((A000203(n)-1)/(floor(sqrtint(4*(floor(max(0,A000203(n)-1)/A019554(max(0,A000203(n)-1)+1))+1)^2)/2)^2))

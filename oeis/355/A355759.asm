...
; Formula: a(n) = b(n-1), b(n) = c(n-3), b(7) = 45, b(6) = 32, b(5) = 24, b(4) = 15, b(3) = 11, b(2) = 6, b(1) = 4, b(0) = 1, c(n) = d(n-1), c(7) = 94, c(6) = 76, c(5) = 57, c(4) = 45, c(3) = 32, c(2) = 24, c(1) = 15, c(0) = 11, d(n) = e(n-1), d(7) = 119, d(6) = 94, d(5) = 76, d(4) = 57, d(3) = 45, d(2) = 32, d(1) = 24, d(0) = 15, e(n) = f(n-2), e(7) = 143, e(6) = 119, e(5) = 94, e(4) = 76, e(3) = 57, e(2) = 45, e(1) = 32, e(0) = 24, f(n) = 2*c(n-3)+2*d(n-1)+2*f(n-1)-c(n-4)-2*c(n-1)-2*e(n-1), f(8) = 249, f(7) = 208, f(6) = 176, f(5) = 143, f(4) = 119, f(3) = 94, f(2) = 76, f(1) = 57, f(0) = 45

...
; Formula: a(n) = -10*truncate((-10*truncate((b(n)+1)/10)+b(n)+11)/10)-10*truncate((b(n)+1)/10)+b(n)+11, b(n) = -b(n-2)+b(n-1)+truncate((10*b(n-2)-10*b(n-1)-40)/(b(n-1)+1))+5, b(1) = -44, b(0) = 0
